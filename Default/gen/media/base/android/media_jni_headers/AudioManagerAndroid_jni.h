...
static std::atomic<jmethodID>
    g_org_chromium_media_AudioManagerAndroid_isAudioSinkConnected(nullptr);
static jboolean Java_AudioManagerAndroid_isAudioSinkConnected(JNIEnv* env) {
  jclass clazz = org_chromium_media_AudioManagerAndroid_clazz(env);
  CHECK_CLAZZ(env, clazz,
      org_chromium_media_AudioManagerAndroid_clazz(env), false);
  ...
  call_context.Init<
      base::android::MethodID::TYPE_STATIC>(
          env,
          clazz,
          "isAudioSinkConnected",
          "()Z",
          &g_org_chromium_media_AudioManagerAndroid_isAudioSinkConnected);
...
static std::atomic<jmethodID>
    g_org_chromium_media_AudioManagerAndroid_getAudioEncodingFormatsSupported(nullptr);
static jint Java_AudioManagerAndroid_getAudioEncodingFormatsSupported(JNIEnv* env) {
  jclass clazz = org_chromium_media_AudioManagerAndroid_clazz(env);
  CHECK_CLAZZ(env, clazz,
      org_chromium_media_AudioManagerAndroid_clazz(env), 0);
  ...
  call_context.Init<
      base::android::MethodID::TYPE_STATIC>(
          env,
          clazz,
          "getAudioEncodingFormatsSupported",
          "()I",
          &g_org_chromium_media_AudioManagerAndroid_getAudioEncodingFormatsSupported);
