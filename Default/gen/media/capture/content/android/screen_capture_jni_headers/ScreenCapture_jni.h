...
static std::atomic<jmethodID> g_org_chromium_media_ScreenCapture_onNativeDestroyed(nullptr);
static void Java_ScreenCapture_onNativeDestroyed(JNIEnv* env, const base::android::JavaRef<jobject>&
    obj) {
  jclass clazz = org_chromium_media_ScreenCapture_clazz(env);
  CHECK_CLAZZ(env, obj.obj(),
  ...
  call_context.Init<
      base::android::MethodID::TYPE_INSTANCE>(
          ...
          "onNativeDestroyed",
          "()V",
          &g_org_chromium_media_ScreenCapture_onNativeDestroyed);
