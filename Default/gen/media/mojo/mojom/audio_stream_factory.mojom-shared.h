...
using AudioStreamFactoryPtrDataView =
    mojo::InterfacePtrDataView<AudioStreamFactoryInterfaceBase>;
using AudioStreamFactoryRequestDataView =
    mojo::InterfaceRequestDataView<AudioStreamFactoryInterfaceBase>;
using AudioStreamFactoryAssociatedPtrInfoDataView =
    mojo::AssociatedInterfacePtrInfoDataView<AudioStreamFactoryInterfaceBase>;
using AudioStreamFactoryAssociatedRequestDataView =
    mojo::AssociatedInterfaceRequestDataView<AudioStreamFactoryInterfaceBase>;
