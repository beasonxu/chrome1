...
HDRMetadata::HDRMetadata(
    const ::gfx::ColorVolumeMetadata& color_volume_metadata_in,
...
NativeGpuMemoryBufferHandle::NativeGpuMemoryBufferHandle(
    ...
    ::media::stable::mojom::NativePixmapHandlePtr platform_handle_in)
    : id(std::move(id_in)),
...
bool StructTraits<::media::stable::mojom::EosVideoFrameData::DataView, ::media::stable::mojom::EosVideoFrameDataPtr>::Read(
    ::media::stable::mojom::EosVideoFrameData::DataView input,
    ::media::stable::mojom::EosVideoFrameDataPtr* output) {
  bool success = true;
...
bool StructTraits<::media::stable::mojom::GpuMemoryBufferVideoFrameData::DataView, ::media::stable::mojom::GpuMemoryBufferVideoFrameDataPtr>::Read(
    ::media::stable::mojom::GpuMemoryBufferVideoFrameData::DataView input,
    ::media::stable::mojom::GpuMemoryBufferVideoFrameDataPtr* output) {
  bool success = true;
...
bool UnionTraits<::media::stable::mojom::VideoFrameData::DataView, ::media::stable::mojom::VideoFrameDataPtr>::Read(
    ::media::stable::mojom::VideoFrameData::DataView input,
    ::media::stable::mojom::VideoFrameDataPtr* output) {
