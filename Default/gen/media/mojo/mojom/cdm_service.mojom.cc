    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("factory"), in_factory,
                        "<value of type ::mojo::PendingReceiver<::media::mojom::CdmFactory>>");
      perfetto::WriteIntoTracedValueWithFallback(
...
void CdmServiceInterceptorForTesting::CreateCdmFactory(::mojo::PendingReceiver<::media::mojom::CdmFactory> factory, ::mojo::PendingRemote<::media::mojom::FrameInterfaceFactory> frame_interfaces) {
