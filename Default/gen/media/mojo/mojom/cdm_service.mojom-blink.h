...
// with not having this data in traces there.
  ...
  virtual void CreateCdmFactory(::mojo::PendingReceiver<::media::mojom::blink::CdmFactory> factory, ::mojo::PendingRemote<::media::mojom::blink::FrameInterfaceFactory> frame_interfaces) = 0;
};
...
class BLINK_PLATFORM_EXPORT CdmServiceBroker
...
class BLINK_PLATFORM_EXPORT CdmServiceProxy
 ...
 public:
  ...
  void CreateCdmFactory(::mojo::PendingReceiver<::media::mojom::blink::CdmFactory> factory, ::mojo::PendingRemote<::media::mojom::blink::FrameInterfaceFactory> frame_interfaces) final;
