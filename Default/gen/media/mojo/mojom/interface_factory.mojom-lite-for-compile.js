...
goog.require('media.mojom.FlingingRendererClientExtension');
goog.require('media.mojom.MediaPlayerRendererClientExtension');
goog.require('media.mojom.MediaPlayerRendererExtension');
...
goog.provide('media.mojom.InterfaceFactory_CreateMediaPlayerRenderer_ParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('media.mojom.InterfaceFactory_CreateFlingingRenderer_ParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('media.mojom.InterfaceFactory_CreateMediaPlayerRenderer_Params');
...
goog.provide('media.mojom.InterfaceFactory_CreateFlingingRenderer_Params');
