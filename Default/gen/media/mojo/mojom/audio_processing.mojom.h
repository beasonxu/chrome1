...
struct  StructTraits<::media::mojom::AudioProcessingStats::DataView,
  ...
  static decltype(::media::mojom::AudioProcessingStats::has_echo_return_loss) has_echo_return_loss(
...
struct  StructTraits<::media::mojom::AudioProcessingSettings::DataView,
  ...
  static decltype(::media::mojom::AudioProcessingSettings::high_pass_filter) high_pass_filter(
      const ::media::mojom::AudioProcessingSettingsPtr& input) {
  ...
  static decltype(::media::mojom::AudioProcessingSettings::stereo_mirroring) stereo_mirroring(
      const ::media::mojom::AudioProcessingSettingsPtr& input) {
    return input->stereo_mirroring;
  }

  static decltype(::media::mojom::AudioProcessingSettings::force_apm_creation) force_apm_creation(
      const ::media::mojom::AudioProcessingSettingsPtr& input) {
