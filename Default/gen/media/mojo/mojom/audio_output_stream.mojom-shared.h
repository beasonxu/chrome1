...
struct Serializer<::media::mojom::AudioOutputStreamObserver_DisconnectReason, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    return Traits::FromMojom(::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::media::mojom::AudioOutputStreamObserver_DisconnectReason>(input)), output);
  }
};
...
template <>
struct  TraceFormatTraits<::media::mojom::AudioOutputStreamObserver_DisconnectReason> {
