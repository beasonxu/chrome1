...
struct media_mojom_internal_MediaFoundationRenderingMode_DataHashFn {
  ...
  static bool Equal(const ::media::mojom::MediaFoundationRenderingMode& left, const ::media::mojom::MediaFoundationRenderingMode& right) {
    return left == right;
  }
...
template <>
struct HashTraits<::media::mojom::MediaFoundationRenderingMode>
    : public GenericHashTraits<::media::mojom::MediaFoundationRenderingMode> {
  static_assert(true,
  ...
  static void ConstructDeletedValue(::media::mojom::MediaFoundationRenderingMode& slot, bool) {
    slot = static_cast<::media::mojom::MediaFoundationRenderingMode>(-1000001);
  }
  static bool IsDeletedValue(const ::media::mojom::MediaFoundationRenderingMode& value) {
    return value == static_cast<::media::mojom::MediaFoundationRenderingMode>(-1000001);
  }
};
}  // namespace WTF
...
class BLINK_PLATFORM_EXPORT MediaFoundationRendererObserver
...
class BLINK_PLATFORM_EXPORT MediaFoundationRendererNotifier
