...
// with not having this data in traces there.
  ...
  virtual void CreateVideoDecoder(::mojo::PendingReceiver<::media::mojom::VideoDecoder> video_decoder, ::mojo::PendingRemote<::media::stable::mojom::StableVideoDecoder> dst_video_decoder) = 0;
...
class  InterfaceFactoryProxy
 ...
 public:
  ...
  void CreateVideoDecoder(::mojo::PendingReceiver<::media::mojom::VideoDecoder> video_decoder, ::mojo::PendingRemote<::media::stable::mojom::StableVideoDecoder> dst_video_decoder) final;
