    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("type"), in_type,
                        "<value of type ::media::DemuxerStream::Type>");
      perfetto::WriteIntoTracedValueWithFallback(
...
class DemuxerStream_Read_ProxyToResponder : public ::mojo::internal::ProxyToResponder {
 ...
 private:
  ...
  void Run(
      ::media::DemuxerStream::Status in_status, ::media::mojom::DecoderBufferPtr in_buffer, const absl::optional<::media::AudioDecoderConfig>& in_audio_config, const absl::optional<::media::VideoDecoderConfig>& in_video_config);
};
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("status"), in_status,
                        "<value of type ::media::DemuxerStream::Status>");
      perfetto::WriteIntoTracedValueWithFallback(
...
,
             ...
             const absl::optional<::media::AudioDecoderConfig>& audio_config,
             const absl::optional<::media::VideoDecoderConfig>& video_config) {*out_status = std::move(status);*out_buffer = std::move(buffer);*out_audio_config = std::move(audio_config);*out_video_config = std::move(video_config);
            loop->Quit();
          },
          &loop,
          out_status,
