...
VideoCodecInfo::VideoCodecInfo(
    WTF::Vector<::media::mojom::blink::VideoCodecProfile> supported_profiles_in,
...
CdmCapability::CdmCapability(
    WTF::Vector<::media::mojom::blink::AudioCodec> audio_codecs_in,
...
void KeySystemSupportObserverProxy::OnKeySystemSupportUpdated(
    WTF::HashMap<WTF::String, KeySystemCapabilityPtr> in_key_systems) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
