 ...
 * @const { {$:!mojo.internal.MojomType}}
 */
export const SharedBufferVideoFrameDataSpec =
    { $: /** @type {!mojo.internal.MojomType} */ ({}) };
...
mojo.internal.Struct(
    SharedBufferVideoFrameDataSpec.$,
 ...
 * @record
 */
export class SharedBufferVideoFrameData {
  constructor() {
...
mojo.internal.Union(
    VideoFrameDataSpec.$, 'VideoFrameData',
    {
      ...
      'sharedBufferData': {
        'ordinal': 1,
        'type': SharedBufferVideoFrameDataSpec.$,
      },
      'gpuMemoryBufferData': {
        'ordinal': 2,
 ...
 *   sharedBufferData: (!SharedBufferVideoFrameData|undefined),
