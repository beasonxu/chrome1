...
PictureBufferAssignment::PictureBufferAssignment(
    ...
    std::vector<uint32_t> texture_ids_in)
...
# endif // !BUILDFLAG(IS_FUCHSIA)
bool GpuAcceleratedVideoDecoderProvider::CreateAcceleratedVideoDecoder(const ::media::VideoDecodeAccelerator::Config& config, ::mojo::PendingAssociatedReceiver<GpuAcceleratedVideoDecoder> receiver, ::mojo::PendingAssociatedRemote<GpuAcceleratedVideoDecoderClient> client, bool* out_success) {
  NOTREACHED();
  return false;
}
...
bool GpuAcceleratedVideoDecoderProviderProxy::CreateAcceleratedVideoDecoder(
    const ::media::VideoDecodeAccelerator::Config& param_config, ::mojo::PendingAssociatedReceiver<GpuAcceleratedVideoDecoder> param_receiver, ::mojo::PendingAssociatedRemote<GpuAcceleratedVideoDecoderClient> param_client, bool* out_param_success) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT_BEGIN1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("config"), param_config,
                        "<value of type const ::media::VideoDecodeAccelerator::Config&>");
      perfetto::WriteIntoTracedValueWithFallback(
...
void GpuAcceleratedVideoDecoderProviderProxy::CreateAcceleratedVideoDecoder(
    const ::media::VideoDecodeAccelerator::Config& in_config, ::mojo::PendingAssociatedReceiver<GpuAcceleratedVideoDecoder> in_receiver, ::mojo::PendingAssociatedRemote<GpuAcceleratedVideoDecoderClient> in_client, CreateAcceleratedVideoDecoderCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
bool GpuAcceleratedVideoDecoderProviderStubDispatch::AcceptWithResponder(
  ...
  switch (message->header()->name) {
    case internal::kGpuAcceleratedVideoDecoderProvider_CreateAcceleratedVideoDecoder_Name: {
      ...
      bool success = true;
      ::media::VideoDecodeAccelerator::Config p_config{};
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("buffer"), in_buffer,
                        "<value of type ::media::BitstreamBuffer>");
   });
#endif
...
void GpuAcceleratedVideoDecoderProxy::AssignPictureBuffers(
    std::vector<PictureBufferAssignmentPtr> in_assignments) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("assignments"), in_assignments,
                        "<value of type std::vector<PictureBufferAssignmentPtr>>");
   });
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
bool GpuAcceleratedVideoDecoderStubDispatch::Accept(
  ...
  switch (message->header()->name) {
    case internal::kGpuAcceleratedVideoDecoder_Decode_Name: {
      ...
      bool success = true;
      ::media::BitstreamBuffer p_buffer{};
...
std::move(p_buffer));
    ...
    case internal::kGpuAcceleratedVideoDecoder_AssignPictureBuffers_Name: {
      ...
      bool success = true;
      std::vector<PictureBufferAssignmentPtr> p_assignments{};
...
bool StructTraits<::media::mojom::PictureBufferAssignment::DataView, ::media::mojom::PictureBufferAssignmentPtr>::Read(
    ::media::mojom::PictureBufferAssignment::DataView input,
    ::media::mojom::PictureBufferAssignmentPtr* output) {
  bool success = true;
...
bool StructTraits<::media::mojom::PictureReadyParams::DataView, ::media::mojom::PictureReadyParamsPtr>::Read(
    ::media::mojom::PictureReadyParams::DataView input,
    ::media::mojom::PictureReadyParamsPtr* output) {
  bool success = true;
