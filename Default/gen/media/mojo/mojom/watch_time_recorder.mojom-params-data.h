 ...
 public:
  ...
  ::media::mojom::WatchTimeKey key() const {
    return ::mojo::internal::ToKnownEnumValueHelper(
          static_cast<::media::mojom::WatchTimeKey>(data_->key));
  }
...
class WatchTimeRecorder_FinalizeWatchTime_ParamsDataView {
 public:
  ...
  template <typename UserType>
  [[nodiscard]] bool ReadWatchTimeKeys(UserType* output) {
...
class WatchTimeRecorder_UpdateSecondaryProperties_ParamsDataView {
 public:
  ...
  template <typename UserType>
  [[nodiscard]] bool ReadSecondaryProperties(UserType* output) {
...
class WatchTimeRecorder_UpdateUnderflowDuration_ParamsDataView {
 public:
  ...
  template <typename UserType>
  [[nodiscard]] bool ReadTotalDuration(UserType* output) {
