    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("audio_decoder"), in_audio_decoder,
                        "<value of type ::mojo::PendingReceiver<::media::mojom::blink::AudioDecoder>>");
   });
#endif
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("video_decoder"), in_video_decoder,
                        "<value of type ::mojo::PendingReceiver<::media::mojom::blink::VideoDecoder>>");
      perfetto::WriteIntoTracedValueWithFallback(
...
void InterfaceFactoryProxy::CreateAudioEncoder(
    ::mojo::PendingReceiver<::media::mojom::blink::AudioEncoder> in_audio_encoder) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("audio_encoder"), in_audio_encoder,
                        "<value of type ::mojo::PendingReceiver<::media::mojom::blink::AudioEncoder>>");
   });
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("renderer"), in_renderer,
                        "<value of type ::mojo::PendingReceiver<::media::mojom::blink::Renderer>>");
   });
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("client_extension"), in_client_extension,
                        "<value of type ::mojo::PendingRemote<::media::mojom::blink::MediaPlayerRendererClientExtension>>");
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("renderer"), in_renderer,
                        "<value of type ::mojo::PendingReceiver<::media::mojom::blink::Renderer>>");
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("renderer_extension"), in_renderer_extension,
                        "<value of type ::mojo::PendingReceiver<::media::mojom::blink::MediaPlayerRendererExtension>>");
   });
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
void InterfaceFactoryProxy::CreateFlingingRenderer(
  ...
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("client_extension"), in_client_extension,
                        "<value of type ::mojo::PendingRemote<::media::mojom::blink::FlingingRendererClientExtension>>");
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("renderer"), in_renderer,
                        "<value of type ::mojo::PendingReceiver<::media::mojom::blink::Renderer>>");
   });
...
void InterfaceFactoryProxy::CreateCdm(
    ::media::mojom::blink::CdmConfigPtr in_cdm_config, CreateCdmCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("cdm_config"), in_cdm_config,
                        "<value of type ::media::mojom::blink::CdmConfigPtr>");
   });
#endif
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("cdm"), in_cdm,
                        "<value of type ::mojo::PendingRemote<::media::mojom::blink::ContentDecryptionModule>>");
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("cdm_context"), in_cdm_context,
                        "<value of type ::media::mojom::blink::CdmContextPtr>");
      perfetto::WriteIntoTracedValueWithFallback(
...
void InterfaceFactoryInterceptorForTesting::CreateVideoDecoder(::mojo::PendingReceiver<::media::mojom::blink::VideoDecoder> video_decoder, ::mojo::PendingRemote<::media::stable::mojom::blink::StableVideoDecoder> dst_video_decoder) {
...
void InterfaceFactoryAsyncWaiter::CreateCdm(
  ...
  proxy_->CreateCdm(std::move(cdm_config),
      base::BindOnce(
          [](base::RunLoop* loop,
             ::mojo::PendingRemote<::media::mojom::blink::ContentDecryptionModule>* out_cdm
,
             ::media::mojom::blink::CdmContextPtr* out_cdm_context
,
             WTF::String* out_error_message
,
             ::mojo::PendingRemote<::media::mojom::blink::ContentDecryptionModule> cdm,
             ::media::mojom::blink::CdmContextPtr cdm_context,
