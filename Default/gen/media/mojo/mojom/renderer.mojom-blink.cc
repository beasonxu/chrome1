...
void RendererProxy::Initialize(
    ::mojo::PendingAssociatedRemote<RendererClient> in_client, absl::optional<WTF::Vector<::mojo::PendingRemote<::media::mojom::blink::DemuxerStream>>> in_streams, MediaUrlParamsPtr in_media_url_params, InitializeCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("streams"), in_streams,
                        "<value of type absl::optional<WTF::Vector<::mojo::PendingRemote<::media::mojom::blink::DemuxerStream>>>>");
      perfetto::WriteIntoTracedValueWithFallback(
