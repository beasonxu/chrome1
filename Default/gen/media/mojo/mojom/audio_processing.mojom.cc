...
bool StructTraits<::media::mojom::AudioProcessingStats::DataView, ::media::mojom::AudioProcessingStatsPtr>::Read(
    ::media::mojom::AudioProcessingStats::DataView input,
    ::media::mojom::AudioProcessingStatsPtr* output) {
  bool success = true;
...
bool StructTraits<::media::mojom::AudioProcessingSettings::DataView, ::media::mojom::AudioProcessingSettingsPtr>::Read(
    ::media::mojom::AudioProcessingSettings::DataView input,
    ::media::mojom::AudioProcessingSettingsPtr* output) {
  bool success = true;
...
bool StructTraits<::media::mojom::AudioProcessingConfig::DataView, ::media::mojom::AudioProcessingConfigPtr>::Read(
    ::media::mojom::AudioProcessingConfig::DataView input,
    ::media::mojom::AudioProcessingConfigPtr* output) {
  bool success = true;
