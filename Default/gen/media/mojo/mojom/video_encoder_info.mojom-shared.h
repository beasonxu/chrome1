...
class VideoEncoderInfoDataView {
 public:
  ...
  template <typename UserType>
  [[nodiscard]] bool ReadResolutionBitrateLimits(UserType* output) {
...
struct Serializer<::media::mojom::ResolutionBitrateLimitDataView, MaybeConstUserType> {
  ...
  static void Serialize(
      ...
      mojo::internal::MessageFragment<::media::mojom::internal::ResolutionBitrateLimit_Data>& fragment) {
...
struct Serializer<::media::mojom::VideoEncoderInfoDataView, MaybeConstUserType> {
  ...
  static void Serialize(
    ...
    mojo::internal::MessageFragment<
        typename decltype(fragment->resolution_bitrate_limits)::BaseType>
        resolution_bitrate_limits_fragment(fragment.message());
    ...
    fragment->resolution_bitrate_limits.Set(
        resolution_bitrate_limits_fragment.is_null() ? nullptr : resolution_bitrate_limits_fragment.data());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        fragment->resolution_bitrate_limits.is_null(),
        mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER,
