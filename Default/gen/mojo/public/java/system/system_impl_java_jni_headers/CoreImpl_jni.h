...
JNI_GENERATOR_EXPORT jlong Java_J_N_MDMdj6cc(
    ...
    jclass jcaller,
    jint fd) {
  return JNI_CoreImpl_CreatePlatformHandle(env, fd);
}
...
static base::android::ScopedJavaLocalRef<jobject> Java_CoreImpl_newReadMessageResult(JNIEnv* env,
    ...
    const base::android::JavaRef<jlongArray>& rawHandles) {
  jclass clazz = org_chromium_mojo_system_impl_CoreImpl_clazz(env);
  CHECK_CLAZZ(env, clazz,
      org_chromium_mojo_system_impl_CoreImpl_clazz(env), NULL);
  ...
  call_context.Init<
      base::android::MethodID::TYPE_STATIC>(
          ...
          "(I[B[J)Lorg/chromium/mojo/system/ResultAnd;",
...
static std::atomic<jmethodID> g_org_chromium_mojo_system_impl_CoreImpl_newResultAndLong(nullptr);
static base::android::ScopedJavaLocalRef<jobject> Java_CoreImpl_newResultAndLong(JNIEnv* env,
    JniIntWrapper mojoResult,
    jlong value) {
  jclass clazz = org_chromium_mojo_system_impl_CoreImpl_clazz(env);
  CHECK_CLAZZ(env, clazz,
  ...
  call_context.Init<
      base::android::MethodID::TYPE_STATIC>(
          ...
          clazz,
          "newResultAndLong",
          "(IJ)Lorg/chromium/mojo/system/ResultAnd;",
          &g_org_chromium_mojo_system_impl_CoreImpl_newResultAndLong);

  jobject ret =
      env->CallStaticObjectMethod(clazz,
          call_context.base.method_id, as_jint(mojoResult), value);
  return base::android::ScopedJavaLocalRef<jobject>(env, ret);
}
...
static base::android::ScopedJavaLocalRef<jobject> Java_CoreImpl_newNativeCreationResult(JNIEnv* env,
  ...
  call_context.Init<
      base::android::MethodID::TYPE_STATIC>(
          ...
          "(IJJ)Lorg/chromium/mojo/system/ResultAnd;",
          &g_org_chromium_mojo_system_impl_CoreImpl_newNativeCreationResult);

  jobject ret =
      env->CallStaticObjectMethod(clazz,
          call_context.base.method_id, as_jint(mojoResult), mojoHandle1, mojoHandle2);
  return base::android::ScopedJavaLocalRef<jobject>(env, ret);
}
