...
~ChromeBuildProto() override;
explicit PROTOBUF_CONSTEXPR ChromeBuildProto(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
PROTOBUF_NOINLINE void Swap(ChromeBuildProto* other) {
...
ChromeBuildProto* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
PROTOBUF_NOINLINE void Swap(AndroidCheckinProto* other) {
if (other == this) return;
#ifdef PROTOBUF_FORCE_COPY_IN_SWAP
if (GetOwningArena() != nullptr &&
GetOwningArena() == other->GetOwningArena()) {
...
template <typename ArgT0 = const std::string&, typename... ArgT>
void set_cell_operator(ArgT0&& arg0, ArgT... args);
std::string* mutable_cell_operator();
PROTOBUF_NODISCARD std::string* release_cell_operator();
void set_allocated_cell_operator(std::string* cell_operator);
private:
const std::string& _internal_cell_operator() const;
inline PROTOBUF_ALWAYS_INLINE void _internal_set_cell_operator(const std::string& value);
...
template <typename ArgT0 = const std::string&, typename... ArgT>
void set_sim_operator(ArgT0&& arg0, ArgT... args);
std::string* mutable_sim_operator();
PROTOBUF_NODISCARD std::string* release_sim_operator();
void set_allocated_sim_operator(std::string* sim_operator);
private:
const std::string& _internal_sim_operator() const;
inline PROTOBUF_ALWAYS_INLINE void _internal_set_sim_operator(const std::string& value);
...
PROTOBUF_NODISCARD ::checkin_proto::ChromeBuildProto* release_chrome_build();
...
int64_t last_checkin_msec() const;
void set_last_checkin_msec(int64_t value);
private:
int64_t _internal_last_checkin_msec() const;
void _internal_set_last_checkin_msec(int64_t value);
public:
...
int32_t user_number() const;
void set_user_number(int32_t value);
private:
int32_t _internal_user_number() const;
void _internal_set_user_number(int32_t value);
public:
...
_has_bits_[0] |= 0x00000001u;
cell_operator_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
std::string* _s = _internal_mutable_cell_operator();
...
_has_bits_[0] |= 0x00000001u;
cell_operator_.Set(value, GetArenaForAllocation());
}
inline std::string* AndroidCheckinProto::_internal_mutable_cell_operator() {
_has_bits_[0] |= 0x00000001u;
return cell_operator_.Mutable(GetArenaForAllocation());
}
...
_has_bits_[0] &= ~0x00000001u;
auto* p = cell_operator_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
if (cell_operator_.IsDefault()) {
...
cell_operator_.SetAllocated(cell_operator, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
if (cell_operator_.IsDefault()) {
cell_operator_.Set("", GetArenaForAllocation());
}
...
_has_bits_[0] |= 0x00000002u;
sim_operator_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
std::string* _s = _internal_mutable_sim_operator();
...
_has_bits_[0] |= 0x00000002u;
sim_operator_.Set(value, GetArenaForAllocation());
}
inline std::string* AndroidCheckinProto::_internal_mutable_sim_operator() {
_has_bits_[0] |= 0x00000002u;
return sim_operator_.Mutable(GetArenaForAllocation());
}
...
_has_bits_[0] &= ~0x00000002u;
auto* p = sim_operator_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
if (sim_operator_.IsDefault()) {
...
sim_operator_.SetAllocated(sim_operator, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
if (sim_operator_.IsDefault()) {
sim_operator_.Set("", GetArenaForAllocation());
}
...
_has_bits_[0] |= 0x00000004u;
roaming_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
_has_bits_[0] |= 0x00000004u;
roaming_.Set(value, GetArenaForAllocation());
}
inline std::string* AndroidCheckinProto::_internal_mutable_roaming() {
_has_bits_[0] |= 0x00000004u;
return roaming_.Mutable(GetArenaForAllocation());
}
...
_has_bits_[0] &= ~0x00000004u;
auto* p = roaming_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
if (roaming_.IsDefault()) {
...
roaming_.SetAllocated(roaming, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
if (roaming_.IsDefault()) {
roaming_.Set("", GetArenaForAllocation());
}
...
auto* p = CreateMaybeMessage<::checkin_proto::ChromeBuildProto>(GetArenaForAllocation());
chrome_build_ = p;
}
return chrome_build_;
}
inline ::checkin_proto::ChromeBuildProto* AndroidCheckinProto::mutable_chrome_build() {
::checkin_proto::ChromeBuildProto* _msg = _internal_mutable_chrome_build();
...
::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(chrome_build);
