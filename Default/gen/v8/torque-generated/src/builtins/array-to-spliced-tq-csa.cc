...
TNode<JSArray> CopyFastPackedArrayForToSpliced_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, ElementsKind p_kind, TNode<JSArray> p_array, TNode<Smi> p_newLenSmi, TNode<Smi> p_actualStartSmi, TNode<Smi> p_insertCountSmi, TNode<Smi> p_actualDeleteCountSmi) {
  ...
  if (block0.is_used()) {
    ...
    tmp4 = CodeStubAssembler(state_).AllocateFixedArray(p_kind, TNode<IntPtrT>{tmp0}, CodeStubAssembler::AllocationFlag::kNone);
    tmp5 = FromConstexpr_intptr_constexpr_int31_0(state_, 8);
    tmp6 = CodeStubAssembler(state_).LoadReference<FixedArrayBase>(CodeStubAssembler::Reference{p_array, tmp5});
    ...
    CodeStubAssembler(state_).CopyElements(p_kind, TNode<FixedArrayBase>{tmp4}, TNode<IntPtrT>{tmp7}, TNode<FixedArrayBase>{tmp6}, TNode<IntPtrT>{tmp8}, TNode<IntPtrT>{tmp1});
    tmp9 = FromConstexpr_intptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull));
    tmp10 = CodeStubAssembler(state_).IntPtrGreaterThan(TNode<IntPtrT>{tmp2}, TNode<IntPtrT>{tmp9});
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    tmp11 = UnsafeCast_FixedDoubleArray_0(state_, TNode<Context>{p_context}, TNode<Object>{tmp4});
    CodeStubAssembler(state_).FillFixedDoubleArrayWithZero(TNode<FixedDoubleArray>{tmp11}, TNode<IntPtrT>{tmp1}, TNode<IntPtrT>{tmp2});
    ca_.Goto(&block6);
  }
  ...
  if (block5.is_used()) {
    ca_.Bind(&block5);
    tmp12 = UnsafeCast_FixedArray_0(state_, TNode<Context>{p_context}, TNode<Object>{tmp4});
    CodeStubAssembler(state_).FillFixedArrayWithSmiZero(p_kind, TNode<FixedArray>{tmp12}, TNode<IntPtrT>{tmp1}, TNode<IntPtrT>{tmp2});
    ca_.Goto(&block6);
  }
  ...
  if (block3.is_used()) {
    ca_.Bind(&block3);
    tmp13 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{tmp1}, TNode<IntPtrT>{tmp2});
    tmp14 = CodeStubAssembler(state_).IntPtrSub(TNode<IntPtrT>{tmp0}, TNode<IntPtrT>{tmp13});
    tmp15 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{tmp1}, TNode<IntPtrT>{tmp3});
    tmp16 = FromConstexpr_intptr_constexpr_int31_0(state_, 8);
    tmp17 = CodeStubAssembler(state_).LoadReference<FixedArrayBase>(CodeStubAssembler::Reference{p_array, tmp16});
    CodeStubAssembler(state_).CopyElements(p_kind, TNode<FixedArrayBase>{tmp4}, TNode<IntPtrT>{tmp13}, TNode<FixedArrayBase>{tmp17}, TNode<IntPtrT>{tmp15}, TNode<IntPtrT>{tmp14});
    tmp18 = CodeStubAssembler(state_).LoadNativeContext(TNode<Context>{p_context});
    tmp19 = CodeStubAssembler(state_).LoadJSArrayElementsMap(p_kind, TNode<NativeContext>{tmp18});
    tmp20 = NewJSArray_0(state_, TNode<Context>{p_context}, TNode<Map>{tmp19}, TNode<FixedArrayBase>{tmp4});
    ca_.Goto(&block11);
  }
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/array-to-spliced.tq?l=47&c=1
...
// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/array-to-spliced.tq?l=106&c=1
...
TF_BUILTIN(ArrayPrototypeToSpliced, CodeStubAssembler) {
  ...
  compiler::CodeAssemblerParameterizedLabel<Smi, Number, Smi, Number> block18(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Smi, Number, Smi, Number> block17(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0);
  ...
  if (block14.is_used()) {
    ...
    tmp37 = TryFastArrayToSpliced_0(state_, TNode<Context>{parameter0}, TorqueStructArguments{TNode<RawPtrT>{torque_arguments.frame}, TNode<RawPtrT>{torque_arguments.base}, TNode<IntPtrT>{torque_arguments.length}, TNode<IntPtrT>{torque_arguments.actual_count}}, TNode<JSReceiver>{tmp4}, TNode<Number>{tmp5}, TNode<Number>{tmp30}, TNode<Number>{phi_bb3_11}, TNode<Smi>{phi_bb14_12}, TNode<Number>{phi_bb14_13}, &label38);
    ca_.Goto(&block17, phi_bb14_12, phi_bb14_13, phi_bb14_12, phi_bb14_13);
    if (label38.is_used()) {
      ca_.Bind(&label38);
      ca_.Goto(&block18, phi_bb14_12, phi_bb14_13, phi_bb14_12, phi_bb14_13);
    }
  }

  TNode<Smi> phi_bb18_12;
  TNode<Number> phi_bb18_13;
  TNode<Smi> phi_bb18_23;
  TNode<Number> phi_bb18_24;
  TNode<JSArray> tmp39;
  if (block18.is_used()) {
    ca_.Bind(&block18, &phi_bb18_12, &phi_bb18_13, &phi_bb18_23, &phi_bb18_24);
    tmp39 = GenericArrayToSpliced_0(state_, TNode<Context>{parameter0}, TorqueStructArguments{TNode<RawPtrT>{torque_arguments.frame}, TNode<RawPtrT>{torque_arguments.base}, TNode<IntPtrT>{torque_arguments.length}, TNode<IntPtrT>{torque_arguments.actual_count}}, TNode<JSReceiver>{tmp4}, TNode<Number>{tmp30}, TNode<Number>{phi_bb3_11}, TNode<Number>{phi_bb18_13});
    arguments.PopAndReturn(tmp39);
  }

  TNode<Smi> phi_bb17_12;
  TNode<Number> phi_bb17_13;
  TNode<Smi> phi_bb17_23;
  TNode<Number> phi_bb17_24;
  if (block17.is_used()) {
    ca_.Bind(&block17, &phi_bb17_12, &phi_bb17_13, &phi_bb17_23, &phi_bb17_24);
    arguments.PopAndReturn(tmp37);
  }
}

// https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/array-to-spliced.tq?l=96&c=5
