...
#define DEFINE_TORQUE_GENERATED_FEEDBACK_VECTOR_FLAGS() \
  ...
  using MaybeHasOptimizedCodeBit = base::BitField<bool, 3, 1, uint16_t>; \
  using OsrTieringStateBit = base::BitField<TieringState, 4, 1, uint16_t>; \
  using AllYourBitsAreBelongToJgruberBits = base::BitField<uint32_t, 5, 11, uint16_t>; \
