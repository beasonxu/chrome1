...
class V8_EXPORT_PRIVATE TorqueGeneratedExportedMacrosAssembler {
 public:
  ...
  TNode<ExternalPointerT> LoadCallHandlerInfoCallback(TNode<CallHandlerInfo> p_o);
  // https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/api-callbacks.tq?l=7&c=3
  void StoreCallHandlerInfoCallback(TNode<CallHandlerInfo> p_o, TNode<ExternalPointerT> p_v);
  // https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/api-callbacks.tq?l=10&c=3
  TNode<ExternalPointerT> LoadCallHandlerInfoJsCallback(TNode<CallHandlerInfo> p_o);
  // https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/api-callbacks.tq?l=10&c=3
  void StoreCallHandlerInfoJsCallback(TNode<CallHandlerInfo> p_o, TNode<ExternalPointerT> p_v);
  ...
  TNode<ExternalPointerT> LoadAccessorInfoJsGetter(TNode<AccessorInfo> p_o);
  // https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/api-callbacks.tq?l=60&c=3
  void StoreAccessorInfoJsGetter(TNode<AccessorInfo> p_o, TNode<ExternalPointerT> p_v);
