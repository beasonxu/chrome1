...
class TqCallHandlerInfo : public TqHeapObject {
 public:
  ...
  Value<ExternalPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> GetJsCallbackValue(d::MemoryAccessor accessor ) const;
};
...
class TqAccessorInfo : public TqHeapObject {
 public:
  ...
  Value<ExternalPointer_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> GetJsGetterValue(d::MemoryAccessor accessor ) const;
  uintptr_t GetFlagsAddress() const;
  Value<uint32_t /*Failing? Ensure constexpr type name is correct, and the necessary #include is in any .tq file*/> GetFlagsValue(d::MemoryAccessor accessor ) const;
};
