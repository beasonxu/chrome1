...
class COMPONENT_EXPORT(DEVICE_VR_TEST_MOJO_BINDINGS_BLINK) XRTestHookInterceptorForTesting : public XRTestHook {
  ...
  void OnFrameSubmitted(WTF::Vector<ViewDataPtr> frame_data, OnFrameSubmittedCallback callback) override;
  ...
  void WaitGetCanCreateSession(WaitGetCanCreateSessionCallback callback) override;
};
class COMPONENT_EXPORT(DEVICE_VR_TEST_MOJO_BINDINGS_BLINK) XRTestHookAsyncWaiter {
 public:
  ...
  XRTestHookAsyncWaiter(const XRTestHookAsyncWaiter&) = delete;
  XRTestHookAsyncWaiter& operator=(const XRTestHookAsyncWaiter&) = delete;
...
class COMPONENT_EXPORT(DEVICE_VR_TEST_MOJO_BINDINGS_BLINK) XRServiceTestHookAsyncWaiter {
 public:
  ...
  XRServiceTestHookAsyncWaiter(const XRServiceTestHookAsyncWaiter&) = delete;
  XRServiceTestHookAsyncWaiter& operator=(const XRServiceTestHookAsyncWaiter&) = delete;
