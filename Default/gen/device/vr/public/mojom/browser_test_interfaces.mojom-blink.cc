...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type WTF::Vector<ControllerAxisDataPtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
bool XRTestHookStubDispatch::AcceptWithResponder(
  ...
  switch (message->header()->name) {
    case internal::kXRTestHook_OnFrameSubmitted_Name: {
      ...
      bool success = true;
      WTF::Vector<ViewDataPtr> p_frame_data{};
...
bool StructTraits<::device_test::mojom::blink::ViewData::DataView, ::device_test::mojom::blink::ViewDataPtr>::Read(
  ...
  bool success = true;
  ::device_test::mojom::blink::ViewDataPtr result(::device_test::mojom::blink::ViewData::New());
