...
class COMPONENT_EXPORT(DEVICE_VR_SERVICE_MOJO_BINDINGS) XRInputSourceButtonListenerInterceptorForTesting : public XRInputSourceButtonListener {
...
class COMPONENT_EXPORT(DEVICE_VR_SERVICE_MOJO_BINDINGS) XRInputSourceButtonListenerAsyncWaiter {
 public:
