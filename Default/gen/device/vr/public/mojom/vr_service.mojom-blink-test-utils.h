...
class COMPONENT_EXPORT(DEVICE_VR_SERVICE_MOJO_BINDINGS_BLINK) XREnvironmentIntegrationProviderInterceptorForTesting : public XREnvironmentIntegrationProvider {
  ...
  void CreateAnchor(XRNativeOriginInformationPtr native_origin_information, const ::device::Pose& native_origin_from_anchor, CreateAnchorCallback callback) override;
  void CreatePlaneAnchor(XRNativeOriginInformationPtr native_origin_information, const ::device::Pose& native_origin_from_anchor, uint64_t plane_id, CreatePlaneAnchorCallback callback) override;
...
class COMPONENT_EXPORT(DEVICE_VR_SERVICE_MOJO_BINDINGS_BLINK) XRInputSourceButtonListenerInterceptorForTesting : public XRInputSourceButtonListener {
...
class COMPONENT_EXPORT(DEVICE_VR_SERVICE_MOJO_BINDINGS_BLINK) XRInputSourceButtonListenerAsyncWaiter {
 public:
  explicit XRInputSourceButtonListenerAsyncWaiter(XRInputSourceButtonListener* proxy);

  XRInputSourceButtonListenerAsyncWaiter(const XRInputSourceButtonListenerAsyncWaiter&) = delete;
  XRInputSourceButtonListenerAsyncWaiter& operator=(const XRInputSourceButtonListenerAsyncWaiter&) = delete;
