...
class CallStackProfile final :
 ...
 public:
  ...
  private:
  bool _internal_has_profile_start_time_offset_ms() const;
  public:
  void clear_profile_start_time_offset_ms();
  int64_t profile_start_time_offset_ms() const;
  void set_profile_start_time_offset_ms(int64_t value);
  private:
  int64_t _internal_profile_start_time_offset_ms() const;
  void _internal_set_profile_start_time_offset_ms(int64_t value);
  public:
 ...
 private:
  ...
  int64_t profile_start_time_offset_ms_;
  friend struct ::TableStruct_call_5fstack_5fprofile_2eproto;
};
// ===================================================================
...
// optional int64 profile_start_time_offset_ms = 10;
inline bool CallStackProfile::_internal_has_profile_start_time_offset_ms() const {
  bool value = (_has_bits_[0] & 0x00000004u) != 0;
  return value;
}
inline bool CallStackProfile::has_profile_start_time_offset_ms() const {
  return _internal_has_profile_start_time_offset_ms();
}
inline void CallStackProfile::clear_profile_start_time_offset_ms() {
  profile_start_time_offset_ms_ = int64_t{0};
  _has_bits_[0] &= ~0x00000004u;
}
inline int64_t CallStackProfile::_internal_profile_start_time_offset_ms() const {
  return profile_start_time_offset_ms_;
}
inline int64_t CallStackProfile::profile_start_time_offset_ms() const {
  // @@protoc_insertion_point(field_get:metrics.CallStackProfile.profile_start_time_offset_ms)
  return _internal_profile_start_time_offset_ms();
}
inline void CallStackProfile::_internal_set_profile_start_time_offset_ms(int64_t value) {
  _has_bits_[0] |= 0x00000004u;
  profile_start_time_offset_ms_ = value;
}
inline void CallStackProfile::set_profile_start_time_offset_ms(int64_t value) {
  _internal_set_profile_start_time_offset_ms(value);
