...
static ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<std::string> OmniboxEventProto_Suggestion_ResultType_strings[33] = {};
...
static const ::PROTOBUF_NAMESPACE_ID::internal::EnumEntry OmniboxEventProto_Suggestion_ResultType_entries[] = {
  ...
  { {OmniboxEventProto_Suggestion_ResultType_names + 230, 12}, 25 },
  { {OmniboxEventProto_Suggestion_ResultType_names + 242, 21}, 26 },
  { {OmniboxEventProto_Suggestion_ResultType_names + 263, 14}, 8 },
  { {OmniboxEventProto_Suggestion_ResultType_names + 277, 19}, 10 },
  { {OmniboxEventProto_Suggestion_ResultType_names + 296, 14}, 9 },
  { {OmniboxEventProto_Suggestion_ResultType_names + 310, 21}, 22 },
  { {OmniboxEventProto_Suggestion_ResultType_names + 331, 21}, 14 },
  { {OmniboxEventProto_Suggestion_ResultType_names + 352, 27}, 16 },
  { {OmniboxEventProto_Suggestion_ResultType_names + 379, 22}, 17 },
  { {OmniboxEventProto_Suggestion_ResultType_names + 401, 19}, 15 },
  { {OmniboxEventProto_Suggestion_ResultType_names + 420, 21}, 7 },
  { {OmniboxEventProto_Suggestion_ResultType_names + 441, 15}, 30 },
  { {OmniboxEventProto_Suggestion_ResultType_names + 456, 19}, 0 },
  { {OmniboxEventProto_Suggestion_ResultType_names + 475, 18}, 1 },
};

static const int OmniboxEventProto_Suggestion_ResultType_entries_by_number[] = {
  31, // 0 -> UNKNOWN_RESULT_TYPE
  32, // 1 -> URL_WHAT_YOU_TYPED
  14, // 2 -> HISTORY_URL
  13, // 3 -> HISTORY_TITLE
  10, // 4 -> HISTORY_BODY
  12, // 5 -> HISTORY_KEYWORD
  16, // 6 -> NAVSUGGEST
  29, // 7 -> SEARCH_WHAT_YOU_TYPED
  21, // 8 -> SEARCH_HISTORY
  23, // 9 -> SEARCH_SUGGEST
  22, // 10 -> SEARCH_OTHER_ENGINE
  9, // 11 -> EXTENSION_APP
  7, // 12 -> CONTACT
  2, // 13 -> BOOKMARK_TITLE
  25, // 14 -> SEARCH_SUGGEST_ENTITY
  28, // 15 -> SEARCH_SUGGEST_TAIL
  26, // 16 -> SEARCH_SUGGEST_PERSONALIZED
  27, // 17 -> SEARCH_SUGGEST_PROFILE
  1, // 18 -> APP_RESULT
  0, // 19 -> APP
  15, // 20 -> LEGACY_ON_DEVICE
  17, // 21 -> NAVSUGGEST_PERSONALIZED
  24, // 22 -> SEARCH_SUGGEST_ANSWER
  3, // 23 -> CALCULATOR
  6, // 24 -> CLIPBOARD_URL
  19, // 25 -> PHYSICAL_WEB
  20, // 26 -> PHYSICAL_WEB_OVERFLOW
  8, // 27 -> DOCUMENT
  5, // 28 -> CLIPBOARD_TEXT
  4, // 29 -> CLIPBOARD_IMAGE
  30, // 30 -> TILE_SUGGESTION
...
const std::string& OmniboxEventProto_Suggestion_ResultType_Name(
  ...
  static const bool dummy =
      ::PROTOBUF_NAMESPACE_ID::internal::InitializeEnumStrings(
          ...
          33, OmniboxEventProto_Suggestion_ResultType_strings);
  (void) dummy;
...
bool OmniboxEventProto_Suggestion_ResultType_Parse(
  ...
  bool success = ::PROTOBUF_NAMESPACE_ID::internal::LookUpEnumValue(
      OmniboxEventProto_Suggestion_ResultType_entries, 33, name, &int_value);
  if (success) {
...
static const ::PROTOBUF_NAMESPACE_ID::internal::EnumEntry OmniboxEventProto_PageClassification_entries[] = {
  { {OmniboxEventProto_PageClassification_names + 0, 24}, 21 },
  { {OmniboxEventProto_PageClassification_names + 24, 21}, 16 },
  { {OmniboxEventProto_PageClassification_names + 45, 24}, 19 },
  { {OmniboxEventProto_PageClassification_names + 69, 8}, 10 },
  { {OmniboxEventProto_PageClassification_names + 77, 8}, 12 },
  { {OmniboxEventProto_PageClassification_names + 85, 10}, 11 },
  { {OmniboxEventProto_PageClassification_names + 95, 5}, 2 },
  { {OmniboxEventProto_PageClassification_names + 100, 17}, 14 },
  { {OmniboxEventProto_PageClassification_names + 117, 9}, 3 },
  { {OmniboxEventProto_PageClassification_names + 126, 42}, 8 },
  { {OmniboxEventProto_PageClassification_names + 168, 42}, 7 },
  { {OmniboxEventProto_PageClassification_names + 210, 12}, 0 },
  { {OmniboxEventProto_PageClassification_names + 222, 3}, 1 },
  { {OmniboxEventProto_PageClassification_names + 225, 11}, 15 },
  { {OmniboxEventProto_PageClassification_names + 236, 16}, 20 },
  { {OmniboxEventProto_PageClassification_names + 252, 20}, 5 },
  { {OmniboxEventProto_PageClassification_names + 272, 5}, 4 },
  { {OmniboxEventProto_PageClassification_names + 277, 18}, 23 },
  { {OmniboxEventProto_PageClassification_names + 295, 31}, 13 },
  { {OmniboxEventProto_PageClassification_names + 326, 48}, 6 },
  { {OmniboxEventProto_PageClassification_names + 374, 45}, 9 },
  { {OmniboxEventProto_PageClassification_names + 419, 16}, 22 },
  { {OmniboxEventProto_PageClassification_names + 435, 22}, 17 },
  { {OmniboxEventProto_PageClassification_names + 457, 21}, 18 },
};
...
static const int OmniboxEventProto_PageClassification_entries_by_number[] = {
  ...
  9, // 8 -> INSTANT_NTP_WITH_FAKEBOX_AS_STARTING_FOCUS
...
constexpr OmniboxEventProto_PageClassification OmniboxEventProto::ANDROID_AUXILIARY_SEARCH;
...
static ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<std::string> OmniboxEventProto_ProviderType_strings[23] = {};
...
static const ::PROTOBUF_NAMESPACE_ID::internal::EnumEntry OmniboxEventProto_ProviderType_entries[] = {
  ...
  { {OmniboxEventProto_ProviderType_names + 175, 12}, 15 },
  { {OmniboxEventProto_ProviderType_names + 187, 10}, 19 },
  { {OmniboxEventProto_ProviderType_names + 197, 6}, 4 },
  { {OmniboxEventProto_ProviderType_names + 203, 9}, 7 },
  { {OmniboxEventProto_ProviderType_names + 212, 16}, 0 },
  { {OmniboxEventProto_ProviderType_names + 228, 12}, 11 },
  { {OmniboxEventProto_ProviderType_names + 240, 26}, 18 },
};

static const int OmniboxEventProto_ProviderType_entries_by_number[] = {
  20, // 0 -> UNKNOWN_PROVIDER
  10, // 1 -> HISTORY_URL
  ...
  22, // 18 -> ZERO_SUGGEST_LOCAL_HISTORY
  17, // 19 -> QUERY_TILE
...
const std::string& OmniboxEventProto_ProviderType_Name(
  ...
  static const bool dummy =
      ::PROTOBUF_NAMESPACE_ID::internal::InitializeEnumStrings(
          ...
          23, OmniboxEventProto_ProviderType_strings);
  (void) dummy;
  int idx = ::PROTOBUF_NAMESPACE_ID::internal::LookUpEnumName(
      OmniboxEventProto_ProviderType_entries,
      OmniboxEventProto_ProviderType_entries_by_number,
...
bool OmniboxEventProto_ProviderType_Parse(
  ...
  int int_value;
  bool success = ::PROTOBUF_NAMESPACE_ID::internal::LookUpEnumValue(
      OmniboxEventProto_ProviderType_entries, 23, name, &int_value);
  if (success) {
...
// @@protoc_insertion_point(class_specific_merge_from_start:metrics.OmniboxEventProto.Suggestion)
  ...
  if (cached_has_bits & 0x00000100u) {
    _internal_set_result_subtype_identifier(from._internal_result_subtype_identifier());
  }
  _internal_metadata_.MergeFrom<std::string>(from._internal_metadata_);
}
...
void OmniboxEventProto_Suggestion::InternalSwap(OmniboxEventProto_Suggestion* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      ...
      - PROTOBUF_FIELD_OFFSET(OmniboxEventProto_Suggestion, provider_)>(
    ...
    switch (tag >> 3) {
      ...
      case 22:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 176)) {
          ...
          do {
            ptr += 2;
            _internal_add_feature_triggered_in_session(::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr));
            CHK_(ptr);
            if (!ctx->DataAvailable(ptr)) break;
          } while (::PROTOBUF_NAMESPACE_ID::internal::ExpectTag<176>(ptr));
        } else if (static_cast<uint8_t>(tag) == 178) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::PackedInt32Parser(_internal_mutable_feature_triggered_in_session(), ptr, ctx);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* OmniboxEventProto::_InternalSerialize(
  ...
  for (int i = 0, n = this->_internal_feature_triggered_in_session_size(); i < n; i++) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt32ToArray(22, this->_internal_feature_triggered_in_session(i), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:metrics.OmniboxEventProto)
  ...
  // repeated int32 feature_triggered_in_session = 22;
  {
    ...
    total_size += 2 *
                  ::_pbi::FromIntSize(this->_internal_feature_triggered_in_session_size());
    total_size += data_size;
  }
...
void OmniboxEventProto::InternalSwap(OmniboxEventProto* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      ...
      - PROTOBUF_FIELD_OFFSET(OmniboxEventProto, time_sec_)>(
