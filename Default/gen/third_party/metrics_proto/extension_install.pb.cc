...
static ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<std::string> ExtensionInstallProto_DisableReason_strings[17] = {};
...
static const ::PROTOBUF_NAMESPACE_ID::internal::EnumEntry ExtensionInstallProto_DisableReason_entries[] = {
  ...
  { {ExtensionInstallProto_DisableReason_names + 144, 9}, 16 },
  { {ExtensionInstallProto_DisableReason_names + 153, 6}, 2 },
  { {ExtensionInstallProto_DisableReason_names + 159, 14}, 9 },
  { {ExtensionInstallProto_DisableReason_names + 173, 16}, 4 },
  { {ExtensionInstallProto_DisableReason_names + 189, 17}, 5 },
  { {ExtensionInstallProto_DisableReason_names + 206, 23}, 3 },
  { {ExtensionInstallProto_DisableReason_names + 229, 25}, 11 },
  { {ExtensionInstallProto_DisableReason_names + 254, 11}, 0 },
};
...
static const int ExtensionInstallProto_DisableReason_entries_by_number[] = {
  ...
  10, // 2 -> RELOAD
  14, // 3 -> UNSUPPORTED_REQUIREMENT
  12, // 4 -> SIDELOAD_WIPEOUT
  13, // 5 -> UNKNOWN_FROM_SYNC
  7, // 6 -> NOT_VERIFIED
  4, // 7 -> GREYLIST
  1, // 8 -> CORRUPTED
  11, // 9 -> REMOTE_INSTALL
  3, // 10 -> EXTERNAL_EXTENSION
  15, // 11 -> UPDATE_REQUIRED_BY_POLICY
...
const std::string& ExtensionInstallProto_DisableReason_Name(
  ...
  static const bool dummy =
      ::PROTOBUF_NAMESPACE_ID::internal::InitializeEnumStrings(
          ...
          17, ExtensionInstallProto_DisableReason_strings);
  (void) dummy;
  int idx = ::PROTOBUF_NAMESPACE_ID::internal::LookUpEnumName(
      ExtensionInstallProto_DisableReason_entries,
      ExtensionInstallProto_DisableReason_entries_by_number,
...
bool ExtensionInstallProto_DisableReason_Parse(
  ...
  int int_value;
  bool success = ::PROTOBUF_NAMESPACE_ID::internal::LookUpEnumValue(
      ExtensionInstallProto_DisableReason_entries, 17, name, &int_value);
  if (success) {
