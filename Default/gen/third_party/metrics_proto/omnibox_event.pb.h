...
constexpr OmniboxEventProto_Suggestion_ResultType OmniboxEventProto_Suggestion_ResultType_ResultType_MAX = OmniboxEventProto_Suggestion_ResultType_OPEN_TAB;
...
enum OmniboxEventProto_PageClassification : int {
  ...
  OmniboxEventProto_PageClassification_ANDROID_AUXILIARY_SEARCH = 21,
...
constexpr OmniboxEventProto_ProviderType OmniboxEventProto_ProviderType_ProviderType_MAX = OmniboxEventProto_ProviderType_OPEN_TAB;
...
class OmniboxEventProto_ProviderInfo final :
 ...
 public:
  ...
  public:
  uint32_t field_trial_triggered(int index) const;
  void set_field_trial_triggered(int index, uint32_t value);
  void add_field_trial_triggered(uint32_t value);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField< uint32_t >&
  ...
  public:
  uint32_t field_trial_triggered_in_session(int index) const;
  void set_field_trial_triggered_in_session(int index, uint32_t value);
  void add_field_trial_triggered_in_session(uint32_t value);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField< uint32_t >&
...
class OmniboxEventProto final :
 ...
 public:
  ...
  static constexpr PageClassification ANDROID_AUXILIARY_SEARCH =
    OmniboxEventProto_PageClassification_ANDROID_AUXILIARY_SEARCH;
  ...
  enum : int {
    ...
    kFeatureTriggeredInSessionFieldNumber = 22,
  ...
  private:
  int32_t _internal_feature_triggered_in_session(int index) const;
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >&
      _internal_feature_triggered_in_session() const;
  void _internal_add_feature_triggered_in_session(int32_t value);
  ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >*
      _internal_mutable_feature_triggered_in_session();
  public:
  int32_t feature_triggered_in_session(int index) const;
  void set_feature_triggered_in_session(int index, int32_t value);
  void add_feature_triggered_in_session(int32_t value);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t >&
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedField< int32_t > feature_triggered_in_session_;
  int64_t time_sec_;
  int32_t tab_id_;
...
inline int32_t OmniboxEventProto::_internal_feature_triggered_in_session(int index) const {
  return feature_triggered_in_session_.Get(index);
}
inline int32_t OmniboxEventProto::feature_triggered_in_session(int index) const {
...
inline void OmniboxEventProto::set_feature_triggered_in_session(int index, int32_t value) {
...
inline void OmniboxEventProto::_internal_add_feature_triggered_in_session(int32_t value) {
  feature_triggered_in_session_.Add(value);
}
inline void OmniboxEventProto::add_feature_triggered_in_session(int32_t value) {
...
OmniboxEventProto::_internal_feature_triggered_in_session() const {
...
OmniboxEventProto::feature_triggered_in_session() const {
  ...
  return _internal_feature_triggered_in_session();
}
