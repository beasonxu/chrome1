...
export declare const waitForAndClickTreeElementWithPartialText: (text: string) => Promise<boolean>;
export declare const waitForElementWithPartialText: (text: string) => Promise<puppeteer.ElementHandle<Element> | null>;
export declare const clickTreeElementWithPartialText: (text: string) => Promise<boolean>;
 ...
 */
export declare const getDisplayedCSSPropertyData: (propertiesSection: puppeteer.ElementHandle<Element>) => Promise<{
    propertyName: string | null;
    isOverLoaded: boolean | null;
    isInherited: boolean | null;
}[]>;
...
export declare const getCSSPropertyInRule: (ruleSection: puppeteer.ElementHandle<Element> | string, name: string, sourcePosition?: string) => Promise<puppeteer.ElementHandle<Element> | undefined>;
