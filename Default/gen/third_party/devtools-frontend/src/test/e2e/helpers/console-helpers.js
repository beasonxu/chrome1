...
async function getCurrentConsoleMessages(withAnchor = false, callback) {
    ...
    }, { timeout: 0, polling: 'mutation' }, exports.CONSOLE_FIRST_MESSAGES_SELECTOR));
