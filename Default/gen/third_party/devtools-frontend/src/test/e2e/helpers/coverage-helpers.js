...
exports.getCoverageData = exports.getMessageContents = exports.clearCoverageContent = exports.stopInstrumentingCoverage = exports.startInstrumentingCoverage = exports.navigateToCoverageTestSite = exports.waitForTheCoveragePanelToLoad = void 0;
...
async function getCoverageData(expectedCount) {
    const rows = await (0, helper_js_1.waitForMany)('.data-grid-data-grid-node', expectedCount, await (0, helper_js_1.waitFor)('.coverage-results'));
