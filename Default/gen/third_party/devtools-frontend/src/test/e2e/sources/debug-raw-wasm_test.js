...
(0, mocha_extensions_js_1.describe)('Sources Tab', async function () {
    ...
    beforeEach(async () => {
        ...
        await (0, helper_js_1.installEventListener)(frontend, sources_helpers_js_1.DEBUGGER_PAUSED_EVENT);
    });
    (0, mocha_extensions_js_1.it)('shows the correct wasm source on load and reload', async () => {
        ...
        {
            const capturedFileNames = await (0, sources_helpers_js_1.captureAddedSourceFiles)(2, () => (0, helper_js_1.goToResource)('sources/wasm/call-to-add-wasm.html'));
    ...
    (0, mocha_extensions_js_1.it)('is able to step with state in multi-threaded code in main thread', async () => {
        ...
        await (0, helper_js_1.step)('check non-breakable lines and add a breakpoint to line No.0x060', async () => {
            chai_1.assert.deepEqual(await (0, sources_helpers_js_1.getNonBreakableLines)(), [
                0x000,
                0x03f,
                0x047,
    ...
    (0, mocha_extensions_js_1.it)('is able to step with state in multi-threaded code in worker thread', async () => {
        await (0, helper_js_1.enableExperiment)('instrumentationBreakpoints');
        const { target, frontend } = (0, helper_js_1.getBrowserAndPages)();
        // enableExperiment() reloads the devtools page, so we need to reinstall the listener on the new window.
        await (0, helper_js_1.installEventListener)(frontend, sources_helpers_js_1.DEBUGGER_PAUSED_EVENT);
        ...
        await (0, helper_js_1.step)('add a breakpoint to line No.0x06d', async () => {
            await (0, sources_helpers_js_1.addBreakpointForLine)(frontend, '0x06d');
        });
        await (0, helper_js_1.step)('reload the page', async () => {
            await (0, sources_helpers_js_1.reloadPageAndWaitForSourceFile)(target, fileName);
        });
        await (0, helper_js_1.waitForFunction)(async () => await (0, sources_helpers_js_1.isBreakpointSet)('0x06d'));
        await (0, helper_js_1.step)('check that the code has paused on the breakpoint at the correct script location', async () => {
            const scriptLocation = await (0, sources_helpers_js_1.retrieveTopCallFrameWithoutResuming)();
        ...
        await (0, helper_js_1.step)('remove the breakpoint from line 0x06d', async () => {
            await (0, sources_helpers_js_1.removeBreakpointForLine)(frontend, '0x06d');
        });
        await (0, helper_js_1.step)('add a breakpoint to line No.0x050', async () => {
            await (0, sources_helpers_js_1.addBreakpointForLine)(frontend, '0x050');
        });
        await (0, helper_js_1.step)('reload the page', async () => {
            await (0, sources_helpers_js_1.reloadPageAndWaitForSourceFile)(target, fileName);
        });
        await (0, helper_js_1.waitForFunction)(async () => await (0, sources_helpers_js_1.isBreakpointSet)('0x050'));
        await (0, helper_js_1.step)('check that the code has paused on the breakpoint at the correct script location', async () => {
            const scriptLocation = await (0, sources_helpers_js_1.retrieveTopCallFrameWithoutResuming)();
