...
describeWithRealConnection('Context menu', async () => {
    ...
    it('should create a context menu', () => {
        ...
        const cssMatchedStyles = new SDK.CSSMatchedStyles.CSSMatchedStyles(stylesPane.cssModel(), stylesPane.node(), null, null, [], [], [], [], [], undefined);
        const cssProperty = new SDK.CSSProperty.CSSProperty(cssMatchedStyles.nodeStyles()[0], 0, '', '', true, false, true, false, '', undefined);
        const stylePropertyTreeElement = new Elements.StylePropertyTreeElement.StylePropertyTreeElement(stylesPane, cssMatchedStyles, cssProperty, false, false, false, true);
...
//# sourceMappingURL=StylePropertyTreeElement_test.js.map