...
describeWithMockConnection('ResourceTreeModel', () => {
    ...
    it('records prerenderingStatus', () => {
        ...
        dispatchEvent(target, 'Page.prerenderAttemptCompleted', {
            ...
            'finalStatus': "TriggerDestroyed" /* Protocol.Page.PrerenderFinalStatus.TriggerDestroyed */,
        });
        dispatchEvent(target, 'Page.prerenderAttemptCompleted', {
            'initiatingFrameId': 'next',
            'prerenderingUrl': 'http://example.com/page.html',
            'finalStatus': "ClientCertRequested" /* Protocol.Page.PrerenderFinalStatus.ClientCertRequested */,
        });
        assertNotNullOrUndefined(resourceTreeModel);
        assertNotNullOrUndefined(resourceTreeModel.mainFrame);
        assert.strictEqual(resourceTreeModel.mainFrame.prerenderFinalStatus, "TriggerDestroyed" /* Protocol.Page.PrerenderFinalStatus.TriggerDestroyed */);
        dispatchEvent(target, 'Page.frameNavigated', {
            frame: {
                id: 'next',
                loaderId: 'foo',
        ...
        assertNotNullOrUndefined(resourceTreeModel);
        assertNotNullOrUndefined(resourceTreeModel.mainFrame);
        assert.strictEqual(resourceTreeModel.mainFrame.prerenderFinalStatus, "ClientCertRequested" /* Protocol.Page.PrerenderFinalStatus.ClientCertRequested */);
    });
