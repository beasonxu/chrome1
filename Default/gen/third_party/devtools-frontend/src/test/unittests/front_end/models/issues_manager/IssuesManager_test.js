...
describeWithEnvironment('IssuesManager', () => {
    it('collects issues from an issues model', () => {
        ...
        mockModel.dispatchEventToListeners("IssueAdded" /* SDK.IssuesModel.Events.IssueAdded */, { issuesModel: mockModel, inspectorIssue: mkInspectorCspIssue('url1') });
        mockModel.dispatchEventToListeners("IssueAdded" /* SDK.IssuesModel.Events.IssueAdded */, { issuesModel: mockModel, inspectorIssue: mkInspectorCspIssue('url2') });
