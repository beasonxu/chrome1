...
import { assertShadowRoot, getCleanTextContentFromElements, getElementsWithinComponent, getElementWithinComponent, renderElementIntoDOM, } from '../../../helpers/DOMHelpers.js';
...
const makeFrame = () => {
    const newFrame = {
        ...
        prerenderFinalStatus: "TriggerDestroyed" /* Protocol.Page.PrerenderFinalStatus.TriggerDestroyed */,
    };
    return newFrame;
};
describeWithRealConnection('FrameDetailsView', () => {
    ...
    it('renders report keys and values', async () => {
        ...
        frame.adFrameType = () => "root" /* Protocol.Page.AdFrameType.Root */,
            frame.getDebuggerId = () => debuggerId;
        const component = new ApplicationComponents.FrameDetailsView.FrameDetailsReportView();
        renderElementIntoDOM(component);
