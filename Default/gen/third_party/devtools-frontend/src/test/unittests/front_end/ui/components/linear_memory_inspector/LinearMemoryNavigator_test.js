...
describeWithLocale('LinearMemoryNavigator', () => {
    ...
    function renderNavigator() {
        ...
        component.data = {
            address: '20',
            valid: true,
            mode: "Submitted" /* LinearMemoryInspector.LinearMemoryNavigator.Mode.Submitted */,
            error: undefined,
    ...
    async function assertNavigationEvents(eventType) {
        ...
        assert.deepEqual(navigation, [
            "Backward" /* LinearMemoryInspector.LinearMemoryNavigator.Navigation.Backward */,
            "Forward" /* LinearMemoryInspector.LinearMemoryNavigator.Navigation.Forward */,
        ]);
    }
    ...
    it('shows tooltip with error and selects all text on submitting invalid address input', () => {
        ...
        component.data = {
            ...
            valid: false,
            mode: "InvalidSubmit" /* LinearMemoryInspector.LinearMemoryNavigator.Mode.InvalidSubmit */,
            error,
            canGoBackInHistory: false,
            canGoForwardInHistory: false,
        };
    ...
    it('shows tooltip with invalid address on hovering over address', () => {
        ...
        component.data = {
            address: '60',
            valid: false,
            mode: "Edit" /* LinearMemoryInspector.LinearMemoryNavigator.Mode.Edit */,
            error,
            canGoBackInHistory: false,
            canGoForwardInHistory: false,
        };
