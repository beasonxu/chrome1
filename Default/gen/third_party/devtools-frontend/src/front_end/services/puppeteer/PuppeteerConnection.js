...
export async function getPuppeteerConnection(rawConnection, mainFrameId, mainTargetId) {
    ...
    const browserPromise = puppeteer.Browser._create('chrome', connection, [] /* contextIds */, false /* ignoreHTTPSErrors */, undefined /* defaultViewport */, undefined /* process */, undefined /* closeCallback */, targetFilterCallback);
