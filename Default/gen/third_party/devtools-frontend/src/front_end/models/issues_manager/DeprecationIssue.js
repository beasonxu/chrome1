    ...
    getDescription() {
        ...
        switch (this.#issueDetails.type) {
            ...
            case "InsecurePrivateNetworkSubresourceRequest" /* Protocol.Audits.DeprecationIssueType.InsecurePrivateNetworkSubresourceRequest */:
                ...
                milestone = 92;
                break;
            case "LegacyConstraintGoogIPv6" /* Protocol.Audits.DeprecationIssueType.LegacyConstraintGoogIPv6 */:
            ...
            case "MediaSourceDurationTruncatingBuffered" /* Protocol.Audits.DeprecationIssueType.MediaSourceDurationTruncatingBuffered */:
                ...
                feature = 6107495151960064;
                break;
            case "NavigateEventRestoreScroll" /* Protocol.Audits.DeprecationIssueType.NavigateEventRestoreScroll */:
                messageFunction = i18nLazyString(UIStrings.deprecatedWithReplacement, { PH1: 'navigateEvent.restoreScroll()', PH2: 'navigateEvent.scroll()' });
                break;
            case "NavigateEventTransitionWhile" /* Protocol.Audits.DeprecationIssueType.NavigateEventTransitionWhile */:
                messageFunction = i18nLazyString(UIStrings.deprecatedWithReplacement, { PH1: 'navigateEvent.transitionWhile()', PH2: 'navigateEvent.intercept()' });
                break;
