...
static constexpr struct {
  ...
  std::array<OriginTrialFeature, kMaxFeaturesPerTrial> features;
    ...
    { "AccessibilityAriaTouchPassthrough", 1, {OriginTrialFeature::kAccessibilityAriaTouchPassthrough, } },
    { "AdInterestGroupAPI", 1, {OriginTrialFeature::kAdInterestGroupAPI, } },
    { "AnonymousIframe", 1, {OriginTrialFeature::kAnonymousIframe, } },
    { "PrivacySandboxAdsAPIs", 6, {OriginTrialFeature::kAttributionReporting,OriginTrialFeature::kFencedFrames,OriginTrialFeature::kFledge,OriginTrialFeature::kPrivacySandboxAdsAPIs,OriginTrialFeature::kSharedStorageAPI,OriginTrialFeature::kTopicsAPI, } },
    { "AutoDarkMode", 1, {OriginTrialFeature::kAutoDarkMode, } },
    { "BackForwardCacheExperimentHTTPHeader", 1, {OriginTrialFeature::kBackForwardCacheExperimentHTTPHeader, } },
    { "BeforeMatchEvent", 1, {OriginTrialFeature::kBeforeMatchEvent, } },
    { "CacheStorageCodeCacheHint", 1, {OriginTrialFeature::kCacheStorageCodeCacheHint, } },
    { "ComputePressure", 1, {OriginTrialFeature::kComputePressure, } },
    { "ConditionalFocus", 1, {OriginTrialFeature::kConditionalFocus, } },
    { "CrossOriginOpenerPolicyReporting", 1, {OriginTrialFeature::kCrossOriginOpenerPolicyReporting, } },
    { "DeviceAttributes", 1, {OriginTrialFeature::kDeviceAttributes, } },
    { "DigitalGoodsV2", 1, {OriginTrialFeature::kDigitalGoods, } },
    { "DisableDifferentOriginSubframeDialogSuppression", 1, {OriginTrialFeature::kDisableDifferentOriginSubframeDialogSuppression, } },
    { "DisableHardwareNoiseSuppression", 1, {OriginTrialFeature::kDisableHardwareNoiseSuppression, } },
    { "DocumentPolicyNegotiation", 1, {OriginTrialFeature::kDocumentPolicyNegotiation, } },
    { "DocumentTransitionV2", 1, {OriginTrialFeature::kDocumentTransition, } },
    { "EarlyHintsPreloadForNavigation", 1, {OriginTrialFeature::kEarlyHintsPreloadForNavigationOptIn, } },
    { "FedCM", 1, {OriginTrialFeature::kFedCm, } },
    { "FileHandling", 1, {OriginTrialFeature::kFileHandling, } },
    { "Focusgroup", 1, {OriginTrialFeature::kFocusgroup, } },
    { "HrefTranslate", 1, {OriginTrialFeature::kHrefTranslate, } },
    { "MediaSourceExtensionsForWebCodecs", 1, {OriginTrialFeature::kMediaSourceExtensionsForWebCodecs, } },
    { "MediaSourceInWorkers", 1, {OriginTrialFeature::kMediaSourceInWorkers, } },
    ...
    { "FrobulateExpiryGracePeriod", 1, {OriginTrialFeature::kOriginTrialsSampleAPIExpiryGracePeriod, } },
    { "FrobulateExpiryGracePeriodThirdParty", 1, {OriginTrialFeature::kOriginTrialsSampleAPIExpiryGracePeriodThirdParty, } },
    ...
    { "FrobulatePersistentExpiryGracePeriod", 1, {OriginTrialFeature::kOriginTrialsSampleAPIPersistentExpiryGracePeriod, } },
    { "FrobulatePersistent", 1, {OriginTrialFeature::kOriginTrialsSampleAPIPersistentFeature, } },
    ...
    { "Parakeet", 1, {OriginTrialFeature::kParakeet, } },
    { "PartitionedCookies", 1, {OriginTrialFeature::kPartitionedCookies, } },
    { "PendingBeaconAPI", 1, {OriginTrialFeature::kPendingBeaconAPI, } },
    ...
    { "Prerender2RelatedFeatures__DONOTUSE", 1, {OriginTrialFeature::kPrerender2RelatedFeatures, } },
    { "PrivateNetworkAccessNonSecureContextsAllowed", 1, {OriginTrialFeature::kPrivateNetworkAccessNonSecureContextsAllowed, } },
    { "RegionCapture", 1, {OriginTrialFeature::kRegionCapture, } },
    ...
    { "RTCInsertableStreams", 1, {OriginTrialFeature::kRTCInsertableStreams, } },
    { "RTCStatsRelativePacketArrivalDelay", 1, {OriginTrialFeature::kRTCStatsRelativePacketArrivalDelay, } },
    { "SecurePaymentConfirmationOptOut", 1, {OriginTrialFeature::kSecurePaymentConfirmationOptOut, } },
    { "SendFullUserAgentAfterReduction", 1, {OriginTrialFeature::kSendFullUserAgentAfterReduction, } },
    ...
    { "SpeculationRules__DONOTUSE", 1, {OriginTrialFeature::kSpeculationRules, } },
    { "SpeculationRulesPrefetch", 1, {OriginTrialFeature::kSpeculationRulesPrefetchProxy, } },
    { "StorageFoundationAPI", 1, {OriginTrialFeature::kStorageFoundationAPI, } },
    ...
    { "U2FSecurityKeyAPI", 1, {OriginTrialFeature::kU2FSecurityKeyAPI, } },
    { "UnrestrictedSharedArrayBuffer", 1, {OriginTrialFeature::kUnrestrictedSharedArrayBuffer, } },
    { "UserAgentReduction", 1, {OriginTrialFeature::kUserAgentReduction, } },
    { "WebAppDarkMode", 1, {OriginTrialFeature::kWebAppDarkMode, } },
    { "Launch Handler", 1, {OriginTrialFeature::kWebAppLaunchHandler, } },
    { "WebAppLaunchQueue", 1, {OriginTrialFeature::kWebAppLaunchQueue, } },
    { "WebAppUrlHandling", 1, {OriginTrialFeature::kWebAppUrlHandling, } },
    { "WebAppWindowControlsOverlay", 1, {OriginTrialFeature::kWebAppWindowControlsOverlay, } },
    { "WebAssemblyExceptions", 1, {OriginTrialFeature::kWebAssemblyExceptions, } },
    { "WebCodecs", 1, {OriginTrialFeature::kWebCodecs, } },
    { "WebGPU", 1, {OriginTrialFeature::kWebGPU, } },
    { "WebPaymentAPICSP", 1, {OriginTrialFeature::kWebPaymentAPICSP, } },
    { "WebTransportCustomCertificates", 1, {OriginTrialFeature::kWebTransportCustomCertificates, } },
    { "WebXRDepth", 1, {OriginTrialFeature::kWebXRDepth, } },
    { "WebXRImageTracking", 1, {OriginTrialFeature::kWebXRImageTracking, } },
    { "WebXRPlaneDetection", 1, {OriginTrialFeature::kWebXRPlaneDetection, } },
    // For testing
...
base::span<const OriginTrialFeature> origin_trials::GetImpliedFeatures(
  ...
  if (feature == OriginTrialFeature::kFledge) {
    static constexpr OriginTrialFeature implied_features[] = {OriginTrialFeature::kAdInterestGroupAPI,};
  ...
  if (feature == OriginTrialFeature::kSpeculationRulesPrefetchProxy) {
    static constexpr OriginTrialFeature implied_features[] = {OriginTrialFeature::kSpeculationRules,};
    return implied_features;
  }
  if (feature == OriginTrialFeature::kWebAppLaunchHandler) {
    static constexpr OriginTrialFeature implied_features[] = {OriginTrialFeature::kWebAppLaunchQueue,};
    return implied_features;
  }
