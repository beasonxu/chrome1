...
public:
    ...
    virtual void clearObjectStore(Maybe<String> in_securityOrigin, Maybe<String> in_storageKey, const String& in_databaseName, const String& in_objectStoreName, std::unique_ptr<ClearObjectStoreCallback> callback) = 0;
    ...
    virtual void deleteObjectStoreEntries(Maybe<String> in_securityOrigin, Maybe<String> in_storageKey, const String& in_databaseName, const String& in_objectStoreName, std::unique_ptr<protocol::IndexedDB::KeyRange> in_keyRange, std::unique_ptr<DeleteObjectStoreEntriesCallback> callback) = 0;
    ...
    virtual void requestData(Maybe<String> in_securityOrigin, Maybe<String> in_storageKey, const String& in_databaseName, const String& in_objectStoreName, const String& in_indexName, int in_skipCount, int in_pageSize, Maybe<protocol::IndexedDB::KeyRange> in_keyRange, std::unique_ptr<RequestDataCallback> callback) = 0;
    ...
    virtual void getMetadata(Maybe<String> in_securityOrigin, Maybe<String> in_storageKey, const String& in_databaseName, const String& in_objectStoreName, std::unique_ptr<GetMetadataCallback> callback) = 0;
    ...
    virtual void requestDatabase(Maybe<String> in_securityOrigin, Maybe<String> in_storageKey, const String& in_databaseName, std::unique_ptr<RequestDatabaseCallback> callback) = 0;
