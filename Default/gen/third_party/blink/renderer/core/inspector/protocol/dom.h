...
public:
    ...
    virtual DispatchResponse getNodesForSubtreeByStyle(int in_nodeId, std::unique_ptr<protocol::Array<protocol::DOM::CSSComputedStyleProperty>> in_computedStyles, Maybe<bool> in_pierce, std::unique_ptr<protocol::Array<int>>* out_nodeIds) = 0;
