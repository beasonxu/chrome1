...
public:
    ...
    bool hasShadowRootType() { return m_shadowRootType.isJust(); }
    protocol::DOMSnapshot::RareStringData* getShadowRootType(protocol::DOMSnapshot::RareStringData* defaultValue) { return m_shadowRootType.isJust() ? m_shadowRootType.fromJust() : defaultValue; }
    ...
    protocol::DOMSnapshot::RareStringData* getPseudoIdentifier(protocol::DOMSnapshot::RareStringData* defaultValue) { return m_pseudoIdentifier.isJust() ? m_pseudoIdentifier.fromJust() : defaultValue; }
...
public:
    ...
    protocol::Array<int>* getBlendedBackgroundColors(protocol::Array<int>* defaultValue) { return m_blendedBackgroundColors.isJust() ? m_blendedBackgroundColors.fromJust() : defaultValue; }
...
public:
    ...
    virtual DispatchResponse captureSnapshot(std::unique_ptr<protocol::Array<String>> in_computedStyles, Maybe<bool> in_includePaintOrder, Maybe<bool> in_includeDOMRects, Maybe<bool> in_includeBlendedBackgroundColors, Maybe<bool> in_includeTextColorOpacities, std::unique_ptr<protocol::Array<protocol::DOMSnapshot::DocumentSnapshot>>* out_documents, std::unique_ptr<protocol::Array<String>>* out_strings) = 0;
