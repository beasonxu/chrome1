...
void AlignmentBaseline::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetAlignmentBaseline(ComputedStyleInitialValues::InitialAlignmentBaseline());
}
void AlignmentBaseline::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetAlignmentBaseline(state.ParentStyle()->AlignmentBaseline());
}
...
void AnchorName::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetAnchorName(ComputedStyleInitialValues::InitialAnchorName());
}
void AnchorName::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetAnchorName(state.ParentStyle()->AnchorName());
}
void AnchorName::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  state.Style()->SetAnchorName(StyleBuilderConverter::ConvertNoneOrCustomIdent(state, value));
}
...
const char* AnchorScroll::GetPropertyName() const {
...
const char* AnchorScroll::GetJSPropertyName() const {
  return "anchorScroll";
}


void AnchorScroll::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetAnchorScroll(ComputedStyleInitialValues::InitialAnchorScroll());
}
void AnchorScroll::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetAnchorScroll(state.ParentStyle()->AnchorScroll());
}
...
void BaselineShift::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetBaselineShift(ComputedStyleInitialValues::InitialBaselineShift());
}
...
void BorderBottomColor::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetBorderBottomColor(StyleColor::CurrentColor());
}

void BorderBottomColor::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetBorderBottomColor(state.ParentStyle()->BorderBottomColor());
}
...
const CSSProperty* BorderEndEndRadius::SurrogateFor(TextDirection direction,
    blink::WritingMode writing_mode) const {
  return &ResolveDirectionAwareProperty(direction, writing_mode);
}

const CSSProperty& BorderEndEndRadius::ResolveDirectionAwareProperty(
    TextDirection direction,
    blink::WritingMode writing_mode) const {
  return CSSDirectionAwareResolver::ResolveEndEnd(direction, writing_mode,
...
const CSSProperty* BorderEndStartRadius::SurrogateFor(TextDirection direction,
    blink::WritingMode writing_mode) const {
  return &ResolveDirectionAwareProperty(direction, writing_mode);
}

const CSSProperty& BorderEndStartRadius::ResolveDirectionAwareProperty(
    TextDirection direction,
    blink::WritingMode writing_mode) const {
  return CSSDirectionAwareResolver::ResolveEndStart(direction, writing_mode,
      CSSDirectionAwareResolver::PhysicalBorderRadiusMapping());
}
...
void BorderLeftColor::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetBorderLeftColor(StyleColor::CurrentColor());
}

void BorderLeftColor::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetBorderLeftColor(state.ParentStyle()->BorderLeftColor());
}
...
void BorderRightColor::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetBorderRightColor(StyleColor::CurrentColor());
}

void BorderRightColor::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetBorderRightColor(state.ParentStyle()->BorderRightColor());
}
...
const CSSProperty* BorderStartEndRadius::SurrogateFor(TextDirection direction,
    blink::WritingMode writing_mode) const {
  return &ResolveDirectionAwareProperty(direction, writing_mode);
}

const CSSProperty& BorderStartEndRadius::ResolveDirectionAwareProperty(
    TextDirection direction,
    blink::WritingMode writing_mode) const {
  return CSSDirectionAwareResolver::ResolveStartEnd(direction, writing_mode,
      CSSDirectionAwareResolver::PhysicalBorderRadiusMapping());
}
...
const CSSProperty* BorderStartStartRadius::SurrogateFor(TextDirection direction,
    blink::WritingMode writing_mode) const {
  return &ResolveDirectionAwareProperty(direction, writing_mode);
}

const CSSProperty& BorderStartStartRadius::ResolveDirectionAwareProperty(
    TextDirection direction,
    blink::WritingMode writing_mode) const {
  return CSSDirectionAwareResolver::ResolveStartStart(direction, writing_mode,
      CSSDirectionAwareResolver::PhysicalBorderRadiusMapping());
}
...
void BorderTopColor::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetBorderTopColor(StyleColor::CurrentColor());
}

void BorderTopColor::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetBorderTopColor(state.ParentStyle()->BorderTopColor());
}
...
void BufferedRendering::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetBufferedRendering(ComputedStyleInitialValues::InitialBufferedRendering());
}
void BufferedRendering::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetBufferedRendering(state.ParentStyle()->BufferedRendering());
}
...
void ClipRule::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetClipRule(ComputedStyleInitialValues::InitialClipRule());
}
void ClipRule::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetClipRule(state.ParentStyle()->ClipRule());
}
void ClipRule::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  state.Style()->SetClipRule(To<CSSIdentifierValue>(value).ConvertTo<blink::WindRule>());
}
...
void ColorInterpolation::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetColorInterpolation(ComputedStyleInitialValues::InitialColorInterpolation());
}
void ColorInterpolation::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetColorInterpolation(state.ParentStyle()->ColorInterpolation());
}
...
void ColorInterpolationFilters::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetColorInterpolationFilters(state.ParentStyle()->ColorInterpolationFilters());
}
...
void ColorRendering::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetColorRendering(ComputedStyleInitialValues::InitialColorRendering());
}
void ColorRendering::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetColorRendering(state.ParentStyle()->ColorRendering());
}
...
void ColumnRuleColor::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetColumnRuleColor(StyleColor::CurrentColor());
}

void ColumnRuleColor::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetColumnRuleColor(state.ParentStyle()->ColumnRuleColor());
}
...
const CSSProperty* ContainIntrinsicBlockSize::SurrogateFor(TextDirection direction,
    blink::WritingMode writing_mode) const {
  return &ResolveDirectionAwareProperty(direction, writing_mode);
}
...
const CSSProperty* ContainIntrinsicInlineSize::SurrogateFor(TextDirection direction,
    blink::WritingMode writing_mode) const {
  return &ResolveDirectionAwareProperty(direction, writing_mode);
}
...
void ContainerName::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetContainerName(ComputedStyleInitialValues::InitialContainerName());
}
void ContainerName::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetContainerName(state.ParentStyle()->ContainerName());
}
...
void ContainerType::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetContainerType(ComputedStyleInitialValues::InitialContainerType());
}
void ContainerType::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetContainerType(state.ParentStyle()->ContainerType());
}
...
void Cx::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetCx(ComputedStyleInitialValues::InitialCx());
}
void Cx::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetCx(state.ParentStyle()->Cx());
}
void Cx::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  state.Style()->SetCx(StyleBuilderConverter::ConvertLength(state, value));
}
...
void Cy::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetCy(ComputedStyleInitialValues::InitialCy());
}
void Cy::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetCy(state.ParentStyle()->Cy());
}
void Cy::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  state.Style()->SetCy(StyleBuilderConverter::ConvertLength(state, value));
}
...
void D::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetD(ComputedStyleInitialValues::InitialD());
}
void D::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetD(state.ParentStyle()->D());
}
void D::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  state.Style()->SetD(StyleBuilderConverter::ConvertPathOrNone(state, value));
}
...
void DominantBaseline::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetDominantBaseline(ComputedStyleInitialValues::InitialDominantBaseline());
}
void DominantBaseline::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetDominantBaseline(state.ParentStyle()->DominantBaseline());
}
...
void Fill::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetFillPaint(ComputedStyleInitialValues::InitialFillPaint());
}

void Fill::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetFillPaint(state.ParentStyle()->FillPaint());
}

void Fill::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  state.Style()->SetFillPaint(StyleBuilderConverter::ConvertSVGPaint(state, value, false));
}
...
void FillOpacity::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetFillOpacity(ComputedStyleInitialValues::InitialFillOpacity());
}
void FillOpacity::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetFillOpacity(state.ParentStyle()->FillOpacity());
}
void FillOpacity::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  state.Style()->SetFillOpacity(StyleBuilderConverter::ConvertAlpha(state, value));
}
...
void FillRule::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetFillRule(ComputedStyleInitialValues::InitialFillRule());
}
void FillRule::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetFillRule(state.ParentStyle()->FillRule());
}
void FillRule::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  state.Style()->SetFillRule(To<CSSIdentifierValue>(value).ConvertTo<blink::WindRule>());
}
...
void FlexBasis::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  state.Style()->SetFlexBasis(StyleBuilderConverter::ConvertLengthSizing(state, value));
}
...
void FloodColor::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetFloodColor(ComputedStyleInitialValues::InitialFloodColor());
}

void FloodColor::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetFloodColor(state.ParentStyle()->FloodColor());
}

void FloodColor::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  state.Style()->SetFloodColor(StyleBuilderConverter::ConvertStyleColor(state, value, false));
}
...
void FloodOpacity::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetFloodOpacity(ComputedStyleInitialValues::InitialFloodOpacity());
}
void FloodOpacity::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetFloodOpacity(state.ParentStyle()->FloodOpacity());
}
void FloodOpacity::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  state.Style()->SetFloodOpacity(StyleBuilderConverter::ConvertAlpha(state, value));
}
...
CSSExposure InternalAlignSelfBlock::Exposure() const {
  return CSSExposure::kUA;
}


const char* InternalAlignSelfBlock::GetPropertyName() const {
  return "-internal-align-self-block";
}
...
const char* InternalAlignSelfBlock::GetJSPropertyName() const {
  return "internalAlignSelfBlock";
}


void InternalAlignSelfBlock::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetAlignSelfBlockCenter(ComputedStyleInitialValues::InitialAlignSelfBlockCenter());
}
void InternalAlignSelfBlock::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetAlignSelfBlockCenter(state.ParentStyle()->AlignSelfBlockCenter());
}
...
CSSExposure InternalFontSizeDelta::Exposure() const {
  return CSSExposure::kUA;
}
...
CSSExposure InternalForcedBackgroundColor::Exposure() const {
  return CSSExposure::kUA;
}
...
CSSExposure InternalForcedBorderColor::Exposure() const {
  return CSSExposure::kUA;
}
...
void InternalForcedBorderColor::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetInternalForcedBorderColor(StyleColor::CurrentColor());
}

void InternalForcedBorderColor::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetInternalForcedBorderColor(state.ParentStyle()->InternalForcedBorderColor());
}
...
CSSExposure InternalForcedColor::Exposure() const {
  return CSSExposure::kUA;
}
...
const CSSProperty* InternalForcedColor::GetVisitedProperty() const {
  return &GetCSSPropertyInternalForcedVisitedColor();
}
...
CSSExposure InternalForcedOutlineColor::Exposure() const {
  return CSSExposure::kUA;
}
...
void InternalForcedOutlineColor::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetInternalForcedOutlineColor(StyleColor::CurrentColor());
}

void InternalForcedOutlineColor::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetInternalForcedOutlineColor(state.ParentStyle()->InternalForcedOutlineColor());
}
...
CSSExposure InternalForcedVisitedColor::Exposure() const {
  return CSSExposure::kUA;
}
...
const CSSProperty* InternalForcedVisitedColor::GetUnvisitedProperty() const {
  return &GetCSSPropertyInternalForcedColor();
}
...
void InternalVisitedBackgroundColor::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetInternalVisitedBackgroundColor(state.ParentStyle()->BackgroundColor());
}
...
void InternalVisitedBorderBottomColor::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetInternalVisitedBorderBottomColor(StyleColor::CurrentColor());
}
...
void InternalVisitedBorderLeftColor::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetInternalVisitedBorderLeftColor(StyleColor::CurrentColor());
}

void InternalVisitedBorderLeftColor::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetInternalVisitedBorderLeftColor(state.ParentStyle()->BorderLeftColor());
}
...
void InternalVisitedBorderRightColor::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetInternalVisitedBorderRightColor(StyleColor::CurrentColor());
}

void InternalVisitedBorderRightColor::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetInternalVisitedBorderRightColor(state.ParentStyle()->BorderRightColor());
}
...
void InternalVisitedBorderTopColor::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetInternalVisitedBorderTopColor(StyleColor::CurrentColor());
}

void InternalVisitedBorderTopColor::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetInternalVisitedBorderTopColor(state.ParentStyle()->BorderTopColor());
}
...
void InternalVisitedCaretColor::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetInternalVisitedCaretColor(StyleAutoColor::AutoColor());
}

void InternalVisitedCaretColor::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetInternalVisitedCaretColor(state.ParentStyle()->CaretColor());
}
...
void InternalVisitedColumnRuleColor::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetInternalVisitedColumnRuleColor(StyleColor::CurrentColor());
}

void InternalVisitedColumnRuleColor::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetInternalVisitedColumnRuleColor(state.ParentStyle()->ColumnRuleColor());
}
...
void InternalVisitedFill::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetInternalVisitedFillPaint(ComputedStyleInitialValues::InitialFillPaint());
}

void InternalVisitedFill::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetInternalVisitedFillPaint(state.ParentStyle()->FillPaint());
}
...
void InternalVisitedOutlineColor::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetInternalVisitedOutlineColor(StyleColor::CurrentColor());
}

void InternalVisitedOutlineColor::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetInternalVisitedOutlineColor(state.ParentStyle()->OutlineColor());
}
...
void InternalVisitedStroke::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetInternalVisitedStrokePaint(ComputedStyleInitialValues::InitialStrokePaint());
}

void InternalVisitedStroke::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetInternalVisitedStrokePaint(state.ParentStyle()->StrokePaint());
}
...
void InternalVisitedTextDecorationColor::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetInternalVisitedTextDecorationColor(StyleColor::CurrentColor());
}
...
const CSSProperty* InternalVisitedTextEmphasisColor::GetUnvisitedProperty() const {
  return &GetCSSPropertyTextEmphasisColor();
}


void InternalVisitedTextEmphasisColor::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetInternalVisitedTextEmphasisColor(StyleColor::CurrentColor());
}
...
void InternalVisitedTextFillColor::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetInternalVisitedTextFillColor(StyleColor::CurrentColor());
}

void InternalVisitedTextFillColor::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetInternalVisitedTextFillColor(state.ParentStyle()->TextFillColor());
}
...
void InternalVisitedTextStrokeColor::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetInternalVisitedTextStrokeColor(StyleColor::CurrentColor());
}

void InternalVisitedTextStrokeColor::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetInternalVisitedTextStrokeColor(state.ParentStyle()->TextStrokeColor());
}
...
void LightingColor::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetLightingColor(ComputedStyleInitialValues::InitialLightingColor());
}

void LightingColor::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetLightingColor(state.ParentStyle()->LightingColor());
}
...
const CSSProperty* LineBreak::SurrogateFor(TextDirection direction,
    blink::WritingMode writing_mode) const {
...
void MarkerEnd::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetMarkerEndResource(ComputedStyleInitialValues::InitialMarkerEndResource());
}
void MarkerEnd::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetMarkerEndResource(state.ParentStyle()->MarkerEndResource());
}
...
void MarkerMid::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetMarkerMidResource(ComputedStyleInitialValues::InitialMarkerMidResource());
}
void MarkerMid::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetMarkerMidResource(state.ParentStyle()->MarkerMidResource());
}
...
void MarkerStart::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetMarkerStartResource(ComputedStyleInitialValues::InitialMarkerStartResource());
}
void MarkerStart::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetMarkerStartResource(state.ParentStyle()->MarkerStartResource());
}
...
void Mask::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetMaskerResource(ComputedStyleInitialValues::InitialMaskerResource());
}
void Mask::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetMaskerResource(state.ParentStyle()->MaskerResource());
}
void Mask::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  state.Style()->SetMaskerResource(StyleBuilderConverter::ConvertElementReference(state, value));
}
...
void MaskType::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetMaskType(ComputedStyleInitialValues::InitialMaskType());
}
void MaskType::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetMaskType(state.ParentStyle()->MaskType());
}
void MaskType::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  state.Style()->SetMaskType(To<CSSIdentifierValue>(value).ConvertTo<blink::EMaskType>());
}
...
void MathDepth::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetMathDepth(ComputedStyleInitialValues::InitialMathDepth());
}
...
void MathShift::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetMathShift(ComputedStyleInitialValues::InitialMathShift());
}
void MathShift::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetMathShift(state.ParentStyle()->MathShift());
}
void MathShift::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  state.Style()->SetMathShift(To<CSSIdentifierValue>(value).ConvertTo<blink::EMathShift>());
}
...
void ObjectViewBox::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetObjectViewBox(ComputedStyleInitialValues::InitialObjectViewBox());
}
void ObjectViewBox::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetObjectViewBox(state.ParentStyle()->ObjectViewBox());
}
...
void OutlineColor::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetOutlineColor(StyleColor::CurrentColor());
}

void OutlineColor::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetOutlineColor(state.ParentStyle()->OutlineColor());
}
...
void OverflowClipMargin::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetOverflowClipMargin(ComputedStyleInitialValues::InitialOverflowClipMargin());
}
void OverflowClipMargin::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetOverflowClipMargin(state.ParentStyle()->OverflowClipMargin());
}
...
CSSExposure PageTransitionTag::Exposure(const ExecutionContext* execution_context) const {
  if (!RuntimeEnabledFeatures::DocumentTransitionEnabled(execution_context))
    return CSSExposure::kNone;
  return CSSExposure::kWeb;
}

const char* PageTransitionTag::GetPropertyName() const {
  return "page-transition-tag";
}
...
const char* PageTransitionTag::GetJSPropertyName() const {
  return "pageTransitionTag";
}


void PageTransitionTag::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetPageTransitionTag(ComputedStyleInitialValues::InitialPageTransitionTag());
}
void PageTransitionTag::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetPageTransitionTag(state.ParentStyle()->PageTransitionTag());
}
...
void PaintOrder::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetPaintOrder(ComputedStyleInitialValues::InitialPaintOrder());
}
void PaintOrder::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetPaintOrder(state.ParentStyle()->PaintOrder());
}
void PaintOrder::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  state.Style()->SetPaintOrder(StyleBuilderConverter::ConvertPaintOrder(state, value));
}
...
CSSExposure PopUpHideDelay::Exposure() const {
...
const char* PopUpHideDelay::GetPropertyName() const {
  return "pop-up-hide-delay";
}

const WTF::AtomicString& PopUpHideDelay::GetPropertyNameAtomicString() const {
  DEFINE_STATIC_LOCAL(const AtomicString, name, ("pop-up-hide-delay"));
  return name;
}

const char* PopUpHideDelay::GetJSPropertyName() const {
  return "popUpHideDelay";
}


void PopUpHideDelay::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetPopUpHideDelay(ComputedStyleInitialValues::InitialPopUpHideDelay());
}
void PopUpHideDelay::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetPopUpHideDelay(state.ParentStyle()->PopUpHideDelay());
}
void PopUpHideDelay::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  state.Style()->SetPopUpHideDelay(StyleBuilderConverter::ConvertTimeValue(state, value));
}

 // pop-up-show-delay

CSSExposure PopUpShowDelay::Exposure() const {
  if (!RuntimeEnabledFeatures::HTMLPopupAttributeEnabled())
    return CSSExposure::kNone;
  return CSSExposure::kWeb;
}
...
const char* PopUpShowDelay::GetPropertyName() const {
  return "pop-up-show-delay";
}

const WTF::AtomicString& PopUpShowDelay::GetPropertyNameAtomicString() const {
  DEFINE_STATIC_LOCAL(const AtomicString, name, ("pop-up-show-delay"));
  return name;
}

const char* PopUpShowDelay::GetJSPropertyName() const {
  return "popUpShowDelay";
}


void PopUpShowDelay::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetPopUpShowDelay(ComputedStyleInitialValues::InitialPopUpShowDelay());
}
void PopUpShowDelay::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetPopUpShowDelay(state.ParentStyle()->PopUpShowDelay());
}
void PopUpShowDelay::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  state.Style()->SetPopUpShowDelay(StyleBuilderConverter::ConvertTimeValue(state, value));
}
...
const char* PositionFallback::GetPropertyName() const {
...
const char* PositionFallback::GetJSPropertyName() const {
  return "positionFallback";
}


void PositionFallback::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetPositionFallback(ComputedStyleInitialValues::InitialPositionFallback());
}
void PositionFallback::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetPositionFallback(state.ParentStyle()->PositionFallback());
}
...
void R::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetR(ComputedStyleInitialValues::InitialR());
}
void R::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetR(state.ParentStyle()->R());
}
void R::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  state.Style()->SetR(StyleBuilderConverter::ConvertLength(state, value));
}
...
void Rx::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetRx(ComputedStyleInitialValues::InitialRx());
}
void Rx::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetRx(state.ParentStyle()->Rx());
}
void Rx::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  state.Style()->SetRx(StyleBuilderConverter::ConvertLengthOrAuto(state, value));
}
...
void Ry::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetRy(ComputedStyleInitialValues::InitialRy());
}
void Ry::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetRy(state.ParentStyle()->Ry());
}
void Ry::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  state.Style()->SetRy(StyleBuilderConverter::ConvertLengthOrAuto(state, value));
}
...
void ScrollbarGutter::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetScrollbarGutter(ComputedStyleInitialValues::InitialScrollbarGutter());
}
void ScrollbarGutter::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetScrollbarGutter(state.ParentStyle()->ScrollbarGutter());
}
...
void ScrollbarWidth::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetScrollbarWidth(ComputedStyleInitialValues::InitialScrollbarWidth());
}
void ScrollbarWidth::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetScrollbarWidth(state.ParentStyle()->ScrollbarWidth());
}
...
void ShapeRendering::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetShapeRendering(ComputedStyleInitialValues::InitialShapeRendering());
}
void ShapeRendering::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetShapeRendering(state.ParentStyle()->ShapeRendering());
}
...
void StopColor::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetStopColor(ComputedStyleInitialValues::InitialStopColor());
}

void StopColor::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetStopColor(state.ParentStyle()->StopColor());
}

void StopColor::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  state.Style()->SetStopColor(StyleBuilderConverter::ConvertStyleColor(state, value, false));
}
...
void StopOpacity::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetStopOpacity(ComputedStyleInitialValues::InitialStopOpacity());
}
void StopOpacity::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetStopOpacity(state.ParentStyle()->StopOpacity());
}
void StopOpacity::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  state.Style()->SetStopOpacity(StyleBuilderConverter::ConvertAlpha(state, value));
}
...
void Stroke::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetStrokePaint(ComputedStyleInitialValues::InitialStrokePaint());
}

void Stroke::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetStrokePaint(state.ParentStyle()->StrokePaint());
}

void Stroke::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  state.Style()->SetStrokePaint(StyleBuilderConverter::ConvertSVGPaint(state, value, false));
}
...
void StrokeDasharray::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetStrokeDashArray(ComputedStyleInitialValues::InitialStrokeDashArray());
}
void StrokeDasharray::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetStrokeDashArray(state.ParentStyle()->StrokeDashArray());
}
...
void StrokeDashoffset::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetStrokeDashOffset(ComputedStyleInitialValues::InitialStrokeDashOffset());
}
void StrokeDashoffset::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetStrokeDashOffset(state.ParentStyle()->StrokeDashOffset());
}
...
void StrokeLinecap::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetCapStyle(ComputedStyleInitialValues::InitialCapStyle());
}
void StrokeLinecap::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetCapStyle(state.ParentStyle()->CapStyle());
}
void StrokeLinecap::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  state.Style()->SetCapStyle(To<CSSIdentifierValue>(value).ConvertTo<blink::LineCap>());
}
...
void StrokeLinejoin::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetJoinStyle(ComputedStyleInitialValues::InitialJoinStyle());
}
void StrokeLinejoin::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetJoinStyle(state.ParentStyle()->JoinStyle());
}
void StrokeLinejoin::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  state.Style()->SetJoinStyle(To<CSSIdentifierValue>(value).ConvertTo<blink::LineJoin>());
}
...
void StrokeMiterlimit::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetStrokeMiterLimit(ComputedStyleInitialValues::InitialStrokeMiterLimit());
}
void StrokeMiterlimit::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetStrokeMiterLimit(state.ParentStyle()->StrokeMiterLimit());
}
void StrokeMiterlimit::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  state.Style()->SetStrokeMiterLimit(To<CSSPrimitiveValue>(value).ConvertTo<float>());
}
...
void StrokeOpacity::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetStrokeOpacity(ComputedStyleInitialValues::InitialStrokeOpacity());
}
void StrokeOpacity::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetStrokeOpacity(state.ParentStyle()->StrokeOpacity());
}
void StrokeOpacity::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  state.Style()->SetStrokeOpacity(StyleBuilderConverter::ConvertAlpha(state, value));
}
...
void StrokeWidth::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetStrokeWidth(ComputedStyleInitialValues::InitialStrokeWidth());
}
void StrokeWidth::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetStrokeWidth(state.ParentStyle()->StrokeWidth());
}
void StrokeWidth::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  state.Style()->SetStrokeWidth(StyleBuilderConverter::ConvertUnzoomedLength(state, value));
}
...
void TextAnchor::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetTextAnchor(ComputedStyleInitialValues::InitialTextAnchor());
}
void TextAnchor::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetTextAnchor(state.ParentStyle()->TextAnchor());
}
void TextAnchor::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  state.Style()->SetTextAnchor(To<CSSIdentifierValue>(value).ConvertTo<blink::ETextAnchor>());
}
...
void TextDecorationColor::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetTextDecorationColor(StyleColor::CurrentColor());
}

void TextDecorationColor::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetTextDecorationColor(state.ParentStyle()->TextDecorationColor());
}
...
void TextDecorationLine::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetTextDecorationLine(ComputedStyleInitialValues::InitialTextDecorationLine());
}
void TextDecorationLine::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetTextDecorationLine(state.ParentStyle()->GetTextDecorationLine());
}
...
void ToggleGroup::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetToggleGroup(ComputedStyleInitialValues::InitialToggleGroup());
}
void ToggleGroup::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetToggleGroup(state.ParentStyle()->ToggleGroup());
}
void ToggleGroup::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  state.Style()->SetToggleGroup(StyleBuilderConverter::ConvertToggleGroup(state, value));
}
...
void ToggleRoot::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetToggleRoot(ComputedStyleInitialValues::InitialToggleRoot());
}
void ToggleRoot::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetToggleRoot(state.ParentStyle()->ToggleRoot());
}
void ToggleRoot::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  state.Style()->SetToggleRoot(StyleBuilderConverter::ConvertToggleRoot(state, value));
}
...
void ToggleTrigger::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetToggleTrigger(ComputedStyleInitialValues::InitialToggleTrigger());
}
void ToggleTrigger::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetToggleTrigger(state.ParentStyle()->ToggleTrigger());
}
...
void VectorEffect::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetVectorEffect(ComputedStyleInitialValues::InitialVectorEffect());
}
void VectorEffect::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetVectorEffect(state.ParentStyle()->VectorEffect());
}
...
void WebkitTextFillColor::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetTextFillColor(StyleColor::CurrentColor());
}

void WebkitTextFillColor::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetTextFillColor(state.ParentStyle()->TextFillColor());
}
...
void WebkitTextStrokeColor::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetTextStrokeColor(StyleColor::CurrentColor());
}

void WebkitTextStrokeColor::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetTextStrokeColor(state.ParentStyle()->TextStrokeColor());
}
...
void X::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetX(ComputedStyleInitialValues::InitialX());
}
void X::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetX(state.ParentStyle()->X());
}
void X::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  state.Style()->SetX(StyleBuilderConverter::ConvertLength(state, value));
}
...
void Y::ApplyInitial(StyleResolverState& state) const {
  state.Style()->SetY(ComputedStyleInitialValues::InitialY());
}
void Y::ApplyInherit(StyleResolverState& state) const {
  state.Style()->SetY(state.ParentStyle()->Y());
}
void Y::ApplyValue(StyleResolverState& state, const CSSValue& value) const {
  state.Style()->SetY(StyleBuilderConverter::ConvertLength(state, value));
}
