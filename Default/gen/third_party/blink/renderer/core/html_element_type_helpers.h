...
template <>
inline bool IsElementOfType<const HTMLMainElement>(const Node& node) {
  return IsA<HTMLMainElement>(node);
}
template <>
inline bool IsElementOfType<const HTMLMainElement>(const HTMLElement& element) {
  return IsA<HTMLMainElement>(element);
}
template <>
struct DowncastTraits<HTMLMainElement> {
  static bool AllowFrom(const Element& element) {
    return element.HasTagName(html_names::kMainTag);
  }
  static bool AllowFrom(const Node& node) {
    return node.IsHTMLElement() && IsA<HTMLMainElement>(To<HTMLElement>(node));
  }
};
...
template <>
inline bool IsElementOfType<const HTMLSelectMenuElement>(const Node& node) {
  return IsA<HTMLSelectMenuElement>(node);
}
template <>
inline bool IsElementOfType<const HTMLSelectMenuElement>(const HTMLElement& element) {
  return IsA<HTMLSelectMenuElement>(element);
}
template <>
struct DowncastTraits<HTMLSelectMenuElement> {
  static bool AllowFrom(const Element& element) {
  ...
  static bool AllowFrom(const Node& node) {
    return node.IsHTMLElement() && IsA<HTMLSelectMenuElement>(To<HTMLElement>(node));
  }
};
