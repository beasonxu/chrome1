...
const char kFederatedCredentialsPolicyName[] = "federated-credentials";
...
const FeatureNameMap& GetDefaultFeatureNameMap() {
  ...
  if (default_feature_name_map.IsEmpty()) {
    ...
    default_feature_name_map.Set(kAutoplayPolicyName,
                                 mojom::PermissionsPolicyFeature::kAutoplay);
    ...
    default_feature_name_map.Set(kClientHintPrefersColorSchemePolicyName,
    ...
    default_feature_name_map.Set(kClientHintSaveDataPolicyName,
    ...
    default_feature_name_map.Set(kClientHintUABitnessPolicyName,
    ...
    default_feature_name_map.Set(kClientHintUAFullPolicyName,
    ...
    default_feature_name_map.Set(kClientHintUAFullVersionListPolicyName,
    ...
    default_feature_name_map.Set(kClientHintUAWoW64PolicyName,
                                 mojom::PermissionsPolicyFeature::kClientHintUAWoW64);
    default_feature_name_map.Set(kClientHintUAReducedPolicyName,
    ...
    default_feature_name_map.Set(kClipboardReadPolicyName,
                                 mojom::PermissionsPolicyFeature::kClipboardRead);
    default_feature_name_map.Set(kClipboardWritePolicyName,
                                 mojom::PermissionsPolicyFeature::kClipboardWrite);
    default_feature_name_map.Set(kCrossOriginIsolatedPolicyName,
                                 mojom::PermissionsPolicyFeature::kCrossOriginIsolated);
    default_feature_name_map.Set(kDisplayCapturePolicyName,
                                 mojom::PermissionsPolicyFeature::kDisplayCapture);
    default_feature_name_map.Set(kDocumentDomainPolicyName,
                                 mojom::PermissionsPolicyFeature::kDocumentDomain);
    default_feature_name_map.Set(kEncryptedMediaPolicyName,
                                 mojom::PermissionsPolicyFeature::kEncryptedMedia);
    default_feature_name_map.Set(kFullscreenPolicyName,
                                 mojom::PermissionsPolicyFeature::kFullscreen);
    default_feature_name_map.Set(kFrobulatePolicyName,
                                 mojom::PermissionsPolicyFeature::kFrobulate);
    default_feature_name_map.Set(kGamepadPolicyName,
                                 mojom::PermissionsPolicyFeature::kGamepad);
    default_feature_name_map.Set(kGeolocationPolicyName,
                                 mojom::PermissionsPolicyFeature::kGeolocation);
    ...
    default_feature_name_map.Set(kKeyboardMapPolicyName,
                                 mojom::PermissionsPolicyFeature::kKeyboardMap);
    default_feature_name_map.Set(kMagnetometerPolicyName,
                                 mojom::PermissionsPolicyFeature::kMagnetometer);
    default_feature_name_map.Set(kMicrophonePolicyName,
                                 mojom::PermissionsPolicyFeature::kMicrophone);
    default_feature_name_map.Set(kMidiFeaturePolicyName,
                                 mojom::PermissionsPolicyFeature::kMidiFeature);
    ...
    default_feature_name_map.Set(kTrustTokenRedemptionPolicyName,
                                 mojom::PermissionsPolicyFeature::kTrustTokenRedemption);
    ...
    if (RuntimeEnabledFeatures::DirectSocketsEnabled()) {
      default_feature_name_map.Set(kDirectSocketsPolicyName,
                                   mojom::PermissionsPolicyFeature::kDirectSockets);
    }
    ...
    if (RuntimeEnabledFeatures::FedCmIframeSupportEnabled()) {
      default_feature_name_map.Set(kFederatedCredentialsPolicyName,
                                   mojom::PermissionsPolicyFeature::kFederatedCredentials);
    }
    if (RuntimeEnabledFeatures::FontAccessEnabled()) {
      default_feature_name_map.Set(kLocalFontsPolicyName,
                                   mojom::PermissionsPolicyFeature::kLocalFonts);
    }
    ...
    if (RuntimeEnabledFeatures::PaymentRequestEnabled()) {
      default_feature_name_map.Set(kPaymentPolicyName,
                                   mojom::PermissionsPolicyFeature::kPayment);
    }
    if (RuntimeEnabledFeatures::PermissionsPolicyUnloadEnabled()) {
      default_feature_name_map.Set(kUnloadPolicyName,
                                   mojom::PermissionsPolicyFeature::kUnload);
    }
    if (RuntimeEnabledFeatures::PictureInPictureAPIEnabled()) {
      default_feature_name_map.Set(kPictureInPicturePolicyName,
                                   mojom::PermissionsPolicyFeature::kPictureInPicture);
    }
    if (RuntimeEnabledFeatures::SensorExtraClassesEnabled()) {
      default_feature_name_map.Set(kAmbientLightSensorPolicyName,
                                   mojom::PermissionsPolicyFeature::kAmbientLightSensor);
    }
    if (RuntimeEnabledFeatures::SerialEnabled()) {
      default_feature_name_map.Set(kSerialPolicyName,
                                   mojom::PermissionsPolicyFeature::kSerial);
    }
    if (RuntimeEnabledFeatures::SharedAutofillEnabled()) {
      default_feature_name_map.Set(kSharedAutofillPolicyName,
                                   mojom::PermissionsPolicyFeature::kSharedAutofill);
    }
    ...
    if (RuntimeEnabledFeatures::WebXREnabled()) {
      default_feature_name_map.Set(kWebXrPolicyName,
                                   mojom::PermissionsPolicyFeature::kWebXr);
    }
    if (RuntimeEnabledFeatures::WindowPlacementEnabled()) {
      default_feature_name_map.Set(kWindowPlacementPolicyName,
                                   mojom::PermissionsPolicyFeature::kWindowPlacement);
    }
  }
...
String PermissionsPolicyFeatureToProtocol(mojom::blink::PermissionsPolicyFeature feature) {
  switch (feature) {
    ...
    case mojom::blink::PermissionsPolicyFeature::kFederatedCredentials:
      return protocol::Page::PermissionsPolicyFeatureEnum::FederatedCredentials;
    ...
    case mojom::blink::PermissionsPolicyFeature::kStorageAccessAPI:
      return protocol::Page::PermissionsPolicyFeatureEnum::StorageAccessApi;
