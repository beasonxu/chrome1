...
if (!bindings::GetDictionaryMemberFromV8Object<V8UnionUSVStringOrUint32Array, is_required>(isolate, current_context, v8_dictionary, v8_own_member_names[0].Get(isolate), fallback_presence_var, member_code_, try_block, exception_state)) {
  return;
}
exception_context_scope.ChangePropertyNameAsOptimizationHack("hints");
constexpr bool is_optional = false;
if (!bindings::GetDictionaryMemberFromV8Object<IDLRecord<IDLUSVString, GPUShaderModuleCompilationHint>, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[1].Get(isolate), has_hints_, member_hints_, try_block, exception_state)) {
  return;
}
exception_context_scope.ChangePropertyNameAsOptimizationHack("sourceMap");
if (!bindings::GetDictionaryMemberFromV8Object<IDLObject, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[2].Get(isolate), fallback_presence_var, member_source_map_, try_block, exception_state)) {
  return;
}
}
