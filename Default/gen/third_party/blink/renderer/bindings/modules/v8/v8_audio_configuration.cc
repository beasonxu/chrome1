...
if (!bindings::GetDictionaryMemberFromV8Object<IDLUnsignedLong, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[0].Get(isolate), has_bitrate_, member_bitrate_, try_block, exception_state)) {
  return;
}
exception_context_scope.ChangePropertyNameAsOptimizationHack("channels");
if (!bindings::GetDictionaryMemberFromV8Object<IDLString, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[1].Get(isolate), has_channels_, member_channels_, try_block, exception_state)) {
  return;
}
...
if (!bindings::GetDictionaryMemberFromV8Object<IDLUnsignedLong, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[3].Get(isolate), has_samplerate_, member_samplerate_, try_block, exception_state)) {
  return;
}
if (RuntimeEnabledFeatures::MediaCapabilitiesSpatialAudioEnabled()) {
  exception_context_scope.ChangePropertyNameAsOptimizationHack("spatialRendering");
if (!bindings::GetDictionaryMemberFromV8Object<IDLBoolean, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[4].Get(isolate), has_spatial_rendering_, member_spatial_rendering_, try_block, exception_state)) {
  return;
}
}
}
