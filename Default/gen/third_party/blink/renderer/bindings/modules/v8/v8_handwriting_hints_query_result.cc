...
if (!bindings::GetDictionaryMemberFromV8Object<IDLBoolean, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[0].Get(isolate), has_alternatives_, member_alternatives_, try_block, exception_state)) {
  return;
}
exception_context_scope.ChangePropertyNameAsOptimizationHack("inputType");
if (!bindings::GetDictionaryMemberFromV8Object<IDLSequence<V8HandwritingInputType>, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[1].Get(isolate), has_input_type_, member_input_type_, try_block, exception_state)) {
  return;
}
exception_context_scope.ChangePropertyNameAsOptimizationHack("recognitionType");
if (!bindings::GetDictionaryMemberFromV8Object<IDLSequence<V8HandwritingRecognitionType>, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[2].Get(isolate), has_recognition_type_, member_recognition_type_, try_block, exception_state)) {
  return;
}
exception_context_scope.ChangePropertyNameAsOptimizationHack("textContext");
if (!bindings::GetDictionaryMemberFromV8Object<IDLBoolean, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[3].Get(isolate), has_text_context_, member_text_context_, try_block, exception_state)) {
  return;
}
}
