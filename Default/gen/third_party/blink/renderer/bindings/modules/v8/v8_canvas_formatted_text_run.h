...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_CANVAS_FORMATTED_TEXT_RUN_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_CANVAS_FORMATTED_TEXT_RUN_H_
...
class CanvasFormattedTextRun;
class ExecutionContext;
struct WrapperTypeInfo;

class MODULES_EXPORT V8CanvasFormattedTextRun final : public bindings::V8InterfaceBridge<V8CanvasFormattedTextRun, CanvasFormattedTextRun> {
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CanvasFormattedTextRun;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_CANVAS_FORMATTED_TEXT_RUN_H_
