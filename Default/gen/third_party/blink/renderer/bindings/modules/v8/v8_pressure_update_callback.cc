...
v8::Maybe<void> V8PressureUpdateCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const PressureRecord* arg1_changes, PressureObserver* arg2_observer) {
...
if (!ToV8Traits<PressureRecord>::ToV8(script_state, arg1_changes).ToLocal(&v8_arg1_changes)) {
  return v8::Nothing<void>();
}
...
v8::Maybe<void> V8PressureUpdateCallback::Construct(const PressureRecord* arg1_changes, PressureObserver* arg2_observer) {
  const char* const class_like_name = "PressureUpdateCallback";
...
void V8PressureUpdateCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const PressureRecord* arg1_changes, PressureObserver* arg2_observer) {
  v8::Isolate* isolate = GetIsolate();
