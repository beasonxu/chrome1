...
if (!bindings::GetDictionaryMemberFromV8Object<IDLSequence<LockInfo>, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[0].Get(isolate), has_held_, member_held_, try_block, exception_state)) {
  return;
}
exception_context_scope.ChangePropertyNameAsOptimizationHack("pending");
if (!bindings::GetDictionaryMemberFromV8Object<IDLSequence<LockInfo>, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[1].Get(isolate), has_pending_, member_pending_, try_block, exception_state)) {
  return;
}
}
