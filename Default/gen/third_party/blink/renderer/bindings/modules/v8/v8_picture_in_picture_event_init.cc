...
if (!bindings::GetDictionaryMemberFromV8Object<PictureInPictureWindow, is_required>(isolate, current_context, v8_dictionary, v8_own_member_names[0].Get(isolate), fallback_presence_var, member_picture_in_picture_window_, try_block, exception_state)) {
  return;
}
}
