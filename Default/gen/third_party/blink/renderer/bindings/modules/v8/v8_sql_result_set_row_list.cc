...
const WrapperTypeInfo& SQLResultSetRowList::wrapper_type_info_ =
    V8SQLResultSetRowList::wrapper_type_info_;
...
instance_object_template->SetHandler(
    v8::IndexedPropertyHandlerConfiguration(
        ...
        nullptr,  // query
        V8SQLResultSetRowList::IndexedPropertyDeleterCallback,
        V8SQLResultSetRowList::IndexedPropertyEnumeratorCallback,
...
void V8SQLResultSetRowList::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template, v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template) {
...
void V8SQLResultSetRowList::InstallContextDependentProperties(v8::Local<v8::Context> context, const DOMWrapperWorld& world, v8::Local<v8::Object> instance_object, v8::Local<v8::Object> prototype_object, v8::Local<v8::Object> interface_object, v8::Local<v8::Template> interface_template, FeatureSelector feature_selector) {
  using bindings::IDLMemberInstaller;
