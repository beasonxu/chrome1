...
if (!bindings::GetDictionaryMemberFromV8Object<IDLSequence<CookieListItem>, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[0].Get(isolate), has_changed_, member_changed_, try_block, exception_state)) {
  return;
}
exception_context_scope.ChangePropertyNameAsOptimizationHack("deleted");
if (!bindings::GetDictionaryMemberFromV8Object<IDLSequence<CookieListItem>, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[1].Get(isolate), has_deleted_, member_deleted_, try_block, exception_state)) {
  return;
}
}
