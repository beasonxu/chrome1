...
if (!bindings::GetDictionaryMemberFromV8Object<IDLNullable<IDLBoolean>, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[0].Get(isolate), has_key_frame_, member_key_frame_, try_block, exception_state)) {
  return;
}
}
