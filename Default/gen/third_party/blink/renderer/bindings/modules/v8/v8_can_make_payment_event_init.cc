...
if (RuntimeEnabledFeatures::IdentityInCanMakePaymentEventFeatureEnabled()) {
  if (hasMethodData()) {
...
if (!bindings::GetDictionaryMemberFromV8Object<IDLSequence<PaymentMethodData>, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[0].Get(isolate), has_method_data_, member_method_data_, try_block, exception_state)) {
  return;
}
}
if (RuntimeEnabledFeatures::IdentityInCanMakePaymentEventFeatureEnabled()) {
...
if (!bindings::GetDictionaryMemberFromV8Object<IDLUSVString, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[2].Get(isolate), has_payment_request_origin_, member_payment_request_origin_, try_block, exception_state)) {
  return;
}
}
if (RuntimeEnabledFeatures::IdentityInCanMakePaymentEventFeatureEnabled()) {
  exception_context_scope.ChangePropertyNameAsOptimizationHack("topOrigin");
if (!bindings::GetDictionaryMemberFromV8Object<IDLUSVString, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[3].Get(isolate), has_top_origin_, member_top_origin_, try_block, exception_state)) {
  return;
}
}
}
