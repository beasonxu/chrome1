...
const WrapperTypeInfo& RTCEncodedAudioFrame::wrapper_type_info_ =
    V8RTCEncodedAudioFrame::wrapper_type_info_;
...
void V8RTCEncodedAudioFrame::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template, v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template) {
