...
kDisableNativeScroll, kPerformBeforeNativeScroll, kPerformAfterNativeScroll
};
...
explicit constexpr  V8NativeScrollBehavior(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
...
inline bool operator==(const V8NativeScrollBehavior& lhs, V8NativeScrollBehavior::Enum rhs) {
  return lhs.AsEnum() == rhs;
}

inline bool operator==(V8NativeScrollBehavior::Enum lhs, const V8NativeScrollBehavior& rhs) {
