...
bool V8AccessibleNodeList::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo& AccessibleNodeList::wrapper_type_info_ =
    V8AccessibleNodeList::wrapper_type_info_;
...
decltype(NativeValueTraits<IDLSequence<AccessibleNode>>::NativeValue(std::declval<v8::Isolate*>(), std::declval<v8::Local<v8::Value>>(), std::declval<ExceptionState&>())) arg1_nodes;
...
decltype(NativeValueTraits<IDLNullable<AccessibleNode>>::NativeValue(std::declval<v8::Isolate*>(), std::declval<v8::Local<v8::Value>>(), std::declval<ExceptionState&>())) arg2_before{nullptr};
...
instance_object_template->SetHandler(
    v8::IndexedPropertyHandlerConfiguration(
        ...
        V8AccessibleNodeList::IndexedPropertySetterCallback,
        nullptr,  // query
        V8AccessibleNodeList::IndexedPropertyDeleterCallback,
        V8AccessibleNodeList::IndexedPropertyEnumeratorCallback,
...
void V8AccessibleNodeList::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template, v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template) {
