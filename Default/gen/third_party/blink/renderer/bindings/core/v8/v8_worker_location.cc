...
const WrapperTypeInfo& WorkerLocation::wrapper_type_info_ =
    V8WorkerLocation::wrapper_type_info_;
...
void V8WorkerLocation::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template, v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template) {
