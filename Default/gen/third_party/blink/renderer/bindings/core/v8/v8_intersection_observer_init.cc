...
if (!bindings::GetDictionaryMemberFromV8Object<V8UnionDoubleOrDoubleSequence, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[3].Get(isolate), fallback_presence_var, member_threshold_, try_block, exception_state)) {
  return;
}
exception_context_scope.ChangePropertyNameAsOptimizationHack("trackVisibility");
if (!bindings::GetDictionaryMemberFromV8Object<IDLBoolean, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[4].Get(isolate), fallback_presence_var, member_track_visibility_, try_block, exception_state)) {
  return;
}
}
