...
kHTMLCanvasElement, kImageBitmap, kOffscreenCanvas
};
...
explicit  V8UnionHTMLCanvasElementOrImageBitmapOrOffscreenCanvas(HTMLCanvasElement* value) : content_type_(ContentType::kHTMLCanvasElement), member_html_canvas_element_(value) {
  DCHECK(value);
}
explicit  V8UnionHTMLCanvasElementOrImageBitmapOrOffscreenCanvas(ImageBitmap* value) : content_type_(ContentType::kImageBitmap), member_image_bitmap_(value) {
  DCHECK(value);
}
explicit  V8UnionHTMLCanvasElementOrImageBitmapOrOffscreenCanvas(OffscreenCanvas* value) : content_type_(ContentType::kOffscreenCanvas), member_offscreen_canvas_(value) {
  DCHECK(value);
}
...
static constexpr const char* UnionNameInIDL() {
  return "(HTMLCanvasElement or ImageBitmap or OffscreenCanvas)";
}
