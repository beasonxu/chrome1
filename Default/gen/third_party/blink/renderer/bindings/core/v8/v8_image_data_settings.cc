...
if (!bindings::GetDictionaryMemberFromV8Object<V8ImageDataStorageFormat, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[1].Get(isolate), fallback_presence_var, member_storage_format_, try_block, exception_state)) {
  return;
}
}
}
