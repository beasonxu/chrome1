...
return execution_context->IsWindow() && RuntimeEnabledFeatures::CloseWatcherEnabled();
}
...
void V8CloseWatcher::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template, v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template) {
