...
void V8Performance::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template, v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template) {
...
{"now", NowOperationCallback, 0, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect)}, 
...
if (is_cross_origin_isolated && (execution_context->IsWindow() || execution_context->IsServiceWorkerGlobalScope() || execution_context->IsSharedWorkerGlobalScope()) && (feature_selector.IsAll() && RuntimeEnabledFeatures::MeasureMemoryEnabled())) {
  static const IDLMemberInstaller::OperationConfig kOperationTable[] = {
