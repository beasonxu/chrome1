...
void LockScreenServiceProxy::SetData(
    const WTF::String& in_key, const WTF::String& in_data, SetDataCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void LockScreenServiceAsyncWaiter::SetData(
    const WTF::String& key, const WTF::String& data, LockScreenServiceStatus* out_status) {
  base::RunLoop loop;
