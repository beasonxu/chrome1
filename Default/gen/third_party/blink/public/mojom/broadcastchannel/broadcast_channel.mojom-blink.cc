...
void BroadcastChannelProviderInterceptorForTesting::ConnectToChannel(const WTF::String& name, ::mojo::PendingAssociatedRemote<BroadcastChannelClient> client, ::mojo::PendingAssociatedReceiver<BroadcastChannelClient> connection) {
