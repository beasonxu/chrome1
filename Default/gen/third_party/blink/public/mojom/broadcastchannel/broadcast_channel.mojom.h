...
// with not having this data in traces there.
  ...
  virtual void ConnectToChannel(const std::string& name, ::mojo::PendingAssociatedRemote<BroadcastChannelClient> client, ::mojo::PendingAssociatedReceiver<BroadcastChannelClient> connection) = 0;
};
...
class CONTENT_EXPORT BroadcastChannelProviderProxy
 ...
 public:
  ...
  void ConnectToChannel(const std::string& name, ::mojo::PendingAssociatedRemote<BroadcastChannelClient> client, ::mojo::PendingAssociatedReceiver<BroadcastChannelClient> connection) final;
