...
class DisplayCutoutSafeAreaDataView {
 public:
  DisplayCutoutSafeAreaDataView() = default;
...
struct Serializer<::blink::mojom::ViewportFit, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    return Traits::FromMojom(::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::blink::mojom::ViewportFit>(input)), output);
  }
};
...
struct Serializer<::blink::mojom::DisplayCutoutSafeAreaDataView, MaybeConstUserType> {
  ...
  static void Serialize(
      ...
      mojo::internal::MessageFragment<::blink::mojom::internal::DisplayCutoutSafeArea_Data>& fragment) {
  ...
  static bool Deserialize(::blink::mojom::internal::DisplayCutoutSafeArea_Data* input,
    ...
    ::blink::mojom::DisplayCutoutSafeAreaDataView data_view(input, message);
...
template <>
struct COMPONENT_EXPORT(MOJOM_SHARED_BLINK_COMMON_EXPORT) TraceFormatTraits<::blink::mojom::ViewportFit> {
