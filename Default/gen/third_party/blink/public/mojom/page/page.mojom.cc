...
size_t PageLifecycleState::Hash(size_t seed) const {
  ...
  seed = mojo::internal::Hash(seed, this->should_dispatch_pageshow_for_debugging);
  return seed;
}
