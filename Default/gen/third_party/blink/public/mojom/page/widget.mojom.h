...
// with not having this data in traces there.
  ...
  virtual void StartDragging(::blink::mojom::DragDataPtr drag_data, ::blink::DragOperationsMask operations_allowed, const ::SkBitmap& image, const ::gfx::Vector2d& bitmap_offset_in_dip, ::blink::mojom::DragEventSourceInfoPtr event_info) = 0;
};
...
class BLINK_COMMON_EXPORT FrameWidgetHostProxy
 ...
 public:
  ...
  void StartDragging(::blink::mojom::DragDataPtr drag_data, ::blink::DragOperationsMask operations_allowed, const ::SkBitmap& image, const ::gfx::Vector2d& bitmap_offset_in_dip, ::blink::mojom::DragEventSourceInfoPtr event_info) final;
