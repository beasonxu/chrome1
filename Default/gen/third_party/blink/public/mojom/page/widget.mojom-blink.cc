...
class FrameWidget_DragTargetDragEnter_ProxyToResponder : public ::mojo::internal::ProxyToResponder {
 ...
 private:
  ...
  void Run(
      ::ui::mojom::blink::DragOperation in_operation);
};
...
void FrameWidgetHostProxy::StartDragging(
    const ::blink::WebDragData& in_drag_data, ::blink::DragOperationsMask in_operations_allowed, const ::SkBitmap& in_image, const ::gfx::Vector2d& in_bitmap_offset_in_dip, ::blink::mojom::blink::DragEventSourceInfoPtr in_event_info) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("event_info"), in_event_info,
                        "<value of type ::blink::mojom::blink::DragEventSourceInfoPtr>");
   });
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
,
             ::ui::mojom::blink::DragOperation operation) {*out_operation = std::move(operation);
            loop->Quit();
          },
          &loop,
          out_operation));
...
void FrameWidgetHostInterceptorForTesting::StartDragging(const ::blink::WebDragData& drag_data, ::blink::DragOperationsMask operations_allowed, const ::SkBitmap& image, const ::gfx::Vector2d& bitmap_offset_in_dip, ::blink::mojom::blink::DragEventSourceInfoPtr event_info) {
