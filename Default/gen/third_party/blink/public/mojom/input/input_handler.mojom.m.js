...
import {
  SynchronousCompositorRemote as blink_mojom_SynchronousCompositorRemote,
  SynchronousCompositorPendingReceiver as blink_mojom_SynchronousCompositorPendingReceiver,
  SynchronousCompositorControlHostRemote as blink_mojom_SynchronousCompositorControlHostRemote,
  SynchronousCompositorControlHostPendingReceiver as blink_mojom_SynchronousCompositorControlHostPendingReceiver,
  SynchronousCompositorHostRemote as blink_mojom_SynchronousCompositorHostRemote,
  SynchronousCompositorHostPendingReceiver as blink_mojom_SynchronousCompositorHostPendingReceiver
} from './synchronous_compositor.mojom.m.js';
...
export class WidgetInputHandlerInterface {
  ...
  /**
   * @param { !blink_mojom_SynchronousCompositorControlHostRemote } controlHost
   * @param { !Object } host
   * @param { !Object } compositorRequest
   */
...
export class WidgetInputHandlerRemote {
  ...
  attachSynchronousCompositor(
    ...
    this.proxy.sendMessage(
        12,
        WidgetInputHandler_AttachSynchronousCompositor_ParamsSpec.$,
        null,
        [
          controlHost,
          host,
...
export class WidgetInputHandlerReceiver {
  ...
  constructor(impl) {
    ...
    this.helper_internal_.registerHandler(
        ...
        WidgetInputHandler_AttachSynchronousCompositor_ParamsSpec.$,
        null,
        impl.attachSynchronousCompositor.bind(impl));
    this.helper_internal_.registerHandler(
        13,
        WidgetInputHandler_GetFrameWidgetInputHandler_ParamsSpec.$,
        null,
...
export class WidgetInputHandlerCallbackRouter {
  constructor() {
     ...
     * @public {!mojo.internal.interfaceSupport.InterfaceCallbackReceiver}
     */
    this.attachSynchronousCompositor =
        new mojo.internal.interfaceSupport.InterfaceCallbackReceiver(
            this.router_);
    ...
    this.helper_internal_.registerHandler(
        ...
        WidgetInputHandler_AttachSynchronousCompositor_ParamsSpec.$,
        null,
        this.attachSynchronousCompositor.createReceiverHandler(false /* expectsResponse */));
    /**
     * @public {!mojo.internal.interfaceSupport.InterfaceCallbackReceiver}
     */
 ...
 * @const { {$:!mojo.internal.MojomType}}
 */
export const WidgetInputHandler_AttachSynchronousCompositor_ParamsSpec =
    { $: /** @type {!mojo.internal.MojomType} */ ({}) };
...
mojo.internal.Struct(
    WidgetInputHandler_AttachSynchronousCompositor_ParamsSpec.$,
    'WidgetInputHandler_AttachSynchronousCompositor_Params',
    [
      mojo.internal.StructField(
        'controlHost', 0,
        0,
        mojo.internal.InterfaceProxy(blink_mojom_SynchronousCompositorControlHostRemote),
        null,
        false /* nullable */,
        0),
      mojo.internal.StructField(
        'host', 8,
        0,
        mojo.internal.AssociatedInterfaceProxy(blink_mojom_SynchronousCompositorHostRemote),
        null,
        false /* nullable */,
        0),
      mojo.internal.StructField(
        'compositorRequest', 16,
        0,
        mojo.internal.AssociatedInterfaceRequest(blink_mojom_SynchronousCompositorPendingReceiver),
        null,
        false /* nullable */,
        0),
    ],
 ...
 * @record
 */
export class WidgetInputHandler_AttachSynchronousCompositor_Params {
  constructor() {
    /** @type { !blink_mojom_SynchronousCompositorControlHostRemote } */
    this.controlHost;
    /** @type { !Object } */
    this.host;
    /** @type { !Object } */
