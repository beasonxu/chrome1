...
#ifndef THIRD_PARTY_BLINK_PUBLIC_MOJOM_INPUT_SYNCHRONOUS_COMPOSITOR_MOJOM_BLINK_JUMBO_H_
#define THIRD_PARTY_BLINK_PUBLIC_MOJOM_INPUT_SYNCHRONOUS_COMPOSITOR_MOJOM_BLINK_JUMBO_H_
...
void SynchronousCompositorProxy::ReclaimResources(
    uint32_t in_layer_tree_frame_sink_id, WTF::Vector<::viz::ReturnedResource> in_resources) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void SynchronousCompositorProxy::BeginFrame(
    const ::viz::BeginFrameArgs& in_args, const WTF::HashMap<uint32_t, ::viz::FrameTimingDetails>& in_timing_details) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
std::move(p_offset));
    ...
    case internal::kSynchronousCompositor_BeginFrame_Name: {
      ...
      WTF::HashMap<uint32_t, ::viz::FrameTimingDetails> p_timing_details{};
...
bool SynchronousCompositorRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::blink::mojom::blink::SynchronousCompositor::Name_;
...
bool SynchronousCompositorHostRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::blink::mojom::blink::SynchronousCompositorHost::Name_;
...
bool SynchronousCompositorControlHostRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::blink::mojom::blink::SynchronousCompositorControlHost::Name_;
...
void SynchronousCompositorInterceptorForTesting::ReclaimResources(uint32_t layer_tree_frame_sink_id, WTF::Vector<::viz::ReturnedResource> resources) {
...
void SynchronousCompositorInterceptorForTesting::BeginFrame(const ::viz::BeginFrameArgs& args, const WTF::HashMap<uint32_t, ::viz::FrameTimingDetails>& timing_details) {
