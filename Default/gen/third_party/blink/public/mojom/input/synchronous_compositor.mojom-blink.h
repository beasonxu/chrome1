...
// with not having this data in traces there.
  ...
  virtual void ReclaimResources(uint32_t layer_tree_frame_sink_id, WTF::Vector<::viz::ReturnedResource> resources) = 0;
...
class PLATFORM_EXPORT SynchronousCompositorProxy
 ...
 public:
  ...
  void ReclaimResources(uint32_t layer_tree_frame_sink_id, WTF::Vector<::viz::ReturnedResource> resources) final;
