...
class BLINK_COMMON_EXPORT SynchronousCompositorInterceptorForTesting : public SynchronousCompositor {
...
class BLINK_COMMON_EXPORT SynchronousCompositorAsyncWaiter {
 public:
...
class BLINK_COMMON_EXPORT SynchronousCompositorHostInterceptorForTesting : public SynchronousCompositorHost {
...
class BLINK_COMMON_EXPORT SynchronousCompositorHostAsyncWaiter {
 public:
...
class BLINK_COMMON_EXPORT SynchronousCompositorControlHostInterceptorForTesting : public SynchronousCompositorControlHost {
...
class BLINK_COMMON_EXPORT SynchronousCompositorControlHostAsyncWaiter {
 public:
