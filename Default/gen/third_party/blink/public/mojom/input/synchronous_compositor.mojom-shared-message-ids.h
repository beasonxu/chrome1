...
constexpr uint32_t kSynchronousCompositor_OnCompositorFrameTransitionDirectiveProcessed_Name = 9;
constexpr uint32_t kSynchronousCompositor_SetScroll_Name = 10;
constexpr uint32_t kSynchronousCompositor_BeginFrame_Name = 11;
constexpr uint32_t kSynchronousCompositor_SetBeginFrameSourcePaused_Name = 12;
