...
class BLINK_COMMON_EXPORT WidgetInputHandlerHost
...
class BLINK_COMMON_EXPORT FrameWidgetInputHandler
...
class BLINK_COMMON_EXPORT WidgetInputHandler
...
// with not having this data in traces there.
  ...
  virtual void ImeSetComposition(const ::std::u16string& text, const std::vector<::ui::ImeTextSpan>& ime_text_spans, const ::gfx::Range& range, int32_t start, int32_t end, ImeSetCompositionCallback callback) = 0;


  using ImeCommitTextCallback = base::OnceCallback<void()>;
  
  virtual void ImeCommitText(const ::std::u16string& text, const std::vector<::ui::ImeTextSpan>& ime_text_spans, const ::gfx::Range& range, int32_t relative_cursor_position, ImeCommitTextCallback callback) = 0;
  ...
  virtual void AttachSynchronousCompositor(::mojo::PendingRemote<::blink::mojom::SynchronousCompositorControlHost> control_host, ::mojo::PendingAssociatedRemote<::blink::mojom::SynchronousCompositorHost> host, ::mojo::PendingAssociatedReceiver<::blink::mojom::SynchronousCompositor> compositor_request) = 0;
...
class BLINK_COMMON_EXPORT WidgetInputHandlerProxy
 ...
 public:
  ...
  void ImeSetComposition(const ::std::u16string& text, const std::vector<::ui::ImeTextSpan>& ime_text_spans, const ::gfx::Range& range, int32_t start, int32_t end, ImeSetCompositionCallback callback) final;
  
  void ImeCommitText(const ::std::u16string& text, const std::vector<::ui::ImeTextSpan>& ime_text_spans, const ::gfx::Range& range, int32_t relative_cursor_position, ImeCommitTextCallback callback) final;
  ...
  void AttachSynchronousCompositor(::mojo::PendingRemote<::blink::mojom::SynchronousCompositorControlHost> control_host, ::mojo::PendingAssociatedRemote<::blink::mojom::SynchronousCompositorHost> host, ::mojo::PendingAssociatedReceiver<::blink::mojom::SynchronousCompositor> compositor_request) final;
...
template <>
struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::KeyData::DataView,
...
template <>
struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::PointerData::DataView,
...
template <>
struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::WheelData::DataView,
...
template <>
struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::MouseData::DataView,
...
template <>
struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::ScrollUpdate::DataView,
                                         ::blink::mojom::ScrollUpdatePtr> {
  ...
  static decltype(::blink::mojom::ScrollUpdate::velocity_x) velocity_x(
      const ::blink::mojom::ScrollUpdatePtr& input) {
    return input->velocity_x;
  }

  static decltype(::blink::mojom::ScrollUpdate::velocity_y) velocity_y(
      const ::blink::mojom::ScrollUpdatePtr& input) {
...
template <>
struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::ScrollData::DataView,
  ...
  static const decltype(::blink::mojom::ScrollData::update_details)& update_details(
      const ::blink::mojom::ScrollDataPtr& input) {
...
template <>
struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::PinchBeginData::DataView,
...
template <>
struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::PinchUpdateData::DataView,
...
template <>
struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::PinchEndData::DataView,
...
template <>
struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::FlingData::DataView,
...
template <>
struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::TapData::DataView,
...
template <>
struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::GestureData::DataView,
...
template <>
struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::TouchPoint::DataView,
...
template <>
struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::TouchData::DataView,
...
template <>
struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::Event::DataView,
...
template <>
struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::DidOverscrollParams::DataView,
...
template <>
struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::TouchActionOptional::DataView,
  ...
  static decltype(::blink::mojom::TouchActionOptional::touch_action) touch_action(
...
template <>
struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::EditCommand::DataView,
...
template <>
struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::SelectAroundCaretResult::DataView,
