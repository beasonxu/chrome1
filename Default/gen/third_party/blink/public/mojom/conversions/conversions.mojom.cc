...
void ConversionHostProxy::RegisterDataHost(
    ::mojo::PendingReceiver<::blink::mojom::AttributionDataHost> in_data_host) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("data_host"), in_data_host,
                        "<value of type ::mojo::PendingReceiver<::blink::mojom::AttributionDataHost>>");
   });
#endif
...
void ConversionHostInterceptorForTesting::RegisterNavigationDataHost(::mojo::PendingReceiver<::blink::mojom::AttributionDataHost> data_host, const ::blink::AttributionSrcToken& attribution_src_token) {
