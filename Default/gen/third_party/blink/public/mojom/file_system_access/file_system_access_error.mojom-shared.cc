...
bool FileSystemAccessError_Data::Validate(
  ...
  [[maybe_unused]] const FileSystemAccessError_Data* object =
      static_cast<const FileSystemAccessError_Data*>(data);
...
// static
void TraceFormatTraits<::blink::mojom::FileSystemAccessStatus>::WriteIntoTrace(
