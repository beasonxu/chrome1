 ...
 public:
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        FileSystemAccessError::DataView, std::vector<uint8_t>>(input);
  }
...
template <>
struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::FileSystemAccessError::DataView,
  ...
  static decltype(::blink::mojom::FileSystemAccessError::status) status(
      const ::blink::mojom::FileSystemAccessErrorPtr& input) {
    return input->status;
  }

  static decltype(::blink::mojom::FileSystemAccessError::file_error) file_error(
      const ::blink::mojom::FileSystemAccessErrorPtr& input) {
    return input->file_error;
  }

  static const decltype(::blink::mojom::FileSystemAccessError::message)& message(
      const ::blink::mojom::FileSystemAccessErrorPtr& input) {
