...
static_assert(sizeof(IdleMonitor_Update_Params_Data) == 24,
...
static_assert(sizeof(IdleManager_AddMonitor_Params_Data) == 16,
...
static_assert(sizeof(IdleManager_AddMonitor_ResponseParams_Data) == 24,
...
class IdleManager_AddMonitor_ResponseParamsDataView {
 public:
  ...
  [[nodiscard]] bool ReadError(UserType* output) const {
    ...
    return mojo::internal::Deserialize<::blink::mojom::IdleManagerError>(
        data_value, output);
  }
  IdleManagerError error() const {
    return ::mojo::internal::ToKnownEnumValueHelper(
          static_cast<::blink::mojom::IdleManagerError>(data_->error));
  }
  inline void GetStateDataView(
      IdleStateDataView* output);
...
static_assert(
    mojo::internal::IsValidUserTypeForOptionalValue<
        ::blink::mojom::IdleStateDataView, UserType>(),
