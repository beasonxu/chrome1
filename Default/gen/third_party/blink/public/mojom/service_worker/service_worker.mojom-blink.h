...
// with not having this data in traces there.
  ...
  virtual void InitializeGlobalScope(::mojo::PendingAssociatedRemote<ServiceWorkerHost> service_worker_host, ::blink::mojom::blink::ServiceWorkerRegistrationObjectInfoPtr registration_info, ::blink::mojom::blink::ServiceWorkerObjectInfoPtr service_worker_info, FetchHandlerExistence fetch_handler_existence, ::mojo::PendingReceiver<::blink::mojom::blink::ReportingObserver> reporting_observer_receiver, ::blink::mojom::blink::AncestorFrameType ancestor_frame_type) = 0;
...
class CORE_EXPORT ServiceWorkerProxy
 ...
 public:
  ...
  void InitializeGlobalScope(::mojo::PendingAssociatedRemote<ServiceWorkerHost> service_worker_host, ::blink::mojom::blink::ServiceWorkerRegistrationObjectInfoPtr registration_info, ::blink::mojom::blink::ServiceWorkerObjectInfoPtr service_worker_info, FetchHandlerExistence fetch_handler_existence, ::mojo::PendingReceiver<::blink::mojom::blink::ReportingObserver> reporting_observer_receiver, ::blink::mojom::blink::AncestorFrameType ancestor_frame_type) final;
