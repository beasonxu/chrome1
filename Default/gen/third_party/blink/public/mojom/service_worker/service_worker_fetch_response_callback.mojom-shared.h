...
class ServiceWorkerFetchEventTimingDataView {
 public:
  ...
  [[nodiscard]] bool ReadDispatchEventTime(UserType* output) {
  ...
  template <typename UserType>
  [[nodiscard]] bool ReadRespondWithSettledTime(UserType* output) {
...
struct Serializer<::blink::mojom::ServiceWorkerFetchEventTimingDataView, MaybeConstUserType> {
  ...
  static void Serialize(
      ...
      mojo::internal::MessageFragment<::blink::mojom::internal::ServiceWorkerFetchEventTiming_Data>& fragment) {
    if (CallIsNullIfExists<Traits>(input))
      return;
    fragment.Allocate();
    decltype(Traits::dispatch_event_time(input)) in_dispatch_event_time = Traits::dispatch_event_time(input);
    mojo::internal::MessageFragment<
        typename decltype(fragment->dispatch_event_time)::BaseType> dispatch_event_time_fragment(
            fragment.message());
    mojo::internal::Serialize<::mojo_base::mojom::TimeTicksDataView>(
        in_dispatch_event_time, dispatch_event_time_fragment);
    fragment->dispatch_event_time.Set(
        dispatch_event_time_fragment.is_null() ? nullptr : dispatch_event_time_fragment.data());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        fragment->dispatch_event_time.is_null(),
    ...
    mojo::internal::MessageFragment<
        typename decltype(fragment->respond_with_settled_time)::BaseType> respond_with_settled_time_fragment(
            fragment.message());
    mojo::internal::Serialize<::mojo_base::mojom::TimeTicksDataView>(
        in_respond_with_settled_time, respond_with_settled_time_fragment);
    fragment->respond_with_settled_time.Set(
        respond_with_settled_time_fragment.is_null() ? nullptr : respond_with_settled_time_fragment.data());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        fragment->respond_with_settled_time.is_null(),
        mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER,
