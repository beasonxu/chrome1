...
static_assert(sizeof(ServiceWorkerContainerInfoForClient_Data) == 24,
              "Bad sizeof(ServiceWorkerContainerInfoForClient_Data)");
// Used by ServiceWorkerContainerInfoForClient::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView>
struct ServiceWorkerContainerInfoForClient_UnserializedMessageContext
    : public mojo::internal::UnserializedMessageContext {
 public:
  static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

  ServiceWorkerContainerInfoForClient_UnserializedMessageContext(
...
const mojo::internal::UnserializedMessageContext::Tag
    ServiceWorkerContainerInfoForClient_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
