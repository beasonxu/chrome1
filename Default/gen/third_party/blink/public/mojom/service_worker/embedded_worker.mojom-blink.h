...
// with not having this data in traces there.
  ...
  virtual void OnStarted(::blink::mojom::blink::ServiceWorkerStartStatus status, ::blink::mojom::blink::ServiceWorkerFetchHandlerType fetch_handler_type, int32_t thread_id, EmbeddedWorkerStartTimingPtr start_timing) = 0;
...
class CORE_EXPORT EmbeddedWorkerInstanceHostProxy
 ...
 public:
  ...
  void OnStarted(::blink::mojom::blink::ServiceWorkerStartStatus status, ::blink::mojom::blink::ServiceWorkerFetchHandlerType fetch_handler_type, int32_t thread_id, EmbeddedWorkerStartTimingPtr start_timing) final;
