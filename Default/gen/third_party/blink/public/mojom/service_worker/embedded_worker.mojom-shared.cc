...
bool EmbeddedWorkerStartParams_Data::Validate(
  ...
  [[maybe_unused]] const EmbeddedWorkerStartParams_Data* object =
      static_cast<const EmbeddedWorkerStartParams_Data*>(data);
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->forced_enabled_runtime_features, 14, validation_context)) {
    return false;
  }
  const mojo::internal::ContainerValidateParams forced_enabled_runtime_features_validate_params(
      0, false, new mojo::internal::ContainerValidateParams(0, false, nullptr));
  if (!mojo::internal::ValidateContainer(object->forced_enabled_runtime_features, validation_context,
                                         &forced_enabled_runtime_features_validate_params)) {
    return false;
  }

  if (!mojo::internal::ValidateHandleOrInterfaceNonNullable(
          object->service_worker_receiver, 15, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidateHandleOrInterfaceNonNullable(
          object->interface_provider, 16, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidateHandleOrInterfaceNonNullable(
          object->controller_receiver, 17, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidateHandleOrInterfaceNonNullable(
          object->instance_host, 19, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->provider_info, 20, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidateHandleOrInterfaceNonNullable(
          object->content_settings_proxy, 21, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidateHandleOrInterfaceNonNullable(
          object->preference_watcher_receiver, 22, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->subresource_loader_factories, 23, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidateHandleOrInterfaceNonNullable(
          object->subresource_loader_updater, 24, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->service_worker_token, 25, validation_context)) {
    return false;
  }
...
bool EmbeddedWorkerStartTiming_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const EmbeddedWorkerStartTiming_Data* object =
      static_cast<const EmbeddedWorkerStartTiming_Data*>(data);
