...
class CORE_EXPORT ControllerServiceWorkerInterceptorForTesting : public ControllerServiceWorker {
  ...
  void Clone(::mojo::PendingReceiver<ControllerServiceWorker> receiver, const ::network::CrossOriginEmbedderPolicy& cross_origin_embedder_policy, ::mojo::PendingRemote<::network::mojom::blink::CrossOriginEmbedderPolicyReporter> coep_reporter) override;
};
