...
struct Serializer<::blink::mojom::FetchHandlerExistence, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    return Traits::FromMojom(::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::blink::mojom::FetchHandlerExistence>(input)), output);
  }
};
...
struct Serializer<::blink::mojom::ExtendableMessageEventDataView, MaybeConstUserType> {
  ...
  static void Serialize(
      ...
      mojo::internal::MessageFragment<::blink::mojom::internal::ExtendableMessageEvent_Data>& fragment) {
    ...
    mojo::internal::MessageFragment<
        typename decltype(fragment->source_info_for_client)::BaseType> source_info_for_client_fragment(
            fragment.message());
    mojo::internal::Serialize<::blink::mojom::ServiceWorkerClientInfoDataView>(
        in_source_info_for_client, source_info_for_client_fragment);
    fragment->source_info_for_client.Set(
        source_info_for_client_fragment.is_null() ? nullptr : source_info_for_client_fragment.data());
    ...
    mojo::internal::MessageFragment<
        typename decltype(fragment->source_info_for_service_worker)::BaseType> source_info_for_service_worker_fragment(
            fragment.message());
    mojo::internal::Serialize<::blink::mojom::ServiceWorkerObjectInfoDataView>(
        in_source_info_for_service_worker, source_info_for_service_worker_fragment);
...
template <>
struct COMPONENT_EXPORT(MOJOM_SHARED_BLINK_COMMON_EXPORT) TraceFormatTraits<::blink::mojom::FetchHandlerExistence> {
