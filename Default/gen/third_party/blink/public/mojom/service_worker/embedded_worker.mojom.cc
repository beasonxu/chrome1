...
void EmbeddedWorkerInstanceHostProxy::OnStarted(
    ::blink::mojom::ServiceWorkerStartStatus in_status, ::blink::mojom::ServiceWorkerFetchHandlerType in_fetch_handler_type, int32_t in_thread_id, EmbeddedWorkerStartTimingPtr in_start_timing) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void EmbeddedWorkerInstanceHostInterceptorForTesting::OnStarted(::blink::mojom::ServiceWorkerStartStatus status, ::blink::mojom::ServiceWorkerFetchHandlerType fetch_handler_type, int32_t thread_id, EmbeddedWorkerStartTimingPtr start_timing) {
