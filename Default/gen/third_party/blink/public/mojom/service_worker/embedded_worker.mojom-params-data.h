...
static_assert(sizeof(EmbeddedWorkerInstanceHost_OnStarted_Params_Data) == 32,
...
class EmbeddedWorkerInstanceHost_OnStarted_ParamsDataView {
 public:
  ...
  ::blink::mojom::ServiceWorkerStartStatus status() const {
    return ::mojo::internal::ToKnownEnumValueHelper(
          static_cast<::blink::mojom::ServiceWorkerStartStatus>(data_->status));
  }
  template <typename UserType>
  ...
  template <typename UserType>
  [[nodiscard]] bool ReadStartTiming(UserType* output) {
...
class EmbeddedWorkerInstanceHost_OnReportConsoleMessage_ParamsDataView {
 public:
  ...
  ::blink::mojom::ConsoleMessageSource source() const {
    return ::mojo::internal::ToKnownEnumValueHelper(
          static_cast<::blink::mojom::ConsoleMessageSource>(data_->source));
  }
  template <typename UserType>
  [[nodiscard]] bool ReadMessageLevel(UserType* output) const {
  ...
  ::blink::mojom::ConsoleMessageLevel message_level() const {
    return ::mojo::internal::ToKnownEnumValueHelper(
          static_cast<::blink::mojom::ConsoleMessageLevel>(data_->message_level));
  }
