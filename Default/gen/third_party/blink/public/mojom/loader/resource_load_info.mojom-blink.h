...
struct blink_mojom_internal_ResourceType_DataHashFn {
  ...
  static bool Equal(const ::blink::mojom::ResourceType& left, const ::blink::mojom::ResourceType& right) {
    return left == right;
  }
...
struct HashTraits<::blink::mojom::ResourceType>
    : public GenericHashTraits<::blink::mojom::ResourceType> {
  static_assert(true,
  ...
  static void ConstructDeletedValue(::blink::mojom::ResourceType& slot, bool) {
    slot = static_cast<::blink::mojom::ResourceType>(-1000001);
  }
  static bool IsDeletedValue(const ::blink::mojom::ResourceType& value) {
    return value == static_cast<::blink::mojom::ResourceType>(-1000001);
  }
};
}  // namespace WTF
 ...
 public:
  ...
  static WTF::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        CommonNetworkInfo::DataView, WTF::Vector<uint8_t>>(input);
  }
...
RedirectInfo& operator=(const RedirectInfo&) = delete;
  ...
  static WTF::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        RedirectInfo::DataView, WTF::Vector<uint8_t>>(input);
  }
...
ResourceLoadInfo& operator=(const ResourceLoadInfo&) = delete;
  ...
  static WTF::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        ResourceLoadInfo::DataView, WTF::Vector<uint8_t>>(input);
  }
...
struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::ResourceLoadInfo::DataView,
  ...
  static decltype(::blink::mojom::blink::ResourceLoadInfo::raw_body_bytes) raw_body_bytes(
      const ::blink::mojom::blink::ResourceLoadInfoPtr& input) {
    return input->raw_body_bytes;
  }

  static decltype(::blink::mojom::blink::ResourceLoadInfo::total_received_bytes) total_received_bytes(
      const ::blink::mojom::blink::ResourceLoadInfoPtr& input) {
