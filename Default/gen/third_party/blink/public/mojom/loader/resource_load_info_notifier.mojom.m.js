...
export class ResourceLoadInfoNotifierRemote {
  ...
  notifyUpdateUserGestureCarryoverInfo() {
    this.proxy.sendMessage(
        0,
        ResourceLoadInfoNotifier_NotifyUpdateUserGestureCarryoverInfo_ParamsSpec.$,
        null,
        [
        ]);
  }
 ...
 */
export const ResourceLoadInfoNotifier_NotifyUpdateUserGestureCarryoverInfo_ParamsSpec =
 ...
 * @record
 */
export class ResourceLoadInfoNotifier_NotifyUpdateUserGestureCarryoverInfo_Params {
  constructor() {
  }
}
