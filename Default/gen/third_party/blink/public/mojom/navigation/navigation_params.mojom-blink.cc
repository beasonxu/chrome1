...
CommonNavigationParams::CommonNavigationParams(
    ...
    WTF::Vector<int32_t> initiator_origin_trial_features_in,
...
CommitNavigationParams::CommitNavigationParams(
    ...
    const ::blink::BlinkStorageKey& storage_key_in,
    bool is_overriding_user_agent_in,
    WTF::Vector<::blink::KURL> redirects_in,
    ...
    const WTF::String& post_content_type_in,
    const ::blink::KURL& original_url_in,
    const WTF::String& original_method_in,
    bool can_load_local_resources_in,
    const WTF::String& page_state_in,
    int32_t nav_entry_id_in,
    const WTF::HashMap<WTF::String, bool>& subframe_unique_names_in,
    ...
    WTF::Vector<::blink::mojom::blink::PrefetchedSignedExchangeInfoPtr> prefetched_signed_exchanges_in,
    const WTF::String& data_url_as_string_in,
    bool is_browser_initiated_in,
    const ::blink::KURL& web_bundle_physical_url_in,
    const ::blink::KURL& web_bundle_claimed_url_in,
    int64_t document_ukm_source_id_in,
    const ::blink::FramePolicy& frame_policy_in,
    WTF::Vector<WTF::String> force_enabled_origin_trials_in,
    bool origin_agent_cluster_in,
    bool origin_agent_cluster_left_as_default_in,
    WTF::Vector<::network::mojom::blink::WebClientHintsType> enabled_client_hints_in,
    ...
    WTF::Vector<::blink::KURL> early_hints_preloaded_resources_in,
    absl::optional<WTF::Vector<::blink::KURL>> ad_auction_components_in,
    ::blink::mojom::blink::FencedFrameReportingPtr fenced_frame_reporting_metadata_in,
    ::base::TimeTicks commit_sent_in,
    const WTF::String& srcdoc_value_in,
