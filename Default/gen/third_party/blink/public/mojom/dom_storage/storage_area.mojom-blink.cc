...
void StorageAreaObserverProxy::KeyChangeFailed(
    const WTF::Vector<uint8_t>& in_key, const WTF::String& in_source) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void StorageAreaObserverProxy::AllDeleted(
    bool in_was_nonempty, const WTF::String& in_source) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
class StorageArea_GetAll_HandleSyncResponse
 ...
 public:
  StorageArea_GetAll_HandleSyncResponse(
      bool* result, WTF::Vector<KeyValuePtr>* out_data)
...
void StorageAreaProxy::DeleteAll(
    const WTF::String& in_source, ::mojo::PendingRemote<StorageAreaObserver> in_new_observer, DeleteAllCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
bool StorageAreaProxy::GetAll(
    ::mojo::PendingRemote<StorageAreaObserver> param_new_observer, WTF::Vector<KeyValuePtr>* out_param_data) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT_BEGIN1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("data"), out_param_data,
                        "<value of type WTF::Vector<KeyValuePtr>>");
   });
#endif
  return result;
}
...
class StorageArea_GetAll_ProxyToResponder : public ::mojo::internal::ProxyToResponder {
 ...
 private:
  ...
  void Run(
      WTF::Vector<KeyValuePtr> in_data);
};
...
void StorageAreaAsyncWaiter::GetAll(
    ::mojo::PendingRemote<StorageAreaObserver> new_observer, WTF::Vector<KeyValuePtr>* out_data) {
  base::RunLoop loop;
...
,
             WTF::Vector<KeyValuePtr> data) {*out_data = std::move(data);
            loop->Quit();
          },
          &loop,
          out_data));
