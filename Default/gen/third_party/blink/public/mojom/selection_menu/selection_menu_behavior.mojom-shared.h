...
struct Serializer<::blink::mojom::SelectionMenuBehavior, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    return Traits::FromMojom(::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::blink::mojom::SelectionMenuBehavior>(input)), output);
  }
};
...
template <>
struct COMPONENT_EXPORT(MOJOM_SHARED_BLINK_COMMON_EXPORT) TraceFormatTraits<::blink::mojom::SelectionMenuBehavior> {
