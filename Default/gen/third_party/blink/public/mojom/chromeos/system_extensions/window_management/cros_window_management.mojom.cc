...
AcceleratorEvent::AcceleratorEvent(
    ...
    const std::string& accelerator_name_in,
    bool repeat_in)
...
class CrosWindowManagement_GetAllWindows_ProxyToResponder : public ::mojo::internal::ProxyToResponder {
 ...
 private:
  ...
  void Run(
      std::vector<CrosWindowInfoPtr> in_result);
};
...
bool CrosWindowManagement_GetAllWindows_ForwardToCallback::Accept(
  ...
  bool success = true;
  std::vector<CrosWindowInfoPtr> p_result{};
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("result"), in_result,
                        "<value of type std::vector<CrosWindowInfoPtr>>");
   });
#endif
...
class CrosWindowManagement_GetAllScreens_ProxyToResponder : public ::mojo::internal::ProxyToResponder {
 ...
 private:
  ...
  void Run(
      std::vector<CrosScreenInfoPtr> in_screens);
};
...
bool CrosWindowManagement_GetAllScreens_ForwardToCallback::Accept(
  ...
  bool success = true;
  std::vector<CrosScreenInfoPtr> p_screens{};
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("screens"), in_screens,
                        "<value of type std::vector<CrosScreenInfoPtr>>");
   });
#endif
...
bool CrosWindowManagementStartObserverRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::blink::mojom::CrosWindowManagementStartObserver::Name_;
...
bool StructTraits<::blink::mojom::CrosWindowInfo::DataView, ::blink::mojom::CrosWindowInfoPtr>::Read(
    ::blink::mojom::CrosWindowInfo::DataView input,
    ::blink::mojom::CrosWindowInfoPtr* output) {
  bool success = true;
...
bool StructTraits<::blink::mojom::CrosScreenInfo::DataView, ::blink::mojom::CrosScreenInfoPtr>::Read(
    ::blink::mojom::CrosScreenInfo::DataView input,
    ::blink::mojom::CrosScreenInfoPtr* output) {
  bool success = true;
...
bool StructTraits<::blink::mojom::AcceleratorEvent::DataView, ::blink::mojom::AcceleratorEventPtr>::Read(
    ::blink::mojom::AcceleratorEvent::DataView input,
    ::blink::mojom::AcceleratorEventPtr* output) {
  bool success = true;
  ...
  proxy_->GetAllWindows(
      base::BindOnce(
          [](base::RunLoop* loop,
             std::vector<CrosWindowInfoPtr>* out_result
,
             std::vector<CrosWindowInfoPtr> result) {*out_result = std::move(result);
            loop->Quit();
          },
          &loop,
          out_result));
  ...
  proxy_->GetAllScreens(
      base::BindOnce(
          [](base::RunLoop* loop,
             std::vector<CrosScreenInfoPtr>* out_screens
,
             std::vector<CrosScreenInfoPtr> screens) {*out_screens = std::move(screens);
            loop->Quit();
          },
          &loop,
          out_screens));
