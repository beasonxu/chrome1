...
class BLINK_COMMON_EXPORT PressureObserver
...
// with not having this data in traces there.
  ...
  virtual void OnUpdate(::device::mojom::PressureStatePtr state) = 0;
};
...
class BLINK_COMMON_EXPORT PressureService
...
class BLINK_COMMON_EXPORT PressureObserverProxy
 ...
 public:
  ...
  void OnUpdate(::device::mojom::PressureStatePtr state) final;
...
class BLINK_COMMON_EXPORT PressureQuantization {
 public:
  template <typename T>
  ...
  explicit PressureQuantization(
      std::vector<double> cpu_utilization_thresholds);
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        PressureQuantization::DataView, std::vector<uint8_t>>(input);
  }
...
template <>
struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::PressureQuantization::DataView,
                                         ::blink::mojom::PressureQuantizationPtr> {
  static bool IsNull(const ::blink::mojom::PressureQuantizationPtr& input) { return !input; }
  static void SetToNull(::blink::mojom::PressureQuantizationPtr* output) { output->reset(); }

  static const decltype(::blink::mojom::PressureQuantization::cpu_utilization_thresholds)& cpu_utilization_thresholds(
      const ::blink::mojom::PressureQuantizationPtr& input) {
    return input->cpu_utilization_thresholds;
  }

  static bool Read(::blink::mojom::PressureQuantization::DataView input, ::blink::mojom::PressureQuantizationPtr* output);
};
