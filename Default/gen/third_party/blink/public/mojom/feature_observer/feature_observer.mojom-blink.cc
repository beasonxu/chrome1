...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    "mojom", "Send blink::mojom::FeatureObserver::Register", "input_parameters",
...
ObservedFeatureAsyncWaiter::ObservedFeatureAsyncWaiter(
    ObservedFeature* proxy) : proxy_(proxy) {}
...
FeatureObserverAsyncWaiter::FeatureObserverAsyncWaiter(
    FeatureObserver* proxy) : proxy_(proxy) {}
