...
(function() {
  ...
  BrowsingTopicsDocumentService_GetBrowsingTopics_Params.encodedSize = codec.kStructHeaderSize + 0;
  ...
  BrowsingTopicsDocumentServiceProxy.prototype.getBrowsingTopics = function() {
  ...
  BrowsingTopicsDocumentServiceStub.prototype.getBrowsingTopics = function() {
    return this.delegate_ && this.delegate_.getBrowsingTopics && this.delegate_.getBrowsingTopics();
  }
  ...
  BrowsingTopicsDocumentServiceStub.prototype.acceptWithResponder =
    ...
    case kBrowsingTopicsDocumentService_GetBrowsingTopics_Name:
      ...
      this.getBrowsingTopics().then(function(response) {
        var responseParams =
