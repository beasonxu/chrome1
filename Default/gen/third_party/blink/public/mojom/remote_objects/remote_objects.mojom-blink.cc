...
class RemoteObject_GetMethods_HandleSyncResponse
 ...
 private:
  bool* result_;
  WTF::Vector<WTF::String>* out_method_names_;};
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("arguments"), param_arguments,
                        "<value of type WTF::Vector<RemoteInvocationArgumentPtr>>");
   });
#else
...
// static
bool StructTraits<::blink::mojom::blink::RemoteTypedArray::DataView, ::blink::mojom::blink::RemoteTypedArrayPtr>::Read(
    ::blink::mojom::blink::RemoteTypedArray::DataView input,
    ::blink::mojom::blink::RemoteTypedArrayPtr* output) {
  bool success = true;
  ::blink::mojom::blink::RemoteTypedArrayPtr result(::blink::mojom::blink::RemoteTypedArray::New());
...
bool UnionTraits<::blink::mojom::blink::RemoteInvocationArgument::DataView, ::blink::mojom::blink::RemoteInvocationArgumentPtr>::Read(
  ...
  switch (input.tag()) {
    ...
    case Tag::kTypedArrayValue: {
      ::blink::mojom::blink::RemoteTypedArrayPtr result_typed_array_value;
