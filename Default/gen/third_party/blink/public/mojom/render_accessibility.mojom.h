...
template <>
struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::LocationChanges::DataView,
                                         ::blink::mojom::LocationChangesPtr> {
  ...
  static decltype(::blink::mojom::LocationChanges::id) id(
      const ::blink::mojom::LocationChangesPtr& input) {
    return input->id;
  }

  static const decltype(::blink::mojom::LocationChanges::new_location)& new_location(
      const ::blink::mojom::LocationChangesPtr& input) {
...
template <>
struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::AXUpdatesAndEvents::DataView,
                                         ::blink::mojom::AXUpdatesAndEventsPtr> {
  ...
  static const decltype(::blink::mojom::AXUpdatesAndEvents::updates)& updates(
      const ::blink::mojom::AXUpdatesAndEventsPtr& input) {
    return input->updates;
  }

  static const decltype(::blink::mojom::AXUpdatesAndEvents::events)& events(
      const ::blink::mojom::AXUpdatesAndEventsPtr& input) {
    return input->events;
  }
