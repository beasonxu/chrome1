...
static_assert(sizeof(HitTestResponse_Data) == 40,
...
static_assert(sizeof(AXUpdatesAndEvents_Data) == 24,
              "Bad sizeof(AXUpdatesAndEvents_Data)");
// Used by AXUpdatesAndEvents::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView>
struct AXUpdatesAndEvents_UnserializedMessageContext
    : public mojo::internal::UnserializedMessageContext {
 public:
  static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

  AXUpdatesAndEvents_UnserializedMessageContext(
    uint32_t message_name,
    uint32_t message_flags,
    UserType input)
      : mojo::internal::UnserializedMessageContext(&kMessageTag, message_name, message_flags)
...
template <typename UserType, typename DataView>
const mojo::internal::UnserializedMessageContext::Tag
    AXUpdatesAndEvents_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
