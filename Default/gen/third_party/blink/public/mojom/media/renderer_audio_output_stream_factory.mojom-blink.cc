...
void RendererAudioOutputStreamFactoryProxy::RequestDeviceAuthorization(
    ::mojo::PendingReceiver<::media::mojom::blink::AudioOutputStreamProvider> in_stream_provider_receiver, const absl::optional<::base::UnguessableToken>& in_session_id, const WTF::String& in_device_id, RequestDeviceAuthorizationCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void RendererAudioOutputStreamFactoryInterceptorForTesting::RequestDeviceAuthorization(::mojo::PendingReceiver<::media::mojom::blink::AudioOutputStreamProvider> stream_provider_receiver, const absl::optional<::base::UnguessableToken>& session_id, const WTF::String& device_id, RequestDeviceAuthorizationCallback callback) {
...
,
             WTF::String* out_matched_device_id
,
             ::media::mojom::blink::OutputDeviceStatus state,
             const ::media::AudioParameters& output_params,
             const WTF::String& matched_device_id) {*out_state = std::move(state);*out_output_params = std::move(output_params);*out_matched_device_id = std::move(matched_device_id);
            loop->Quit();
          },
          &loop,
          out_state,
