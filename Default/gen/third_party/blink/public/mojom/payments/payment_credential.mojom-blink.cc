...
void PaymentCredentialInterceptorForTesting::StorePaymentCredential(const WTF::Vector<uint8_t>& credential_id, const WTF::String& rp_id, const WTF::Vector<uint8_t>& user_id, StorePaymentCredentialCallback callback) {
