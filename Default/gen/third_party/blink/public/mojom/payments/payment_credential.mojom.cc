...
void PaymentCredentialProxy::StorePaymentCredential(
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    "mojom", "Send payments::mojom::PaymentCredential::StorePaymentCredential", "input_parameters",
  ...
  mojo::internal::MessageFragment<
      ::payments::mojom::internal::PaymentCredential_StorePaymentCredential_Params_Data> params(
          message);
  params.Allocate();
  mojo::internal::MessageFragment<
...
void PaymentCredential_StorePaymentCredential_ProxyToResponder::Run(
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    "mojom", "Send reply payments::mojom::PaymentCredential::StorePaymentCredential", "async_response_parameters",
    [&](perfetto::TracedValue context){
      auto dict = std::move(context).WriteDictionary();
      perfetto::WriteIntoTracedValueWithFallback(
  ...
  mojo::Message message(
      internal::kPaymentCredential_StorePaymentCredential_Name, kFlags, 0, 0, nullptr);
  mojo::internal::MessageFragment<
      ::payments::mojom::internal::PaymentCredential_StorePaymentCredential_ResponseParams_Data> params(
          message);
  params.Allocate();
...
void PaymentCredentialInterceptorForTesting::StorePaymentCredential(const std::vector<uint8_t>& credential_id, const std::string& rp_id, const std::vector<uint8_t>& user_id, StorePaymentCredentialCallback callback) {
  GetForwardingInterface()->StorePaymentCredential(std::move(credential_id), std::move(rp_id), std::move(user_id), std::move(callback));
}
PaymentCredentialAsyncWaiter::PaymentCredentialAsyncWaiter(
    PaymentCredential* proxy) : proxy_(proxy) {}
