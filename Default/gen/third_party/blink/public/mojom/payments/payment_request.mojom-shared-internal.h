...
static_assert(sizeof(SecurePaymentConfirmationResponse_Data) == 40,
              "Bad sizeof(SecurePaymentConfirmationResponse_Data)");
// Used by SecurePaymentConfirmationResponse::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView>
struct SecurePaymentConfirmationResponse_UnserializedMessageContext
    : public mojo::internal::UnserializedMessageContext {
 public:
  static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

  SecurePaymentConfirmationResponse_UnserializedMessageContext(
    uint32_t message_name,
    uint32_t message_flags,
    UserType input)
      : mojo::internal::UnserializedMessageContext(&kMessageTag, message_name, message_flags)
...
template <typename UserType, typename DataView>
const mojo::internal::UnserializedMessageContext::Tag
    SecurePaymentConfirmationResponse_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
...
static_assert(sizeof(SecurePaymentConfirmationRequest_Data) == 72,
              "Bad sizeof(SecurePaymentConfirmationRequest_Data)");
// Used by SecurePaymentConfirmationRequest::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView>
struct SecurePaymentConfirmationRequest_UnserializedMessageContext
    : public mojo::internal::UnserializedMessageContext {
 public:
  static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

  SecurePaymentConfirmationRequest_UnserializedMessageContext(
    uint32_t message_name,
    uint32_t message_flags,
    UserType input)
      : mojo::internal::UnserializedMessageContext(&kMessageTag, message_name, message_flags)
...
template <typename UserType, typename DataView>
const mojo::internal::UnserializedMessageContext::Tag
    SecurePaymentConfirmationRequest_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
