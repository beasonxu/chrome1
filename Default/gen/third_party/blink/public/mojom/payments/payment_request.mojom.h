...
class BLINK_COMMON_EXPORT SecurePaymentConfirmationResponse {
 public:
  template <typename T>
  using EnableIfSame = std::enable_if_t<std::is_same<SecurePaymentConfirmationResponse, T>::value>;
  ...
  template <typename U>
  static SecurePaymentConfirmationResponsePtr From(const U& u) {
    return mojo::TypeConverter<SecurePaymentConfirmationResponsePtr, U>::Convert(u);
  }

  template <typename U>
  U To() const {
    return mojo::TypeConverter<U, SecurePaymentConfirmationResponse>::Convert(*this);
  }
...
SecurePaymentConfirmationResponse& operator=(const SecurePaymentConfirmationResponse&) = delete;
  ...
  // bindings generator does not need to know whether Clone() or copy
  // constructor/assignment are available for members.
  template <typename StructPtrType = SecurePaymentConfirmationResponsePtr>
  SecurePaymentConfirmationResponsePtr Clone() const;

  // Equals() is a template so it is only instantiated if it is used. Thus, the
  // bindings generator does not need to know whether Equals() or == operator
  // are available for members.
  template <typename T, SecurePaymentConfirmationResponse::EnableIfSame<T>* = nullptr>
  bool Equals(const T& other) const;
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        SecurePaymentConfirmationResponse::DataView, std::vector<uint8_t>>(input);
  }

  template <typename UserType>
  static mojo::Message SerializeAsMessage(UserType* input) {
    return mojo::internal::SerializeAsMessageImpl<
        SecurePaymentConfirmationResponse::DataView>(input);
  }
  ...
  static mojo::Message WrapAsMessage(UserType input) {
    return mojo::Message(std::make_unique<
        internal::SecurePaymentConfirmationResponse_UnserializedMessageContext<
            UserType, SecurePaymentConfirmationResponse::DataView>>(0, 0, std::move(input)),
        MOJO_CREATE_MESSAGE_FLAG_NONE);
  }
  ...
  static bool Deserialize(const void* data,
                          ...
                          UserType* output) {
    mojo::Message message;
    return mojo::internal::DeserializeImpl<SecurePaymentConfirmationResponse::DataView>(
        message, data, data_num_bytes, output, Validate);
  }
  ...
  static bool Deserialize(const std::vector<uint8_t>& input,
                          UserType* output) {
    return SecurePaymentConfirmationResponse::Deserialize(
        input.size() == 0 ? nullptr : &input.front(), input.size(), output);
  }
  ...
  static bool DeserializeFromMessage(mojo::Message input,
    ...
    auto context = input.TakeUnserializedContext<
        internal::SecurePaymentConfirmationResponse_UnserializedMessageContext<
            UserType, SecurePaymentConfirmationResponse::DataView>>();
    if (context) {
      *output = std::move(context->TakeData());
      return true;
    }
...
template <typename StructPtrType>
SecurePaymentConfirmationResponsePtr SecurePaymentConfirmationResponse::Clone() const {
  return New(
      mojo::Clone(credential_info),
...
template <typename T, SecurePaymentConfirmationResponse::EnableIfSame<T>*>
bool SecurePaymentConfirmationResponse::Equals(const T& other_struct) const {
...
struct BLINK_COMMON_EXPORT StructTraits<::payments::mojom::PaymentResponse::DataView,
  ...
  static const decltype(::payments::mojom::PaymentResponse::secure_payment_confirmation)& secure_payment_confirmation(
      const ::payments::mojom::PaymentResponsePtr& input) {
...
template <>
struct BLINK_COMMON_EXPORT StructTraits<::payments::mojom::SecurePaymentConfirmationResponse::DataView,
                                         ::payments::mojom::SecurePaymentConfirmationResponsePtr> {
  ...
  static const decltype(::payments::mojom::SecurePaymentConfirmationResponse::signature)& signature(
      const ::payments::mojom::SecurePaymentConfirmationResponsePtr& input) {
  ...
  static const decltype(::payments::mojom::SecurePaymentConfirmationResponse::user_handle)& user_handle(
      const ::payments::mojom::SecurePaymentConfirmationResponsePtr& input) {
