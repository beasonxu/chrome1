...
struct Serializer<::blink::mojom::FileSystemType, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    return Traits::FromMojom(::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::blink::mojom::FileSystemType>(input)), output);
  }
};
...
struct Serializer<::blink::mojom::FileSystemInfoDataView, MaybeConstUserType> {
  ...
  static void Serialize(
    ...
    mojo::internal::Serialize<::blink::mojom::FileSystemType>(
        Traits::mount_type(input), &fragment->mount_type);
  }
...
template <>
struct COMPONENT_EXPORT(MOJOM_SHARED_BLINK_COMMON_EXPORT) TraceFormatTraits<::blink::mojom::FileSystemType> {
