...
void ContentIndexServiceProxy::CheckOfflineCapability(
    int64_t in_service_worker_registration_id, const ::blink::KURL& in_launch_url, CheckOfflineCapabilityCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("descriptions"), in_descriptions,
                        "<value of type WTF::Vector<ContentDescriptionPtr>>");
   });
#endif
