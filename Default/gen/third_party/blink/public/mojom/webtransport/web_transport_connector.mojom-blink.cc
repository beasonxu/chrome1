...
void WebTransportConnectorProxy::Connect(
    const ::blink::KURL& in_url, WTF::Vector<::network::mojom::blink::WebTransportCertificateFingerprintPtr> in_fingerprints, ::mojo::PendingRemote<::network::mojom::blink::WebTransportHandshakeClient> in_client) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    "mojom", "Send blink::mojom::WebTransportConnector::Connect", "input_parameters",
...
void WebTransportConnectorInterceptorForTesting::Connect(const ::blink::KURL& url, WTF::Vector<::network::mojom::blink::WebTransportCertificateFingerprintPtr> fingerprints, ::mojo::PendingRemote<::network::mojom::blink::WebTransportHandshakeClient> client) {
  GetForwardingInterface()->Connect(std::move(url), std::move(fingerprints), std::move(client));
}
WebTransportConnectorAsyncWaiter::WebTransportConnectorAsyncWaiter(
    WebTransportConnector* proxy) : proxy_(proxy) {}
