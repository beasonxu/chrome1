...
void WebTransportConnectorInterceptorForTesting::Connect(const ::GURL& url, std::vector<::network::mojom::WebTransportCertificateFingerprintPtr> fingerprints, ::mojo::PendingRemote<::network::mojom::WebTransportHandshakeClient> client) {
