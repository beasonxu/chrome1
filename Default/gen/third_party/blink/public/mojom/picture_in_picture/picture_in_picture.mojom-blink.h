...
// with not having this data in traces there.
  ...
  virtual void Update(uint32_t player_id, ::mojo::PendingAssociatedRemote<::media::mojom::blink::MediaPlayer> player_remote, const ::viz::SurfaceId& surface_id, const ::gfx::Size& natural_size, bool show_play_pause_button) = 0;
...
// with not having this data in traces there.
  ...
  virtual void StartSession(uint32_t player_id, ::mojo::PendingAssociatedRemote<::media::mojom::blink::MediaPlayer> player_remote, const ::viz::SurfaceId& surface_id, const ::gfx::Size& natural_size, bool show_play_pause_button, ::mojo::PendingRemote<PictureInPictureSessionObserver> observer, const ::gfx::Rect& source_bounds, StartSessionCallback callback) = 0;
};
...
class PLATFORM_EXPORT PictureInPictureSessionProxy
 ...
 public:
  ...
  void Update(uint32_t player_id, ::mojo::PendingAssociatedRemote<::media::mojom::blink::MediaPlayer> player_remote, const ::viz::SurfaceId& surface_id, const ::gfx::Size& natural_size, bool show_play_pause_button) final;
...
class PLATFORM_EXPORT PictureInPictureServiceProxy
 ...
 public:
  ...
  void StartSession(uint32_t player_id, ::mojo::PendingAssociatedRemote<::media::mojom::blink::MediaPlayer> player_remote, const ::viz::SurfaceId& surface_id, const ::gfx::Size& natural_size, bool show_play_pause_button, ::mojo::PendingRemote<PictureInPictureSessionObserver> observer, const ::gfx::Rect& source_bounds, StartSessionCallback callback) final;
