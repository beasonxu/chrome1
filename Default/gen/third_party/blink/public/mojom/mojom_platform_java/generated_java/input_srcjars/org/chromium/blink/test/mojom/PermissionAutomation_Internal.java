...
SetPermission_Response callback) {
            ...
            try {
                ...
                result = new PermissionAutomationSetPermissionParams(elementsOrVersion);
                    ...
                    result.status = decoder0.readInt(16);
                        ...
                        result.status = org.chromium.blink.mojom.PermissionStatus.toKnownValue(result.status);
                    }
                    {
    ...
    static class PermissionAutomationSetPermissionResponseParamsForwardToCallback extends org.chromium.mojo.bindings.SideEffectFreeCloseable
        ...
        PermissionAutomationSetPermissionResponseParamsForwardToCallback(PermissionAutomation.SetPermission_Response callback) {
    ...
    static class PermissionAutomationSetPermissionResponseParamsProxyToResponder implements PermissionAutomation.SetPermission_Response {
