...
struct Serializer<::blink::mojom::DateTimeSuggestionDataView, MaybeConstUserType> {
  ...
  static void Serialize(
      ...
      mojo::internal::MessageFragment<::blink::mojom::internal::DateTimeSuggestion_Data>& fragment) {
    ...
    mojo::internal::MessageFragment<
        typename decltype(fragment->localized_value)::BaseType> localized_value_fragment(
            fragment.message());
    mojo::internal::Serialize<::mojo_base::mojom::String16DataView>(
        in_localized_value, localized_value_fragment);
    fragment->localized_value.Set(
        localized_value_fragment.is_null() ? nullptr : localized_value_fragment.data());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        fragment->localized_value.is_null(),
...
struct Serializer<::blink::mojom::DateTimeDialogValueDataView, MaybeConstUserType> {
  ...
  static void Serialize(
      MaybeConstUserType& input,
      mojo::internal::MessageFragment<::blink::mojom::internal::DateTimeDialogValue_Data>& fragment) {
    if (CallIsNullIfExists<Traits>(input))
      return;
    fragment.Allocate();
    mojo::internal::Serialize<::ui::mojom::TextInputType>(
        Traits::dialog_type(input), &fragment->dialog_type);
