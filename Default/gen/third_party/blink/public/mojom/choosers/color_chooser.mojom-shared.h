...
using EyeDropperChooserPtrDataView =
    mojo::InterfacePtrDataView<EyeDropperChooserInterfaceBase>;
using EyeDropperChooserRequestDataView =
    mojo::InterfaceRequestDataView<EyeDropperChooserInterfaceBase>;
using EyeDropperChooserAssociatedPtrInfoDataView =
    mojo::AssociatedInterfacePtrInfoDataView<EyeDropperChooserInterfaceBase>;
using EyeDropperChooserAssociatedRequestDataView =
    mojo::AssociatedInterfaceRequestDataView<EyeDropperChooserInterfaceBase>;
...
struct Serializer<::blink::mojom::ColorSuggestionDataView, MaybeConstUserType> {
  ...
  static void Serialize(
      ...
      mojo::internal::MessageFragment<::blink::mojom::internal::ColorSuggestion_Data>& fragment) {
