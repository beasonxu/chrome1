...
// with not having this data in traces there.
  ...
  struct ShowUnhandledTapUIIfNeeded_Sym {
    NOINLINE static uint32_t IPCStableHash();
  };
#endif // !BUILDFLAG(IS_FUCHSIA)
  virtual ~UnhandledTapNotifier() = default;
...
class UnhandledTapNotifierStub
 ...
 public:
  ...
  UnhandledTapNotifierStub() = default;
  ~UnhandledTapNotifierStub() override = default;
