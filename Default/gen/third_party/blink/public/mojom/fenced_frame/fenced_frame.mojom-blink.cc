...
FencedFrameReporting::FencedFrameReporting(
    const WTF::HashMap<ReportingDestination, WTF::HashMap<WTF::String, ::blink::KURL>>& metadata_in)
    : metadata(std::move(metadata_in)) {}

FencedFrameReporting::~FencedFrameReporting() = default;

void FencedFrameReporting::WriteIntoTrace(
...
bool FencedFrameReporting::Validate(
    const void* data,
...
uint32_t FencedFrameOwnerHost::Navigate_Sym::IPCStableHash() {
  ...
  constexpr uint32_t kHash = base::MD5Hash32Constexpr(
          "(Impl)blink::mojom::FencedFrameOwnerHost::Navigate");
...
void FencedFrameOwnerHostProxy::Navigate(
    const ::blink::KURL& in_url, ::base::TimeTicks in_navigation_start_time) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
  ...
  mojo::internal::Serialize<::mojo_base::mojom::TimeTicksDataView>(
      in_navigation_start_time, navigation_start_time_fragment);
...
bool StructTraits<::blink::mojom::blink::FencedFrameReporting::DataView, ::blink::mojom::blink::FencedFrameReportingPtr>::Read(
    ::blink::mojom::blink::FencedFrameReporting::DataView input,
    ::blink::mojom::blink::FencedFrameReportingPtr* output) {
  bool success = true;
