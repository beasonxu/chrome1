...
struct blink_mojom_internal_DevToolsExecutionContextType_DataHashFn {
  ...
  static bool Equal(const ::blink::mojom::DevToolsExecutionContextType& left, const ::blink::mojom::DevToolsExecutionContextType& right) {
    return left == right;
  }
...
template <>
struct HashTraits<::blink::mojom::DevToolsExecutionContextType>
    : public GenericHashTraits<::blink::mojom::DevToolsExecutionContextType> {
  static_assert(true,
  ...
  static void ConstructDeletedValue(::blink::mojom::DevToolsExecutionContextType& slot, bool) {
    slot = static_cast<::blink::mojom::DevToolsExecutionContextType>(-1000001);
  }
  static bool IsDeletedValue(const ::blink::mojom::DevToolsExecutionContextType& value) {
    return value == static_cast<::blink::mojom::DevToolsExecutionContextType>(-1000001);
  }
};
}  // namespace WTF
...
// with not having this data in traces there.
  ...
  virtual void ChildTargetCreated(::mojo::PendingRemote<DevToolsAgent> worker_devtools_agent, ::mojo::PendingReceiver<DevToolsAgentHost> worker_devtools_agent_host, const ::blink::KURL& url, const WTF::String& name, const ::base::UnguessableToken& devtools_worker_token, bool waiting_for_debugger, DevToolsExecutionContextType context_type) = 0;
};
...
class PLATFORM_EXPORT DevToolsAgentHostProxy
 ...
 public:
  ...
  void ChildTargetCreated(::mojo::PendingRemote<DevToolsAgent> worker_devtools_agent, ::mojo::PendingReceiver<DevToolsAgentHost> worker_devtools_agent_host, const ::blink::KURL& url, const WTF::String& name, const ::base::UnguessableToken& devtools_worker_token, bool waiting_for_debugger, DevToolsExecutionContextType context_type) final;
...
class PLATFORM_EXPORT DevToolsSessionState {
 public:
  ...
  explicit DevToolsSessionState(
      const WTF::HashMap<WTF::String, absl::optional<WTF::Vector<uint8_t>>>& entries);
