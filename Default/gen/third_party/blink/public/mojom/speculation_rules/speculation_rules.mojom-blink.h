...
struct blink_mojom_internal_SpeculationAction_DataHashFn {
  ...
  static bool Equal(const ::blink::mojom::SpeculationAction& left, const ::blink::mojom::SpeculationAction& right) {
    return left == right;
  }
...
struct HashTraits<::blink::mojom::SpeculationAction>
    : public GenericHashTraits<::blink::mojom::SpeculationAction> {
  static_assert(true,
  ...
  static void ConstructDeletedValue(::blink::mojom::SpeculationAction& slot, bool) {
    slot = static_cast<::blink::mojom::SpeculationAction>(-1000001);
  }
  static bool IsDeletedValue(const ::blink::mojom::SpeculationAction& value) {
    return value == static_cast<::blink::mojom::SpeculationAction>(-1000001);
  }
};
}  // namespace WTF
...
SpeculationCandidate& operator=(const SpeculationCandidate&) = delete;
  ...
  static WTF::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        SpeculationCandidate::DataView, WTF::Vector<uint8_t>>(input);
  }
