...
void AnnotationAgentContainerProxy::CreateAgent(
    ::mojo::PendingRemote<AnnotationAgentHost> in_host_remote, ::mojo::PendingReceiver<AnnotationAgent> in_agent_receiver, AnnotationType in_type, const std::string& in_serialized_selector) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
class AnnotationAgentContainer_CreateAgentFromSelection_ProxyToResponder : public ::mojo::internal::ProxyToResponder {
 ...
 private:
  ...
  void Run(
      ::mojo::PendingReceiver<AnnotationAgentHost> in_host_receiver, ::mojo::PendingRemote<AnnotationAgent> in_agent_remote, const std::string& in_serialized_selector, const ::std::u16string& in_selected_text);
};
...
void AnnotationAgentContainerInterceptorForTesting::CreateAgent(::mojo::PendingRemote<AnnotationAgentHost> host_remote, ::mojo::PendingReceiver<AnnotationAgent> agent_receiver, AnnotationType type, const std::string& serialized_selector) {
...
,
             std::string* out_serialized_selector
,
             ::std::u16string* out_selected_text
,
             ...
             const ::std::u16string& selected_text) {*out_host_receiver = std::move(host_receiver);*out_agent_remote = std::move(agent_remote);*out_serialized_selector = std::move(serialized_selector);*out_selected_text = std::move(selected_text);
            loop->Quit();
          },
          &loop,
          out_host_receiver,
