...
class PLATFORM_EXPORT AnnotationAgentContainerInterceptorForTesting : public AnnotationAgentContainer {
  ...
  void CreateAgent(::mojo::PendingRemote<AnnotationAgentHost> host_remote, ::mojo::PendingReceiver<AnnotationAgent> agent_receiver, AnnotationType type, const WTF::String& serialized_selector) override;
