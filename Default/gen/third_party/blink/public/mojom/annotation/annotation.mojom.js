...
(function() {
  ...
  AnnotationAgentContainer_CreateAgentFromSelection_ResponseParams.validate = function(messageValidator, offset) {
    ...
    // validate AnnotationAgentContainer_CreateAgentFromSelection_ResponseParams.hostReceiver
    err = messageValidator.validateInterfaceRequest(offset + codec.kStructHeaderSize + 0, true)
    if (err !== validator.validationError.NONE)
        return err;


    // validate AnnotationAgentContainer_CreateAgentFromSelection_ResponseParams.agentRemote
    err = messageValidator.validateInterface(offset + codec.kStructHeaderSize + 4, true);
    if (err !== validator.validationError.NONE)
        return err;


    // validate AnnotationAgentContainer_CreateAgentFromSelection_ResponseParams.serializedSelector
    err = messageValidator.validateStringPointer(offset + codec.kStructHeaderSize + 16, false)
    if (err !== validator.validationError.NONE)
        return err;


    // validate AnnotationAgentContainer_CreateAgentFromSelection_ResponseParams.selectedText
  ...
  AnnotationAgentContainer_CreateAgentFromSelection_ResponseParams.encodedSize = codec.kStructHeaderSize + 32;
  ...
  AnnotationAgentContainer_CreateAgentFromSelection_ResponseParams.decode = function(decoder) {
    ...
    val.agentRemote =
        decoder.decodeStruct(new codec.NullableInterface(AnnotationAgentPtr));
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  AnnotationAgentContainer_CreateAgentFromSelection_ResponseParams.encode = function(encoder, val) {
    ...
    encoder.writeUint32(0);
    encoder.encodeStruct(codec.NullableInterfaceRequest, val.hostReceiver);
    encoder.encodeStruct(new codec.NullableInterface(AnnotationAgentPtr), val.agentRemote);
    encoder.skip(1);
    encoder.skip(1);
    encoder.skip(1);
    encoder.skip(1);
  ...
  AnnotationAgentContainerStub.prototype.acceptWithResponder =
    ...
    case kAnnotationAgentContainer_CreateAgentFromSelection_Name:
      ...
      this.createAgentFromSelection(params.type).then(function(response) {
        ...
        responseParams.hostReceiver = response.hostReceiver;
        responseParams.agentRemote = response.agentRemote;
        responseParams.serializedSelector = response.serializedSelector;
        responseParams.selectedText = response.selectedText;
        var builder = new codec.MessageV1Builder(
            kAnnotationAgentContainer_CreateAgentFromSelection_Name,
