...
static_assert(sizeof(MediaDevicesDispatcherHost_SetCaptureHandleConfig_Params_Data) == 16,
              "Bad sizeof(MediaDevicesDispatcherHost_SetCaptureHandleConfig_Params_Data)");
...
class MediaDevicesDispatcherHost_EnumerateDevices_ResponseParamsDataView {
 public:
  ...
  [[nodiscard]] bool ReadEnumeration(UserType* output) {
  ...
  template <typename UserType>
  [[nodiscard]] bool ReadVideoInputDeviceCapabilities(UserType* output) {
  ...
  template <typename UserType>
  [[nodiscard]] bool ReadAudioInputDeviceCapabilities(UserType* output) {
...
class MediaDevicesDispatcherHost_SetCaptureHandleConfig_ParamsDataView {
 public:
  ...
  MediaDevicesDispatcherHost_SetCaptureHandleConfig_ParamsDataView(
      internal::MediaDevicesDispatcherHost_SetCaptureHandleConfig_Params_Data* data,
      mojo::Message* message)
      : data_(data), message_(message) {}
  ...
  [[nodiscard]] bool ReadConfig(UserType* output) {
    ...
    return mojo::internal::Deserialize<::blink::mojom::CaptureHandleConfigDataView>(
        pointer, output, message_);
  }
 private:
 ...
 public:
  ...
  MediaDeviceType type() const {
    return ::mojo::internal::ToKnownEnumValueHelper(
          static_cast<::blink::mojom::MediaDeviceType>(data_->type));
  }
