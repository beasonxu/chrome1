...
class BLINK_COMMON_EXPORT GetOpenDeviceResponse {
 public:
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        GetOpenDeviceResponse::DataView, std::vector<uint8_t>>(input);
  }
...
class BLINK_COMMON_EXPORT StreamDevices {
 public:
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        StreamDevices::DataView, std::vector<uint8_t>>(input);
  }
...
StreamDevicesSet& operator=(const StreamDevicesSet&) = delete;
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        StreamDevicesSet::DataView, std::vector<uint8_t>>(input);
  }
...
struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::StreamControls::DataView,
  ...
  static decltype(::blink::mojom::StreamControls::exclude_system_audio) exclude_system_audio(
      const ::blink::mojom::StreamControlsPtr& input) {
  ...
  static decltype(::blink::mojom::StreamControls::request_all_screens) request_all_screens(
      const ::blink::mojom::StreamControlsPtr& input) {
...
struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::GetOpenDeviceResponse::DataView,
  ...
  static const decltype(::blink::mojom::GetOpenDeviceResponse::label)& label(
      const ::blink::mojom::GetOpenDeviceResponsePtr& input) {
    return input->label;
  }

  static const decltype(::blink::mojom::GetOpenDeviceResponse::device)& device(
      const ::blink::mojom::GetOpenDeviceResponsePtr& input) {
    return input->device;
  }

  static decltype(::blink::mojom::GetOpenDeviceResponse::pan_tilt_zoom_allowed) pan_tilt_zoom_allowed(
      const ::blink::mojom::GetOpenDeviceResponsePtr& input) {
...
struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::StreamDevices::DataView,
  ...
  static const decltype(::blink::mojom::StreamDevices::audio_device)& audio_device(
      const ::blink::mojom::StreamDevicesPtr& input) {
    return input->audio_device;
  }

  static const decltype(::blink::mojom::StreamDevices::video_device)& video_device(
      const ::blink::mojom::StreamDevicesPtr& input) {
...
struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::StreamDevicesSet::DataView,
  ...
  static const decltype(::blink::mojom::StreamDevicesSet::stream_devices)& stream_devices(
      const ::blink::mojom::StreamDevicesSetPtr& input) {
