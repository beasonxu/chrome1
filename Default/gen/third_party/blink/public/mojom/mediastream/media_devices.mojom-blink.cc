...
void MediaDevicesDispatcherHostProxy::SetCaptureHandleConfig(
    ::blink::mojom::blink::CaptureHandleConfigPtr in_config) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
class MediaDevicesDispatcherHost_EnumerateDevices_ProxyToResponder : public ::mojo::internal::ProxyToResponder {
 ...
 private:
  ...
  void Run(
      const WTF::Vector<WTF::Vector<::blink::WebMediaDeviceInfo>>& in_enumeration, WTF::Vector<VideoInputDeviceCapabilitiesPtr> in_video_input_device_capabilities, WTF::Vector<AudioInputDeviceCapabilitiesPtr> in_audio_input_device_capabilities);
};
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("enumeration"), in_enumeration,
                        "<value of type const WTF::Vector<WTF::Vector<::blink::WebMediaDeviceInfo>>&>");
      perfetto::WriteIntoTracedValueWithFallback(
...
void MediaDevicesListenerProxy::OnDevicesChanged(
    MediaDeviceType in_type, const WTF::Vector<::blink::WebMediaDeviceInfo>& in_device_infos) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void MediaDevicesDispatcherHostAsyncWaiter::EnumerateDevices(
  ...
  proxy_->EnumerateDevices(std::move(request_audio_input),std::move(request_video_input),std::move(request_audio_output),std::move(request_video_input_capabilities),std::move(request_audio_input_capabilities),
      base::BindOnce(
          [](base::RunLoop* loop,
             WTF::Vector<WTF::Vector<::blink::WebMediaDeviceInfo>>* out_enumeration
,
