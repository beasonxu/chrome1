...
void ManifestUrlChangeObserverProxy::ManifestUrlChanged(
    const ::blink::KURL& in_manifest_url) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    "mojom", "Send blink::mojom::ManifestUrlChangeObserver::ManifestUrlChanged", "input_parameters",
  ...
  mojo::internal::MessageFragment<
      ::blink::mojom::internal::ManifestUrlChangeObserver_ManifestUrlChanged_Params_Data> params(
          message);
  params.Allocate();
  mojo::internal::MessageFragment<
