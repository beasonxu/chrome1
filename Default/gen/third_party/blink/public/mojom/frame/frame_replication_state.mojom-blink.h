 ...
 public:
  ...
  static WTF::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        FrameReplicationState::DataView, WTF::Vector<uint8_t>>(input);
  }
...
template <>
struct CORE_EXPORT StructTraits<::blink::mojom::blink::FrameReplicationState::DataView,
