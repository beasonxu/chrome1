...
struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::ViewportIntersectionState::DataView,
  ...
  static const decltype(::blink::mojom::ViewportIntersectionState::main_frame_viewport_size)& main_frame_viewport_size(
      const ::blink::mojom::ViewportIntersectionStatePtr& input) {
    return input->main_frame_viewport_size;
  }

  static const decltype(::blink::mojom::ViewportIntersectionState::main_frame_scroll_position)& main_frame_scroll_position(
      const ::blink::mojom::ViewportIntersectionStatePtr& input) {
