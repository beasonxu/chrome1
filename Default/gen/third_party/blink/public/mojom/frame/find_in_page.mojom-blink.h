...
// with not having this data in traces there.
  ...
  using FindMatchRectsCallback = base::OnceCallback<void(int32_t, const WTF::Vector<::gfx::RectF>&, const ::gfx::RectF&)>;
...
class CORE_EXPORT FindInPageClient
...
class CORE_EXPORT FindInPageResponseValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
...
template <>
struct CORE_EXPORT StructTraits<::blink::mojom::blink::FindOptions::DataView,
