...
void PendingBeaconHostProxy::CreateBeacon(
    ::mojo::PendingReceiver<PendingBeacon> in_receiver, const ::blink::KURL& in_url, BeaconMethod in_method, ::base::TimeDelta in_timeout) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void PendingBeaconProxy::SetRequestData(
    ::scoped_refptr<::network::ResourceRequestBody> in_request_body, const WTF::String& in_content_type) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void PendingBeaconHostInterceptorForTesting::CreateBeacon(::mojo::PendingReceiver<PendingBeacon> receiver, const ::blink::KURL& url, BeaconMethod method, ::base::TimeDelta timeout) {
...
void PendingBeaconInterceptorForTesting::SetRequestURL(const ::blink::KURL& url) {
