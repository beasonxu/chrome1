...
// with not having this data in traces there.
  ...
  virtual void OnWorkerHostCreated(::mojo::PendingRemote<::blink::mojom::BrowserInterfaceBroker> browser_interface_broker, ::mojo::PendingRemote<::blink::mojom::DedicatedWorkerHost> host) = 0;
...
// with not having this data in traces there.
  ...
  virtual void CreateWorkerHost(const ::blink::DedicatedWorkerToken& token, const ::GURL& script_url, ::mojo::PendingReceiver<::blink::mojom::BrowserInterfaceBroker> browser_interface_broker, ::mojo::PendingReceiver<::blink::mojom::DedicatedWorkerHost> host, CreateWorkerHostCallback callback) = 0;

  
  virtual void CreateWorkerHostAndStartScriptLoad(const ::blink::DedicatedWorkerToken& token, const ::GURL& script_url, ::network::mojom::CredentialsMode credentials_mode, ::blink::mojom::FetchClientSettingsObjectPtr outside_fetch_client_settings_object, ::mojo::PendingRemote<::blink::mojom::BlobURLToken> blob_url_token, ::mojo::PendingRemote<DedicatedWorkerHostFactoryClient> client) = 0;
};
...
class BLINK_COMMON_EXPORT DedicatedWorkerHostFactoryClientProxy
 ...
 public:
  ...
  void OnWorkerHostCreated(::mojo::PendingRemote<::blink::mojom::BrowserInterfaceBroker> browser_interface_broker, ::mojo::PendingRemote<::blink::mojom::DedicatedWorkerHost> host) final;
...
class BLINK_COMMON_EXPORT DedicatedWorkerHostFactoryProxy
 ...
 public:
  ...
  void CreateWorkerHost(const ::blink::DedicatedWorkerToken& token, const ::GURL& script_url, ::mojo::PendingReceiver<::blink::mojom::BrowserInterfaceBroker> browser_interface_broker, ::mojo::PendingReceiver<::blink::mojom::DedicatedWorkerHost> host, CreateWorkerHostCallback callback) final;
  
  void CreateWorkerHostAndStartScriptLoad(const ::blink::DedicatedWorkerToken& token, const ::GURL& script_url, ::network::mojom::CredentialsMode credentials_mode, ::blink::mojom::FetchClientSettingsObjectPtr outside_fetch_client_settings_object, ::mojo::PendingRemote<::blink::mojom::BlobURLToken> blob_url_token, ::mojo::PendingRemote<DedicatedWorkerHostFactoryClient> client) final;
