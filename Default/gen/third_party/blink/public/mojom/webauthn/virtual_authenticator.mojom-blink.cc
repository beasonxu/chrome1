...
void VirtualAuthenticatorProxy::GetLargeBlob(
    const WTF::Vector<uint8_t>& in_key_handle, GetLargeBlobCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void VirtualAuthenticatorProxy::SetLargeBlob(
    const WTF::Vector<uint8_t>& in_key_handle, const WTF::Vector<uint8_t>& in_blob, SetLargeBlobCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("keys"), in_keys,
                        "<value of type WTF::Vector<RegisteredKeyPtr>>");
   });
#endif
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("authenticators"), in_authenticators,
                        "<value of type WTF::Vector<::mojo::PendingRemote<VirtualAuthenticator>>>");
   });
#endif
