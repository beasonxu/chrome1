 ...
 public:
  ...
  ::blink::mojom::SpeechRecognitionErrorCode code() const {
    return ::mojo::internal::ToKnownEnumValueHelper(
          static_cast<::blink::mojom::SpeechRecognitionErrorCode>(data_->code));
  }
  template <typename UserType>
  ...
  SpeechAudioErrorDetails details() const {
    return ::mojo::internal::ToKnownEnumValueHelper(
          static_cast<::blink::mojom::SpeechAudioErrorDetails>(data_->details));
  }
 private:
...
struct Serializer<::blink::mojom::SpeechAudioErrorDetails, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    return Traits::FromMojom(::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::blink::mojom::SpeechAudioErrorDetails>(input)), output);
  }
};
...
struct Serializer<::blink::mojom::SpeechRecognitionErrorDataView, MaybeConstUserType> {
  ...
  static void Serialize(
      ...
      mojo::internal::MessageFragment<::blink::mojom::internal::SpeechRecognitionError_Data>& fragment) {
...
template <>
struct COMPONENT_EXPORT(MOJOM_SHARED_BLINK_COMMON_EXPORT) TraceFormatTraits<::blink::mojom::SpeechAudioErrorDetails> {
