...
// static
bool ReportingServiceProxy_QueuePermissionsPolicyViolationReport_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
...
// static
bool ReportingServiceProxy_QueueDocumentPolicyViolationReport_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->policy_id, 3, validation_context)) {
    return false;
  }
  const mojo::internal::ContainerValidateParams policy_id_validate_params(
      0, false, nullptr);
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->disposition, 4, validation_context)) {
    return false;
  }
  const mojo::internal::ContainerValidateParams disposition_validate_params(
      0, false, nullptr);
