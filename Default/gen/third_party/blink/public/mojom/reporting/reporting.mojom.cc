...
void ReportingServiceProxyProxy::QueuePermissionsPolicyViolationReport(
    const ::GURL& in_url, const std::string& in_policy_id, const std::string& in_disposition, const absl::optional<std::string>& in_message, const absl::optional<std::string>& in_source_file, int32_t in_line_number, int32_t in_column_number) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void ReportingServiceProxyInterceptorForTesting::QueuePermissionsPolicyViolationReport(const ::GURL& url, const std::string& policy_id, const std::string& disposition, const absl::optional<std::string>& message, const absl::optional<std::string>& source_file, int32_t line_number, int32_t column_number) {
