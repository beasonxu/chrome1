...
// with not having this data in traces there.
  ...
  virtual void BatchGetAll(int64_t transaction_id, int64_t object_store_id, int64_t index_id, WTF::Vector<IDBKeyRangePtr> key_ranges, uint32_t max_count, BatchGetAllCallback callback) = 0;
...
class MODULES_EXPORT IDBDatabaseProxy
 ...
 public:
  ...
  void BatchGetAll(int64_t transaction_id, int64_t object_store_id, int64_t index_id, WTF::Vector<IDBKeyRangePtr> key_ranges, uint32_t max_count, BatchGetAllCallback callback) final;
...
template <>
struct MODULES_EXPORT UnionTraits<::blink::mojom::blink::IDBDatabaseBatchGetAllResult::DataView,
                                        ::blink::mojom::blink::IDBDatabaseBatchGetAllResultPtr> {
  ...
  static ::blink::mojom::blink::IDBDatabaseBatchGetAllResult::Tag GetTag(const ::blink::mojom::blink::IDBDatabaseBatchGetAllResultPtr& input) {
    return input->which();
  }

  static const ::blink::mojom::blink::IDBErrorPtr& error_result(const ::blink::mojom::blink::IDBDatabaseBatchGetAllResultPtr& input) {
    return input->get_error_result();
  }

  static  WTF::Vector<WTF::Vector<::blink::mojom::blink::IDBReturnValuePtr>>& values( ::blink::mojom::blink::IDBDatabaseBatchGetAllResultPtr& input) {
    return input->get_values();
  }
