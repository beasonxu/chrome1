...
IDBBlobInfo::IDBBlobInfo(
    ...
    const ::std::u16string& mime_type_in,
    int64_t size_in,
...
IDBError::IDBError(
    ...
    const ::std::u16string& error_message_in)
...
void IDBKeyPathData::set_string_array(
  ...
  if (tag_ == Tag::kStringArray) {
    *(data_.string_array) = std::move(string_array);
    ...
    data_.string_array = new std::vector<::std::u16string>(
...
void IDBExternalObject::set_file_system_access_token(
  ...
  if (tag_ == Tag::kFileSystemAccessToken) {
    *(data_.file_system_access_token) = std::move(file_system_access_token);
    ...
    data_.file_system_access_token = new ::mojo::PendingRemote<::blink::mojom::FileSystemAccessTransferToken>(
...
void IDBDatabaseBatchGetAllResult::set_values(
  ...
  if (tag_ == Tag::kValues) {
    *(data_.values) = std::move(values);
    ...
    DestroyActive();
    tag_ = Tag::kValues;
    data_.values = new std::vector<std::vector<IDBReturnValuePtr>>(
        std::move(values));
  }
}
...
void IDBCallbacksProxy::Error(
    IDBException in_code, const ::std::u16string& in_message) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("value"), in_value,
                        "<value of type std::vector<IDBNameAndVersionPtr>>");
   });
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
void IDBDatabaseCallbacksProxy::Abort(
    int64_t in_transaction_id, IDBException in_code, const ::std::u16string& in_message) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void IDBDatabaseGetAllResultSinkProxy::ReceiveKeys(
    const std::vector<::blink::IndexedDBKey>& in_keys) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void IDBDatabaseProxy::RenameObjectStore(
    int64_t in_transaction_id, int64_t in_object_store_id, const ::std::u16string& in_new_name) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void IDBDatabaseProxy::BatchGetAll(
    int64_t in_transaction_id, int64_t in_object_store_id, int64_t in_index_id, const std::vector<::blink::IndexedDBKeyRange>& in_key_ranges, uint32_t in_max_count, BatchGetAllCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("key_ranges"), in_key_ranges,
                        "<value of type const std::vector<::blink::IndexedDBKeyRange>&>");
      perfetto::WriteIntoTracedValueWithFallback(
...
void IDBDatabaseProxy::CreateIndex(
    int64_t in_transaction_id, int64_t in_object_store_id, int64_t in_index_id, const ::std::u16string& in_name, const ::blink::IndexedDBKeyPath& in_key_path, bool in_unique, bool in_multi_entry) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void IDBDatabaseProxy::RenameIndex(
    int64_t in_transaction_id, int64_t in_object_store_id, int64_t in_index_id, const ::std::u16string& in_new_name) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
bool IDBDatabaseStubDispatch::AcceptWithResponder(
  ...
  switch (message->header()->name) {
    ...
    case internal::kIDBDatabase_BatchGetAll_Name: {
      ...
      int64_t p_object_store_id{};
      int64_t p_index_id{};
      std::vector<::blink::IndexedDBKeyRange> p_key_ranges{};
...
void IDBFactoryProxy::Open(
    ::mojo::PendingAssociatedRemote<IDBCallbacks> in_pending_callbacks, ::mojo::PendingAssociatedRemote<IDBDatabaseCallbacks> in_database_callbacks, const ::std::u16string& in_name, int64_t in_version, ::mojo::PendingAssociatedReceiver<IDBTransaction> in_version_change_transaction_receiver, int64_t in_transaction_id) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void IDBFactoryProxy::DeleteDatabase(
    ::mojo::PendingAssociatedRemote<IDBCallbacks> in_pending_callbacks, const ::std::u16string& in_name, bool in_force_close) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
// static
bool UnionTraits<::blink::mojom::IDBKey::DataView, ::blink::mojom::IDBKeyPtr>::Read(
  ...
  switch (input.tag()) {
    ...
    case Tag::kFileSystemAccessToken: {
      *output = UnionType::NewFileSystemAccessToken(
          input.TakeFileSystemAccessToken<::mojo::PendingRemote<::blink::mojom::FileSystemAccessTransferToken>>());
      break;
    }
    default:
...
bool UnionTraits<::blink::mojom::IDBDatabaseBatchGetAllResult::DataView, ::blink::mojom::IDBDatabaseBatchGetAllResultPtr>::Read(
    ::blink::mojom::IDBDatabaseBatchGetAllResult::DataView input,
    ::blink::mojom::IDBDatabaseBatchGetAllResultPtr* output) {
...
void IDBCallbacksInterceptorForTesting::Error(IDBException code, const ::std::u16string& message) {
...
void IDBDatabaseGetAllResultSinkInterceptorForTesting::ReceiveValues(std::vector<IDBReturnValuePtr> values) {
  GetForwardingInterface()->ReceiveValues(std::move(values));
}
void IDBDatabaseGetAllResultSinkInterceptorForTesting::ReceiveKeys(const std::vector<::blink::IndexedDBKey>& keys) {
...
void IDBDatabaseInterceptorForTesting::BatchGetAll(int64_t transaction_id, int64_t object_store_id, int64_t index_id, const std::vector<::blink::IndexedDBKeyRange>& key_ranges, uint32_t max_count, BatchGetAllCallback callback) {
...
void IDBDatabaseInterceptorForTesting::CreateIndex(int64_t transaction_id, int64_t object_store_id, int64_t index_id, const ::std::u16string& name, const ::blink::IndexedDBKeyPath& key_path, bool unique, bool multi_entry) {
...
void IDBDatabaseAsyncWaiter::BatchGetAll(
    int64_t transaction_id, int64_t object_store_id, int64_t index_id, const std::vector<::blink::IndexedDBKeyRange>& key_ranges, uint32_t max_count, IDBDatabaseBatchGetAllResultPtr* out_result) {
  base::RunLoop loop;
...
void IDBDatabaseAsyncWaiter::GetAll(
    int64_t transaction_id, int64_t object_store_id, int64_t index_id, const ::blink::IndexedDBKeyRange& key_range, bool key_only, int64_t max_count, ::mojo::PendingReceiver<IDBDatabaseGetAllResultSink>* out_receiver) {
  base::RunLoop loop;
