...
bool PluginMimeType_Data::Validate(
  ...
  [[maybe_unused]] const PluginMimeType_Data* object =
      static_cast<const PluginMimeType_Data*>(data);
...
bool PluginRegistry_GetPlugins_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const PluginRegistry_GetPlugins_Params_Data* object =
      static_cast<const PluginRegistry_GetPlugins_Params_Data*>(data);
...
bool PluginRegistry_GetPlugins_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const PluginRegistry_GetPlugins_ResponseParams_Data* object =
      static_cast<const PluginRegistry_GetPlugins_ResponseParams_Data*>(data);
