...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_private_5fmembership_2eproto PRIVATE_MEMBERSHIP_EXPORT
...
struct PRIVATE_MEMBERSHIP_EXPORT TableStruct_private_5fmembership_2eproto {
static const uint32_t offsets[];
};
namespace private_membership {
class DoublyEncryptedId;
struct DoublyEncryptedIdDefaultTypeInternal;
PRIVATE_MEMBERSHIP_EXPORT extern DoublyEncryptedIdDefaultTypeInternal _DoublyEncryptedId_default_instance_;
class MembershipResponse;
struct MembershipResponseDefaultTypeInternal;
PRIVATE_MEMBERSHIP_EXPORT extern MembershipResponseDefaultTypeInternal _MembershipResponse_default_instance_;
}  // namespace private_membership
PROTOBUF_NAMESPACE_OPEN
template<> PRIVATE_MEMBERSHIP_EXPORT ::private_membership::DoublyEncryptedId* Arena::CreateMaybeMessage<::private_membership::DoublyEncryptedId>(Arena*);
template<> PRIVATE_MEMBERSHIP_EXPORT ::private_membership::MembershipResponse* Arena::CreateMaybeMessage<::private_membership::MembershipResponse>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace private_membership {
...
PRIVATE_MEMBERSHIP_EXPORT bool HashType_IsValid(int value);
...
PRIVATE_MEMBERSHIP_EXPORT bool EncryptedBucketHashType_IsValid(int value);
...
class PRIVATE_MEMBERSHIP_EXPORT DoublyEncryptedId final :
...
class PRIVATE_MEMBERSHIP_EXPORT MembershipResponse final :
...
doubly_encrypted_id_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
return doubly_encrypted_id_.Release();
}
...
doubly_encrypted_id_.SetAllocated(doubly_encrypted_id, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
if (doubly_encrypted_id_.IsDefault()) {
