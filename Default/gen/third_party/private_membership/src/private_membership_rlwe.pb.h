...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_private_5fmembership_5frlwe_2eproto PRIVATE_MEMBERSHIP_EXPORT
...
delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(hashed_buckets_parameters_);
}
...
::private_membership::rlwe::EncryptedBucketsParameters* encrypted_buckets_parameters) {
if (GetArenaForAllocation() == nullptr) {
delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(encrypted_buckets_parameters_);
}
...
::private_membership::rlwe::RlweParameters* rlwe_parameters) {
if (GetArenaForAllocation() == nullptr) {
delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(rlwe_parameters_);
}
...
non_sensitive_id_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
return non_sensitive_id_.Release();
}
...
non_sensitive_id_.SetAllocated(non_sensitive_id, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
if (non_sensitive_id_.IsDefault()) {
...
sensitive_id_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
sensitive_id_.SetAllocated(sensitive_id, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
if (sensitive_id_.IsDefault()) {
...
hashed_bucket_id_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
return hashed_bucket_id_.Release();
}
...
hashed_bucket_id_.SetAllocated(hashed_bucket_id, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
if (hashed_bucket_id_.IsDefault()) {
...
queried_encrypted_id_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
return queried_encrypted_id_.Release();
}
...
queried_encrypted_id_.SetAllocated(queried_encrypted_id, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
if (queried_encrypted_id_.IsDefault()) {
...
::private_membership::rlwe::PirRequest* pir_request) {
if (GetArenaForAllocation() == nullptr) {
delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(pir_request_);
}
...
::private_membership::rlwe::PrivateMembershipRlweQuery_HashedBucketId* hashed_bucket_id) {
if (GetArenaForAllocation() == nullptr) {
delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(hashed_bucket_id_);
}
...
::private_membership::rlwe::PirResponse* pir_response) {
if (GetArenaForAllocation() == nullptr) {
delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(pir_response_);
}
...
prng_seed_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
prng_seed_.Set(value, GetArenaForAllocation());
}
inline std::string* PirRequest::_internal_mutable_prng_seed() {

return prng_seed_.Mutable(GetArenaForAllocation());
}
...
prng_seed_.SetAllocated(prng_seed, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
if (prng_seed_.IsDefault()) {
...
encrypted_id_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
encrypted_id_.SetAllocated(encrypted_id, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
if (encrypted_id_.IsDefault()) {
...
encrypted_value_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
return encrypted_value_.Release();
}
...
encrypted_value_.SetAllocated(encrypted_value, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
if (encrypted_value_.IsDefault()) {
