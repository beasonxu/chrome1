...
SysStatsConfig::SysStatsConfig(const SysStatsConfig& from)
  ...
  ::memcpy(&meminfo_period_ms_, &from.meminfo_period_ms_,
    static_cast<size_t>(reinterpret_cast<char*>(&buddyinfo_period_ms_) -
    reinterpret_cast<char*>(&meminfo_period_ms_)) + sizeof(buddyinfo_period_ms_));
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    ...
    0, static_cast<size_t>(reinterpret_cast<char*>(&buddyinfo_period_ms_) -
    reinterpret_cast<char*>(&meminfo_period_ms_)) + sizeof(buddyinfo_period_ms_));
}
...
// @@protoc_insertion_point(message_clear_start:perfetto.protos.SysStatsConfig)
  ...
  if (cached_has_bits & 0x0000003fu) {
    ::memset(&meminfo_period_ms_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&buddyinfo_period_ms_) -
        reinterpret_cast<char*>(&meminfo_period_ms_)) + sizeof(buddyinfo_period_ms_));
  }
  _has_bits_.Clear();
...
void SysStatsConfig::InternalSwap(SysStatsConfig* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(SysStatsConfig, buddyinfo_period_ms_)
      + sizeof(SysStatsConfig::buddyinfo_period_ms_)
