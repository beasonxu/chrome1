...
PROTOBUF_CONSTEXPR NumberFormat::NumberFormat(
  ...
  , national_prefix_formatting_rule_(&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{})
  , domestic_carrier_code_formatting_rule_(&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{})
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 NumberFormatDefaultTypeInternal _NumberFormat_default_instance_;
PROTOBUF_CONSTEXPR PhoneNumberDesc::PhoneNumberDesc(
    ::_pbi::ConstantInitialized)
  : possible_length_()
  , possible_length_local_only_()
  , national_number_pattern_(&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{})
  , example_number_(&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}){}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 PhoneNumberDescDefaultTypeInternal _PhoneNumberDesc_default_instance_;
PROTOBUF_CONSTEXPR PhoneMetadata::PhoneMetadata(
    ::_pbi::ConstantInitialized)
  : number_format_()
  , intl_number_format_()
  , id_(&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{})
  , international_prefix_(&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{})
  , national_prefix_(&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{})
  , preferred_extn_prefix_(&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{})
  , national_prefix_for_parsing_(&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{})
  , national_prefix_transform_rule_(&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{})
  , preferred_international_prefix_(&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{})
  , leading_digits_(&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{})
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 PhoneMetadataDefaultTypeInternal _PhoneMetadata_default_instance_;
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 PhoneMetadataCollectionDefaultTypeInternal _PhoneMetadataCollection_default_instance_;
}  // namespace phonenumbers
}  // namespace i18n
namespace i18n {
namespace phonenumbers {
...
NumberFormat::NumberFormat(const NumberFormat& from)
  ...
  national_prefix_formatting_rule_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    national_prefix_formatting_rule_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (from._internal_has_national_prefix_formatting_rule()) {
    national_prefix_formatting_rule_.Set(from._internal_national_prefix_formatting_rule(), 
      GetArenaForAllocation());
  }
  domestic_carrier_code_formatting_rule_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  ...
  if (from._internal_has_domestic_carrier_code_formatting_rule()) {
    domestic_carrier_code_formatting_rule_.Set(from._internal_domestic_carrier_code_formatting_rule(), 
      GetArenaForAllocation());
  }
...
inline void NumberFormat::SharedDtor() {
  ...
  pattern_.Destroy();
  format_.Destroy();
  national_prefix_formatting_rule_.Destroy();
  domestic_carrier_code_formatting_rule_.Destroy();
}
...
PhoneNumberDesc::PhoneNumberDesc(const PhoneNumberDesc& from)
  ...
  _internal_metadata_.MergeFrom<std::string>(from._internal_metadata_);
  national_number_pattern_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    national_number_pattern_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (from._internal_has_national_number_pattern()) {
    national_number_pattern_.Set(from._internal_national_number_pattern(), 
      GetArenaForAllocation());
  }
  example_number_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    example_number_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (from._internal_has_example_number()) {
    example_number_.Set(from._internal_example_number(), 
      GetArenaForAllocation());
  }
...
inline void PhoneNumberDesc::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  national_number_pattern_.Destroy();
  example_number_.Destroy();
}
...
PhoneMetadata::PhoneMetadata(const PhoneMetadata& from)
  ...
  international_prefix_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    international_prefix_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (from._internal_has_international_prefix()) {
    international_prefix_.Set(from._internal_international_prefix(), 
      GetArenaForAllocation());
  }
  national_prefix_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    national_prefix_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (from._internal_has_national_prefix()) {
    national_prefix_.Set(from._internal_national_prefix(), 
      GetArenaForAllocation());
  }
  preferred_extn_prefix_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    preferred_extn_prefix_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (from._internal_has_preferred_extn_prefix()) {
    preferred_extn_prefix_.Set(from._internal_preferred_extn_prefix(), 
      GetArenaForAllocation());
  }
  national_prefix_for_parsing_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    national_prefix_for_parsing_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (from._internal_has_national_prefix_for_parsing()) {
    national_prefix_for_parsing_.Set(from._internal_national_prefix_for_parsing(), 
      GetArenaForAllocation());
  }
  national_prefix_transform_rule_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    national_prefix_transform_rule_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (from._internal_has_national_prefix_transform_rule()) {
    national_prefix_transform_rule_.Set(from._internal_national_prefix_transform_rule(), 
      GetArenaForAllocation());
  }
  preferred_international_prefix_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    preferred_international_prefix_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (from._internal_has_preferred_international_prefix()) {
    preferred_international_prefix_.Set(from._internal_preferred_international_prefix(), 
      GetArenaForAllocation());
  }
  leading_digits_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    leading_digits_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (from._internal_has_leading_digits()) {
    leading_digits_.Set(from._internal_leading_digits(), 
      GetArenaForAllocation());
  }
...
inline void PhoneMetadata::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  id_.Destroy();
  international_prefix_.Destroy();
  national_prefix_.Destroy();
  preferred_extn_prefix_.Destroy();
  national_prefix_for_parsing_.Destroy();
  national_prefix_transform_rule_.Destroy();
  preferred_international_prefix_.Destroy();
  leading_digits_.Destroy();
...
uint8_t* PhoneMetadata::_InternalSerialize(
  ...
  if (cached_has_bits & 0x10000000u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteBoolToArray(26, this->_internal_leading_zero_possible(), target);
  }
