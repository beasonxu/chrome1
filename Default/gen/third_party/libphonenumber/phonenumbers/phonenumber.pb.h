...
class PhoneNumber final :
 ...
 public:
  ...
  PROTOBUF_NOINLINE void Swap(PhoneNumber* other) {
...
void PhoneNumber::set_raw_input(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000002u;
 raw_input_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void PhoneNumber::_internal_set_raw_input(const std::string& value) {
  _has_bits_[0] |= 0x00000002u;
  raw_input_.Set(value, GetArenaForAllocation());
}
inline std::string* PhoneNumber::_internal_mutable_raw_input() {
  _has_bits_[0] |= 0x00000002u;
  return raw_input_.Mutable(GetArenaForAllocation());
}
inline std::string* PhoneNumber::release_raw_input() {
  ...
  _has_bits_[0] &= ~0x00000002u;
  auto* p = raw_input_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (raw_input_.IsDefault()) {
    raw_input_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  return p;
}
inline void PhoneNumber::set_allocated_raw_input(std::string* raw_input) {
  ...
  raw_input_.SetAllocated(raw_input, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (raw_input_.IsDefault()) {
    raw_input_.Set("", GetArenaForAllocation());
  }
...
void PhoneNumber::set_preferred_domestic_carrier_code(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000004u;
 preferred_domestic_carrier_code_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void PhoneNumber::_internal_set_preferred_domestic_carrier_code(const std::string& value) {
  _has_bits_[0] |= 0x00000004u;
  preferred_domestic_carrier_code_.Set(value, GetArenaForAllocation());
}
inline std::string* PhoneNumber::_internal_mutable_preferred_domestic_carrier_code() {
  _has_bits_[0] |= 0x00000004u;
  return preferred_domestic_carrier_code_.Mutable(GetArenaForAllocation());
}
inline std::string* PhoneNumber::release_preferred_domestic_carrier_code() {
  ...
  _has_bits_[0] &= ~0x00000004u;
  auto* p = preferred_domestic_carrier_code_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (preferred_domestic_carrier_code_.IsDefault()) {
    preferred_domestic_carrier_code_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  return p;
}
inline void PhoneNumber::set_allocated_preferred_domestic_carrier_code(std::string* preferred_domestic_carrier_code) {
  ...
  preferred_domestic_carrier_code_.SetAllocated(preferred_domestic_carrier_code, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (preferred_domestic_carrier_code_.IsDefault()) {
    preferred_domestic_carrier_code_.Set("", GetArenaForAllocation());
  }
