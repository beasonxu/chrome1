...
public interface IWebApkApi extends android.os.IInterface
{
  ...
  public static class Default implements org.chromium.webapk.lib.runtime_library.IWebApkApi
  {
    ...
    @Override public int checkNotificationPermission() throws android.os.RemoteException
    {
      return 0;
    }
    // Creates a pending intent for requesting notification permission.
    @Override public android.app.PendingIntent requestNotificationPermission(java.lang.String channelName, java.lang.String channelId) throws android.os.RemoteException
    {
      return null;
    }
    @Override
  ...
  public static abstract class Stub extends android.os.Binder implements org.chromium.webapk.lib.runtime_library.IWebApkApi
  {
    ...
    @Override public boolean onTransact(int code, android.os.Parcel data, android.os.Parcel reply, int flags) throws android.os.RemoteException
    {
      ...
      switch (code)
      {
        ...
        case TRANSACTION_requestNotificationPermission:
        {
          ...
          android.app.PendingIntent _result = this.requestNotificationPermission(_arg0, _arg1);
          reply.writeNoException();
    ...
    private static class Proxy implements org.chromium.webapk.lib.runtime_library.IWebApkApi
    {
      ...
      @Override public int checkNotificationPermission() throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          boolean _status = mRemote.transact(Stub.TRANSACTION_checkNotificationPermission, _data, _reply, 0);
          _reply.readException();
          _result = _reply.readInt();
        }
        finally {
      ...
      @Override public android.app.PendingIntent requestNotificationPermission(java.lang.String channelName, java.lang.String channelId) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_requestNotificationPermission, _data, _reply, 0);
          _reply.readException();
    ...
    static final int TRANSACTION_checkNotificationPermission = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
    static final int TRANSACTION_requestNotificationPermission = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
  }
  public static final java.lang.String DESCRIPTOR = "org.chromium.webapk.lib.runtime_library.IWebApkApi";
  // Gets the id of the icon to represent WebAPK notifications in status bar.
  ...
  // Creates a pending intent for requesting notification permission.
  public android.app.PendingIntent requestNotificationPermission(java.lang.String channelName, java.lang.String channelId) throws android.os.RemoteException;
  /** @hide */
