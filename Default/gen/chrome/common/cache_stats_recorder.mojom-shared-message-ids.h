// chrome/common/cache_stats_recorder.mojom-shared-message-ids.h is auto generated by mojom_bindings_generator.py, do not edit
...
constexpr uint32_t kCacheStatsRecorder_RecordCacheStats_Name = 0;
