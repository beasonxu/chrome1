...
DeviceTable.prototype = {
    ...
    setDevices(deviceCollection) {
        ...
        this.devices_.addEventListener('device-update', this.handleDeviceUpdate_.bind(this));
        this.devices_.addEventListener('device-added', this.handleDeviceAdded_.bind(this));
        this.devices_.addEventListener('devices-reset-for-test', this.redraw_.bind(this));
        this.redraw_();
    },
    /**
    ...
    handleDeviceUpdate_(event) {
        this.updateRow_(
        /** @type {!DeviceInfo} */ (this.devices_.item(event.detail)), event.detail);
    },
    /**
