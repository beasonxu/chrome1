...
export class CharacteristicListItemElement extends CustomElement {
    ...
    initialize(characteristicInfo, deviceAddress, serviceId) {
        ...
        this.propertiesFieldSet_.setObject({
            ...
            write_without_response: (this.info.properties & Property.WRITE_WITHOUT_RESPONSE) > 0,
            ...
            authenticated_signed_writes: (this.info.properties & Property.AUTHENTICATED_SIGNED_WRITES) > 0,
            extended_properties: (this.info.properties & Property.EXTENDED_PROPERTIES) > 0,
            reliable_write: (this.info.properties & Property.RELIABLE_WRITE) > 0,
            writable_auxiliaries: (this.info.properties & Property.WRITABLE_AUXILIARIES) > 0,
            ...
            read_encrypted_authenticated: (this.info.properties & Property.READ_ENCRYPTED_AUTHENTICATED) > 0,
            write_encrypted_authenticated: (this.info.properties & Property.WRITE_ENCRYPTED_AUTHENTICATED) > 0,
        });
        ...
        const characteristicDiv = this.shadowRoot.querySelector('.characteristic-div');
        ...
        infoDiv.insertBefore(this.valueControl_, this.shadowRoot.querySelector('characteristic-list'));
    }
}
customElements.define('characteristic-list-item', CharacteristicListItemElement);
