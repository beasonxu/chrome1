...
public class TabWindowManagerFactory {
    public static TabWindowManager createInstance (TabModelSelectorFactory selectorFactory, AsyncTabParamsManager asyncTabParamsManager, int maxSelectors) { return null; }
}
