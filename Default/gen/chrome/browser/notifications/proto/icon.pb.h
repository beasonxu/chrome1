...
PROTOBUF_NAMESPACE_OPEN
template<> ::notifications::proto::Icon* Arena::CreateMaybeMessage<::notifications::proto::Icon>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace notifications {
namespace proto {
...
class Icon final :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:notifications.proto.Icon) */ {
 public:
  inline Icon() : Icon(nullptr) {}
  ~Icon() override;
  explicit PROTOBUF_CONSTEXPR Icon(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  PROTOBUF_NOINLINE void Swap(Icon* other) {
  ...
  Icon* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
// optional bytes icon = 1;
inline bool Icon::_internal_has_icon() const {
  bool value = (_has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool Icon::has_icon() const {
  return _internal_has_icon();
}
inline void Icon::clear_icon() {
  icon_.ClearToEmpty();
  _has_bits_[0] &= ~0x00000001u;
}
inline const std::string& Icon::icon() const {
  // @@protoc_insertion_point(field_get:notifications.proto.Icon.icon)
  return _internal_icon();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Icon::set_icon(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 icon_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:notifications.proto.Icon.icon)
}
inline std::string* Icon::mutable_icon() {
  std::string* _s = _internal_mutable_icon();
  // @@protoc_insertion_point(field_mutable:notifications.proto.Icon.icon)
  return _s;
}
inline const std::string& Icon::_internal_icon() const {
  return icon_.Get();
}
inline void Icon::_internal_set_icon(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  icon_.Set(value, GetArenaForAllocation());
}
inline std::string* Icon::_internal_mutable_icon() {
  _has_bits_[0] |= 0x00000001u;
  return icon_.Mutable(GetArenaForAllocation());
}
inline std::string* Icon::release_icon() {
  // @@protoc_insertion_point(field_release:notifications.proto.Icon.icon)
...
inline void Icon::set_allocated_icon(std::string* icon) {
  if (icon != nullptr) {
    _has_bits_[0] |= 0x00000001u;
  } else {
    _has_bits_[0] &= ~0x00000001u;
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:notifications.proto.Icon.icon)
}
