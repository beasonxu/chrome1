// chrome/browser/ui/webui/bluetooth_internals/bluetooth_internals.mojom-lite-for-compile.js is auto generated by mojom_bindings_generator.py, do not edit
...
goog.require('bluetooth.mojom.Adapter');
...
goog.provide('mojom.DebugLogsChangeHandlerReceiver');
goog.provide('mojom.DebugLogsChangeHandlerCallbackRouter');
goog.provide('mojom.DebugLogsChangeHandlerInterface');
goog.provide('mojom.DebugLogsChangeHandlerRemote');
goog.provide('mojom.DebugLogsChangeHandlerPendingReceiver');
...
/** @interface */
mojom.DebugLogsChangeHandlerInterface = class {
...
goog.provide('mojom.BluetoothInternalsHandlerReceiver');
goog.provide('mojom.BluetoothInternalsHandlerCallbackRouter');
goog.provide('mojom.BluetoothInternalsHandlerInterface');
goog.provide('mojom.BluetoothInternalsHandlerRemote');
goog.provide('mojom.BluetoothInternalsHandlerPendingReceiver');
...
/** @interface */
mojom.BluetoothInternalsHandlerInterface = class {
...
goog.provide('mojom.DebugLogsChangeHandler_ChangeDebugLogsState_ParamsSpec');
/**
...
goog.provide('mojom.BluetoothInternalsHandler_GetAdapter_ParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('mojom.BluetoothInternalsHandler_GetAdapter_ResponseParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('mojom.BluetoothInternalsHandler_GetDebugLogsChangeHandler_ParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('mojom.BluetoothInternalsHandler_GetDebugLogsChangeHandler_ResponseParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
