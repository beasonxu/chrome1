...
class RemoteCopyMessage final :
 ...
 public:
  inline RemoteCopyMessage() : RemoteCopyMessage(nullptr) {}
  ...
  protected:
  explicit RemoteCopyMessage(::PROTOBUF_NAMESPACE_ID::Arena* arena,
...
inline void RemoteCopyMessage::set_text(ArgT0&& arg0, ArgT... args) {
  if (!_internal_has_text()) {
    clear_content();
    set_has_text();
    content_.text_.InitDefault();
  }
  content_.text_.Set( static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void RemoteCopyMessage::_internal_set_text(const std::string& value) {
  ...
  content_.text_.Set(value, GetArenaForAllocation());
}
inline std::string* RemoteCopyMessage::_internal_mutable_text() {
  ...
  return content_.text_.Mutable(      GetArenaForAllocation());
}
...
inline void RemoteCopyMessage::set_allocated_text(std::string* text) {
  ...
  if (text != nullptr) {
    set_has_text();
    content_.text_.InitAllocated(text, GetArenaForAllocation());
  }
...
template <typename ArgT0, typename... ArgT>
inline void RemoteCopyMessage::set_image_url(ArgT0&& arg0, ArgT... args) {
  if (!_internal_has_image_url()) {
    clear_content();
    set_has_image_url();
    content_.image_url_.InitDefault();
  }
  content_.image_url_.Set( static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline const std::string& RemoteCopyMessage::_internal_image_url() const {
  if (_internal_has_image_url()) {
    return content_.image_url_.Get();
  }
  return ::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited();
}
inline void RemoteCopyMessage::_internal_set_image_url(const std::string& value) {
  ...
  content_.image_url_.Set(value, GetArenaForAllocation());
}
inline std::string* RemoteCopyMessage::_internal_mutable_image_url() {
  ...
  return content_.image_url_.Mutable(      GetArenaForAllocation());
}
inline std::string* RemoteCopyMessage::release_image_url() {
  ...
  if (_internal_has_image_url()) {
    clear_has_content();
    return content_.image_url_.Release();
  } else {
    return nullptr;
  }
}
inline void RemoteCopyMessage::set_allocated_image_url(std::string* image_url) {
  ...
  if (image_url != nullptr) {
    set_has_image_url();
    content_.image_url_.InitAllocated(image_url, GetArenaForAllocation());
  }
