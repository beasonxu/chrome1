...
PROTOBUF_CONSTEXPR RemoteCopyMessage::RemoteCopyMessage(
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 RemoteCopyMessageDefaultTypeInternal _RemoteCopyMessage_default_instance_;
}  // namespace chrome_browser_sharing
namespace chrome_browser_sharing {
...
RemoteCopyMessage::RemoteCopyMessage(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::MessageLite(arena, is_message_owned) {
  SharedCtor();
  // @@protoc_insertion_point(arena_constructor:chrome_browser_sharing.RemoteCopyMessage)
}
...
inline void RemoteCopyMessage::SharedCtor() {
clear_has_content();
}
...
// @@protoc_insertion_point(one_of_clear_start:chrome_browser_sharing.RemoteCopyMessage)
  switch (content_case()) {
    case kText: {
      content_.text_.Destroy();
      break;
    }
    case kImageUrl: {
      content_.image_url_.Destroy();
      break;
    }
    case CONTENT_NOT_SET: {
      break;
...
uint8_t* RemoteCopyMessage::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:chrome_browser_sharing.RemoteCopyMessage)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:chrome_browser_sharing.RemoteCopyMessage)
  return target;
}
...
void RemoteCopyMessage::CheckTypeAndMergeFrom(
  ...
  MergeFrom(*::_pbi::DownCast<const RemoteCopyMessage*>(
      &from));
}
...
template<> PROTOBUF_NOINLINE ::chrome_browser_sharing::RemoteCopyMessage*
Arena::CreateMaybeMessage< ::chrome_browser_sharing::RemoteCopyMessage >(Arena* arena) {
  return Arena::CreateMessageInternal< ::chrome_browser_sharing::RemoteCopyMessage >(arena);
}
