 ...
 public:
  ...
  static WTF::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        DelegatedInkBrowserMetadata::DataView, WTF::Vector<uint8_t>>(input);
  }
...
RenderFrameMetadata& operator=(const RenderFrameMetadata&) = delete;
  ...
  static WTF::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        RenderFrameMetadata::DataView, WTF::Vector<uint8_t>>(input);
  }
...
struct BLINK_PLATFORM_EXPORT StructTraits<::cc::mojom::blink::RenderFrameMetadata::DataView,
  ...
  static decltype(::cc::mojom::blink::RenderFrameMetadata::bottom_controls_height) bottom_controls_height(
      const ::cc::mojom::blink::RenderFrameMetadataPtr& input) {
    return input->bottom_controls_height;
  }

  static decltype(::cc::mojom::blink::RenderFrameMetadata::bottom_controls_shown_ratio) bottom_controls_shown_ratio(
      const ::cc::mojom::blink::RenderFrameMetadataPtr& input) {
    return input->bottom_controls_shown_ratio;
  }

  static decltype(::cc::mojom::blink::RenderFrameMetadata::top_controls_min_height_offset) top_controls_min_height_offset(
      const ::cc::mojom::blink::RenderFrameMetadataPtr& input) {
    return input->top_controls_min_height_offset;
  }

  static decltype(::cc::mojom::blink::RenderFrameMetadata::bottom_controls_min_height_offset) bottom_controls_min_height_offset(
      const ::cc::mojom::blink::RenderFrameMetadataPtr& input) {
    return input->bottom_controls_min_height_offset;
  }

  static decltype(::cc::mojom::blink::RenderFrameMetadata::min_page_scale_factor) min_page_scale_factor(
      const ::cc::mojom::blink::RenderFrameMetadataPtr& input) {
    return input->min_page_scale_factor;
  }

  static decltype(::cc::mojom::blink::RenderFrameMetadata::max_page_scale_factor) max_page_scale_factor(
      const ::cc::mojom::blink::RenderFrameMetadataPtr& input) {
    return input->max_page_scale_factor;
  }

  static decltype(::cc::mojom::blink::RenderFrameMetadata::root_overflow_y_hidden) root_overflow_y_hidden(
      const ::cc::mojom::blink::RenderFrameMetadataPtr& input) {
    return input->root_overflow_y_hidden;
  }

  static const decltype(::cc::mojom::blink::RenderFrameMetadata::scrollable_viewport_size)& scrollable_viewport_size(
      const ::cc::mojom::blink::RenderFrameMetadataPtr& input) {
    return input->scrollable_viewport_size;
  }

  static const decltype(::cc::mojom::blink::RenderFrameMetadata::root_layer_size)& root_layer_size(
      const ::cc::mojom::blink::RenderFrameMetadataPtr& input) {
    return input->root_layer_size;
  }

  static decltype(::cc::mojom::blink::RenderFrameMetadata::has_transparent_background) has_transparent_background(
      const ::cc::mojom::blink::RenderFrameMetadataPtr& input) {
