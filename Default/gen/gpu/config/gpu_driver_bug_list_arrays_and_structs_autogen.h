...
{GpuControlList::kLT, GpuControlList::kVersionStyleNumerical, GpuControlList::kVersionSchemaCommon, "3.0", nullptr},  // gl_version
...
GpuControlList::kGLTypeGLES,  // gl_type
{GpuControlList::kEQ, GpuControlList::kVersionStyleNumerical, GpuControlList::kVersionSchemaCommon, "3.1", nullptr},  // gl_version
{GpuControlList::kUnknown, GpuControlList::kVersionStyleNumerical, GpuControlList::kVersionSchemaCommon, nullptr, nullptr},  // pixel_shader_version
false,  // in_process_gpu
0,  // gl_reset_notification_strategy
{GpuControlList::kUnknown, GpuControlList::kVersionStyleNumerical, GpuControlList::kVersionSchemaCommon, nullptr, nullptr},  // direct_rendering_version
...
const uint32_t kCrBugsForWorkaroundsEntry88[2] = {
398694,
1165751,
};
...
{GpuControlList::kBetween, GpuControlList::kVersionStyleNumerical, GpuControlList::kVersionSchemaCommon, "1.3", "1.4"},  // driver_version
};
...
nullptr,  // driver_vendor
{GpuControlList::kLT, GpuControlList::kVersionStyleNumerical, GpuControlList::kVersionSchemaCommon, "95", nullptr},  // driver_version
};
...
nullptr,  // driver_vendor
{GpuControlList::kLT, GpuControlList::kVersionStyleNumerical, GpuControlList::kVersionSchemaCommon, "346", nullptr},  // driver_version
};
...
std::size(kMachineModelNameForEntry157),  // machine model name size
...
const uint32_t kCrBugsForWorkaroundsEntry214[6] = {
670607,
682075,
696627,
698197,
...
nullptr,  // driver_vendor
{GpuControlList::kGE, GpuControlList::kVersionStyleNumerical, GpuControlList::kVersionSchemaCommon, "103.0", nullptr},  // driver_version
};
...
std::size(kMachineModelNameForEntry247),  // machine model name size
...
nullptr,  // driver_vendor
{GpuControlList::kEQ, GpuControlList::kVersionStyleNumerical, GpuControlList::kVersionSchemaCommon, "12.1.01alp0", nullptr},  // driver_version
};
...
nullptr,  // driver_vendor
{GpuControlList::kGT, GpuControlList::kVersionStyleNumerical, GpuControlList::kVersionSchemaCommon, "237.0", nullptr},  // driver_version
};
...
nullptr,  // driver_vendor
{GpuControlList::kEQ, GpuControlList::kVersionStyleNumerical, GpuControlList::kVersionSchemaCommon, "12.0.04rel0", nullptr},  // driver_version
};
...
const uint32_t kCrBugsForWorkaroundsEntry334[2] = {
1052114,
1117370,
};
...
const int kFeatureListForWorkaroundsEntry358[1] = {
FORCE_ENABLE_COLOR_BUFFER_FLOAT_EXCEPT_RGB32F,
};

const uint32_t kCrBugsForWorkaroundsEntry358[1] = {
1127387,
};

const GpuControlList::More kMoreForEntry358_619971032 = {
GpuControlList::kGLTypeNone,  // gl_type
{GpuControlList::kUnknown, GpuControlList::kVersionStyleNumerical, GpuControlList::kVersionSchemaCommon, nullptr, nullptr},  // gl_version
{GpuControlList::kUnknown, GpuControlList::kVersionStyleNumerical, GpuControlList::kVersionSchemaCommon, nullptr, nullptr},  // pixel_shader_version
false,  // in_process_gpu
...
const int kFeatureListForWorkaroundsEntry359[1] = {
DISABLE_DEPTH_TEXTURE,
};

const char* const kDisabledExtensionsForEntry359[1] = {
"GL_OES_depth_texture",
};

const uint32_t kCrBugsForWorkaroundsEntry359[2] = {
682075,
1042214,
};

const GpuControlList::GLStrings kGLStringsForWorkaroundsEntry359 = {
nullptr,
"Adreno \\(TM\\) 3.*",
nullptr,
nullptr,
...
const GpuControlList::More kMoreForEntry359_619971032 = {
GpuControlList::kGLTypeNone,  // gl_type
{GpuControlList::kUnknown, GpuControlList::kVersionStyleNumerical, GpuControlList::kVersionSchemaCommon, nullptr, nullptr},  // gl_version
{GpuControlList::kUnknown, GpuControlList::kVersionStyleNumerical, GpuControlList::kVersionSchemaCommon, nullptr, nullptr},  // pixel_shader_version
false,  // in_process_gpu
...
const int kFeatureListForWorkaroundsEntry365[1] = {
EXIT_ON_CONTEXT_LOST,
};

const uint32_t kCrBugsForWorkaroundsEntry365[1] = {
1079161,
};

const GpuControlList::GLStrings kGLStringsForWorkaroundsEntry365 = {
nullptr,
"Adreno.*",
nullptr,
nullptr,
...
const GpuControlList::More kMoreForEntry365_619971032 = {
GpuControlList::kGLTypeNone,  // gl_type
{GpuControlList::kUnknown, GpuControlList::kVersionStyleNumerical, GpuControlList::kVersionSchemaCommon, nullptr, nullptr},  // gl_version
{GpuControlList::kUnknown, GpuControlList::kVersionStyleNumerical, GpuControlList::kVersionSchemaCommon, nullptr, nullptr},  // pixel_shader_version
false,  // in_process_gpu
...
const int kFeatureListForWorkaroundsEntry367[1] = {
EXIT_ON_CONTEXT_LOST,
};

const uint32_t kCrBugsForWorkaroundsEntry367[1] = {
1180962,
};

const GpuControlList::GLStrings kGLStringsForWorkaroundsEntry367 = {
nullptr,
"ANGLE.*",
nullptr,
nullptr,
...
const GpuControlList::More kMoreForEntry367_619971032 = {
GpuControlList::kGLTypeNone,  // gl_type
{GpuControlList::kUnknown, GpuControlList::kVersionStyleNumerical, GpuControlList::kVersionSchemaCommon, nullptr, nullptr},  // gl_version
{GpuControlList::kUnknown, GpuControlList::kVersionStyleNumerical, GpuControlList::kVersionSchemaCommon, nullptr, nullptr},  // pixel_shader_version
false,  // in_process_gpu
...
const int kFeatureListForWorkaroundsEntry386[1] = {
DISABLE_CANVAS_OOP_RASTERIZATION,
};

const uint32_t kCrBugsForWorkaroundsEntry386[1] = {
1253962,
};

const GpuControlList::DriverInfo kDriverInfoForWorkaroundsEntry386 = {
nullptr,  // driver_vendor
{GpuControlList::kLT, GpuControlList::kVersionStyleNumerical, GpuControlList::kVersionSchemaCommon, "145", nullptr},  // driver_version
};

const GpuControlList::GLStrings kGLStringsForWorkaroundsEntry386 = {
nullptr,
".*Adreno \\(TM\\) 4.*",
nullptr,
nullptr,
...
const GpuControlList::More kMoreForEntry386_619971032 = {
GpuControlList::kGLTypeNone,  // gl_type
{GpuControlList::kUnknown, GpuControlList::kVersionStyleNumerical, GpuControlList::kVersionSchemaCommon, nullptr, nullptr},  // gl_version
{GpuControlList::kUnknown, GpuControlList::kVersionStyleNumerical, GpuControlList::kVersionSchemaCommon, nullptr, nullptr},  // pixel_shader_version
false,  // in_process_gpu
...
const int kFeatureListForWorkaroundsEntry399[1] = {
MSAA_IS_SLOW_2,
};

const uint32_t kCrBugsForWorkaroundsEntry399[1] = {
759471,
};

const GpuControlList::GLStrings kGLStringsForWorkaroundsEntry399 = {
"Intel.*",
nullptr,
nullptr,
nullptr,
...
const GpuControlList::More kMoreForEntry399_619971032 = {
GpuControlList::kGLTypeNone,  // gl_type
{GpuControlList::kUnknown, GpuControlList::kVersionStyleNumerical, GpuControlList::kVersionSchemaCommon, nullptr, nullptr},  // gl_version
{GpuControlList::kUnknown, GpuControlList::kVersionStyleNumerical, GpuControlList::kVersionSchemaCommon, nullptr, nullptr},  // pixel_shader_version
false,  // in_process_gpu
