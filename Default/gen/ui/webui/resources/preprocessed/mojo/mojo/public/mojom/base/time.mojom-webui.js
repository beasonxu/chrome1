 ...
 */
export const TimeSpec = { $: /** @type {!mojo.internal.MojomType} */ ({}) };
/**
 * @const { {$:!mojo.internal.MojomType}}
 */
export const TimeDeltaSpec = { $: /** @type {!mojo.internal.MojomType} */ ({}) };
/**
 * @const { {$:!mojo.internal.MojomType}}
 */
export const TimeTicksSpec = { $: /** @type {!mojo.internal.MojomType} */ ({}) };
