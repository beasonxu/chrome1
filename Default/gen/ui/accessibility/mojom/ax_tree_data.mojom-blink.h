...
AXTreeData& operator=(const AXTreeData&) = delete;
  ...
  static WTF::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        AXTreeData::DataView, WTF::Vector<uint8_t>>(input);
  }
...
template <>
struct  StructTraits<::ax::mojom::blink::AXTreeData::DataView,
                                         ::ax::mojom::blink::AXTreeDataPtr> {
  ...
  static const decltype(::ax::mojom::blink::AXTreeData::tree_id)& tree_id(
      const ::ax::mojom::blink::AXTreeDataPtr& input) {
    return input->tree_id;
  }

  static const decltype(::ax::mojom::blink::AXTreeData::parent_tree_id)& parent_tree_id(
      const ::ax::mojom::blink::AXTreeDataPtr& input) {
    return input->parent_tree_id;
  }

  static const decltype(::ax::mojom::blink::AXTreeData::focused_tree_id)& focused_tree_id(
      const ::ax::mojom::blink::AXTreeDataPtr& input) {
    return input->focused_tree_id;
  }

  static const decltype(::ax::mojom::blink::AXTreeData::doctype)& doctype(
      const ::ax::mojom::blink::AXTreeDataPtr& input) {
    return input->doctype;
  }

  static decltype(::ax::mojom::blink::AXTreeData::loaded) loaded(
      const ::ax::mojom::blink::AXTreeDataPtr& input) {
    return input->loaded;
  }

  static decltype(::ax::mojom::blink::AXTreeData::loading_progress) loading_progress(
      const ::ax::mojom::blink::AXTreeDataPtr& input) {
    return input->loading_progress;
  }

  static const decltype(::ax::mojom::blink::AXTreeData::mimetype)& mimetype(
      const ::ax::mojom::blink::AXTreeDataPtr& input) {
    return input->mimetype;
  }

  static const decltype(::ax::mojom::blink::AXTreeData::title)& title(
      const ::ax::mojom::blink::AXTreeDataPtr& input) {
    return input->title;
  }

  static const decltype(::ax::mojom::blink::AXTreeData::url)& url(
      const ::ax::mojom::blink::AXTreeDataPtr& input) {
    return input->url;
  }

  static decltype(::ax::mojom::blink::AXTreeData::focus_id) focus_id(
      const ::ax::mojom::blink::AXTreeDataPtr& input) {
    return input->focus_id;
  }

  static decltype(::ax::mojom::blink::AXTreeData::sel_is_backward) sel_is_backward(
      const ::ax::mojom::blink::AXTreeDataPtr& input) {
    return input->sel_is_backward;
  }

  static decltype(::ax::mojom::blink::AXTreeData::sel_anchor_object_id) sel_anchor_object_id(
      const ::ax::mojom::blink::AXTreeDataPtr& input) {
    return input->sel_anchor_object_id;
  }

  static decltype(::ax::mojom::blink::AXTreeData::sel_anchor_offset) sel_anchor_offset(
      const ::ax::mojom::blink::AXTreeDataPtr& input) {
    return input->sel_anchor_offset;
  }

  static decltype(::ax::mojom::blink::AXTreeData::sel_anchor_affinity) sel_anchor_affinity(
      const ::ax::mojom::blink::AXTreeDataPtr& input) {
    return input->sel_anchor_affinity;
  }

  static decltype(::ax::mojom::blink::AXTreeData::sel_focus_object_id) sel_focus_object_id(
      const ::ax::mojom::blink::AXTreeDataPtr& input) {
    return input->sel_focus_object_id;
  }

  static decltype(::ax::mojom::blink::AXTreeData::sel_focus_offset) sel_focus_offset(
      const ::ax::mojom::blink::AXTreeDataPtr& input) {
    return input->sel_focus_offset;
  }

  static decltype(::ax::mojom::blink::AXTreeData::sel_focus_affinity) sel_focus_affinity(
      const ::ax::mojom::blink::AXTreeDataPtr& input) {
    return input->sel_focus_affinity;
  }

  static decltype(::ax::mojom::blink::AXTreeData::root_scroller_id) root_scroller_id(
      const ::ax::mojom::blink::AXTreeDataPtr& input) {
    return input->root_scroller_id;
  }

  static const decltype(::ax::mojom::blink::AXTreeData::metadata)& metadata(
      const ::ax::mojom::blink::AXTreeDataPtr& input) {
