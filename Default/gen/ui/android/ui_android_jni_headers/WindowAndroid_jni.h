...
static std::atomic<jmethodID> g_org_chromium_ui_base_WindowAndroid_destroy(nullptr);
static void Java_WindowAndroid_destroy(JNIEnv* env, const base::android::JavaRef<jobject>& obj) {
  jclass clazz = org_chromium_ui_base_WindowAndroid_clazz(env);
  CHECK_CLAZZ(env, obj.obj(),
      org_chromium_ui_base_WindowAndroid_clazz(env));
  ...
  call_context.Init<
      base::android::MethodID::TYPE_INSTANCE>(
          ...
          "destroy",
          "()V",
          &g_org_chromium_ui_base_WindowAndroid_destroy);
...
static std::atomic<jmethodID> g_org_chromium_ui_base_WindowAndroid_setWideColorEnabled(nullptr);
static void Java_WindowAndroid_setWideColorEnabled(JNIEnv* env, const
  ...
  call_context.Init<
      base::android::MethodID::TYPE_INSTANCE>(
          ...
          "setWideColorEnabled",
          "(Z)V",
          &g_org_chromium_ui_base_WindowAndroid_setWideColorEnabled);
