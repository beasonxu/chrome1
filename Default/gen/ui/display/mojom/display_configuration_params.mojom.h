...
DisplayConfigurationParams& operator=(const DisplayConfigurationParams&) = delete;
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        DisplayConfigurationParams::DataView, std::vector<uint8_t>>(input);
  }
...
template <>
struct  StructTraits<::display::mojom::DisplayConfigurationParams::DataView,
                                         ::display::mojom::DisplayConfigurationParamsPtr> {
  ...
  static decltype(::display::mojom::DisplayConfigurationParams::id) id(
      const ::display::mojom::DisplayConfigurationParamsPtr& input) {
    return input->id;
  }

  static const decltype(::display::mojom::DisplayConfigurationParams::origin)& origin(
      const ::display::mojom::DisplayConfigurationParamsPtr& input) {
    return input->origin;
  }

  static const decltype(::display::mojom::DisplayConfigurationParams::mode)& mode(
      const ::display::mojom::DisplayConfigurationParamsPtr& input) {
    return input->mode;
  }
