...
struct  StructTraits<::display::mojom::blink::DisplaySnapshot::DataView,
  ...
  static decltype(::display::mojom::blink::DisplaySnapshot::port_display_id) port_display_id(
      const ::display::mojom::blink::DisplaySnapshotPtr& input) {
    return input->port_display_id;
  }

  static decltype(::display::mojom::blink::DisplaySnapshot::edid_display_id) edid_display_id(
      const ::display::mojom::blink::DisplaySnapshotPtr& input) {
    return input->edid_display_id;
  }

  static decltype(::display::mojom::blink::DisplaySnapshot::connector_index) connector_index(
      const ::display::mojom::blink::DisplaySnapshotPtr& input) {
  ...
  static decltype(::display::mojom::blink::DisplaySnapshot::base_connector_id) base_connector_id(
      const ::display::mojom::blink::DisplaySnapshotPtr& input) {
    return input->base_connector_id;
  }

  static const decltype(::display::mojom::blink::DisplaySnapshot::path_topology)& path_topology(
      const ::display::mojom::blink::DisplaySnapshotPtr& input) {
