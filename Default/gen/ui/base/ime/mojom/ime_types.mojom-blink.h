...
struct ui_mojom_internal_TextInputAction_DataHashFn {
  ...
  static bool Equal(const ::ui::mojom::TextInputAction& left, const ::ui::mojom::TextInputAction& right) {
    return left == right;
  }
  static const bool safe_to_compare_to_empty_or_deleted = true;
};
...
struct HashTraits<::ui::mojom::TextInputAction>
    : public GenericHashTraits<::ui::mojom::TextInputAction> {
  static_assert(true,
                "-1000000 is a reserved enum value");
  static_assert(true,
                "-1000001 is a reserved enum value");
  ...
  static void ConstructDeletedValue(::ui::mojom::TextInputAction& slot, bool) {
    slot = static_cast<::ui::mojom::TextInputAction>(-1000001);
  }
  static bool IsDeletedValue(const ::ui::mojom::TextInputAction& value) {
    return value == static_cast<::ui::mojom::TextInputAction>(-1000001);
  }
};
}  // namespace WTF
