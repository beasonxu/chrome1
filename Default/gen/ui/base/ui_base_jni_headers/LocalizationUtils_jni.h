...
static base::android::ScopedJavaLocalRef<jstring> JNI_LocalizationUtils_GetNativeUiLocale(JNIEnv*
    env);

JNI_GENERATOR_EXPORT jstring Java_J_N_MqGtfAYA(
    JNIEnv* env,
    jclass jcaller) {
  return JNI_LocalizationUtils_GetNativeUiLocale(env).Release();
}
