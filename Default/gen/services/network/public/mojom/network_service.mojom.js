...
(function() {
  ...
  NetworkService_OnApplicationStateChange_Params.decode = function(decoder) {
    ...
    var version = decoder.readUint32();
    val.state =
        decoder.decodeStruct(new codec.Enum(application_state$.ApplicationState));
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  NetworkService_SetFirstPartySets_Params.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateMapPointer(offset + codec.kStructHeaderSize + 0, false, new codec.PointerTo(schemeful_site$.SchemefulSite), new codec.PointerTo(first_party_sets$.FirstPartySetEntry), false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  NetworkService_SetFirstPartySets_Params.decode = function(decoder) {
    ...
    var version = decoder.readUint32();
    val.sets =
        decoder.decodeMapPointer(new codec.PointerTo(schemeful_site$.SchemefulSite), new codec.PointerTo(first_party_sets$.FirstPartySetEntry));
    return val;
  };
  ...
  NetworkService_SetFirstPartySets_Params.encode = function(encoder, val) {
    ...
    encoder.writeUint32(0);
    encoder.encodeMapPointer(new codec.PointerTo(schemeful_site$.SchemefulSite), new codec.PointerTo(first_party_sets$.FirstPartySetEntry), val.sets);
  };
  ...
  var kNetworkService_OnApplicationStateChange_Name = 20;
  var kNetworkService_SetEnvironment_Name = 21;
  var kNetworkService_SetTrustTokenKeyCommitments_Name = 22;
  var kNetworkService_ClearSCTAuditingCache_Name = 23;
  var kNetworkService_ConfigureSCTAuditing_Name = 24;
  var kNetworkService_UpdateCtLogList_Name = 25;
  var kNetworkService_UpdateCtKnownPopularSCTs_Name = 26;
  var kNetworkService_SetCtEnforcementEnabled_Name = 27;
  var kNetworkService_UpdateKeyPinsList_Name = 28;
  var kNetworkService_DumpWithoutCrashing_Name = 29;
  var kNetworkService_BindTestInterface_Name = 30;
  var kNetworkService_SetFirstPartySets_Name = 31;
  var kNetworkService_SetExplicitlyAllowedPorts_Name = 32;
  var kNetworkService_ParseHeaders_Name = 33;
