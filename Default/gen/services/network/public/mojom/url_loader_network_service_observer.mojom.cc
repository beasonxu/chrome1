...
void URLLoaderNetworkServiceObserverProxy::OnClearSiteData(
    const ::GURL& in_url, const std::string& in_header_value, int32_t in_load_flags, const absl::optional<::net::CookiePartitionKey>& in_cookie_partition_key, OnClearSiteDataCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void URLLoaderNetworkServiceObserverInterceptorForTesting::OnClearSiteData(const ::GURL& url, const std::string& header_value, int32_t load_flags, const absl::optional<::net::CookiePartitionKey>& cookie_partition_key, OnClearSiteDataCallback callback) {
