...
// with not having this data in traces there.
  ...
  virtual void SetFirstPartySets(const base::flat_map<::net::SchemefulSite, ::net::FirstPartySetEntry>& sets) = 0;
...
class  NetworkServiceProxy
 ...
 public:
  ...
  void SetFirstPartySets(const base::flat_map<::net::SchemefulSite, ::net::FirstPartySetEntry>& sets) final;
