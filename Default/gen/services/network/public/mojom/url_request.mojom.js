...
(function() {
  ...
  URLRequest.decode = function(decoder) {
    ...
    val.isSignedExchangePrefetchCacheEnabled = (packed >> 4) & 1 ? true : false;
    val.isFetchLikeApi = (packed >> 5) & 1 ? true : false;
    val.isFavicon = (packed >> 6) & 1 ? true : false;
    decoder.skip(1);
    decoder.skip(1);
    val.referrerPolicy =
  ...
  URLRequest.encode = function(encoder, val) {
    ...
    packed |= (val.isSignedExchangePrefetchCacheEnabled & 1) << 4
    packed |= (val.isFetchLikeApi & 1) << 5
    packed |= (val.isFavicon & 1) << 6
    encoder.writeUint8(packed);
    encoder.skip(1);
    encoder.skip(1);
