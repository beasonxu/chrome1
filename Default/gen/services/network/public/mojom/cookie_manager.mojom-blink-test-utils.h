...
class BLINK_PLATFORM_EXPORT CookieManagerInterceptorForTesting : public CookieManager {
  ...
  void SetStorageAccessGrantSettings(WTF::Vector<::content_settings::mojom::blink::ContentSettingPatternSourcePtr> settings, SetStorageAccessGrantSettingsCallback callback) override;
