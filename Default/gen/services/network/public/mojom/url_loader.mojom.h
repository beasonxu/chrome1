...
// with not having this data in traces there.
  ...
  virtual void OnReceiveResponse(::network::mojom::URLResponseHeadPtr head, ::mojo::ScopedDataPipeConsumerHandle body) = 0;
...
class  URLLoaderClientProxy
 ...
 public:
  ...
  void OnReceiveResponse(::network::mojom::URLResponseHeadPtr head, ::mojo::ScopedDataPipeConsumerHandle body) final;
