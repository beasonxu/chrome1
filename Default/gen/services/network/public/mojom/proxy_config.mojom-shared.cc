...
bool ProxyBypassRules_Data::Validate(
  ...
  [[maybe_unused]] const ProxyBypassRules_Data* object =
      static_cast<const ProxyBypassRules_Data*>(data);
...
bool ProxyConfig_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->pac_url, 3, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->proxy_rules, 5, validation_context)) {
    return false;
  }
