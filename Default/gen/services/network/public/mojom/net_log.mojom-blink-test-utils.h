...
class BLINK_PLATFORM_EXPORT NetLogProxySinkInterceptorForTesting : public NetLogProxySink {
  ...
  void AddEntry(uint32_t type, uint32_t source_type, uint32_t source_id, ::base::TimeTicks source_start_time, NetLogEventPhase phase, ::base::TimeTicks time, ::base::Value params) override;
};
