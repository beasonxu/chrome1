...
class  URLLoaderClient_OnReceiveCachedMetadata_Params_Data {
 ...
 private:
  friend class mojo::internal::MessageFragment<URLLoaderClient_OnReceiveCachedMetadata_Params_Data>;
...
class URLLoaderClient_OnReceiveCachedMetadata_ParamsDataView {
 public:
  URLLoaderClient_OnReceiveCachedMetadata_ParamsDataView() = default;
