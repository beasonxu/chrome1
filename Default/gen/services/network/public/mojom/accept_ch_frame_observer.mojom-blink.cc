...
void AcceptCHFrameObserverProxy::OnAcceptCHFrameReceived(
    const ::scoped_refptr<const ::blink::SecurityOrigin>& in_origin, const WTF::Vector<::network::mojom::blink::WebClientHintsType>& in_accept_ch_frame, OnAcceptCHFrameReceivedCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void AcceptCHFrameObserverInterceptorForTesting::OnAcceptCHFrameReceived(const ::scoped_refptr<const ::blink::SecurityOrigin>& origin, const WTF::Vector<::network::mojom::blink::WebClientHintsType>& accept_ch_frame, OnAcceptCHFrameReceivedCallback callback) {
