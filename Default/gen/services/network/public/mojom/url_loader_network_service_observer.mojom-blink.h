...
// with not having this data in traces there.
  ...
  virtual void OnClearSiteData(const ::blink::KURL& url, const WTF::String& header_value, int32_t load_flags, ::network::mojom::blink::CookiePartitionKeyPtr cookie_partition_key, OnClearSiteDataCallback callback) = 0;
...
class BLINK_PLATFORM_EXPORT URLLoaderNetworkServiceObserverProxy
 ...
 public:
  ...
  void OnClearSiteData(const ::blink::KURL& url, const WTF::String& header_value, int32_t load_flags, ::network::mojom::blink::CookiePartitionKeyPtr cookie_partition_key, OnClearSiteDataCallback callback) final;
