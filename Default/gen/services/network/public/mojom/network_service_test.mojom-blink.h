...
struct network_mojom_internal_NetworkServiceTest_RequireCT_DataHashFn {
  ...
  static bool Equal(const ::network::mojom::NetworkServiceTest_RequireCT& left, const ::network::mojom::NetworkServiceTest_RequireCT& right) {
    return left == right;
  }
  static const bool safe_to_compare_to_empty_or_deleted = true;
};
...
struct HashTraits<::network::mojom::NetworkServiceTest_RequireCT>
    : public GenericHashTraits<::network::mojom::NetworkServiceTest_RequireCT> {
  static_assert(true,
                "-1000000 is a reserved enum value");
  static_assert(true,
                "-1000001 is a reserved enum value");
  ...
  static void ConstructDeletedValue(::network::mojom::NetworkServiceTest_RequireCT& slot, bool) {
    slot = static_cast<::network::mojom::NetworkServiceTest_RequireCT>(-1000001);
  }
