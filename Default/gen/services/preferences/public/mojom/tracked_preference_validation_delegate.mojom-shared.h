...
struct Serializer<::prefs::mojom::TrackedPreferenceValidationDelegate_ValueState, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    return Traits::FromMojom(::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::prefs::mojom::TrackedPreferenceValidationDelegate_ValueState>(input)), output);
  }
};
...
template <>
struct  TraceFormatTraits<::prefs::mojom::TrackedPreferenceValidationDelegate_ValueState> {
