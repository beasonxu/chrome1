 ...
 public:
  ...
  ProxyScheme scheme() const {
    return ::mojo::internal::ToKnownEnumValueHelper(
          static_cast<::proxy_resolver::mojom::ProxyScheme>(data_->scheme));
  }
...
struct Serializer<::proxy_resolver::mojom::ProxyScheme, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    return Traits::FromMojom(::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::proxy_resolver::mojom::ProxyScheme>(input)), output);
  }
};
...
struct Serializer<::proxy_resolver::mojom::ProxyServerDataView, MaybeConstUserType> {
  ...
  static void Serialize(
      ...
      mojo::internal::MessageFragment<::proxy_resolver::mojom::internal::ProxyServer_Data>& fragment) {
...
template <>
struct  TraceFormatTraits<::proxy_resolver::mojom::ProxyScheme> {
