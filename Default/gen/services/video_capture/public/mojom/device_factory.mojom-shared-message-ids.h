...
constexpr uint32_t kDeviceFactory_AddGpuMemoryBufferVirtualDevice_Name = 4;
constexpr uint32_t kDeviceFactory_RegisterVirtualDevicesChangedObserver_Name = 5;
