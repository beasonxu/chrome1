...
bool Landmark_Data::Validate(
  ...
  [[maybe_unused]] const Landmark_Data* object =
      static_cast<const Landmark_Data*>(data);
...
bool FaceDetectionResult_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const FaceDetectionResult_Data* object =
      static_cast<const FaceDetectionResult_Data*>(data);
...
bool FaceDetectorOptions_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const FaceDetectorOptions_Data* object =
      static_cast<const FaceDetectorOptions_Data*>(data);
...
bool FaceDetection_Detect_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const FaceDetection_Detect_Params_Data* object =
      static_cast<const FaceDetection_Detect_Params_Data*>(data);
...
bool FaceDetection_Detect_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const FaceDetection_Detect_ResponseParams_Data* object =
      static_cast<const FaceDetection_Detect_ResponseParams_Data*>(data);
