...
bool TextDetectionResult_Data::Validate(
  ...
  [[maybe_unused]] const TextDetectionResult_Data* object =
      static_cast<const TextDetectionResult_Data*>(data);
...
bool TextDetection_Detect_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const TextDetection_Detect_Params_Data* object =
      static_cast<const TextDetection_Detect_Params_Data*>(data);
...
bool TextDetection_Detect_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const TextDetection_Detect_ResponseParams_Data* object =
      static_cast<const TextDetection_Detect_ResponseParams_Data*>(data);
