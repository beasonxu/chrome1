...
static std::atomic<jmethodID> g_org_chromium_device_sensors_PlatformSensor_create(nullptr);
static base::android::ScopedJavaLocalRef<jobject> Java_PlatformSensor_create(JNIEnv* env, const
    base::android::JavaRef<jobject>& provider,
    JniIntWrapper type,
    jlong nativePlatformSensorAndroid) {
  jclass clazz = org_chromium_device_sensors_PlatformSensor_clazz(env);
  CHECK_CLAZZ(env, clazz,
      org_chromium_device_sensors_PlatformSensor_clazz(env), NULL);
  ...
  call_context.Init<
      base::android::MethodID::TYPE_STATIC>(
          ...
          clazz,
          "create",
"(Lorg/chromium/device/sensors/PlatformSensorProvider;IJ)Lorg/chromium/device/sensors/PlatformSensor;",
          &g_org_chromium_device_sensors_PlatformSensor_create);

  jobject ret =
      env->CallStaticObjectMethod(clazz,
          call_context.base.method_id, provider.obj(), as_jint(type), nativePlatformSensorAndroid);
