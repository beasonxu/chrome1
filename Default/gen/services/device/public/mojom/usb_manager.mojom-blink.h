...
// with not having this data in traces there.
  ...
  virtual void GetDevice(const WTF::String& guid, const WTF::Vector<uint8_t>& blocked_interface_classes, ::mojo::PendingReceiver<::device::mojom::blink::UsbDevice> device_receiver, ::mojo::PendingRemote<::device::mojom::blink::UsbDeviceClient> device_client) = 0;

  
  virtual void GetSecurityKeyDevice(const WTF::String& guid, ::mojo::PendingReceiver<::device::mojom::blink::UsbDevice> device_receiver, ::mojo::PendingRemote<::device::mojom::blink::UsbDeviceClient> device_client) = 0;
...
class BLINK_PLATFORM_EXPORT UsbDeviceManagerProxy
 ...
 public:
  ...
  void GetDevice(const WTF::String& guid, const WTF::Vector<uint8_t>& blocked_interface_classes, ::mojo::PendingReceiver<::device::mojom::blink::UsbDevice> device_receiver, ::mojo::PendingRemote<::device::mojom::blink::UsbDeviceClient> device_client) final;
  
  void GetSecurityKeyDevice(const WTF::String& guid, ::mojo::PendingReceiver<::device::mojom::blink::UsbDevice> device_receiver, ::mojo::PendingRemote<::device::mojom::blink::UsbDeviceClient> device_client) final;
