...
bool DevicePostureProviderClient_OnPostureChanged_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const DevicePostureProviderClient_OnPostureChanged_Params_Data* object =
      static_cast<const DevicePostureProviderClient_OnPostureChanged_Params_Data*>(data);
