...
struct Serializer<::device::mojom::InputDeviceSubsystem, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    return Traits::FromMojom(::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::device::mojom::InputDeviceSubsystem>(input)), output);
  }
};
...
struct Serializer<::device::mojom::InputDeviceType, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    return Traits::FromMojom(::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::device::mojom::InputDeviceType>(input)), output);
  }
};
...
struct Serializer<::device::mojom::InputDeviceInfoDataView, MaybeConstUserType> {
  ...
  static void Serialize(
    ...
    mojo::internal::Serialize<::device::mojom::InputDeviceSubsystem>(
        Traits::subsystem(input), &fragment->subsystem);
...
template <>
struct  TraceFormatTraits<::device::mojom::InputDeviceSubsystem> {
...
template <>
struct  TraceFormatTraits<::device::mojom::InputDeviceType> {
