...
bool ScreenOrientation_LockOrientation_Params_Data::Validate(
  ...
  [[maybe_unused]] const ScreenOrientation_LockOrientation_Params_Data* object =
      static_cast<const ScreenOrientation_LockOrientation_Params_Data*>(data);
...
bool ScreenOrientation_UnlockOrientation_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const ScreenOrientation_UnlockOrientation_Params_Data* object =
      static_cast<const ScreenOrientation_UnlockOrientation_Params_Data*>(data);
