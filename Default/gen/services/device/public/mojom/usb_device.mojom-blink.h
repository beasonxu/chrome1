...
struct device_mojom_internal_UsbClaimInterfaceResult_DataHashFn {
  ...
  static bool Equal(const ::device::mojom::UsbClaimInterfaceResult& left, const ::device::mojom::UsbClaimInterfaceResult& right) {
    return left == right;
  }
  static const bool safe_to_compare_to_empty_or_deleted = true;
};
...
struct HashTraits<::device::mojom::UsbClaimInterfaceResult>
    : public GenericHashTraits<::device::mojom::UsbClaimInterfaceResult> {
  static_assert(true,
                "-1000000 is a reserved enum value");
  static_assert(true,
                "-1000001 is a reserved enum value");
  ...
  static void ConstructDeletedValue(::device::mojom::UsbClaimInterfaceResult& slot, bool) {
    slot = static_cast<::device::mojom::UsbClaimInterfaceResult>(-1000001);
  }
  static bool IsDeletedValue(const ::device::mojom::UsbClaimInterfaceResult& value) {
    return value == static_cast<::device::mojom::UsbClaimInterfaceResult>(-1000001);
  }
};
}  // namespace WTF
...
// with not having this data in traces there.
  ...
  virtual void IsochronousTransferOut(uint8_t endpoint_number, ::base::span<const ::uint8_t> data, const WTF::Vector<uint32_t>& packet_lengths, uint32_t timeout, IsochronousTransferOutCallback callback) = 0;
};
...
class BLINK_PLATFORM_EXPORT UsbDeviceProxy
 ...
 public:
  ...
  void IsochronousTransferOut(uint8_t endpoint_number, ::base::span<const ::uint8_t> data, const WTF::Vector<uint32_t>& packet_lengths, uint32_t timeout, IsochronousTransferOutCallback callback) final;
