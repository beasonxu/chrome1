...
void UsbDeviceManagerProxy::GetDevice(
    const std::string& in_guid, const std::vector<uint8_t>& in_blocked_interface_classes, ::mojo::PendingReceiver<::device::mojom::UsbDevice> in_device_receiver, ::mojo::PendingRemote<::device::mojom::UsbDeviceClient> in_device_client) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void UsbDeviceManagerInterceptorForTesting::GetDevice(const std::string& guid, const std::vector<uint8_t>& blocked_interface_classes, ::mojo::PendingReceiver<::device::mojom::UsbDevice> device_receiver, ::mojo::PendingRemote<::device::mojom::UsbDeviceClient> device_client) {
...
void UsbDeviceManagerInterceptorForTesting::GetSecurityKeyDevice(const std::string& guid, ::mojo::PendingReceiver<::device::mojom::UsbDevice> device_receiver, ::mojo::PendingRemote<::device::mojom::UsbDeviceClient> device_client) {
