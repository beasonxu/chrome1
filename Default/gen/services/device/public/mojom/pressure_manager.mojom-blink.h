...
// with not having this data in traces there.
  ...
  virtual void PressureStateChanged(::device::mojom::blink::PressureStatePtr state, ::base::Time timestamp) = 0;
};
...
class BLINK_PLATFORM_EXPORT PressureClientProxy
 ...
 public:
  ...
  void PressureStateChanged(::device::mojom::blink::PressureStatePtr state, ::base::Time timestamp) final;
