 ...
 public:
  ...
  Geoposition_ErrorCode error_code() const {
    return ::mojo::internal::ToKnownEnumValueHelper(
          static_cast<::device::mojom::Geoposition_ErrorCode>(data_->error_code));
  }
...
struct Serializer<::device::mojom::Geoposition_ErrorCode, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    return Traits::FromMojom(::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::device::mojom::Geoposition_ErrorCode>(input)), output);
  }
};
  ...
  static void Serialize(
    ...
    mojo::internal::MessageFragment<
        typename decltype(fragment->error_technical)::BaseType> error_technical_fragment(
            fragment.message());
    mojo::internal::Serialize<mojo::StringDataView>(
        in_error_technical, error_technical_fragment);
    ...
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        ...
        mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER,
        "null error_technical in Geoposition struct");
  }
...
inline void GeopositionDataView::GetErrorTechnicalDataView(
    mojo::StringDataView* output) {
  auto pointer = data_->error_technical.Get();
  *output = mojo::StringDataView(pointer, message_);
}
...
template <>
struct  TraceFormatTraits<::device::mojom::Geoposition_ErrorCode> {
