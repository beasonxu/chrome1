...
class  BluetoothSystemFactoryAsyncWaiter {
 public:
  ...
  BluetoothSystemFactoryAsyncWaiter(const BluetoothSystemFactoryAsyncWaiter&) = delete;
  BluetoothSystemFactoryAsyncWaiter& operator=(const BluetoothSystemFactoryAsyncWaiter&) = delete;
...
class  BluetoothSystemAsyncWaiter {
 public:
  ...
  BluetoothSystemAsyncWaiter(const BluetoothSystemAsyncWaiter&) = delete;
  BluetoothSystemAsyncWaiter& operator=(const BluetoothSystemAsyncWaiter&) = delete;
...
class  BluetoothSystemClientAsyncWaiter {
 public:
  ...
  BluetoothSystemClientAsyncWaiter(const BluetoothSystemClientAsyncWaiter&) = delete;
  BluetoothSystemClientAsyncWaiter& operator=(const BluetoothSystemClientAsyncWaiter&) = delete;
