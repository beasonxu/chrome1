...
// with not having this data in traces there.
  ...
  virtual void PressureStateChanged(::device::mojom::PressureStatePtr state, ::base::Time timestamp) = 0;
};
...
class  PressureClientProxy
 ...
 public:
  ...
  void PressureStateChanged(::device::mojom::PressureStatePtr state, ::base::Time timestamp) final;
