...
using BluetoothSystemFactoryInterfaceBase = BluetoothSystemFactoryInterfaceBase;
using BluetoothSystemInterfaceBase = BluetoothSystemInterfaceBase;
using BluetoothSystemClientInterfaceBase = BluetoothSystemClientInterfaceBase;
