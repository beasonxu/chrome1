...
constexpr uint32_t kNFC_MakeReadOnly_Name = 3;
constexpr uint32_t kNFC_CancelMakeReadOnly_Name = 4;
constexpr uint32_t kNFC_Watch_Name = 5;
constexpr uint32_t kNFC_CancelWatch_Name = 6;
