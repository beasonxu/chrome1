...
void PressureClientProxy::PressureStateChanged(
    ::device::mojom::blink::PressureStatePtr in_state, ::base::Time in_timestamp) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void PressureClientInterceptorForTesting::PressureStateChanged(::device::mojom::blink::PressureStatePtr state, ::base::Time timestamp) {
