...
void PressureManagerProxy::AddClient(
    ::mojo::PendingRemote<PressureClient> in_client, AddClientCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("client"), in_client,
                        "<value of type ::mojo::PendingRemote<PressureClient>>");
   });
#endif
  ...
  mojo::Message message(
      internal::kPressureManager_AddClient_Name, kFlags, 0, 0, nullptr);
  mojo::internal::MessageFragment<
      ::device::mojom::internal::PressureManager_AddClient_Params_Data> params(
          message);
  params.Allocate();
  mojo::internal::Serialize<mojo::InterfacePtrDataView<::device::mojom::PressureClientInterfaceBase>>(
...
uint32_t PressureClient::PressureStateChanged_Sym::IPCStableHash() {
  ...
  // hash instead of __LINE__.
  constexpr uint32_t kHash = base::MD5Hash32Constexpr(
          "(Impl)device::mojom::PressureClient::PressureStateChanged");
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
...
void PressureClientProxy::PressureStateChanged(
    ::device::mojom::PressureStatePtr in_state, ::base::Time in_timestamp) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    "mojom", "Send device::mojom::PressureClient::PressureStateChanged", "input_parameters",
    [&](perfetto::TracedValue context){
      auto dict = std::move(context).WriteDictionary();
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("state"), in_state,
                        "<value of type ::device::mojom::PressureStatePtr>");
      perfetto::WriteIntoTracedValueWithFallback(
  ...
  mojo::Message message(
      internal::kPressureClient_PressureStateChanged_Name, kFlags, 0, 0, nullptr);
  mojo::internal::MessageFragment<
      ::device::mojom::internal::PressureClient_PressureStateChanged_Params_Data> params(
          message);
  params.Allocate();
  mojo::internal::MessageFragment<
  ...
  MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
      ...
      "null state in PressureClient.PressureStateChanged request");
  mojo::internal::MessageFragment<
  ...
  MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
      ...
      mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER,
      "null timestamp in PressureClient.PressureStateChanged request");
  ...
  switch (message->header()->name) {
    case internal::kPressureClient_PressureStateChanged_Name: {
      ...
      internal::PressureClient_PressureStateChanged_Params_Data* params =
          reinterpret_cast<internal::PressureClient_PressureStateChanged_Params_Data*>(
              message->mutable_payload());
      
      bool success = true;
      ::device::mojom::PressureStatePtr p_state{};
      ::base::Time p_timestamp{};
...
static const mojo::internal::GenericValidationInfo kPressureClientValidationInfo[] = {
    {&internal::PressureClient_PressureStateChanged_Params_Data::Validate,
     nullptr /* no response */},
};
...
void PressureClientInterceptorForTesting::PressureStateChanged(::device::mojom::PressureStatePtr state, ::base::Time timestamp) {
  GetForwardingInterface()->PressureStateChanged(std::move(state), std::move(timestamp));
}
