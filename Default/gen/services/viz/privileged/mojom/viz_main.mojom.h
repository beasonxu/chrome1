...
// with not having this data in traces there.
  ...
  virtual void CreateGpuService(::mojo::PendingReceiver<::viz::mojom::GpuService> gpu_service, ::mojo::PendingRemote<::viz::mojom::GpuHost> gpu_host, ::mojo::PendingRemote<::discardable_memory::mojom::DiscardableSharedMemoryManager> discardable_memory_manager, ::base::UnsafeSharedMemoryRegion activity_flags, ::gfx::FontRenderParams::SubpixelRendering subpixel_rendering) = 0;

  
  virtual void SetHostProcessId(int32_t pid) = 0;
};
...
class  VizMainProxy
 ...
 public:
  ...
  void CreateGpuService(::mojo::PendingReceiver<::viz::mojom::GpuService> gpu_service, ::mojo::PendingRemote<::viz::mojom::GpuHost> gpu_host, ::mojo::PendingRemote<::discardable_memory::mojom::DiscardableSharedMemoryManager> discardable_memory_manager, ::base::UnsafeSharedMemoryRegion activity_flags, ::gfx::FontRenderParams::SubpixelRendering subpixel_rendering) final;
  
  void SetHostProcessId(int32_t pid) final;
