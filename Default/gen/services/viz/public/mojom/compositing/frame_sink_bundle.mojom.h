...
// with not having this data in traces there.
  ...
  virtual void SetThreadIds(uint32_t sink_id, const std::vector<int32_t>& thread_ids) = 0;
};
...
class  FrameSinkBundleProxy
 ...
 public:
  ...
  void SetThreadIds(uint32_t sink_id, const std::vector<int32_t>& thread_ids) final;
 ...
 public:
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        BeginFrameInfo::DataView, std::vector<uint8_t>>(input);
  }
...
struct  UnionTraits<::viz::mojom::BundledFrameSubmissionData::DataView,
  ...
  static const ::gpu::Mailbox& did_delete_shared_bitmap(const ::viz::mojom::BundledFrameSubmissionDataPtr& input) {
