...
struct viz_mojom_internal_CopyOutputResultDestination_DataHashFn {
  ...
  static bool Equal(const ::viz::mojom::CopyOutputResultDestination& left, const ::viz::mojom::CopyOutputResultDestination& right) {
    return left == right;
  }
  static const bool safe_to_compare_to_empty_or_deleted = true;
};
...
struct HashTraits<::viz::mojom::CopyOutputResultDestination>
    : public GenericHashTraits<::viz::mojom::CopyOutputResultDestination> {
  static_assert(true,
                "-1000000 is a reserved enum value");
  static_assert(true,
                "-1000001 is a reserved enum value");
  ...
  static void ConstructDeletedValue(::viz::mojom::CopyOutputResultDestination& slot, bool) {
    slot = static_cast<::viz::mojom::CopyOutputResultDestination>(-1000001);
  }
  static bool IsDeletedValue(const ::viz::mojom::CopyOutputResultDestination& value) {
    return value == static_cast<::viz::mojom::CopyOutputResultDestination>(-1000001);
  }
};
}  // namespace WTF
