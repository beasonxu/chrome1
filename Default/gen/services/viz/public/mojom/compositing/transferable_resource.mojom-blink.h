...
struct viz_mojom_internal_SynchronizationType_DataHashFn {
  ...
  static bool Equal(const ::viz::mojom::SynchronizationType& left, const ::viz::mojom::SynchronizationType& right) {
    return left == right;
  }
...
struct HashTraits<::viz::mojom::SynchronizationType>
    : public GenericHashTraits<::viz::mojom::SynchronizationType> {
  static_assert(true,
  ...
  static void ConstructDeletedValue(::viz::mojom::SynchronizationType& slot, bool) {
    slot = static_cast<::viz::mojom::SynchronizationType>(-1000001);
  }
  static bool IsDeletedValue(const ::viz::mojom::SynchronizationType& value) {
    return value == static_cast<::viz::mojom::SynchronizationType>(-1000001);
  }
};
}  // namespace WTF
...
class BLINK_PLATFORM_EXPORT TransferableResource {
 public:
  ...
  TransferableResource(
      ...
      ::viz::mojom::blink::ResourceFormat format,
      uint32_t filter,
      const ::gfx::Size& size,
