...
void FrameSinkBundleProxy::SetThreadIds(
    uint32_t in_sink_id, const WTF::Vector<int32_t>& in_thread_ids) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void FrameSinkBundleInterceptorForTesting::SetThreadIds(uint32_t sink_id, const WTF::Vector<int32_t>& thread_ids) {
