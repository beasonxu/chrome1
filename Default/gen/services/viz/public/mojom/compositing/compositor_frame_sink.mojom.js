...
(function() {
  ...
  function CompositorFrameSink_SetThreadIds_Params(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  CompositorFrameSink_SetThreadIds_Params.prototype.initDefaults_ = function() {
    this.threadIds = null;
  };
  CompositorFrameSink_SetThreadIds_Params.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  CompositorFrameSink_SetThreadIds_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    // validate CompositorFrameSink_SetThreadIds_Params.threadIds
  ...
  CompositorFrameSink_SetThreadIds_Params.encodedSize = codec.kStructHeaderSize + 8;

  CompositorFrameSink_SetThreadIds_Params.decode = function(decoder) {
    var packed;
    var val = new CompositorFrameSink_SetThreadIds_Params();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.threadIds =
  ...
  CompositorFrameSink_SetThreadIds_Params.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(CompositorFrameSink_SetThreadIds_Params.encodedSize);
    encoder.writeUint32(0);
    encoder.encodeArrayPointer(codec.Int32, val.threadIds);
  };
  ...
  var kCompositorFrameSink_SetThreadIds_Name = 8;
  ...
  CompositorFrameSinkPtr.prototype.setThreadIds = function() {
    return CompositorFrameSinkProxy.prototype.setThreadIds
        .apply(this.ptr.getProxy(), arguments);
  };

  CompositorFrameSinkProxy.prototype.setThreadIds = function(threadIds) {
    var params_ = new CompositorFrameSink_SetThreadIds_Params();
    params_.threadIds = threadIds;
    var builder = new codec.MessageV0Builder(
        kCompositorFrameSink_SetThreadIds_Name,
        codec.align(CompositorFrameSink_SetThreadIds_Params.encodedSize));
    builder.encodeStruct(CompositorFrameSink_SetThreadIds_Params, params_);
    var message = builder.finish();
    this.receiver_.accept(message);
  };
  ...
  CompositorFrameSinkStub.prototype.setThreadIds = function(threadIds) {
    return this.delegate_ && this.delegate_.setThreadIds && this.delegate_.setThreadIds(threadIds);
  }
  ...
  CompositorFrameSinkStub.prototype.accept = function(message) {
    ...
    case kCompositorFrameSink_InitializeCompositorFrameSinkType_Name:
      ...
      return true;
    case kCompositorFrameSink_SetThreadIds_Name:
      var params = reader.decodeStruct(CompositorFrameSink_SetThreadIds_Params);
      this.setThreadIds(params.threadIds);
      return true;
    default:
      return false;
    }
  ...
  function validateCompositorFrameSinkRequest(messageValidator) {
    ...
    switch (message.getName()) {
      ...
      case kCompositorFrameSink_SetThreadIds_Name:
        if (!message.expectsResponse() && !message.isResponse())
          paramsClass = CompositorFrameSink_SetThreadIds_Params;
      break;
    }
    if (paramsClass === null)
      return validator.validationError.NONE;
