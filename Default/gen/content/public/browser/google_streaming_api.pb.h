...
class SpeechRecognitionEvent final :
 ...
 public:
  inline SpeechRecognitionEvent() : SpeechRecognitionEvent(nullptr) {}
  ~SpeechRecognitionEvent() override;
  explicit PROTOBUF_CONSTEXPR SpeechRecognitionEvent(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  PROTOBUF_NOINLINE void Swap(SpeechRecognitionEvent* other) {
  ...
  void UnsafeArenaSwap(SpeechRecognitionEvent* other) {
    if (other == this) return;
  ...
  SpeechRecognitionEvent* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  protected:
  explicit SpeechRecognitionEvent(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  static inline bool EndpointerEventType_Parse(::PROTOBUF_NAMESPACE_ID::ConstStringParam name,
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::content::proto::SpeechRecognitionResult >*
      mutable_result();
  private:
  const ::content::proto::SpeechRecognitionResult& _internal_result(int index) const;
  ::content::proto::SpeechRecognitionResult* _internal_add_result();
  public:
  ...
  private:
  ::content::proto::SpeechRecognitionEvent_StatusCode _internal_status() const;
  void _internal_set_status(::content::proto::SpeechRecognitionEvent_StatusCode value);
  public:
  ...
  private:
  ::content::proto::SpeechRecognitionEvent_EndpointerEventType _internal_endpoint() const;
  void _internal_set_endpoint(::content::proto::SpeechRecognitionEvent_EndpointerEventType value);
  public:
...
class SpeechRecognitionResult final :
 ...
 public:
  ...
  PROTOBUF_NOINLINE void Swap(SpeechRecognitionResult* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  private:
  int _internal_alternative_size() const;
  public:
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::content::proto::SpeechRecognitionAlternative >*
      mutable_alternative();
  private:
  const ::content::proto::SpeechRecognitionAlternative& _internal_alternative(int index) const;
  ::content::proto::SpeechRecognitionAlternative* _internal_add_alternative();
  public:
...
class SpeechRecognitionAlternative final :
 ...
 public:
  ...
  PROTOBUF_NOINLINE void Swap(SpeechRecognitionAlternative* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
...
inline ::content::proto::SpeechRecognitionResult* SpeechRecognitionEvent::add_result() {
  ::content::proto::SpeechRecognitionResult* _add = _internal_add_result();
...
inline int SpeechRecognitionResult::alternative_size() const {
  return _internal_alternative_size();
}
...
inline const ::content::proto::SpeechRecognitionAlternative& SpeechRecognitionResult::alternative(int index) const {
  ...
  return _internal_alternative(index);
}
...
inline ::content::proto::SpeechRecognitionAlternative* SpeechRecognitionResult::add_alternative() {
  ::content::proto::SpeechRecognitionAlternative* _add = _internal_add_alternative();
...
void SpeechRecognitionAlternative::set_transcript(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 transcript_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void SpeechRecognitionAlternative::_internal_set_transcript(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  transcript_.Set(value, GetArenaForAllocation());
}
inline std::string* SpeechRecognitionAlternative::_internal_mutable_transcript() {
  _has_bits_[0] |= 0x00000001u;
  return transcript_.Mutable(GetArenaForAllocation());
}
inline std::string* SpeechRecognitionAlternative::release_transcript() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  auto* p = transcript_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (transcript_.IsDefault()) {
...
inline void SpeechRecognitionAlternative::set_allocated_transcript(std::string* transcript) {
  ...
  transcript_.SetAllocated(transcript, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (transcript_.IsDefault()) {
    transcript_.Set("", GetArenaForAllocation());
  }
