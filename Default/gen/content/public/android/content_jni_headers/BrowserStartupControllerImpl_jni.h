...
static std::atomic<jmethodID>
    g_org_chromium_content_browser_BrowserStartupControllerImpl_minimalBrowserStartupComplete(nullptr);
static void Java_BrowserStartupControllerImpl_minimalBrowserStartupComplete(JNIEnv* env) {
  jclass clazz = org_chromium_content_browser_BrowserStartupControllerImpl_clazz(env);
  CHECK_CLAZZ(env, clazz,
      org_chromium_content_browser_BrowserStartupControllerImpl_clazz(env));
  ...
  call_context.Init<
      base::android::MethodID::TYPE_STATIC>(
          env,
          clazz,
          "minimalBrowserStartupComplete",
          "()V",
&g_org_chromium_content_browser_BrowserStartupControllerImpl_minimalBrowserStartupComplete);
