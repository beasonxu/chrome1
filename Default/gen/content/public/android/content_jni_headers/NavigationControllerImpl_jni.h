...
JNI_GENERATOR_EXPORT void Java_J_N_MAqmDh4t(
  ...
  return native->LoadUrl(env, base::android::JavaParamRef<jobject>(env, caller),
      ...
      isRendererInitiated, shouldReplaceCurrentEntry, base::android::JavaParamRef<jobject>(env,
      initiatorOrigin), hasUserGesture, shouldClearHistoryList, inputStart, navigationUIDataPtr);
}
...
JNI_GENERATOR_EXPORT void Java_J_N_MrilyCK6(
  ...
  return native->SetUseDesktopUserAgent(env, base::android::JavaParamRef<jobject>(env, caller),
      override, reloadOnChange, source);
}
...
static base::android::ScopedJavaLocalRef<jobject>
    ...
    const base::android::JavaRef<jobject>& virtualUrl,
...
"(ILorg/chromium/url/GURL;Lorg/chromium/url/GURL;Lorg/chromium/url/GURL;Lorg/chromium/url/GURL;Ljava/lang/String;Landroid/graphics/Bitmap;IJZ)Lorg/chromium/content_public/browser/NavigationEntry;",
