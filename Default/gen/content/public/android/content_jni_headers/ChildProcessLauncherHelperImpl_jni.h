...
JNI_GENERATOR_EXPORT void Java_J_N_MJcoZ9pW(
  ...
  return JNI_ChildProcessLauncherHelperImpl_SetTerminationInfo(env, termiantionInfoPtr,
      bindingState, killedByUs, cleanExit, exceptionDuringInit, reverseRank);
}

static jboolean JNI_ChildProcessLauncherHelperImpl_ServiceGroupImportanceEnabled(JNIEnv* env);

JNI_GENERATOR_EXPORT jboolean Java_J_N_MyYLH6Fg(
    JNIEnv* env,
    jclass jcaller) {
  return JNI_ChildProcessLauncherHelperImpl_ServiceGroupImportanceEnabled(env);
}
