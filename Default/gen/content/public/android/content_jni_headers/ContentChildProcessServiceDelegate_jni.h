...
static void JNI_ContentChildProcessServiceDelegate_InitMemoryPressureListener(JNIEnv* env);

JNI_GENERATOR_EXPORT void Java_J_N_M8I_00024ZbIR(
    JNIEnv* env,
    jclass jcaller) {
  return JNI_ContentChildProcessServiceDelegate_InitMemoryPressureListener(env);
}
