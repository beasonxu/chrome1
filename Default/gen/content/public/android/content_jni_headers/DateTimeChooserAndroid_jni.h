...
static std::atomic<jmethodID>
    g_org_chromium_content_browser_input_DateTimeChooserAndroid_dismissAndDestroy(nullptr);
static void Java_DateTimeChooserAndroid_dismissAndDestroy(JNIEnv* env, const
  ...
  call_context.Init<
      base::android::MethodID::TYPE_INSTANCE>(
          ...
          "dismissAndDestroy",
          "()V",
          &g_org_chromium_content_browser_input_DateTimeChooserAndroid_dismissAndDestroy);
