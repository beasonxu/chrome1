...
class COMPONENT_EXPORT(MOJOM_SHARED_CONTENT_EXPORT) PrivateAggregationRequest_Data {
 public:
  ...
  mojo::internal::Pointer<::content::mojom::internal::AggregatableReportHistogramContribution_Data> contribution;
  int32_t aggregation_mode;
  uint8_t padfinal_[4];

 private:
  friend class mojo::internal::MessageFragment<PrivateAggregationRequest_Data>;

  PrivateAggregationRequest_Data();
  ~PrivateAggregationRequest_Data() = delete;
};
static_assert(sizeof(PrivateAggregationRequest_Data) == 24,
              "Bad sizeof(PrivateAggregationRequest_Data)");
...
struct PrivateAggregationRequest_UnserializedMessageContext
 ...
 public:
  ...
  PrivateAggregationRequest_UnserializedMessageContext(
    uint32_t message_name,
    uint32_t message_flags,
    UserType input)
      : mojo::internal::UnserializedMessageContext(&kMessageTag, message_name, message_flags)
      , user_data_(std::move(input)) {}
  ~PrivateAggregationRequest_UnserializedMessageContext() override = default;
 ...
 private:
  ...
  void Serialize(mojo::Message& message) override {
    mojo::internal::MessageFragment<PrivateAggregationRequest_Data> fragment(message);
