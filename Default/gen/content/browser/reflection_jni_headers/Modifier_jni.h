...
[[maybe_unused]] static jboolean Java_Modifier_isPublic(JNIEnv* env, JniIntWrapper p0);
...
[[maybe_unused]] static jboolean Java_Modifier_isPrivate(JNIEnv* env, JniIntWrapper p0);
...
[[maybe_unused]] static jboolean Java_Modifier_isProtected(JNIEnv* env, JniIntWrapper p0);
...
[[maybe_unused]] static jboolean Java_Modifier_isStatic(JNIEnv* env, JniIntWrapper p0);
...
[[maybe_unused]] static jboolean Java_Modifier_isFinal(JNIEnv* env, JniIntWrapper p0);
...
[[maybe_unused]] static jboolean Java_Modifier_isSynchronized(JNIEnv* env, JniIntWrapper p0);
...
[[maybe_unused]] static jboolean Java_Modifier_isVolatile(JNIEnv* env, JniIntWrapper p0);
...
[[maybe_unused]] static jboolean Java_Modifier_isTransient(JNIEnv* env, JniIntWrapper p0);
...
[[maybe_unused]] static jboolean Java_Modifier_isNative(JNIEnv* env, JniIntWrapper p0);
...
[[maybe_unused]] static jboolean Java_Modifier_isInterface(JNIEnv* env, JniIntWrapper p0);
...
[[maybe_unused]] static jboolean Java_Modifier_isAbstract(JNIEnv* env, JniIntWrapper p0);
...
[[maybe_unused]] static jboolean Java_Modifier_isStrict(JNIEnv* env, JniIntWrapper p0);
...
[[maybe_unused]] static base::android::ScopedJavaLocalRef<jstring> Java_Modifier_toString(JNIEnv*
...
[[maybe_unused]] static jint Java_Modifier_classModifiers(JNIEnv* env);
...
[[maybe_unused]] static jint Java_Modifier_interfaceModifiers(JNIEnv* env);
...
[[maybe_unused]] static jint Java_Modifier_constructorModifiers(JNIEnv* env);
...
[[maybe_unused]] static jint Java_Modifier_methodModifiers(JNIEnv* env);
...
[[maybe_unused]] static jint Java_Modifier_fieldModifiers(JNIEnv* env);
...
[[maybe_unused]] static jint Java_Modifier_parameterModifiers(JNIEnv* env);
...
[[maybe_unused]] static base::android::ScopedJavaLocalRef<jobject> Java_Modifier_Constructor(JNIEnv*
    env);
