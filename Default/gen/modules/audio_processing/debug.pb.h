...
inline int32_t Stream::_internal_level() const {
  return level_;
}
inline int32_t Stream::level() const {
  // @@protoc_insertion_point(field_get:webrtc.audioproc.Stream.level)
  return _internal_level();
}
inline void Stream::_internal_set_level(int32_t value) {
  _has_bits_[0] |= 0x00000010u;
  level_ = value;
}
inline void Stream::set_level(int32_t value) {
