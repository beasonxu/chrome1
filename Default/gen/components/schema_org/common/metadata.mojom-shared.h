...
struct Serializer<::schema_org::mojom::PropertyDataView, MaybeConstUserType> {
  ...
  static void Serialize(
      ...
      mojo::internal::MessageFragment<::schema_org::mojom::internal::Property_Data>& fragment) {
    ...
    mojo::internal::MessageFragment<decltype(fragment->values)>
    ...
    mojo::internal::Serialize<::schema_org::mojom::ValuesDataView>(
        in_values, values_fragment, true);
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
...
struct Serializer<::schema_org::mojom::EntityDataView, MaybeConstUserType> {
  ...
  static void Serialize(
      MaybeConstUserType& input,
      mojo::internal::MessageFragment<::schema_org::mojom::internal::Entity_Data>& fragment) {
    if (CallIsNullIfExists<Traits>(input))
      return;
    fragment.Allocate();
...
struct Serializer<::schema_org::mojom::ValuesDataView, MaybeConstUserType> {
  ...
  static void Serialize(MaybeConstUserType& input,
                        MessageFragment<::schema_org::mojom::internal::Values_Data>& fragment,
                        bool inlined) {
    if (CallIsNullIfExists<Traits>(input)) {
       if (inlined)
        fragment->set_null();
    ...
    switch (fragment->tag) {
      ...
      case ::schema_org::mojom::ValuesDataView::Tag::kLongValues: {
        ...
        mojo::internal::MessageFragment<
            typename decltype(fragment->data.f_long_values)::BaseType>
            value_fragment(fragment.message());
        const ContainerValidateParams long_values_validate_params(
            0, false, nullptr);
        mojo::internal::Serialize<mojo::ArrayDataView<int64_t>>(
            in_long_values, value_fragment, &long_values_validate_params);
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
            value_fragment.is_null(),
            mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER,
            "null long_values in Values union");
        fragment->data.f_long_values.Set(
            value_fragment.is_null() ? nullptr : value_fragment.data());
        break;
      }
      case ::schema_org::mojom::ValuesDataView::Tag::kStringValues: {
        ...
        mojo::internal::MessageFragment<
            typename decltype(fragment->data.f_string_values)::BaseType>
            value_fragment(fragment.message());
        const ContainerValidateParams string_values_validate_params(
            0, false, new mojo::internal::ContainerValidateParams(0, false, nullptr));
        mojo::internal::Serialize<mojo::ArrayDataView<mojo::StringDataView>>(
            in_string_values, value_fragment, &string_values_validate_params);
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
            value_fragment.is_null(),
            mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER,
            "null string_values in Values union");
        fragment->data.f_string_values.Set(
            value_fragment.is_null() ? nullptr : value_fragment.data());
        break;
      }
      case ::schema_org::mojom::ValuesDataView::Tag::kEntityValues: {
        ...
        mojo::internal::MessageFragment<
            typename decltype(fragment->data.f_entity_values)::BaseType>
            value_fragment(fragment.message());
        ...
        fragment->data.f_entity_values.Set(
            value_fragment.is_null() ? nullptr : value_fragment.data());
        break;
      }
    }
