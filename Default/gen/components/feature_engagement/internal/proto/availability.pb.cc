...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 AvailabilityDefaultTypeInternal _Availability_default_instance_;
}  // namespace feature_engagement
namespace feature_engagement {
...
void Availability::CheckTypeAndMergeFrom(
  ...
  MergeFrom(*::_pbi::DownCast<const Availability*>(
      &from));
}
...
template<> PROTOBUF_NOINLINE ::feature_engagement::Availability*
Arena::CreateMaybeMessage< ::feature_engagement::Availability >(Arena* arena) {
