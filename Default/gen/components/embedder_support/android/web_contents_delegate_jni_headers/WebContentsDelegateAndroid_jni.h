...
static void Java_WebContentsDelegateAndroid_openNewTab(JNIEnv* env, const
  ...
  call_context.Init<
      base::android::MethodID::TYPE_INSTANCE>(
          ...
          clazz,
          "openNewTab",
"(Lorg/chromium/url/GURL;Ljava/lang/String;Lorg/chromium/content_public/common/ResourceRequestBody;IZ)V",
...
static void Java_WebContentsDelegateAndroid_loadingStateChanged(JNIEnv* env, const
    base::android::JavaRef<jobject>& obj, jboolean shouldShowLoadingUI) {
  jclass clazz =
      org_chromium_components_embedder_1support_delegate_WebContentsDelegateAndroid_clazz(env);
  CHECK_CLAZZ(env, obj.obj(),
      org_chromium_components_embedder_1support_delegate_WebContentsDelegateAndroid_clazz(env));
...
&g_org_chromium_components_embedder_1support_delegate_WebContentsDelegateAndroid_loadingStateChanged);
     ...
     env->CallVoidMethod(obj.obj(),
          call_context.base.method_id, shouldShowLoadingUI);
}
...
static void Java_WebContentsDelegateAndroid_webContentsCreated(JNIEnv* env, const
    ...
    const base::android::JavaRef<jobject>& targetUrl,
  ...
  call_context.Init<
      base::android::MethodID::TYPE_INSTANCE>(
          ...
          clazz,
          "webContentsCreated",
"(Lorg/chromium/content_public/browser/WebContents;JJLjava/lang/String;Lorg/chromium/url/GURL;Lorg/chromium/content_public/browser/WebContents;)V",
...
static jboolean Java_WebContentsDelegateAndroid_shouldCreateWebContents(JNIEnv* env, const
    base::android::JavaRef<jobject>& obj, const base::android::JavaRef<jobject>& targetUrl) {
  jclass clazz =
      org_chromium_components_embedder_1support_delegate_WebContentsDelegateAndroid_clazz(env);
  CHECK_CLAZZ(env, obj.obj(),
      org_chromium_components_embedder_1support_delegate_WebContentsDelegateAndroid_clazz(env),
...
&g_org_chromium_components_embedder_1support_delegate_WebContentsDelegateAndroid_enterFullscreenModeForTab);
     ...
     env->CallVoidMethod(obj.obj(),
          call_context.base.method_id, prefersNavigationBar, prefersStatusBar);
}

static std::atomic<jmethodID>
    g_org_chromium_components_embedder_1support_delegate_WebContentsDelegateAndroid_fullscreenStateChangedForTab(nullptr);
static void Java_WebContentsDelegateAndroid_fullscreenStateChangedForTab(JNIEnv* env, const
    base::android::JavaRef<jobject>& obj, jboolean prefersNavigationBar,
    jboolean prefersStatusBar) {
  jclass clazz =
      org_chromium_components_embedder_1support_delegate_WebContentsDelegateAndroid_clazz(env);
  ...
  call_context.Init<
      base::android::MethodID::TYPE_INSTANCE>(
          env,
          clazz,
          "fullscreenStateChangedForTab",
          "(ZZ)V",
&g_org_chromium_components_embedder_1support_delegate_WebContentsDelegateAndroid_fullscreenStateChangedForTab);
...
static std::atomic<jmethodID>
    g_org_chromium_components_embedder_1support_delegate_WebContentsDelegateAndroid_getDisplayModeChecked(nullptr);
static jint Java_WebContentsDelegateAndroid_getDisplayModeChecked(JNIEnv* env, const
    base::android::JavaRef<jobject>& obj) {
  jclass clazz =
      org_chromium_components_embedder_1support_delegate_WebContentsDelegateAndroid_clazz(env);
  CHECK_CLAZZ(env, obj.obj(),
  ...
  call_context.Init<
      base::android::MethodID::TYPE_INSTANCE>(
          env,
          clazz,
          "getDisplayModeChecked",
          "()I",
&g_org_chromium_components_embedder_1support_delegate_WebContentsDelegateAndroid_getDisplayModeChecked);
