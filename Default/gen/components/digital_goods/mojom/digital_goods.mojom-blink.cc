...
#ifndef COMPONENTS_DIGITAL_GOODS_MOJOM_DIGITAL_GOODS_MOJOM_BLINK_JUMBO_H_
#define COMPONENTS_DIGITAL_GOODS_MOJOM_DIGITAL_GOODS_MOJOM_BLINK_JUMBO_H_
#endif
...
ItemDetails::ItemDetails(
    ...
    ItemType type_in,
    absl::optional<WTF::Vector<::blink::KURL>> icon_urls_in)
    : item_id(std::move(item_id_in)),
      title(std::move(title_in)),
      description(std::move(description_in)),
      price(std::move(price_in)),
