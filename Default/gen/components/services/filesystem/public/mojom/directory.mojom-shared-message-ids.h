...
constexpr uint32_t kDirectory_OpenFileHandle_Name = 1;
constexpr uint32_t kDirectory_OpenFileHandles_Name = 2;
constexpr uint32_t kDirectory_OpenDirectory_Name = 3;
constexpr uint32_t kDirectory_Rename_Name = 4;
constexpr uint32_t kDirectory_Replace_Name = 5;
