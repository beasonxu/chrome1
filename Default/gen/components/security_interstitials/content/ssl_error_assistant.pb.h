...
class CaptivePortalCert final :
 ...
 public:
  inline CaptivePortalCert() : CaptivePortalCert(nullptr) {}
  ...
  protected:
  explicit CaptivePortalCert(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  void set_sha256_hash(ArgT0&& arg0, ArgT... args);
...
class MITMSoftware final :
 ...
 public:
  inline MITMSoftware() : MITMSoftware(nullptr) {}
  ...
  protected:
  explicit MITMSoftware(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_issuer_common_name_regex(ArgT0&& arg0, ArgT... args);
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_issuer_organization_regex(ArgT0&& arg0, ArgT... args);
...
class DynamicInterstitial final :
 ...
 public:
  inline DynamicInterstitial() : DynamicInterstitial(nullptr) {}
  ...
  protected:
  explicit DynamicInterstitial(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  static inline bool InterstitialPageType_Parse(::PROTOBUF_NAMESPACE_ID::ConstStringParam name,
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_mitm_software_name(ArgT0&& arg0, ArgT... args);
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_support_url(ArgT0&& arg0, ArgT... args);
...
class SSLErrorAssistantConfig final :
 ...
 public:
  inline SSLErrorAssistantConfig() : SSLErrorAssistantConfig(nullptr) {}
  ...
  protected:
  explicit SSLErrorAssistantConfig(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
...
void CaptivePortalCert::set_sha256_hash(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 sha256_hash_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* CaptivePortalCert::release_sha256_hash() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  auto* p = sha256_hash_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (sha256_hash_.IsDefault()) {
...
inline void CaptivePortalCert::set_allocated_sha256_hash(std::string* sha256_hash) {
  ...
  sha256_hash_.SetAllocated(sha256_hash, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (sha256_hash_.IsDefault()) {
    sha256_hash_.Set("", GetArenaForAllocation());
  }
...
inline void MITMSoftware::clear_issuer_common_name_regex() {
  issuer_common_name_regex_.ClearToEmpty();
...
void MITMSoftware::set_issuer_common_name_regex(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000002u;
 issuer_common_name_regex_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* MITMSoftware::release_issuer_common_name_regex() {
  ...
  _has_bits_[0] &= ~0x00000002u;
  auto* p = issuer_common_name_regex_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (issuer_common_name_regex_.IsDefault()) {
...
inline void MITMSoftware::set_allocated_issuer_common_name_regex(std::string* issuer_common_name_regex) {
  ...
  issuer_common_name_regex_.SetAllocated(issuer_common_name_regex, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (issuer_common_name_regex_.IsDefault()) {
    issuer_common_name_regex_.Set("", GetArenaForAllocation());
  }
...
inline void MITMSoftware::clear_issuer_organization_regex() {
  issuer_organization_regex_.ClearToEmpty();
...
void MITMSoftware::set_issuer_organization_regex(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000004u;
 issuer_organization_regex_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* MITMSoftware::release_issuer_organization_regex() {
  ...
  _has_bits_[0] &= ~0x00000004u;
  auto* p = issuer_organization_regex_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (issuer_organization_regex_.IsDefault()) {
...
inline void MITMSoftware::set_allocated_issuer_organization_regex(std::string* issuer_organization_regex) {
  ...
  issuer_organization_regex_.SetAllocated(issuer_organization_regex, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (issuer_organization_regex_.IsDefault()) {
    issuer_organization_regex_.Set("", GetArenaForAllocation());
  }
...
inline void DynamicInterstitial::clear_mitm_software_name() {
  mitm_software_name_.ClearToEmpty();
  _has_bits_[0] &= ~0x00000004u;
}
...
void DynamicInterstitial::set_mitm_software_name(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000004u;
 mitm_software_name_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* DynamicInterstitial::release_mitm_software_name() {
  ...
  _has_bits_[0] &= ~0x00000004u;
  auto* p = mitm_software_name_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (mitm_software_name_.IsDefault()) {
...
inline void DynamicInterstitial::set_allocated_mitm_software_name(std::string* mitm_software_name) {
  ...
  mitm_software_name_.SetAllocated(mitm_software_name, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (mitm_software_name_.IsDefault()) {
    mitm_software_name_.Set("", GetArenaForAllocation());
  }
...
void DynamicInterstitial::set_support_url(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000008u;
 support_url_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* DynamicInterstitial::release_support_url() {
  ...
  _has_bits_[0] &= ~0x00000008u;
  auto* p = support_url_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (support_url_.IsDefault()) {
...
inline void DynamicInterstitial::set_allocated_support_url(std::string* support_url) {
  ...
  support_url_.SetAllocated(support_url, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (support_url_.IsDefault()) {
    support_url_.Set("", GetArenaForAllocation());
  }
