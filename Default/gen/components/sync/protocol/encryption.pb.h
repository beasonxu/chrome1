...
void EncryptedData::set_key_name(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 key_name_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void EncryptedData::_internal_set_key_name(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  key_name_.Set(value, GetArenaForAllocation());
}
inline std::string* EncryptedData::_internal_mutable_key_name() {
  _has_bits_[0] |= 0x00000001u;
  return key_name_.Mutable(GetArenaForAllocation());
}
inline std::string* EncryptedData::release_key_name() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  auto* p = key_name_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (key_name_.IsDefault()) {
...
inline void EncryptedData::set_allocated_key_name(std::string* key_name) {
  ...
  key_name_.SetAllocated(key_name, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (key_name_.IsDefault()) {
    key_name_.Set("", GetArenaForAllocation());
  }
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void EncryptedData::set_blob(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000002u;
 blob_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
