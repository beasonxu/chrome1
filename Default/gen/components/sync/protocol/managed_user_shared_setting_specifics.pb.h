...
class ManagedUserSharedSettingSpecifics final :
 ...
 public:
  inline ManagedUserSharedSettingSpecifics() : ManagedUserSharedSettingSpecifics(nullptr) {}
  ...
  protected:
  explicit ManagedUserSharedSettingSpecifics(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  void set_mu_id(ArgT0&& arg0, ArgT... args);
...
void ManagedUserSharedSettingSpecifics::set_mu_id(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 mu_id_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void ManagedUserSharedSettingSpecifics::_internal_set_mu_id(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  mu_id_.Set(value, GetArenaForAllocation());
}
inline std::string* ManagedUserSharedSettingSpecifics::_internal_mutable_mu_id() {
  _has_bits_[0] |= 0x00000001u;
  return mu_id_.Mutable(GetArenaForAllocation());
}
...
inline void ManagedUserSharedSettingSpecifics::set_allocated_mu_id(std::string* mu_id) {
  ...
  mu_id_.SetAllocated(mu_id, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (mu_id_.IsDefault()) {
    mu_id_.Set("", GetArenaForAllocation());
  }
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void ManagedUserSharedSettingSpecifics::set_key(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000002u;
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void ManagedUserSharedSettingSpecifics::set_value(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000004u;
