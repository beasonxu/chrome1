...
class ExtensionSettingSpecifics final :
 ...
 public:
  inline ExtensionSettingSpecifics() : ExtensionSettingSpecifics(nullptr) {}
  ...
  protected:
  explicit ExtensionSettingSpecifics(::PROTOBUF_NAMESPACE_ID::Arena* arena,
...
void ExtensionSettingSpecifics::set_extension_id(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void ExtensionSettingSpecifics::set_key(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000002u;
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void ExtensionSettingSpecifics::set_value(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000004u;
