...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 DictionarySpecificsDefaultTypeInternal _DictionarySpecifics_default_instance_;
}  // namespace sync_pb
namespace sync_pb {
...
void DictionarySpecifics::CheckTypeAndMergeFrom(
  ...
  MergeFrom(*::_pbi::DownCast<const DictionarySpecifics*>(
      &from));
}
