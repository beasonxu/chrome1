...
namespace sync_pb {
PROTOBUF_CONSTEXPR OsPreferenceSpecifics::OsPreferenceSpecifics(
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 OsPreferenceSpecificsDefaultTypeInternal _OsPreferenceSpecifics_default_instance_;
}  // namespace sync_pb
namespace sync_pb {
...
OsPreferenceSpecifics::OsPreferenceSpecifics(::PROTOBUF_NAMESPACE_ID::Arena* arena,
...
inline void OsPreferenceSpecifics::SharedCtor() {
preference_ = nullptr;
}
...
uint8_t* OsPreferenceSpecifics::_InternalSerialize(
...
void OsPreferenceSpecifics::CheckTypeAndMergeFrom(
  ...
  MergeFrom(*::_pbi::DownCast<const OsPreferenceSpecifics*>(
      &from));
}
...
template<> PROTOBUF_NOINLINE ::sync_pb::OsPreferenceSpecifics*
Arena::CreateMaybeMessage< ::sync_pb::OsPreferenceSpecifics >(Arena* arena) {
