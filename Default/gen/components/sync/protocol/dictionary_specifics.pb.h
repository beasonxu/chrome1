...
class DictionarySpecifics final :
 ...
 public:
  ...
  protected:
  explicit DictionarySpecifics(::PROTOBUF_NAMESPACE_ID::Arena* arena,
...
void DictionarySpecifics::set_word(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
