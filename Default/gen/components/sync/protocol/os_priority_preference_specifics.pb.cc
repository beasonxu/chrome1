...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 OsPriorityPreferenceSpecificsDefaultTypeInternal _OsPriorityPreferenceSpecifics_default_instance_;
}  // namespace sync_pb
namespace sync_pb {
...
void OsPriorityPreferenceSpecifics::CheckTypeAndMergeFrom(
  ...
  MergeFrom(*::_pbi::DownCast<const OsPriorityPreferenceSpecifics*>(
      &from));
}
