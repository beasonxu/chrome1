...
class  PageInterceptorForTesting : public Page {
  ...
  void OnLogMessageAdded(::base::Time event_time, ::optimization_guide_common::mojom::LogSource log_source, const std::string& source_file, int64_t source_line, const std::string& message) override;
};
