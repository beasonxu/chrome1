...
class AutofillSyncStorageKey final :
 ...
 public:
  inline AutofillSyncStorageKey() : AutofillSyncStorageKey(nullptr) {}
  ...
  protected:
  explicit AutofillSyncStorageKey(::PROTOBUF_NAMESPACE_ID::Arena* arena,
...
void AutofillSyncStorageKey::set_name(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void AutofillSyncStorageKey::set_value(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000002u;
