...
class CommonData final :
 ...
 public:
  inline CommonData() : CommonData(nullptr) {}
  ~CommonData() override;
  ...
  protected:
  explicit CommonData(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_description_translated(ArgT0&& arg0, ArgT... args);
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_source_description_language(ArgT0&& arg0, ArgT... args);
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_ui_language(ArgT0&& arg0, ArgT... args);
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_unique_report_identifier(ArgT0&& arg0, ArgT... args);
...
inline void CommonData::clear_description_translated() {
  description_translated_.ClearToEmpty();
...
void CommonData::set_description_translated(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000004u;
 description_translated_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* CommonData::release_description_translated() {
  ...
  _has_bits_[0] &= ~0x00000004u;
  auto* p = description_translated_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (description_translated_.IsDefault()) {
...
inline void CommonData::set_allocated_description_translated(std::string* description_translated) {
  ...
  description_translated_.SetAllocated(description_translated, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (description_translated_.IsDefault()) {
    description_translated_.Set("", GetArenaForAllocation());
  }
...
inline const std::string& CommonData::source_description_language() const {
  ...
  if (source_description_language_.IsDefault()) return _i_give_permission_to_break_this_code_default_source_description_language_.get();
...
void CommonData::set_source_description_language(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000008u;
 source_description_language_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline const std::string& CommonData::_internal_source_description_language() const {
  return source_description_language_.Get();
}
inline void CommonData::_internal_set_source_description_language(const std::string& value) {
  _has_bits_[0] |= 0x00000008u;
  source_description_language_.Set(value, GetArenaForAllocation());
}
inline std::string* CommonData::_internal_mutable_source_description_language() {
  _has_bits_[0] |= 0x00000008u;
  return source_description_language_.Mutable(::userfeedback::CommonData::_i_give_permission_to_break_this_code_default_source_description_language_, GetArenaForAllocation());
}
inline std::string* CommonData::release_source_description_language() {
  ...
  _has_bits_[0] &= ~0x00000008u;
  auto* p = source_description_language_.Release();
  return p;
}
inline void CommonData::set_allocated_source_description_language(std::string* source_description_language) {
  ...
  source_description_language_.SetAllocated(source_description_language, GetArenaForAllocation());
...
inline const std::string& CommonData::ui_language() const {
  ...
  if (ui_language_.IsDefault()) return _i_give_permission_to_break_this_code_default_ui_language_.get();
...
void CommonData::set_ui_language(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000010u;
 ui_language_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline const std::string& CommonData::_internal_ui_language() const {
  return ui_language_.Get();
}
inline void CommonData::_internal_set_ui_language(const std::string& value) {
  _has_bits_[0] |= 0x00000010u;
  ui_language_.Set(value, GetArenaForAllocation());
}
inline std::string* CommonData::_internal_mutable_ui_language() {
  _has_bits_[0] |= 0x00000010u;
  return ui_language_.Mutable(::userfeedback::CommonData::_i_give_permission_to_break_this_code_default_ui_language_, GetArenaForAllocation());
}
...
inline void CommonData::set_allocated_ui_language(std::string* ui_language) {
  ...
  ui_language_.SetAllocated(ui_language, GetArenaForAllocation());
...
inline void CommonData::clear_unique_report_identifier() {
  unique_report_identifier_.ClearToEmpty();
...
void CommonData::set_unique_report_identifier(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000020u;
 unique_report_identifier_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline const std::string& CommonData::_internal_unique_report_identifier() const {
  return unique_report_identifier_.Get();
}
inline void CommonData::_internal_set_unique_report_identifier(const std::string& value) {
  _has_bits_[0] |= 0x00000020u;
  unique_report_identifier_.Set(value, GetArenaForAllocation());
}
inline std::string* CommonData::_internal_mutable_unique_report_identifier() {
  _has_bits_[0] |= 0x00000020u;
  return unique_report_identifier_.Mutable(GetArenaForAllocation());
}
inline std::string* CommonData::release_unique_report_identifier() {
  ...
  _has_bits_[0] &= ~0x00000020u;
  auto* p = unique_report_identifier_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (unique_report_identifier_.IsDefault()) {
...
inline void CommonData::set_allocated_unique_report_identifier(std::string* unique_report_identifier) {
  ...
  unique_report_identifier_.SetAllocated(unique_report_identifier, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (unique_report_identifier_.IsDefault()) {
    unique_report_identifier_.Set("", GetArenaForAllocation());
  }
