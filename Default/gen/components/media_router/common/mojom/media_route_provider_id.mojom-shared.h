...
inline bool IsKnownEnumValue(MediaRouteProviderId value) {
  return internal::MediaRouteProviderId_Data::IsKnownValue(
...
struct Serializer<::media_router::mojom::MediaRouteProviderId, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    return Traits::FromMojom(::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::media_router::mojom::MediaRouteProviderId>(input)), output);
  }
};
