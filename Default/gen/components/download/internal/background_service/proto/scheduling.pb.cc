...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 SchedulingParamsDefaultTypeInternal _SchedulingParams_default_instance_;
}  // namespace protodb
namespace protodb {
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    reinterpret_cast<char*>(&cancel_time_) - reinterpret_cast<char*>(this)),
    0, static_cast<size_t>(reinterpret_cast<char*>(&battery_requirements_) -
    reinterpret_cast<char*>(&cancel_time_)) + sizeof(battery_requirements_));
}
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 16)) {
          ...
          cancel_time_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* SchedulingParams::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000004u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteEnumToArray(
      4, this->_internal_network_requirements(), target);
  }
  ...
  if (cached_has_bits & 0x00000008u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteEnumToArray(
      5, this->_internal_battery_requirements(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:protodb.SchedulingParams)
  ...
  if (cached_has_bits & 0x0000000fu) {
    ...
    if (cached_has_bits & 0x00000004u) {
      total_size += 1 +
        ::_pbi::WireFormatLite::EnumSize(this->_internal_network_requirements());
    }

    // optional .protodb.SchedulingParams.BatteryRequirements battery_requirements = 5;
    if (cached_has_bits & 0x00000008u) {
      total_size += 1 +
        ::_pbi::WireFormatLite::EnumSize(this->_internal_battery_requirements());
    }
...
void SchedulingParams::CheckTypeAndMergeFrom(
  ...
  MergeFrom(*::_pbi::DownCast<const SchedulingParams*>(
      &from));
}
...
void SchedulingParams::InternalSwap(SchedulingParams* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(SchedulingParams, battery_requirements_)
      + sizeof(SchedulingParams::battery_requirements_)
      - PROTOBUF_FIELD_OFFSET(SchedulingParams, cancel_time_)>(
          reinterpret_cast<char*>(&cancel_time_),
          reinterpret_cast<char*>(&other->cancel_time_));
}
