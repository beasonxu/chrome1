...
static ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<std::string> DownloadSource_strings[12] = {};
...
static const ::PROTOBUF_NAMESPACE_ID::internal::EnumEntry DownloadSource_entries[] = {
  ...
  { {DownloadSource_names + 126, 7}, 0 },
  { {DownloadSource_names + 133, 16}, 7 },
};
...
bool DownloadSource_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, DownloadSource* value) {
  int int_value;
  bool success = ::PROTOBUF_NAMESPACE_ID::internal::LookUpEnumValue(
      DownloadSource_entries, 12, name, &int_value);
  if (success) {
