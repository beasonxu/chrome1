...
JNI_GENERATOR_EXPORT jboolean Java_J_N_Mw3X2cb0(
  ...
  return native->ClearPrimaryAccount(env, sourceMetric, deleteMetric);
}
...
JNI_GENERATOR_EXPORT void Java_J_N_MFKwWXk6(
    ...
    jint deleteMetric) {
  JniIdentityMutator* native = reinterpret_cast<JniIdentityMutator*>(nativeJniIdentityMutator);
  CHECK_NATIVE_PTR(env, jcaller, native, "RevokeSyncConsent");
  return native->RevokeSyncConsent(env, sourceMetric, deleteMetric);
}
