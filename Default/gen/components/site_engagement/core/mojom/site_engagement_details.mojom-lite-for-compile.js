// components/site_engagement/core/mojom/site_engagement_details.mojom-lite-for-compile.js is auto generated by mojom_bindings_generator.py, do not edit
...
goog.provide('siteEngagement.mojom.SiteEngagementDetailsProvider');
goog.provide('siteEngagement.mojom.SiteEngagementDetailsProviderReceiver');
goog.provide('siteEngagement.mojom.SiteEngagementDetailsProviderCallbackRouter');
goog.provide('siteEngagement.mojom.SiteEngagementDetailsProviderInterface');
goog.provide('siteEngagement.mojom.SiteEngagementDetailsProviderRemote');
goog.provide('siteEngagement.mojom.SiteEngagementDetailsProviderPendingReceiver');
...
/** @interface */
siteEngagement.mojom.SiteEngagementDetailsProviderInterface = class {
...
goog.provide('siteEngagement.mojom.SiteEngagementDetailsSpec');
/**
...
goog.provide('siteEngagement.mojom.SiteEngagementDetailsProvider_GetSiteEngagementDetails_ParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('siteEngagement.mojom.SiteEngagementDetailsProvider_GetSiteEngagementDetails_ResponseParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('siteEngagement.mojom.SiteEngagementDetailsProvider_SetSiteEngagementBaseScoreForUrl_ParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('siteEngagement.mojom.SiteEngagementDetails');
...
goog.provide('siteEngagement.mojom.SiteEngagementDetailsProvider_GetSiteEngagementDetails_Params');
...
goog.provide('siteEngagement.mojom.SiteEngagementDetailsProvider_GetSiteEngagementDetails_ResponseParams');
...
goog.provide('siteEngagement.mojom.SiteEngagementDetailsProvider_SetSiteEngagementBaseScoreForUrl_Params');
