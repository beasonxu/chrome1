...
#ifndef COMPONENTS_FEED_MOJOM_RSS_LINK_READER_MOJOM_JUMBO_H_
#define COMPONENTS_FEED_MOJOM_RSS_LINK_READER_MOJOM_JUMBO_H_
#endif
...
RssLinkReader::IPCStableHashFunction RssLinkReader::MessageToMethodInfo_(mojo::Message& message) {
  ...
  switch (message.name()) {
    case internal::kRssLinkReader_GetRssLinks_Name: {
...
uint32_t RssLinkReader::GetRssLinks_Sym::IPCStableHash() {
  ...
  constexpr uint32_t kHash = base::MD5Hash32Constexpr(
          "(Impl)feed::mojom::RssLinkReader::GetRssLinks");
...
void RssLinkReaderProxy::GetRssLinks(
  ...
  mojo::Message message(
      internal::kRssLinkReader_GetRssLinks_Name, kFlags, 0, 0, nullptr);
...
void RssLinkReader_GetRssLinks_ProxyToResponder::Run(
  ...
  mojo::internal::Serialize<::feed::mojom::RssLinksDataView>(
      in_rss_links, rss_links_fragment);
