...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 PayloadMetadataDefaultTypeInternal _PayloadMetadata_default_instance_;
}  // namespace feedwire
namespace feedwire {
...
class PayloadMetadata::_Internal {
 public:
  using HasBits = decltype(std::declval<PayloadMetadata>()._has_bits_);
...
// @@protoc_insertion_point(message_clear_start:feedwire.PayloadMetadata)
  ...
  if (cached_has_bits & 0x00000001u) {
    GOOGLE_DCHECK(content_id_ != nullptr);
    content_id_->Clear();
  }
  _has_bits_.Clear();
...
void PayloadMetadata::CheckTypeAndMergeFrom(
  ...
  MergeFrom(*::_pbi::DownCast<const PayloadMetadata*>(
      &from));
}
