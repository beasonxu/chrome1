// components/ml/mojom/web_platform_model.mojom.cc is auto generated by mojom_bindings_generator.py, do not edit
...
size_t CreateModelLoaderOptions::Hash(size_t seed) const {
  seed = mojo::internal::Hash(seed, this->num_threads);
  seed = mojo::internal::Hash(seed, this->model_format);
  seed = mojo::internal::Hash(seed, this->device_preference);
  return seed;
}
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type base::flat_map<std::string, TensorInfoPtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
bool ModelLoaderRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::ml::model_loader::mojom::ModelLoader::Name_;
...
bool ModelRequestValidator::Accept(mojo::Message* message) {
  const char* name = ::ml::model_loader::mojom::Model::Name_;
...
bool StructTraits<::ml::model_loader::mojom::CreateModelLoaderOptions::DataView, ::ml::model_loader::mojom::CreateModelLoaderOptionsPtr>::Read(
  ...
  bool success = true;
  ::ml::model_loader::mojom::CreateModelLoaderOptionsPtr result(::ml::model_loader::mojom::CreateModelLoaderOptions::New());
...
bool StructTraits<::ml::model_loader::mojom::TensorInfo::DataView, ::ml::model_loader::mojom::TensorInfoPtr>::Read(
  ...
  bool success = true;
  ::ml::model_loader::mojom::TensorInfoPtr result(::ml::model_loader::mojom::TensorInfo::New());
...
bool StructTraits<::ml::model_loader::mojom::ModelInfo::DataView, ::ml::model_loader::mojom::ModelInfoPtr>::Read(
  ...
  bool success = true;
  ::ml::model_loader::mojom::ModelInfoPtr result(::ml::model_loader::mojom::ModelInfo::New());
