...
@IntDef({
    ...
    DropOutReason.ONBOARDING_DIALOG_DISMISSED, DropOutReason.MULTIPLE_AUTOSTARTABLE_SCRIPTS,
    DropOutReason.MAX_VALUE
})
...
public @interface DropOutReason {
  ...
  int MULTIPLE_AUTOSTARTABLE_SCRIPTS = 28;
  int MAX_VALUE = MULTIPLE_AUTOSTARTABLE_SCRIPTS;
}
