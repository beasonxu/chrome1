...
#ifndef COMPONENTS_AUTOFILL_ASSISTANT_BROWSER_DEVTOOLS_DEVTOOLS_DOMAINS_TYPES_PERFORMANCE_H_
#define COMPONENTS_AUTOFILL_ASSISTANT_BROWSER_DEVTOOLS_DEVTOOLS_DOMAINS_TYPES_PERFORMANCE_H_

#include "third_party/abseil-cpp/absl/types/optional.h"
#include "base/values.h"
#include "components/autofill_assistant/browser/devtools/devtools/internal/types_forward_declarations_performance.h"
...
class EnableParams {
 public:
  ...
  ::autofill_assistant::performance::EnableTimeDomain GetTimeDomain() const { DCHECK(HasTimeDomain()); return time_domain_.value(); }
  void SetTimeDomain(::autofill_assistant::performance::EnableTimeDomain value) { time_domain_ = value; }
  ...
  public:
    ...
    EnableParamsBuilder<STATE>& SetTimeDomain(::autofill_assistant::performance::EnableTimeDomain value) {
 ...
 private:
  ...
  absl::optional<::autofill_assistant::performance::EnableTimeDomain> time_domain_;
};
...
class SetTimeDomainParams {
 public:
  ...
  SetTimeDomainParams(const SetTimeDomainParams&) = delete;
  SetTimeDomainParams& operator=(const SetTimeDomainParams&) = delete;
  ~SetTimeDomainParams() { }

  // Time domain
  ::autofill_assistant::performance::SetTimeDomainTimeDomain GetTimeDomain() const { return time_domain_; }
  void SetTimeDomain(::autofill_assistant::performance::SetTimeDomainTimeDomain value) { time_domain_ = value; }
  ...
  public:
    ...
    SetTimeDomainParamsBuilder<STATE | kTimeDomainSet>& SetTimeDomain(::autofill_assistant::performance::SetTimeDomainTimeDomain value) {
 ...
 private:
  ...
  ::autofill_assistant::performance::SetTimeDomainTimeDomain time_domain_;
};
...
class SetTimeDomainResult {
 public:
  ...
  SetTimeDomainResult(const SetTimeDomainResult&) = delete;
  SetTimeDomainResult& operator=(const SetTimeDomainResult&) = delete;
  ~SetTimeDomainResult() { }
...
class GetMetricsParams {
 public:
  ...
  GetMetricsParams(const GetMetricsParams&) = delete;
  GetMetricsParams& operator=(const GetMetricsParams&) = delete;
  ~GetMetricsParams() { }
...
class GetMetricsResult {
 public:
  ...
  GetMetricsResult(const GetMetricsResult&) = delete;
  GetMetricsResult& operator=(const GetMetricsResult&) = delete;
  ~GetMetricsResult() { }

  // Current values for run-time metrics.
  const std::vector<std::unique_ptr<::autofill_assistant::performance::Metric>>* GetMetrics() const { return &metrics_; }
  void SetMetrics(std::vector<std::unique_ptr<::autofill_assistant::performance::Metric>> value) { metrics_ = std::move(value); }
  ...
  public:
    ...
    GetMetricsResultBuilder<STATE | kMetricsSet>& SetMetrics(std::vector<std::unique_ptr<::autofill_assistant::performance::Metric>> value) {
 ...
 private:
  ...
  std::vector<std::unique_ptr<::autofill_assistant::performance::Metric>> metrics_;
};
...
class MetricsParams {
 public:
  ...
  MetricsParams(const MetricsParams&) = delete;
  MetricsParams& operator=(const MetricsParams&) = delete;
  ~MetricsParams() { }
  ...
  public:
    ...
    MetricsParamsBuilder<STATE | kMetricsSet>& SetMetrics(std::vector<std::unique_ptr<::autofill_assistant::performance::Metric>> value) {
      static_assert(!(STATE & kMetricsSet), "property metrics should not have already been set");
      result_->SetMetrics(std::move(value));
      return CastState<kMetricsSet>();
    }
...
#endif  // COMPONENTS_AUTOFILL_ASSISTANT_BROWSER_DEVTOOLS_DEVTOOLS_DOMAINS_TYPES_PERFORMANCE_H_
