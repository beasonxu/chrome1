...
#ifndef COMPONENTS_AUTOFILL_ASSISTANT_BROWSER_DEVTOOLS_DEVTOOLS_DOMAINS_PERFORMANCE_TIMELINE_H_
#define COMPONENTS_AUTOFILL_ASSISTANT_BROWSER_DEVTOOLS_DEVTOOLS_DOMAINS_PERFORMANCE_TIMELINE_H_
...
class ExperimentalObserver {
 public:
  ...
  virtual void OnTimelineEventAdded(const TimelineEventAddedParams& params) {}
};

class Observer : public ExperimentalObserver {
 public:
  virtual ~Observer() {}
  // Experimental: Sent when a performance timeline event is added. See reportPerformanceTimeline method.
  virtual void OnTimelineEventAdded(const TimelineEventAddedParams& params) final {}
};
...
class Domain {
 ...
 protected:
  ...
  void DispatchTimelineEventAddedEvent(const base::Value& params);
...
#endif  // COMPONENTS_AUTOFILL_ASSISTANT_BROWSER_DEVTOOLS_DEVTOOLS_DOMAINS_PERFORMANCE_TIMELINE_H_
