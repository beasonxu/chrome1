...
std::unique_ptr<EventListener> EventListener::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (handler_value) {
    ...
    result->handler_ = internal::FromValue<::autofill_assistant::runtime::RemoteObject>::Parse(*handler_value, errors);
  }
  ...
  if (original_handler_value) {
    ...
    result->original_handler_ = internal::FromValue<::autofill_assistant::runtime::RemoteObject>::Parse(*original_handler_value, errors);
  }
...
std::unique_ptr<GetEventListenersResult> GetEventListenersResult::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (listeners_value) {
    ...
    result->listeners_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::dom_debugger::EventListener>>>::Parse(*listeners_value, errors);
  } else {
...
std::unique_ptr<RemoveDOMBreakpointParams> RemoveDOMBreakpointParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (type_value) {
    errors->SetName("type");
    result->type_ = internal::FromValue<::autofill_assistant::dom_debugger::DOMBreakpointType>::Parse(*type_value, errors);
  } else {
    errors->AddError("required property missing: type");
  }
  errors->Pop();
...
std::unique_ptr<SetBreakOnCSPViolationParams> SetBreakOnCSPViolationParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  errors->Push();
  errors->SetName("SetBreakOnCSPViolationParams");
  const base::Value* violation_types_value = value.FindKey("violationTypes");
  if (violation_types_value) {
    errors->SetName("violationTypes");
    result->violation_types_ = internal::FromValue<std::vector<::autofill_assistant::dom_debugger::CSPViolationType>>::Parse(*violation_types_value, errors);
  } else {
...
std::unique_ptr<base::Value> SetBreakOnCSPViolationParams::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
...
std::unique_ptr<base::Value> SetBreakOnCSPViolationResult::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  return std::move(result);
}
