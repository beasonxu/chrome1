...
#include "components/autofill_assistant/browser/devtools/devtools/internal/type_conversions_cache_storage.h"
...
std::unique_ptr<DataEntry> DataEntry::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (request_headers_value) {
    ...
    result->request_headers_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::cache_storage::Header>>>::Parse(*request_headers_value, errors);
  } else {
  ...
  if (response_type_value) {
    ...
    result->response_type_ = internal::FromValue<::autofill_assistant::cache_storage::CachedResponseType>::Parse(*response_type_value, errors);
  } else {
  ...
  if (response_headers_value) {
    ...
    result->response_headers_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::cache_storage::Header>>>::Parse(*response_headers_value, errors);
  } else {
...
std::unique_ptr<RequestCacheNamesResult> RequestCacheNamesResult::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (caches_value) {
    ...
    result->caches_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::cache_storage::Cache>>>::Parse(*caches_value, errors);
  } else {
...
std::unique_ptr<RequestCachedResponseResult> RequestCachedResponseResult::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (response_value) {
    ...
    result->response_ = internal::FromValue<::autofill_assistant::cache_storage::CachedResponse>::Parse(*response_value, errors);
  } else {
...
std::unique_ptr<RequestEntriesResult> RequestEntriesResult::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (cache_data_entries_value) {
    ...
    result->cache_data_entries_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::cache_storage::DataEntry>>>::Parse(*cache_data_entries_value, errors);
  } else {
