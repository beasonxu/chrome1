...
std::unique_ptr<TargetInfo> TargetInfo::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  const base::Value* can_access_opener_value = value.FindKey("canAccessOpener");
  if (can_access_opener_value) {
    errors->SetName("canAccessOpener");
    result->can_access_opener_ = internal::FromValue<bool>::Parse(*can_access_opener_value, errors);
  } else {
    errors->AddError("required property missing: canAccessOpener");
  }
  const base::Value* opener_frame_id_value = value.FindKey("openerFrameId");
  if (opener_frame_id_value) {
    errors->SetName("openerFrameId");
    result->opener_frame_id_ = internal::FromValue<std::string>::Parse(*opener_frame_id_value, errors);
  }
...
std::unique_ptr<base::Value> TargetInfo::Serialize() const {
  ...
  result->Set("canAccessOpener", internal::ToValue(can_access_opener_));
  if (opener_frame_id_)
    result->Set("openerFrameId", internal::ToValue(opener_frame_id_.value()));
...
std::unique_ptr<FilterEntry> FilterEntry::Parse(const base::Value& value, ErrorReporter* errors) {
  errors->Push();
  errors->SetName("FilterEntry");
  if (!value.is_dict()) {
    errors->AddError("object expected");
    errors->Pop();
    return nullptr;
  ...
  std::unique_ptr<FilterEntry> result(new FilterEntry());
  errors->Push();
  errors->SetName("FilterEntry");
  const base::Value* exclude_value = value.FindKey("exclude");
  if (exclude_value) {
    errors->SetName("exclude");
    result->exclude_ = internal::FromValue<bool>::Parse(*exclude_value, errors);
  }
  const base::Value* type_value = value.FindKey("type");
  if (type_value) {
    errors->SetName("type");
...
std::unique_ptr<base::Value> FilterEntry::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  if (exclude_)
    result->Set("exclude", internal::ToValue(exclude_.value()));
  if (type_)
    result->Set("type", internal::ToValue(type_.value()));
  return std::move(result);
}

std::unique_ptr<FilterEntry> FilterEntry::Clone() const {
  ErrorReporter errors;
  std::unique_ptr<FilterEntry> result = Parse(*Serialize(), &errors);
  DCHECK(!errors.HasErrors());
  return result;
}
...
std::unique_ptr<CreateBrowserContextParams> CreateBrowserContextParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  const base::Value* origins_with_universal_network_access_value = value.FindKey("originsWithUniversalNetworkAccess");
  if (origins_with_universal_network_access_value) {
    errors->SetName("originsWithUniversalNetworkAccess");
    result->origins_with_universal_network_access_ = internal::FromValue<std::vector<std::string>>::Parse(*origins_with_universal_network_access_value, errors);
  }
  errors->Pop();
  errors->Pop();
  if (errors->HasErrors())
...
std::unique_ptr<base::Value> CreateBrowserContextParams::Serialize() const {
  ...
  if (origins_with_universal_network_access_)
    result->Set("originsWithUniversalNetworkAccess", internal::ToValue(origins_with_universal_network_access_.value()));
  return std::move(result);
}
...
std::unique_ptr<GetTargetInfoResult> GetTargetInfoResult::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (target_info_value) {
    errors->SetName("targetInfo");
    result->target_info_ = internal::FromValue<::autofill_assistant::target::TargetInfo>::Parse(*target_info_value, errors);
  } else {
...
std::unique_ptr<GetTargetsParams> GetTargetsParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  errors->Push();
  errors->SetName("GetTargetsParams");
  const base::Value* filter_value = value.FindKey("filter");
  if (filter_value) {
    errors->SetName("filter");
    result->filter_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::target::FilterEntry>>>::Parse(*filter_value, errors);
  }
  errors->Pop();
  errors->Pop();
  if (errors->HasErrors())
...
std::unique_ptr<base::Value> GetTargetsParams::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  if (filter_)
    result->Set("filter", internal::ToValue(filter_.value()));
  return std::move(result);
}
...
std::unique_ptr<GetTargetsResult> GetTargetsResult::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (target_infos_value) {
    ...
    result->target_infos_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::target::TargetInfo>>>::Parse(*target_infos_value, errors);
  } else {
...
std::unique_ptr<AutoAttachRelatedParams> AutoAttachRelatedParams::Parse(const base::Value& value, ErrorReporter* errors) {
  errors->Push();
  errors->SetName("AutoAttachRelatedParams");
  if (!value.is_dict()) {
    errors->AddError("object expected");
    errors->Pop();
    return nullptr;
  ...
  std::unique_ptr<AutoAttachRelatedParams> result(new AutoAttachRelatedParams());
  errors->Push();
  errors->SetName("AutoAttachRelatedParams");
  const base::Value* target_id_value = value.FindKey("targetId");
  if (target_id_value) {
...
std::unique_ptr<base::Value> AutoAttachRelatedParams::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  result->Set("targetId", internal::ToValue(target_id_));
  result->Set("waitForDebuggerOnStart", internal::ToValue(wait_for_debugger_on_start_));
  if (filter_)
...
std::unique_ptr<AutoAttachRelatedParams> AutoAttachRelatedParams::Clone() const {
  ErrorReporter errors;
  std::unique_ptr<AutoAttachRelatedParams> result = Parse(*Serialize(), &errors);
  DCHECK(!errors.HasErrors());
  return result;
}


std::unique_ptr<AutoAttachRelatedResult> AutoAttachRelatedResult::Parse(const base::Value& value, ErrorReporter* errors) {
  errors->Push();
  errors->SetName("AutoAttachRelatedResult");
  if (!value.is_dict()) {
    errors->AddError("object expected");
    errors->Pop();
    return nullptr;
  ...
  std::unique_ptr<AutoAttachRelatedResult> result(new AutoAttachRelatedResult());
  errors->Push();
  errors->SetName("AutoAttachRelatedResult");
  errors->Pop();
  errors->Pop();
...
std::unique_ptr<base::Value> AutoAttachRelatedResult::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  return std::move(result);
}

std::unique_ptr<AutoAttachRelatedResult> AutoAttachRelatedResult::Clone() const {
  ErrorReporter errors;
  std::unique_ptr<AutoAttachRelatedResult> result = Parse(*Serialize(), &errors);
  DCHECK(!errors.HasErrors());
  return result;
}
...
std::unique_ptr<SetRemoteLocationsParams> SetRemoteLocationsParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (locations_value) {
    ...
    result->locations_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::target::RemoteLocation>>>::Parse(*locations_value, errors);
  } else {
