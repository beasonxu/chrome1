...
#include "components/autofill_assistant/browser/devtools/devtools/internal/type_conversions_dom_debugger.h"
#include "components/autofill_assistant/browser/devtools/devtools/internal/type_conversions_dom_snapshot.h"
...
std::unique_ptr<DOMNode> DOMNode::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (attributes_value) {
    ...
    result->attributes_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::dom_snapshot::NameValue>>>::Parse(*attributes_value, errors);
  }
  ...
  if (event_listeners_value) {
    ...
    result->event_listeners_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::dom_debugger::EventListener>>>::Parse(*event_listeners_value, errors);
  }
...
std::unique_ptr<InlineTextBox> InlineTextBox::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (bounding_box_value) {
    ...
    result->bounding_box_ = internal::FromValue<::autofill_assistant::dom::Rect>::Parse(*bounding_box_value, errors);
  } else {
...
std::unique_ptr<LayoutTreeNode> LayoutTreeNode::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (inline_text_nodes_value) {
    ...
    result->inline_text_nodes_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::dom_snapshot::InlineTextBox>>>::Parse(*inline_text_nodes_value, errors);
  }
...
std::unique_ptr<ComputedStyle> ComputedStyle::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (properties_value) {
    ...
    result->properties_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::dom_snapshot::NameValue>>>::Parse(*properties_value, errors);
  } else {
...
std::unique_ptr<DocumentSnapshot> DocumentSnapshot::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (nodes_value) {
    ...
    result->nodes_ = internal::FromValue<::autofill_assistant::dom_snapshot::NodeTreeSnapshot>::Parse(*nodes_value, errors);
  } else {
  ...
  if (layout_value) {
    ...
    result->layout_ = internal::FromValue<::autofill_assistant::dom_snapshot::LayoutTreeSnapshot>::Parse(*layout_value, errors);
  } else {
  ...
  if (text_boxes_value) {
    ...
    result->text_boxes_ = internal::FromValue<::autofill_assistant::dom_snapshot::TextBoxSnapshot>::Parse(*text_boxes_value, errors);
  } else {
...
std::unique_ptr<NodeTreeSnapshot> NodeTreeSnapshot::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (shadow_root_type_value) {
    errors->SetName("shadowRootType");
    result->shadow_root_type_ = internal::FromValue<::autofill_assistant::dom_snapshot::RareStringData>::Parse(*shadow_root_type_value, errors);
  }
  const base::Value* node_name_value = value.FindKey("nodeName");
  if (node_name_value) {
    errors->SetName("nodeName");
  ...
  if (text_value_value) {
    errors->SetName("textValue");
    result->text_value_ = internal::FromValue<::autofill_assistant::dom_snapshot::RareStringData>::Parse(*text_value_value, errors);
  }
  const base::Value* input_value_value = value.FindKey("inputValue");
  if (input_value_value) {
    errors->SetName("inputValue");
    result->input_value_ = internal::FromValue<::autofill_assistant::dom_snapshot::RareStringData>::Parse(*input_value_value, errors);
  }
  const base::Value* input_checked_value = value.FindKey("inputChecked");
  if (input_checked_value) {
    errors->SetName("inputChecked");
    result->input_checked_ = internal::FromValue<::autofill_assistant::dom_snapshot::RareBooleanData>::Parse(*input_checked_value, errors);
  }
  const base::Value* option_selected_value = value.FindKey("optionSelected");
  if (option_selected_value) {
    errors->SetName("optionSelected");
    result->option_selected_ = internal::FromValue<::autofill_assistant::dom_snapshot::RareBooleanData>::Parse(*option_selected_value, errors);
  }
  const base::Value* content_document_index_value = value.FindKey("contentDocumentIndex");
  if (content_document_index_value) {
    errors->SetName("contentDocumentIndex");
    result->content_document_index_ = internal::FromValue<::autofill_assistant::dom_snapshot::RareIntegerData>::Parse(*content_document_index_value, errors);
  }
  const base::Value* pseudo_type_value = value.FindKey("pseudoType");
  if (pseudo_type_value) {
    errors->SetName("pseudoType");
    result->pseudo_type_ = internal::FromValue<::autofill_assistant::dom_snapshot::RareStringData>::Parse(*pseudo_type_value, errors);
  }
  ...
  if (pseudo_identifier_value) {
    ...
    result->pseudo_identifier_ = internal::FromValue<::autofill_assistant::dom_snapshot::RareStringData>::Parse(*pseudo_identifier_value, errors);
  }
  const base::Value* is_clickable_value = value.FindKey("isClickable");
  if (is_clickable_value) {
    errors->SetName("isClickable");
    result->is_clickable_ = internal::FromValue<::autofill_assistant::dom_snapshot::RareBooleanData>::Parse(*is_clickable_value, errors);
  }
  const base::Value* current_sourceurl_value = value.FindKey("currentSourceURL");
  if (current_sourceurl_value) {
    errors->SetName("currentSourceURL");
    result->current_sourceurl_ = internal::FromValue<::autofill_assistant::dom_snapshot::RareStringData>::Parse(*current_sourceurl_value, errors);
  }
  const base::Value* originurl_value = value.FindKey("originURL");
  if (originurl_value) {
    errors->SetName("originURL");
    result->originurl_ = internal::FromValue<::autofill_assistant::dom_snapshot::RareStringData>::Parse(*originurl_value, errors);
  }
  errors->Pop();
  errors->Pop();
  if (errors->HasErrors())
...
std::unique_ptr<LayoutTreeSnapshot> LayoutTreeSnapshot::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (stacking_contexts_value) {
    ...
    result->stacking_contexts_ = internal::FromValue<::autofill_assistant::dom_snapshot::RareBooleanData>::Parse(*stacking_contexts_value, errors);
  } else {
  ...
  const base::Value* blended_background_colors_value = value.FindKey("blendedBackgroundColors");
  if (blended_background_colors_value) {
    errors->SetName("blendedBackgroundColors");
    result->blended_background_colors_ = internal::FromValue<std::vector<int>>::Parse(*blended_background_colors_value, errors);
  }
  const base::Value* text_color_opacities_value = value.FindKey("textColorOpacities");
  if (text_color_opacities_value) {
    errors->SetName("textColorOpacities");
    result->text_color_opacities_ = internal::FromValue<std::vector<double>>::Parse(*text_color_opacities_value, errors);
  }
  errors->Pop();
  errors->Pop();
  if (errors->HasErrors())
...
std::unique_ptr<base::Value> LayoutTreeSnapshot::Serialize() const {
  ...
  if (blended_background_colors_)
    result->Set("blendedBackgroundColors", internal::ToValue(blended_background_colors_.value()));
  if (text_color_opacities_)
    result->Set("textColorOpacities", internal::ToValue(text_color_opacities_.value()));
  return std::move(result);
}
...
std::unique_ptr<GetSnapshotResult> GetSnapshotResult::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (dom_nodes_value) {
    ...
    result->dom_nodes_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::dom_snapshot::DOMNode>>>::Parse(*dom_nodes_value, errors);
  } else {
  ...
  if (layout_tree_nodes_value) {
    ...
    result->layout_tree_nodes_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::dom_snapshot::LayoutTreeNode>>>::Parse(*layout_tree_nodes_value, errors);
  } else {
  ...
  if (computed_styles_value) {
    ...
    result->computed_styles_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::dom_snapshot::ComputedStyle>>>::Parse(*computed_styles_value, errors);
  } else {
...
std::unique_ptr<CaptureSnapshotParams> CaptureSnapshotParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  const base::Value* include_blended_background_colors_value = value.FindKey("includeBlendedBackgroundColors");
  if (include_blended_background_colors_value) {
    errors->SetName("includeBlendedBackgroundColors");
    result->include_blended_background_colors_ = internal::FromValue<bool>::Parse(*include_blended_background_colors_value, errors);
  }
  const base::Value* include_text_color_opacities_value = value.FindKey("includeTextColorOpacities");
  if (include_text_color_opacities_value) {
    errors->SetName("includeTextColorOpacities");
    result->include_text_color_opacities_ = internal::FromValue<bool>::Parse(*include_text_color_opacities_value, errors);
  }
  errors->Pop();
  errors->Pop();
  if (errors->HasErrors())
...
std::unique_ptr<base::Value> CaptureSnapshotParams::Serialize() const {
  ...
  if (include_blended_background_colors_)
    result->Set("includeBlendedBackgroundColors", internal::ToValue(include_blended_background_colors_.value()));
  if (include_text_color_opacities_)
    result->Set("includeTextColorOpacities", internal::ToValue(include_text_color_opacities_.value()));
  return std::move(result);
}
...
std::unique_ptr<CaptureSnapshotResult> CaptureSnapshotResult::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (documents_value) {
    ...
    result->documents_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::dom_snapshot::DocumentSnapshot>>>::Parse(*documents_value, errors);
  } else {
