...
#include "components/autofill_assistant/browser/devtools/devtools/internal/type_conversions_service_worker.h"
...
std::unique_ptr<ServiceWorkerVersion> ServiceWorkerVersion::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (running_status_value) {
    ...
    result->running_status_ = internal::FromValue<::autofill_assistant::service_worker::ServiceWorkerVersionRunningStatus>::Parse(*running_status_value, errors);
  } else {
  ...
  if (status_value) {
    ...
    result->status_ = internal::FromValue<::autofill_assistant::service_worker::ServiceWorkerVersionStatus>::Parse(*status_value, errors);
  } else {
...
std::unique_ptr<WorkerErrorReportedParams> WorkerErrorReportedParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (error_message_value) {
    errors->SetName("errorMessage");
    result->error_message_ = internal::FromValue<::autofill_assistant::service_worker::ServiceWorkerErrorMessage>::Parse(*error_message_value, errors);
  } else {
    errors->AddError("required property missing: errorMessage");
  }
  errors->Pop();
...
std::unique_ptr<WorkerRegistrationUpdatedParams> WorkerRegistrationUpdatedParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (registrations_value) {
    ...
    result->registrations_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::service_worker::ServiceWorkerRegistration>>>::Parse(*registrations_value, errors);
  } else {
...
std::unique_ptr<WorkerVersionUpdatedParams> WorkerVersionUpdatedParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (versions_value) {
    ...
    result->versions_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::service_worker::ServiceWorkerVersion>>>::Parse(*versions_value, errors);
  } else {
