...
#include "components/autofill_assistant/browser/devtools/devtools/internal/type_conversions_indexeddb.h"
...
std::unique_ptr<DatabaseWithObjectStores> DatabaseWithObjectStores::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (object_stores_value) {
    ...
    result->object_stores_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::indexeddb::ObjectStore>>>::Parse(*object_stores_value, errors);
  } else {
...
std::unique_ptr<ObjectStore> ObjectStore::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (key_path_value) {
    ...
    result->key_path_ = internal::FromValue<::autofill_assistant::indexeddb::KeyPath>::Parse(*key_path_value, errors);
  } else {
  ...
  if (indexes_value) {
    ...
    result->indexes_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::indexeddb::ObjectStoreIndex>>>::Parse(*indexes_value, errors);
  } else {
...
std::unique_ptr<Key> Key::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (type_value) {
    errors->SetName("type");
    result->type_ = internal::FromValue<::autofill_assistant::indexeddb::KeyType>::Parse(*type_value, errors);
  } else {
  ...
  if (array_value) {
    ...
    result->array_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::indexeddb::Key>>>::Parse(*array_value, errors);
  }
  errors->Pop();
  errors->Pop();
  if (errors->HasErrors())
...
std::unique_ptr<KeyRange> KeyRange::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (lower_value) {
    ...
    result->lower_ = internal::FromValue<::autofill_assistant::indexeddb::Key>::Parse(*lower_value, errors);
  }
  const base::Value* upper_value = value.FindKey("upper");
  if (upper_value) {
    errors->SetName("upper");
    result->upper_ = internal::FromValue<::autofill_assistant::indexeddb::Key>::Parse(*upper_value, errors);
  }
...
std::unique_ptr<DataEntry> DataEntry::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (key_value) {
    errors->SetName("key");
    result->key_ = internal::FromValue<::autofill_assistant::runtime::RemoteObject>::Parse(*key_value, errors);
  } else {
  ...
  if (primary_key_value) {
    ...
    result->primary_key_ = internal::FromValue<::autofill_assistant::runtime::RemoteObject>::Parse(*primary_key_value, errors);
  } else {
...
std::unique_ptr<KeyPath> KeyPath::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (type_value) {
    errors->SetName("type");
    result->type_ = internal::FromValue<::autofill_assistant::indexeddb::KeyPathType>::Parse(*type_value, errors);
  } else {
    errors->AddError("required property missing: type");
  }
  const base::Value* string_value = value.FindKey("string");
...
std::unique_ptr<DeleteObjectStoreEntriesParams> DeleteObjectStoreEntriesParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (key_range_value) {
    errors->SetName("keyRange");
    result->key_range_ = internal::FromValue<::autofill_assistant::indexeddb::KeyRange>::Parse(*key_range_value, errors);
  } else {
...
std::unique_ptr<RequestDataResult> RequestDataResult::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (object_store_data_entries_value) {
    ...
    result->object_store_data_entries_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::indexeddb::DataEntry>>>::Parse(*object_store_data_entries_value, errors);
  } else {
...
std::unique_ptr<RequestDatabaseResult> RequestDatabaseResult::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (database_with_object_stores_value) {
    errors->SetName("databaseWithObjectStores");
    result->database_with_object_stores_ = internal::FromValue<::autofill_assistant::indexeddb::DatabaseWithObjectStores>::Parse(*database_with_object_stores_value, errors);
  } else {
