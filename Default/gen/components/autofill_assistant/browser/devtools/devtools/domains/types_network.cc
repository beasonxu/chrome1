...
std::unique_ptr<PostDataEntry> PostDataEntry::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  errors->Push();
  errors->SetName("PostDataEntry");
  const base::Value* bytes_value = value.FindKey("bytes");
  if (bytes_value) {
    errors->SetName("bytes");
    result->bytes_ = internal::FromValue<std::string>::Parse(*bytes_value, errors);
  }
  errors->Pop();
  errors->Pop();
  if (errors->HasErrors())
...
std::unique_ptr<base::Value> PostDataEntry::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  if (bytes_)
...
std::unique_ptr<Request> Request::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  const base::Value* post_data_entries_value = value.FindKey("postDataEntries");
  if (post_data_entries_value) {
    errors->SetName("postDataEntries");
    result->post_data_entries_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::network::PostDataEntry>>>::Parse(*post_data_entries_value, errors);
  }
  ...
  if (mixed_content_type_value) {
    ...
    result->mixed_content_type_ = internal::FromValue<::autofill_assistant::security::MixedContentType>::Parse(*mixed_content_type_value, errors);
  }
  ...
  if (initial_priority_value) {
    ...
    result->initial_priority_ = internal::FromValue<::autofill_assistant::network::ResourcePriority>::Parse(*initial_priority_value, errors);
  } else {
  ...
  if (referrer_policy_value) {
    ...
    result->referrer_policy_ = internal::FromValue<::autofill_assistant::network::RequestReferrerPolicy>::Parse(*referrer_policy_value, errors);
  } else {
  ...
  const base::Value* trust_token_params_value = value.FindKey("trustTokenParams");
  if (trust_token_params_value) {
    errors->SetName("trustTokenParams");
    result->trust_token_params_ = internal::FromValue<::autofill_assistant::network::TrustTokenParams>::Parse(*trust_token_params_value, errors);
  }
  const base::Value* is_same_site_value = value.FindKey("isSameSite");
...
std::unique_ptr<SecurityDetails> SecurityDetails::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (signed_certificate_timestamp_list_value) {
    ...
    result->signed_certificate_timestamp_list_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::network::SignedCertificateTimestamp>>>::Parse(*signed_certificate_timestamp_list_value, errors);
  } else {
  ...
  if (certificate_transparency_compliance_value) {
    ...
    result->certificate_transparency_compliance_ = internal::FromValue<::autofill_assistant::network::CertificateTransparencyCompliance>::Parse(*certificate_transparency_compliance_value, errors);
  } else {
    errors->AddError("required property missing: certificateTransparencyCompliance");
  }
  const base::Value* server_signature_algorithm_value = value.FindKey("serverSignatureAlgorithm");
  ...
  const base::Value* encrypted_client_hello_value = value.FindKey("encryptedClientHello");
...
std::unique_ptr<CorsErrorStatus> CorsErrorStatus::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  errors->Push();
  errors->SetName("CorsErrorStatus");
  const base::Value* cors_error_value = value.FindKey("corsError");
  if (cors_error_value) {
    errors->SetName("corsError");
    result->cors_error_ = internal::FromValue<::autofill_assistant::network::CorsError>::Parse(*cors_error_value, errors);
  } else {
    errors->AddError("required property missing: corsError");
  }
  const base::Value* failed_parameter_value = value.FindKey("failedParameter");
...
std::unique_ptr<base::Value> CorsErrorStatus::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
...
std::unique_ptr<TrustTokenParams> TrustTokenParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (type_value) {
    errors->SetName("type");
    result->type_ = internal::FromValue<::autofill_assistant::network::TrustTokenOperationType>::Parse(*type_value, errors);
  } else {
    errors->AddError("required property missing: type");
  }
  const base::Value* refresh_policy_value = value.FindKey("refreshPolicy");
  if (refresh_policy_value) {
    errors->SetName("refreshPolicy");
    result->refresh_policy_ = internal::FromValue<::autofill_assistant::network::TrustTokenParamsRefreshPolicy>::Parse(*refresh_policy_value, errors);
  } else {
    errors->AddError("required property missing: refreshPolicy");
  }
  const base::Value* issuers_value = value.FindKey("issuers");
  if (issuers_value) {
...
std::unique_ptr<base::Value> TrustTokenParams::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
...
std::unique_ptr<Response> Response::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (timing_value) {
    ...
    result->timing_ = internal::FromValue<::autofill_assistant::network::ResourceTiming>::Parse(*timing_value, errors);
  }
  ...
  if (service_worker_response_source_value) {
    ...
    result->service_worker_response_source_ = internal::FromValue<::autofill_assistant::network::ServiceWorkerResponseSource>::Parse(*service_worker_response_source_value, errors);
  }
  ...
  if (security_state_value) {
    ...
    result->security_state_ = internal::FromValue<::autofill_assistant::security::SecurityState>::Parse(*security_state_value, errors);
  } else {
  ...
  if (security_details_value) {
    errors->SetName("securityDetails");
    result->security_details_ = internal::FromValue<::autofill_assistant::network::SecurityDetails>::Parse(*security_details_value, errors);
  }
  errors->Pop();
  errors->Pop();
  if (errors->HasErrors())
...
std::unique_ptr<CachedResource> CachedResource::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (response_value) {
    errors->SetName("response");
    result->response_ = internal::FromValue<::autofill_assistant::network::Response>::Parse(*response_value, errors);
  }
...
std::unique_ptr<Initiator> Initiator::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (type_value) {
    errors->SetName("type");
    result->type_ = internal::FromValue<::autofill_assistant::network::InitiatorType>::Parse(*type_value, errors);
  } else {
    errors->AddError("required property missing: type");
  }
...
std::unique_ptr<Cookie> Cookie::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (same_site_value) {
    ...
    result->same_site_ = internal::FromValue<::autofill_assistant::network::CookieSameSite>::Parse(*same_site_value, errors);
  }
  const base::Value* priority_value = value.FindKey("priority");
  if (priority_value) {
    errors->SetName("priority");
    result->priority_ = internal::FromValue<::autofill_assistant::network::CookiePriority>::Parse(*priority_value, errors);
  } else {
    errors->AddError("required property missing: priority");
  }
  const base::Value* same_party_value = value.FindKey("sameParty");
  if (same_party_value) {
  ...
  const base::Value* source_scheme_value = value.FindKey("sourceScheme");
  if (source_scheme_value) {
    errors->SetName("sourceScheme");
    result->source_scheme_ = internal::FromValue<::autofill_assistant::network::CookieSourceScheme>::Parse(*source_scheme_value, errors);
  } else {
    errors->AddError("required property missing: sourceScheme");
  }
  const base::Value* source_port_value = value.FindKey("sourcePort");
  ...
  const base::Value* partition_key_value = value.FindKey("partitionKey");
  ...
  const base::Value* partition_key_opaque_value = value.FindKey("partitionKeyOpaque");
...
std::unique_ptr<BlockedSetCookieWithReason> BlockedSetCookieWithReason::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (blocked_reasons_value) {
    ...
    result->blocked_reasons_ = internal::FromValue<std::vector<::autofill_assistant::network::SetCookieBlockedReason>>::Parse(*blocked_reasons_value, errors);
  } else {
  ...
  if (cookie_value) {
    errors->SetName("cookie");
    result->cookie_ = internal::FromValue<::autofill_assistant::network::Cookie>::Parse(*cookie_value, errors);
  }
  errors->Pop();
  errors->Pop();
  if (errors->HasErrors())
...
std::unique_ptr<BlockedCookieWithReason> BlockedCookieWithReason::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (blocked_reasons_value) {
    errors->SetName("blockedReasons");
    result->blocked_reasons_ = internal::FromValue<std::vector<::autofill_assistant::network::CookieBlockedReason>>::Parse(*blocked_reasons_value, errors);
  } else {
    errors->AddError("required property missing: blockedReasons");
  }
  const base::Value* cookie_value = value.FindKey("cookie");
...
std::unique_ptr<AuthChallenge> AuthChallenge::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (source_value) {
    ...
    result->source_ = internal::FromValue<::autofill_assistant::network::AuthChallengeSource>::Parse(*source_value, errors);
  }
  const base::Value* origin_value = value.FindKey("origin");
  if (origin_value) {
    errors->SetName("origin");
...
std::unique_ptr<AuthChallengeResponse> AuthChallengeResponse::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (response_value) {
    errors->SetName("response");
    result->response_ = internal::FromValue<::autofill_assistant::network::AuthChallengeResponseResponse>::Parse(*response_value, errors);
  } else {
...
std::unique_ptr<RequestPattern> RequestPattern::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (resource_type_value) {
    ...
    result->resource_type_ = internal::FromValue<::autofill_assistant::network::ResourceType>::Parse(*resource_type_value, errors);
  }
  ...
  if (interception_stage_value) {
    ...
    result->interception_stage_ = internal::FromValue<::autofill_assistant::network::InterceptionStage>::Parse(*interception_stage_value, errors);
  }
  errors->Pop();
  errors->Pop();
  if (errors->HasErrors())
...
std::unique_ptr<SignedExchangeHeader> SignedExchangeHeader::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (signatures_value) {
    ...
    result->signatures_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::network::SignedExchangeSignature>>>::Parse(*signatures_value, errors);
  } else {
...
std::unique_ptr<SignedExchangeError> SignedExchangeError::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (error_field_value) {
    ...
    result->error_field_ = internal::FromValue<::autofill_assistant::network::SignedExchangeErrorField>::Parse(*error_field_value, errors);
  }
  errors->Pop();
  errors->Pop();
  if (errors->HasErrors())
...
std::unique_ptr<SignedExchangeInfo> SignedExchangeInfo::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (outer_response_value) {
    ...
    result->outer_response_ = internal::FromValue<::autofill_assistant::network::Response>::Parse(*outer_response_value, errors);
  } else {
  ...
  if (header_value) {
    ...
    result->header_ = internal::FromValue<::autofill_assistant::network::SignedExchangeHeader>::Parse(*header_value, errors);
  }
  const base::Value* security_details_value = value.FindKey("securityDetails");
  if (security_details_value) {
    errors->SetName("securityDetails");
  ...
  if (errors_value) {
    ...
    result->errors_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::network::SignedExchangeError>>>::Parse(*errors_value, errors);
  }
  errors->Pop();
  errors->Pop();
  if (errors->HasErrors())
...
std::unique_ptr<base::Value> ConnectTiming::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  result->Set("requestTime", internal::ToValue(request_time_));
  return std::move(result);
}
...
std::unique_ptr<ClientSecurityState> ClientSecurityState::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  errors->Push();
  errors->SetName("ClientSecurityState");
  const base::Value* initiator_is_secure_context_value = value.FindKey("initiatorIsSecureContext");
  ...
  const base::Value* initiatorip_address_space_value = value.FindKey("initiatorIPAddressSpace");
  if (initiatorip_address_space_value) {
    errors->SetName("initiatorIPAddressSpace");
    result->initiatorip_address_space_ = internal::FromValue<::autofill_assistant::network::IPAddressSpace>::Parse(*initiatorip_address_space_value, errors);
  } else {
    errors->AddError("required property missing: initiatorIPAddressSpace");
  }
  const base::Value* private_network_request_policy_value = value.FindKey("privateNetworkRequestPolicy");
  if (private_network_request_policy_value) {
    errors->SetName("privateNetworkRequestPolicy");
    result->private_network_request_policy_ = internal::FromValue<::autofill_assistant::network::PrivateNetworkRequestPolicy>::Parse(*private_network_request_policy_value, errors);
  } else {
...
std::unique_ptr<base::Value> ClientSecurityState::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
...
std::unique_ptr<CrossOriginOpenerPolicyStatus> CrossOriginOpenerPolicyStatus::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (value_value) {
    errors->SetName("value");
    result->value_ = internal::FromValue<::autofill_assistant::network::CrossOriginOpenerPolicyValue>::Parse(*value_value, errors);
  } else {
    errors->AddError("required property missing: value");
  }
  const base::Value* report_only_value_value = value.FindKey("reportOnlyValue");
  if (report_only_value_value) {
    errors->SetName("reportOnlyValue");
    result->report_only_value_ = internal::FromValue<::autofill_assistant::network::CrossOriginOpenerPolicyValue>::Parse(*report_only_value_value, errors);
  } else {
    errors->AddError("required property missing: reportOnlyValue");
  }
  const base::Value* reporting_endpoint_value = value.FindKey("reportingEndpoint");
  ...
  const base::Value* report_only_reporting_endpoint_value = value.FindKey("reportOnlyReportingEndpoint");
...
std::unique_ptr<base::Value> CrossOriginOpenerPolicyStatus::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  result->Set("value", internal::ToValue(value_));
...
std::unique_ptr<CrossOriginEmbedderPolicyStatus> CrossOriginEmbedderPolicyStatus::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (value_value) {
    errors->SetName("value");
    result->value_ = internal::FromValue<::autofill_assistant::network::CrossOriginEmbedderPolicyValue>::Parse(*value_value, errors);
  } else {
    errors->AddError("required property missing: value");
  }
  const base::Value* report_only_value_value = value.FindKey("reportOnlyValue");
  if (report_only_value_value) {
    errors->SetName("reportOnlyValue");
    result->report_only_value_ = internal::FromValue<::autofill_assistant::network::CrossOriginEmbedderPolicyValue>::Parse(*report_only_value_value, errors);
  } else {
    errors->AddError("required property missing: reportOnlyValue");
  }
  const base::Value* reporting_endpoint_value = value.FindKey("reportingEndpoint");
...
std::unique_ptr<base::Value> CrossOriginEmbedderPolicyStatus::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  result->Set("value", internal::ToValue(value_));
  result->Set("reportOnlyValue", internal::ToValue(report_only_value_));
  if (reporting_endpoint_)
...
std::unique_ptr<SecurityIsolationStatus> SecurityIsolationStatus::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  errors->Push();
  errors->SetName("SecurityIsolationStatus");
  const base::Value* coop_value = value.FindKey("coop");
  if (coop_value) {
    errors->SetName("coop");
    result->coop_ = internal::FromValue<::autofill_assistant::network::CrossOriginOpenerPolicyStatus>::Parse(*coop_value, errors);
  }
  const base::Value* coep_value = value.FindKey("coep");
  if (coep_value) {
    errors->SetName("coep");
    result->coep_ = internal::FromValue<::autofill_assistant::network::CrossOriginEmbedderPolicyStatus>::Parse(*coep_value, errors);
  }
  errors->Pop();
  errors->Pop();
  if (errors->HasErrors())
...
std::unique_ptr<base::Value> SecurityIsolationStatus::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  if (coop_)
...
std::unique_ptr<ReportingApiReport> ReportingApiReport::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  const base::Value* initiator_url_value = value.FindKey("initiatorUrl");
  ...
  const base::Value* destination_value = value.FindKey("destination");
  ...
  const base::Value* completed_attempts_value = value.FindKey("completedAttempts");
  ...
  if (status_value) {
    errors->SetName("status");
    result->status_ = internal::FromValue<::autofill_assistant::network::ReportStatus>::Parse(*status_value, errors);
  } else {
    errors->AddError("required property missing: status");
  }
  errors->Pop();
...
std::unique_ptr<base::Value> ReportingApiReport::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
...
std::unique_ptr<ReportingApiEndpoint> ReportingApiEndpoint::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  const base::Value* group_name_value = value.FindKey("groupName");
  if (group_name_value) {
...
std::unique_ptr<base::Value> ReportingApiEndpoint::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  result->Set("url", internal::ToValue(url_));
...
std::unique_ptr<LoadNetworkResourcePageResult> LoadNetworkResourcePageResult::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  const base::Value* net_error_value = value.FindKey("netError");
  if (net_error_value) {
    errors->SetName("netError");
    result->net_error_ = internal::FromValue<double>::Parse(*net_error_value, errors);
  }
  const base::Value* net_error_name_value = value.FindKey("netErrorName");
...
std::unique_ptr<base::Value> LoadNetworkResourcePageResult::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
...
std::unique_ptr<LoadNetworkResourceOptions> LoadNetworkResourceOptions::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  errors->Push();
  errors->SetName("LoadNetworkResourceOptions");
  const base::Value* disable_cache_value = value.FindKey("disableCache");
  ...
  const base::Value* include_credentials_value = value.FindKey("includeCredentials");
...
std::unique_ptr<base::Value> LoadNetworkResourceOptions::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
...
std::unique_ptr<SetAcceptedEncodingsParams> SetAcceptedEncodingsParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  errors->Push();
  errors->SetName("SetAcceptedEncodingsParams");
  const base::Value* encodings_value = value.FindKey("encodings");
  if (encodings_value) {
    errors->SetName("encodings");
    result->encodings_ = internal::FromValue<std::vector<::autofill_assistant::network::ContentEncoding>>::Parse(*encodings_value, errors);
  } else {
...
std::unique_ptr<base::Value> SetAcceptedEncodingsParams::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
...
std::unique_ptr<base::Value> SetAcceptedEncodingsResult::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  return std::move(result);
}
...
std::unique_ptr<base::Value> ClearAcceptedEncodingsOverrideParams::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  return std::move(result);
}
...
std::unique_ptr<base::Value> ClearAcceptedEncodingsOverrideResult::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  return std::move(result);
}
...
std::unique_ptr<ContinueInterceptedRequestParams> ContinueInterceptedRequestParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (error_reason_value) {
    ...
    result->error_reason_ = internal::FromValue<::autofill_assistant::network::ErrorReason>::Parse(*error_reason_value, errors);
  }
  ...
  if (auth_challenge_response_value) {
    errors->SetName("authChallengeResponse");
    result->auth_challenge_response_ = internal::FromValue<::autofill_assistant::network::AuthChallengeResponse>::Parse(*auth_challenge_response_value, errors);
  }
  errors->Pop();
  errors->Pop();
  if (errors->HasErrors())
...
std::unique_ptr<EmulateNetworkConditionsParams> EmulateNetworkConditionsParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (connection_type_value) {
    ...
    result->connection_type_ = internal::FromValue<::autofill_assistant::network::ConnectionType>::Parse(*connection_type_value, errors);
  }
  errors->Pop();
  errors->Pop();
  if (errors->HasErrors())
...
std::unique_ptr<base::Value> SetAttachDebugStackParams::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
...
std::unique_ptr<base::Value> SetAttachDebugStackResult::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  return std::move(result);
}
...
std::unique_ptr<SetRequestInterceptionParams> SetRequestInterceptionParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (patterns_value) {
    ...
    result->patterns_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::network::RequestPattern>>>::Parse(*patterns_value, errors);
  } else {
...
std::unique_ptr<SetUserAgentOverrideParams> SetUserAgentOverrideParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (user_agent_metadata_value) {
    ...
    result->user_agent_metadata_ = internal::FromValue<::autofill_assistant::emulation::UserAgentMetadata>::Parse(*user_agent_metadata_value, errors);
  }
  errors->Pop();
  errors->Pop();
  if (errors->HasErrors())
...
std::unique_ptr<base::Value> GetSecurityIsolationStatusParams::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  if (frame_id_)
...
std::unique_ptr<GetSecurityIsolationStatusResult> GetSecurityIsolationStatusResult::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (status_value) {
    errors->SetName("status");
    result->status_ = internal::FromValue<::autofill_assistant::network::SecurityIsolationStatus>::Parse(*status_value, errors);
  } else {
    errors->AddError("required property missing: status");
  }
  errors->Pop();
...
std::unique_ptr<base::Value> GetSecurityIsolationStatusResult::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  result->Set("status", internal::ToValue(*status_));
  return std::move(result);
}
...
std::unique_ptr<base::Value> EnableReportingApiParams::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
...
std::unique_ptr<base::Value> EnableReportingApiResult::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  return std::move(result);
}
...
std::unique_ptr<LoadNetworkResourceParams> LoadNetworkResourceParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (options_value) {
    ...
    result->options_ = internal::FromValue<::autofill_assistant::network::LoadNetworkResourceOptions>::Parse(*options_value, errors);
  } else {
...
std::unique_ptr<base::Value> LoadNetworkResourceParams::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  if (frame_id_)
    result->Set("frameId", internal::ToValue(frame_id_.value()));
  result->Set("url", internal::ToValue(url_));
...
std::unique_ptr<LoadNetworkResourceResult> LoadNetworkResourceResult::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  errors->Push();
  errors->SetName("LoadNetworkResourceResult");
  const base::Value* resource_value = value.FindKey("resource");
  if (resource_value) {
    errors->SetName("resource");
    result->resource_ = internal::FromValue<::autofill_assistant::network::LoadNetworkResourcePageResult>::Parse(*resource_value, errors);
  } else {
...
std::unique_ptr<base::Value> LoadNetworkResourceResult::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
...
std::unique_ptr<LoadingFailedParams> LoadingFailedParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (blocked_reason_value) {
    ...
    result->blocked_reason_ = internal::FromValue<::autofill_assistant::network::BlockedReason>::Parse(*blocked_reason_value, errors);
  }
...
std::unique_ptr<RequestInterceptedParams> RequestInterceptedParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (request_value) {
    errors->SetName("request");
    result->request_ = internal::FromValue<::autofill_assistant::network::Request>::Parse(*request_value, errors);
  } else {
  ...
  if (auth_challenge_value) {
    errors->SetName("authChallenge");
    result->auth_challenge_ = internal::FromValue<::autofill_assistant::network::AuthChallenge>::Parse(*auth_challenge_value, errors);
  }
  ...
  if (response_error_reason_value) {
    ...
    result->response_error_reason_ = internal::FromValue<::autofill_assistant::network::ErrorReason>::Parse(*response_error_reason_value, errors);
  }
...
std::unique_ptr<RequestWillBeSentParams> RequestWillBeSentParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (initiator_value) {
    errors->SetName("initiator");
    result->initiator_ = internal::FromValue<::autofill_assistant::network::Initiator>::Parse(*initiator_value, errors);
  } else {
    errors->AddError("required property missing: initiator");
  }
  const base::Value* redirect_has_extra_info_value = value.FindKey("redirectHasExtraInfo");
  ...
  if (redirect_response_value) {
    ...
    result->redirect_response_ = internal::FromValue<::autofill_assistant::network::Response>::Parse(*redirect_response_value, errors);
  }
  const base::Value* type_value = value.FindKey("type");
  if (type_value) {
    errors->SetName("type");
...
std::unique_ptr<ResourceChangedPriorityParams> ResourceChangedPriorityParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (new_priority_value) {
    ...
    result->new_priority_ = internal::FromValue<::autofill_assistant::network::ResourcePriority>::Parse(*new_priority_value, errors);
  } else {
...
std::unique_ptr<SignedExchangeReceivedParams> SignedExchangeReceivedParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (info_value) {
    errors->SetName("info");
    result->info_ = internal::FromValue<::autofill_assistant::network::SignedExchangeInfo>::Parse(*info_value, errors);
  } else {
...
std::unique_ptr<ResponseReceivedParams> ResponseReceivedParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  const base::Value* has_extra_info_value = value.FindKey("hasExtraInfo");
...
std::unique_ptr<WebSocketFrameReceivedParams> WebSocketFrameReceivedParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (response_value) {
    errors->SetName("response");
    result->response_ = internal::FromValue<::autofill_assistant::network::WebSocketFrame>::Parse(*response_value, errors);
  } else {
    errors->AddError("required property missing: response");
  }
  errors->Pop();
...
std::unique_ptr<WebSocketHandshakeResponseReceivedParams> WebSocketHandshakeResponseReceivedParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (response_value) {
    errors->SetName("response");
    result->response_ = internal::FromValue<::autofill_assistant::network::WebSocketResponse>::Parse(*response_value, errors);
  } else {
    errors->AddError("required property missing: response");
  }
  errors->Pop();
...
std::unique_ptr<WebSocketWillSendHandshakeRequestParams> WebSocketWillSendHandshakeRequestParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (request_value) {
    errors->SetName("request");
    result->request_ = internal::FromValue<::autofill_assistant::network::WebSocketRequest>::Parse(*request_value, errors);
  } else {
    errors->AddError("required property missing: request");
  }
  errors->Pop();
...
std::unique_ptr<WebTransportCreatedParams> WebTransportCreatedParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  errors->Push();
  errors->SetName("WebTransportCreatedParams");
  const base::Value* transport_id_value = value.FindKey("transportId");
...
std::unique_ptr<base::Value> WebTransportCreatedParams::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
...
std::unique_ptr<base::Value> WebTransportConnectionEstablishedParams::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  result->Set("transportId", internal::ToValue(transport_id_));
  result->Set("timestamp", internal::ToValue(timestamp_));
  return std::move(result);
...
std::unique_ptr<base::Value> WebTransportClosedParams::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  result->Set("transportId", internal::ToValue(transport_id_));
  result->Set("timestamp", internal::ToValue(timestamp_));
  return std::move(result);
...
std::unique_ptr<RequestWillBeSentExtraInfoParams> RequestWillBeSentExtraInfoParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (associated_cookies_value) {
    ...
    result->associated_cookies_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::network::BlockedCookieWithReason>>>::Parse(*associated_cookies_value, errors);
  } else {
  ...
  const base::Value* connect_timing_value = value.FindKey("connectTiming");
  if (connect_timing_value) {
    errors->SetName("connectTiming");
    result->connect_timing_ = internal::FromValue<::autofill_assistant::network::ConnectTiming>::Parse(*connect_timing_value, errors);
  } else {
...
std::unique_ptr<ResponseReceivedExtraInfoParams> ResponseReceivedExtraInfoParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (blocked_cookies_value) {
    ...
    result->blocked_cookies_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::network::BlockedSetCookieWithReason>>>::Parse(*blocked_cookies_value, errors);
  } else {
  ...
  const base::Value* status_code_value = value.FindKey("statusCode");
...
std::unique_ptr<TrustTokenOperationDoneParams> TrustTokenOperationDoneParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (status_value) {
    errors->SetName("status");
    result->status_ = internal::FromValue<::autofill_assistant::network::TrustTokenOperationDoneStatus>::Parse(*status_value, errors);
  } else {
    errors->AddError("required property missing: status");
  }
  const base::Value* type_value = value.FindKey("type");
  ...
  const base::Value* top_level_origin_value = value.FindKey("topLevelOrigin");
  ...
  const base::Value* issued_token_count_value = value.FindKey("issuedTokenCount");
...
std::unique_ptr<base::Value> TrustTokenOperationDoneParams::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  result->Set("status", internal::ToValue(status_));
  result->Set("type", internal::ToValue(type_));
  result->Set("requestId", internal::ToValue(request_id_));
...
std::unique_ptr<base::Value> SubresourceWebBundleMetadataReceivedParams::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  result->Set("requestId", internal::ToValue(request_id_));
  result->Set("urls", internal::ToValue(urls_));
  return std::move(result);
...
std::unique_ptr<base::Value> SubresourceWebBundleMetadataErrorParams::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  result->Set("requestId", internal::ToValue(request_id_));
  result->Set("errorMessage", internal::ToValue(error_message_));
  return std::move(result);
...
std::unique_ptr<SubresourceWebBundleInnerResponseParsedParams> SubresourceWebBundleInnerResponseParsedParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  errors->Push();
  errors->SetName("SubresourceWebBundleInnerResponseParsedParams");
  const base::Value* inner_request_id_value = value.FindKey("innerRequestId");
  ...
  const base::Value* inner_requesturl_value = value.FindKey("innerRequestURL");
  ...
  const base::Value* bundle_request_id_value = value.FindKey("bundleRequestId");
...
std::unique_ptr<base::Value> SubresourceWebBundleInnerResponseParsedParams::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
...
std::unique_ptr<base::Value> SubresourceWebBundleInnerResponseErrorParams::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  result->Set("innerRequestId", internal::ToValue(inner_request_id_));
  result->Set("innerRequestURL", internal::ToValue(inner_requesturl_));
  result->Set("errorMessage", internal::ToValue(error_message_));
...
std::unique_ptr<ReportingApiReportAddedParams> ReportingApiReportAddedParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  errors->Push();
  errors->SetName("ReportingApiReportAddedParams");
  const base::Value* report_value = value.FindKey("report");
  if (report_value) {
    errors->SetName("report");
    result->report_ = internal::FromValue<::autofill_assistant::network::ReportingApiReport>::Parse(*report_value, errors);
  } else {
...
std::unique_ptr<base::Value> ReportingApiReportAddedParams::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
...
std::unique_ptr<base::Value> ReportingApiReportUpdatedParams::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  result->Set("report", internal::ToValue(*report_));
  return std::move(result);
}
...
std::unique_ptr<ReportingApiEndpointsChangedForOriginParams> ReportingApiEndpointsChangedForOriginParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  const base::Value* endpoints_value = value.FindKey("endpoints");
  if (endpoints_value) {
    errors->SetName("endpoints");
    result->endpoints_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::network::ReportingApiEndpoint>>>::Parse(*endpoints_value, errors);
  } else {
...
std::unique_ptr<base::Value> ReportingApiEndpointsChangedForOriginParams::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  result->Set("origin", internal::ToValue(origin_));
