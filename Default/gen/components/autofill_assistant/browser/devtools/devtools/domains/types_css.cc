...
#include "components/autofill_assistant/browser/devtools/devtools/internal/type_conversions_css.h"
...
std::unique_ptr<PseudoElementMatches> PseudoElementMatches::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (pseudo_type_value) {
    ...
    result->pseudo_type_ = internal::FromValue<::autofill_assistant::dom::PseudoType>::Parse(*pseudo_type_value, errors);
  } else {
    errors->AddError("required property missing: pseudoType");
  }
  const base::Value* pseudo_identifier_value = value.FindKey("pseudoIdentifier");
  ...
  if (matches_value) {
    ...
    result->matches_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::css::RuleMatch>>>::Parse(*matches_value, errors);
  } else {
...
std::unique_ptr<InheritedStyleEntry> InheritedStyleEntry::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (inline_style_value) {
    ...
    result->inline_style_ = internal::FromValue<::autofill_assistant::css::CSSStyle>::Parse(*inline_style_value, errors);
  }
  ...
  if (matchedcss_rules_value) {
    ...
    result->matchedcss_rules_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::css::RuleMatch>>>::Parse(*matchedcss_rules_value, errors);
  } else {
...
std::unique_ptr<InheritedPseudoElementMatches> InheritedPseudoElementMatches::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (pseudo_elements_value) {
    ...
    result->pseudo_elements_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::css::PseudoElementMatches>>>::Parse(*pseudo_elements_value, errors);
  } else {
...
std::unique_ptr<base::Value> InheritedPseudoElementMatches::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
...
std::unique_ptr<RuleMatch> RuleMatch::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (rule_value) {
    errors->SetName("rule");
    result->rule_ = internal::FromValue<::autofill_assistant::css::CSSRule>::Parse(*rule_value, errors);
  } else {
...
std::unique_ptr<Value> Value::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (range_value) {
    ...
    result->range_ = internal::FromValue<::autofill_assistant::css::SourceRange>::Parse(*range_value, errors);
  }
  errors->Pop();
  errors->Pop();
  if (errors->HasErrors())
...
std::unique_ptr<SelectorList> SelectorList::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (selectors_value) {
    ...
    result->selectors_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::css::Value>>>::Parse(*selectors_value, errors);
  } else {
...
std::unique_ptr<CSSStyleSheetHeader> CSSStyleSheetHeader::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (origin_value) {
    ...
    result->origin_ = internal::FromValue<::autofill_assistant::css::StyleSheetOrigin>::Parse(*origin_value, errors);
  } else {
  ...
  const base::Value* is_constructed_value = value.FindKey("isConstructed");
...
std::unique_ptr<CSSRule> CSSRule::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (selector_list_value) {
    errors->SetName("selectorList");
    result->selector_list_ = internal::FromValue<::autofill_assistant::css::SelectorList>::Parse(*selector_list_value, errors);
  } else {
  ...
  if (style_value) {
    ...
    result->style_ = internal::FromValue<::autofill_assistant::css::CSSStyle>::Parse(*style_value, errors);
  } else {
  ...
  if (media_value) {
    ...
    result->media_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::css::CSSMedia>>>::Parse(*media_value, errors);
  }
  const base::Value* container_queries_value = value.FindKey("containerQueries");
  if (container_queries_value) {
    errors->SetName("containerQueries");
    result->container_queries_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::css::CSSContainerQuery>>>::Parse(*container_queries_value, errors);
  }
  const base::Value* supports_value = value.FindKey("supports");
  if (supports_value) {
    errors->SetName("supports");
    result->supports_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::css::CSSSupports>>>::Parse(*supports_value, errors);
  }
  const base::Value* layers_value = value.FindKey("layers");
  if (layers_value) {
    errors->SetName("layers");
    result->layers_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::css::CSSLayer>>>::Parse(*layers_value, errors);
  }
  const base::Value* scopes_value = value.FindKey("scopes");
  if (scopes_value) {
    errors->SetName("scopes");
    result->scopes_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::css::CSSScope>>>::Parse(*scopes_value, errors);
  }
  errors->Pop();
  errors->Pop();
  if (errors->HasErrors())
...
std::unique_ptr<CSSStyle> CSSStyle::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (css_properties_value) {
    ...
    result->css_properties_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::css::CSSProperty>>>::Parse(*css_properties_value, errors);
  } else {
  ...
  if (shorthand_entries_value) {
    ...
    result->shorthand_entries_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::css::ShorthandEntry>>>::Parse(*shorthand_entries_value, errors);
  } else {
...
std::unique_ptr<CSSProperty> CSSProperty::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  const base::Value* longhand_properties_value = value.FindKey("longhandProperties");
  if (longhand_properties_value) {
    errors->SetName("longhandProperties");
    result->longhand_properties_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::css::CSSProperty>>>::Parse(*longhand_properties_value, errors);
  }
  errors->Pop();
  errors->Pop();
  if (errors->HasErrors())
...
std::unique_ptr<CSSMedia> CSSMedia::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (source_value) {
    ...
    result->source_ = internal::FromValue<::autofill_assistant::css::CSSMediaSource>::Parse(*source_value, errors);
  } else {
  ...
  if (media_list_value) {
    ...
    result->media_list_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::css::MediaQuery>>>::Parse(*media_list_value, errors);
  }
  errors->Pop();
  errors->Pop();
  if (errors->HasErrors())
...
std::unique_ptr<MediaQuery> MediaQuery::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (expressions_value) {
    ...
    result->expressions_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::css::MediaQueryExpression>>>::Parse(*expressions_value, errors);
  } else {
...
std::unique_ptr<MediaQueryExpression> MediaQueryExpression::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (value_range_value) {
    ...
    result->value_range_ = internal::FromValue<::autofill_assistant::css::SourceRange>::Parse(*value_range_value, errors);
  }
...
std::unique_ptr<base::Value> CSSContainerQuery::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  result->Set("text", internal::ToValue(text_));
  if (range_)
    result->Set("range", internal::ToValue(*range_.value()));
...
std::unique_ptr<base::Value> CSSSupports::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  result->Set("text", internal::ToValue(text_));
  result->Set("active", internal::ToValue(active_));
  if (range_)
...
std::unique_ptr<base::Value> CSSScope::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  result->Set("text", internal::ToValue(text_));
  if (range_)
    result->Set("range", internal::ToValue(*range_.value()));
...
std::unique_ptr<base::Value> CSSLayer::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  result->Set("text", internal::ToValue(text_));
  if (range_)
    result->Set("range", internal::ToValue(*range_.value()));
...
std::unique_ptr<CSSLayerData> CSSLayerData::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  const base::Value* sub_layers_value = value.FindKey("subLayers");
  if (sub_layers_value) {
    errors->SetName("subLayers");
    result->sub_layers_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::css::CSSLayerData>>>::Parse(*sub_layers_value, errors);
  }
  const base::Value* order_value = value.FindKey("order");
  if (order_value) {
...
std::unique_ptr<base::Value> CSSLayerData::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  result->Set("name", internal::ToValue(name_));
  if (sub_layers_)
...
std::unique_ptr<base::Value> FontVariationAxis::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
...
std::unique_ptr<FontFace> FontFace::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  const base::Value* font_display_value = value.FindKey("fontDisplay");
  ...
  const base::Value* font_variation_axes_value = value.FindKey("fontVariationAxes");
  if (font_variation_axes_value) {
    errors->SetName("fontVariationAxes");
    result->font_variation_axes_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::css::FontVariationAxis>>>::Parse(*font_variation_axes_value, errors);
  }
  errors->Pop();
  errors->Pop();
  if (errors->HasErrors())
...
std::unique_ptr<CSSKeyframesRule> CSSKeyframesRule::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (animation_name_value) {
    ...
    result->animation_name_ = internal::FromValue<::autofill_assistant::css::Value>::Parse(*animation_name_value, errors);
  } else {
  ...
  if (keyframes_value) {
    ...
    result->keyframes_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::css::CSSKeyframeRule>>>::Parse(*keyframes_value, errors);
  } else {
...
std::unique_ptr<CSSKeyframeRule> CSSKeyframeRule::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (key_text_value) {
    ...
    result->key_text_ = internal::FromValue<::autofill_assistant::css::Value>::Parse(*key_text_value, errors);
  } else {
...
std::unique_ptr<AddRuleParams> AddRuleParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (location_value) {
    ...
    result->location_ = internal::FromValue<::autofill_assistant::css::SourceRange>::Parse(*location_value, errors);
  } else {
...
std::unique_ptr<GetComputedStyleForNodeResult> GetComputedStyleForNodeResult::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (computed_style_value) {
    ...
    result->computed_style_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::css::CSSComputedStyleProperty>>>::Parse(*computed_style_value, errors);
  } else {
...
std::unique_ptr<GetInlineStylesForNodeResult> GetInlineStylesForNodeResult::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (attributes_style_value) {
    ...
    result->attributes_style_ = internal::FromValue<::autofill_assistant::css::CSSStyle>::Parse(*attributes_style_value, errors);
  }
  errors->Pop();
  errors->Pop();
  if (errors->HasErrors())
...
std::unique_ptr<GetMatchedStylesForNodeResult> GetMatchedStylesForNodeResult::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (inherited_value) {
    ...
    result->inherited_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::css::InheritedStyleEntry>>>::Parse(*inherited_value, errors);
  }
  const base::Value* inherited_pseudo_elements_value = value.FindKey("inheritedPseudoElements");
  if (inherited_pseudo_elements_value) {
    errors->SetName("inheritedPseudoElements");
    result->inherited_pseudo_elements_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::css::InheritedPseudoElementMatches>>>::Parse(*inherited_pseudo_elements_value, errors);
  }
  ...
  if (css_keyframes_rules_value) {
    ...
    result->css_keyframes_rules_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::css::CSSKeyframesRule>>>::Parse(*css_keyframes_rules_value, errors);
  }
  const base::Value* parent_layout_node_id_value = value.FindKey("parentLayoutNodeId");
...
std::unique_ptr<GetMediaQueriesResult> GetMediaQueriesResult::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (medias_value) {
    ...
    result->medias_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::css::CSSMedia>>>::Parse(*medias_value, errors);
  } else {
...
std::unique_ptr<GetPlatformFontsForNodeResult> GetPlatformFontsForNodeResult::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (fonts_value) {
    ...
    result->fonts_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::css::PlatformFontUsage>>>::Parse(*fonts_value, errors);
  } else {
...
std::unique_ptr<base::Value> GetLayersForNodeParams::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  result->Set("nodeId", internal::ToValue(node_id_));
  return std::move(result);
}
...
std::unique_ptr<GetLayersForNodeResult> GetLayersForNodeResult::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  errors->Push();
  errors->SetName("GetLayersForNodeResult");
  const base::Value* root_layer_value = value.FindKey("rootLayer");
  if (root_layer_value) {
    errors->SetName("rootLayer");
    result->root_layer_ = internal::FromValue<::autofill_assistant::css::CSSLayerData>::Parse(*root_layer_value, errors);
  } else {
...
std::unique_ptr<base::Value> GetLayersForNodeResult::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
...
std::unique_ptr<TrackComputedStyleUpdatesParams> TrackComputedStyleUpdatesParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  errors->Push();
  errors->SetName("TrackComputedStyleUpdatesParams");
  const base::Value* properties_to_track_value = value.FindKey("propertiesToTrack");
  if (properties_to_track_value) {
    errors->SetName("propertiesToTrack");
    result->properties_to_track_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::css::CSSComputedStyleProperty>>>::Parse(*properties_to_track_value, errors);
  } else {
...
std::unique_ptr<base::Value> TrackComputedStyleUpdatesParams::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
...
std::unique_ptr<base::Value> TrackComputedStyleUpdatesResult::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  return std::move(result);
}
...
std::unique_ptr<base::Value> TakeComputedStyleUpdatesParams::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  return std::move(result);
}
...
std::unique_ptr<base::Value> TakeComputedStyleUpdatesResult::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
...
std::unique_ptr<SetMediaTextResult> SetMediaTextResult::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (media_value) {
    errors->SetName("media");
    result->media_ = internal::FromValue<::autofill_assistant::css::CSSMedia>::Parse(*media_value, errors);
  } else {
...
std::unique_ptr<base::Value> SetContainerQueryTextParams::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  result->Set("styleSheetId", internal::ToValue(style_sheet_id_));
  result->Set("range", internal::ToValue(*range_));
  result->Set("text", internal::ToValue(text_));
...
std::unique_ptr<SetContainerQueryTextResult> SetContainerQueryTextResult::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  errors->Push();
  errors->SetName("SetContainerQueryTextResult");
  const base::Value* container_query_value = value.FindKey("containerQuery");
  if (container_query_value) {
    errors->SetName("containerQuery");
    result->container_query_ = internal::FromValue<::autofill_assistant::css::CSSContainerQuery>::Parse(*container_query_value, errors);
  } else {
...
std::unique_ptr<base::Value> SetContainerQueryTextResult::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
...
std::unique_ptr<base::Value> SetSupportsTextParams::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  result->Set("styleSheetId", internal::ToValue(style_sheet_id_));
  result->Set("range", internal::ToValue(*range_));
  result->Set("text", internal::ToValue(text_));
...
std::unique_ptr<SetSupportsTextResult> SetSupportsTextResult::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (supports_value) {
    errors->SetName("supports");
    result->supports_ = internal::FromValue<::autofill_assistant::css::CSSSupports>::Parse(*supports_value, errors);
  } else {
...
std::unique_ptr<base::Value> SetSupportsTextResult::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
...
std::unique_ptr<base::Value> SetScopeTextParams::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  result->Set("styleSheetId", internal::ToValue(style_sheet_id_));
  result->Set("range", internal::ToValue(*range_));
  result->Set("text", internal::ToValue(text_));
...
std::unique_ptr<SetScopeTextResult> SetScopeTextResult::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (scope_value) {
    ...
    result->scope_ = internal::FromValue<::autofill_assistant::css::CSSScope>::Parse(*scope_value, errors);
  } else {
...
std::unique_ptr<base::Value> SetScopeTextResult::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
...
std::unique_ptr<SetStyleTextsParams> SetStyleTextsParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (edits_value) {
    ...
    result->edits_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::css::StyleDeclarationEdit>>>::Parse(*edits_value, errors);
  } else {
...
std::unique_ptr<SetStyleTextsResult> SetStyleTextsResult::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (styles_value) {
    ...
    result->styles_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::css::CSSStyle>>>::Parse(*styles_value, errors);
  } else {
...
std::unique_ptr<StopRuleUsageTrackingResult> StopRuleUsageTrackingResult::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (rule_usage_value) {
    errors->SetName("ruleUsage");
    result->rule_usage_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::css::RuleUsage>>>::Parse(*rule_usage_value, errors);
  } else {
...
std::unique_ptr<TakeCoverageDeltaResult> TakeCoverageDeltaResult::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (coverage_value) {
    ...
    result->coverage_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::css::RuleUsage>>>::Parse(*coverage_value, errors);
  } else {
...
std::unique_ptr<base::Value> SetLocalFontsEnabledParams::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
...
std::unique_ptr<base::Value> SetLocalFontsEnabledResult::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  return std::move(result);
}
...
std::unique_ptr<FontsUpdatedParams> FontsUpdatedParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (font_value) {
    errors->SetName("font");
    result->font_ = internal::FromValue<::autofill_assistant::css::FontFace>::Parse(*font_value, errors);
  }
  errors->Pop();
  errors->Pop();
  if (errors->HasErrors())
...
std::unique_ptr<StyleSheetAddedParams> StyleSheetAddedParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (header_value) {
    ...
    result->header_ = internal::FromValue<::autofill_assistant::css::CSSStyleSheetHeader>::Parse(*header_value, errors);
  } else {
