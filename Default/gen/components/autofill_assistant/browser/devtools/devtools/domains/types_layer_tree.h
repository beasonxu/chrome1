...
#ifndef COMPONENTS_AUTOFILL_ASSISTANT_BROWSER_DEVTOOLS_DEVTOOLS_DOMAINS_TYPES_LAYER_TREE_H_
#define COMPONENTS_AUTOFILL_ASSISTANT_BROWSER_DEVTOOLS_DEVTOOLS_DOMAINS_TYPES_LAYER_TREE_H_
...
#include "components/autofill_assistant/browser/devtools/devtools/internal/types_forward_declarations_layer_tree.h"
...
class ScrollRect {
 public:
  ...
  ScrollRect(const ScrollRect&) = delete;
  ScrollRect& operator=(const ScrollRect&) = delete;
  ~ScrollRect() { }
  ...
  ::autofill_assistant::layer_tree::ScrollRectType GetType() const { return type_; }
  void SetType(::autofill_assistant::layer_tree::ScrollRectType value) { type_ = value; }
  ...
  public:
    ...
    ScrollRectBuilder<STATE | kRectSet>& SetRect(std::unique_ptr<::autofill_assistant::dom::Rect> value) {
    ...
    ScrollRectBuilder<STATE | kTypeSet>& SetType(::autofill_assistant::layer_tree::ScrollRectType value) {
 ...
 private:
  ...
  ::autofill_assistant::layer_tree::ScrollRectType type_;
};
...
class StickyPositionConstraint {
 public:
  ...
  StickyPositionConstraint(const StickyPositionConstraint&) = delete;
  StickyPositionConstraint& operator=(const StickyPositionConstraint&) = delete;
  ~StickyPositionConstraint() { }

  // Layout rectangle of the sticky element before being shifted
  const ::autofill_assistant::dom::Rect* GetStickyBoxRect() const { return sticky_box_rect_.get(); }
  void SetStickyBoxRect(std::unique_ptr<::autofill_assistant::dom::Rect> value) { sticky_box_rect_ = std::move(value); }

  // Layout rectangle of the containing block of the sticky element
  const ::autofill_assistant::dom::Rect* GetContainingBlockRect() const { return containing_block_rect_.get(); }
  void SetContainingBlockRect(std::unique_ptr<::autofill_assistant::dom::Rect> value) { containing_block_rect_ = std::move(value); }
  ...
  public:
    ...
    StickyPositionConstraintBuilder<STATE | kStickyBoxRectSet>& SetStickyBoxRect(std::unique_ptr<::autofill_assistant::dom::Rect> value) {
    ...
    StickyPositionConstraintBuilder<STATE | kContainingBlockRectSet>& SetContainingBlockRect(std::unique_ptr<::autofill_assistant::dom::Rect> value) {
 ...
 private:
  ...
  std::unique_ptr<::autofill_assistant::dom::Rect> sticky_box_rect_;
  std::unique_ptr<::autofill_assistant::dom::Rect> containing_block_rect_;
  absl::optional<std::string> nearest_layer_shifting_sticky_box_;
  absl::optional<std::string> nearest_layer_shifting_containing_block_;
};
...
class PictureTile {
 public:
  ...
  PictureTile(const PictureTile&) = delete;
  PictureTile& operator=(const PictureTile&) = delete;
  ~PictureTile() { }
...
class Layer {
 public:
  ...
  const std::vector<std::unique_ptr<::autofill_assistant::layer_tree::ScrollRect>>* GetScrollRects() const { DCHECK(HasScrollRects()); return &scroll_rects_.value(); }
  void SetScrollRects(std::vector<std::unique_ptr<::autofill_assistant::layer_tree::ScrollRect>> value) { scroll_rects_ = std::move(value); }

  // Sticky position constraint information
  bool HasStickyPositionConstraint() const { return !!sticky_position_constraint_; }
  const ::autofill_assistant::layer_tree::StickyPositionConstraint* GetStickyPositionConstraint() const { DCHECK(HasStickyPositionConstraint()); return sticky_position_constraint_.value().get(); }
  void SetStickyPositionConstraint(std::unique_ptr<::autofill_assistant::layer_tree::StickyPositionConstraint> value) { sticky_position_constraint_ = std::move(value); }
  ...
  public:
    ...
    LayerBuilder<STATE>& SetScrollRects(std::vector<std::unique_ptr<::autofill_assistant::layer_tree::ScrollRect>> value) {
      result_->SetScrollRects(std::move(value));
      return *this;
    }

    LayerBuilder<STATE>& SetStickyPositionConstraint(std::unique_ptr<::autofill_assistant::layer_tree::StickyPositionConstraint> value) {
 ...
 private:
  ...
  absl::optional<std::string> parent_layer_id_;
  absl::optional<int> backend_node_id_;
  double offsetx_;
  double offsety_;
  double width_;
  double height_;
  absl::optional<std::vector<double>> transform_;
  absl::optional<double> anchorx_;
  absl::optional<double> anchory_;
  absl::optional<double> anchorz_;
  int paint_count_;
  bool draws_content_;
  absl::optional<bool> invisible_;
  absl::optional<std::vector<std::unique_ptr<::autofill_assistant::layer_tree::ScrollRect>>> scroll_rects_;
  absl::optional<std::unique_ptr<::autofill_assistant::layer_tree::StickyPositionConstraint>> sticky_position_constraint_;
};
...
class CompositingReasonsParams {
 public:
  ...
  CompositingReasonsParams(const CompositingReasonsParams&) = delete;
  CompositingReasonsParams& operator=(const CompositingReasonsParams&) = delete;
...
class CompositingReasonsResult {
 public:
  ...
  CompositingReasonsResult(const CompositingReasonsResult&) = delete;
  CompositingReasonsResult& operator=(const CompositingReasonsResult&) = delete;
...
class LoadSnapshotParams {
 public:
  ...
  LoadSnapshotParams(const LoadSnapshotParams&) = delete;
  LoadSnapshotParams& operator=(const LoadSnapshotParams&) = delete;
  ~LoadSnapshotParams() { }

  // An array of tiles composing the snapshot.
  const std::vector<std::unique_ptr<::autofill_assistant::layer_tree::PictureTile>>* GetTiles() const { return &tiles_; }
  void SetTiles(std::vector<std::unique_ptr<::autofill_assistant::layer_tree::PictureTile>> value) { tiles_ = std::move(value); }
  ...
  public:
    ...
    LoadSnapshotParamsBuilder<STATE | kTilesSet>& SetTiles(std::vector<std::unique_ptr<::autofill_assistant::layer_tree::PictureTile>> value) {
 ...
 private:
  ...
  std::vector<std::unique_ptr<::autofill_assistant::layer_tree::PictureTile>> tiles_;
};
...
class LoadSnapshotResult {
 public:
  ...
  LoadSnapshotResult(const LoadSnapshotResult&) = delete;
  LoadSnapshotResult& operator=(const LoadSnapshotResult&) = delete;
  ~LoadSnapshotResult() { }
...
class MakeSnapshotParams {
 public:
  ...
  MakeSnapshotParams(const MakeSnapshotParams&) = delete;
  MakeSnapshotParams& operator=(const MakeSnapshotParams&) = delete;
  ~MakeSnapshotParams() { }
...
class MakeSnapshotResult {
 public:
  ...
  MakeSnapshotResult(const MakeSnapshotResult&) = delete;
  MakeSnapshotResult& operator=(const MakeSnapshotResult&) = delete;
  ~MakeSnapshotResult() { }
...
class ProfileSnapshotParams {
 public:
  ...
  ProfileSnapshotParams(const ProfileSnapshotParams&) = delete;
  ProfileSnapshotParams& operator=(const ProfileSnapshotParams&) = delete;
  ...
  const ::autofill_assistant::dom::Rect* GetClipRect() const { DCHECK(HasClipRect()); return clip_rect_.value().get(); }
  void SetClipRect(std::unique_ptr<::autofill_assistant::dom::Rect> value) { clip_rect_ = std::move(value); }
  ...
  public:
    ...
    ProfileSnapshotParamsBuilder<STATE>& SetClipRect(std::unique_ptr<::autofill_assistant::dom::Rect> value) {
 ...
 private:
  ...
  std::string snapshot_id_;
  absl::optional<int> min_repeat_count_;
  absl::optional<double> min_duration_;
  absl::optional<std::unique_ptr<::autofill_assistant::dom::Rect>> clip_rect_;
};
...
class ProfileSnapshotResult {
 public:
  ...
  ProfileSnapshotResult(const ProfileSnapshotResult&) = delete;
  ProfileSnapshotResult& operator=(const ProfileSnapshotResult&) = delete;
...
class ReleaseSnapshotParams {
 public:
  ...
  ReleaseSnapshotParams(const ReleaseSnapshotParams&) = delete;
  ReleaseSnapshotParams& operator=(const ReleaseSnapshotParams&) = delete;
...
class ReleaseSnapshotResult {
 public:
  ...
  ReleaseSnapshotResult(const ReleaseSnapshotResult&) = delete;
  ReleaseSnapshotResult& operator=(const ReleaseSnapshotResult&) = delete;
...
class ReplaySnapshotParams {
 public:
  ...
  ReplaySnapshotParams(const ReplaySnapshotParams&) = delete;
  ReplaySnapshotParams& operator=(const ReplaySnapshotParams&) = delete;
 ...
 private:
  ...
  std::string snapshot_id_;
  absl::optional<int> from_step_;
  absl::optional<int> to_step_;
...
class ReplaySnapshotResult {
 public:
  ...
  ReplaySnapshotResult(const ReplaySnapshotResult&) = delete;
  ReplaySnapshotResult& operator=(const ReplaySnapshotResult&) = delete;
...
class SnapshotCommandLogParams {
 public:
  ...
  SnapshotCommandLogParams(const SnapshotCommandLogParams&) = delete;
  SnapshotCommandLogParams& operator=(const SnapshotCommandLogParams&) = delete;
...
class SnapshotCommandLogResult {
 public:
  ...
  SnapshotCommandLogResult(const SnapshotCommandLogResult&) = delete;
  SnapshotCommandLogResult& operator=(const SnapshotCommandLogResult&) = delete;
...
class LayerPaintedParams {
 public:
  ...
  LayerPaintedParams(const LayerPaintedParams&) = delete;
  LayerPaintedParams& operator=(const LayerPaintedParams&) = delete;
  ~LayerPaintedParams() { }
  ...
  // Clip rectangle.
  const ::autofill_assistant::dom::Rect* GetClip() const { return clip_.get(); }
  void SetClip(std::unique_ptr<::autofill_assistant::dom::Rect> value) { clip_ = std::move(value); }
  ...
  public:
    ...
    LayerPaintedParamsBuilder<STATE | kClipSet>& SetClip(std::unique_ptr<::autofill_assistant::dom::Rect> value) {
 ...
 private:
  ...
  std::string layer_id_;
  std::unique_ptr<::autofill_assistant::dom::Rect> clip_;
};
...
class LayerTreeDidChangeParams {
 public:
  ...
  LayerTreeDidChangeParams(const LayerTreeDidChangeParams&) = delete;
  LayerTreeDidChangeParams& operator=(const LayerTreeDidChangeParams&) = delete;
  ~LayerTreeDidChangeParams() { }

  // Layer tree, absent if not in the comspositing mode.
  bool HasLayers() const { return !!layers_; }
  const std::vector<std::unique_ptr<::autofill_assistant::layer_tree::Layer>>* GetLayers() const { DCHECK(HasLayers()); return &layers_.value(); }
  void SetLayers(std::vector<std::unique_ptr<::autofill_assistant::layer_tree::Layer>> value) { layers_ = std::move(value); }
  ...
  public:
    ...
    LayerTreeDidChangeParamsBuilder<STATE>& SetLayers(std::vector<std::unique_ptr<::autofill_assistant::layer_tree::Layer>> value) {
 ...
 private:
  ...
  absl::optional<std::vector<std::unique_ptr<::autofill_assistant::layer_tree::Layer>>> layers_;
};
...
#endif  // COMPONENTS_AUTOFILL_ASSISTANT_BROWSER_DEVTOOLS_DEVTOOLS_DOMAINS_TYPES_LAYER_TREE_H_
