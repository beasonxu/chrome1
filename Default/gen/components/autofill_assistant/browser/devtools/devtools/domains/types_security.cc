...
std::unique_ptr<SafetyTipInfo> SafetyTipInfo::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (safety_tip_status_value) {
    ...
    result->safety_tip_status_ = internal::FromValue<::autofill_assistant::security::SafetyTipStatus>::Parse(*safety_tip_status_value, errors);
  } else {
...
std::unique_ptr<VisibleSecurityState> VisibleSecurityState::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (certificate_security_state_value) {
    errors->SetName("certificateSecurityState");
    result->certificate_security_state_ = internal::FromValue<::autofill_assistant::security::CertificateSecurityState>::Parse(*certificate_security_state_value, errors);
  }
  const base::Value* safety_tip_info_value = value.FindKey("safetyTipInfo");
  if (safety_tip_info_value) {
    errors->SetName("safetyTipInfo");
    result->safety_tip_info_ = internal::FromValue<::autofill_assistant::security::SafetyTipInfo>::Parse(*safety_tip_info_value, errors);
  }
...
std::unique_ptr<InsecureContentStatus> InsecureContentStatus::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (ran_insecure_content_style_value) {
    ...
    result->ran_insecure_content_style_ = internal::FromValue<::autofill_assistant::security::SecurityState>::Parse(*ran_insecure_content_style_value, errors);
  } else {
  ...
  if (displayed_insecure_content_style_value) {
    ...
    result->displayed_insecure_content_style_ = internal::FromValue<::autofill_assistant::security::SecurityState>::Parse(*displayed_insecure_content_style_value, errors);
  } else {
...
std::unique_ptr<HandleCertificateErrorParams> HandleCertificateErrorParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (action_value) {
    ...
    result->action_ = internal::FromValue<::autofill_assistant::security::CertificateErrorAction>::Parse(*action_value, errors);
  } else {
...
std::unique_ptr<VisibleSecurityStateChangedParams> VisibleSecurityStateChangedParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (visible_security_state_value) {
    errors->SetName("visibleSecurityState");
    result->visible_security_state_ = internal::FromValue<::autofill_assistant::security::VisibleSecurityState>::Parse(*visible_security_state_value, errors);
  } else {
...
std::unique_ptr<SecurityStateChangedParams> SecurityStateChangedParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (explanations_value) {
    ...
    result->explanations_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::security::SecurityStateExplanation>>>::Parse(*explanations_value, errors);
  } else {
  ...
  if (insecure_content_status_value) {
    errors->SetName("insecureContentStatus");
    result->insecure_content_status_ = internal::FromValue<::autofill_assistant::security::InsecureContentStatus>::Parse(*insecure_content_status_value, errors);
  } else {
