...
#include "components/autofill_assistant/browser/devtools/devtools/internal/type_conversions_layer_tree.h"
...
std::unique_ptr<ScrollRect> ScrollRect::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (type_value) {
    errors->SetName("type");
    result->type_ = internal::FromValue<::autofill_assistant::layer_tree::ScrollRectType>::Parse(*type_value, errors);
  } else {
...
std::unique_ptr<StickyPositionConstraint> StickyPositionConstraint::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (sticky_box_rect_value) {
    ...
    result->sticky_box_rect_ = internal::FromValue<::autofill_assistant::dom::Rect>::Parse(*sticky_box_rect_value, errors);
  } else {
  ...
  if (containing_block_rect_value) {
    ...
    result->containing_block_rect_ = internal::FromValue<::autofill_assistant::dom::Rect>::Parse(*containing_block_rect_value, errors);
  } else {
...
std::unique_ptr<Layer> Layer::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (scroll_rects_value) {
    ...
    result->scroll_rects_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::layer_tree::ScrollRect>>>::Parse(*scroll_rects_value, errors);
  }
  ...
  if (sticky_position_constraint_value) {
    errors->SetName("stickyPositionConstraint");
    result->sticky_position_constraint_ = internal::FromValue<::autofill_assistant::layer_tree::StickyPositionConstraint>::Parse(*sticky_position_constraint_value, errors);
  }
  errors->Pop();
  errors->Pop();
  if (errors->HasErrors())
...
std::unique_ptr<LoadSnapshotParams> LoadSnapshotParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (tiles_value) {
    ...
    result->tiles_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::layer_tree::PictureTile>>>::Parse(*tiles_value, errors);
  } else {
...
std::unique_ptr<ProfileSnapshotParams> ProfileSnapshotParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (clip_rect_value) {
    ...
    result->clip_rect_ = internal::FromValue<::autofill_assistant::dom::Rect>::Parse(*clip_rect_value, errors);
  }
  errors->Pop();
  errors->Pop();
  if (errors->HasErrors())
...
std::unique_ptr<LayerPaintedParams> LayerPaintedParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (clip_value) {
    errors->SetName("clip");
    result->clip_ = internal::FromValue<::autofill_assistant::dom::Rect>::Parse(*clip_value, errors);
  } else {
...
std::unique_ptr<LayerTreeDidChangeParams> LayerTreeDidChangeParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (layers_value) {
    ...
    result->layers_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::layer_tree::Layer>>>::Parse(*layers_value, errors);
  }
  errors->Pop();
  errors->Pop();
  if (errors->HasErrors())
