...
#include "components/autofill_assistant/browser/devtools/devtools/internal/type_conversions_web_authn.h"
...
std::unique_ptr<VirtualAuthenticatorOptions> VirtualAuthenticatorOptions::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (protocol_value) {
    ...
    result->protocol_ = internal::FromValue<::autofill_assistant::web_authn::AuthenticatorProtocol>::Parse(*protocol_value, errors);
  } else {
    errors->AddError("required property missing: protocol");
  }
  const base::Value* ctap2_version_value = value.FindKey("ctap2Version");
  if (ctap2_version_value) {
    errors->SetName("ctap2Version");
    result->ctap2_version_ = internal::FromValue<::autofill_assistant::web_authn::Ctap2Version>::Parse(*ctap2_version_value, errors);
  }
  const base::Value* transport_value = value.FindKey("transport");
  if (transport_value) {
    errors->SetName("transport");
    result->transport_ = internal::FromValue<::autofill_assistant::web_authn::AuthenticatorTransport>::Parse(*transport_value, errors);
  } else {
  ...
  const base::Value* has_large_blob_value = value.FindKey("hasLargeBlob");
  if (has_large_blob_value) {
    errors->SetName("hasLargeBlob");
    result->has_large_blob_ = internal::FromValue<bool>::Parse(*has_large_blob_value, errors);
  }
  const base::Value* has_cred_blob_value = value.FindKey("hasCredBlob");
  if (has_cred_blob_value) {
    errors->SetName("hasCredBlob");
    result->has_cred_blob_ = internal::FromValue<bool>::Parse(*has_cred_blob_value, errors);
  }
  const base::Value* has_min_pin_length_value = value.FindKey("hasMinPinLength");
  if (has_min_pin_length_value) {
    errors->SetName("hasMinPinLength");
    result->has_min_pin_length_ = internal::FromValue<bool>::Parse(*has_min_pin_length_value, errors);
  }
...
std::unique_ptr<base::Value> VirtualAuthenticatorOptions::Serialize() const {
  ...
  if (ctap2_version_)
    result->Set("ctap2Version", internal::ToValue(ctap2_version_.value()));
  ...
  if (has_large_blob_)
    result->Set("hasLargeBlob", internal::ToValue(has_large_blob_.value()));
  if (has_cred_blob_)
    result->Set("hasCredBlob", internal::ToValue(has_cred_blob_.value()));
  if (has_min_pin_length_)
    result->Set("hasMinPinLength", internal::ToValue(has_min_pin_length_.value()));
...
std::unique_ptr<Credential> Credential::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (credential_id_value) {
    ...
    result->credential_id_ = internal::FromValue<std::string>::Parse(*credential_id_value, errors);
  } else {
  ...
  if (private_key_value) {
    ...
    result->private_key_ = internal::FromValue<std::string>::Parse(*private_key_value, errors);
  } else {
  ...
  if (user_handle_value) {
    ...
    result->user_handle_ = internal::FromValue<std::string>::Parse(*user_handle_value, errors);
  }
  ...
  const base::Value* large_blob_value = value.FindKey("largeBlob");
  if (large_blob_value) {
    errors->SetName("largeBlob");
    result->large_blob_ = internal::FromValue<std::string>::Parse(*large_blob_value, errors);
  }
  errors->Pop();
  errors->Pop();
  if (errors->HasErrors())
...
std::unique_ptr<base::Value> Credential::Serialize() const {
  ...
  if (large_blob_)
    result->Set("largeBlob", internal::ToValue(large_blob_.value()));
  return std::move(result);
}
...
std::unique_ptr<EnableParams> EnableParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  errors->Push();
  errors->SetName("EnableParams");
  const base::Value* enableui_value = value.FindKey("enableUI");
  if (enableui_value) {
    errors->SetName("enableUI");
    result->enableui_ = internal::FromValue<bool>::Parse(*enableui_value, errors);
  }
  errors->Pop();
  errors->Pop();
  if (errors->HasErrors())
...
std::unique_ptr<base::Value> EnableParams::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  if (enableui_)
    result->Set("enableUI", internal::ToValue(enableui_.value()));
  return std::move(result);
}
...
std::unique_ptr<AddVirtualAuthenticatorParams> AddVirtualAuthenticatorParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (options_value) {
    ...
    result->options_ = internal::FromValue<::autofill_assistant::web_authn::VirtualAuthenticatorOptions>::Parse(*options_value, errors);
  } else {
...
std::unique_ptr<AddCredentialParams> AddCredentialParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (credential_value) {
    errors->SetName("credential");
    result->credential_ = internal::FromValue<::autofill_assistant::web_authn::Credential>::Parse(*credential_value, errors);
  } else {
...
std::unique_ptr<GetCredentialsResult> GetCredentialsResult::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (credentials_value) {
    ...
    result->credentials_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::web_authn::Credential>>>::Parse(*credentials_value, errors);
  } else {
...
std::unique_ptr<SetAutomaticPresenceSimulationParams> SetAutomaticPresenceSimulationParams::Parse(const base::Value& value, ErrorReporter* errors) {
  errors->Push();
  errors->SetName("SetAutomaticPresenceSimulationParams");
  if (!value.is_dict()) {
    errors->AddError("object expected");
    errors->Pop();
    return nullptr;
  ...
  std::unique_ptr<SetAutomaticPresenceSimulationParams> result(new SetAutomaticPresenceSimulationParams());
  errors->Push();
  errors->SetName("SetAutomaticPresenceSimulationParams");
  const base::Value* authenticator_id_value = value.FindKey("authenticatorId");
  if (authenticator_id_value) {
...
std::unique_ptr<base::Value> SetAutomaticPresenceSimulationParams::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  result->Set("authenticatorId", internal::ToValue(authenticator_id_));
...
std::unique_ptr<SetAutomaticPresenceSimulationParams> SetAutomaticPresenceSimulationParams::Clone() const {
  ErrorReporter errors;
  std::unique_ptr<SetAutomaticPresenceSimulationParams> result = Parse(*Serialize(), &errors);
  DCHECK(!errors.HasErrors());
  return result;
}


std::unique_ptr<SetAutomaticPresenceSimulationResult> SetAutomaticPresenceSimulationResult::Parse(const base::Value& value, ErrorReporter* errors) {
  errors->Push();
  errors->SetName("SetAutomaticPresenceSimulationResult");
  if (!value.is_dict()) {
    errors->AddError("object expected");
    errors->Pop();
    return nullptr;
  ...
  std::unique_ptr<SetAutomaticPresenceSimulationResult> result(new SetAutomaticPresenceSimulationResult());
  errors->Push();
  errors->SetName("SetAutomaticPresenceSimulationResult");
  errors->Pop();
  errors->Pop();
...
std::unique_ptr<base::Value> SetAutomaticPresenceSimulationResult::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  return std::move(result);
}

std::unique_ptr<SetAutomaticPresenceSimulationResult> SetAutomaticPresenceSimulationResult::Clone() const {
  ErrorReporter errors;
  std::unique_ptr<SetAutomaticPresenceSimulationResult> result = Parse(*Serialize(), &errors);
  DCHECK(!errors.HasErrors());
  return result;
}
