...
std::unique_ptr<Bounds> Bounds::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (window_state_value) {
    ...
    result->window_state_ = internal::FromValue<::autofill_assistant::browser::WindowState>::Parse(*window_state_value, errors);
  }
  errors->Pop();
  errors->Pop();
  if (errors->HasErrors())
...
std::unique_ptr<PermissionDescriptor> PermissionDescriptor::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  const base::Value* pan_tilt_zoom_value = value.FindKey("panTiltZoom");
  if (pan_tilt_zoom_value) {
    errors->SetName("panTiltZoom");
    result->pan_tilt_zoom_ = internal::FromValue<bool>::Parse(*pan_tilt_zoom_value, errors);
  }
  errors->Pop();
  errors->Pop();
  if (errors->HasErrors())
...
std::unique_ptr<base::Value> PermissionDescriptor::Serialize() const {
  ...
  if (pan_tilt_zoom_)
    result->Set("panTiltZoom", internal::ToValue(pan_tilt_zoom_.value()));
  return std::move(result);
}
...
std::unique_ptr<Histogram> Histogram::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (buckets_value) {
    ...
    result->buckets_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::browser::Bucket>>>::Parse(*buckets_value, errors);
  } else {
...
std::unique_ptr<SetPermissionParams> SetPermissionParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (permission_value) {
    ...
    result->permission_ = internal::FromValue<::autofill_assistant::browser::PermissionDescriptor>::Parse(*permission_value, errors);
  } else {
  ...
  if (setting_value) {
    ...
    result->setting_ = internal::FromValue<::autofill_assistant::browser::PermissionSetting>::Parse(*setting_value, errors);
  } else {
...
std::unique_ptr<GrantPermissionsParams> GrantPermissionsParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (permissions_value) {
    ...
    result->permissions_ = internal::FromValue<std::vector<::autofill_assistant::browser::PermissionType>>::Parse(*permissions_value, errors);
  } else {
...
std::unique_ptr<SetDownloadBehaviorParams> SetDownloadBehaviorParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (behavior_value) {
    ...
    result->behavior_ = internal::FromValue<::autofill_assistant::browser::SetDownloadBehaviorBehavior>::Parse(*behavior_value, errors);
  } else {
  ...
  const base::Value* events_enabled_value = value.FindKey("eventsEnabled");
  if (events_enabled_value) {
    errors->SetName("eventsEnabled");
    result->events_enabled_ = internal::FromValue<bool>::Parse(*events_enabled_value, errors);
  }
  errors->Pop();
  errors->Pop();
  if (errors->HasErrors())
...
std::unique_ptr<base::Value> SetDownloadBehaviorParams::Serialize() const {
  ...
  if (events_enabled_)
    result->Set("eventsEnabled", internal::ToValue(events_enabled_.value()));
  return std::move(result);
}
...
std::unique_ptr<CancelDownloadParams> CancelDownloadParams::Parse(const base::Value& value, ErrorReporter* errors) {
  errors->Push();
  errors->SetName("CancelDownloadParams");
  if (!value.is_dict()) {
    errors->AddError("object expected");
    errors->Pop();
    return nullptr;
  ...
  std::unique_ptr<CancelDownloadParams> result(new CancelDownloadParams());
  errors->Push();
  errors->SetName("CancelDownloadParams");
...
std::unique_ptr<base::Value> CancelDownloadParams::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
...
std::unique_ptr<CancelDownloadParams> CancelDownloadParams::Clone() const {
  ErrorReporter errors;
  std::unique_ptr<CancelDownloadParams> result = Parse(*Serialize(), &errors);
  DCHECK(!errors.HasErrors());
  return result;
}


std::unique_ptr<CancelDownloadResult> CancelDownloadResult::Parse(const base::Value& value, ErrorReporter* errors) {
  errors->Push();
  errors->SetName("CancelDownloadResult");
  if (!value.is_dict()) {
    errors->AddError("object expected");
    errors->Pop();
    return nullptr;
  ...
  std::unique_ptr<CancelDownloadResult> result(new CancelDownloadResult());
  errors->Push();
  errors->SetName("CancelDownloadResult");
  errors->Pop();
  errors->Pop();
...
std::unique_ptr<base::Value> CancelDownloadResult::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  return std::move(result);
}

std::unique_ptr<CancelDownloadResult> CancelDownloadResult::Clone() const {
  ErrorReporter errors;
  std::unique_ptr<CancelDownloadResult> result = Parse(*Serialize(), &errors);
  DCHECK(!errors.HasErrors());
  return result;
}
...
std::unique_ptr<GetHistogramsResult> GetHistogramsResult::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (histograms_value) {
    ...
    result->histograms_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::browser::Histogram>>>::Parse(*histograms_value, errors);
  } else {
...
std::unique_ptr<GetHistogramResult> GetHistogramResult::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (histogram_value) {
    errors->SetName("histogram");
    result->histogram_ = internal::FromValue<::autofill_assistant::browser::Histogram>::Parse(*histogram_value, errors);
  } else {
...
std::unique_ptr<GetWindowBoundsResult> GetWindowBoundsResult::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (bounds_value) {
    errors->SetName("bounds");
    result->bounds_ = internal::FromValue<::autofill_assistant::browser::Bounds>::Parse(*bounds_value, errors);
  } else {
...
std::unique_ptr<SetDockTileParams> SetDockTileParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (image_value) {
    ...
    result->image_ = internal::FromValue<std::string>::Parse(*image_value, errors);
  }
  errors->Pop();
  errors->Pop();
  if (errors->HasErrors())
...
std::unique_ptr<ExecuteBrowserCommandParams> ExecuteBrowserCommandParams::Parse(const base::Value& value, ErrorReporter* errors) {
  errors->Push();
  errors->SetName("ExecuteBrowserCommandParams");
  if (!value.is_dict()) {
    errors->AddError("object expected");
    errors->Pop();
    return nullptr;
  ...
  std::unique_ptr<ExecuteBrowserCommandParams> result(new ExecuteBrowserCommandParams());
  errors->Push();
  errors->SetName("ExecuteBrowserCommandParams");
  const base::Value* command_id_value = value.FindKey("commandId");
  if (command_id_value) {
    errors->SetName("commandId");
    result->command_id_ = internal::FromValue<::autofill_assistant::browser::BrowserCommandId>::Parse(*command_id_value, errors);
  } else {
    errors->AddError("required property missing: commandId");
  }
  errors->Pop();
  errors->Pop();
  if (errors->HasErrors())
...
std::unique_ptr<base::Value> ExecuteBrowserCommandParams::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  result->Set("commandId", internal::ToValue(command_id_));
  return std::move(result);
}

std::unique_ptr<ExecuteBrowserCommandParams> ExecuteBrowserCommandParams::Clone() const {
  ErrorReporter errors;
  std::unique_ptr<ExecuteBrowserCommandParams> result = Parse(*Serialize(), &errors);
  DCHECK(!errors.HasErrors());
  return result;
}


std::unique_ptr<ExecuteBrowserCommandResult> ExecuteBrowserCommandResult::Parse(const base::Value& value, ErrorReporter* errors) {
  errors->Push();
  errors->SetName("ExecuteBrowserCommandResult");
  if (!value.is_dict()) {
    errors->AddError("object expected");
    errors->Pop();
    return nullptr;
  ...
  std::unique_ptr<ExecuteBrowserCommandResult> result(new ExecuteBrowserCommandResult());
  errors->Push();
  errors->SetName("ExecuteBrowserCommandResult");
  errors->Pop();
  errors->Pop();
...
std::unique_ptr<base::Value> ExecuteBrowserCommandResult::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  return std::move(result);
}

std::unique_ptr<ExecuteBrowserCommandResult> ExecuteBrowserCommandResult::Clone() const {
  ErrorReporter errors;
  std::unique_ptr<ExecuteBrowserCommandResult> result = Parse(*Serialize(), &errors);
  DCHECK(!errors.HasErrors());
  return result;
}
...
std::unique_ptr<DownloadProgressParams> DownloadProgressParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (state_value) {
    ...
    result->state_ = internal::FromValue<::autofill_assistant::browser::DownloadProgressState>::Parse(*state_value, errors);
  } else {
