...
#include "components/autofill_assistant/browser/devtools/devtools/internal/type_conversions_web_audio.h"
...
std::unique_ptr<BaseAudioContext> BaseAudioContext::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (context_type_value) {
    ...
    result->context_type_ = internal::FromValue<::autofill_assistant::web_audio::ContextType>::Parse(*context_type_value, errors);
  } else {
  ...
  if (context_state_value) {
    ...
    result->context_state_ = internal::FromValue<::autofill_assistant::web_audio::ContextState>::Parse(*context_state_value, errors);
  } else {
  ...
  if (realtime_data_value) {
    ...
    result->realtime_data_ = internal::FromValue<::autofill_assistant::web_audio::ContextRealtimeData>::Parse(*realtime_data_value, errors);
  }
...
std::unique_ptr<AudioNode> AudioNode::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (channel_count_mode_value) {
    ...
    result->channel_count_mode_ = internal::FromValue<::autofill_assistant::web_audio::ChannelCountMode>::Parse(*channel_count_mode_value, errors);
  } else {
  ...
  if (channel_interpretation_value) {
    ...
    result->channel_interpretation_ = internal::FromValue<::autofill_assistant::web_audio::ChannelInterpretation>::Parse(*channel_interpretation_value, errors);
  } else {
...
std::unique_ptr<AudioParam> AudioParam::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (rate_value) {
    errors->SetName("rate");
    result->rate_ = internal::FromValue<::autofill_assistant::web_audio::AutomationRate>::Parse(*rate_value, errors);
  } else {
...
std::unique_ptr<ContextCreatedParams> ContextCreatedParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (context_value) {
    ...
    result->context_ = internal::FromValue<::autofill_assistant::web_audio::BaseAudioContext>::Parse(*context_value, errors);
  } else {
...
std::unique_ptr<AudioListenerCreatedParams> AudioListenerCreatedParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (listener_value) {
    ...
    result->listener_ = internal::FromValue<::autofill_assistant::web_audio::AudioListener>::Parse(*listener_value, errors);
  } else {
...
std::unique_ptr<AudioNodeCreatedParams> AudioNodeCreatedParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (node_value) {
    errors->SetName("node");
    result->node_ = internal::FromValue<::autofill_assistant::web_audio::AudioNode>::Parse(*node_value, errors);
  } else {
...
std::unique_ptr<AudioParamCreatedParams> AudioParamCreatedParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (param_value) {
    ...
    result->param_ = internal::FromValue<::autofill_assistant::web_audio::AudioParam>::Parse(*param_value, errors);
  } else {
