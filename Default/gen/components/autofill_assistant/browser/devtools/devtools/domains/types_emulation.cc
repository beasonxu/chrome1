...
std::unique_ptr<ScreenOrientation> ScreenOrientation::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (type_value) {
    errors->SetName("type");
    result->type_ = internal::FromValue<::autofill_assistant::emulation::ScreenOrientationType>::Parse(*type_value, errors);
  } else {
...
std::unique_ptr<DisplayFeature> DisplayFeature::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  errors->Push();
  errors->SetName("DisplayFeature");
  const base::Value* orientation_value = value.FindKey("orientation");
  if (orientation_value) {
    errors->SetName("orientation");
    result->orientation_ = internal::FromValue<::autofill_assistant::emulation::DisplayFeatureOrientation>::Parse(*orientation_value, errors);
  } else {
  ...
  const base::Value* mask_length_value = value.FindKey("maskLength");
...
std::unique_ptr<base::Value> DisplayFeature::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
...
std::unique_ptr<UserAgentMetadata> UserAgentMetadata::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (brands_value) {
    ...
    result->brands_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::emulation::UserAgentBrandVersion>>>::Parse(*brands_value, errors);
  }
  const base::Value* full_version_list_value = value.FindKey("fullVersionList");
  if (full_version_list_value) {
    errors->SetName("fullVersionList");
    result->full_version_list_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::emulation::UserAgentBrandVersion>>>::Parse(*full_version_list_value, errors);
  }
  ...
  const base::Value* bitness_value = value.FindKey("bitness");
  if (bitness_value) {
    errors->SetName("bitness");
    result->bitness_ = internal::FromValue<std::string>::Parse(*bitness_value, errors);
  }
  const base::Value* wow64_value = value.FindKey("wow64");
  if (wow64_value) {
...
std::unique_ptr<base::Value> SetAutoDarkModeOverrideParams::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  if (enabled_)
...
std::unique_ptr<base::Value> SetAutoDarkModeOverrideResult::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  return std::move(result);
}
...
std::unique_ptr<SetDeviceMetricsOverrideParams> SetDeviceMetricsOverrideParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  const base::Value* display_feature_value = value.FindKey("displayFeature");
  if (display_feature_value) {
    errors->SetName("displayFeature");
    result->display_feature_ = internal::FromValue<::autofill_assistant::emulation::DisplayFeature>::Parse(*display_feature_value, errors);
  }
  errors->Pop();
  errors->Pop();
  if (errors->HasErrors())
...
std::unique_ptr<SetEmitTouchEventsForMouseParams> SetEmitTouchEventsForMouseParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (configuration_value) {
    ...
    result->configuration_ = internal::FromValue<::autofill_assistant::emulation::SetEmitTouchEventsForMouseConfiguration>::Parse(*configuration_value, errors);
  }
  errors->Pop();
  errors->Pop();
  if (errors->HasErrors())
...
std::unique_ptr<SetEmulatedMediaParams> SetEmulatedMediaParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (features_value) {
    ...
    result->features_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::emulation::MediaFeature>>>::Parse(*features_value, errors);
  }
  errors->Pop();
  errors->Pop();
  if (errors->HasErrors())
...
std::unique_ptr<SetEmulatedVisionDeficiencyParams> SetEmulatedVisionDeficiencyParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (type_value) {
    errors->SetName("type");
    result->type_ = internal::FromValue<::autofill_assistant::emulation::SetEmulatedVisionDeficiencyType>::Parse(*type_value, errors);
  } else {
    errors->AddError("required property missing: type");
  }
  errors->Pop();
...
std::unique_ptr<SetIdleOverrideParams> SetIdleOverrideParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  errors->Push();
  errors->SetName("SetIdleOverrideParams");
  const base::Value* is_user_active_value = value.FindKey("isUserActive");
  ...
  const base::Value* is_screen_unlocked_value = value.FindKey("isScreenUnlocked");
...
std::unique_ptr<base::Value> SetIdleOverrideParams::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
...
std::unique_ptr<base::Value> SetIdleOverrideResult::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  return std::move(result);
}
...
std::unique_ptr<base::Value> ClearIdleOverrideParams::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  return std::move(result);
}
...
std::unique_ptr<base::Value> ClearIdleOverrideResult::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  return std::move(result);
}
...
std::unique_ptr<SetVirtualTimePolicyParams> SetVirtualTimePolicyParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (policy_value) {
    ...
    result->policy_ = internal::FromValue<::autofill_assistant::emulation::VirtualTimePolicy>::Parse(*policy_value, errors);
  } else {
...
std::unique_ptr<SetDisabledImageTypesParams> SetDisabledImageTypesParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  errors->Push();
  errors->SetName("SetDisabledImageTypesParams");
  const base::Value* image_types_value = value.FindKey("imageTypes");
  if (image_types_value) {
    errors->SetName("imageTypes");
    result->image_types_ = internal::FromValue<std::vector<::autofill_assistant::emulation::DisabledImageType>>::Parse(*image_types_value, errors);
  } else {
...
std::unique_ptr<base::Value> SetDisabledImageTypesParams::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
...
std::unique_ptr<base::Value> SetDisabledImageTypesResult::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  return std::move(result);
}
...
std::unique_ptr<SetHardwareConcurrencyOverrideParams> SetHardwareConcurrencyOverrideParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  errors->Push();
  errors->SetName("SetHardwareConcurrencyOverrideParams");
  const base::Value* hardware_concurrency_value = value.FindKey("hardwareConcurrency");
...
std::unique_ptr<base::Value> SetHardwareConcurrencyOverrideParams::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
...
std::unique_ptr<base::Value> SetHardwareConcurrencyOverrideResult::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  return std::move(result);
}
...
std::unique_ptr<base::Value> SetAutomationOverrideParams::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  result->Set("enabled", internal::ToValue(enabled_));
  return std::move(result);
}
...
std::unique_ptr<base::Value> SetAutomationOverrideResult::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  return std::move(result);
}
