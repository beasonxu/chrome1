...
#ifndef COMPONENTS_AUTOFILL_ASSISTANT_BROWSER_DEVTOOLS_DEVTOOLS_DOMAINS_TYPES_DOM_SNAPSHOT_H_
#define COMPONENTS_AUTOFILL_ASSISTANT_BROWSER_DEVTOOLS_DEVTOOLS_DOMAINS_TYPES_DOM_SNAPSHOT_H_
...
#include "components/autofill_assistant/browser/devtools/devtools/internal/types_forward_declarations_dom_snapshot.h"
...
class DOMNode {
 public:
  ...
  const std::vector<std::unique_ptr<::autofill_assistant::dom_snapshot::NameValue>>* GetAttributes() const { DCHECK(HasAttributes()); return &attributes_.value(); }
  void SetAttributes(std::vector<std::unique_ptr<::autofill_assistant::dom_snapshot::NameValue>> value) { attributes_ = std::move(value); }
  ...
  const std::vector<std::unique_ptr<::autofill_assistant::dom_debugger::EventListener>>* GetEventListeners() const { DCHECK(HasEventListeners()); return &event_listeners_.value(); }
  void SetEventListeners(std::vector<std::unique_ptr<::autofill_assistant::dom_debugger::EventListener>> value) { event_listeners_ = std::move(value); }
  ...
  public:
    ...
    DOMNodeBuilder<STATE>& SetAttributes(std::vector<std::unique_ptr<::autofill_assistant::dom_snapshot::NameValue>> value) {
    ...
    DOMNodeBuilder<STATE>& SetPseudoType(::autofill_assistant::dom::PseudoType value) {
      result_->SetPseudoType(value);
      return *this;
    }

    DOMNodeBuilder<STATE>& SetShadowRootType(::autofill_assistant::dom::ShadowRootType value) {
    ...
    DOMNodeBuilder<STATE>& SetEventListeners(std::vector<std::unique_ptr<::autofill_assistant::dom_debugger::EventListener>> value) {
 ...
 private:
  ...
  absl::optional<std::string> text_value_;
  absl::optional<std::string> input_value_;
  absl::optional<bool> input_checked_;
  absl::optional<bool> option_selected_;
  int backend_node_id_;
  absl::optional<std::vector<int>> child_node_indexes_;
  absl::optional<std::vector<std::unique_ptr<::autofill_assistant::dom_snapshot::NameValue>>> attributes_;
  absl::optional<std::vector<int>> pseudo_element_indexes_;
  absl::optional<int> layout_node_index_;
  absl::optional<std::string> documenturl_;
  absl::optional<std::string> baseurl_;
  absl::optional<std::string> content_language_;
  absl::optional<std::string> document_encoding_;
  absl::optional<std::string> public_id_;
  absl::optional<std::string> system_id_;
  absl::optional<std::string> frame_id_;
  absl::optional<int> content_document_index_;
  ...
  absl::optional<bool> is_clickable_;
  absl::optional<std::vector<std::unique_ptr<::autofill_assistant::dom_debugger::EventListener>>> event_listeners_;
  absl::optional<std::string> current_sourceurl_;
  absl::optional<std::string> originurl_;
  absl::optional<double> scroll_offsetx_;
  absl::optional<double> scroll_offsety_;
};
...
class InlineTextBox {
 public:
  ...
  InlineTextBox(const InlineTextBox&) = delete;
  InlineTextBox& operator=(const InlineTextBox&) = delete;
  ~InlineTextBox() { }

  // The bounding box in document coordinates. Note that scroll offset of the document is ignored.
  const ::autofill_assistant::dom::Rect* GetBoundingBox() const { return bounding_box_.get(); }
  void SetBoundingBox(std::unique_ptr<::autofill_assistant::dom::Rect> value) { bounding_box_ = std::move(value); }
  ...
  public:
    ...
    InlineTextBoxBuilder<STATE | kBoundingBoxSet>& SetBoundingBox(std::unique_ptr<::autofill_assistant::dom::Rect> value) {
 ...
 private:
  ...
  std::unique_ptr<::autofill_assistant::dom::Rect> bounding_box_;
...
class LayoutTreeNode {
 public:
  ...
  LayoutTreeNode(const LayoutTreeNode&) = delete;
  LayoutTreeNode& operator=(const LayoutTreeNode&) = delete;
  ~LayoutTreeNode() { }
  ...
  const std::vector<std::unique_ptr<::autofill_assistant::dom_snapshot::InlineTextBox>>* GetInlineTextNodes() const { DCHECK(HasInlineTextNodes()); return &inline_text_nodes_.value(); }
  void SetInlineTextNodes(std::vector<std::unique_ptr<::autofill_assistant::dom_snapshot::InlineTextBox>> value) { inline_text_nodes_ = std::move(value); }
  ...
  public:
    ...
    LayoutTreeNodeBuilder<STATE | kBoundingBoxSet>& SetBoundingBox(std::unique_ptr<::autofill_assistant::dom::Rect> value) {
      static_assert(!(STATE & kBoundingBoxSet), "property boundingBox should not have already been set");
      result_->SetBoundingBox(std::move(value));
      return CastState<kBoundingBoxSet>();
    }
    ...
    LayoutTreeNodeBuilder<STATE>& SetInlineTextNodes(std::vector<std::unique_ptr<::autofill_assistant::dom_snapshot::InlineTextBox>> value) {
 ...
 private:
  ...
  int dom_node_index_;
  std::unique_ptr<::autofill_assistant::dom::Rect> bounding_box_;
  absl::optional<std::string> layout_text_;
  absl::optional<std::vector<std::unique_ptr<::autofill_assistant::dom_snapshot::InlineTextBox>>> inline_text_nodes_;
  absl::optional<int> style_index_;
  absl::optional<int> paint_order_;
  absl::optional<bool> is_stacking_context_;
};
...
class ComputedStyle {
 public:
  ...
  ComputedStyle& operator=(const ComputedStyle&) = delete;
  ~ComputedStyle() { }

  // Name/value pairs of computed style properties.
  const std::vector<std::unique_ptr<::autofill_assistant::dom_snapshot::NameValue>>* GetProperties() const { return &properties_; }
  void SetProperties(std::vector<std::unique_ptr<::autofill_assistant::dom_snapshot::NameValue>> value) { properties_ = std::move(value); }
  ...
  public:
    ...
    ComputedStyleBuilder<STATE | kPropertiesSet>& SetProperties(std::vector<std::unique_ptr<::autofill_assistant::dom_snapshot::NameValue>> value) {
 ...
 private:
  ...
  std::vector<std::unique_ptr<::autofill_assistant::dom_snapshot::NameValue>> properties_;
};
...
class RareStringData {
 public:
  ...
  RareStringData(const RareStringData&) = delete;
  RareStringData& operator=(const RareStringData&) = delete;
  ~RareStringData() { }
...
class RareBooleanData {
 public:
  ...
  RareBooleanData(const RareBooleanData&) = delete;
  RareBooleanData& operator=(const RareBooleanData&) = delete;
  ~RareBooleanData() { }
...
class RareIntegerData {
 public:
  ...
  RareIntegerData(const RareIntegerData&) = delete;
  RareIntegerData& operator=(const RareIntegerData&) = delete;
  ~RareIntegerData() { }
...
class DocumentSnapshot {
 public:
  ...
  const ::autofill_assistant::dom_snapshot::NodeTreeSnapshot* GetNodes() const { return nodes_.get(); }
  void SetNodes(std::unique_ptr<::autofill_assistant::dom_snapshot::NodeTreeSnapshot> value) { nodes_ = std::move(value); }

  // The nodes in the layout tree.
  const ::autofill_assistant::dom_snapshot::LayoutTreeSnapshot* GetLayout() const { return layout_.get(); }
  void SetLayout(std::unique_ptr<::autofill_assistant::dom_snapshot::LayoutTreeSnapshot> value) { layout_ = std::move(value); }

  // The post-layout inline text nodes.
  const ::autofill_assistant::dom_snapshot::TextBoxSnapshot* GetTextBoxes() const { return text_boxes_.get(); }
  void SetTextBoxes(std::unique_ptr<::autofill_assistant::dom_snapshot::TextBoxSnapshot> value) { text_boxes_ = std::move(value); }
  ...
  public:
    ...
    DocumentSnapshotBuilder<STATE | kNodesSet>& SetNodes(std::unique_ptr<::autofill_assistant::dom_snapshot::NodeTreeSnapshot> value) {
    ...
    DocumentSnapshotBuilder<STATE | kLayoutSet>& SetLayout(std::unique_ptr<::autofill_assistant::dom_snapshot::LayoutTreeSnapshot> value) {
    ...
    DocumentSnapshotBuilder<STATE | kTextBoxesSet>& SetTextBoxes(std::unique_ptr<::autofill_assistant::dom_snapshot::TextBoxSnapshot> value) {
 ...
 private:
  ...
  int system_id_;
  int frame_id_;
  std::unique_ptr<::autofill_assistant::dom_snapshot::NodeTreeSnapshot> nodes_;
  std::unique_ptr<::autofill_assistant::dom_snapshot::LayoutTreeSnapshot> layout_;
  std::unique_ptr<::autofill_assistant::dom_snapshot::TextBoxSnapshot> text_boxes_;
  absl::optional<double> scroll_offsetx_;
  absl::optional<double> scroll_offsety_;
  absl::optional<double> content_width_;
  absl::optional<double> content_height_;
};
...
class NodeTreeSnapshot {
 public:
  ...
  NodeTreeSnapshot(const NodeTreeSnapshot&) = delete;
  NodeTreeSnapshot& operator=(const NodeTreeSnapshot&) = delete;
  ~NodeTreeSnapshot() { }
  ...
  bool HasShadowRootType() const { return !!shadow_root_type_; }
  const ::autofill_assistant::dom_snapshot::RareStringData* GetShadowRootType() const { DCHECK(HasShadowRootType()); return shadow_root_type_.value().get(); }
  void SetShadowRootType(std::unique_ptr<::autofill_assistant::dom_snapshot::RareStringData> value) { shadow_root_type_ = std::move(value); }
  ...
  // Only set for textarea elements, contains the text value.
  bool HasTextValue() const { return !!text_value_; }
  const ::autofill_assistant::dom_snapshot::RareStringData* GetTextValue() const { DCHECK(HasTextValue()); return text_value_.value().get(); }
  void SetTextValue(std::unique_ptr<::autofill_assistant::dom_snapshot::RareStringData> value) { text_value_ = std::move(value); }

  // Only set for input elements, contains the input's associated text value.
  bool HasInputValue() const { return !!input_value_; }
  const ::autofill_assistant::dom_snapshot::RareStringData* GetInputValue() const { DCHECK(HasInputValue()); return input_value_.value().get(); }
  void SetInputValue(std::unique_ptr<::autofill_assistant::dom_snapshot::RareStringData> value) { input_value_ = std::move(value); }

  // Only set for radio and checkbox input elements, indicates if the element has been checked
  bool HasInputChecked() const { return !!input_checked_; }
  const ::autofill_assistant::dom_snapshot::RareBooleanData* GetInputChecked() const { DCHECK(HasInputChecked()); return input_checked_.value().get(); }
  void SetInputChecked(std::unique_ptr<::autofill_assistant::dom_snapshot::RareBooleanData> value) { input_checked_ = std::move(value); }

  // Only set for option elements, indicates if the element has been selected
  bool HasOptionSelected() const { return !!option_selected_; }
  const ::autofill_assistant::dom_snapshot::RareBooleanData* GetOptionSelected() const { DCHECK(HasOptionSelected()); return option_selected_.value().get(); }
  void SetOptionSelected(std::unique_ptr<::autofill_assistant::dom_snapshot::RareBooleanData> value) { option_selected_ = std::move(value); }

  // The index of the document in the list of the snapshot documents.
  bool HasContentDocumentIndex() const { return !!content_document_index_; }
  const ::autofill_assistant::dom_snapshot::RareIntegerData* GetContentDocumentIndex() const { DCHECK(HasContentDocumentIndex()); return content_document_index_.value().get(); }
  void SetContentDocumentIndex(std::unique_ptr<::autofill_assistant::dom_snapshot::RareIntegerData> value) { content_document_index_ = std::move(value); }

  // Type of a pseudo element node.
  bool HasPseudoType() const { return !!pseudo_type_; }
  const ::autofill_assistant::dom_snapshot::RareStringData* GetPseudoType() const { DCHECK(HasPseudoType()); return pseudo_type_.value().get(); }
  void SetPseudoType(std::unique_ptr<::autofill_assistant::dom_snapshot::RareStringData> value) { pseudo_type_ = std::move(value); }

  // Pseudo element identifier for this node. Only present if there is a
  // valid pseudoType.
  bool HasPseudoIdentifier() const { return !!pseudo_identifier_; }
  const ::autofill_assistant::dom_snapshot::RareStringData* GetPseudoIdentifier() const { DCHECK(HasPseudoIdentifier()); return pseudo_identifier_.value().get(); }
  void SetPseudoIdentifier(std::unique_ptr<::autofill_assistant::dom_snapshot::RareStringData> value) { pseudo_identifier_ = std::move(value); }

  // Whether this DOM node responds to mouse clicks. This includes nodes that have had click
  // event listeners attached via JavaScript as well as anchor tags that naturally navigate when
  // clicked.
  bool HasIsClickable() const { return !!is_clickable_; }
  const ::autofill_assistant::dom_snapshot::RareBooleanData* GetIsClickable() const { DCHECK(HasIsClickable()); return is_clickable_.value().get(); }
  void SetIsClickable(std::unique_ptr<::autofill_assistant::dom_snapshot::RareBooleanData> value) { is_clickable_ = std::move(value); }

  // The selected url for nodes with a srcset attribute.
  bool HasCurrentSourceURL() const { return !!current_sourceurl_; }
  const ::autofill_assistant::dom_snapshot::RareStringData* GetCurrentSourceURL() const { DCHECK(HasCurrentSourceURL()); return current_sourceurl_.value().get(); }
  void SetCurrentSourceURL(std::unique_ptr<::autofill_assistant::dom_snapshot::RareStringData> value) { current_sourceurl_ = std::move(value); }

  // The url of the script (if any) that generates this node.
  bool HasOriginURL() const { return !!originurl_; }
  const ::autofill_assistant::dom_snapshot::RareStringData* GetOriginURL() const { DCHECK(HasOriginURL()); return originurl_.value().get(); }
  void SetOriginURL(std::unique_ptr<::autofill_assistant::dom_snapshot::RareStringData> value) { originurl_ = std::move(value); }
  ...
  public:
    ...
    NodeTreeSnapshotBuilder<STATE>& SetShadowRootType(std::unique_ptr<::autofill_assistant::dom_snapshot::RareStringData> value) {
      result_->SetShadowRootType(std::move(value));
      return *this;
    }
    ...
    NodeTreeSnapshotBuilder<STATE>& SetTextValue(std::unique_ptr<::autofill_assistant::dom_snapshot::RareStringData> value) {
      result_->SetTextValue(std::move(value));
      return *this;
    }

    NodeTreeSnapshotBuilder<STATE>& SetInputValue(std::unique_ptr<::autofill_assistant::dom_snapshot::RareStringData> value) {
      result_->SetInputValue(std::move(value));
      return *this;
    }

    NodeTreeSnapshotBuilder<STATE>& SetInputChecked(std::unique_ptr<::autofill_assistant::dom_snapshot::RareBooleanData> value) {
      result_->SetInputChecked(std::move(value));
      return *this;
    }

    NodeTreeSnapshotBuilder<STATE>& SetOptionSelected(std::unique_ptr<::autofill_assistant::dom_snapshot::RareBooleanData> value) {
      result_->SetOptionSelected(std::move(value));
      return *this;
    }

    NodeTreeSnapshotBuilder<STATE>& SetContentDocumentIndex(std::unique_ptr<::autofill_assistant::dom_snapshot::RareIntegerData> value) {
      result_->SetContentDocumentIndex(std::move(value));
      return *this;
    }

    NodeTreeSnapshotBuilder<STATE>& SetPseudoType(std::unique_ptr<::autofill_assistant::dom_snapshot::RareStringData> value) {
      result_->SetPseudoType(std::move(value));
      return *this;
    }

    NodeTreeSnapshotBuilder<STATE>& SetPseudoIdentifier(std::unique_ptr<::autofill_assistant::dom_snapshot::RareStringData> value) {
      result_->SetPseudoIdentifier(std::move(value));
      return *this;
    }

    NodeTreeSnapshotBuilder<STATE>& SetIsClickable(std::unique_ptr<::autofill_assistant::dom_snapshot::RareBooleanData> value) {
      result_->SetIsClickable(std::move(value));
      return *this;
    }

    NodeTreeSnapshotBuilder<STATE>& SetCurrentSourceURL(std::unique_ptr<::autofill_assistant::dom_snapshot::RareStringData> value) {
      result_->SetCurrentSourceURL(std::move(value));
      return *this;
    }

    NodeTreeSnapshotBuilder<STATE>& SetOriginURL(std::unique_ptr<::autofill_assistant::dom_snapshot::RareStringData> value) {
 ...
 private:
  ...
  absl::optional<std::vector<int>> parent_index_;
  absl::optional<std::vector<int>> node_type_;
  absl::optional<std::unique_ptr<::autofill_assistant::dom_snapshot::RareStringData>> shadow_root_type_;
  absl::optional<std::vector<int>> node_name_;
  absl::optional<std::vector<int>> node_value_;
  absl::optional<std::vector<int>> backend_node_id_;
  absl::optional<std::vector<std::vector<int>>> attributes_;
  absl::optional<std::unique_ptr<::autofill_assistant::dom_snapshot::RareStringData>> text_value_;
  absl::optional<std::unique_ptr<::autofill_assistant::dom_snapshot::RareStringData>> input_value_;
  absl::optional<std::unique_ptr<::autofill_assistant::dom_snapshot::RareBooleanData>> input_checked_;
  absl::optional<std::unique_ptr<::autofill_assistant::dom_snapshot::RareBooleanData>> option_selected_;
  absl::optional<std::unique_ptr<::autofill_assistant::dom_snapshot::RareIntegerData>> content_document_index_;
  absl::optional<std::unique_ptr<::autofill_assistant::dom_snapshot::RareStringData>> pseudo_type_;
  absl::optional<std::unique_ptr<::autofill_assistant::dom_snapshot::RareStringData>> pseudo_identifier_;
  absl::optional<std::unique_ptr<::autofill_assistant::dom_snapshot::RareBooleanData>> is_clickable_;
  absl::optional<std::unique_ptr<::autofill_assistant::dom_snapshot::RareStringData>> current_sourceurl_;
  absl::optional<std::unique_ptr<::autofill_assistant::dom_snapshot::RareStringData>> originurl_;
};
...
class LayoutTreeSnapshot {
 public:
  ...
  LayoutTreeSnapshot(const LayoutTreeSnapshot&) = delete;
  LayoutTreeSnapshot& operator=(const LayoutTreeSnapshot&) = delete;
  ~LayoutTreeSnapshot() { }
  ...
  const ::autofill_assistant::dom_snapshot::RareBooleanData* GetStackingContexts() const { return stacking_contexts_.get(); }
  void SetStackingContexts(std::unique_ptr<::autofill_assistant::dom_snapshot::RareBooleanData> value) { stacking_contexts_ = std::move(value); }
  ...
  bool HasBlendedBackgroundColors() const { return !!blended_background_colors_; }
  const std::vector<int>* GetBlendedBackgroundColors() const { DCHECK(HasBlendedBackgroundColors()); return &blended_background_colors_.value(); }
  void SetBlendedBackgroundColors(std::vector<int> value) { blended_background_colors_ = std::move(value); }

  // The list of computed text opacities.
  bool HasTextColorOpacities() const { return !!text_color_opacities_; }
  const std::vector<double>* GetTextColorOpacities() const { DCHECK(HasTextColorOpacities()); return &text_color_opacities_.value(); }
  void SetTextColorOpacities(std::vector<double> value) { text_color_opacities_ = std::move(value); }
  ...
  public:
    ...
    LayoutTreeSnapshotBuilder<STATE | kStackingContextsSet>& SetStackingContexts(std::unique_ptr<::autofill_assistant::dom_snapshot::RareBooleanData> value) {
    ...
    LayoutTreeSnapshotBuilder<STATE>& SetBlendedBackgroundColors(std::vector<int> value) {
      result_->SetBlendedBackgroundColors(std::move(value));
      return *this;
    }

    LayoutTreeSnapshotBuilder<STATE>& SetTextColorOpacities(std::vector<double> value) {
      result_->SetTextColorOpacities(std::move(value));
      return *this;
    }
 ...
 private:
  ...
  std::unique_ptr<::autofill_assistant::dom_snapshot::RareBooleanData> stacking_contexts_;
  absl::optional<std::vector<int>> paint_orders_;
  absl::optional<std::vector<std::vector<double>>> offset_rects_;
  absl::optional<std::vector<std::vector<double>>> scroll_rects_;
  absl::optional<std::vector<std::vector<double>>> client_rects_;
  absl::optional<std::vector<int>> blended_background_colors_;
  absl::optional<std::vector<double>> text_color_opacities_;
};
...
class TextBoxSnapshot {
 public:
  ...
  TextBoxSnapshot(const TextBoxSnapshot&) = delete;
  TextBoxSnapshot& operator=(const TextBoxSnapshot&) = delete;
  ~TextBoxSnapshot() { }
...
class GetSnapshotParams {
 public:
  ...
  GetSnapshotParams(const GetSnapshotParams&) = delete;
  GetSnapshotParams& operator=(const GetSnapshotParams&) = delete;
  ~GetSnapshotParams() { }
 ...
 private:
  ...
  absl::optional<bool> include_event_listeners_;
  absl::optional<bool> include_paint_order_;
  absl::optional<bool> include_user_agent_shadow_tree_;
};
...
class GetSnapshotResult {
 public:
  ...
  GetSnapshotResult(const GetSnapshotResult&) = delete;
  GetSnapshotResult& operator=(const GetSnapshotResult&) = delete;
  ~GetSnapshotResult() { }

  // The nodes in the DOM tree. The DOMNode at index 0 corresponds to the root document.
  const std::vector<std::unique_ptr<::autofill_assistant::dom_snapshot::DOMNode>>* GetDomNodes() const { return &dom_nodes_; }
  void SetDomNodes(std::vector<std::unique_ptr<::autofill_assistant::dom_snapshot::DOMNode>> value) { dom_nodes_ = std::move(value); }

  // The nodes in the layout tree.
  const std::vector<std::unique_ptr<::autofill_assistant::dom_snapshot::LayoutTreeNode>>* GetLayoutTreeNodes() const { return &layout_tree_nodes_; }
  void SetLayoutTreeNodes(std::vector<std::unique_ptr<::autofill_assistant::dom_snapshot::LayoutTreeNode>> value) { layout_tree_nodes_ = std::move(value); }

  // Whitelisted ComputedStyle properties for each node in the layout tree.
  const std::vector<std::unique_ptr<::autofill_assistant::dom_snapshot::ComputedStyle>>* GetComputedStyles() const { return &computed_styles_; }
  void SetComputedStyles(std::vector<std::unique_ptr<::autofill_assistant::dom_snapshot::ComputedStyle>> value) { computed_styles_ = std::move(value); }
  ...
  public:
    ...
    GetSnapshotResultBuilder<STATE | kDomNodesSet>& SetDomNodes(std::vector<std::unique_ptr<::autofill_assistant::dom_snapshot::DOMNode>> value) {
    ...
    GetSnapshotResultBuilder<STATE | kLayoutTreeNodesSet>& SetLayoutTreeNodes(std::vector<std::unique_ptr<::autofill_assistant::dom_snapshot::LayoutTreeNode>> value) {
    ...
    GetSnapshotResultBuilder<STATE | kComputedStylesSet>& SetComputedStyles(std::vector<std::unique_ptr<::autofill_assistant::dom_snapshot::ComputedStyle>> value) {
 ...
 private:
  ...
  std::vector<std::unique_ptr<::autofill_assistant::dom_snapshot::DOMNode>> dom_nodes_;
  std::vector<std::unique_ptr<::autofill_assistant::dom_snapshot::LayoutTreeNode>> layout_tree_nodes_;
  std::vector<std::unique_ptr<::autofill_assistant::dom_snapshot::ComputedStyle>> computed_styles_;
};
...
class CaptureSnapshotParams {
 public:
  ...
  bool HasIncludeBlendedBackgroundColors() const { return !!include_blended_background_colors_; }
  bool GetIncludeBlendedBackgroundColors() const { DCHECK(HasIncludeBlendedBackgroundColors()); return include_blended_background_colors_.value(); }
  void SetIncludeBlendedBackgroundColors(bool value) { include_blended_background_colors_ = value; }

  // Whether to include text color opacity in the snapshot (default: false).
  // An element might have the opacity property set that affects the text color of the element.
  // The final text color opacity is computed based on the opacity of all overlapping elements.
  bool HasIncludeTextColorOpacities() const { return !!include_text_color_opacities_; }
  bool GetIncludeTextColorOpacities() const { DCHECK(HasIncludeTextColorOpacities()); return include_text_color_opacities_.value(); }
  void SetIncludeTextColorOpacities(bool value) { include_text_color_opacities_ = value; }
  ...
  public:
    ...
    CaptureSnapshotParamsBuilder<STATE>& SetIncludeBlendedBackgroundColors(bool value) {
      result_->SetIncludeBlendedBackgroundColors(value);
      return *this;
    }

    CaptureSnapshotParamsBuilder<STATE>& SetIncludeTextColorOpacities(bool value) {
      result_->SetIncludeTextColorOpacities(value);
      return *this;
    }
 ...
 private:
  ...
  absl::optional<bool> include_paint_order_;
  absl::optional<bool> includedom_rects_;
  absl::optional<bool> include_blended_background_colors_;
  absl::optional<bool> include_text_color_opacities_;
};
...
class CaptureSnapshotResult {
 public:
  ...
  // The nodes in the DOM tree. The DOMNode at index 0 corresponds to the root document.
  const std::vector<std::unique_ptr<::autofill_assistant::dom_snapshot::DocumentSnapshot>>* GetDocuments() const { return &documents_; }
  void SetDocuments(std::vector<std::unique_ptr<::autofill_assistant::dom_snapshot::DocumentSnapshot>> value) { documents_ = std::move(value); }
  ...
  public:
    ...
    CaptureSnapshotResultBuilder<STATE | kDocumentsSet>& SetDocuments(std::vector<std::unique_ptr<::autofill_assistant::dom_snapshot::DocumentSnapshot>> value) {
 ...
 private:
  ...
  std::vector<std::unique_ptr<::autofill_assistant::dom_snapshot::DocumentSnapshot>> documents_;
...
#endif  // COMPONENTS_AUTOFILL_ASSISTANT_BROWSER_DEVTOOLS_DEVTOOLS_DOMAINS_TYPES_DOM_SNAPSHOT_H_
