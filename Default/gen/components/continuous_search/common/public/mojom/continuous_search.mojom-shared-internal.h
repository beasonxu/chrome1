...
static_assert(sizeof(SearchResult_Data) == 24,
              "Bad sizeof(SearchResult_Data)");
...
struct SearchResult_UnserializedMessageContext
 ...
 public:
  ...
  SearchResult_UnserializedMessageContext(
...
static_assert(sizeof(ResultGroup_Data) == 24,
              "Bad sizeof(ResultGroup_Data)");
...
struct ResultGroup_UnserializedMessageContext
 ...
 public:
  ...
  ResultGroup_UnserializedMessageContext(
    uint32_t message_name,
    uint32_t message_flags,
    UserType input)
      : mojo::internal::UnserializedMessageContext(&kMessageTag, message_name, message_flags)
...
static_assert(sizeof(CategoryResults_Data) == 32,
              "Bad sizeof(CategoryResults_Data)");
...
struct CategoryResults_UnserializedMessageContext
 ...
 public:
  ...
  CategoryResults_UnserializedMessageContext(
    uint32_t message_name,
    uint32_t message_flags,
    UserType input)
      : mojo::internal::UnserializedMessageContext(&kMessageTag, message_name, message_flags)
