...
class FileEnumerator_GetNext_HandleSyncResponse
 ...
 public:
  FileEnumerator_GetNext_HandleSyncResponse(
      bool* result, WTF::Vector<FileEnumerationEntryPtr>* out_entries, bool* out_end, bool* out_error)
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("entries"), out_param_entries,
                        "<value of type WTF::Vector<FileEnumerationEntryPtr>>");
      perfetto::WriteIntoTracedValueWithFallback(
...
void FileEnumeratorAsyncWaiter::GetNext(
  ...
  proxy_->GetNext(std::move(num_entries),
      base::BindOnce(
          [](base::RunLoop* loop,
             WTF::Vector<FileEnumerationEntryPtr>* out_entries
,
             bool* out_end
,
             bool* out_error
,
             WTF::Vector<FileEnumerationEntryPtr> entries,
             bool end,
