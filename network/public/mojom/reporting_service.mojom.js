...
(function() {
  ...
  ReportingApiReport.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 48, values$.DeprecatedDictionaryValue, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  ReportingApiReport.decode = function(decoder) {
    ...
    val.attempts =
        decoder.decodeStruct(codec.Int32);
    val.body =
        decoder.decodeStructPointer(values$.DeprecatedDictionaryValue);
    val.status =
  ...
  ReportingApiReport.encode = function(encoder, val) {
    ...
    encoder.encodeStructPointer(values$.DeprecatedDictionaryValue, val.body);
  ...
  ReportingApiEndpoint.validate = function(messageValidator, offset) {
    ...
    // validate ReportingApiEndpoint.networkIsolationKey
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 48, network_isolation_key$.NetworkIsolationKey, false);
    if (err !== validator.validationError.NONE)
        return err;
