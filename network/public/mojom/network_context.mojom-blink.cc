...
CTPolicy::CTPolicy(
    WTF::Vector<WTF::String> required_hosts_in,
    WTF::Vector<WTF::String> excluded_hosts_in,
    WTF::Vector<WTF::String> excluded_spkis_in,
...
NetworkContextParams::NetworkContextParams(
    ...
    ::mojo::PendingRemote<::network::mojom::blink::SocketBroker> socket_broker_in,
    ...
    ::mojo::PendingReceiver<::network::mojom::blink::CookieManager> cookie_manager_in,
...
URLLoaderFactoryParams::URLLoaderFactoryParams(
    ...
    const ::scoped_refptr<const ::blink::SecurityOrigin>& request_initiator_origin_lock_in,
...
void CustomProxyConnectionObserverProxy::OnFallback(
    ::proxy_resolver::mojom::blink::ProxyServerPtr in_bad_proxy, int32_t in_net_error) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
bool CustomProxyConnectionObserverStubDispatch::Accept(
  ...
  switch (message->header()->name) {
    case internal::kCustomProxyConnectionObserver_OnFallback_Name: {
      ...
      bool success = true;
      ::proxy_resolver::mojom::blink::ProxyServerPtr p_bad_proxy{};
      int32_t p_net_error{};
...
std::move(p_net_error));
    ...
    case internal::kCustomProxyConnectionObserver_OnTunnelHeadersReceived_Name: {
      ...
      bool success = true;
      ::proxy_resolver::mojom::blink::ProxyServerPtr p_proxy_server{};
...
void NetworkContextClientProxy::OnTrustTokenIssuanceDivertedToSystem(
  ...
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("request"), in_request,
                        "<value of type ::network::mojom::blink::FulfillTrustTokenIssuanceRequestPtr>");
   });
#endif
  const bool kExpectsResponse = true;
  const bool kIsSync = false;
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("files"), in_files,
                        "<value of type WTF::Vector<::base::File>>");
   });
#endif
...
class NetworkContextClient_OnTrustTokenIssuanceDivertedToSystem_ProxyToResponder : public ::mojo::internal::ProxyToResponder {
 ...
 private:
  ...
  void Run(
      ::network::mojom::blink::FulfillTrustTokenIssuanceAnswerPtr in_response);
};
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("response"), in_response,
                        "<value of type ::network::mojom::blink::FulfillTrustTokenIssuanceAnswerPtr>");
   });
#endif
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("role"), in_role,
                        "<value of type ::network::mojom::blink::RestrictedCookieManagerRole>");
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("origin"), in_origin,
                        "<value of type const ::scoped_refptr<const ::blink::SecurityOrigin>&>");
      perfetto::WriteIntoTracedValueWithFallback(
...
void NetworkContextProxy::GetTrustTokenQueryAnswerer(
    ::mojo::PendingReceiver<::network::mojom::blink::TrustTokenQueryAnswerer> in_trust_token_query_answerer, const ::scoped_refptr<const ::blink::SecurityOrigin>& in_top_frame_origin) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void NetworkContextProxy::DeleteStoredTrustTokens(
    const ::scoped_refptr<const ::blink::SecurityOrigin>& in_issuer, DeleteStoredTrustTokensCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void NetworkContextProxy::NotifyExternalCacheHit(
    const ::blink::KURL& in_url, const WTF::String& in_http_method, ::network::mojom::blink::NetworkIsolationKeyPtr in_key, bool in_is_subframe_document_resource, bool in_include_credentials) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void NetworkContextProxy::SetDocumentReportingEndpoints(
    const ::base::UnguessableToken& in_reporting_source, const ::scoped_refptr<const ::blink::SecurityOrigin>& in_origin, const ::net::IsolationInfo& in_isolation_info, const WTF::HashMap<WTF::String, WTF::String>& in_endpoints) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void NetworkContextProxy::QueueReport(
    const WTF::String& in_type, const WTF::String& in_group, const ::blink::KURL& in_url, const absl::optional<::base::UnguessableToken>& in_reporting_source, ::network::mojom::blink::NetworkIsolationKeyPtr in_network_isolation_key, const WTF::String& in_user_agent, ::base::Value::Dict in_body) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void NetworkContextProxy::QueueSignedExchangeReport(
    SignedExchangeReportPtr in_report, ::network::mojom::blink::NetworkIsolationKeyPtr in_network_isolation_key) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void NetworkContextProxy::AddExpectCT(
    const WTF::String& in_host, ::base::Time in_expiry, bool in_enforce, const ::blink::KURL& in_report_uri, ::network::mojom::blink::NetworkIsolationKeyPtr in_network_isolation_key, AddExpectCTCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void NetworkContextProxy::GetExpectCTState(
    const WTF::String& in_domain, ::network::mojom::blink::NetworkIsolationKeyPtr in_network_isolation_key, GetExpectCTStateCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("receiver"), in_receiver,
                        "<value of type ::mojo::PendingReceiver<::network::mojom::blink::UDPSocket>>");
      perfetto::WriteIntoTracedValueWithFallback(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("additional_headers"), in_additional_headers,
                        "<value of type WTF::Vector<::network::mojom::blink::HttpHeaderPtr>>");
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("process_id"), in_process_id,
                        "<value of type int32_t>");
      perfetto::WriteIntoTracedValueWithFallback(
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("handshake_client"), in_handshake_client,
                        "<value of type ::mojo::PendingRemote<::network::mojom::blink::WebSocketHandshakeClient>>");
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("url_loader_network_observer"), in_url_loader_network_observer,
                        "<value of type ::mojo::PendingRemote<::network::mojom::blink::URLLoaderNetworkServiceObserver>>");
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("auth_handler"), in_auth_handler,
                        "<value of type ::mojo::PendingRemote<::network::mojom::blink::WebSocketAuthenticationHandler>>");
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("header_client"), in_header_client,
...
void NetworkContextProxy::CreateWebTransport(
    const ::blink::KURL& in_url, const ::scoped_refptr<const ::blink::SecurityOrigin>& in_origin, ::network::mojom::blink::NetworkIsolationKeyPtr in_network_isolation_key, WTF::Vector<::network::mojom::blink::WebTransportCertificateFingerprintPtr> in_fingerprints, ::mojo::PendingRemote<::network::mojom::blink::WebTransportHandshakeClient> in_handshake_client) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("fingerprints"), in_fingerprints,
                        "<value of type WTF::Vector<::network::mojom::blink::WebTransportCertificateFingerprintPtr>>");
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("handshake_client"), in_handshake_client,
...
void NetworkContextProxy::CreateP2PSocketManager(
    ::network::mojom::blink::NetworkIsolationKeyPtr in_network_isolation_key, ::mojo::PendingRemote<::network::mojom::blink::P2PTrustedSocketManagerClient> in_client, ::mojo::PendingReceiver<::network::mojom::blink::P2PTrustedSocketManager> in_trusted_socket_manager, ::mojo::PendingReceiver<::network::mojom::blink::P2PSocketManager> in_socket_manager) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("client"), in_client,
                        "<value of type ::mojo::PendingRemote<::network::mojom::blink::P2PTrustedSocketManagerClient>>");
      perfetto::WriteIntoTracedValueWithFallback(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("optional_parameters"), in_optional_parameters,
                        "<value of type ::network::mojom::blink::ResolveHostParametersPtr>");
      perfetto::WriteIntoTracedValueWithFallback(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("config_overrides"), in_config_overrides,
                        "<value of type ::network::mojom::blink::DnsConfigOverridesPtr>");
      perfetto::WriteIntoTracedValueWithFallback(
...
void NetworkContextProxy::VerifyCertForSignedExchange(
    ::network::mojom::blink::X509CertificatePtr in_certificate, const ::blink::KURL& in_url, ::network::mojom::blink::NetworkIsolationKeyPtr in_network_isolation_key, const WTF::String& in_ocsp_response, const WTF::String& in_sct_list, VerifyCertForSignedExchangeCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void NetworkContextProxy::AddAuthCacheEntry(
    const ::net::AuthChallengeInfo& in_challenge, ::network::mojom::blink::NetworkIsolationKeyPtr in_network_isolation_key, ::network::mojom::blink::AuthCredentialsPtr in_credentials, AddAuthCacheEntryCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void NetworkContextProxy::AddReportingApiObserver(
    ::mojo::PendingRemote<::network::mojom::blink::ReportingApiObserver> in_observer) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
class NetworkContext_GetStoredTrustTokenCounts_ProxyToResponder : public ::mojo::internal::ProxyToResponder {
 ...
 private:
  ...
  void Run(
      WTF::Vector<::network::mojom::blink::StoredTrustTokensForIssuerPtr> in_tokens);
};
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("tokens"), in_tokens,
                        "<value of type WTF::Vector<::network::mojom::blink::StoredTrustTokensForIssuerPtr>>");
   });
#endif
...
class NetworkContext_DeleteStoredTrustTokens_ProxyToResponder : public ::mojo::internal::ProxyToResponder {
 ...
 private:
  ...
  void Run(
      ::network::mojom::blink::DeleteStoredTrustTokensStatus in_status);
};
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("status"), in_status,
                        "<value of type ::network::mojom::blink::DeleteStoredTrustTokensStatus>");
   });
#endif
...
bool StructTraits<::network::mojom::blink::CertVerifierServiceRemoteParams::DataView, ::network::mojom::blink::CertVerifierServiceRemoteParamsPtr>::Read(
    ::network::mojom::blink::CertVerifierServiceRemoteParams::DataView input,
    ::network::mojom::blink::CertVerifierServiceRemoteParamsPtr* output) {
  bool success = true;
...
bool StructTraits<::network::mojom::blink::CTPolicy::DataView, ::network::mojom::blink::CTPolicyPtr>::Read(
    ::network::mojom::blink::CTPolicy::DataView input,
    ::network::mojom::blink::CTPolicyPtr* output) {
  bool success = true;
...
bool StructTraits<::network::mojom::blink::NetworkContextFilePaths::DataView, ::network::mojom::blink::NetworkContextFilePathsPtr>::Read(
    ::network::mojom::blink::NetworkContextFilePaths::DataView input,
    ::network::mojom::blink::NetworkContextFilePathsPtr* output) {
  bool success = true;
...
void CustomProxyConnectionObserverInterceptorForTesting::OnTunnelHeadersReceived(::proxy_resolver::mojom::blink::ProxyServerPtr proxy_server, ::network::mojom::blink::HttpResponseHeadersPtr response_headers) {
...
void NetworkContextClientInterceptorForTesting::OnTrustTokenIssuanceDivertedToSystem(::network::mojom::blink::FulfillTrustTokenIssuanceRequestPtr request, OnTrustTokenIssuanceDivertedToSystemCallback callback) {
...
void NetworkContextClientAsyncWaiter::OnTrustTokenIssuanceDivertedToSystem(
  ...
  proxy_->OnTrustTokenIssuanceDivertedToSystem(std::move(request),
      base::BindOnce(
          [](base::RunLoop* loop,
             ::network::mojom::blink::FulfillTrustTokenIssuanceAnswerPtr* out_response
,
             ::network::mojom::blink::FulfillTrustTokenIssuanceAnswerPtr response) {*out_response = std::move(response);
            loop->Quit();
          },
          &loop,
          out_response));
...
void NetworkContextInterceptorForTesting::GetRestrictedCookieManager(::mojo::PendingReceiver<::network::mojom::blink::RestrictedCookieManager> restricted_cookie_manager, ::network::mojom::blink::RestrictedCookieManagerRole role, const ::scoped_refptr<const ::blink::SecurityOrigin>& origin, const ::net::IsolationInfo& isolation_info, ::mojo::PendingRemote<::network::mojom::blink::CookieAccessObserver> cookie_observer) {
...
void NetworkContextInterceptorForTesting::GetTrustTokenQueryAnswerer(::mojo::PendingReceiver<::network::mojom::blink::TrustTokenQueryAnswerer> trust_token_query_answerer, const ::scoped_refptr<const ::blink::SecurityOrigin>& top_frame_origin) {
...
void NetworkContextInterceptorForTesting::NotifyExternalCacheHit(const ::blink::KURL& url, const WTF::String& http_method, ::network::mojom::blink::NetworkIsolationKeyPtr key, bool is_subframe_document_resource, bool include_credentials) {
...
void NetworkContextInterceptorForTesting::SetDocumentReportingEndpoints(const ::base::UnguessableToken& reporting_source, const ::scoped_refptr<const ::blink::SecurityOrigin>& origin, const ::net::IsolationInfo& isolation_info, const WTF::HashMap<WTF::String, WTF::String>& endpoints) {
...
void NetworkContextInterceptorForTesting::QueueReport(const WTF::String& type, const WTF::String& group, const ::blink::KURL& url, const absl::optional<::base::UnguessableToken>& reporting_source, ::network::mojom::blink::NetworkIsolationKeyPtr network_isolation_key, const WTF::String& user_agent, ::base::Value::Dict body) {
...
void NetworkContextInterceptorForTesting::QueueSignedExchangeReport(SignedExchangeReportPtr report, ::network::mojom::blink::NetworkIsolationKeyPtr network_isolation_key) {
...
void NetworkContextInterceptorForTesting::AddExpectCT(const WTF::String& host, ::base::Time expiry, bool enforce, const ::blink::KURL& report_uri, ::network::mojom::blink::NetworkIsolationKeyPtr network_isolation_key, AddExpectCTCallback callback) {
...
void NetworkContextInterceptorForTesting::GetExpectCTState(const WTF::String& domain, ::network::mojom::blink::NetworkIsolationKeyPtr network_isolation_key, GetExpectCTStateCallback callback) {
...
void NetworkContextInterceptorForTesting::CreateWebTransport(const ::blink::KURL& url, const ::scoped_refptr<const ::blink::SecurityOrigin>& origin, ::network::mojom::blink::NetworkIsolationKeyPtr network_isolation_key, WTF::Vector<::network::mojom::blink::WebTransportCertificateFingerprintPtr> fingerprints, ::mojo::PendingRemote<::network::mojom::blink::WebTransportHandshakeClient> handshake_client) {
...
void NetworkContextInterceptorForTesting::CreateP2PSocketManager(::network::mojom::blink::NetworkIsolationKeyPtr network_isolation_key, ::mojo::PendingRemote<::network::mojom::blink::P2PTrustedSocketManagerClient> client, ::mojo::PendingReceiver<::network::mojom::blink::P2PTrustedSocketManager> trusted_socket_manager, ::mojo::PendingReceiver<::network::mojom::blink::P2PSocketManager> socket_manager) {
...
void NetworkContextInterceptorForTesting::VerifyCertForSignedExchange(::network::mojom::blink::X509CertificatePtr certificate, const ::blink::KURL& url, ::network::mojom::blink::NetworkIsolationKeyPtr network_isolation_key, const WTF::String& ocsp_response, const WTF::String& sct_list, VerifyCertForSignedExchangeCallback callback) {
...
void NetworkContextInterceptorForTesting::AddAuthCacheEntry(const ::net::AuthChallengeInfo& challenge, ::network::mojom::blink::NetworkIsolationKeyPtr network_isolation_key, ::network::mojom::blink::AuthCredentialsPtr credentials, AddAuthCacheEntryCallback callback) {
...
void NetworkContextInterceptorForTesting::AddDomainReliabilityContextForTesting(const ::scoped_refptr<const ::blink::SecurityOrigin>& origin, const ::blink::KURL& upload_url, AddDomainReliabilityContextForTestingCallback callback) {
...
void NetworkContextAsyncWaiter::GetStoredTrustTokenCounts(
    WTF::Vector<::network::mojom::blink::StoredTrustTokensForIssuerPtr>* out_tokens) {
  base::RunLoop loop;
  proxy_->GetStoredTrustTokenCounts(
      base::BindOnce(
          [](base::RunLoop* loop,
             WTF::Vector<::network::mojom::blink::StoredTrustTokensForIssuerPtr>* out_tokens
,
             WTF::Vector<::network::mojom::blink::StoredTrustTokensForIssuerPtr> tokens) {*out_tokens = std::move(tokens);
            loop->Quit();
          },
          &loop,
          out_tokens));
...
void NetworkContextAsyncWaiter::DeleteStoredTrustTokens(
  ...
  proxy_->DeleteStoredTrustTokens(std::move(issuer),
      base::BindOnce(
          [](base::RunLoop* loop,
             ::network::mojom::blink::DeleteStoredTrustTokensStatus* out_status
,
             ::network::mojom::blink::DeleteStoredTrustTokensStatus status) {*out_status = std::move(status);
            loop->Quit();
          },
          &loop,
          out_status));
...
void NetworkContextAsyncWaiter::AddExpectCT(
    const WTF::String& host, ::base::Time expiry, bool enforce, const ::blink::KURL& report_uri, ::network::mojom::blink::NetworkIsolationKeyPtr network_isolation_key, bool* out_success) {
  base::RunLoop loop;
...
void NetworkContextAsyncWaiter::GetExpectCTState(
    const WTF::String& domain, ::network::mojom::blink::NetworkIsolationKeyPtr network_isolation_key, ::base::Value::Dict* out_state) {
  base::RunLoop loop;
...
void NetworkContextAsyncWaiter::CreateTCPServerSocket(
    const ::net::IPEndPoint& local_addr, uint32_t backlog, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation, ::mojo::PendingReceiver<::network::mojom::blink::TCPServerSocket> socket, int32_t* out_result, absl::optional<::net::IPEndPoint>* out_local_addr_out) {
  base::RunLoop loop;
...
void NetworkContextAsyncWaiter::VerifyCertForSignedExchange(
    ::network::mojom::blink::X509CertificatePtr certificate, const ::blink::KURL& url, ::network::mojom::blink::NetworkIsolationKeyPtr network_isolation_key, const WTF::String& ocsp_response, const WTF::String& sct_list, int32_t* out_error_code, ::network::mojom::blink::CertVerifyResultPtr* out_cv_result, bool* out_pkp_bypassed, WTF::String* out_pinning_failure_log) {
  base::RunLoop loop;
...
void NetworkContextAsyncWaiter::GetHSTSState(
    const WTF::String& domain, ::base::Value::Dict* out_state) {
  base::RunLoop loop;
...
void NetworkContextAsyncWaiter::AddAuthCacheEntry(
    const ::net::AuthChallengeInfo& challenge, ::network::mojom::blink::NetworkIsolationKeyPtr network_isolation_key, ::network::mojom::blink::AuthCredentialsPtr credentials) {
  base::RunLoop loop;
