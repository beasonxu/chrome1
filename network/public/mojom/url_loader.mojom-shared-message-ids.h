...
constexpr uint32_t kURLLoaderClient_OnReceiveEarlyHints_Name = 0;
constexpr uint32_t kURLLoaderClient_OnReceiveResponse_Name = 1;
constexpr uint32_t kURLLoaderClient_OnReceiveRedirect_Name = 2;
