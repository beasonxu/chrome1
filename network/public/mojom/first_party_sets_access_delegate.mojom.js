...
(function() {
  ...
  FirstPartySetsReadyEvent.validate = function(messageValidator, offset) {
    ...
    // validate FirstPartySetsReadyEvent.customizations
    err = messageValidator.validateMapPointer(offset + codec.kStructHeaderSize + 0, false, new codec.PointerTo(schemeful_site$.SchemefulSite), new codec.NullablePointerTo(first_party_sets$.FirstPartySetEntry), true);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  FirstPartySetsReadyEvent.encodedSize = codec.kStructHeaderSize + 8;
  ...
  FirstPartySetsReadyEvent.decode = function(decoder) {
    ...
    var version = decoder.readUint32();
    val.customizations =
        decoder.decodeMapPointer(new codec.PointerTo(schemeful_site$.SchemefulSite), new codec.NullablePointerTo(first_party_sets$.FirstPartySetEntry));
    return val;
  };
  ...
  FirstPartySetsReadyEvent.encode = function(encoder, val) {
    ...
    encoder.writeUint32(0);
    encoder.encodeMapPointer(new codec.PointerTo(schemeful_site$.SchemefulSite), new codec.NullablePointerTo(first_party_sets$.FirstPartySetEntry), val.customizations);
  };
