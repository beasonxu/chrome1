...
struct network_mojom_internal_PrivateNetworkRequestPolicy_DataHashFn {
  ...
  static bool Equal(const ::network::mojom::PrivateNetworkRequestPolicy& left, const ::network::mojom::PrivateNetworkRequestPolicy& right) {
    return left == right;
  }
...
template <>
struct HashTraits<::network::mojom::PrivateNetworkRequestPolicy>
    : public GenericHashTraits<::network::mojom::PrivateNetworkRequestPolicy> {
  static_assert(true,
  ...
  static void ConstructDeletedValue(::network::mojom::PrivateNetworkRequestPolicy& slot, bool) {
    slot = static_cast<::network::mojom::PrivateNetworkRequestPolicy>(-1000001);
  }
  static bool IsDeletedValue(const ::network::mojom::PrivateNetworkRequestPolicy& value) {
    return value == static_cast<::network::mojom::PrivateNetworkRequestPolicy>(-1000001);
  }
};
}  // namespace WTF
 ...
 public:
  ...
  static WTF::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        ClientSecurityState::DataView, WTF::Vector<uint8_t>>(input);
  }
