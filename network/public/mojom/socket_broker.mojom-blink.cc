...
uint32_t SocketBroker::CreateTcpSocket_Sym::IPCStableHash() {
  ...
  constexpr uint32_t kHash = base::MD5Hash32Constexpr(
          "(Impl)network::mojom::SocketBroker::CreateTcpSocket");
...
void SocketBrokerProxy::CreateTcpSocket(
  ...
  mojo::internal::Serialize<::network::mojom::AddressFamily>(
      in_address_family, &params->address_family);
...
class SocketBroker_CreateTcpSocket_ProxyToResponder : public ::mojo::internal::ProxyToResponder {
 ...
 private:
  ...
  void Run(
      ::mojo::PlatformHandle in_created_socket, int32_t in_rv);
};
...
bool SocketBroker_CreateTcpSocket_ForwardToCallback::Accept(
  ...
  bool success = true;
  ::mojo::PlatformHandle p_created_socket{};
  int32_t p_rv{};
  SocketBroker_CreateTcpSocket_ResponseParamsDataView input_data_view(params, message);
  
  if (success)
    p_created_socket = input_data_view.TakeCreatedSocket();
  if (success)
...
void SocketBroker_CreateTcpSocket_ProxyToResponder::Run(
  ...
  mojo::internal::Serialize<mojo::PlatformHandle>(
      in_created_socket, &params->created_socket, &params.message());
  params->rv = in_rv;
...
void SocketBrokerAsyncWaiter::CreateTcpSocket(
    ::network::mojom::blink::AddressFamily address_family, ::mojo::PlatformHandle* out_created_socket, int32_t* out_rv) {
  base::RunLoop loop;
  proxy_->CreateTcpSocket(std::move(address_family),
      base::BindOnce(
          [](base::RunLoop* loop,
             ::mojo::PlatformHandle* out_created_socket
,
             int32_t* out_rv
,
             ::mojo::PlatformHandle created_socket,
