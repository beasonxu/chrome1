...
void NetLogExporterInterceptorForTesting::Start(::base::File destination, ::base::Value::Dict extra_constants, ::net::NetLogCaptureMode capture_mode, uint64_t max_file_size, StartCallback callback) {
...
void NetLogProxySinkInterceptorForTesting::AddEntry(uint32_t type, uint32_t source_type, uint32_t source_id, ::base::TimeTicks source_start_time, ::net::NetLogEventPhase phase, ::base::TimeTicks time, ::base::Value params) {
