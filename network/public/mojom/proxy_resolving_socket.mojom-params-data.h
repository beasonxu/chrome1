...
static_assert(sizeof(ProxyResolvingSocketFactory_CreateProxyResolvingSocket_Params_Data) == 56,
...
inline void ProxyResolvingSocketFactory_CreateProxyResolvingSocket_ParamsDataView::GetNetworkIsolationKeyDataView(
    ::network::mojom::NetworkIsolationKeyDataView* output) {
  auto pointer = data_->network_isolation_key.Get();
