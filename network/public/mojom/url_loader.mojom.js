...
(function() {
  ...
  var kURLLoaderClient_OnReceiveCachedMetadata_Name = 4;
  var kURLLoaderClient_OnTransferSizeUpdated_Name = 5;
  ...
  URLLoaderClientProxy.prototype.onReceiveResponse = function(head, body) {
  ...
  URLLoaderClientStub.prototype.onReceiveResponse = function(head, body) {
    return this.delegate_ && this.delegate_.onReceiveResponse && this.delegate_.onReceiveResponse(head, body);
  }
  ...
  URLLoaderClientStub.prototype.accept = function(message) {
    ...
    case kURLLoaderClient_OnReceiveResponse_Name:
      ...
      this.onReceiveResponse(params.head, params.body);
      return true;
