...
// with not having this data in traces there.
  ...
  virtual void NotifyExternalCacheHit(const ::GURL& url, const std::string& http_method, const ::net::NetworkIsolationKey& key, bool is_subframe_document_resource, bool include_credentials) = 0;
  ...
  virtual void QueueReport(const std::string& type, const std::string& group, const ::GURL& url, const absl::optional<::base::UnguessableToken>& reporting_source, const ::net::NetworkIsolationKey& network_isolation_key, const absl::optional<std::string>& user_agent, ::base::Value::Dict body) = 0;

  
  virtual void QueueSignedExchangeReport(SignedExchangeReportPtr report, const ::net::NetworkIsolationKey& network_isolation_key) = 0;
  ...
  virtual void CreateTCPConnectedSocket(const absl::optional<::net::IPEndPoint>& local_addr, const ::net::AddressList& remote_addr_list, ::network::mojom::TCPConnectedSocketOptionsPtr tcp_connected_socket_options, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation, ::mojo::PendingReceiver<::network::mojom::TCPConnectedSocket> socket, ::mojo::PendingRemote<::network::mojom::SocketObserver> observer, CreateTCPConnectedSocketCallback callback) = 0;
  ...
  virtual void CreateWebSocket(const ::GURL& url, const std::vector<std::string>& requested_protocols, const ::net::SiteForCookies& site_for_cookies, const ::net::IsolationInfo& isolation_info, std::vector<::network::mojom::HttpHeaderPtr> additional_headers, int32_t process_id, const ::url::Origin& origin, uint32_t options, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation, ::mojo::PendingRemote<::network::mojom::WebSocketHandshakeClient> handshake_client, ::mojo::PendingRemote<::network::mojom::URLLoaderNetworkServiceObserver> url_loader_network_observer, ::mojo::PendingRemote<::network::mojom::WebSocketAuthenticationHandler> auth_handler, ::mojo::PendingRemote<TrustedHeaderClient> header_client, const absl::optional<::base::UnguessableToken>& throttling_profile_id) = 0;

  
  virtual void CreateWebTransport(const ::GURL& url, const ::url::Origin& origin, const ::net::NetworkIsolationKey& network_isolation_key, std::vector<::network::mojom::WebTransportCertificateFingerprintPtr> fingerprints, ::mojo::PendingRemote<::network::mojom::WebTransportHandshakeClient> handshake_client) = 0;
  ...
  virtual void VerifyCertForSignedExchange(const ::scoped_refptr<::net::X509Certificate>& certificate, const ::GURL& url, const ::net::NetworkIsolationKey& network_isolation_key, const std::string& ocsp_response, const std::string& sct_list, VerifyCertForSignedExchangeCallback callback) = 0;
...
class  NetworkContextProxy
 ...
 public:
  ...
  void NotifyExternalCacheHit(const ::GURL& url, const std::string& http_method, const ::net::NetworkIsolationKey& key, bool is_subframe_document_resource, bool include_credentials) final;
  ...
  void QueueReport(const std::string& type, const std::string& group, const ::GURL& url, const absl::optional<::base::UnguessableToken>& reporting_source, const ::net::NetworkIsolationKey& network_isolation_key, const absl::optional<std::string>& user_agent, ::base::Value::Dict body) final;
  
  void QueueSignedExchangeReport(SignedExchangeReportPtr report, const ::net::NetworkIsolationKey& network_isolation_key) final;
  ...
  void CreateWebTransport(const ::GURL& url, const ::url::Origin& origin, const ::net::NetworkIsolationKey& network_isolation_key, std::vector<::network::mojom::WebTransportCertificateFingerprintPtr> fingerprints, ::mojo::PendingRemote<::network::mojom::WebTransportHandshakeClient> handshake_client) final;
  ...
  void VerifyCertForSignedExchange(const ::scoped_refptr<::net::X509Certificate>& certificate, const ::GURL& url, const ::net::NetworkIsolationKey& network_isolation_key, const std::string& ocsp_response, const std::string& sct_list, VerifyCertForSignedExchangeCallback callback) final;
...
class  NetworkContextParams {
 public:
  ...
  NetworkContextParams(
      ...
      const absl::optional<::net::ProxyConfigWithAnnotation>& initial_proxy_config,
...
struct  StructTraits<::network::mojom::NetworkContextParams::DataView,
  ...
  static  decltype(::network::mojom::NetworkContextParams::http_cache_directory)& http_cache_directory(
       ::network::mojom::NetworkContextParamsPtr& input) {
  ...
  static  decltype(::network::mojom::NetworkContextParams::socket_broker)& socket_broker(
       ::network::mojom::NetworkContextParamsPtr& input) {
