...
class TCPConnectedSocket_UpgradeToTLS_ProxyToResponder : public ::mojo::internal::ProxyToResponder {
 ...
 private:
  ...
  void Run(
      int32_t in_net_error, ::mojo::ScopedDataPipeConsumerHandle in_receive_stream, ::mojo::ScopedDataPipeProducerHandle in_send_stream, const absl::optional<::net::SSLInfo>& in_ssl_info);
};
...
bool TCPConnectedSocket_UpgradeToTLS_ForwardToCallback::Accept(
  ...
  ::mojo::ScopedDataPipeConsumerHandle p_receive_stream{};
  ::mojo::ScopedDataPipeProducerHandle p_send_stream{};
  absl::optional<::net::SSLInfo> p_ssl_info{};
...
,
             ::mojo::ScopedDataPipeProducerHandle* out_send_stream
,
             absl::optional<::net::SSLInfo>* out_ssl_info
,
             int32_t net_error,
             ::mojo::ScopedDataPipeConsumerHandle receive_stream,
             ::mojo::ScopedDataPipeProducerHandle send_stream,
             const absl::optional<::net::SSLInfo>& ssl_info) {*out_net_error = std::move(net_error);*out_receive_stream = std::move(receive_stream);*out_send_stream = std::move(send_stream);*out_ssl_info = std::move(ssl_info);
            loop->Quit();
          },
          &loop,
          out_net_error,
