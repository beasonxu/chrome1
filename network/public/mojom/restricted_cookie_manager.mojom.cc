...
# endif // !BUILDFLAG(IS_FUCHSIA)
bool RestrictedCookieManager::SetCookieFromString(const ::GURL& url, const ::net::SiteForCookies& site_for_cookies, const ::url::Origin& top_frame_origin, const std::string& cookie, bool partitioned_cookies_runtime_feature_enabled, bool* out_site_for_cookies_ok, bool* out_top_frame_origin_ok) {
  NOTREACHED();
  return false;
}
bool RestrictedCookieManager::GetCookiesString(const ::GURL& url, const ::net::SiteForCookies& site_for_cookies, const ::url::Origin& top_frame_origin, bool partitioned_cookies_runtime_feature_enabled, std::string* out_cookies) {
  NOTREACHED();
  return false;
}
...
void RestrictedCookieManagerProxy::GetAllForUrl(
    const ::GURL& in_url, const ::net::SiteForCookies& in_site_for_cookies, const ::url::Origin& in_top_frame_origin, CookieManagerGetOptionsPtr in_options, bool in_partitioned_cookies_runtime_feature_enabled, GetAllForUrlCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void RestrictedCookieManagerProxy::SetCanonicalCookie(
    const ::net::CanonicalCookie& in_cookie, const ::GURL& in_url, const ::net::SiteForCookies& in_site_for_cookies, const ::url::Origin& in_top_frame_origin, ::net::CookieInclusionStatus in_status, SetCanonicalCookieCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
bool RestrictedCookieManagerProxy::SetCookieFromString(
    const ::GURL& param_url, const ::net::SiteForCookies& param_site_for_cookies, const ::url::Origin& param_top_frame_origin, const std::string& param_cookie, bool param_partitioned_cookies_runtime_feature_enabled, bool* out_param_site_for_cookies_ok, bool* out_param_top_frame_origin_ok) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT_BEGIN1(
...
void RestrictedCookieManagerProxy::SetCookieFromString(
    const ::GURL& in_url, const ::net::SiteForCookies& in_site_for_cookies, const ::url::Origin& in_top_frame_origin, const std::string& in_cookie, bool in_partitioned_cookies_runtime_feature_enabled, SetCookieFromStringCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
bool RestrictedCookieManagerProxy::GetCookiesString(
    const ::GURL& param_url, const ::net::SiteForCookies& param_site_for_cookies, const ::url::Origin& param_top_frame_origin, bool param_partitioned_cookies_runtime_feature_enabled, std::string* out_param_cookies) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT_BEGIN1(
...
void RestrictedCookieManagerProxy::GetCookiesString(
    const ::GURL& in_url, const ::net::SiteForCookies& in_site_for_cookies, const ::url::Origin& in_top_frame_origin, bool in_partitioned_cookies_runtime_feature_enabled, GetCookiesStringCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void RestrictedCookieManagerInterceptorForTesting::GetAllForUrl(const ::GURL& url, const ::net::SiteForCookies& site_for_cookies, const ::url::Origin& top_frame_origin, CookieManagerGetOptionsPtr options, bool partitioned_cookies_runtime_feature_enabled, GetAllForUrlCallback callback) {
...
void RestrictedCookieManagerInterceptorForTesting::SetCanonicalCookie(const ::net::CanonicalCookie& cookie, const ::GURL& url, const ::net::SiteForCookies& site_for_cookies, const ::url::Origin& top_frame_origin, ::net::CookieInclusionStatus status, SetCanonicalCookieCallback callback) {
...
void RestrictedCookieManagerInterceptorForTesting::SetCookieFromString(const ::GURL& url, const ::net::SiteForCookies& site_for_cookies, const ::url::Origin& top_frame_origin, const std::string& cookie, bool partitioned_cookies_runtime_feature_enabled, SetCookieFromStringCallback callback) {
...
void RestrictedCookieManagerInterceptorForTesting::GetCookiesString(const ::GURL& url, const ::net::SiteForCookies& site_for_cookies, const ::url::Origin& top_frame_origin, bool partitioned_cookies_runtime_feature_enabled, GetCookiesStringCallback callback) {
