...
class LoadTimingInfoConnectTimingDataView {
 public:
  ...
  [[nodiscard]] bool ReadDnsStart(UserType* output) {
  ...
  template <typename UserType>
  [[nodiscard]] bool ReadDnsEnd(UserType* output) {
...
struct Serializer<::network::mojom::LoadTimingInfoConnectTimingDataView, MaybeConstUserType> {
  ...
  static void Serialize(
    ...
    mojo::internal::MessageFragment<
        typename decltype(fragment->dns_start)::BaseType> dns_start_fragment(
            fragment.message());
    mojo::internal::Serialize<::mojo_base::mojom::TimeTicksDataView>(
        in_dns_start, dns_start_fragment);
    fragment->dns_start.Set(
        dns_start_fragment.is_null() ? nullptr : dns_start_fragment.data());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        fragment->dns_start.is_null(),
    ...
    mojo::internal::MessageFragment<
        typename decltype(fragment->dns_end)::BaseType> dns_end_fragment(
            fragment.message());
    mojo::internal::Serialize<::mojo_base::mojom::TimeTicksDataView>(
        in_dns_end, dns_end_fragment);
    fragment->dns_end.Set(
        dns_end_fragment.is_null() ? nullptr : dns_end_fragment.data());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        fragment->dns_end.is_null(),
        mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER,
