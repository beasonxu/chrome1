            ...
            try {
                ...
                switch(header.getType()) {
                    ...
                    case ON_RAW_REQUEST_ORDINAL: {
                        ...
                        getImpl().onRawRequest(data.devtoolRequestId, data.cookiesWithAccessResult, data.headers, data.timestamp, data.clientSecurityState);
                        return true;
                    }
                    ...
                    case ON_RAW_RESPONSE_ORDINAL: {
                        ...
                        getImpl().onRawResponse(data.devtoolRequestId, data.cookiesWithAccessResult, data.headers, data.rawResponseHeaders, data.resourceAddressSpace, data.httpStatusCode);
                        return true;
                    }
