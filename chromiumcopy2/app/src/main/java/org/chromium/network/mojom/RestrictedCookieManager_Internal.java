...
org.chromium.url.mojom.Url url) {
    ...
    static final class RestrictedCookieManagerSetCookieFromStringResponseParams extends org.chromium.mojo.bindings.Struct {
        ...
        private static final org.chromium.mojo.bindings.DataHeader[] VERSION_ARRAY = new org.chromium.mojo.bindings.DataHeader[] {new org.chromium.mojo.bindings.DataHeader(16, 0)};
        private static final org.chromium.mojo.bindings.DataHeader DEFAULT_STRUCT_INFO = VERSION_ARRAY[0];
        public boolean siteForCookiesOk;
        public boolean topFrameOriginOk;
        ...
        public static RestrictedCookieManagerSetCookieFromStringResponseParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
            ...
            try {
                ...
                result = new RestrictedCookieManagerSetCookieFromStringResponseParams(elementsOrVersion);
                    ...
                    result.siteForCookiesOk = decoder0.readBoolean(8, 0);
                    }
                    {
                        
                    result.topFrameOriginOk = decoder0.readBoolean(8, 1);
                    }
        ...
        protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
            ...
            encoder0.encode(this.siteForCookiesOk, 8, 0);
            
            encoder0.encode(this.topFrameOriginOk, 8, 1);
        }
    }
    ...
    static class RestrictedCookieManagerSetCookieFromStringResponseParamsForwardToCallback extends org.chromium.mojo.bindings.SideEffectFreeCloseable
        ...
        public boolean accept(org.chromium.mojo.bindings.Message message) {
            try {
                ...
                RestrictedCookieManagerSetCookieFromStringResponseParams response = RestrictedCookieManagerSetCookieFromStringResponseParams.deserialize(messageWithHeader.getPayload());

                mCallback.call(response.siteForCookiesOk, response.topFrameOriginOk);
                return true;
            } catch (org.chromium.mojo.bindings.DeserializationException e) {
                return false;
            }
    ...
    static class RestrictedCookieManagerSetCookieFromStringResponseParamsProxyToResponder implements RestrictedCookieManager.SetCookieFromString_Response {
        ...
        @Override
        public void call(Boolean siteForCookiesOk, Boolean topFrameOriginOk) {
            ...
            _response.siteForCookiesOk = siteForCookiesOk;

            _response.topFrameOriginOk = topFrameOriginOk;
