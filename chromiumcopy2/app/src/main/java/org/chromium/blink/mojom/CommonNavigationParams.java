...
public final class CommonNavigationParams extends org.chromium.mojo.bindings.Struct {
    ...
    public static CommonNavigationParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
        ...
        try {
            ...
            result = new CommonNavigationParams(elementsOrVersion);
                ...
                result.navigationType = decoder0.readInt(36);
                ...
                result.shouldCheckMainWorldCsp = decoder0.readInt(52);
                ...
                result.initiatorOriginTrialFeatures = decoder0.readInts(96, org.chromium.mojo.bindings.BindingsHelper.NOTHING_NULLABLE, org.chromium.mojo.bindings.BindingsHelper.UNSPECIFIED_ARRAY_LENGTH);
                }
                {
                    
                result.hrefTranslate = decoder0.readString(104, false);
                }
                {
                ...
                result.requestDestination = decoder0.readInt(120);
    ...
    protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
        ...
        encoder0.encode(this.downloadPolicy, 40, false);
        ...
        encoder0.encode(this.shouldCheckMainWorldCsp, 52);
        
        encoder0.encode(this.baseUrlForDataUrl, 56, false);
        
        encoder0.encode(this.navigationStart, 64, false);
        
        encoder0.encode(this.method, 72, false);
        
        encoder0.encode(this.postData, 80, true);
        
        encoder0.encode(this.sourceLocation, 88, false);
        
        encoder0.encode(this.initiatorOriginTrialFeatures, 96, org.chromium.mojo.bindings.BindingsHelper.NOTHING_NULLABLE, org.chromium.mojo.bindings.BindingsHelper.UNSPECIFIED_ARRAY_LENGTH);
        
        encoder0.encode(this.hrefTranslate, 104, false);
        
        encoder0.encode(this.inputStart, 112, false);
        
        encoder0.encode(this.requestDestination, 120);
    }
}