// SharedStorageUrlWithMetadata.java is auto generated by mojom_bindings_generator.py, do not edit
...
public final class SharedStorageUrlWithMetadata extends org.chromium.mojo.bindings.Struct {

    private static final int STRUCT_SIZE = 24;
    private static final org.chromium.mojo.bindings.DataHeader[] VERSION_ARRAY = new org.chromium.mojo.bindings.DataHeader[] {new org.chromium.mojo.bindings.DataHeader(24, 0)};
    private static final org.chromium.mojo.bindings.DataHeader DEFAULT_STRUCT_INFO = VERSION_ARRAY[0];
    public org.chromium.url.mojom.Url url;
    public java.util.Map<String, org.chromium.url.mojom.Url> reportingMetadata;

    private SharedStorageUrlWithMetadata(int version) {
    ...
    public static SharedStorageUrlWithMetadata deserialize(org.chromium.mojo.bindings.Message message) {
     ...
     */
    public static SharedStorageUrlWithMetadata deserialize(java.nio.ByteBuffer data) {
        return deserialize(new org.chromium.mojo.bindings.Message(
                data, new java.util.ArrayList<org.chromium.mojo.system.Handle>()));
    }

    @SuppressWarnings("unchecked")
    public static SharedStorageUrlWithMetadata decode(org.chromium.mojo.bindings.Decoder decoder0) {
        if (decoder0 == null) {
            return null;
        }
        decoder0.increaseStackDepth();
        SharedStorageUrlWithMetadata result;
        try {
            org.chromium.mojo.bindings.DataHeader mainDataHeader = decoder0.readAndValidateDataHeader(VERSION_ARRAY);
            final int elementsOrVersion = mainDataHeader.elementsOrVersion;
            result = new SharedStorageUrlWithMetadata(elementsOrVersion);
                {
                ...
                org.chromium.mojo.bindings.Decoder decoder1 = decoder0.readPointer(16, false);
                {
                    ...
                    String[] keys0;
                    org.chromium.url.mojom.Url[] values0;
                    {
                    ...
                    }
                    {
                        ...
                        org.chromium.mojo.bindings.Decoder decoder2 = decoder1.readPointer(org.chromium.mojo.bindings.DataHeader.HEADER_SIZE + org.chromium.mojo.bindings.BindingsHelper.POINTER_SIZE, false);
                        {
                            ...
                            values0 = new org.chromium.url.mojom.Url[si2.elementsOrVersion];
                            for (int i2 = 0; i2 < si2.elementsOrVersion; ++i2) {
                                ...
                                values0[i2] = org.chromium.url.mojom.Url.decode(decoder3);
                            }
                        }
                    }
                    result.reportingMetadata = new java.util.HashMap<String, org.chromium.url.mojom.Url>();
                    for (int index0 = 0; index0 < keys0.length; ++index0) {
                        result.reportingMetadata.put(keys0[index0],  values0[index0]);
                    }
                }
                }
    ...
    protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
        ...
        if (this.reportingMetadata == null) {
            ...
            int size0 = this.reportingMetadata.size();
            String[] keys0 = new String[size0];
            org.chromium.url.mojom.Url[] values0 = new org.chromium.url.mojom.Url[size0];
            int index0 = 0;
            for (java.util.Map.Entry<String, org.chromium.url.mojom.Url> entry0 : this.reportingMetadata.entrySet()) {
