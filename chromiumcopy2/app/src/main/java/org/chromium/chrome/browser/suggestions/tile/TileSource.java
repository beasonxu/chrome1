...
@IntDef({
    TileSource.TOP_SITES, TileSource.POPULAR, TileSource.POPULAR_BAKED_IN, TileSource.CUSTOM_LINKS,
    TileSource.ALLOWLIST, TileSource.HOMEPAGE, TileSource.EXPLORE, TileSource.LAST
})
