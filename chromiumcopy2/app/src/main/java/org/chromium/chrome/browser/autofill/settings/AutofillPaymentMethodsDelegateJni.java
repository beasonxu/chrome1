...
class AutofillPaymentMethodsDelegateJni implements AutofillPaymentMethodsDelegate.Natives {
  ...
  public void enrollOfferedVirtualCard(long nativeAutofillPaymentMethodsDelegate,
    ...
    GEN_JNI.org_chromium_chrome_browser_autofill_settings_AutofillPaymentMethodsDelegate_enrollOfferedVirtualCard(nativeAutofillPaymentMethodsDelegate, virtualCardEnrollmentUpdateResponseCallback);
  }

  @Override
  public void unenrollVirtualCard(long nativeAutofillPaymentMethodsDelegate, long instrumentId,
      Callback<Boolean> virtualCardEnrollmentUpdateResponseCallback) {
    GEN_JNI.org_chromium_chrome_browser_autofill_settings_AutofillPaymentMethodsDelegate_unenrollVirtualCard(nativeAutofillPaymentMethodsDelegate, instrumentId, virtualCardEnrollmentUpdateResponseCallback);
  }
