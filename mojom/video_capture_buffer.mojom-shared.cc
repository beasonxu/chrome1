...
bool VideoBufferHandle_Data::Validate(
  ...
  switch (object->tag) {
    ...
    case VideoBufferHandle_Tag::kSharedMemoryViaRawFileDescriptor: {
...
bool MailboxBufferHandleSet_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const MailboxBufferHandleSet_Data* object =
      static_cast<const MailboxBufferHandleSet_Data*>(data);
...
bool SharedMemoryViaRawFileDescriptor_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const SharedMemoryViaRawFileDescriptor_Data* object =
      static_cast<const SharedMemoryViaRawFileDescriptor_Data*>(data);
