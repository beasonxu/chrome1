...
size_t AxisChange::Hash(size_t seed) const {
  seed = mojo::internal::Hash(seed, this->axis_index);
  seed = mojo::internal::Hash(seed, this->axis_snapshot);
  return seed;
}
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type std::vector<ButtonChangePtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type std::vector<AxisChangePtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
size_t GamepadEffectParameters::Hash(size_t seed) const {
  ...
  seed = mojo::internal::Hash(seed, this->left_trigger);
  seed = mojo::internal::Hash(seed, this->right_trigger);
  return seed;
}
...
bool StructTraits<::device::mojom::ButtonChange::DataView, ::device::mojom::ButtonChangePtr>::Read(
  ...
  bool success = true;
  ::device::mojom::ButtonChangePtr result(::device::mojom::ButtonChange::New());
...
bool StructTraits<::device::mojom::AxisChange::DataView, ::device::mojom::AxisChangePtr>::Read(
  ...
  bool success = true;
  ::device::mojom::AxisChangePtr result(::device::mojom::AxisChange::New());
...
bool StructTraits<::device::mojom::GamepadChanges::DataView, ::device::mojom::GamepadChangesPtr>::Read(
  ...
  bool success = true;
  ::device::mojom::GamepadChangesPtr result(::device::mojom::GamepadChanges::New());
