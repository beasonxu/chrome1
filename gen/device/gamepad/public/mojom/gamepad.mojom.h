...
class COMPONENT_EXPORT(GAMEPAD_MOJOM) AxisChange {
 public:
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        AxisChange::DataView, std::vector<uint8_t>>(input);
  }
...
class COMPONENT_EXPORT(GAMEPAD_MOJOM) ButtonChange {
 public:
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        ButtonChange::DataView, std::vector<uint8_t>>(input);
  }
...
class COMPONENT_EXPORT(GAMEPAD_MOJOM) GamepadChanges {
 public:
  ...
  GamepadChanges(
      ...
      std::vector<ButtonChangePtr> button_changes,
      std::vector<AxisChangePtr> axis_changes,
      int64_t timestamp);
...
GamepadChanges& operator=(const GamepadChanges&) = delete;
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        GamepadChanges::DataView, std::vector<uint8_t>>(input);
  }
...
struct COMPONENT_EXPORT(GAMEPAD_MOJOM) StructTraits<::device::mojom::ButtonChange::DataView,
  ...
  static bool IsNull(const ::device::mojom::ButtonChangePtr& input) { return !input; }
  static void SetToNull(::device::mojom::ButtonChangePtr* output) { output->reset(); }

  static decltype(::device::mojom::ButtonChange::button_index) button_index(
      const ::device::mojom::ButtonChangePtr& input) {
    return input->button_index;
  }

  static decltype(::device::mojom::ButtonChange::button_down) button_down(
      const ::device::mojom::ButtonChangePtr& input) {
    return input->button_down;
  }

  static decltype(::device::mojom::ButtonChange::button_up) button_up(
      const ::device::mojom::ButtonChangePtr& input) {
    return input->button_up;
  }

  static decltype(::device::mojom::ButtonChange::value_changed) value_changed(
      const ::device::mojom::ButtonChangePtr& input) {
    return input->value_changed;
  }

  static const decltype(::device::mojom::ButtonChange::button_snapshot)& button_snapshot(
      const ::device::mojom::ButtonChangePtr& input) {
    return input->button_snapshot;
  }

  static bool Read(::device::mojom::ButtonChange::DataView input, ::device::mojom::ButtonChangePtr* output);
};
...
struct COMPONENT_EXPORT(GAMEPAD_MOJOM) StructTraits<::device::mojom::AxisChange::DataView,
  ...
  static bool IsNull(const ::device::mojom::AxisChangePtr& input) { return !input; }
  static void SetToNull(::device::mojom::AxisChangePtr* output) { output->reset(); }

  static decltype(::device::mojom::AxisChange::axis_index) axis_index(
      const ::device::mojom::AxisChangePtr& input) {
    return input->axis_index;
  }

  static decltype(::device::mojom::AxisChange::axis_snapshot) axis_snapshot(
      const ::device::mojom::AxisChangePtr& input) {
    return input->axis_snapshot;
  }

  static bool Read(::device::mojom::AxisChange::DataView input, ::device::mojom::AxisChangePtr* output);
};
...
struct COMPONENT_EXPORT(GAMEPAD_MOJOM) StructTraits<::device::mojom::GamepadChanges::DataView,
  ...
  static bool IsNull(const ::device::mojom::GamepadChangesPtr& input) { return !input; }
  static void SetToNull(::device::mojom::GamepadChangesPtr* output) { output->reset(); }

  static decltype(::device::mojom::GamepadChanges::gamepad_index) gamepad_index(
      const ::device::mojom::GamepadChangesPtr& input) {
    return input->gamepad_index;
  }

  static const decltype(::device::mojom::GamepadChanges::button_changes)& button_changes(
      const ::device::mojom::GamepadChangesPtr& input) {
    return input->button_changes;
  }

  static const decltype(::device::mojom::GamepadChanges::axis_changes)& axis_changes(
      const ::device::mojom::GamepadChangesPtr& input) {
    return input->axis_changes;
  }

  static decltype(::device::mojom::GamepadChanges::timestamp) timestamp(
      const ::device::mojom::GamepadChangesPtr& input) {
    return input->timestamp;
  }

  static bool Read(::device::mojom::GamepadChanges::DataView input, ::device::mojom::GamepadChangesPtr* output);
};
