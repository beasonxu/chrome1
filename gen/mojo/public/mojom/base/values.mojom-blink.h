...
DeprecatedDictionaryValue& operator=(const DeprecatedDictionaryValue&) = delete;
  ...
  static WTF::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        DeprecatedDictionaryValue::DataView, WTF::Vector<uint8_t>>(input);
  }
...
template <>
struct COMPONENT_EXPORT(MOJO_BASE_MOJOM_BLINK) StructTraits<::mojo_base::mojom::blink::DeprecatedDictionaryValue::DataView,
                                         ::mojo_base::mojom::blink::DeprecatedDictionaryValuePtr> {
  ...
  static const decltype(::mojo_base::mojom::blink::DeprecatedDictionaryValue::storage)& storage(
      const ::mojo_base::mojom::blink::DeprecatedDictionaryValuePtr& input) {
    return input->storage;
  }
