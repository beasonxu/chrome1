...
static_assert(sizeof(VmRegion_Data) == 120,
...
class COMPONENT_EXPORT(RESOURCE_COORDINATOR_PUBLIC_MOJOM_SHARED) AllocatorMemDump_Data {
 public:
  ...
  mojo::internal::Pointer<mojo::internal::Map_Data<mojo::internal::Pointer<mojo::internal::String_Data>, mojo::internal::Pointer<internal::AllocatorMemDump_Data>>> children;
...
static_assert(sizeof(AllocatorMemDump_Data) == 24,
