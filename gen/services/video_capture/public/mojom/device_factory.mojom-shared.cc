...
bool DeviceFactory_GetDeviceInfos_Params_Data::Validate(
  ...
  [[maybe_unused]] const DeviceFactory_GetDeviceInfos_Params_Data* object =
      static_cast<const DeviceFactory_GetDeviceInfos_Params_Data*>(data);
...
bool DeviceFactory_GetDeviceInfos_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const DeviceFactory_GetDeviceInfos_ResponseParams_Data* object =
      static_cast<const DeviceFactory_GetDeviceInfos_ResponseParams_Data*>(data);
...
bool DeviceFactory_CreateDevice_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const DeviceFactory_CreateDevice_Params_Data* object =
      static_cast<const DeviceFactory_CreateDevice_Params_Data*>(data);
...
bool DeviceFactory_CreateDevice_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const DeviceFactory_CreateDevice_ResponseParams_Data* object =
      static_cast<const DeviceFactory_CreateDevice_ResponseParams_Data*>(data);
...
bool DeviceFactory_AddSharedMemoryVirtualDevice_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const DeviceFactory_AddSharedMemoryVirtualDevice_Params_Data* object =
      static_cast<const DeviceFactory_AddSharedMemoryVirtualDevice_Params_Data*>(data);
...
bool DeviceFactory_AddTextureVirtualDevice_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const DeviceFactory_AddTextureVirtualDevice_Params_Data* object =
      static_cast<const DeviceFactory_AddTextureVirtualDevice_Params_Data*>(data);
...
bool DeviceFactory_AddGpuMemoryBufferVirtualDevice_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const DeviceFactory_AddGpuMemoryBufferVirtualDevice_Params_Data* object =
      static_cast<const DeviceFactory_AddGpuMemoryBufferVirtualDevice_Params_Data*>(data);
...
bool DeviceFactory_RegisterVirtualDevicesChangedObserver_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const DeviceFactory_RegisterVirtualDevicesChangedObserver_Params_Data* object =
      static_cast<const DeviceFactory_RegisterVirtualDevicesChangedObserver_Params_Data*>(data);
