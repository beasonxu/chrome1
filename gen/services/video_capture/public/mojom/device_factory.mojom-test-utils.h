...
class  DeviceFactoryInterceptorForTesting : public DeviceFactory {
  ...
  void AddGpuMemoryBufferVirtualDevice(const ::media::VideoCaptureDeviceInfo& device_info, ::mojo::PendingReceiver<::video_capture::mojom::GpuMemoryBufferVirtualDevice> virtual_device_receiver) override;
...
class  DeviceFactoryAsyncWaiter {
 public:
  ...
  DeviceFactoryAsyncWaiter(const DeviceFactoryAsyncWaiter&) = delete;
  DeviceFactoryAsyncWaiter& operator=(const DeviceFactoryAsyncWaiter&) = delete;
