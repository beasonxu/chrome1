...
bool TextureVirtualDevice_OnNewMailboxHolderBufferHandle_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const TextureVirtualDevice_OnNewMailboxHolderBufferHandle_Params_Data* object =
      static_cast<const TextureVirtualDevice_OnNewMailboxHolderBufferHandle_Params_Data*>(data);
...
// static
bool TextureVirtualDevice_OnFrameAccessHandlerReady_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
...
// static
bool GpuMemoryBufferVirtualDevice_OnFrameAccessHandlerReady_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
