...
struct Serializer<::data_decoder::mojom::WebBundlerError, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    return Traits::FromMojom(::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::data_decoder::mojom::WebBundlerError>(input)), output);
  }
};
...
template <>
struct  TraceFormatTraits<::data_decoder::mojom::WebBundlerError> {
 static void WriteIntoTrace(perfetto::TracedValue context, ::data_decoder::mojom::WebBundlerError value);
};
