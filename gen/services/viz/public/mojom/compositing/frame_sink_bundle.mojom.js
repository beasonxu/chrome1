...
(function() {
  ...
  function FrameSinkBundle_SetThreadIds_Params(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  FrameSinkBundle_SetThreadIds_Params.prototype.initDefaults_ = function() {
    this.sinkId = 0;
    this.threadIds = null;
  };
  FrameSinkBundle_SetThreadIds_Params.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  FrameSinkBundle_SetThreadIds_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    // validate FrameSinkBundle_SetThreadIds_Params.threadIds
  ...
  FrameSinkBundle_SetThreadIds_Params.encodedSize = codec.kStructHeaderSize + 16;

  FrameSinkBundle_SetThreadIds_Params.decode = function(decoder) {
    var packed;
    var val = new FrameSinkBundle_SetThreadIds_Params();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.sinkId =
        decoder.decodeStruct(codec.Uint32);
  ...
  FrameSinkBundle_SetThreadIds_Params.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(FrameSinkBundle_SetThreadIds_Params.encodedSize);
    encoder.writeUint32(0);
    encoder.encodeStruct(codec.Uint32, val.sinkId);
    encoder.skip(1);
    encoder.skip(1);
  ...
  var kFrameSinkBundle_SetThreadIds_Name = 4;
  ...
  FrameSinkBundlePtr.prototype.setThreadIds = function() {
    return FrameSinkBundleProxy.prototype.setThreadIds
        .apply(this.ptr.getProxy(), arguments);
  };

  FrameSinkBundleProxy.prototype.setThreadIds = function(sinkId, threadIds) {
    var params_ = new FrameSinkBundle_SetThreadIds_Params();
    params_.sinkId = sinkId;
    params_.threadIds = threadIds;
    var builder = new codec.MessageV0Builder(
        kFrameSinkBundle_SetThreadIds_Name,
        codec.align(FrameSinkBundle_SetThreadIds_Params.encodedSize));
    builder.encodeStruct(FrameSinkBundle_SetThreadIds_Params, params_);
    var message = builder.finish();
    this.receiver_.accept(message);
  };
  ...
  FrameSinkBundleStub.prototype.setThreadIds = function(sinkId, threadIds) {
    return this.delegate_ && this.delegate_.setThreadIds && this.delegate_.setThreadIds(sinkId, threadIds);
  }
  ...
  FrameSinkBundleStub.prototype.accept = function(message) {
    ...
    case kFrameSinkBundle_DidAllocateSharedBitmap_Name:
      ...
      return true;
    case kFrameSinkBundle_SetThreadIds_Name:
      var params = reader.decodeStruct(FrameSinkBundle_SetThreadIds_Params);
      this.setThreadIds(params.sinkId, params.threadIds);
      return true;
    default:
      return false;
    }
  ...
  function validateFrameSinkBundleRequest(messageValidator) {
    ...
    switch (message.getName()) {
      ...
      case kFrameSinkBundle_SetThreadIds_Name:
        if (!message.expectsResponse() && !message.isResponse())
          paramsClass = FrameSinkBundle_SetThreadIds_Params;
      break;
    }
    if (paramsClass === null)
      return validator.validationError.NONE;
