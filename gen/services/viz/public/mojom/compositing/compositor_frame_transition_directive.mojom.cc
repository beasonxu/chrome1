...
// static
bool StructTraits<::viz::mojom::CompositorFrameTransitionDirectiveConfig::DataView, ::viz::mojom::CompositorFrameTransitionDirectiveConfigPtr>::Read(
    ::viz::mojom::CompositorFrameTransitionDirectiveConfig::DataView input,
    ::viz::mojom::CompositorFrameTransitionDirectiveConfigPtr* output) {
  bool success = true;
  ::viz::mojom::CompositorFrameTransitionDirectiveConfigPtr result(::viz::mojom::CompositorFrameTransitionDirectiveConfig::New());
