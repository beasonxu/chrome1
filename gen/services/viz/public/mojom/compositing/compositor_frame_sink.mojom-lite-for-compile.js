...
viz.mojom.CompositorFrameSinkRemote = class {
  ...
  setThreadIds(
    ...
    this.proxy.sendMessage(
        8,
        viz.mojom.CompositorFrameSink_SetThreadIds_ParamsSpec.$,
        null,
        [
          threadIds
        ]);
...
goog.provide('viz.mojom.CompositorFrameSink_SetThreadIds_ParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('viz.mojom.CompositorFrameSink_SetThreadIds_Params');

/** @record */
viz.mojom.CompositorFrameSink_SetThreadIds_Params = class {
  constructor() {
    /** @export { !Array<!number> } */
    this.threadIds;
  }
