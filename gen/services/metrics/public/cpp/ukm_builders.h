...
class AdPageLoadCustomSampling final : public ::ukm::internal::UkmEntryBuilderBase {
 public:
  explicit AdPageLoadCustomSampling(ukm::SourceId source_id);
  explicit AdPageLoadCustomSampling(ukm::SourceIdObj source_id);
  ~AdPageLoadCustomSampling() override;

  static const char kEntryName[];
  static constexpr uint64_t kEntryNameHash = UINT64_C(17267887671196867343);
  ...
  AdPageLoadCustomSampling& SetAverageViewportAdDensity(int64_t value);
  ...
  AdPageLoadCustomSampling& SetKurtosisViewportAdDensity(int64_t value);
  ...
  AdPageLoadCustomSampling& SetSkewnessViewportAdDensity(int64_t value);
  ...
  AdPageLoadCustomSampling& SetVarianceViewportAdDensity(int64_t value);
...
class AmpPageLoad final : public ::ukm::internal::UkmEntryBuilderBase {
 public:
  ...
  static const char kSubFrame_InteractiveTiming_AverageUserInteractionLatencyOverBudget_MaxEventdurationName[];
  static constexpr uint64_t kSubFrame_InteractiveTiming_AverageUserInteractionLatencyOverBudget_MaxEventdurationNameHash = UINT64_C(14645859956980131597);
  AmpPageLoad& SetSubFrame_InteractiveTiming_AverageUserInteractionLatencyOverBudget_MaxEventduration(int64_t value);
  ...
  static const char kSubFrame_InteractiveTiming_SlowUserInteractionLatencyOverBudget_HighPercentile2_MaxEventdurationName[];
  static constexpr uint64_t kSubFrame_InteractiveTiming_SlowUserInteractionLatencyOverBudget_HighPercentile2_MaxEventdurationNameHash = UINT64_C(12429208189888324441);
  AmpPageLoad& SetSubFrame_InteractiveTiming_SlowUserInteractionLatencyOverBudget_HighPercentile2_MaxEventduration(int64_t value);

  static const char kSubFrame_InteractiveTiming_SumOfUserInteractionLatencyOverBudget_MaxEventdurationName[];
  static constexpr uint64_t kSubFrame_InteractiveTiming_SumOfUserInteractionLatencyOverBudget_MaxEventdurationNameHash = UINT64_C(13162107139764575476);
  AmpPageLoad& SetSubFrame_InteractiveTiming_SumOfUserInteractionLatencyOverBudget_MaxEventduration(int64_t value);
  ...
  static const char kSubFrame_InteractiveTiming_WorstUserInteractionLatency_MaxEventdurationName[];
  static constexpr uint64_t kSubFrame_InteractiveTiming_WorstUserInteractionLatency_MaxEventdurationNameHash = UINT64_C(12637276920974549230);
  AmpPageLoad& SetSubFrame_InteractiveTiming_WorstUserInteractionLatency_MaxEventduration(int64_t value);
...
class HistoryNavigation final : public ::ukm::internal::UkmEntryBuilderBase {
 public:
  ...
  static const char kAverageUserInteractionLatencyOverBudgetAfterBackForwardCacheRestore_MaxEventdurationName[];
  static constexpr uint64_t kAverageUserInteractionLatencyOverBudgetAfterBackForwardCacheRestore_MaxEventdurationNameHash = UINT64_C(8156443847000158495);
  HistoryNavigation& SetAverageUserInteractionLatencyOverBudgetAfterBackForwardCacheRestore_MaxEventduration(int64_t value);
  ...
  static const char kSlowUserInteractionLatencyOverBudgetAfterBackForwardCacheRestore_HighPercentile2_MaxEventdurationName[];
  static constexpr uint64_t kSlowUserInteractionLatencyOverBudgetAfterBackForwardCacheRestore_HighPercentile2_MaxEventdurationNameHash = UINT64_C(9227168809744732569);
  HistoryNavigation& SetSlowUserInteractionLatencyOverBudgetAfterBackForwardCacheRestore_HighPercentile2_MaxEventduration(int64_t value);

  static const char kSumOfUserInteractionLatencyOverBudgetAfterBackForwardCacheRestore_MaxEventdurationName[];
  static constexpr uint64_t kSumOfUserInteractionLatencyOverBudgetAfterBackForwardCacheRestore_MaxEventdurationNameHash = UINT64_C(16452971018079486867);
  HistoryNavigation& SetSumOfUserInteractionLatencyOverBudgetAfterBackForwardCacheRestore_MaxEventduration(int64_t value);
  ...
  static const char kWorstUserInteractionLatencyAfterBackForwardCacheRestore_MaxEventdurationName[];
  static constexpr uint64_t kWorstUserInteractionLatencyAfterBackForwardCacheRestore_MaxEventdurationNameHash = UINT64_C(7847071731255501414);
  HistoryNavigation& SetWorstUserInteractionLatencyAfterBackForwardCacheRestore_MaxEventduration(int64_t value);
...
class PageContentAnnotations final : public ::ukm::internal::UkmEntryBuilderBase {
 public:
  explicit PageContentAnnotations(ukm::SourceId source_id);
  explicit PageContentAnnotations(ukm::SourceIdObj source_id);
  ~PageContentAnnotations() override;

  static const char kEntryName[];
  static constexpr uint64_t kEntryNameHash = UINT64_C(42194223400199379);


  static const char kVisibilityScoreName[];
  static constexpr uint64_t kVisibilityScoreNameHash = UINT64_C(16472091843743240030);
  PageContentAnnotations& SetVisibilityScore(int64_t value);
