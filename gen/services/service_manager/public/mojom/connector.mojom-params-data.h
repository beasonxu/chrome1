 ...
 public:
  ...
  mojo::ScopedMessagePipeHandle TakeInterfacePipe() {
    ...
    bool ret =
        mojo::internal::Deserialize<mojo::ScopedMessagePipeHandle>(
            &data_->interface_pipe, &result, message_);
    DCHECK(ret);
    return result;
  }
  template <typename UserType>
  ...
  BindInterfacePriority priority() const {
    return ::mojo::internal::ToKnownEnumValueHelper(
          static_cast<::service_manager::mojom::BindInterfacePriority>(data_->priority));
  }
 private:
...
class Connector_BindInterface_ResponseParamsDataView {
 public:
  ...
  ConnectResult result() const {
    return ::mojo::internal::ToKnownEnumValueHelper(
          static_cast<::service_manager::mojom::ConnectResult>(data_->result));
  }
...
static_assert(
    mojo::internal::IsValidUserTypeForOptionalValue<
        ::service_manager::mojom::IdentityDataView, UserType>(),
...
static_assert(
    mojo::internal::IsValidUserTypeForOptionalValue<
        ::service_manager::mojom::ServiceInfoDataView, UserType>(),
