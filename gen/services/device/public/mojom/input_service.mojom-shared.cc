...
bool InputDeviceInfo_Data::Validate(
  ...
  [[maybe_unused]] const InputDeviceInfo_Data* object =
      static_cast<const InputDeviceInfo_Data*>(data);
...
bool InputDeviceManager_GetDevices_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const InputDeviceManager_GetDevices_Params_Data* object =
      static_cast<const InputDeviceManager_GetDevices_Params_Data*>(data);
