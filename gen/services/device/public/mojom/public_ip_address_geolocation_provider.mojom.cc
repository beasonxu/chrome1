...
void PublicIpAddressGeolocationProviderProxy::CreateGeolocation(
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    "mojom", "Send device::mojom::PublicIpAddressGeolocationProvider::CreateGeolocation", "input_parameters",
    [&](perfetto::TracedValue context){
      auto dict = std::move(context).WriteDictionary();
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("tag"), in_tag,
                        "<value of type const ::net::MutablePartialNetworkTrafficAnnotationTag&>");
      perfetto::WriteIntoTracedValueWithFallback(
  ...
  mojo::internal::MessageFragment<
      ::device::mojom::internal::PublicIpAddressGeolocationProvider_CreateGeolocation_Params_Data> params(
          message);
  params.Allocate();
  mojo::internal::MessageFragment<
