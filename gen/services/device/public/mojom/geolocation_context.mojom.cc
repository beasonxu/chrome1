...
void GeolocationContextProxy::BindGeolocation(
    ::mojo::PendingReceiver<::device::mojom::Geolocation> in_receiver, const ::GURL& in_origin) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("receiver"), in_receiver,
                        "<value of type ::mojo::PendingReceiver<::device::mojom::Geolocation>>");
      perfetto::WriteIntoTracedValueWithFallback(
  ...
  MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
      ...
      "null origin in GeolocationContext.BindGeolocation request");
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("geoposition"), in_geoposition,
                        "<value of type ::device::mojom::GeopositionPtr>");
   });
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
void GeolocationContextInterceptorForTesting::BindGeolocation(::mojo::PendingReceiver<::device::mojom::Geolocation> receiver, const ::GURL& origin) {
  GetForwardingInterface()->BindGeolocation(std::move(receiver), std::move(origin));
}
