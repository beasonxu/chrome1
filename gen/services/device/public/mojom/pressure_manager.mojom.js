...
(function() {
  ...
  if (mojo.config.autoLoadMojomDeps) {
    mojo.internal.loadMojomIfNecessary(
        'services/device/public/mojom/pressure_state.mojom', 'pressure_state.mojom.js');
  }
  ...
  PressureClient_PressureStateChanged_Params.validate = function(messageValidator, offset) {
    ...
    // validate PressureClient_PressureStateChanged_Params.state
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 0, pressure_state$.PressureState, false);
    if (err !== validator.validationError.NONE)
        return err;


    // validate PressureClient_PressureStateChanged_Params.timestamp
  ...
  PressureClient_PressureStateChanged_Params.encodedSize = codec.kStructHeaderSize + 16;
  ...
  var kPressureManager_AddClient_Name = 0;
  ...
  var kPressureClient_PressureStateChanged_Name = 0;
  ...
  PressureClientProxy.prototype.pressureStateChanged = function(state, timestamp) {
  ...
  PressureClientStub.prototype.pressureStateChanged = function(state, timestamp) {
    return this.delegate_ && this.delegate_.pressureStateChanged && this.delegate_.pressureStateChanged(state, timestamp);
  }
  ...
  PressureClientStub.prototype.accept = function(message) {
    ...
    case kPressureClient_PressureStateChanged_Name:
      ...
      this.pressureStateChanged(params.state, params.timestamp);
      return true;
    default:
      return false;
    }
