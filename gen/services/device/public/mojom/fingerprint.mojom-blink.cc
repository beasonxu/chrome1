...
void FingerprintObserverProxy::OnAuthScanDone(
    FingerprintMessagePtr in_msg, const WTF::HashMap<WTF::String, WTF::Vector<WTF::String>>& in_matches) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
bool UnionTraits<::device::mojom::blink::FingerprintMessage::DataView, ::device::mojom::blink::FingerprintMessagePtr>::Read(
    ::device::mojom::blink::FingerprintMessage::DataView input,
    ::device::mojom::blink::FingerprintMessagePtr* output) {
