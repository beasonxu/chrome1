...
void GeolocationContextProxy::BindGeolocation(
    ::mojo::PendingReceiver<::device::mojom::blink::Geolocation> in_receiver, const ::blink::KURL& in_origin) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void GeolocationContextInterceptorForTesting::BindGeolocation(::mojo::PendingReceiver<::device::mojom::blink::Geolocation> receiver, const ::blink::KURL& origin) {
