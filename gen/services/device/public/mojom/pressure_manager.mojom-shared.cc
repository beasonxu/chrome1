...
// static
bool PressureClient_PressureStateChanged_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const PressureClient_PressureStateChanged_Params_Data* object =
      static_cast<const PressureClient_PressureStateChanged_Params_Data*>(data);
