...
(function() {
  ...
  TrustTokenParams.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 16, TrustTokenSignRequestData);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  TrustTokenParams.encodedSize = codec.kStructHeaderSize + 48;
  ...
  var kTrustTokenQueryAnswerer_HasTrustTokens_Name = 0;
