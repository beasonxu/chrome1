...
struct network_mojom_internal_NetLogEventPhase_DataHashFn {
  ...
  static bool Equal(const ::network::mojom::NetLogEventPhase& left, const ::network::mojom::NetLogEventPhase& right) {
    return left == right;
  }
  static const bool safe_to_compare_to_empty_or_deleted = true;
};
...
template <>
struct HashTraits<::network::mojom::NetLogEventPhase>
    : public GenericHashTraits<::network::mojom::NetLogEventPhase> {
  static_assert(true,
                "-1000000 is a reserved enum value");
  static_assert(true,
                "-1000001 is a reserved enum value");
  ...
  static void ConstructDeletedValue(::network::mojom::NetLogEventPhase& slot, bool) {
    slot = static_cast<::network::mojom::NetLogEventPhase>(-1000001);
  }
  static bool IsDeletedValue(const ::network::mojom::NetLogEventPhase& value) {
    return value == static_cast<::network::mojom::NetLogEventPhase>(-1000001);
  }
};
}  // namespace WTF
...
class BLINK_PLATFORM_EXPORT NetLogProxySource
...
class BLINK_PLATFORM_EXPORT NetLogProxySink
...
// with not having this data in traces there.
  ...
  virtual void AddEntry(uint32_t type, uint32_t source_type, uint32_t source_id, ::base::TimeTicks source_start_time, NetLogEventPhase phase, ::base::TimeTicks time, ::base::Value params) = 0;
};
...
class BLINK_PLATFORM_EXPORT NetLogProxySinkProxy
 ...
 public:
  ...
  void AddEntry(uint32_t type, uint32_t source_type, uint32_t source_id, ::base::TimeTicks source_start_time, NetLogEventPhase phase, ::base::TimeTicks time, ::base::Value params) final;
