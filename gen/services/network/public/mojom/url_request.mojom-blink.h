...
struct network_mojom_internal_SourceType_DataHashFn {
  ...
  static bool Equal(const ::network::mojom::SourceType& left, const ::network::mojom::SourceType& right) {
    return left == right;
  }
...
struct HashTraits<::network::mojom::SourceType>
    : public GenericHashTraits<::network::mojom::SourceType> {
  static_assert(true,
  ...
  static void ConstructDeletedValue(::network::mojom::SourceType& slot, bool) {
    slot = static_cast<::network::mojom::SourceType>(-1000001);
  }
  static bool IsDeletedValue(const ::network::mojom::SourceType& value) {
    return value == static_cast<::network::mojom::SourceType>(-1000001);
  }
};
}  // namespace WTF
 ...
 public:
  ...
  static WTF::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        NetLogSource::DataView, WTF::Vector<uint8_t>>(input);
  }
