...
bool StructTraits<::network::mojom::SiteIndex::DataView, ::network::mojom::SiteIndexPtr>::Read(
    ::network::mojom::SiteIndex::DataView input,
    ::network::mojom::SiteIndexPtr* output) {
  bool success = true;
...
bool StructTraits<::network::mojom::SamePartyContext::DataView, ::network::mojom::SamePartyContextPtr>::Read(
    ::network::mojom::SamePartyContext::DataView input,
    ::network::mojom::SamePartyContextPtr* output) {
  bool success = true;
