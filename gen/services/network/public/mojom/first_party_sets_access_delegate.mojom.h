...
class  FirstPartySetsReadyEvent {
 public:
  ...
  explicit FirstPartySetsReadyEvent(
      const base::flat_map<::net::SchemefulSite, absl::optional<::net::FirstPartySetEntry>>& customizations);
...
struct  StructTraits<::network::mojom::FirstPartySetsReadyEvent::DataView,
  ...
  static const decltype(::network::mojom::FirstPartySetsReadyEvent::customizations)& customizations(
