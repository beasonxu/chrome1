...
class BLINK_PLATFORM_EXPORT NetworkIsolationKey {
 public:
  ...
  NetworkIsolationKey(
      const absl::optional<::blink::BlinkSchemefulSite>& top_frame_site,
      const absl::optional<::blink::BlinkSchemefulSite>& frame_site,
...
struct BLINK_PLATFORM_EXPORT StructTraits<::network::mojom::blink::NetworkIsolationKey::DataView,
  ...
  static const decltype(::network::mojom::blink::NetworkIsolationKey::top_frame_site)& top_frame_site(
      const ::network::mojom::blink::NetworkIsolationKeyPtr& input) {
    return input->top_frame_site;
  }

  static const decltype(::network::mojom::blink::NetworkIsolationKey::frame_site)& frame_site(
      const ::network::mojom::blink::NetworkIsolationKeyPtr& input) {
    return input->frame_site;
  }

  static const decltype(::network::mojom::blink::NetworkIsolationKey::nonce)& nonce(
      const ::network::mojom::blink::NetworkIsolationKeyPtr& input) {
    return input->nonce;
  }
