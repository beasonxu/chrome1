...
void CertVerifierServiceProxy::Verify(
    RequestParamsPtr in_params, uint32_t in_netlog_source_type, uint32_t in_netlog_source_id, ::base::TimeTicks in_netlog_source_start_time, ::mojo::PendingRemote<CertVerifierRequest> in_cert_verifier_request) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void CertVerifierServiceInterceptorForTesting::Verify(RequestParamsPtr params, uint32_t netlog_source_type, uint32_t netlog_source_id, ::base::TimeTicks netlog_source_start_time, ::mojo::PendingRemote<CertVerifierRequest> cert_verifier_request) {
