...
void CrossOriginOpenerPolicyReporterInterceptorForTesting::QueueAccessReport(CoopAccessReportType report_type, const WTF::String& property, ::network::mojom::blink::SourceLocationPtr source_location, const WTF::String& reported_window_url) {
