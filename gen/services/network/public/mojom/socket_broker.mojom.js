...
(function() {
  ...
  SocketBroker_CreateTcpSocket_ResponseParams.encodedSize = codec.kStructHeaderSize + 8;
  ...
  SocketBroker_CreateTcpSocket_ResponseParams.encode = function(encoder, val) {
    ...
    encoder.writeUint32(0);
    encoder.encodeStruct(codec.NullableHandle, val.createdSocket);
    encoder.encodeStruct(codec.Int32, val.rv);
  };
  var kSocketBroker_CreateTcpSocket_Name = 0;
