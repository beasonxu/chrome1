 ...
 public:
  ...
  static WTF::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        PinSetInfo::DataView, WTF::Vector<uint8_t>>(input);
  }
...
class BLINK_PLATFORM_EXPORT PinSet {
 public:
  ...
  static WTF::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        PinSet::DataView, WTF::Vector<uint8_t>>(input);
  }
...
PinList& operator=(const PinList&) = delete;
  ...
  static WTF::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        PinList::DataView, WTF::Vector<uint8_t>>(input);
  }
...
struct BLINK_PLATFORM_EXPORT StructTraits<::network::mojom::blink::PinSet::DataView,
  ...
  static const decltype(::network::mojom::blink::PinSet::report_uri)& report_uri(
      const ::network::mojom::blink::PinSetPtr& input) {
