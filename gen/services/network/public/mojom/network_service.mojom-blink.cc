...
HttpAuthDynamicParams::HttpAuthDynamicParams(
    absl::optional<WTF::Vector<WTF::String>> allowed_schemes_in,
...
void NetworkServiceProxy::StartNetLog(
    ::base::File in_file, ::network::mojom::blink::NetLogCaptureMode in_capture_mode, ::base::Value::Dict in_constants) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("state"), in_state,
                        "<value of type ::mojo_base::mojom::blink::ApplicationState>");
   });
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
void NetworkServiceProxy::UpdateCtLogList(
    WTF::Vector<::network::mojom::blink::CTLogInfoPtr> in_log_list, ::base::Time in_update_time, UpdateCtLogListCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("log_list"), in_log_list,
                        "<value of type WTF::Vector<::network::mojom::blink::CTLogInfoPtr>>");
      perfetto::WriteIntoTracedValueWithFallback(
...
void NetworkServiceProxy::SetFirstPartySets(
    WTF::HashMap<::blink::BlinkSchemefulSite, ::network::mojom::blink::FirstPartySetEntryPtr> in_sets) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("sets"), in_sets,
                        "<value of type WTF::HashMap<::blink::BlinkSchemefulSite, ::network::mojom::blink::FirstPartySetEntryPtr>>");
   });
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
class NetworkService_GetNetworkList_ProxyToResponder : public ::mojo::internal::ProxyToResponder {
 ...
 private:
  ...
  void Run(
      const absl::optional<WTF::Vector<::net::NetworkInterface>>& in_networks);
};
...
bool NetworkService_GetNetworkList_ForwardToCallback::Accept(
  ...
  bool success = true;
  absl::optional<WTF::Vector<::net::NetworkInterface>> p_networks{};
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("networks"), in_networks,
                        "<value of type const absl::optional<WTF::Vector<::net::NetworkInterface>>&>");
   });
#endif
...
std::move(p_receiver));
    ...
    case internal::kNetworkService_SetFirstPartySets_Name: {
      ...
      bool success = true;
      WTF::HashMap<::blink::BlinkSchemefulSite, ::network::mojom::blink::FirstPartySetEntryPtr> p_sets{};
...
void NetworkServiceInterceptorForTesting::SetFirstPartySets(WTF::HashMap<::blink::BlinkSchemefulSite, ::network::mojom::blink::FirstPartySetEntryPtr> sets) {
