...
DnsConfigOverrides::DnsConfigOverrides(
    absl::optional<WTF::Vector<::net::IPEndPoint>> nameservers_in,
    absl::optional<WTF::Vector<WTF::String>> search_in,
...
void ResolveHostClientProxy::OnComplete(
    int32_t in_result, ::network::mojom::blink::ResolveErrorInfoPtr in_resolve_error_info, ::network::mojom::blink::AddressListPtr in_resolved_addresses) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("hosts"), in_hosts,
                        "<value of type WTF::Vector<::network::mojom::blink::HostPortPairPtr>>");
   });
#endif
  const bool kExpectsResponse = false;
  const bool kIsSync = false;
...
void ResolveHostClientInterceptorForTesting::OnComplete(int32_t result, ::network::mojom::blink::ResolveErrorInfoPtr resolve_error_info, ::network::mojom::blink::AddressListPtr resolved_addresses) {
