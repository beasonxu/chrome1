...
void Bitrate::set_variable(
  ...
  if (tag_ == Tag::kVariable) {
    *(data_.variable) = std::move(variable);
    ...
    DestroyActive();
    tag_ = Tag::kVariable;
    data_.variable = new ::media::Bitrate(
        std::move(variable));
  }
}
...
bool VideoEncodeAcceleratorProxy::Initialize(
    const ::media::VideoEncodeAccelerator::Config& param_config, ::mojo::PendingAssociatedRemote<VideoEncodeAcceleratorClient> param_client, ::mojo::PendingRemote<::media::mojom::MediaLog> param_media_log, bool* out_param_result) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT_BEGIN1(
...
// static
bool StructTraits<::media::mojom::Av1Metadata::DataView, ::media::mojom::Av1MetadataPtr>::Read(
    ::media::mojom::Av1Metadata::DataView input,
    ::media::mojom::Av1MetadataPtr* output) {
  bool success = true;
