...
public final class AudioProcessingSettings extends org.chromium.mojo.bindings.Struct {
    ...
    public static AudioProcessingSettings decode(org.chromium.mojo.bindings.Decoder decoder0) {
        ...
        try {
            ...
            result = new AudioProcessingSettings(elementsOrVersion);
                ...
                result.experimentalAutomaticGainControl = decoder0.readBoolean(8, 4);
                }
                {
                    
                result.highPassFilter = decoder0.readBoolean(8, 5);
                }
                {
                    
                result.multiChannelCaptureProcessing = decoder0.readBoolean(8, 6);
                }
                {
                    
                result.stereoMirroring = decoder0.readBoolean(8, 7);
                }
                {
                    
                result.forceApmCreation = decoder0.readBoolean(9, 0);
                }
    ...
    protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
        ...
        encoder0.encode(this.experimentalAutomaticGainControl, 8, 4);
        
        encoder0.encode(this.highPassFilter, 8, 5);
        
        encoder0.encode(this.multiChannelCaptureProcessing, 8, 6);
        
        encoder0.encode(this.stereoMirroring, 8, 7);
        
        encoder0.encode(this.forceApmCreation, 9, 0);
    }
}