...
struct Serializer<::media::mojom::CdmStorage_Status, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    return Traits::FromMojom(::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::media::mojom::CdmStorage_Status>(input)), output);
  }
};
...
struct Serializer<::media::mojom::CdmFile_Status, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    return Traits::FromMojom(::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::media::mojom::CdmFile_Status>(input)), output);
  }
};
...
template <>
struct  TraceFormatTraits<::media::mojom::CdmStorage_Status> {
...
template <>
struct  TraceFormatTraits<::media::mojom::CdmFile_Status> {
