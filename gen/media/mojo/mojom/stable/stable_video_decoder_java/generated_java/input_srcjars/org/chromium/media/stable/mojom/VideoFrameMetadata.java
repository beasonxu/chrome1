...
public final class VideoFrameMetadata extends org.chromium.mojo.bindings.Struct {
    ...
    public static VideoFrameMetadata decode(org.chromium.mojo.bindings.Decoder decoder0) {
        ...
        try {
            ...
            result = new VideoFrameMetadata(elementsOrVersion);
                ...
                result.endOfStream = decoder0.readBoolean(8, 1);
                }
                {
                    
                result.readLockFencesEnabled = decoder0.readBoolean(8, 2);
                }
                {
                    
                result.protectedVideo = decoder0.readBoolean(8, 3);
                }
                {
                    
                result.hwProtected = decoder0.readBoolean(8, 4);
                }
                {
                    
                result.powerEfficient = decoder0.readBoolean(8, 5);
                }
    ...
    protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
        ...
        encoder0.encode(this.endOfStream, 8, 1);
        
        encoder0.encode(this.readLockFencesEnabled, 8, 2);
        
        encoder0.encode(this.protectedVideo, 8, 3);
        
        encoder0.encode(this.hwProtected, 8, 4);
        
        encoder0.encode(this.powerEfficient, 8, 5);
    }
}