...
(function() {
  ...
  MediaLogRecord.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 8, values$.DeprecatedDictionaryValue, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  MediaLogRecord.encode = function(encoder, val) {
    ...
    encoder.encodeStructPointer(values$.DeprecatedDictionaryValue, val.params);
