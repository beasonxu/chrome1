...
void AudioStreamFactoryProxy::CreateInputStream(
    ::mojo::PendingReceiver<::media::mojom::blink::AudioInputStream> in_stream, ::mojo::PendingRemote<::media::mojom::blink::AudioInputStreamClient> in_client, ::mojo::PendingRemote<::media::mojom::blink::AudioInputStreamObserver> in_observer, ::mojo::PendingRemote<::media::mojom::blink::AudioLog> in_log, const WTF::String& in_device_id, const ::media::AudioParameters& in_params, uint32_t in_shared_memory_count, bool in_enable_agc, ::base::ReadOnlySharedMemoryRegion in_key_press_count_buffer, ::media::mojom::blink::AudioProcessingConfigPtr in_processing_config, CreateInputStreamCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("stream"), in_stream,
                        "<value of type ::mojo::PendingReceiver<::media::mojom::blink::AudioInputStream>>");
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("client"), in_client,
                        "<value of type ::mojo::PendingRemote<::media::mojom::blink::AudioInputStreamClient>>");
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("observer"), in_observer,
                        "<value of type ::mojo::PendingRemote<::media::mojom::blink::AudioInputStreamObserver>>");
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("log"), in_log,
                        "<value of type ::mojo::PendingRemote<::media::mojom::blink::AudioLog>>");
      perfetto::WriteIntoTracedValueWithFallback(
...
void AudioStreamFactoryProxy::CreateOutputStream(
    ::mojo::PendingReceiver<::media::mojom::blink::AudioOutputStream> in_stream, ::mojo::PendingAssociatedRemote<::media::mojom::blink::AudioOutputStreamObserver> in_observer, ::mojo::PendingRemote<::media::mojom::blink::AudioLog> in_log, const WTF::String& in_device_id, const ::media::AudioParameters& in_params, const ::base::UnguessableToken& in_group_id, CreateOutputStreamCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("stream"), in_stream,
                        "<value of type ::mojo::PendingReceiver<::media::mojom::blink::AudioOutputStream>>");
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("observer"), in_observer,
                        "<value of type ::mojo::PendingAssociatedRemote<::media::mojom::blink::AudioOutputStreamObserver>>");
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("log"), in_log,
                        "<value of type ::mojo::PendingRemote<::media::mojom::blink::AudioLog>>");
      perfetto::WriteIntoTracedValueWithFallback(
...
void AudioStreamFactoryProxy::CreateLoopbackStream(
    ::mojo::PendingReceiver<::media::mojom::blink::AudioInputStream> in_receiver, ::mojo::PendingRemote<::media::mojom::blink::AudioInputStreamClient> in_client, ::mojo::PendingRemote<::media::mojom::blink::AudioInputStreamObserver> in_observer, const ::media::AudioParameters& in_params, uint32_t in_shared_memory_count, const ::base::UnguessableToken& in_group_id, CreateLoopbackStreamCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("data_pipe"), in_data_pipe,
                        "<value of type ::media::mojom::blink::ReadOnlyAudioDataPipePtr>");
      perfetto::WriteIntoTracedValueWithFallback(
...
class AudioStreamFactory_CreateOutputStream_ProxyToResponder : public ::mojo::internal::ProxyToResponder {
 ...
 private:
  ...
  void Run(
      ::media::mojom::blink::ReadWriteAudioDataPipePtr in_data_pipe);
};
...
class AudioStreamFactory_CreateLoopbackStream_ProxyToResponder : public ::mojo::internal::ProxyToResponder {
 ...
 private:
  ...
  void Run(
      ::media::mojom::blink::ReadOnlyAudioDataPipePtr in_data_pipe);
};
...
void AudioStreamFactoryInterceptorForTesting::CreateInputStream(::mojo::PendingReceiver<::media::mojom::blink::AudioInputStream> stream, ::mojo::PendingRemote<::media::mojom::blink::AudioInputStreamClient> client, ::mojo::PendingRemote<::media::mojom::blink::AudioInputStreamObserver> observer, ::mojo::PendingRemote<::media::mojom::blink::AudioLog> log, const WTF::String& device_id, const ::media::AudioParameters& params, uint32_t shared_memory_count, bool enable_agc, ::base::ReadOnlySharedMemoryRegion key_press_count_buffer, ::media::mojom::blink::AudioProcessingConfigPtr processing_config, CreateInputStreamCallback callback) {
...
,
             ::media::mojom::blink::ReadWriteAudioDataPipePtr data_pipe) {*out_data_pipe = std::move(data_pipe);
            loop->Quit();
          },
          &loop,
          out_data_pipe));
  ...
  proxy_->CreateLoopbackStream(std::move(receiver),std::move(client),std::move(observer),std::move(params),std::move(shared_memory_count),std::move(group_id),
      base::BindOnce(
          [](base::RunLoop* loop,
             ::media::mojom::blink::ReadOnlyAudioDataPipePtr* out_data_pipe
,
             ::media::mojom::blink::ReadOnlyAudioDataPipePtr data_pipe) {*out_data_pipe = std::move(data_pipe);
            loop->Quit();
          },
          &loop,
          out_data_pipe));
