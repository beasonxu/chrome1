 ...
 public:
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        CaptureHandle::DataView, std::vector<uint8_t>>(input);
  }
...
template <>
struct  StructTraits<::media::mojom::CaptureHandle::DataView,
  ...
  static const decltype(::media::mojom::CaptureHandle::origin)& origin(
      const ::media::mojom::CaptureHandlePtr& input) {
    return input->origin;
  }

  static const decltype(::media::mojom::CaptureHandle::capture_handle)& capture_handle(
      const ::media::mojom::CaptureHandlePtr& input) {
