...
import {
  FlingingRendererClientExtensionRemote as media_mojom_FlingingRendererClientExtensionRemote,
  FlingingRendererClientExtensionPendingReceiver as media_mojom_FlingingRendererClientExtensionPendingReceiver,
  MediaPlayerRendererClientExtensionRemote as media_mojom_MediaPlayerRendererClientExtensionRemote,
  MediaPlayerRendererClientExtensionPendingReceiver as media_mojom_MediaPlayerRendererClientExtensionPendingReceiver,
  MediaPlayerRendererExtensionRemote as media_mojom_MediaPlayerRendererExtensionRemote,
  MediaPlayerRendererExtensionPendingReceiver as media_mojom_MediaPlayerRendererExtensionPendingReceiver
...
export class InterfaceFactoryInterface {
  ...
  /**
   * @param { !media_mojom_MediaPlayerRendererClientExtensionRemote } clientExtension
   * @param { !media_mojom_RendererPendingReceiver } renderer
   * @param { !media_mojom_MediaPlayerRendererExtensionPendingReceiver } rendererExtension
   */

  createMediaPlayerRenderer(clientExtension, renderer, rendererExtension) {}
  
  /**
   * @param { !string } presentationId
   * @param { !media_mojom_FlingingRendererClientExtensionRemote } clientExtension
   * @param { !media_mojom_RendererPendingReceiver } renderer
   */

  createFlingingRenderer(presentationId, clientExtension, renderer) {}
...
export class InterfaceFactoryRemote {
  ...
  createMediaPlayerRenderer(
    ...
    this.proxy.sendMessage(
        4,
        InterfaceFactory_CreateMediaPlayerRenderer_ParamsSpec.$,
        null,
        [
          clientExtension,
          renderer,
  ...
  createFlingingRenderer(
    ...
    this.proxy.sendMessage(
        5,
        InterfaceFactory_CreateFlingingRenderer_ParamsSpec.$,
        null,
        [
          presentationId,
          clientExtension,
 ...
 * @const { {$:!mojo.internal.MojomType}}
 */
export const InterfaceFactory_CreateMediaPlayerRenderer_ParamsSpec =
    { $: /** @type {!mojo.internal.MojomType} */ ({}) };

/**
 * @const { {$:!mojo.internal.MojomType}}
 */
export const InterfaceFactory_CreateFlingingRenderer_ParamsSpec =
    { $: /** @type {!mojo.internal.MojomType} */ ({}) };
...
mojo.internal.Struct(
    ...
    [
      mojo.internal.StructField(
        'clientExtension', 0,
        0,
        mojo.internal.InterfaceProxy(media_mojom_MediaPlayerRendererClientExtensionRemote),
        null,
        false /* nullable */,
        0),
      mojo.internal.StructField(
      ...
      mojo.internal.StructField(
        ...
        0,
        mojo.internal.InterfaceRequest(media_mojom_MediaPlayerRendererExtensionPendingReceiver),
        null,
        false /* nullable */,
        0),
    ],
 ...
 * @record
 */
export class InterfaceFactory_CreateMediaPlayerRenderer_Params {
  constructor() {
    /** @type { !media_mojom_MediaPlayerRendererClientExtensionRemote } */
    this.clientExtension;
    /** @type { !media_mojom_RendererPendingReceiver } */
    this.renderer;
    /** @type { !media_mojom_MediaPlayerRendererExtensionPendingReceiver } */
...
mojo.internal.Struct(
    ...
    [
      ...
      mojo.internal.StructField(
        'clientExtension', 8,
        0,
        mojo.internal.InterfaceProxy(media_mojom_FlingingRendererClientExtensionRemote),
        null,
        false /* nullable */,
        0),
      mojo.internal.StructField(
 ...
 * @record
 */
export class InterfaceFactory_CreateFlingingRenderer_Params {
  constructor() {
    /** @type { !string } */
    this.presentationId;
    /** @type { !media_mojom_FlingingRendererClientExtensionRemote } */
    this.clientExtension;
    /** @type { !media_mojom_RendererPendingReceiver } */
    this.renderer;
  }
