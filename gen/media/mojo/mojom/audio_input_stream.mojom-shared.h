...
struct Serializer<::media::mojom::AudioInputStreamObserver_DisconnectReason, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    return Traits::FromMojom(::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::media::mojom::AudioInputStreamObserver_DisconnectReason>(input)), output);
  }
};
...
template <>
struct  TraceFormatTraits<::media::mojom::AudioInputStreamObserver_DisconnectReason> {
