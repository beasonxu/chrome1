...
struct Serializer<::media::mojom::PlaybackPropertiesDataView, MaybeConstUserType> {
  ...
  static void Serialize(
    ...
    mojo::internal::Serialize<::media::mojom::MediaStreamType>(
        Traits::media_stream_type(input), &fragment->media_stream_type);
  }
...
struct Serializer<::media::mojom::SecondaryPlaybackPropertiesDataView, MaybeConstUserType> {
  ...
  static void Serialize(
    ...
    mojo::internal::Serialize<::media::mojom::AudioCodec>(
        Traits::audio_codec(input), &fragment->audio_codec);
    mojo::internal::Serialize<::media::mojom::VideoCodec>(
        Traits::video_codec(input), &fragment->video_codec);
    mojo::internal::Serialize<::media::mojom::AudioCodecProfile>(
        Traits::audio_codec_profile(input), &fragment->audio_codec_profile);
    mojo::internal::Serialize<::media::mojom::VideoCodecProfile>(
        Traits::video_codec_profile(input), &fragment->video_codec_profile);
    mojo::internal::Serialize<::media::mojom::AudioDecoderType>(
        Traits::audio_decoder(input), &fragment->audio_decoder);
    mojo::internal::Serialize<::media::mojom::VideoDecoderType>(
        Traits::video_decoder(input), &fragment->video_decoder);
    mojo::internal::Serialize<::media::mojom::EncryptionScheme>(
        Traits::audio_encryption_scheme(input), &fragment->audio_encryption_scheme);
    mojo::internal::Serialize<::media::mojom::EncryptionScheme>(
        Traits::video_encryption_scheme(input), &fragment->video_encryption_scheme);
