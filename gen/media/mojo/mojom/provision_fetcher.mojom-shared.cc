...
bool ProvisionFetcher_Retrieve_Params_Data::Validate(
  ...
  [[maybe_unused]] const ProvisionFetcher_Retrieve_Params_Data* object =
      static_cast<const ProvisionFetcher_Retrieve_Params_Data*>(data);
...
bool ProvisionFetcher_Retrieve_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const ProvisionFetcher_Retrieve_ResponseParams_Data* object =
      static_cast<const ProvisionFetcher_Retrieve_ResponseParams_Data*>(data);
