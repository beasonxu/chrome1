...
void ProvisionFetcherProxy::Retrieve(
    const ::blink::KURL& in_default_url, const WTF::String& in_request_data, RetrieveCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
  ...
  mojo::internal::Serialize<::url::mojom::UrlDataView>(
      in_default_url, default_url_fragment);
...
void ProvisionFetcherAsyncWaiter::Retrieve(
    const ::blink::KURL& default_url, const WTF::String& request_data, bool* out_result, WTF::String* out_response) {
  base::RunLoop loop;
