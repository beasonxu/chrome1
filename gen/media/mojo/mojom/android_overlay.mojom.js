...
(function() {
  ...
  function AndroidOverlayClient_OnSynchronouslyDestroyed_Params(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  AndroidOverlayClient_OnSynchronouslyDestroyed_Params.prototype.initDefaults_ = function() {
  };
  AndroidOverlayClient_OnSynchronouslyDestroyed_Params.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  AndroidOverlayClient_OnSynchronouslyDestroyed_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  AndroidOverlayClient_OnSynchronouslyDestroyed_Params.encodedSize = codec.kStructHeaderSize + 0;

  AndroidOverlayClient_OnSynchronouslyDestroyed_Params.decode = function(decoder) {
    var packed;
    var val = new AndroidOverlayClient_OnSynchronouslyDestroyed_Params();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    return val;
  };

  AndroidOverlayClient_OnSynchronouslyDestroyed_Params.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(AndroidOverlayClient_OnSynchronouslyDestroyed_Params.encodedSize);
    encoder.writeUint32(0);
  };
  function AndroidOverlayClient_OnSynchronouslyDestroyed_ResponseParams(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  AndroidOverlayClient_OnSynchronouslyDestroyed_ResponseParams.prototype.initDefaults_ = function() {
  };
  AndroidOverlayClient_OnSynchronouslyDestroyed_ResponseParams.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  AndroidOverlayClient_OnSynchronouslyDestroyed_ResponseParams.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  AndroidOverlayClient_OnSynchronouslyDestroyed_ResponseParams.encodedSize = codec.kStructHeaderSize + 0;

  AndroidOverlayClient_OnSynchronouslyDestroyed_ResponseParams.decode = function(decoder) {
    var packed;
    var val = new AndroidOverlayClient_OnSynchronouslyDestroyed_ResponseParams();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    return val;
  };

  AndroidOverlayClient_OnSynchronouslyDestroyed_ResponseParams.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(AndroidOverlayClient_OnSynchronouslyDestroyed_ResponseParams.encodedSize);
    encoder.writeUint32(0);
  };
  ...
  var kAndroidOverlayClient_OnSynchronouslyDestroyed_Name = 2;
  var kAndroidOverlayClient_OnPowerEfficientState_Name = 3;
  ...
  AndroidOverlayClientPtr.prototype.onSynchronouslyDestroyed = function() {
    return AndroidOverlayClientProxy.prototype.onSynchronouslyDestroyed
        .apply(this.ptr.getProxy(), arguments);
  };

  AndroidOverlayClientProxy.prototype.onSynchronouslyDestroyed = function() {
    var params_ = new AndroidOverlayClient_OnSynchronouslyDestroyed_Params();
    return new Promise(function(resolve, reject) {
      var builder = new codec.MessageV1Builder(
          kAndroidOverlayClient_OnSynchronouslyDestroyed_Name,
          codec.align(AndroidOverlayClient_OnSynchronouslyDestroyed_Params.encodedSize),
          codec.kMessageExpectsResponse, 0);
      builder.encodeStruct(AndroidOverlayClient_OnSynchronouslyDestroyed_Params, params_);
      var message = builder.finish();
      this.receiver_.acceptAndExpectResponse(message).then(function(message) {
        var reader = new codec.MessageReader(message);
        var responseParams =
            reader.decodeStruct(AndroidOverlayClient_OnSynchronouslyDestroyed_ResponseParams);
  ...
  AndroidOverlayClientStub.prototype.onSynchronouslyDestroyed = function() {
    return this.delegate_ && this.delegate_.onSynchronouslyDestroyed && this.delegate_.onSynchronouslyDestroyed();
  }
  ...
  AndroidOverlayClientStub.prototype.acceptWithResponder =
    ...
    var reader = new codec.MessageReader(message);
    switch (reader.messageName) {
    case kAndroidOverlayClient_OnSynchronouslyDestroyed_Name:
      var params = reader.decodeStruct(AndroidOverlayClient_OnSynchronouslyDestroyed_Params);
      this.onSynchronouslyDestroyed().then(function(response) {
        var responseParams =
            new AndroidOverlayClient_OnSynchronouslyDestroyed_ResponseParams();
        var builder = new codec.MessageV1Builder(
            kAndroidOverlayClient_OnSynchronouslyDestroyed_Name,
            codec.align(AndroidOverlayClient_OnSynchronouslyDestroyed_ResponseParams.encodedSize),
            codec.kMessageIsResponse, reader.requestID);
        builder.encodeStruct(AndroidOverlayClient_OnSynchronouslyDestroyed_ResponseParams,
                             responseParams);
        var message = builder.finish();
    ...
    switch (message.getName()) {
      ...
      case kAndroidOverlayClient_OnSynchronouslyDestroyed_Name:
        if (message.expectsResponse())
          paramsClass = AndroidOverlayClient_OnSynchronouslyDestroyed_Params;
      break;
      case kAndroidOverlayClient_OnPowerEfficientState_Name:
        if (!message.expectsResponse() && !message.isResponse())
   ...
   switch (message.getName()) {
      case kAndroidOverlayClient_OnSynchronouslyDestroyed_Name:
        if (message.isResponse())
          paramsClass = AndroidOverlayClient_OnSynchronouslyDestroyed_ResponseParams;
        break;
    }
    if (paramsClass === null)
      return validator.validationError.NONE;
  ...
  var AndroidOverlayClient = {
    ...
    validateResponse: validateAndroidOverlayClientResponse,
  };
  AndroidOverlayClientStub.prototype.validator = validateAndroidOverlayClientRequest;
  AndroidOverlayClientProxy.prototype.validator = validateAndroidOverlayClientResponse;
