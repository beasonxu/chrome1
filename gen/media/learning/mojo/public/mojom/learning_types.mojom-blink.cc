...
void FeatureValue::WriteIntoTrace(
...
void TargetValue::WriteIntoTrace(
    perfetto::TracedValue traced_context) const {
  [[maybe_unused]] auto dict = std::move(traced_context).WriteDictionary();
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
...
LabelledExample::LabelledExample(
    WTF::Vector<::media::learning::FeatureValue> features_in,
...
void LabelledExample::WriteIntoTrace(
    perfetto::TracedValue traced_context) const {
  [[maybe_unused]] auto dict = std::move(traced_context).WriteDictionary();
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
...
void ObservationCompletion::WriteIntoTrace(
    perfetto::TracedValue traced_context) const {
  [[maybe_unused]] auto dict = std::move(traced_context).WriteDictionary();
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
...
void TargetHistogramPair::WriteIntoTrace(
    perfetto::TracedValue traced_context) const {
  [[maybe_unused]] auto dict = std::move(traced_context).WriteDictionary();
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
...
TargetHistogram::TargetHistogram(
    WTF::Vector<::media::learning::TargetHistogramPair> pairs_in)
    : pairs(std::move(pairs_in)) {}

TargetHistogram::~TargetHistogram() = default;

void TargetHistogram::WriteIntoTrace(
    perfetto::TracedValue traced_context) const {
  [[maybe_unused]] auto dict = std::move(traced_context).WriteDictionary();
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
...
bool StructTraits<::media::learning::mojom::blink::TargetHistogramPair::DataView, ::media::learning::mojom::blink::TargetHistogramPairPtr>::Read(
    ::media::learning::mojom::blink::TargetHistogramPair::DataView input,
    ::media::learning::mojom::blink::TargetHistogramPairPtr* output) {
  bool success = true;
