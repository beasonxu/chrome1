...
// with not having this data in traces there.
  ...
  virtual void BeginObservation(const ::base::UnguessableToken& id, const std::vector<::media::learning::FeatureValue>& features, const absl::optional<::media::learning::TargetValue>& default_target) = 0;
...
class  LearningTaskControllerProxy
 ...
 public:
  ...
  void BeginObservation(const ::base::UnguessableToken& id, const std::vector<::media::learning::FeatureValue>& features, const absl::optional<::media::learning::TargetValue>& default_target) final;
