...
#define TORQUE_ASSIGNED_INSTANCE_TYPES(V) \
  V(FIRST_HEAP_OBJECT_TYPE, 0) \
    ...
    V(FIRST_STRUCT_TYPE, 132) \
      ...
      V(WASM_EXCEPTION_TAG_TYPE, 174) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/wasm/wasm-objects.tq?l=117&c=1 */\
      V(WASM_INDIRECT_FUNCTION_TABLE_TYPE, 175) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/wasm/wasm-objects.tq?l=93&c=1 */\
    ...
    V(FIRST_FOREIGN_TYPE, 204) \
      ...
      V(WASM_TYPE_INFO_TYPE, 205) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/wasm/wasm-objects.tq?l=182&c=1 */\
    V(LAST_FOREIGN_TYPE, 205) \
    V(FIRST_CONTEXT_TYPE, 206) \
      V(AWAIT_CONTEXT_TYPE, 206) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/contexts.tq?l=17&c=1 */\
      V(BLOCK_CONTEXT_TYPE, 207) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/contexts.tq?l=18&c=1 */\
      V(CATCH_CONTEXT_TYPE, 208) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/contexts.tq?l=19&c=1 */\
      V(DEBUG_EVALUATE_CONTEXT_TYPE, 209) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/contexts.tq?l=20&c=1 */\
      V(EVAL_CONTEXT_TYPE, 210) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/contexts.tq?l=22&c=1 */\
      V(FUNCTION_CONTEXT_TYPE, 211) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/contexts.tq?l=27&c=1 */\
      V(MODULE_CONTEXT_TYPE, 212) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/contexts.tq?l=23&c=1 */\
      V(NATIVE_CONTEXT_TYPE, 213) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/contexts.tq?l=53&c=1 */\
      V(SCRIPT_CONTEXT_TYPE, 214) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/contexts.tq?l=24&c=1 */\
      V(WITH_CONTEXT_TYPE, 215) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/contexts.tq?l=25&c=1 */\
    V(LAST_CONTEXT_TYPE, 215) \
    V(FIRST_UNCOMPILED_DATA_TYPE, 216) \
      V(FIRST_UNCOMPILED_DATA_WITH_PREPARSE_DATA_TYPE, 216) \
        V(UNCOMPILED_DATA_WITH_PREPARSE_DATA_TYPE, 216) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/shared-function-info.tq?l=125&c=1 */\
        V(UNCOMPILED_DATA_WITH_PREPARSE_DATA_AND_JOB_TYPE, 217) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/shared-function-info.tq?l=141&c=1 */\
      V(LAST_UNCOMPILED_DATA_WITH_PREPARSE_DATA_TYPE, 217) \
      V(FIRST_UNCOMPILED_DATA_WITHOUT_PREPARSE_DATA_TYPE, 218) \
        V(UNCOMPILED_DATA_WITHOUT_PREPARSE_DATA_TYPE, 218) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/shared-function-info.tq?l=119&c=1 */\
        V(UNCOMPILED_DATA_WITHOUT_PREPARSE_DATA_WITH_JOB_TYPE, 219) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/shared-function-info.tq?l=132&c=1 */\
      V(LAST_UNCOMPILED_DATA_WITHOUT_PREPARSE_DATA_TYPE, 219) \
    V(LAST_UNCOMPILED_DATA_TYPE, 219) \
    V(FIRST_WASM_FUNCTION_DATA_TYPE, 220) \
      V(WASM_FUNCTION_DATA_TYPE, 220) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/wasm/wasm-objects.tq?l=52&c=1 */\
      V(WASM_CAPI_FUNCTION_DATA_TYPE, 221) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/wasm/wasm-objects.tq?l=83&c=1 */\
      V(WASM_EXPORTED_FUNCTION_DATA_TYPE, 222) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/wasm/wasm-objects.tq?l=62&c=1 */\
      V(WASM_JS_FUNCTION_DATA_TYPE, 223) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/wasm/wasm-objects.tq?l=77&c=1 */\
    V(LAST_WASM_FUNCTION_DATA_TYPE, 223) \
    V(FIRST_SMALL_ORDERED_HASH_TABLE_TYPE, 224) \
      V(SMALL_ORDERED_HASH_MAP_TYPE, 224) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/ordered-hash-table.tq?l=65&c=1 */\
      V(SMALL_ORDERED_HASH_SET_TYPE, 225) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/ordered-hash-table.tq?l=26&c=1 */\
      V(SMALL_ORDERED_NAME_DICTIONARY_TYPE, 226) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/ordered-hash-table.tq?l=102&c=1 */\
    V(LAST_SMALL_ORDERED_HASH_TABLE_TYPE, 226) \
    V(FIRST_ABSTRACT_INTERNAL_CLASS_TYPE, 227) \
      V(ABSTRACT_INTERNAL_CLASS_SUBCLASS1_TYPE, 227) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/test/torque/test-torque.tq?l=1187&c=1 */\
      V(ABSTRACT_INTERNAL_CLASS_SUBCLASS2_TYPE, 228) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/test/torque/test-torque.tq?l=1189&c=1 */\
    V(LAST_ABSTRACT_INTERNAL_CLASS_TYPE, 228) \
    V(FIRST_DESCRIPTOR_ARRAY_TYPE, 229) \
      V(DESCRIPTOR_ARRAY_TYPE, 229) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/descriptor-array.tq?l=17&c=1 */\
      V(STRONG_DESCRIPTOR_ARRAY_TYPE, 230) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/descriptor-array.tq?l=29&c=1 */\
    V(LAST_DESCRIPTOR_ARRAY_TYPE, 230) \
    V(FIRST_MODULE_TYPE, 231) \
      V(SOURCE_TEXT_MODULE_TYPE, 231) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/source-text-module.tq?l=12&c=1 */\
      V(SYNTHETIC_MODULE_TYPE, 232) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/synthetic-module.tq?l=5&c=1 */\
    V(LAST_MODULE_TYPE, 232) \
    V(FIRST_WEAK_FIXED_ARRAY_TYPE, 233) \
      V(WEAK_FIXED_ARRAY_TYPE, 233) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/fixed-array.tq?l=22&c=1 */\
      V(TRANSITION_ARRAY_TYPE, 234) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/base.tq?l=242&c=1 */\
    V(LAST_WEAK_FIXED_ARRAY_TYPE, 234) \
    V(ACCESSOR_INFO_TYPE, 235) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/api-callbacks.tq?l=53&c=1 */\
    V(CALL_HANDLER_INFO_TYPE, 236) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/api-callbacks.tq?l=5&c=1 */\
    V(CELL_TYPE, 237) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/cell.tq?l=5&c=1 */\
    V(CODE_TYPE, 238) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/base.tq?l=232&c=1 */\
    V(CODE_DATA_CONTAINER_TYPE, 239) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/code.tq?l=29&c=1 */\
    V(COVERAGE_INFO_TYPE, 240) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/debug-objects.tq?l=66&c=1 */\
    V(EMBEDDER_DATA_ARRAY_TYPE, 241) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/embedder-data-array.tq?l=5&c=1 */\
    V(FEEDBACK_METADATA_TYPE, 242) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/feedback-vector.tq?l=48&c=1 */\
    V(FEEDBACK_VECTOR_TYPE, 243) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/feedback-vector.tq?l=29&c=1 */\
    V(FILLER_TYPE, 244) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/base.tq?l=569&c=1 */\
    V(FREE_SPACE_TYPE, 245) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/free-space.tq?l=5&c=1 */\
    V(INTERNAL_CLASS_TYPE, 246) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/test/torque/test-torque.tq?l=759&c=1 */\
    V(INTERNAL_CLASS_WITH_STRUCT_ELEMENTS_TYPE, 247) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/test/torque/test-torque.tq?l=1202&c=1 */\
    V(MAP_TYPE, 248) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/map.tq?l=37&c=1 */\
    V(MEGA_DOM_HANDLER_TYPE, 249) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/megadom-handler.tq?l=5&c=1 */\
    V(ON_HEAP_BASIC_BLOCK_PROFILER_DATA_TYPE, 250) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/shared-function-info.tq?l=154&c=1 */\
    V(PREPARSE_DATA_TYPE, 251) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/shared-function-info.tq?l=5&c=1 */\
    V(PROPERTY_ARRAY_TYPE, 252) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/property-array.tq?l=5&c=1 */\
    V(PROPERTY_CELL_TYPE, 253) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/property-cell.tq?l=5&c=1 */\
    V(SCOPE_INFO_TYPE, 254) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/scope-info.tq?l=110&c=1 */\
    V(SHARED_FUNCTION_INFO_TYPE, 255) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/shared-function-info.tq?l=50&c=1 */\
    V(SMI_BOX_TYPE, 256) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/test/torque/test-torque.tq?l=926&c=1 */\
    V(SMI_PAIR_TYPE, 257) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/test/torque/test-torque.tq?l=825&c=1 */\
    V(SORT_STATE_TYPE, 258) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/third_party/v8/builtins/array-sort.tq?l=17&c=1 */\
    V(SWISS_NAME_DICTIONARY_TYPE, 259) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/swiss-name-dictionary.tq?l=7&c=1 */\
    V(WASM_API_FUNCTION_REF_TYPE, 260) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/wasm/wasm-objects.tq?l=20&c=1 */\
    V(WASM_CONTINUATION_OBJECT_TYPE, 261) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/wasm/wasm-objects.tq?l=103&c=1 */\
    V(WASM_INTERNAL_FUNCTION_TYPE, 262) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/wasm/wasm-objects.tq?l=32&c=1 */\
    V(WASM_RESUME_DATA_TYPE, 263) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/wasm/wasm-objects.tq?l=88&c=1 */\
    V(WASM_STRING_VIEW_ITER_TYPE, 264) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/wasm/wasm-objects.tq?l=213&c=1 */\
    ...
    V(FIRST_JS_RECEIVER_TYPE, 267) \
      V(FIRST_WASM_OBJECT_TYPE, 267) \
        V(WASM_ARRAY_TYPE, 267) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/wasm/wasm-objects.tq?l=205&c=1 */\
        V(WASM_STRUCT_TYPE, 268) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/wasm/wasm-objects.tq?l=201&c=1 */\
      ...
      V(FIRST_JS_OBJECT_TYPE, 270) \
        ...
        V(FIRST_JS_CUSTOM_ELEMENTS_OBJECT_TYPE, 270) \
          V(FIRST_JS_SPECIAL_OBJECT_TYPE, 270) \
            ...
            V(JS_SPECIAL_API_OBJECT_TYPE, 1040) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/base.tq?l=589&c=1 */\
        ...
        V(FIRST_JS_OBJECT_WITH_EMBEDDER_SLOTS_TYPE, 1058) \
          V(FIRST_JS_API_OBJECT_TYPE, 1058) \
            V(JS_API_OBJECT_TYPE, 1058) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/base.tq?l=575&c=1 */\
            V(JS_LAST_DUMMY_API_OBJECT_TYPE, 2058) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/base.tq?l=582&c=1 */\
        ...
        V(JS_CONTEXT_EXTENSION_OBJECT_TYPE, 2110) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/base.tq?l=592&c=1 */\
        ...
        V(JS_ERROR_TYPE, 2114) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/base.tq?l=594&c=1 */\
        V(JS_EXTERNAL_OBJECT_TYPE, 2115) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-objects.tq?l=43&c=1 */\
        V(JS_FINALIZATION_REGISTRY_TYPE, 2116) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-weak-refs.tq?l=9&c=1 */\
        V(JS_LIST_FORMAT_TYPE, 2117) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-list-format.tq?l=14&c=1 */\
        V(JS_LOCALE_TYPE, 2118) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-locale.tq?l=7&c=1 */\
        V(JS_MESSAGE_OBJECT_TYPE, 2119) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-objects.tq?l=123&c=1 */\
        V(JS_NUMBER_FORMAT_TYPE, 2120) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-number-format.tq?l=7&c=1 */\
        V(JS_PLURAL_RULES_TYPE, 2121) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-plural-rules.tq?l=12&c=1 */\
        V(JS_REG_EXP_TYPE, 2122) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-regexp.tq?l=16&c=1 */\
        ...
        V(JS_SHARED_ARRAY_TYPE, 2129) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-shared-array.tq?l=5&c=1 */\
        V(JS_SHARED_STRUCT_TYPE, 2130) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-struct.tq?l=5&c=1 */\
        V(JS_STRING_ITERATOR_TYPE, 2131) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-objects.tq?l=169&c=1 */\
        V(JS_TEMPORAL_CALENDAR_TYPE, 2132) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-temporal-objects.tq?l=37&c=1 */\
        V(JS_TEMPORAL_DURATION_TYPE, 2133) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-temporal-objects.tq?l=41&c=1 */\
        V(JS_TEMPORAL_INSTANT_TYPE, 2134) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-temporal-objects.tq?l=54&c=1 */\
        V(JS_TEMPORAL_PLAIN_DATE_TYPE, 2135) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-temporal-objects.tq?l=65&c=1 */\
        V(JS_TEMPORAL_PLAIN_DATE_TIME_TYPE, 2136) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-temporal-objects.tq?l=58&c=1 */\
        V(JS_TEMPORAL_PLAIN_MONTH_DAY_TYPE, 2137) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-temporal-objects.tq?l=70&c=1 */\
        V(JS_TEMPORAL_PLAIN_TIME_TYPE, 2138) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-temporal-objects.tq?l=75&c=1 */\
        V(JS_TEMPORAL_PLAIN_YEAR_MONTH_TYPE, 2139) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-temporal-objects.tq?l=81&c=1 */\
        V(JS_TEMPORAL_TIME_ZONE_TYPE, 2140) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-temporal-objects.tq?l=86&c=1 */\
        V(JS_TEMPORAL_ZONED_DATE_TIME_TYPE, 2141) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-temporal-objects.tq?l=91&c=1 */\
        V(JS_V8_BREAK_ITERATOR_TYPE, 2142) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-break-iterator.tq?l=7&c=1 */\
        V(JS_WEAK_REF_TYPE, 2143) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-weak-refs.tq?l=42&c=1 */\
        V(WASM_EXCEPTION_PACKAGE_TYPE, 2144) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/wasm/wasm-objects.tq?l=124&c=1 */\
        V(WASM_GLOBAL_OBJECT_TYPE, 2145) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/wasm/wasm-objects.tq?l=154&c=1 */\
        V(WASM_INSTANCE_OBJECT_TYPE, 2146) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/wasm/wasm-objects.tq?l=12&c=1 */\
        V(WASM_MEMORY_OBJECT_TYPE, 2147) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/wasm/wasm-objects.tq?l=147&c=1 */\
        V(WASM_MODULE_OBJECT_TYPE, 2148) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/wasm/wasm-objects.tq?l=126&c=1 */\
        V(WASM_SUSPENDER_OBJECT_TYPE, 2149) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/wasm/wasm-objects.tq?l=109&c=1 */\
        V(WASM_TABLE_OBJECT_TYPE, 2150) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/wasm/wasm-objects.tq?l=132&c=1 */\
        V(WASM_TAG_OBJECT_TYPE, 2151) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/wasm/wasm-objects.tq?l=169&c=1 */\
        V(WASM_VALUE_OBJECT_TYPE, 2152) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/debug/debug-wasm-objects.tq?l=7&c=1 */\
      V(LAST_JS_OBJECT_TYPE, 2152) \
    V(LAST_JS_RECEIVER_TYPE, 2152) \
  V(LAST_HEAP_OBJECT_TYPE, 2152) \
...
#define TORQUE_ASSIGNED_INSTANCE_TYPE_LIST(V) \
  ...
  V(WASM_CAPI_FUNCTION_DATA_TYPE) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/wasm/wasm-objects.tq?l=83&c=1 */\
  ...
  V(FEEDBACK_METADATA_TYPE) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/feedback-vector.tq?l=48&c=1 */\
  V(FEEDBACK_VECTOR_TYPE) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/feedback-vector.tq?l=29&c=1 */\
  V(FILLER_TYPE) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/base.tq?l=569&c=1 */\
  ...
  V(ON_HEAP_BASIC_BLOCK_PROFILER_DATA_TYPE) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/shared-function-info.tq?l=154&c=1 */\
  ...
  V(WASM_STRING_VIEW_ITER_TYPE) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/wasm/wasm-objects.tq?l=213&c=1 */\
  ...
  V(WASM_ARRAY_TYPE) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/wasm/wasm-objects.tq?l=205&c=1 */\
  V(WASM_STRUCT_TYPE) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/wasm/wasm-objects.tq?l=201&c=1 */\
  ...
  V(JS_SPECIAL_API_OBJECT_TYPE) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/base.tq?l=589&c=1 */\
  V(JS_PRIMITIVE_WRAPPER_TYPE) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/js-objects.tq?l=119&c=1 */\
  V(JS_API_OBJECT_TYPE) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/base.tq?l=575&c=1 */\
  V(JS_LAST_DUMMY_API_OBJECT_TYPE) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/base.tq?l=582&c=1 */\
  ...
  V(JS_CONTEXT_EXTENSION_OBJECT_TYPE) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/base.tq?l=592&c=1 */\
  ...
  V(JS_ERROR_TYPE) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/base.tq?l=594&c=1 */\
  ...
  V(WASM_GLOBAL_OBJECT_TYPE) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/wasm/wasm-objects.tq?l=154&c=1 */\
  V(WASM_INSTANCE_OBJECT_TYPE) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/wasm/wasm-objects.tq?l=12&c=1 */\
  V(WASM_MEMORY_OBJECT_TYPE) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/wasm/wasm-objects.tq?l=147&c=1 */\
  ...
  V(WASM_TABLE_OBJECT_TYPE) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/wasm/wasm-objects.tq?l=132&c=1 */\
  V(WASM_TAG_OBJECT_TYPE) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/wasm/wasm-objects.tq?l=169&c=1 */\
...
#define TORQUE_INSTANCE_CHECKERS_SINGLE_FULLY_DEFINED(V) \
  ...
  V(WasmCapiFunctionData, WASM_CAPI_FUNCTION_DATA_TYPE) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/wasm/wasm-objects.tq?l=83&c=1 */ \
  ...
  V(FeedbackVector, FEEDBACK_VECTOR_TYPE) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/feedback-vector.tq?l=29&c=1 */ \
  ...
  V(OnHeapBasicBlockProfilerData, ON_HEAP_BASIC_BLOCK_PROFILER_DATA_TYPE) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/shared-function-info.tq?l=154&c=1 */ \
  ...
  V(WasmStringViewIter, WASM_STRING_VIEW_ITER_TYPE) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/wasm/wasm-objects.tq?l=213&c=1 */ \
  ...
  V(WasmArray, WASM_ARRAY_TYPE) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/wasm/wasm-objects.tq?l=205&c=1 */ \
  V(WasmStruct, WASM_STRUCT_TYPE) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/wasm/wasm-objects.tq?l=201&c=1 */ \
  ...
  V(WasmGlobalObject, WASM_GLOBAL_OBJECT_TYPE) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/wasm/wasm-objects.tq?l=154&c=1 */ \
  V(WasmMemoryObject, WASM_MEMORY_OBJECT_TYPE) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/wasm/wasm-objects.tq?l=147&c=1 */ \
  ...
  V(WasmTableObject, WASM_TABLE_OBJECT_TYPE) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/wasm/wasm-objects.tq?l=132&c=1 */ \
  V(WasmTagObject, WASM_TAG_OBJECT_TYPE) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/wasm/wasm-objects.tq?l=169&c=1 */ \
...
#define TORQUE_INSTANCE_CHECKERS_SINGLE_ONLY_DECLARED(V) \
  ...
  V(FeedbackMetadata, FEEDBACK_METADATA_TYPE) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/objects/feedback-vector.tq?l=48&c=1 */ \
  V(Filler, FILLER_TYPE) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/base.tq?l=569&c=1 */ \
  V(JSSpecialApiObject, JS_SPECIAL_API_OBJECT_TYPE) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/base.tq?l=589&c=1 */ \
  V(JSLastDummyApiObject, JS_LAST_DUMMY_API_OBJECT_TYPE) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/base.tq?l=582&c=1 */ \
  ...
  V(JSContextExtensionObject, JS_CONTEXT_EXTENSION_OBJECT_TYPE) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/base.tq?l=592&c=1 */ \
  V(JSError, JS_ERROR_TYPE) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/base.tq?l=594&c=1 */ \
...
#define TORQUE_INSTANCE_CHECKERS_MULTIPLE_ONLY_DECLARED(V) \
  ...
  V(JSApiObject, JS_API_OBJECT_TYPE) /* https://source.chromium.org/chromium/chromium/src/+/main:v8/src/builtins/base.tq?l=575&c=1 */ \
