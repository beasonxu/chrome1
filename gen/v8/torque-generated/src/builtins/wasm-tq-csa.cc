...
TNode<BoolT> IsWord16WasmArrayMap_0(compiler::CodeAssemblerState* state_, TNode<Map> p_map) {
  ...
  if (block0.is_used()) {
    ...
    tmp1 = CodeStubAssembler(state_).LoadForeignForeignAddressPtr(TNode<Foreign>{tmp0});
...
TF_BUILTIN(ExperimentalWasmConvertArrayToString, CodeStubAssembler) {
  ...
  USE(parameter0);
  TNode<Object> parameter1 = UncheckedParameter<Object>(Descriptor::kArray);
  USE(parameter1);
  TNode<Object> parameter2 = UncheckedParameter<Object>(Descriptor::kStart);
  USE(parameter2);
  TNode<Object> parameter3 = UncheckedParameter<Object>(Descriptor::kCount);
  USE(parameter3);
  compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<> block6(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<> block5(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    compiler::CodeAssemblerLabel label1(&ca_);
    tmp0 = TryNumberToIntptr_0(state_, TNode<Object>{parameter2}, &label1);
    ca_.Goto(&block5);
    if (label1.is_used()) {
      ca_.Bind(&label1);
      ca_.Goto(&block6);
  ...
  if (block5.is_used()) {
    ca_.Bind(&block5);
    compiler::CodeAssemblerLabel label3(&ca_);
    tmp2 = TryNumberToIntptr_0(state_, TNode<Object>{parameter3}, &label3);
    ca_.Goto(&block9);
    if (label3.is_used()) {
      ca_.Bind(&label3);
      ca_.Goto(&block10);
  ...
  if (block9.is_used()) {
    ...
    tmp4 = Cast_WasmArray_1(state_, TNode<Context>{parameter0}, TNode<Object>{parameter1}, &label5);
    ca_.Goto(&block13);
    if (label5.is_used()) {
      ca_.Bind(&label5);
      ca_.Goto(&block14);
  ...
  if (block13.is_used()) {
    ...
    tmp7 = CodeStubAssembler(state_).LoadReference<Map>(CodeStubAssembler::Reference{tmp4, tmp6});
    tmp8 = IsWord16WasmArrayMap_0(state_, TNode<Map>{tmp7});
  ...
  if (block16.is_used()) {
    ...
    tmp11 = CodeStubAssembler(state_).LoadReference<Uint32T>(CodeStubAssembler::Reference{tmp4, tmp10});
    tmp12 = Convert_intptr_uint32_0(state_, TNode<Uint32T>{tmp11});
    tmp13 = FromConstexpr_intptr_constexpr_int32_0(state_, WasmArray::kHeaderSize);
    std::tie(tmp14, tmp15, tmp16) = NewConstSlice_char16_0(state_, TNode<Object>{tmp4}, TNode<IntPtrT>{tmp13}, TNode<IntPtrT>{tmp12}).Flatten();
    tmp17 = CodeStubAssembler(state_).Unsigned(TNode<IntPtrT>{tmp2});
    tmp18 = Convert_uint32_uintptr_0(state_, TNode<UintPtrT>{tmp17});
    compiler::CodeAssemblerLabel label22(&ca_);
    std::tie(tmp19, tmp20, tmp21) = Subslice_char16_0(state_, TorqueStructSlice_char16_ConstReference_char16_0{TNode<Object>{tmp14}, TNode<IntPtrT>{tmp15}, TNode<IntPtrT>{tmp16}, TorqueStructUnsafe_0{}}, TNode<IntPtrT>{tmp0}, TNode<IntPtrT>{tmp2}, &label22).Flatten();
    ca_.Goto(&block19);
    if (label22.is_used()) {
      ca_.Bind(&label22);
      ca_.Goto(&block20);
  ...
  if (block19.is_used()) {
    ca_.Bind(&block19);
    tmp23 = TimesSizeOf_char16_0(state_, TNode<IntPtrT>{tmp21});
    tmp24 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{tmp20}, TNode<IntPtrT>{tmp23});
    tmp25 = AllocateSeqTwoByteString_SliceIterator_char16_ConstReference_char16_0(state_, TNode<Uint32T>{tmp18}, TorqueStructSliceIterator_char16_ConstReference_char16_0{TNode<Object>{tmp19}, TNode<IntPtrT>{tmp20}, TNode<IntPtrT>{tmp24}, TorqueStructUnsafe_0{}});
...
TF_BUILTIN(ExperimentalWasmConvertStringToArray, CodeStubAssembler) {
  ...
  TNode<NativeContext> parameter0 = UncheckedParameter<NativeContext>(Descriptor::kContext);
  USE(parameter0);
  TNode<Object> parameter1 = UncheckedParameter<Object>(Descriptor::kString);
  USE(parameter1);
  TNode<Object> parameter2 = UncheckedParameter<Object>(Descriptor::kSampleArray);
  USE(parameter2);
  compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<> block6(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<> block5(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  compiler::CodeAssemblerParameterizedLabel<String, IntPtrT, String, String> block23(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<String, IntPtrT, String, String> block22(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<String, IntPtrT, String, IntPtrT> block27(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<String, IntPtrT, String, IntPtrT> block26(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  compiler::CodeAssemblerParameterizedLabel<String, IntPtrT, String, IntPtrT> block35(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<String, IntPtrT, String, IntPtrT> block34(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  compiler::CodeAssemblerParameterizedLabel<String, IntPtrT, String> block46(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  compiler::CodeAssemblerParameterizedLabel<String, IntPtrT, String, IntPtrT> block55(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<String, IntPtrT, String, IntPtrT> block54(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<String, IntPtrT, String> block59(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<String, IntPtrT, String> block58(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<String, IntPtrT, String, IntPtrT> block63(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<String, IntPtrT, String, IntPtrT> block62(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  compiler::CodeAssemblerParameterizedLabel<Object, IntPtrT, IntPtrT, Object, IntPtrT, IntPtrT> block73(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  compiler::CodeAssemblerParameterizedLabel<Object, IntPtrT, IntPtrT> block14(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    compiler::CodeAssemblerLabel label1(&ca_);
    tmp0 = Cast_WasmArray_1(state_, TNode<Context>{parameter0}, TNode<Object>{parameter2}, &label1);
    ca_.Goto(&block5);
    if (label1.is_used()) {
      ca_.Bind(&label1);
      ca_.Goto(&block6);
  ...
  if (block5.is_used()) {
    ...
    tmp4 = IsWord16WasmArrayMap_0(state_, TNode<Map>{tmp3});
  ...
  if (block8.is_used()) {
    ca_.Bind(&block8);
    compiler::CodeAssemblerLabel label7(&ca_);
    tmp6 = Cast_String_1(state_, TNode<Context>{parameter0}, TNode<Object>{parameter1}, &label7);
    ca_.Goto(&block11);
    if (label7.is_used()) {
      ca_.Bind(&label7);
      ca_.Goto(&block12);
  ...
  if (block11.is_used()) {
    ...
    tmp9 = CodeStubAssembler(state_).LoadReference<Int32T>(CodeStubAssembler::Reference{tmp6, tmp8});
    ...
    tmp12 = ca_.CallStub<WasmArray>(Builtins::CallableFor(ca_.isolate(), Builtin::kWasmAllocateArray_Uninitialized), TNode<Object>(), tmp3, tmp10, tmp11);
    tmp13 = Convert_intptr_int32_0(state_, TNode<Int32T>{tmp9});
    tmp14 = FromConstexpr_intptr_constexpr_int32_0(state_, WasmArray::kHeaderSize);
    std::tie(tmp15, tmp16, tmp17) = NewMutableSlice_char16_0(state_, TNode<Object>{tmp12}, TNode<IntPtrT>{tmp14}, TNode<IntPtrT>{tmp13}).Flatten();
    ...
    tmp20 = CodeStubAssembler(state_).LoadReference<Int32T>(CodeStubAssembler::Reference{tmp6, tmp19});
    tmp21 = Convert_intptr_int32_0(state_, TNode<Int32T>{tmp20});
    ca_.Goto(&block19, tmp6, tmp18);
  }
  ...
  TNode<BoolT> tmp22;
  if (block19.is_used()) {
    ca_.Bind(&block19, &phi_bb19_13, &phi_bb19_14);
    tmp22 = FromConstexpr_bool_constexpr_bool_0(state_, true);
    ca_.Branch(tmp22, &block17, std::vector<compiler::Node*>{phi_bb19_13, phi_bb19_14}, &block18, std::vector<compiler::Node*>{phi_bb19_13, phi_bb19_14});
  }
  ...
  if (block17.is_used()) {
    ca_.Bind(&block17, &phi_bb17_13, &phi_bb17_14);
    compiler::CodeAssemblerLabel label24(&ca_);
    tmp23 = Cast_SeqOneByteString_1(state_, TNode<String>{phi_bb17_13}, &label24);
    ca_.Goto(&block22, phi_bb17_13, phi_bb17_14, phi_bb17_13, phi_bb17_13);
    if (label24.is_used()) {
      ca_.Bind(&label24);
      ca_.Goto(&block23, phi_bb17_13, phi_bb17_14, phi_bb17_13, phi_bb17_13);
    }
  }

  TNode<String> phi_bb23_13;
  TNode<IntPtrT> phi_bb23_14;
  TNode<String> phi_bb23_16;
  TNode<String> phi_bb23_17;
  TNode<SeqTwoByteString> tmp25;
  if (block23.is_used()) {
    ca_.Bind(&block23, &phi_bb23_13, &phi_bb23_14, &phi_bb23_16, &phi_bb23_17);
    compiler::CodeAssemblerLabel label26(&ca_);
    tmp25 = Cast_SeqTwoByteString_1(state_, TNode<String>{ca_.UncheckedCast<String>(phi_bb23_16)}, &label26);
    ca_.Goto(&block30, phi_bb23_13, phi_bb23_14, phi_bb23_16);
    if (label26.is_used()) {
      ca_.Bind(&label26);
      ca_.Goto(&block31, phi_bb23_13, phi_bb23_14, phi_bb23_16);
    }
  }

  TNode<String> phi_bb22_13;
  TNode<IntPtrT> phi_bb22_14;
  TNode<String> phi_bb22_16;
  TNode<String> phi_bb22_17;
  TNode<Object> tmp27;
  TNode<IntPtrT> tmp28;
  TNode<IntPtrT> tmp29;
  TNode<Object> tmp30;
  ...
  TNode<IntPtrT> tmp32;
  if (block22.is_used()) {
    ca_.Bind(&block22, &phi_bb22_13, &phi_bb22_14, &phi_bb22_16, &phi_bb22_17);
    ...
    std::tie(tmp30, tmp31, tmp32) = Subslice_char8_0(state_, TorqueStructSlice_char8_ConstReference_char8_0{TNode<Object>{tmp27}, TNode<IntPtrT>{tmp28}, TNode<IntPtrT>{tmp29}, TorqueStructUnsafe_0{}}, TNode<IntPtrT>{phi_bb22_14}, TNode<IntPtrT>{tmp21}, &label33).Flatten();
    ca_.Goto(&block26, phi_bb22_13, phi_bb22_14, phi_bb22_16, phi_bb22_14);
    if (label33.is_used()) {
      ca_.Bind(&label33);
      ca_.Goto(&block27, phi_bb22_13, phi_bb22_14, phi_bb22_16, phi_bb22_14);
    }
  }

  TNode<String> phi_bb27_13;
  TNode<IntPtrT> phi_bb27_14;
  TNode<String> phi_bb27_16;
  TNode<IntPtrT> phi_bb27_21;
  if (block27.is_used()) {
    ca_.Bind(&block27, &phi_bb27_13, &phi_bb27_14, &phi_bb27_16, &phi_bb27_21);
    CodeStubAssembler(state_).Unreachable();
  }

  TNode<String> phi_bb26_13;
  TNode<IntPtrT> phi_bb26_14;
  TNode<String> phi_bb26_16;
  TNode<IntPtrT> phi_bb26_21;
  if (block26.is_used()) {
    ca_.Bind(&block26, &phi_bb26_13, &phi_bb26_14, &phi_bb26_16, &phi_bb26_21);
    ca_.Goto(&block16, tmp30, tmp31, tmp32);
  }

  TNode<String> phi_bb31_13;
  TNode<IntPtrT> phi_bb31_14;
  TNode<String> phi_bb31_16;
  TNode<ThinString> tmp34;
  if (block31.is_used()) {
    ca_.Bind(&block31, &phi_bb31_13, &phi_bb31_14, &phi_bb31_16);
    compiler::CodeAssemblerLabel label35(&ca_);
    tmp34 = Cast_ThinString_1(state_, TNode<String>{ca_.UncheckedCast<String>(phi_bb31_16)}, &label35);
    ca_.Goto(&block38, phi_bb31_13, phi_bb31_14, phi_bb31_16);
    if (label35.is_used()) {
      ca_.Bind(&label35);
      ca_.Goto(&block39, phi_bb31_13, phi_bb31_14, phi_bb31_16);
    }
  }

  TNode<String> phi_bb30_13;
  TNode<IntPtrT> phi_bb30_14;
  TNode<String> phi_bb30_16;
  TNode<Object> tmp36;
  TNode<IntPtrT> tmp37;
  TNode<IntPtrT> tmp38;
  TNode<Object> tmp39;
  ...
  TNode<IntPtrT> tmp41;
  if (block30.is_used()) {
    ca_.Bind(&block30, &phi_bb30_13, &phi_bb30_14, &phi_bb30_16);
    ...
    std::tie(tmp39, tmp40, tmp41) = Subslice_char16_0(state_, TorqueStructSlice_char16_ConstReference_char16_0{TNode<Object>{tmp36}, TNode<IntPtrT>{tmp37}, TNode<IntPtrT>{tmp38}, TorqueStructUnsafe_0{}}, TNode<IntPtrT>{phi_bb30_14}, TNode<IntPtrT>{tmp21}, &label42).Flatten();
    ca_.Goto(&block34, phi_bb30_13, phi_bb30_14, phi_bb30_16, phi_bb30_14);
    if (label42.is_used()) {
      ca_.Bind(&label42);
      ca_.Goto(&block35, phi_bb30_13, phi_bb30_14, phi_bb30_16, phi_bb30_14);
    }
  }

  TNode<String> phi_bb35_13;
  TNode<IntPtrT> phi_bb35_14;
  TNode<String> phi_bb35_16;
  TNode<IntPtrT> phi_bb35_21;
  if (block35.is_used()) {
    ca_.Bind(&block35, &phi_bb35_13, &phi_bb35_14, &phi_bb35_16, &phi_bb35_21);
    CodeStubAssembler(state_).Unreachable();
  }

  TNode<String> phi_bb34_13;
  TNode<IntPtrT> phi_bb34_14;
  TNode<String> phi_bb34_16;
  TNode<IntPtrT> phi_bb34_21;
  if (block34.is_used()) {
    ca_.Bind(&block34, &phi_bb34_13, &phi_bb34_14, &phi_bb34_16, &phi_bb34_21);
    ca_.Goto(&block14, tmp39, tmp40, tmp41);
  }

  TNode<String> phi_bb39_13;
  TNode<IntPtrT> phi_bb39_14;
  TNode<String> phi_bb39_16;
  TNode<ConsString> tmp43;
  if (block39.is_used()) {
    ca_.Bind(&block39, &phi_bb39_13, &phi_bb39_14, &phi_bb39_16);
    compiler::CodeAssemblerLabel label44(&ca_);
    tmp43 = Cast_ConsString_1(state_, TNode<String>{ca_.UncheckedCast<String>(phi_bb39_16)}, &label44);
    ca_.Goto(&block42, phi_bb39_13, phi_bb39_14, phi_bb39_16);
    if (label44.is_used()) {
      ca_.Bind(&label44);
      ca_.Goto(&block43, phi_bb39_13, phi_bb39_14, phi_bb39_16);
    }
  }

  TNode<String> phi_bb38_13;
  TNode<IntPtrT> phi_bb38_14;
  TNode<String> phi_bb38_16;
  TNode<IntPtrT> tmp45;
  TNode<String> tmp46;
  if (block38.is_used()) {
    ca_.Bind(&block38, &phi_bb38_13, &phi_bb38_14, &phi_bb38_16);
    ...
    ca_.Goto(&block36, tmp46, phi_bb38_14, phi_bb38_16);
  }

  TNode<String> phi_bb43_13;
  TNode<IntPtrT> phi_bb43_14;
  TNode<String> phi_bb43_16;
  TNode<SlicedString> tmp47;
  if (block43.is_used()) {
    ca_.Bind(&block43, &phi_bb43_13, &phi_bb43_14, &phi_bb43_16);
    compiler::CodeAssemblerLabel label48(&ca_);
    tmp47 = Cast_SlicedString_1(state_, TNode<String>{ca_.UncheckedCast<String>(phi_bb43_16)}, &label48);
    ca_.Goto(&block46, phi_bb43_13, phi_bb43_14, phi_bb43_16);
    if (label48.is_used()) {
      ca_.Bind(&label48);
      ca_.Goto(&block47, phi_bb43_13, phi_bb43_14, phi_bb43_16);
    }
  }

  TNode<String> phi_bb42_13;
  TNode<IntPtrT> phi_bb42_14;
  TNode<String> phi_bb42_16;
  TNode<String> tmp49;
  if (block42.is_used()) {
    ca_.Bind(&block42, &phi_bb42_13, &phi_bb42_14, &phi_bb42_16);
    tmp49 = Flatten_1(state_, TNode<ConsString>{tmp43});
    ca_.Goto(&block40, tmp49, phi_bb42_14, phi_bb42_16);
  }

  TNode<String> phi_bb47_13;
  TNode<IntPtrT> phi_bb47_14;
  TNode<String> phi_bb47_16;
  TNode<ExternalOneByteString> tmp50;
  if (block47.is_used()) {
    ca_.Bind(&block47, &phi_bb47_13, &phi_bb47_14, &phi_bb47_16);
    compiler::CodeAssemblerLabel label51(&ca_);
    tmp50 = Cast_ExternalOneByteString_1(state_, TNode<String>{ca_.UncheckedCast<String>(phi_bb47_16)}, &label51);
    ca_.Goto(&block50, phi_bb47_13, phi_bb47_14, phi_bb47_16);
    if (label51.is_used()) {
      ca_.Bind(&label51);
      ca_.Goto(&block51, phi_bb47_13, phi_bb47_14, phi_bb47_16);
    }
  }

  TNode<String> phi_bb46_13;
  TNode<IntPtrT> phi_bb46_14;
  TNode<String> phi_bb46_16;
  TNode<IntPtrT> tmp52;
  TNode<Smi> tmp53;
  TNode<IntPtrT> tmp54;
  TNode<IntPtrT> tmp55;
  ...
  TNode<String> tmp57;
  if (block46.is_used()) {
    ca_.Bind(&block46, &phi_bb46_13, &phi_bb46_14, &phi_bb46_16);
    ...
    tmp55 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{phi_bb46_14}, TNode<IntPtrT>{tmp54});
    ...
    ca_.Goto(&block40, tmp57, tmp55, phi_bb46_16);
  }

  TNode<String> phi_bb51_13;
  TNode<IntPtrT> phi_bb51_14;
  TNode<String> phi_bb51_16;
  TNode<ExternalTwoByteString> tmp58;
  if (block51.is_used()) {
    ca_.Bind(&block51, &phi_bb51_13, &phi_bb51_14, &phi_bb51_16);
    compiler::CodeAssemblerLabel label59(&ca_);
    tmp58 = Cast_ExternalTwoByteString_1(state_, TNode<String>{ca_.UncheckedCast<String>(phi_bb51_16)}, &label59);
    ca_.Goto(&block58, phi_bb51_13, phi_bb51_14, phi_bb51_16);
    if (label59.is_used()) {
      ca_.Bind(&label59);
      ca_.Goto(&block59, phi_bb51_13, phi_bb51_14, phi_bb51_16);
    }
  }

  TNode<String> phi_bb50_13;
  TNode<IntPtrT> phi_bb50_14;
  TNode<String> phi_bb50_16;
  TNode<RawPtrT> tmp60;
  TNode<IntPtrT> tmp61;
  TNode<Int32T> tmp62;
  TNode<IntPtrT> tmp63;
  ...
  TNode<IntPtrT> tmp69;
  if (block50.is_used()) {
    ca_.Bind(&block50, &phi_bb50_13, &phi_bb50_14, &phi_bb50_16);
    ...
    std::tie(tmp67, tmp68, tmp69) = Subslice_char8_0(state_, TorqueStructSlice_char8_ConstReference_char8_0{TNode<Object>{tmp64}, TNode<IntPtrT>{tmp65}, TNode<IntPtrT>{tmp66}, TorqueStructUnsafe_0{}}, TNode<IntPtrT>{phi_bb50_14}, TNode<IntPtrT>{tmp21}, &label70).Flatten();
    ca_.Goto(&block54, phi_bb50_13, phi_bb50_14, phi_bb50_16, phi_bb50_14);
    if (label70.is_used()) {
      ca_.Bind(&label70);
      ca_.Goto(&block55, phi_bb50_13, phi_bb50_14, phi_bb50_16, phi_bb50_14);
    }
  }

  TNode<String> phi_bb55_13;
  TNode<IntPtrT> phi_bb55_14;
  TNode<String> phi_bb55_16;
  TNode<IntPtrT> phi_bb55_24;
  if (block55.is_used()) {
    ca_.Bind(&block55, &phi_bb55_13, &phi_bb55_14, &phi_bb55_16, &phi_bb55_24);
    CodeStubAssembler(state_).Unreachable();
  }

  TNode<String> phi_bb54_13;
  TNode<IntPtrT> phi_bb54_14;
  TNode<String> phi_bb54_16;
  TNode<IntPtrT> phi_bb54_24;
  if (block54.is_used()) {
    ca_.Bind(&block54, &phi_bb54_13, &phi_bb54_14, &phi_bb54_16, &phi_bb54_24);
    ca_.Goto(&block16, tmp67, tmp68, tmp69);
  }

  TNode<String> phi_bb59_13;
  TNode<IntPtrT> phi_bb59_14;
  TNode<String> phi_bb59_16;
  if (block59.is_used()) {
    ca_.Bind(&block59, &phi_bb59_13, &phi_bb59_14, &phi_bb59_16);
    CodeStubAssembler(state_).Unreachable();
  }

  TNode<String> phi_bb58_13;
  TNode<IntPtrT> phi_bb58_14;
  TNode<String> phi_bb58_16;
  TNode<RawPtrT> tmp71;
  TNode<IntPtrT> tmp72;
  TNode<Int32T> tmp73;
  TNode<IntPtrT> tmp74;
  ...
  TNode<IntPtrT> tmp80;
  if (block58.is_used()) {
    ca_.Bind(&block58, &phi_bb58_13, &phi_bb58_14, &phi_bb58_16);
    ...
    std::tie(tmp78, tmp79, tmp80) = Subslice_char16_0(state_, TorqueStructSlice_char16_ConstReference_char16_0{TNode<Object>{tmp75}, TNode<IntPtrT>{tmp76}, TNode<IntPtrT>{tmp77}, TorqueStructUnsafe_0{}}, TNode<IntPtrT>{phi_bb58_14}, TNode<IntPtrT>{tmp21}, &label81).Flatten();
    ca_.Goto(&block62, phi_bb58_13, phi_bb58_14, phi_bb58_16, phi_bb58_14);
    if (label81.is_used()) {
      ca_.Bind(&label81);
      ca_.Goto(&block63, phi_bb58_13, phi_bb58_14, phi_bb58_16, phi_bb58_14);
    }
  }

  TNode<String> phi_bb63_13;
  TNode<IntPtrT> phi_bb63_14;
  TNode<String> phi_bb63_16;
  TNode<IntPtrT> phi_bb63_24;
  if (block63.is_used()) {
    ca_.Bind(&block63, &phi_bb63_13, &phi_bb63_14, &phi_bb63_16, &phi_bb63_24);
    CodeStubAssembler(state_).Unreachable();
  }

  TNode<String> phi_bb62_13;
  TNode<IntPtrT> phi_bb62_14;
  TNode<String> phi_bb62_16;
  TNode<IntPtrT> phi_bb62_24;
  if (block62.is_used()) {
    ca_.Bind(&block62, &phi_bb62_13, &phi_bb62_14, &phi_bb62_16, &phi_bb62_24);
    ca_.Goto(&block14, tmp78, tmp79, tmp80);
  }

  TNode<String> phi_bb40_13;
  TNode<IntPtrT> phi_bb40_14;
  TNode<String> phi_bb40_16;
  if (block40.is_used()) {
    ca_.Bind(&block40, &phi_bb40_13, &phi_bb40_14, &phi_bb40_16);
    ca_.Goto(&block36, phi_bb40_13, phi_bb40_14, phi_bb40_16);
  }

  TNode<String> phi_bb36_13;
  TNode<IntPtrT> phi_bb36_14;
  TNode<String> phi_bb36_16;
  if (block36.is_used()) {
    ca_.Bind(&block36, &phi_bb36_13, &phi_bb36_14, &phi_bb36_16);
    ca_.Goto(&block19, phi_bb36_13, phi_bb36_14);
  }

  TNode<String> phi_bb18_13;
  ...
  if (block16.is_used()) {
    ...
    tmp82 = TimesSizeOf_char8_0(state_, TNode<IntPtrT>{phi_bb16_13});
    tmp83 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{phi_bb16_12}, TNode<IntPtrT>{tmp82});
    ...
    ca_.Goto(&block68, phi_bb16_11, phi_bb16_12, phi_bb16_13, phi_bb16_11, phi_bb16_12, tmp16);
  }

  TNode<Object> phi_bb68_11;
  TNode<IntPtrT> phi_bb68_12;
  TNode<IntPtrT> phi_bb68_13;
  TNode<Object> phi_bb68_14;
  TNode<IntPtrT> phi_bb68_15;
  TNode<IntPtrT> phi_bb68_18;
  TNode<BoolT> tmp86;
  if (block68.is_used()) {
    ca_.Bind(&block68, &phi_bb68_11, &phi_bb68_12, &phi_bb68_13, &phi_bb68_14, &phi_bb68_15, &phi_bb68_18);
    tmp86 = FromConstexpr_bool_constexpr_bool_0(state_, true);
    ca_.Branch(tmp86, &block66, std::vector<compiler::Node*>{phi_bb68_11, phi_bb68_12, phi_bb68_13, phi_bb68_14, phi_bb68_15, phi_bb68_18}, &block67, std::vector<compiler::Node*>{phi_bb68_11, phi_bb68_12, phi_bb68_13, phi_bb68_14, phi_bb68_15, phi_bb68_18});
  }

  TNode<Object> phi_bb66_11;
  TNode<IntPtrT> phi_bb66_12;
  TNode<IntPtrT> phi_bb66_13;
  TNode<Object> phi_bb66_14;
  TNode<IntPtrT> phi_bb66_15;
  TNode<IntPtrT> phi_bb66_18;
  TNode<BoolT> tmp87;
  if (block66.is_used()) {
    ca_.Bind(&block66, &phi_bb66_11, &phi_bb66_12, &phi_bb66_13, &phi_bb66_14, &phi_bb66_15, &phi_bb66_18);
    tmp87 = CodeStubAssembler(state_).WordEqual(TNode<IntPtrT>{phi_bb66_18}, TNode<IntPtrT>{tmp85});
    ca_.Branch(tmp87, &block72, std::vector<compiler::Node*>{phi_bb66_11, phi_bb66_12, phi_bb66_13, phi_bb66_14, phi_bb66_15, phi_bb66_18}, &block73, std::vector<compiler::Node*>{phi_bb66_11, phi_bb66_12, phi_bb66_13, phi_bb66_14, phi_bb66_15, phi_bb66_18});
  }

  TNode<Object> phi_bb72_11;
  TNode<IntPtrT> phi_bb72_12;
  TNode<IntPtrT> phi_bb72_13;
  TNode<Object> phi_bb72_14;
  TNode<IntPtrT> phi_bb72_15;
  TNode<IntPtrT> phi_bb72_18;
  if (block72.is_used()) {
    ca_.Bind(&block72, &phi_bb72_11, &phi_bb72_12, &phi_bb72_13, &phi_bb72_14, &phi_bb72_15, &phi_bb72_18);
    ca_.Goto(&block67, phi_bb72_11, phi_bb72_12, phi_bb72_13, phi_bb72_14, phi_bb72_15, phi_bb72_18);
  }

  TNode<Object> phi_bb73_11;
  TNode<IntPtrT> phi_bb73_12;
  TNode<IntPtrT> phi_bb73_13;
  TNode<Object> phi_bb73_14;
  TNode<IntPtrT> phi_bb73_15;
  TNode<IntPtrT> phi_bb73_18;
  TNode<Object> tmp88;
  TNode<IntPtrT> tmp89;
  TNode<IntPtrT> tmp90;
  TNode<IntPtrT> tmp91;
  ...
  TNode<Uint16T> tmp98;
  if (block73.is_used()) {
    ca_.Bind(&block73, &phi_bb73_11, &phi_bb73_12, &phi_bb73_13, &phi_bb73_14, &phi_bb73_15, &phi_bb73_18);
    std::tie(tmp88, tmp89) = NewReference_char16_0(state_, TNode<Object>{tmp15}, TNode<IntPtrT>{phi_bb73_18}).Flatten();
    tmp90 = FromConstexpr_intptr_constexpr_int31_0(state_, kUInt16Size);
    tmp91 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{phi_bb73_18}, TNode<IntPtrT>{tmp90});
    std::tie(tmp92, tmp93) = NewReference_char8_0(state_, TNode<Object>{phi_bb73_14}, TNode<IntPtrT>{phi_bb73_15}).Flatten();
    tmp94 = FromConstexpr_intptr_constexpr_int31_0(state_, kUInt8Size);
    tmp95 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{phi_bb73_15}, TNode<IntPtrT>{tmp94});
    ...
    ca_.Goto(&block68, phi_bb73_11, phi_bb73_12, phi_bb73_13, phi_bb73_14, tmp95, tmp91);
  }

  TNode<Object> phi_bb67_11;
  TNode<IntPtrT> phi_bb67_12;
  TNode<IntPtrT> phi_bb67_13;
  TNode<Object> phi_bb67_14;
  TNode<IntPtrT> phi_bb67_15;
  TNode<IntPtrT> phi_bb67_18;
  if (block67.is_used()) {
    ca_.Bind(&block67, &phi_bb67_11, &phi_bb67_12, &phi_bb67_13, &phi_bb67_14, &phi_bb67_15, &phi_bb67_18);
    ca_.Goto(&block13);
  }
  ...
  TNode<IntPtrT> tmp102;
  if (block14.is_used()) {
    ca_.Bind(&block14, &phi_bb14_11, &phi_bb14_12, &phi_bb14_13);
    tmp99 = TimesSizeOf_char16_0(state_, TNode<IntPtrT>{phi_bb14_13});
    tmp100 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{phi_bb14_12}, TNode<IntPtrT>{tmp99});
    ...
    ca_.Goto(&block87, phi_bb14_11, phi_bb14_12, phi_bb14_13, phi_bb14_11, phi_bb14_12, tmp16);
  }

  TNode<Object> phi_bb87_11;
  TNode<IntPtrT> phi_bb87_12;
  TNode<IntPtrT> phi_bb87_13;
  TNode<Object> phi_bb87_14;
  TNode<IntPtrT> phi_bb87_15;
  TNode<IntPtrT> phi_bb87_18;
  TNode<BoolT> tmp103;
  if (block87.is_used()) {
    ca_.Bind(&block87, &phi_bb87_11, &phi_bb87_12, &phi_bb87_13, &phi_bb87_14, &phi_bb87_15, &phi_bb87_18);
    tmp103 = FromConstexpr_bool_constexpr_bool_0(state_, true);
    ca_.Branch(tmp103, &block85, std::vector<compiler::Node*>{phi_bb87_11, phi_bb87_12, phi_bb87_13, phi_bb87_14, phi_bb87_15, phi_bb87_18}, &block86, std::vector<compiler::Node*>{phi_bb87_11, phi_bb87_12, phi_bb87_13, phi_bb87_14, phi_bb87_15, phi_bb87_18});
  }

  TNode<Object> phi_bb85_11;
  TNode<IntPtrT> phi_bb85_12;
  TNode<IntPtrT> phi_bb85_13;
  TNode<Object> phi_bb85_14;
  TNode<IntPtrT> phi_bb85_15;
  TNode<IntPtrT> phi_bb85_18;
  TNode<BoolT> tmp104;
  if (block85.is_used()) {
    ca_.Bind(&block85, &phi_bb85_11, &phi_bb85_12, &phi_bb85_13, &phi_bb85_14, &phi_bb85_15, &phi_bb85_18);
    tmp104 = CodeStubAssembler(state_).WordEqual(TNode<IntPtrT>{phi_bb85_18}, TNode<IntPtrT>{tmp102});
    ca_.Branch(tmp104, &block91, std::vector<compiler::Node*>{phi_bb85_11, phi_bb85_12, phi_bb85_13, phi_bb85_14, phi_bb85_15, phi_bb85_18}, &block92, std::vector<compiler::Node*>{phi_bb85_11, phi_bb85_12, phi_bb85_13, phi_bb85_14, phi_bb85_15, phi_bb85_18});
  }

  TNode<Object> phi_bb91_11;
  TNode<IntPtrT> phi_bb91_12;
  TNode<IntPtrT> phi_bb91_13;
  TNode<Object> phi_bb91_14;
  TNode<IntPtrT> phi_bb91_15;
  TNode<IntPtrT> phi_bb91_18;
  if (block91.is_used()) {
    ca_.Bind(&block91, &phi_bb91_11, &phi_bb91_12, &phi_bb91_13, &phi_bb91_14, &phi_bb91_15, &phi_bb91_18);
    ca_.Goto(&block86, phi_bb91_11, phi_bb91_12, phi_bb91_13, phi_bb91_14, phi_bb91_15, phi_bb91_18);
  }

  TNode<Object> phi_bb92_11;
  TNode<IntPtrT> phi_bb92_12;
  TNode<IntPtrT> phi_bb92_13;
  TNode<Object> phi_bb92_14;
  ...
  if (block92.is_used()) {
    ca_.Bind(&block92, &phi_bb92_11, &phi_bb92_12, &phi_bb92_13, &phi_bb92_14, &phi_bb92_15, &phi_bb92_18);
    std::tie(tmp105, tmp106) = NewReference_char16_0(state_, TNode<Object>{tmp15}, TNode<IntPtrT>{phi_bb92_18}).Flatten();
    tmp107 = FromConstexpr_intptr_constexpr_int31_0(state_, kUInt16Size);
    tmp108 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{phi_bb92_18}, TNode<IntPtrT>{tmp107});
    std::tie(tmp109, tmp110) = NewReference_char16_0(state_, TNode<Object>{phi_bb92_14}, TNode<IntPtrT>{phi_bb92_15}).Flatten();
    tmp111 = FromConstexpr_intptr_constexpr_int31_0(state_, kUInt16Size);
    tmp112 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{phi_bb92_15}, TNode<IntPtrT>{tmp111});
    ...
    ca_.Goto(&block87, phi_bb92_11, phi_bb92_12, phi_bb92_13, phi_bb92_14, tmp112, tmp108);
  }

  TNode<Object> phi_bb86_11;
  TNode<IntPtrT> phi_bb86_12;
  TNode<IntPtrT> phi_bb86_13;
  TNode<Object> phi_bb86_14;
  TNode<IntPtrT> phi_bb86_15;
  TNode<IntPtrT> phi_bb86_18;
  if (block86.is_used()) {
    ca_.Bind(&block86, &phi_bb86_11, &phi_bb86_12, &phi_bb86_13, &phi_bb86_14, &phi_bb86_15, &phi_bb86_18);
    ca_.Goto(&block13);
  }
...
TF_BUILTIN(WasmStringNewWtf8, CodeStubAssembler) {
  ...
  USE(parameter2);
  TNode<Smi> parameter3 = UncheckedParameter<Smi>(Descriptor::kPolicy);
  USE(parameter3);
  compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0);
...
TF_BUILTIN(WasmStringViewWtf8Encode, CodeStubAssembler) {
  ...
  USE(parameter4);
  TNode<Smi> parameter5 = UncheckedParameter<Smi>(Descriptor::kPolicy);
  USE(parameter5);
  compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0);
