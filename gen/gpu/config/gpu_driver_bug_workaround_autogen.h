...
#define GPU_DRIVER_BUG_WORKAROUNDS(GPU_OP)                                  \
  ...
  GPU_OP(ADD_FENCE_FOR_SAME_GL_CONTEXT,                                     \
  ...
  GPU_OP(DISABLE_DXVA_VIDEO_DECODER,                                        \
  ...
  GPU_OP(DISALLOW_VP9_RESILIENT_DXVA_DECODING,                              \
  ...
  GPU_OP(FORCE_DIRECT_COMPOSITION_FULL_DAMAGE_ALWAYS,                       \
  ...
  GPU_OP(FORCE_RGB10A2_OVERLAY_SUPPORT_FLAGS,                               \
  ...
  GPU_OP(USE_EMPTY_VIDEO_HDR_METADATA,                                      \
