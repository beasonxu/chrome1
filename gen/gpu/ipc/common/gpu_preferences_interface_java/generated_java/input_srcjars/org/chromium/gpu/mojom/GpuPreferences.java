...
public final class GpuPreferences extends org.chromium.mojo.bindings.Struct {
    ...
    public static GpuPreferences decode(org.chromium.mojo.bindings.Decoder decoder0) {
        ...
        try {
            ...
            result = new GpuPreferences(elementsOrVersion);
                ...
                result.watchdogStartsBackgrounded = decoder0.readBoolean(11, 6);
                }
                {
                    
                result.enableVulkanProtectedMemory = decoder0.readBoolean(11, 7);
                }
                {
                ...
                result.disableVulkanSurface = decoder0.readBoolean(44, 0);
                }
                {
                    
                result.disableVulkanFallbackToGlForTesting = decoder0.readBoolean(44, 1);
                }
                {
                    
                result.enableMetal = decoder0.readBoolean(44, 2);
                }
                {
                    
                result.enableGpuBenchmarkingExtension = decoder0.readBoolean(44, 3);
                }
                {
                    
                result.enableWebgpu = decoder0.readBoolean(44, 4);
                }
                {
                    
                result.enableUnsafeWebgpu = decoder0.readBoolean(44, 5);
                }
                {
                ...
                result.enableDawnBackendValidation = decoder0.readInt(60);
    ...
    protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
        ...
        encoder0.encode(this.watchdogStartsBackgrounded, 11, 6);
        
        encoder0.encode(this.enableVulkanProtectedMemory, 11, 7);
        ...
        encoder0.encode(this.disableVulkanSurface, 44, 0);
        
        encoder0.encode(this.disableVulkanFallbackToGlForTesting, 44, 1);
        
        encoder0.encode(this.enableMetal, 44, 2);
        
        encoder0.encode(this.enableGpuBenchmarkingExtension, 44, 3);
        
        encoder0.encode(this.enableWebgpu, 44, 4);
        
        encoder0.encode(this.enableUnsafeWebgpu, 44, 5);
        ...
        encoder0.encode(this.enableDawnBackendValidation, 60);
        
        if (this.enabledDawnFeaturesList == null) {
            encoder0.encodeNullPointer(64, false);
        } else {
            org.chromium.mojo.bindings.Encoder encoder1 = encoder0.encodePointerArray(this.enabledDawnFeaturesList.length, 64, org.chromium.mojo.bindings.BindingsHelper.UNSPECIFIED_ARRAY_LENGTH);
        ...
        if (this.disabledDawnFeaturesList == null) {
            ...
            org.chromium.mojo.bindings.Encoder encoder1 = encoder0.encodePointerArray(this.disabledDawnFeaturesList.length, 72, org.chromium.mojo.bindings.BindingsHelper.UNSPECIFIED_ARRAY_LENGTH);
