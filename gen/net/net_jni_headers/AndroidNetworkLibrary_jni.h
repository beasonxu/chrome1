...
static std::atomic<jmethodID> g_org_chromium_net_AndroidNetworkLibrary_setWifiEnabled(nullptr);
static void Java_AndroidNetworkLibrary_setWifiEnabled(JNIEnv* env, jboolean enabled) {
  jclass clazz = org_chromium_net_AndroidNetworkLibrary_clazz(env);
  CHECK_CLAZZ(env, clazz,
      org_chromium_net_AndroidNetworkLibrary_clazz(env));
  ...
  call_context.Init<
      base::android::MethodID::TYPE_STATIC>(
          ...
          "setWifiEnabled",
          "(Z)V",
          &g_org_chromium_net_AndroidNetworkLibrary_setWifiEnabled);
...
static std::atomic<jmethodID>
    g_org_chromium_net_AndroidNetworkLibrary_getDnsStatusForNetwork(nullptr);
static base::android::ScopedJavaLocalRef<jobject>
  ...
  call_context.Init<
      base::android::MethodID::TYPE_STATIC>(
          ...
          "(J)Lorg/chromium/net/DnsStatus;",
          &g_org_chromium_net_AndroidNetworkLibrary_getDnsStatusForNetwork);
...
static std::atomic<jmethodID> g_org_chromium_net_AndroidNetworkLibrary_getCurrentDnsStatus(nullptr);
static base::android::ScopedJavaLocalRef<jobject>
  ...
  call_context.Init<
      base::android::MethodID::TYPE_STATIC>(
          ...
          &g_org_chromium_net_AndroidNetworkLibrary_getCurrentDnsStatus);
