...
template <>
struct  StructTraits<::gfx::mojom::blink::ColorVolumeMetadata::DataView,
                                         ::gfx::mojom::blink::ColorVolumeMetadataPtr> {
  ...
  static const decltype(::gfx::mojom::blink::ColorVolumeMetadata::primary_r)& primary_r(
      const ::gfx::mojom::blink::ColorVolumeMetadataPtr& input) {
    return input->primary_r;
  }

  static const decltype(::gfx::mojom::blink::ColorVolumeMetadata::primary_g)& primary_g(
      const ::gfx::mojom::blink::ColorVolumeMetadataPtr& input) {
    return input->primary_g;
  }

  static const decltype(::gfx::mojom::blink::ColorVolumeMetadata::primary_b)& primary_b(
      const ::gfx::mojom::blink::ColorVolumeMetadataPtr& input) {
    return input->primary_b;
  }

  static const decltype(::gfx::mojom::blink::ColorVolumeMetadata::white_point)& white_point(
      const ::gfx::mojom::blink::ColorVolumeMetadataPtr& input) {
    return input->white_point;
  }

  static decltype(::gfx::mojom::blink::ColorVolumeMetadata::luminance_max) luminance_max(
      const ::gfx::mojom::blink::ColorVolumeMetadataPtr& input) {
    return input->luminance_max;
  }

  static decltype(::gfx::mojom::blink::ColorVolumeMetadata::luminance_min) luminance_min(
      const ::gfx::mojom::blink::ColorVolumeMetadataPtr& input) {
...
struct  StructTraits<::gfx::mojom::blink::HDRMetadata::DataView,
  ...
  static const decltype(::gfx::mojom::blink::HDRMetadata::color_volume_metadata)& color_volume_metadata(
      const ::gfx::mojom::blink::HDRMetadataPtr& input) {
    return input->color_volume_metadata;
  }

  static decltype(::gfx::mojom::blink::HDRMetadata::max_content_light_level) max_content_light_level(
      const ::gfx::mojom::blink::HDRMetadataPtr& input) {
    return input->max_content_light_level;
  }

  static decltype(::gfx::mojom::blink::HDRMetadata::max_frame_average_light_level) max_frame_average_light_level(
      const ::gfx::mojom::blink::HDRMetadataPtr& input) {
