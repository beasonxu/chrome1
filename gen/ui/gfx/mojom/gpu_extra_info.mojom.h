...
struct  StructTraits<::gfx::mojom::ANGLEFeature::DataView,
  ...
  static const decltype(::gfx::mojom::ANGLEFeature::description)& description(
      const ::gfx::mojom::ANGLEFeaturePtr& input) {
    return input->description;
  }

  static const decltype(::gfx::mojom::ANGLEFeature::bug)& bug(
      const ::gfx::mojom::ANGLEFeaturePtr& input) {
    return input->bug;
  }
  ...
  static const decltype(::gfx::mojom::ANGLEFeature::condition)& condition(
      const ::gfx::mojom::ANGLEFeaturePtr& input) {
