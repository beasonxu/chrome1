...
struct gfx_mojom_internal_BufferPlane_DataHashFn {
  ...
  static bool Equal(const ::gfx::mojom::BufferPlane& left, const ::gfx::mojom::BufferPlane& right) {
    return left == right;
  }
  static const bool safe_to_compare_to_empty_or_deleted = true;
};
...
template <>
struct HashTraits<::gfx::mojom::BufferPlane>
    : public GenericHashTraits<::gfx::mojom::BufferPlane> {
  static_assert(true,
                "-1000000 is a reserved enum value");
  static_assert(true,
                "-1000001 is a reserved enum value");
  ...
  static void ConstructDeletedValue(::gfx::mojom::BufferPlane& slot, bool) {
    slot = static_cast<::gfx::mojom::BufferPlane>(-1000001);
  }
  static bool IsDeletedValue(const ::gfx::mojom::BufferPlane& value) {
    return value == static_cast<::gfx::mojom::BufferPlane>(-1000001);
  }
};
}  // namespace WTF
