...
static std::atomic<jmethodID>
    g_org_chromium_base_Callback_00024Helper_onLongResultFromNative(nullptr);
static void Java_Helper_onLongResultFromNative(JNIEnv* env, const base::android::JavaRef<jobject>&
  ...
  call_context.Init<
      base::android::MethodID::TYPE_STATIC>(
          ...
          &g_org_chromium_base_Callback_00024Helper_onLongResultFromNative);
...
static std::atomic<jmethodID>
    g_org_chromium_base_Callback_00024Helper_onTimeResultFromNative(nullptr);
static void Java_Helper_onTimeResultFromNative(JNIEnv* env, const base::android::JavaRef<jobject>&
  ...
  call_context.Init<
      base::android::MethodID::TYPE_STATIC>(
          ...
          "(Lorg/chromium/base/Callback;J)V",
          &g_org_chromium_base_Callback_00024Helper_onTimeResultFromNative);
