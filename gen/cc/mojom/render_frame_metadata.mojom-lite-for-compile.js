...
cc.mojom.RenderFrameMetadataObserverRemote = class {
  ...
  reportAllRootScrolls(
    ...
    this.proxy.sendMessage(
        0,
        cc.mojom.RenderFrameMetadataObserver_ReportAllRootScrolls_ParamsSpec.$,
        null,
        [
          enabled
        ]);
...
cc.mojom.RenderFrameMetadataObserverClientInterface = class {
  ...
  /**
   * @param { !gfx.mojom.PointF } rootScrollOffset
   */
...
goog.provide('cc.mojom.RenderFrameMetadataObserver_ReportAllRootScrolls_ParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('cc.mojom.RenderFrameMetadataObserverClient_OnRootScrollOffsetChanged_ParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('cc.mojom.RenderFrameMetadataObserver_ReportAllRootScrolls_Params');

/** @record */
cc.mojom.RenderFrameMetadataObserver_ReportAllRootScrolls_Params = class {
  constructor() {
    /** @export { !boolean } */
    this.enabled;
  }
...
goog.provide('cc.mojom.RenderFrameMetadataObserverClient_OnRootScrollOffsetChanged_Params');

/** @record */
cc.mojom.RenderFrameMetadataObserverClient_OnRootScrollOffsetChanged_Params = class {
  constructor() {
