...
(function() {
  ...
  RenderFrameMetadata.prototype.initDefaults_ = function() {
    ...
    this.topControlsMinHeightOffset = 0;
    this.bottomControlsMinHeightOffset = 0;
  ...
  RenderFrameMetadata.validate = function(messageValidator, offset) {
    ...
    // validate RenderFrameMetadata.scrollableViewportSize
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 120, geometry$.SizeF, false);
    if (err !== validator.validationError.NONE)
        return err;


    // validate RenderFrameMetadata.rootLayerSize
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 128, geometry$.SizeF, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  RenderFrameMetadata.encodedSize = codec.kStructHeaderSize + 136;
  ...
  RenderFrameMetadata.decode = function(decoder) {
    ...
    val.rootOverflowYHidden = (packed >> 2) & 1 ? true : false;
    val.hasTransparentBackground = (packed >> 3) & 1 ? true : false;
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    ...
    val.bottomControlsShownRatio =
        decoder.decodeStruct(codec.Float);
    val.topControlsMinHeightOffset =
        decoder.decodeStruct(codec.Float);
    val.bottomControlsMinHeightOffset =
        decoder.decodeStruct(codec.Float);
  ...
  RenderFrameMetadata.encode = function(encoder, val) {
    ...
    packed |= (val.rootOverflowYHidden & 1) << 2
    packed |= (val.hasTransparentBackground & 1) << 3
    encoder.writeUint8(packed);
    encoder.skip(1);
    encoder.skip(1);
    encoder.skip(1);
    ...
    encoder.encodeStruct(codec.Float, val.topControlsMinHeightOffset);
    encoder.encodeStruct(codec.Float, val.bottomControlsMinHeightOffset);
  ...
  function RenderFrameMetadataObserver_ReportAllRootScrolls_Params(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  RenderFrameMetadataObserver_ReportAllRootScrolls_Params.prototype.initDefaults_ = function() {
    this.enabled = false;
  };
  RenderFrameMetadataObserver_ReportAllRootScrolls_Params.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  RenderFrameMetadataObserver_ReportAllRootScrolls_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  RenderFrameMetadataObserver_ReportAllRootScrolls_Params.encodedSize = codec.kStructHeaderSize + 8;

  RenderFrameMetadataObserver_ReportAllRootScrolls_Params.decode = function(decoder) {
    var packed;
    var val = new RenderFrameMetadataObserver_ReportAllRootScrolls_Params();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    packed = decoder.readUint8();
  ...
  RenderFrameMetadataObserver_ReportAllRootScrolls_Params.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(RenderFrameMetadataObserver_ReportAllRootScrolls_Params.encodedSize);
    encoder.writeUint32(0);
    packed = 0;
  ...
  function RenderFrameMetadataObserverClient_OnRootScrollOffsetChanged_Params(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  RenderFrameMetadataObserverClient_OnRootScrollOffsetChanged_Params.prototype.initDefaults_ = function() {
    this.rootScrollOffset = null;
  };
  RenderFrameMetadataObserverClient_OnRootScrollOffsetChanged_Params.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  RenderFrameMetadataObserverClient_OnRootScrollOffsetChanged_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    // validate RenderFrameMetadataObserverClient_OnRootScrollOffsetChanged_Params.rootScrollOffset
  ...
  RenderFrameMetadataObserverClient_OnRootScrollOffsetChanged_Params.encodedSize = codec.kStructHeaderSize + 8;

  RenderFrameMetadataObserverClient_OnRootScrollOffsetChanged_Params.decode = function(decoder) {
    var packed;
    var val = new RenderFrameMetadataObserverClient_OnRootScrollOffsetChanged_Params();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.rootScrollOffset =
        decoder.decodeStructPointer(geometry$.PointF);
  ...
  RenderFrameMetadataObserverClient_OnRootScrollOffsetChanged_Params.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(RenderFrameMetadataObserverClient_OnRootScrollOffsetChanged_Params.encodedSize);
    encoder.writeUint32(0);
    encoder.encodeStructPointer(geometry$.PointF, val.rootScrollOffset);
  };
  var kRenderFrameMetadataObserver_ReportAllRootScrolls_Name = 0;
  var kRenderFrameMetadataObserver_ReportAllFrameSubmissionsForTesting_Name = 1;
  ...
  RenderFrameMetadataObserverPtr.prototype.reportAllRootScrolls = function() {
    return RenderFrameMetadataObserverProxy.prototype.reportAllRootScrolls
        .apply(this.ptr.getProxy(), arguments);
  };

  RenderFrameMetadataObserverProxy.prototype.reportAllRootScrolls = function(enabled) {
    var params_ = new RenderFrameMetadataObserver_ReportAllRootScrolls_Params();
    params_.enabled = enabled;
    var builder = new codec.MessageV0Builder(
        kRenderFrameMetadataObserver_ReportAllRootScrolls_Name,
        codec.align(RenderFrameMetadataObserver_ReportAllRootScrolls_Params.encodedSize));
    builder.encodeStruct(RenderFrameMetadataObserver_ReportAllRootScrolls_Params, params_);
  ...
  RenderFrameMetadataObserverStub.prototype.reportAllRootScrolls = function(enabled) {
    return this.delegate_ && this.delegate_.reportAllRootScrolls && this.delegate_.reportAllRootScrolls(enabled);
  }
  ...
  RenderFrameMetadataObserverStub.prototype.accept = function(message) {
    ...
    case kRenderFrameMetadataObserver_ReportAllRootScrolls_Name:
      var params = reader.decodeStruct(RenderFrameMetadataObserver_ReportAllRootScrolls_Params);
      this.reportAllRootScrolls(params.enabled);
      return true;
    ...
    switch (message.getName()) {
      case kRenderFrameMetadataObserver_ReportAllRootScrolls_Name:
        if (!message.expectsResponse() && !message.isResponse())
          paramsClass = RenderFrameMetadataObserver_ReportAllRootScrolls_Params;
      break;
      case kRenderFrameMetadataObserver_ReportAllFrameSubmissionsForTesting_Name:
        if (!message.expectsResponse() && !message.isResponse())
  ...
  var kRenderFrameMetadataObserverClient_OnRenderFrameMetadataChanged_Name = 0;
  var kRenderFrameMetadataObserverClient_OnFrameSubmissionForTesting_Name = 1;
  var kRenderFrameMetadataObserverClient_OnRootScrollOffsetChanged_Name = 2;
  ...
  RenderFrameMetadataObserverClientPtr.prototype.onRootScrollOffsetChanged = function() {
    return RenderFrameMetadataObserverClientProxy.prototype.onRootScrollOffsetChanged
        .apply(this.ptr.getProxy(), arguments);
  };

  RenderFrameMetadataObserverClientProxy.prototype.onRootScrollOffsetChanged = function(rootScrollOffset) {
    var params_ = new RenderFrameMetadataObserverClient_OnRootScrollOffsetChanged_Params();
    params_.rootScrollOffset = rootScrollOffset;
    var builder = new codec.MessageV0Builder(
        kRenderFrameMetadataObserverClient_OnRootScrollOffsetChanged_Name,
        codec.align(RenderFrameMetadataObserverClient_OnRootScrollOffsetChanged_Params.encodedSize));
    builder.encodeStruct(RenderFrameMetadataObserverClient_OnRootScrollOffsetChanged_Params, params_);
    var message = builder.finish();
    this.receiver_.accept(message);
  };
  ...
  RenderFrameMetadataObserverClientStub.prototype.onRootScrollOffsetChanged = function(rootScrollOffset) {
    return this.delegate_ && this.delegate_.onRootScrollOffsetChanged && this.delegate_.onRootScrollOffsetChanged(rootScrollOffset);
  }
  ...
  RenderFrameMetadataObserverClientStub.prototype.accept = function(message) {
    ...
    case kRenderFrameMetadataObserverClient_OnFrameSubmissionForTesting_Name:
      ...
      return true;
    case kRenderFrameMetadataObserverClient_OnRootScrollOffsetChanged_Name:
      var params = reader.decodeStruct(RenderFrameMetadataObserverClient_OnRootScrollOffsetChanged_Params);
      this.onRootScrollOffsetChanged(params.rootScrollOffset);
      return true;
    default:
      return false;
    }
  ...
  function validateRenderFrameMetadataObserverClientRequest(messageValidator) {
    ...
    switch (message.getName()) {
      ...
      case kRenderFrameMetadataObserverClient_OnRootScrollOffsetChanged_Name:
        if (!message.expectsResponse() && !message.isResponse())
          paramsClass = RenderFrameMetadataObserverClient_OnRootScrollOffsetChanged_Params;
      break;
    }
    if (paramsClass === null)
      return validator.validationError.NONE;
