// chrome/common/renderer_configuration.mojom-shared-message-ids.h is auto generated by mojom_bindings_generator.py, do not edit
...
constexpr uint32_t kRendererConfiguration_SetConfiguration_Name = 1;
