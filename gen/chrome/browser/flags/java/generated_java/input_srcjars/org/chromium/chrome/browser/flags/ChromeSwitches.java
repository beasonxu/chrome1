...
public abstract class ChromeSwitches {
    ...
    public static final String AUTH_SERVER_ALLOWLIST = "auth-server-allowlist";


    public static final String AUTH_SERVER_ALLOWLIST_DEPRECATED = "auth-server-whitelist";
    ...
    public static final String ENABLE_HANGOUT_SERVICES_EXTENSION_FOR_TESTING = "enable-hangout-services-extension-for-testing";
    ...
    // the first run.
    public static final String INITIAL_PREFERENCES_FILE = "initial-preferences-file";
    ...
    public static final String WEB_RTC_IP_HANDLING_POLICY = "webrtc-ip-handling-policy";
