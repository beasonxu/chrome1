...
export class DeviceDetailsPage extends Page {
    ...
    constructor(id, deviceInfo) {
        ...
        this.pageDiv.appendChild(document.importNode($('device-details-template').content, true /* deep */));
    ...
    connect() {
        ...
        connectToDevice(this.deviceInfo.address)
            ...
            Snackbar.show(this.deviceInfo.nameForDisplay + ': ' + error.message, SnackbarType.ERROR, 'Retry', this.connect.bind(this));
    ...
    redraw() {
        ...
        const manufacturerDataMapText = formatManufacturerDataMap(this.deviceInfo.manufacturerDataMap);
        const deviceViewObj = {
