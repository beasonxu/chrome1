...
export class DescriptorListElement extends ExpandableListElement {
    ...
    createItem(data) {
        ...
        item.initialize(data, assert(this.deviceAddress_), assert(this.serviceId_), assert(this.characteristicId_));
        return item;
    }
    /**
    ...
    load(deviceAddress, serviceId, characteristicId) {
        ...
        connectToDevice(deviceAddress)
            ...
            this.descriptorsRequested_ = false;
            Snackbar.show(deviceAddress + ': ' + error.message, SnackbarType.ERROR, 'Retry', function () {
