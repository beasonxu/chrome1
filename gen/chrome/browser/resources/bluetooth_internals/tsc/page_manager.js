...
export class PageManager {
    ...
    register(page) {
        ...
        page.addEventListener('page-hash-changed', e => this.onPageHashChanged_(/** @type {!CustomEvent} */ (e)));
        page.initializePage();
    }
    /**
    ...
    showDefaultPage(opt_updateHistory) {
        assert(this.defaultPage_ instanceof Page, 'PageManager must be initialized with a default page.');
