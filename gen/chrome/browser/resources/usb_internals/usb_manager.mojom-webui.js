...
export class UsbDeviceManagerRemote {
  ...
  refreshDeviceInfo(
    ...
    return this.proxy.sendMessage(
        4,
        UsbDeviceManager_RefreshDeviceInfo_ParamsSpec.$,
        UsbDeviceManager_RefreshDeviceInfo_ResponseParamsSpec.$,
        [
          guid
        ]);
  }
 ...
 * @const { {$:!mojo.internal.MojomType}}
 */
export const UsbDeviceManager_RefreshDeviceInfo_ParamsSpec =
    { $: /** @type {!mojo.internal.MojomType} */ ({}) };

/**
 * @const { {$:!mojo.internal.MojomType}}
 */
export const UsbDeviceManager_RefreshDeviceInfo_ResponseParamsSpec =
    { $: /** @type {!mojo.internal.MojomType} */ ({}) };
