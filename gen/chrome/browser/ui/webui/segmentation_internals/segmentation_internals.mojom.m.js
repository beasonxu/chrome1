// chrome/browser/ui/webui/segmentation_internals/segmentation_internals.mojom.m.js is auto generated by mojom_bindings_generator.py, do not edit
...
export class PageHandlerFactoryPendingReceiver {
  ...
  bindInBrowser(scope = 'context') {
    mojo.internal.interfaceSupport.bind(
        this.handle, 'segmentation_internals.mojom.PageHandlerFactory', scope);
  }
}
...
export class PageHandlerPendingReceiver {
  ...
  bindInBrowser(scope = 'context') {
    mojo.internal.interfaceSupport.bind(
        this.handle, 'segmentation_internals.mojom.PageHandler', scope);
  }
}
...
export class PagePendingReceiver {
  ...
  bindInBrowser(scope = 'context') {
    mojo.internal.interfaceSupport.bind(
        this.handle, 'segmentation_internals.mojom.Page', scope);
  }
}
 ...
 */
export const ServiceStatusSpec =
    { $: /** @type {!mojo.internal.MojomType} */ ({}) };

/**
 * @const { {$:!mojo.internal.MojomType}}
 */
export const SegmentInfoSpec =
    { $: /** @type {!mojo.internal.MojomType} */ ({}) };

/**
 * @const { {$:!mojo.internal.MojomType}}
 */
export const ClientInfoSpec =
    { $: /** @type {!mojo.internal.MojomType} */ ({}) };
 ...
 * @const { {$:!mojo.internal.MojomType}}
 */
export const PageHandler_GetServiceStatus_ParamsSpec =
    { $: /** @type {!mojo.internal.MojomType} */ ({}) };

/**
 * @const { {$:!mojo.internal.MojomType}}
 */
export const PageHandler_ExecuteModel_ParamsSpec =
    { $: /** @type {!mojo.internal.MojomType} */ ({}) };

/**
 * @const { {$:!mojo.internal.MojomType}}
 */
export const PageHandler_OverwriteResult_ParamsSpec =
    { $: /** @type {!mojo.internal.MojomType} */ ({}) };

/**
 * @const { {$:!mojo.internal.MojomType}}
 */
export const PageHandler_SetSelected_ParamsSpec =
    { $: /** @type {!mojo.internal.MojomType} */ ({}) };

/**
 * @const { {$:!mojo.internal.MojomType}}
 */
export const Page_OnServiceStatusChanged_ParamsSpec =
    { $: /** @type {!mojo.internal.MojomType} */ ({}) };

/**
 * @const { {$:!mojo.internal.MojomType}}
 */
export const Page_OnClientInfoAvailable_ParamsSpec =
    { $: /** @type {!mojo.internal.MojomType} */ ({}) };
...
mojo.internal.Struct(
    ...
    [
      ...
      mojo.internal.StructField(
        'segmentInfo', 16,
        0,
        mojo.internal.Array(SegmentInfoSpec.$, false),
        null,
        false /* nullable */,
        0),
    ],
...
mojo.internal.Struct(
    ...
    [
      mojo.internal.StructField(
        'clientInfo', 0,
        0,
        mojo.internal.Array(ClientInfoSpec.$, false),
        null,
        false /* nullable */,
        0),
    ],
