...
constexpr uint32_t kDebugLogsChangeHandler_ChangeDebugLogsState_Name = 0;
constexpr uint32_t kBluetoothInternalsHandler_GetAdapter_Name = 0;
constexpr uint32_t kBluetoothInternalsHandler_GetDebugLogsChangeHandler_Name = 1;
