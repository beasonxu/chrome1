...
(function() {
  ...
  AutocompleteMatch.validate = function(messageValidator, offset) {
    ...
    // validate AutocompleteMatch.aqsTypeSubtypes
    ...
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 144, 8, new codec.PointerTo(AutocompleteAdditionalInfo), false, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  AutocompleteMatch.encode = function(encoder, val) {
    ...
    encoder.encodeStruct(codec.String, val.aqsTypeSubtypes);
