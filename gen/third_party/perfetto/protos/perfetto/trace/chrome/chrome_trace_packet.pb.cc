...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 ChromeTracePacketDefaultTypeInternal _ChromeTracePacket_default_instance_;
}  // namespace protos
}  // namespace perfetto
namespace perfetto {
namespace protos {
...
void ChromeTracePacket::clear_chrome_events() {
  if (GetArenaForAllocation() == nullptr && chrome_events_ != nullptr) {
    delete chrome_events_;
  }
  chrome_events_ = nullptr;
}
void ChromeTracePacket::clear_clock_snapshot() {
  if (GetArenaForAllocation() == nullptr && clock_snapshot_ != nullptr) {
    delete clock_snapshot_;
  }
  clock_snapshot_ = nullptr;
}
void ChromeTracePacket::clear_track_event() {
  if (GetArenaForAllocation() == nullptr && track_event_ != nullptr) {
    delete track_event_;
  }
  track_event_ = nullptr;
}
void ChromeTracePacket::clear_process_descriptor() {
  if (GetArenaForAllocation() == nullptr && process_descriptor_ != nullptr) {
    delete process_descriptor_;
  }
  process_descriptor_ = nullptr;
}
void ChromeTracePacket::clear_thread_descriptor() {
  if (GetArenaForAllocation() == nullptr && thread_descriptor_ != nullptr) {
    delete thread_descriptor_;
  }
  thread_descriptor_ = nullptr;
}
void ChromeTracePacket::clear_streaming_profile_packet() {
  if (GetArenaForAllocation() == nullptr && streaming_profile_packet_ != nullptr) {
    delete streaming_profile_packet_;
  }
  streaming_profile_packet_ = nullptr;
}
void ChromeTracePacket::clear_profiled_frame_symbols() {
  if (GetArenaForAllocation() == nullptr && profiled_frame_symbols_ != nullptr) {
...
void ChromeTracePacket::clear_trace_stats() {
  if (GetArenaForAllocation() == nullptr && trace_stats_ != nullptr) {
    delete trace_stats_;
  }
  trace_stats_ = nullptr;
}
void ChromeTracePacket::clear_interned_data() {
  if (GetArenaForAllocation() == nullptr && interned_data_ != nullptr) {
