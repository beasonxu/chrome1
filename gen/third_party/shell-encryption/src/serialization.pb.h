...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_serialization_2eproto SHELL_ENCRYPTION_EXPORT
...
struct SHELL_ENCRYPTION_EXPORT TableStruct_serialization_2eproto {
static const uint32_t offsets[];
};
namespace rlwe {
class SerializedGaloisKey;
struct SerializedGaloisKeyDefaultTypeInternal;
SHELL_ENCRYPTION_EXPORT extern SerializedGaloisKeyDefaultTypeInternal _SerializedGaloisKey_default_instance_;
class SerializedNttPolynomial;
struct SerializedNttPolynomialDefaultTypeInternal;
SHELL_ENCRYPTION_EXPORT extern SerializedNttPolynomialDefaultTypeInternal _SerializedNttPolynomial_default_instance_;
class SerializedRelinearizationKey;
struct SerializedRelinearizationKeyDefaultTypeInternal;
SHELL_ENCRYPTION_EXPORT extern SerializedRelinearizationKeyDefaultTypeInternal _SerializedRelinearizationKey_default_instance_;
class SerializedSymmetricRlweCiphertext;
struct SerializedSymmetricRlweCiphertextDefaultTypeInternal;
SHELL_ENCRYPTION_EXPORT extern SerializedSymmetricRlweCiphertextDefaultTypeInternal _SerializedSymmetricRlweCiphertext_default_instance_;
}  // namespace rlwe
PROTOBUF_NAMESPACE_OPEN
template<> SHELL_ENCRYPTION_EXPORT ::rlwe::SerializedGaloisKey* Arena::CreateMaybeMessage<::rlwe::SerializedGaloisKey>(Arena*);
template<> SHELL_ENCRYPTION_EXPORT ::rlwe::SerializedNttPolynomial* Arena::CreateMaybeMessage<::rlwe::SerializedNttPolynomial>(Arena*);
template<> SHELL_ENCRYPTION_EXPORT ::rlwe::SerializedRelinearizationKey* Arena::CreateMaybeMessage<::rlwe::SerializedRelinearizationKey>(Arena*);
template<> SHELL_ENCRYPTION_EXPORT ::rlwe::SerializedSymmetricRlweCiphertext* Arena::CreateMaybeMessage<::rlwe::SerializedSymmetricRlweCiphertext>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace rlwe {

// ===================================================================

class SHELL_ENCRYPTION_EXPORT SerializedNttPolynomial final :
...
class SHELL_ENCRYPTION_EXPORT SerializedSymmetricRlweCiphertext final :
...
class SHELL_ENCRYPTION_EXPORT SerializedRelinearizationKey final :
...
class SHELL_ENCRYPTION_EXPORT SerializedGaloisKey final :
...
_has_bits_[0] |= 0x00000001u;
coeffs_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
_has_bits_[0] |= 0x00000001u;
coeffs_.Set(value, GetArenaForAllocation());
}
inline std::string* SerializedNttPolynomial::_internal_mutable_coeffs() {
_has_bits_[0] |= 0x00000001u;
return coeffs_.Mutable(GetArenaForAllocation());
}
...
_has_bits_[0] &= ~0x00000001u;
auto* p = coeffs_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
if (coeffs_.IsDefault()) {
...
coeffs_.SetAllocated(coeffs, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
if (coeffs_.IsDefault()) {
coeffs_.Set("", GetArenaForAllocation());
}
