...
PROTOBUF_CONSTEXPR PhoneNumber::PhoneNumber(
  ...
  , raw_input_(&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{})
  , preferred_domestic_carrier_code_(&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{})
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 PhoneNumberDefaultTypeInternal _PhoneNumber_default_instance_;
}  // namespace phonenumbers
}  // namespace i18n
namespace i18n {
namespace phonenumbers {
...
PhoneNumber::PhoneNumber(const PhoneNumber& from)
  ...
  raw_input_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    raw_input_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (from._internal_has_raw_input()) {
    raw_input_.Set(from._internal_raw_input(), 
      GetArenaForAllocation());
  }
  preferred_domestic_carrier_code_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    preferred_domestic_carrier_code_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (from._internal_has_preferred_domestic_carrier_code()) {
    preferred_domestic_carrier_code_.Set(from._internal_preferred_domestic_carrier_code(), 
      GetArenaForAllocation());
  }
...
inline void PhoneNumber::SharedDtor() {
  ...
  extension_.Destroy();
  raw_input_.Destroy();
  preferred_domestic_carrier_code_.Destroy();
}
