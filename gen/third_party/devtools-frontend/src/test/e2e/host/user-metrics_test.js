...
(0, mocha_extensions_js_1.describe)('User Metrics for Issue Panel', () => {
    ...
    (0, mocha_extensions_js_1.it)('dispatches an event when a Client Hints are used with invalid origin for DelegateCH', async () => {
        await (0, helper_js_1.goToResource)('issues/client-hint-issue-DelegateCH-MetaTagAllowListInvalidOrigin.html');
        await (0, helper_js_1.waitFor)('.issue');
        await assertHistogramEventsInclude([
            {
                actionName: 'DevTools.IssueCreated',
    ...
    (0, mocha_extensions_js_1.it)('dispatches an event when a Client Hints are modified by javascript for DelegateCH', async () => {
        await (0, helper_js_1.goToResource)('issues/client-hint-issue-DelegateCH-MetaTagModifiedHTML.html');
        await (0, helper_js_1.waitFor)('.issue');
        await assertHistogramEventsInclude([
            {
                actionName: 'DevTools.IssueCreated',
