...
(0, mocha_extensions_js_1.describe)('Client Hint issues test', async () => {
    (0, mocha_extensions_js_1.it)('should display issue when Client Hints are used with invalid origin for DelegateCH', async () => {
    ...
    (0, mocha_extensions_js_1.it)('should display issue when Client Hints are modified by javascript for DelegateCH', async () => {
