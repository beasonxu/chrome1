...
(0, mocha_extensions_js_1.describe)('Flexbox Editor', async function () {
    ...
    // Flaky test
    mocha_extensions_js_1.it.skipOnPlatforms(['win32', 'linux'], '[crbug.com/1340492] can be opened and flexbox styles can be edited', async () => {
    ...
    mocha_extensions_js_1.it.skipOnPlatforms(['win32', 'linux'], '[crbug.com/1342534] can be opened for flexbox styles with !important', async () => {
