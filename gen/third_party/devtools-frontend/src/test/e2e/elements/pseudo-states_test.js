...
// Flaky test group.
mocha_extensions_js_1.describe.skip('[crbug.com/1280763]: The Elements tab', async () => {
    (0, mocha_extensions_js_1.it)('can force :hover state for selected DOM node', async () => {
    ...
    (0, mocha_extensions_js_1.it)('can force :focus state for selected DOM node', async () => {
        const { frontend } = (0, helper_js_1.getBrowserAndPages)();
    ...
    (0, mocha_extensions_js_1.it)('can remove :focus state', async () => {
        const { frontend } = (0, helper_js_1.getBrowserAndPages)();
        await (0, helper_js_1.goToResource)('elements/focus.html');
        await (0, elements_helpers_js_1.waitForElementsStyleSection)();
        await (0, helper_js_1.step)('Ensure the correct node is selected after opening a file', async () => {
