...
(0, mocha_extensions_js_1.describe)('The Extension API', async () => {
    (0, mocha_extensions_js_1.it)('can open wasm resources with offset', async () => {
        await (0, sources_helpers_js_1.waitForSourceFiles)("source-tree-file-added" /* SourceFileEvents.AddedToSourceTree */, files => files.some(f => f.endsWith('scopes.wasm')), () => (0, sources_helpers_js_1.openFileInSourcesPanel)('wasm/scopes.html'));
