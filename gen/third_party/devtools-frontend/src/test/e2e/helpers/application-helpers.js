...
exports.getPieChartLegendRows = exports.waitForQuotaUsage = exports.selectCookieByName = exports.deleteSelectedStorageItem = exports.selectStorageItemAtIndex = exports.clearStorageItems = exports.clearStorageItemsFilter = exports.filterStorageItems = exports.getStorageItemsData = exports.getFrameTreeTitles = exports.getTrimmedTextContent = exports.getDataGridData = exports.doubleClickSourceTreeItem = exports.navigateToManifestInApplicationTab = exports.navigateToServiceWorkers = exports.navigateToApplicationTab = void 0;
...
async function navigateToManifestInApplicationTab(testName) {
...
exports.navigateToManifestInApplicationTab = navigateToManifestInApplicationTab;
...
async function selectStorageItemAtIndex(index) {
    const dataGridNodes = await (0, helper_js_1.$$)('.storage-view .data-grid-data-grid-node:not(.creation-node)');
