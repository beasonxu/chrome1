...
describe('AggregatedIssue', async () => {
    it('aggregates two TWA issues with same violationType correctly', () => {
        ...
        const details1 = {
            violationType: "kHttpError" /* Protocol.Audits.TwaQualityEnforcementViolationType.KHttpError */,
            url: 'test.url1.com',
            httpStatusCode: 500,
        };
        ...
        mockManager.dispatchEventToListeners("IssueAdded" /* IssuesManager.IssuesManager.Events.IssueAdded */, { issuesModel: mockModel, issue: issue1 });
        mockManager.dispatchEventToListeners("IssueAdded" /* IssuesManager.IssuesManager.Events.IssueAdded */, { issuesModel: mockModel, issue: issue2 });
    ...
    it('TWA issues with different violationType do not aggregate', () => {
        ...
        const issue1 = new IssuesManager.TrustedWebActivityIssue.TrustedWebActivityIssue(details1);
        const details2 = {
            violationType: "kUnavailableOffline" /* Protocol.Audits.TwaQualityEnforcementViolationType.KUnavailableOffline */,
            url: 'test.url2.com',
        };
        const issue2 = new IssuesManager.TrustedWebActivityIssue.TrustedWebActivityIssue(details2);
        const details3 = {
            violationType: "kDigitalAssetLinks" /* Protocol.Audits.TwaQualityEnforcementViolationType.KDigitalAssetLinks */,
            url: 'test.url3.com',
        };
        ...
        mockManager.dispatchEventToListeners("IssueAdded" /* IssuesManager.IssuesManager.Events.IssueAdded */, { issuesModel: mockModel, issue: issue1 });
        mockManager.dispatchEventToListeners("IssueAdded" /* IssuesManager.IssuesManager.Events.IssueAdded */, { issuesModel: mockModel, issue: issue2 });
        mockManager.dispatchEventToListeners("IssueAdded" /* IssuesManager.IssuesManager.Events.IssueAdded */, { issuesModel: mockModel, issue: issue3 });
        const issues = Array.from(aggregator.aggregatedIssues());
