...
describeWithLocale('ValueInterpreterSettings', () => {
    function setUpComponent() {
        ...
        const data = {
            valueTypes: new Set([
                ...
                "Float 64-bit" /* LinearMemoryInspector.ValueInterpreterDisplayUtils.ValueType.Float64 */,
    ...
    it('renders all checkboxes', () => {
        ...
        assert.deepEqual(checkboxLabels, [
            ...
            "Integer 64-bit" /* LinearMemoryInspector.ValueInterpreterDisplayUtils.ValueType.Int64 */,
