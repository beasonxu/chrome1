    ...
    async dispatchMouseEvent(eventData) {
        ...
        const params = {
            ...
            button: (eventData.type === 'mousedown' || eventData.type === 'mouseup') ? buttonActionName :
                "none" /* Protocol.Input.MouseButton.None */,
...
const MOUSE_EVENT_TYPE_TO_REQUEST_TYPE = new Map([
    ...
    ['wheel', "mouseWheel" /* Protocol.Input.DispatchMouseEventRequestType.MouseWheel */],
]);
const KEYBOARD_EVENT_TYPE_TO_REQUEST_TYPE = new Map([
    ['keydown', "keyDown" /* Protocol.Input.DispatchKeyEventRequestType.KeyDown */],
    ['keyup', "keyUp" /* Protocol.Input.DispatchKeyEventRequestType.KeyUp */],
    ['keypress', "char" /* Protocol.Input.DispatchKeyEventRequestType.Char */],
]);
const BUTTONID_TO_ACTION_NAME = new Map([
    [0, "left" /* Protocol.Input.MouseButton.Left */],
    [1, "middle" /* Protocol.Input.MouseButton.Middle */],
    [2, "right" /* Protocol.Input.MouseButton.Right */],
    [3, "back" /* Protocol.Input.MouseButton.Back */],
    [4, "forward" /* Protocol.Input.MouseButton.Forward */],
]);
