...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    ...
    0, static_cast<size_t>(reinterpret_cast<char*>(&profile_start_time_offset_ms_) -
    reinterpret_cast<char*>(&profile_duration_ms_)) + sizeof(profile_start_time_offset_ms_));
}
    ...
    switch (tag >> 3) {
      ...
      case 10:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 80)) {
          ...
          profile_start_time_offset_ms_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* CallStackProfile::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000004u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt64ToArray(10, this->_internal_profile_start_time_offset_ms(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:metrics.CallStackProfile)
  ...
  if (cached_has_bits & 0x00000007u) {
    ...
    // optional int64 profile_start_time_offset_ms = 10;
    if (cached_has_bits & 0x00000004u) {
      total_size += ::_pbi::WireFormatLite::Int64SizePlusOne(this->_internal_profile_start_time_offset_ms());
    }
...
void CallStackProfile::InternalSwap(CallStackProfile* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(CallStackProfile, profile_start_time_offset_ms_)
      + sizeof(CallStackProfile::profile_start_time_offset_ms_)
