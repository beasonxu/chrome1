...
class PLATFORM_EXPORT RuntimeEnabledFeaturesBase {
 ...
 public:
  class PLATFORM_EXPORT Backup {
   ...
   private:
    ...
    bool is_auto_expand_details_element_enabled_;
    ...
    bool is_canvas_formatted_text_enabled_;
    ...
    bool is_composite_relative_keyframes_enabled_;
    bool is_composite_video_element_enabled_;
    ...
    bool is_content_visibility_auto_state_changed_event_enabled_;
    ...
    bool is_css_dynamic_range_media_queries_enabled_;
    ...
    bool is_dialog_focus_new_spec_behavior_enabled_;
    ...
    bool is_display_capture_permissions_policy_enabled_;
    ...
    bool is_identity_in_can_make_payment_event_feature_enabled_;
    ...
    bool is_layout_ng_view_enabled_;
    ...
    bool is_prefers_contrast_enabled_;
    ...
    bool is_restrict_battery_status_to_secure_contexts_enabled_;
    ...
    bool is_secure_context_fix_for_workers_enabled_;
    ...
    bool is_soft_navigation_heuristics_logging_enabled_;
    ...
    bool is_web_app_manifest_id_enabled_;
  ...
  static bool AbortSignalThrowIfAbortedEnabled() {
    return is_abort_signal_throw_if_aborted_enabled_;
  }
  static bool AbortSignalThrowIfAbortedEnabled(const FeatureContext*) { return AbortSignalThrowIfAbortedEnabled(); }

  static bool AbortSignalTimeoutEnabled() {
    return is_abort_signal_timeout_enabled_;
  }
  ...
  static bool AriaTouchPassthroughEnabled() {
    return is_aria_touch_passthrough_enabled_;
  }
  ...
  static bool AutoExpandDetailsElementEnabled() {
    return is_auto_expand_details_element_enabled_;
  }
  static bool AutoExpandDetailsElementEnabled(const FeatureContext*) { return AutoExpandDetailsElementEnabled(); }
  ...
  static bool BatchFetchRequestsEnabled() {
    return is_batch_fetch_requests_enabled_;
  }
  ...
  static bool BlockingAttributeEnabled() {
    return is_blocking_attribute_enabled_;
  }
  ...
  static bool CanvasColorManagementV2Enabled() {
    return is_canvas_color_management_v_2_enabled_;
  }
  static bool CanvasColorManagementV2Enabled(const FeatureContext*) { return CanvasColorManagementV2Enabled(); }

  static bool CanvasFormattedTextEnabled() {
    if (!LayoutNGEnabled())
      return false;
    return is_canvas_formatted_text_enabled_;
  }
  static bool CanvasFormattedTextEnabled(const FeatureContext*) { return CanvasFormattedTextEnabled(); }
  ...
  static bool CLSScrollAnchoringEnabled() {
    return is_cls_scroll_anchoring_enabled_;
  }
  ...
  static bool CompositeRelativeKeyframesEnabled() {
    return is_composite_relative_keyframes_enabled_;
  }
  static bool CompositeRelativeKeyframesEnabled(const FeatureContext*) { return CompositeRelativeKeyframesEnabled(); }

  static bool CompositeVideoElementEnabled() {
    return is_composite_video_element_enabled_;
  }
  static bool CompositeVideoElementEnabled(const FeatureContext*) { return CompositeVideoElementEnabled(); }
  ...
  static bool ContentVisibilityAutoStateChangedEventEnabled() {
    return is_content_visibility_auto_state_changed_event_enabled_;
  }
  static bool ContentVisibilityAutoStateChangedEventEnabled(const FeatureContext*) { return ContentVisibilityAutoStateChangedEventEnabled(); }
  ...
  static bool CSSContainerQueriesEnabled() {
    return is_css_container_queries_enabled_;
  }
  ...
  static bool CSSDynamicRangeMediaQueriesEnabled() {
    return is_css_dynamic_range_media_queries_enabled_;
  }
  static bool CSSDynamicRangeMediaQueriesEnabled(const FeatureContext*) { return CSSDynamicRangeMediaQueriesEnabled(); }
  ...
  static bool CSSIcUnitEnabled() {
    return is_css_ic_unit_enabled_;
  }
  ...
  static bool CSSMediaQueries4Enabled() {
    return is_css_media_queries_4_enabled_;
  }
  ...
  static bool CSSOverflowForReplacedElementsEnabled() {
    return is_css_overflow_for_replaced_elements_enabled_;
  }
  ...
  static bool CSSPseudoAutofillEnabled() {
    return is_css_pseudo_autofill_enabled_;
  }
  ...
  static bool CSSPseudoHasEnabled() {
    return is_css_pseudo_has_enabled_;
  }
  ...
  static bool CSSScrollbarsEnabled() {
    return is_css_scrollbars_enabled_;
  }
  ...
  static bool CSSTrigonometricFunctionsEnabled() {
    return is_css_trigonometric_functions_enabled_;
  }
  ...
  static bool DialogFocusNewSpecBehaviorEnabled() {
    return is_dialog_focus_new_spec_behavior_enabled_;
  }
  static bool DialogFocusNewSpecBehaviorEnabled(const FeatureContext*) { return DialogFocusNewSpecBehaviorEnabled(); }
  ...
  static bool DisplayCapturePermissionsPolicyEnabled() {
    return is_display_capture_permissions_policy_enabled_;
  }
  static bool DisplayCapturePermissionsPolicyEnabled(const FeatureContext*) { return DisplayCapturePermissionsPolicyEnabled(); }
  ...
  static bool ElementSuperRareDataEnabled() {
    return is_element_super_rare_data_enabled_;
  }
  static bool ElementSuperRareDataEnabled(const FeatureContext*) { return ElementSuperRareDataEnabled(); }

  static bool EventPathEnabled() {
    return is_event_path_enabled_;
  }
  ...
  static bool ExperimentalWebSnapshotsEnabled() {
    return is_experimental_web_snapshots_enabled_;
  }
  ...
  static bool FeaturePolicyReportingEnabled() {
    return is_feature_policy_reporting_enabled_;
  }
  ...
  static bool FileSystemAccessAccessHandleEnabled() {
    return is_file_system_access_access_handle_enabled_;
  }
  ...
  static bool FirstPartySetsEnabled() {
    return is_first_party_sets_enabled_;
  }
  ...
  static bool FontPaletteEnabled() {
    return is_font_palette_enabled_;
  }
  ...
  static bool HTMLParamElementUrlSupportEnabled() {
    return is_html_param_element_url_support_enabled_;
  }
  static bool HTMLParamElementUrlSupportEnabled(const FeatureContext*) { return HTMLParamElementUrlSupportEnabled(); }

  static bool HTMLPopupAttributeEnabled() {
    if (HTMLSelectMenuElementEnabled())
      return true;
    return is_html_popup_attribute_enabled_;
  }
  static bool HTMLPopupAttributeEnabled(const FeatureContext*) { return HTMLPopupAttributeEnabled(); }

  static bool HTMLSelectMenuElementEnabled() {
    return is_html_select_menu_element_enabled_;
  }
  static bool HTMLSelectMenuElementEnabled(const FeatureContext*) { return HTMLSelectMenuElementEnabled(); }

  static bool IDBBatchGetAllEnabled() {
    return is_idb_batch_get_all_enabled_;
  }
  static bool IDBBatchGetAllEnabled(const FeatureContext*) { return IDBBatchGetAllEnabled(); }

  static bool IdentityInCanMakePaymentEventFeatureEnabled() {
    return is_identity_in_can_make_payment_event_feature_enabled_;
  }
  static bool IdentityInCanMakePaymentEventFeatureEnabled(const FeatureContext*) { return IdentityInCanMakePaymentEventFeatureEnabled(); }
  ...
  static bool LayoutNGBlockFragmentationEnabled() {
    if (LayoutNGPrintingEnabled())
      return true;
    if (LayoutNGTableFragmentationEnabled())
      return true;
  ...
  static bool LayoutNGViewEnabled() {
    if (LayoutNGPrintingEnabled())
      return true;
    return is_layout_ng_view_enabled_;
  }
  static bool LayoutNGViewEnabled(const FeatureContext*) { return LayoutNGViewEnabled(); }

  static bool LayoutNGVTTCueEnabled() {
    return is_layout_ngvtt_cue_enabled_;
  }
  ...
  static bool MediaSessionWebRTCEnabled() {
    return is_media_session_web_rtc_enabled_;
  }
  ...
  static bool MediaSourceInWorkersUsingHandleEnabled() {
    return is_media_source_in_workers_using_handle_enabled_;
  }
  ...
  static bool MediaStreamTrackInWindowEnabled() {
    return is_media_stream_track_in_window_enabled_;
  }
  static bool MediaStreamTrackInWindowEnabled(const FeatureContext*) { return MediaStreamTrackInWindowEnabled(); }

  static bool MediaStreamTrackInWorkerEnabled() {
    return is_media_stream_track_in_worker_enabled_;
  }
  ...
  static bool NavigationApiEnabled() {
    return is_navigation_api_enabled_;
  }
  static bool NavigationApiEnabled(const FeatureContext*) { return NavigationApiEnabled(); }

  static bool NavigationIdEnabled() {
    return is_navigation_id_enabled_;
  }
  ...
  static bool NewFlexboxSizingEnabled() {
    return is_new_flexbox_sizing_enabled_;
  }
  ...
  static bool PermissionsPolicyUnloadEnabled() {
    return is_permissions_policy_unload_enabled_;
  }
  static bool PermissionsPolicyUnloadEnabled(const FeatureContext*) { return PermissionsPolicyUnloadEnabled(); }
  ...
  static bool PrefersColorSchemeClientHintHeaderEnabled() {
    return is_prefers_color_scheme_client_hint_header_enabled_;
  }
  ...
  static bool PrefersContrastEnabled() {
    if (!ForcedColorsEnabled())
      return false;
    return is_prefers_contrast_enabled_;
  }
  static bool PrefersContrastEnabled(const FeatureContext*) { return PrefersContrastEnabled(); }
  ...
  static bool PrefixedStorageInfoEnabled() {
    return is_prefixed_storage_info_enabled_;
  }
  ...
  static bool PriorityHintsEnabled() {
    return is_priority_hints_enabled_;
  }
  ...
  static bool RestrictBatteryStatusToSecureContextsEnabled() {
    return is_restrict_battery_status_to_secure_contexts_enabled_;
  }
  static bool RestrictBatteryStatusToSecureContextsEnabled(const FeatureContext*) { return RestrictBatteryStatusToSecureContextsEnabled(); }
  ...
  static bool ScrollUpdateOptimizationsEnabled() {
    return is_scroll_update_optimizations_enabled_;
  }
  static bool ScrollUpdateOptimizationsEnabled(const FeatureContext*) { return ScrollUpdateOptimizationsEnabled(); }

  static bool SecureContextFixForSharedWorkersEnabled() {
    return is_secure_context_fix_for_shared_workers_enabled_;
  }
  static bool SecureContextFixForSharedWorkersEnabled(const FeatureContext*) { return SecureContextFixForSharedWorkersEnabled(); }

  static bool SecureContextFixForWorkersEnabled() {
    return is_secure_context_fix_for_workers_enabled_;
  }
  static bool SecureContextFixForWorkersEnabled(const FeatureContext*) { return SecureContextFixForWorkersEnabled(); }
  ...
  static bool SerialPortForgetEnabled() {
    return is_serial_port_forget_enabled_;
  }
  ...
  static bool SoftNavigationHeuristicsLoggingEnabled() {
    return is_soft_navigation_heuristics_logging_enabled_;
  }
  static bool SoftNavigationHeuristicsLoggingEnabled(const FeatureContext*) { return SoftNavigationHeuristicsLoggingEnabled(); }
  ...
  static bool SystemAudioConstraintEnabled() {
    return is_system_audio_constraint_enabled_;
  }
  ...
  static bool ThrottleDisplayNoneAndVisibilityHiddenCrossOriginIframesEnabled() {
    return is_throttle_display_none_and_visibility_hidden_cross_origin_iframes_enabled_;
  }
  ...
  static bool TouchActionEffectiveAtPointerDownEnabled() {
    return is_touch_action_effective_at_pointer_down_enabled_;
  }
  ...
  static bool VariableCOLRV1Enabled() {
    return is_variable_colrv_1_enabled_;
  }
  ...
  static bool WebAppManifestIdEnabled() {
    return is_web_app_manifest_id_enabled_;
  }
  static bool WebAppManifestIdEnabled(const FeatureContext*) { return WebAppManifestIdEnabled(); }
  ...
  static bool WebAssemblyCSPEnabled() {
    return is_web_assembly_csp_enabled_;
  }
  ...
  static bool WebAuthenticationConditionalUIEnabled() {
    return is_web_authentication_conditional_ui_enabled_;
  }
  ...
  static bool WebCodecsDequeueEventEnabled() {
    return is_webcodecs_dequeue_event_enabled_;
  }
  static bool WebCodecsDequeueEventEnabled(const FeatureContext*) { return WebCodecsDequeueEventEnabled(); }

  static bool WebGLColorManagementEnabled() {
    return is_webgl_color_management_enabled_;
  }
  ...
  static bool WebGPUImportTextureEnabled() {
    return is_webgpu_import_texture_enabled_;
  }
  ...
  static bool WebHIDExclusionFiltersOptionEnabled() {
    return is_web_hid_exclusion_filters_option_enabled_;
  }
  ...
  static bool WebUsbDeviceForgetEnabled() {
    return is_web_usb_device_forget_enabled_;
  }
  ...
  static bool WindowOpenNewPopupBehaviorEnabled() {
    return is_window_open_new_popup_behavior_enabled_;
  }
  ...
  static bool WindowPlacementEnhancedScreenLabelsEnabled() {
    return is_window_placement_enhanced_screen_labels_enabled_;
  }
  ...
  static bool DocumentTransitionEnabledByRuntimeFlag() { return DocumentTransitionEnabled(nullptr); }
  static bool DocumentTransitionEnabled(const FeatureContext*);
  ...
  static bool FedCmEnabledByRuntimeFlag() { return FedCmEnabled(nullptr); }
  ...
  static bool RegionCaptureEnabledByRuntimeFlag() { return RegionCaptureEnabled(nullptr); }
 ...
 protected:
  ...
  static void SetAutoExpandDetailsElementEnabled(bool enabled) { is_auto_expand_details_element_enabled_ = enabled; }
  ...
  static void SetCanvasFormattedTextEnabled(bool enabled) { is_canvas_formatted_text_enabled_ = enabled; }
  ...
  static void SetCompositeRelativeKeyframesEnabled(bool enabled) { is_composite_relative_keyframes_enabled_ = enabled; }
  static void SetCompositeVideoElementEnabled(bool enabled) { is_composite_video_element_enabled_ = enabled; }
  ...
  static void SetContentVisibilityAutoStateChangedEventEnabled(bool enabled) { is_content_visibility_auto_state_changed_event_enabled_ = enabled; }
  ...
  static void SetCSSDynamicRangeMediaQueriesEnabled(bool enabled) { is_css_dynamic_range_media_queries_enabled_ = enabled; }
  ...
  static void SetDialogFocusNewSpecBehaviorEnabled(bool enabled) { is_dialog_focus_new_spec_behavior_enabled_ = enabled; }
  ...
  static void SetDisplayCapturePermissionsPolicyEnabled(bool enabled) { is_display_capture_permissions_policy_enabled_ = enabled; }
  ...
  static void SetIdentityInCanMakePaymentEventFeatureEnabled(bool enabled) { is_identity_in_can_make_payment_event_feature_enabled_ = enabled; }
  ...
  static void SetLayoutNGViewEnabled(bool enabled) { is_layout_ng_view_enabled_ = enabled; }
  ...
  static void SetPrefersContrastEnabled(bool enabled) { is_prefers_contrast_enabled_ = enabled; }
  ...
  static void SetRestrictBatteryStatusToSecureContextsEnabled(bool enabled) { is_restrict_battery_status_to_secure_contexts_enabled_ = enabled; }
  ...
  static void SetSecureContextFixForWorkersEnabled(bool enabled) { is_secure_context_fix_for_workers_enabled_ = enabled; }
  ...
  static void SetSoftNavigationHeuristicsLoggingEnabled(bool enabled) { is_soft_navigation_heuristics_logging_enabled_ = enabled; }
  ...
  static void SetThrottleDisplayNoneAndVisibilityHiddenCrossOriginIframesEnabled(bool enabled) { is_throttle_display_none_and_visibility_hidden_cross_origin_iframes_enabled_ = enabled; }
  ...
  static void SetWebAppManifestIdEnabled(bool enabled) { is_web_app_manifest_id_enabled_ = enabled; }
 ...
 private:
  ...
  static bool is_auto_expand_details_element_enabled_;
  ...
  static bool is_canvas_formatted_text_enabled_;
  ...
  static bool is_composite_relative_keyframes_enabled_;
  static bool is_composite_video_element_enabled_;
  ...
  static bool is_content_visibility_auto_state_changed_event_enabled_;
  ...
  static bool is_css_dynamic_range_media_queries_enabled_;
  ...
  static bool is_dialog_focus_new_spec_behavior_enabled_;
  ...
  static bool is_display_capture_permissions_policy_enabled_;
  ...
  static bool is_identity_in_can_make_payment_event_feature_enabled_;
  ...
  static bool is_layout_ng_view_enabled_;
  ...
  static bool is_prefers_contrast_enabled_;
  ...
  static bool is_restrict_battery_status_to_secure_contexts_enabled_;
  ...
  static bool is_secure_context_fix_for_workers_enabled_;
  ...
  static bool is_soft_navigation_heuristics_logging_enabled_;
  ...
  static bool is_web_app_manifest_id_enabled_;
