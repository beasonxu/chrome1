...
public:
    ...
    virtual DispatchResponse setVirtualTimePolicy(const String& in_policy, Maybe<double> in_budget, Maybe<int> in_maxVirtualTimeTaskStarvationCount, Maybe<double> in_initialVirtualTime, double* out_virtualTimeTicksBase) = 0;
