...
public:
    ...
    virtual DispatchResponse getAXNodeAndAncestors(Maybe<int> in_nodeId, Maybe<int> in_backendNodeId, Maybe<String> in_objectId, std::unique_ptr<protocol::Array<protocol::Accessibility::AXNode>>* out_nodes) = 0;
    ...
    virtual DispatchResponse queryAXTree(Maybe<int> in_nodeId, Maybe<int> in_backendNodeId, Maybe<String> in_objectId, Maybe<String> in_accessibleName, Maybe<String> in_role, std::unique_ptr<protocol::Array<protocol::Accessibility::AXNode>>* out_nodes) = 0;
