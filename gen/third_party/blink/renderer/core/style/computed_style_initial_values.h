...
class ComputedStyleInitialValues{
 ...
 public:
  ...
  static AtomicString InitialAnchorName() {
    return g_null_atom;
  }

  static AtomicString InitialAnchorScroll() {
    return g_null_atom;
  }
  ...
  static absl::optional<Length> InitialColumnGap() {
    return absl::nullopt;
  }

  static StyleColor InitialColumnRuleColor() {
    return StyleColor::CurrentColor();
  }
  ...
  static absl::optional<StyleIntrinsicLength> InitialContainIntrinsicHeight() {
    return absl::optional<StyleIntrinsicLength>();
  }

  static absl::optional<StyleIntrinsicLength> InitialContainIntrinsicWidth() {
    return absl::nullopt;
  }

  static Vector<AtomicString> InitialContainerName() {
  ...
  static bool InitialAlignSelfBlockCenter() {
    return false;
  }
  ...
  static ListStyleTypeData* InitialListStyleType() {
    return ListStyleTypeData::CreateCounterStyle("disc", nullptr);
  }
  ...
  static StyleSVGResource* InitialMaskerResource() {
    return nullptr;
  }
  ...
  static LayoutUnit InitialOutlineWidth() {
    return LayoutUnit(3);
  }
  ...
  static absl::optional<StyleOverflowClipMargin> InitialOverflowClipMargin() {
    return absl::nullopt;
  }
  ...
  static AtomicString InitialPageTransitionTag() {
    return AtomicString();
  }
  ...
  static float InitialPopUpHideDelay() {
    return HUGE_VALF;
  }

  static float InitialPopUpShowDelay() {
    return 0.5;
  }
  ...
  static AtomicString InitialPositionFallback() {
    return g_null_atom;
  }
  ...
  static absl::optional<Length> InitialRowGap() {
    return absl::nullopt;
  }
  ...
  static bool InitialInsideFragmentationContextWithNondeterministicEngine() {
    return false;
  }
  ...
  static bool InitialCompositablePaintAnimationChanged() {
    return false;
  }
  ...
  static bool InitialIsStackingContextWithoutContainment() {
    return false;
  }
  ...
  static NamedGridLinesMap InitialImplicitNamedGridColumnLines() {
    return NamedGridLinesMap();
  }

  static NamedGridLinesMap InitialImplicitNamedGridRowLines() {
    return NamedGridLinesMap();
  }
  ...
  static wtf_size_t InitialNamedGridAreaRowCount() {
    return 0;
  }

  static wtf_size_t InitialNamedGridAreaColumnCount() {
    return 0;
  }
  ...
  static bool InitialHasExplicitOverflowXVisible() {
    return false;
  }

  static bool InitialHasExplicitOverflowYVisible() {
    return false;
  }
