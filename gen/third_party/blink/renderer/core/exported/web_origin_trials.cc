  ...
  for (OriginTrialFeature feature : origin_trials::FeaturesForTrial(trial.Utf8())) {
    switch (feature) {
      ...
      case OriginTrialFeature::kConditionalFocus:
        if (!RuntimeEnabledFeatures::ConditionalFocusEnabled(
                document->GetExecutionContext())) {
          return false;
        }
        break;
      case OriginTrialFeature::kCrossOriginOpenerPolicyReporting:
        if (!RuntimeEnabledFeatures::CrossOriginOpenerPolicyReportingEnabled(
                document->GetExecutionContext())) {
          return false;
        }
        break;
      ...
      case OriginTrialFeature::kRTCIceTransportExtension:
        if (!RuntimeEnabledFeatures::RTCIceTransportExtensionEnabled(
                document->GetExecutionContext())) {
          return false;
        }
        break;
      ...
      case OriginTrialFeature::kRTCQuicTransport:
        if (!RuntimeEnabledFeatures::RTCQuicTransportEnabled(
                document->GetExecutionContext())) {
          return false;
        }
        break;
      ...
      case OriginTrialFeature::kSkipAd:
        if (!RuntimeEnabledFeatures::SkipAdEnabled(
                document->GetExecutionContext())) {
          return false;
        }
        break;
      ...
      case OriginTrialFeature::kStorageFoundationAPI:
        if (!RuntimeEnabledFeatures::StorageFoundationAPIEnabled(
                document->GetExecutionContext())) {
          return false;
        }
        break;
      ...
      case OriginTrialFeature::kTrustTokens:
        if (!RuntimeEnabledFeatures::TrustTokensEnabled(
                document->GetExecutionContext())) {
          return false;
        }
        break;
      case OriginTrialFeature::kU2FSecurityKeyAPI:
        if (!RuntimeEnabledFeatures::U2FSecurityKeyAPIEnabled(
                document->GetExecutionContext())) {
          return false;
        }
        break;
      ...
      case OriginTrialFeature::kUserAgentReduction:
        if (!RuntimeEnabledFeatures::UserAgentReductionEnabled(
                document->GetExecutionContext())) {
          return false;
        }
        break;
      ...
      case OriginTrialFeature::kWebAssemblyExceptions:
        if (!RuntimeEnabledFeatures::WebAssemblyExceptionsEnabled(
                document->GetExecutionContext())) {
          return false;
        }
        break;
      ...
      case OriginTrialFeature::kWebPaymentAPICSP:
        if (!RuntimeEnabledFeatures::WebPaymentAPICSPEnabled(
                document->GetExecutionContext())) {
          return false;
        }
        break;
      ...
      case OriginTrialFeature::kWebXRDepth:
        if (!RuntimeEnabledFeatures::WebXRDepthEnabled(
                document->GetExecutionContext())) {
          return false;
        }
        break;
