...
const AtomicString& kContentVisibilityAutoStateChangedEvent = reinterpret_cast<AtomicString*>(&names_storage)[7];
...
void Init() {
  ...
  static const NameEntry kNames[] = {
    ...
    { "ContentVisibilityAutoStateChangedEvent", 12489391, 38 },
