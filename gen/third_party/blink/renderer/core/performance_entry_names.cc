...
const AtomicString& kTaskattribution = reinterpret_cast<AtomicString*>(&names_storage)[12];
const AtomicString& kVisibilityState = reinterpret_cast<AtomicString*>(&names_storage)[13];
