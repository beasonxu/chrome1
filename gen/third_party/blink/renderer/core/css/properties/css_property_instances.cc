...
static constexpr css_longhand::PopUpHideDelay property_csspropertypopuphidedelay;
static constexpr css_longhand::PopUpShowDelay property_csspropertypopupshowdelay;
...
const CSSProperty& GetCSSPropertyFontPalette() {
  return property_csspropertyfontpalette;
}
...
const CSSProperty& GetCSSPropertyFontSynthesisSmallCaps() {
  return property_csspropertyfontsynthesissmallcaps;
}
const CSSProperty& GetCSSPropertyFontSynthesisStyle() {
  return property_csspropertyfontsynthesisstyle;
}
const CSSProperty& GetCSSPropertyFontSynthesisWeight() {
  return property_csspropertyfontsynthesisweight;
}
...
const CSSProperty& GetCSSPropertyAccentColor() {
  return property_csspropertyaccentcolor;
}
const CSSProperty& GetCSSPropertyAdditiveSymbols() {
  return property_csspropertyadditivesymbols;
}
...
const CSSProperty& GetCSSPropertyAnchorName() {
  return property_csspropertyanchorname;
}
const CSSProperty& GetCSSPropertyAnchorScroll() {
  return property_csspropertyanchorscroll;
}
...
const CSSProperty& GetCSSPropertyAnimationTimeline() {
  return property_csspropertyanimationtimeline;
}
const CSSProperty& GetCSSPropertyAnimationTimingFunction() {
  return property_csspropertyanimationtimingfunction;
}
const CSSProperty& GetCSSPropertyAppRegion() {
  return property_csspropertyappregion;
}
const CSSProperty& GetCSSPropertyAppearance() {
  return property_csspropertyappearance;
}
const CSSProperty& GetCSSPropertyAscentOverride() {
  return property_csspropertyascentoverride;
}
const CSSProperty& GetCSSPropertyAspectRatio() {
  return property_csspropertyaspectratio;
}
...
const CSSProperty& GetCSSPropertyBasePalette() {
  return property_csspropertybasepalette;
}
...
const CSSProperty& GetCSSPropertyBorderEndEndRadius() {
  return property_csspropertyborderendendradius;
}
const CSSProperty& GetCSSPropertyBorderEndStartRadius() {
  return property_csspropertyborderendstartradius;
}
...
const CSSProperty& GetCSSPropertyBorderStartEndRadius() {
  return property_csspropertyborderstartendradius;
}
const CSSProperty& GetCSSPropertyBorderStartStartRadius() {
  return property_csspropertyborderstartstartradius;
}
...
const CSSProperty& GetCSSPropertyContainerName() {
  return property_csspropertycontainername;
}
const CSSProperty& GetCSSPropertyContainerType() {
  return property_csspropertycontainertype;
}
const CSSProperty& GetCSSPropertyContent() {
  return property_csspropertycontent;
}
const CSSProperty& GetCSSPropertyContentVisibility() {
  return property_csspropertycontentvisibility;
}
...
const CSSProperty& GetCSSPropertyCounterSet() {
  return property_csspropertycounterset;
}
...
const CSSProperty& GetCSSPropertyDescentOverride() {
  return property_csspropertydescentoverride;
}
...
const CSSProperty& GetCSSPropertyEnd() {
  return property_csspropertyend;
}
const CSSProperty& GetCSSPropertyFallback() {
  return property_csspropertyfallback;
}
...
const CSSProperty& GetCSSPropertyInternalAlignSelfBlock() {
  return property_csspropertyinternalalignselfblock;
}
const CSSProperty& GetCSSPropertyInternalEmptyLineHeight() {
  return property_csspropertyinternalemptylineheight;
}
const CSSProperty& GetCSSPropertyInternalFontSizeDelta() {
  return property_csspropertyinternalfontsizedelta;
}
const CSSProperty& GetCSSPropertyInternalForcedBackgroundColor() {
  return property_csspropertyinternalforcedbackgroundcolor;
}
const CSSProperty& GetCSSPropertyInternalForcedBorderColor() {
  return property_csspropertyinternalforcedbordercolor;
}
const CSSProperty& GetCSSPropertyInternalForcedColor() {
  return property_csspropertyinternalforcedcolor;
}
const CSSProperty& GetCSSPropertyInternalForcedOutlineColor() {
  return property_csspropertyinternalforcedoutlinecolor;
}
const CSSProperty& GetCSSPropertyInternalForcedVisitedColor() {
  return property_csspropertyinternalforcedvisitedcolor;
}
...
const CSSProperty& GetCSSPropertyLineGapOverride() {
  return property_csspropertylinegapoverride;
}
...
const CSSProperty& GetCSSPropertyMathDepth() {
  return property_csspropertymathdepth;
}
const CSSProperty& GetCSSPropertyMathShift() {
  return property_csspropertymathshift;
}
const CSSProperty& GetCSSPropertyMathStyle() {
  return property_csspropertymathstyle;
}
...
const CSSProperty& GetCSSPropertyNegative() {
  return property_csspropertynegative;
}
...
const CSSProperty& GetCSSPropertyObjectViewBox() {
  return property_csspropertyobjectviewbox;
}
...
const CSSProperty& GetCSSPropertyOverflowClipMargin() {
  return property_csspropertyoverflowclipmargin;
}
...
const CSSProperty& GetCSSPropertyOverrideColors() {
  return property_csspropertyoverridecolors;
}
...
const CSSProperty& GetCSSPropertyPad() {
  return property_csspropertypad;
}
...
const CSSProperty& GetCSSPropertyPageOrientation() {
  return property_csspropertypageorientation;
}
const CSSProperty& GetCSSPropertyPageTransitionTag() {
  return property_csspropertypagetransitiontag;
}
...
const CSSProperty& GetCSSPropertyPopUpHideDelay() {
  return property_csspropertypopuphidedelay;
}
const CSSProperty& GetCSSPropertyPopUpShowDelay() {
  return property_csspropertypopupshowdelay;
}
const CSSProperty& GetCSSPropertyPosition() {
  return property_csspropertyposition;
}
const CSSProperty& GetCSSPropertyPositionFallback() {
  return property_csspropertypositionfallback;
}
const CSSProperty& GetCSSPropertyPrefix() {
  return property_csspropertyprefix;
}
...
const CSSProperty& GetCSSPropertyRange() {
  return property_csspropertyrange;
}
...
const CSSProperty& GetCSSPropertyRubyPosition() {
  return property_csspropertyrubyposition;
}
...
const CSSProperty& GetCSSPropertyScrollbarGutter() {
  return property_csspropertyscrollbargutter;
}
const CSSProperty& GetCSSPropertyScrollbarWidth() {
  return property_csspropertyscrollbarwidth;
}
...
const CSSProperty& GetCSSPropertySizeAdjust() {
  return property_csspropertysizeadjust;
}
const CSSProperty& GetCSSPropertySource() {
  return property_csspropertysource;
}
const CSSProperty& GetCSSPropertySpeak() {
  return property_csspropertyspeak;
}
const CSSProperty& GetCSSPropertySpeakAs() {
  return property_csspropertyspeakas;
}
const CSSProperty& GetCSSPropertySrc() {
  return property_csspropertysrc;
}
const CSSProperty& GetCSSPropertyStart() {
  return property_csspropertystart;
}
...
const CSSProperty& GetCSSPropertySuffix() {
  return property_csspropertysuffix;
}
const CSSProperty& GetCSSPropertySymbols() {
  return property_csspropertysymbols;
}
const CSSProperty& GetCSSPropertySyntax() {
  return property_csspropertysyntax;
}
const CSSProperty& GetCSSPropertySystem() {
  return property_csspropertysystem;
}
...
const CSSProperty& GetCSSPropertyTextDecorationThickness() {
  return property_csspropertytextdecorationthickness;
}
const CSSProperty& GetCSSPropertyTextEmphasisColor() {
  return property_csspropertytextemphasiscolor;
}
const CSSProperty& GetCSSPropertyTextEmphasisPosition() {
  return property_csspropertytextemphasisposition;
}
const CSSProperty& GetCSSPropertyTextEmphasisStyle() {
  return property_csspropertytextemphasisstyle;
}
...
const CSSProperty& GetCSSPropertyTextUnderlineOffset() {
  return property_csspropertytextunderlineoffset;
}
const CSSProperty& GetCSSPropertyTextUnderlinePosition() {
  return property_csspropertytextunderlineposition;
}
const CSSProperty& GetCSSPropertyToggleGroup() {
  return property_csspropertytogglegroup;
}
const CSSProperty& GetCSSPropertyToggleRoot() {
  return property_csspropertytoggleroot;
}
const CSSProperty& GetCSSPropertyToggleTrigger() {
  return property_csspropertytoggletrigger;
}
...
const CSSProperty& GetCSSPropertyContainer() {
  return property_csspropertycontainer;
}
...
const CSSProperty& GetCSSPropertyFontSynthesis() {
  return property_csspropertyfontsynthesis;
}
...
const CSSProperty& GetCSSPropertyTextEmphasis() {
  return property_csspropertytextemphasis;
}
const CSSProperty& GetCSSPropertyToggle() {
  return property_csspropertytoggle;
}
...
const CSSUnresolvedProperty* const kPropertyClasses[] = {
  ...
  &property_csspropertypopuphidedelay,  // CSSPropertyPopUpHideDelay
  &property_csspropertypopupshowdelay,  // CSSPropertyPopUpShowDelay
