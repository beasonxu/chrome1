...
if (!bindings::GetDictionaryMemberFromV8Object<IDLArray<V8XRHitTestTrackableType>, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[0].Get(isolate), has_entity_types_, member_entity_types_, try_block, exception_state)) {
  return;
}
}
exception_context_scope.ChangePropertyNameAsOptimizationHack("offsetRay");
if (!bindings::GetDictionaryMemberFromV8Object<XRRay, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[1].Get(isolate), has_offset_ray_, member_offset_ray_, try_block, exception_state)) {
  return;
}
exception_context_scope.ChangePropertyNameAsOptimizationHack("profile");
constexpr bool is_required = true;
bool fallback_presence_var;
if (!bindings::GetDictionaryMemberFromV8Object<IDLString, is_required>(isolate, current_context, v8_dictionary, v8_own_member_names[2].Get(isolate), fallback_presence_var, member_profile_, try_block, exception_state)) {
  return;
}
}
