...
if (!bindings::GetDictionaryMemberFromV8Object<IDLRecord<IDLUSVString, V8UnionUSVStringOrUSVStringSequence>, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[0].Get(isolate), has_accept_, member_accept_, try_block, exception_state)) {
  return;
}
exception_context_scope.ChangePropertyNameAsOptimizationHack("description");
if (!bindings::GetDictionaryMemberFromV8Object<IDLUSVString, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[1].Get(isolate), has_description_, member_description_, try_block, exception_state)) {
  return;
}
}
