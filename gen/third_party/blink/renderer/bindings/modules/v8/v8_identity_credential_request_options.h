...
bool hasPreferAutoSignIn() const {
  return true;
}
bool preferAutoSignIn() const {
  return member_prefer_auto_sign_in_;
}
void setPreferAutoSignIn(bool value) {
  member_prefer_auto_sign_in_ = value;
}
