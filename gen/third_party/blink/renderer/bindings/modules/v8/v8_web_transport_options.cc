...
if (!bindings::GetDictionaryMemberFromV8Object<IDLSequence<WebTransportHash>, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[0].Get(isolate), has_server_certificate_hashes_, member_server_certificate_hashes_, try_block, exception_state)) {
  return;
}
}
}
