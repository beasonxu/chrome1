...
const WrapperTypeInfo& WorkletAnimation::wrapper_type_info_ =
    V8WorkletAnimation::wrapper_type_info_;
...
void V8WorkletAnimation::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template, v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template) {
