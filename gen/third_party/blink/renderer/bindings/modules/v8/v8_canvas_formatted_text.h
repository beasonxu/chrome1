...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_CANVAS_FORMATTED_TEXT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_CANVAS_FORMATTED_TEXT_H_
...
class MODULES_EXPORT V8CanvasFormattedText final : public bindings::V8InterfaceBridge<V8CanvasFormattedText, CanvasFormattedText> {
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CanvasFormattedText;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_CANVAS_FORMATTED_TEXT_H_
