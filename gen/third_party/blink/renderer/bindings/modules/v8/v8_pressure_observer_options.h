...
bool hasCpuUtilizationThresholds() const {
  return true;
}
const Vector<double>& cpuUtilizationThresholds() const {
  return member_cpu_utilization_thresholds_;
}
void setCpuUtilizationThresholds(const Vector<double>& value);
void setCpuUtilizationThresholds(Vector<double>&& value);
...
Vector<double> member_cpu_utilization_thresholds_;
