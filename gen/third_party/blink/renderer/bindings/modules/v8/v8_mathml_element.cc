...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_MathMLElement_oncontentvisibilityautostatechanged_Getter");
BLINK_BINDINGS_TRACE_EVENT("MathMLElement.oncontentvisibilityautostatechanged.get");
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_MathMLElement_oncontentvisibilityautostatechanged_Setter");
BLINK_BINDINGS_TRACE_EVENT("MathMLElement.oncontentvisibilityautostatechanged.set");
...
void V8MathMLElement::Impl::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template, v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template) {
