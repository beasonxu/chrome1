...
if (!bindings::GetDictionaryMemberFromV8Object<IDLBoolean, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[0].Get(isolate), fallback_presence_var, member_accept_all_devices_, try_block, exception_state)) {
  return;
}
exception_context_scope.ChangePropertyNameAsOptimizationHack("filters");
if (!bindings::GetDictionaryMemberFromV8Object<IDLSequence<BluetoothLEScanFilterInit>, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[1].Get(isolate), has_filters_, member_filters_, try_block, exception_state)) {
  return;
}
if (RuntimeEnabledFeatures::WebBluetoothWatchAdvertisementsEnabled()) {
  exception_context_scope.ChangePropertyNameAsOptimizationHack("optionalManufacturerData");
if (!bindings::GetDictionaryMemberFromV8Object<IDLSequence<IDLUnsignedShort>, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[2].Get(isolate), fallback_presence_var, member_optional_manufacturer_data_, try_block, exception_state)) {
  return;
}
}
exception_context_scope.ChangePropertyNameAsOptimizationHack("optionalServices");
if (!bindings::GetDictionaryMemberFromV8Object<IDLSequence<V8UnionStringOrUnsignedLong>, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[3].Get(isolate), fallback_presence_var, member_optional_services_, try_block, exception_state)) {
  return;
}
}
