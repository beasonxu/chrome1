...
if (!bindings::GetDictionaryMemberFromV8Object<IDLNullable<V8UnionAudioTrackOrTextTrackOrVideoTrack>, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[0].Get(isolate), has_track_, member_track_, try_block, exception_state)) {
  return;
}
}
