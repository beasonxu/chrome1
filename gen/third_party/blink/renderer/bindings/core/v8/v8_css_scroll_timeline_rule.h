...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_SCROLL_TIMELINE_RULE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_SCROLL_TIMELINE_RULE_H_
...
class CSSScrollTimelineRule;
class ExecutionContext;
struct WrapperTypeInfo;

class CORE_EXPORT V8CSSScrollTimelineRule final : public bindings::V8InterfaceBridge<V8CSSScrollTimelineRule, CSSScrollTimelineRule> {
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CSSScrollTimelineRule;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_SCROLL_TIMELINE_RULE_H_
