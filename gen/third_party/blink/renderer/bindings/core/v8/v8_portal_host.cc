...
bool V8PortalHost::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo& PortalHost::wrapper_type_info_ =
    V8PortalHost::wrapper_type_info_;
...
void V8PortalHost::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> instance_template, v8::Local<v8::Template> prototype_template, v8::Local<v8::Template> interface_template) {
