...
kNone, kText, kDecimal, kSearch, kEmail, kNumeric, kTel, kUrl, kPassword
};
...
explicit constexpr  V8EditContextInputMode(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
...
inline bool operator==(const V8EditContextInputMode& lhs, V8EditContextInputMode::Enum rhs) {
  return lhs.AsEnum() == rhs;
}

inline bool operator==(V8EditContextInputMode::Enum lhs, const V8EditContextInputMode& rhs) {
