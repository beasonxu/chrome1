...
class CORE_EXPORT DedicatedWorkerHostFactoryClientInterceptorForTesting : public DedicatedWorkerHostFactoryClient {
  ...
  void OnWorkerHostCreated(::mojo::PendingRemote<::blink::mojom::blink::BrowserInterfaceBroker> browser_interface_broker, ::mojo::PendingRemote<::blink::mojom::blink::DedicatedWorkerHost> host) override;
...
class CORE_EXPORT DedicatedWorkerHostFactoryInterceptorForTesting : public DedicatedWorkerHostFactory {
  ...
  void CreateWorkerHost(const ::blink::DedicatedWorkerToken& token, const ::blink::KURL& script_url, ::mojo::PendingReceiver<::blink::mojom::blink::BrowserInterfaceBroker> browser_interface_broker, ::mojo::PendingReceiver<::blink::mojom::blink::DedicatedWorkerHost> host, CreateWorkerHostCallback callback) override;
  void CreateWorkerHostAndStartScriptLoad(const ::blink::DedicatedWorkerToken& token, const ::blink::KURL& script_url, ::network::mojom::blink::CredentialsMode credentials_mode, ::blink::mojom::blink::FetchClientSettingsObjectPtr outside_fetch_client_settings_object, ::mojo::PendingRemote<::blink::mojom::blink::BlobURLToken> blob_url_token, ::mojo::PendingRemote<DedicatedWorkerHostFactoryClient> client) override;
};
