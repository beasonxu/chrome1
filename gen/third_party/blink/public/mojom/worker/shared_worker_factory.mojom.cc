...
void SharedWorkerFactoryProxy::CreateSharedWorker(
    ::blink::mojom::SharedWorkerInfoPtr in_info, const ::blink::SharedWorkerToken& in_token, const ::url::Origin& in_constructor_origin, bool in_is_constructor_secure_context, const std::string& in_user_agent, const std::string& in_full_user_agent, const std::string& in_reduced_user_agent, const ::blink::UserAgentMetadata& in_ua_metadata, bool in_pause_on_start, const ::base::UnguessableToken& in_devtools_worker_token, const ::blink::RendererPreferences& in_renderer_preferences, ::mojo::PendingReceiver<::blink::mojom::RendererPreferenceWatcher> in_preference_watcher_receiver, ::mojo::PendingRemote<::blink::mojom::WorkerContentSettingsProxy> in_content_settings, ::blink::mojom::ServiceWorkerContainerInfoForClientPtr in_service_worker_container_info, ::blink::mojom::WorkerMainScriptLoadParamsPtr in_main_script_load_params, ::std::unique_ptr<::blink::PendingURLLoaderFactoryBundle> in_subresource_loader_factories, ::blink::mojom::ControllerServiceWorkerInfoPtr in_controller_info, ::blink::mojom::PolicyContainerPtr in_policy_container, ::mojo::PendingRemote<::blink::mojom::SharedWorkerHost> in_host, ::mojo::PendingReceiver<::blink::mojom::SharedWorker> in_shared_worker, ::mojo::PendingRemote<::blink::mojom::BrowserInterfaceBroker> in_browser_interface_broker, int64_t in_ukm_source_id) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("host"), in_host,
                        "<value of type ::mojo::PendingRemote<::blink::mojom::SharedWorkerHost>>");
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("shared_worker"), in_shared_worker,
                        "<value of type ::mojo::PendingReceiver<::blink::mojom::SharedWorker>>");
      perfetto::WriteIntoTracedValueWithFallback(
