...
bool WorkerMainScriptLoadParams_Data::Validate(
  ...
  [[maybe_unused]] const WorkerMainScriptLoadParams_Data* object =
      static_cast<const WorkerMainScriptLoadParams_Data*>(data);

  if (!mojo::internal::ValidatePointerNonNullable(
          object->response_head, 2, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->redirect_response_heads, 6, validation_context)) {
    return false;
  }
