...
void DedicatedWorkerHostFactoryProxy::CreateWorkerHost(
    const ::blink::DedicatedWorkerToken& in_token, const ::blink::KURL& in_script_url, ::mojo::PendingReceiver<::blink::mojom::blink::BrowserInterfaceBroker> in_browser_interface_broker, ::mojo::PendingReceiver<::blink::mojom::blink::DedicatedWorkerHost> in_host, CreateWorkerHostCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("host"), in_host,
                        "<value of type ::mojo::PendingReceiver<::blink::mojom::blink::DedicatedWorkerHost>>");
   });
#endif
...
void DedicatedWorkerHostFactoryClientInterceptorForTesting::OnWorkerHostCreated(::mojo::PendingRemote<::blink::mojom::blink::BrowserInterfaceBroker> browser_interface_broker, ::mojo::PendingRemote<::blink::mojom::blink::DedicatedWorkerHost> host) {
...
void DedicatedWorkerHostFactoryInterceptorForTesting::CreateWorkerHost(const ::blink::DedicatedWorkerToken& token, const ::blink::KURL& script_url, ::mojo::PendingReceiver<::blink::mojom::blink::BrowserInterfaceBroker> browser_interface_broker, ::mojo::PendingReceiver<::blink::mojom::blink::DedicatedWorkerHost> host, CreateWorkerHostCallback callback) {
...
void DedicatedWorkerHostFactoryAsyncWaiter::CreateWorkerHost(
    const ::blink::DedicatedWorkerToken& token, const ::blink::KURL& script_url, ::mojo::PendingReceiver<::blink::mojom::blink::BrowserInterfaceBroker> browser_interface_broker, ::mojo::PendingReceiver<::blink::mojom::blink::DedicatedWorkerHost> host, ::network::CrossOriginEmbedderPolicy* out_parent_coep, ::mojo::PendingRemote<::blink::mojom::blink::BackForwardCacheControllerHost>* out_back_forward_cache_controller_host) {
  base::RunLoop loop;
...
,
             ...
             ::mojo::PendingRemote<::blink::mojom::blink::BackForwardCacheControllerHost> back_forward_cache_controller_host) {*out_parent_coep = std::move(parent_coep);*out_back_forward_cache_controller_host = std::move(back_forward_cache_controller_host);
            loop->Quit();
          },
          &loop,
          out_parent_coep,
