...
struct blink_mojom_internal_PushEventStatus_DataHashFn {
  ...
  static bool Equal(const ::blink::mojom::PushEventStatus& left, const ::blink::mojom::PushEventStatus& right) {
    return left == right;
  }
...
struct HashTraits<::blink::mojom::PushEventStatus>
    : public GenericHashTraits<::blink::mojom::PushEventStatus> {
  static_assert(true,
  ...
  static void ConstructDeletedValue(::blink::mojom::PushEventStatus& slot, bool) {
    slot = static_cast<::blink::mojom::PushEventStatus>(-1000001);
  }
  static bool IsDeletedValue(const ::blink::mojom::PushEventStatus& value) {
    return value == static_cast<::blink::mojom::PushEventStatus>(-1000001);
  }
};
}  // namespace WTF
