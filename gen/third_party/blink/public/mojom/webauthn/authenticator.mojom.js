...
(function() {
  ...
  AuthenticatorStatus.REMOTE_DESKTOP_CLIENT_OVERRIDE_NOT_AUTHORIZED = 21;
  ...
  GetAssertionAuthenticatorResponse.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 56, 1, codec.Uint8, true, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  PublicKeyCredentialRequestOptions.decode = function(decoder) {
    ...
    val.prf = (packed >> 2) & 1 ? true : false;
    val.largeBlobRead = (packed >> 3) & 1 ? true : false;
    val.getCredBlob = (packed >> 4) & 1 ? true : false;
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  PublicKeyCredentialRequestOptions.encode = function(encoder, val) {
    ...
    packed |= (val.prf & 1) << 2
    packed |= (val.largeBlobRead & 1) << 3
    packed |= (val.getCredBlob & 1) << 4
    encoder.writeUint8(packed);
    encoder.skip(1);
    encoder.skip(1);
    encoder.skip(1);
