...
struct blink_test_mojom_internal_Ctap2Version_DataHashFn {
  ...
  static bool Equal(const ::blink::test::mojom::Ctap2Version& left, const ::blink::test::mojom::Ctap2Version& right) {
    return left == right;
  }
  static const bool safe_to_compare_to_empty_or_deleted = true;
};
...
struct HashTraits<::blink::test::mojom::Ctap2Version>
    : public GenericHashTraits<::blink::test::mojom::Ctap2Version> {
  static_assert(true,
                "-1000000 is a reserved enum value");
  static_assert(true,
                "-1000001 is a reserved enum value");
  ...
  static void ConstructDeletedValue(::blink::test::mojom::Ctap2Version& slot, bool) {
    slot = static_cast<::blink::test::mojom::Ctap2Version>(-1000001);
  }
  static bool IsDeletedValue(const ::blink::test::mojom::Ctap2Version& value) {
    return value == static_cast<::blink::test::mojom::Ctap2Version>(-1000001);
  }
};
}  // namespace WTF
...
struct PLATFORM_EXPORT StructTraits<::blink::test::mojom::blink::VirtualAuthenticatorOptions::DataView,
  ...
  static decltype(::blink::test::mojom::blink::VirtualAuthenticatorOptions::ctap2_version) ctap2_version(
      const ::blink::test::mojom::blink::VirtualAuthenticatorOptionsPtr& input) {
  ...
  static decltype(::blink::test::mojom::blink::VirtualAuthenticatorOptions::has_cred_blob) has_cred_blob(
      const ::blink::test::mojom::blink::VirtualAuthenticatorOptionsPtr& input) {
