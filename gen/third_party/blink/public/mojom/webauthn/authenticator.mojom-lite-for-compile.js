...
goog.provide('blink.mojom.UvmEntrySpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('blink.mojom.UvmEntry');
...
mojo.internal.Struct(
    ...
    [
      ...
      mojo.internal.StructField(
        ...
        0,
        mojo.internal.Array(blink.mojom.UvmEntrySpec.$, false),
        null,
        true /* nullable */),
      mojo.internal.StructField(
        'echoPrf', 12,
...
blink.mojom.GetAssertionAuthenticatorResponse = class {
  constructor() {
    ...
    /** @export { (Array<!number>|undefined) } */
    this.userHandle;
    /** @export { (Array<!blink.mojom.UvmEntry>|undefined) } */
