...
struct BLINK_COMMON_EXPORT StructTraits<::blink::test::mojom::VirtualAuthenticatorOptions::DataView,
  ...
  static decltype(::blink::test::mojom::VirtualAuthenticatorOptions::has_large_blob) has_large_blob(
      const ::blink::test::mojom::VirtualAuthenticatorOptionsPtr& input) {
    return input->has_large_blob;
  }

  static decltype(::blink::test::mojom::VirtualAuthenticatorOptions::has_cred_blob) has_cred_blob(
      const ::blink::test::mojom::VirtualAuthenticatorOptionsPtr& input) {
    return input->has_cred_blob;
  }

  static decltype(::blink::test::mojom::VirtualAuthenticatorOptions::has_min_pin_length) has_min_pin_length(
      const ::blink::test::mojom::VirtualAuthenticatorOptionsPtr& input) {
