...
// with not having this data in traces there.
  ...
  using RunAdAuctionCallback = base::OnceCallback<void(const absl::optional<::blink::KURL>&)>;
  
  virtual void RunAdAuction(::blink::mojom::blink::AuctionAdConfigPtr config, RunAdAuctionCallback callback) = 0;
...
class PLATFORM_EXPORT AdAuctionServiceProxy
 ...
 public:
  ...
  void RunAdAuction(::blink::mojom::blink::AuctionAdConfigPtr config, RunAdAuctionCallback callback) final;
...
class PLATFORM_EXPORT Replacement {
 public:
  template <typename T>
  using EnableIfSame = std::enable_if_t<std::is_same<Replacement, T>::value>;
  using DataView = ReplacementDataView;
  using Data_ = internal::Replacement_Data;

  template <typename... Args>
  static ReplacementPtr New(Args&&... args) {
    return ReplacementPtr(
        absl::in_place, std::forward<Args>(args)...);
  }

  template <typename U>
  static ReplacementPtr From(const U& u) {
    return mojo::TypeConverter<ReplacementPtr, U>::Convert(u);
  }

  template <typename U>
  U To() const {
    return mojo::TypeConverter<U, Replacement>::Convert(*this);
  }
  ...
  template <typename StructPtrType = ReplacementPtr>
  ReplacementPtr Clone() const;

  // Equals() is a template so it is only instantiated if it is used. Thus, the
  // bindings generator does not need to know whether Equals() or == operator
  // are available for members.
  template <typename T, Replacement::EnableIfSame<T>* = nullptr>
  ...
  static WTF::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        Replacement::DataView, WTF::Vector<uint8_t>>(input);
  }

  template <typename UserType>
  static mojo::Message SerializeAsMessage(UserType* input) {
    return mojo::internal::SerializeAsMessageImpl<
        Replacement::DataView>(input);
  }
  ...
  static mojo::Message WrapAsMessage(UserType input) {
    return mojo::Message(std::make_unique<
        internal::Replacement_UnserializedMessageContext<
            UserType, Replacement::DataView>>(0, 0, std::move(input)),
  ...
  static bool Deserialize(const void* data,
                          ...
                          UserType* output) {
    mojo::Message message;
    return mojo::internal::DeserializeImpl<Replacement::DataView>(
  ...
  static bool Deserialize(const WTF::Vector<uint8_t>& input,
                          UserType* output) {
    return Replacement::Deserialize(
...
ReplacementPtr Replacement::Clone() const {
  return New(
      mojo::Clone(match),
...
template <typename T, Replacement::EnableIfSame<T>*>
bool Replacement::Equals(const T& other_struct) const {
...
template <>
struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::Replacement::DataView,
                                         ::blink::mojom::blink::ReplacementPtr> {
  ...
  static const decltype(::blink::mojom::blink::Replacement::match)& match(
      const ::blink::mojom::blink::ReplacementPtr& input) {
    return input->match;
  }

  static const decltype(::blink::mojom::blink::Replacement::replacement)& replacement(
      const ::blink::mojom::blink::ReplacementPtr& input) {
