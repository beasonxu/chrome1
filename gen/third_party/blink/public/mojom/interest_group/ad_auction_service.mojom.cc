    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("config"), in_config,
                        "<value of type ::blink::mojom::AdRequestConfigPtr>");
   });
#endif
...
void AdAuctionServiceProxy::FinalizeAd(
  ...
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("config"), in_config,
                        "<value of type const ::blink::AuctionConfig&>");
   });
#endif
  const bool kExpectsResponse = true;
  const bool kIsSync = false;
...
void AdAuctionServiceProxy::RunAdAuction(
    const ::blink::AuctionConfig& in_config, RunAdAuctionCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void AdAuctionServiceProxy::DeprecatedGetURLFromURN(
    const ::GURL& in_uuid_url, DeprecatedGetURLFromURNCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void AdAuctionServiceProxy::DeprecatedReplaceInURN(
    const ::GURL& in_uuid_url, std::vector<ReplacementPtr> in_replacements, DeprecatedReplaceInURNCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("replacements"), in_replacements,
                        "<value of type std::vector<ReplacementPtr>>");
   });
#endif
  const bool kExpectsResponse = true;
  const bool kIsSync = false;
...
class AdAuctionService_CreateAdRequest_ProxyToResponder : public ::mojo::internal::ProxyToResponder {
 ...
 private:
  ...
  void Run(
      const absl::optional<std::string>& in_ads_guid);
};
...
bool AdAuctionService_CreateAdRequest_ForwardToCallback::Accept(
  ...
  bool success = true;
  absl::optional<std::string> p_ads_guid{};
...
class AdAuctionService_DeprecatedGetURLFromURN_ProxyToResponder : public ::mojo::internal::ProxyToResponder {
 ...
 private:
  ...
  void Run(
      const absl::optional<::GURL>& in_decoded_url);
};
...
bool AdAuctionService_DeprecatedGetURLFromURN_ForwardToCallback::Accept(
  ...
  bool success = true;
  absl::optional<::GURL> p_decoded_url{};
...
std::move(p_uuid_url), std::move(callback));
    ...
    case internal::kAdAuctionService_DeprecatedReplaceInURN_Name: {
      ...
      bool success = true;
      ::GURL p_uuid_url{};
      std::vector<ReplacementPtr> p_replacements{};
...
// static
bool StructTraits<::blink::mojom::Replacement::DataView, ::blink::mojom::ReplacementPtr>::Read(
    ::blink::mojom::Replacement::DataView input,
    ::blink::mojom::ReplacementPtr* output) {
  bool success = true;
...
void AdAuctionServiceInterceptorForTesting::RunAdAuction(const ::blink::AuctionConfig& config, RunAdAuctionCallback callback) {
...
void AdAuctionServiceAsyncWaiter::CreateAdRequest(
  ...
  proxy_->CreateAdRequest(std::move(config),
      base::BindOnce(
          [](base::RunLoop* loop,
             absl::optional<std::string>* out_ads_guid
,
             const absl::optional<std::string>& ads_guid) {*out_ads_guid = std::move(ads_guid);
            loop->Quit();
          },
          &loop,
          out_ads_guid));
...
void AdAuctionServiceAsyncWaiter::FinalizeAd(
  ...
  proxy_->FinalizeAd(std::move(ads_guid),std::move(config),
      base::BindOnce(
          [](base::RunLoop* loop,
             absl::optional<::GURL>* out_ad_display_url
,
             const absl::optional<::GURL>& ad_display_url) {*out_ad_display_url = std::move(ad_display_url);
            loop->Quit();
          },
          &loop,
          out_ad_display_url));
...
void AdAuctionServiceAsyncWaiter::DeprecatedGetURLFromURN(
  ...
  proxy_->DeprecatedGetURLFromURN(std::move(uuid_url),
      base::BindOnce(
          [](base::RunLoop* loop,
             absl::optional<::GURL>* out_decoded_url
,
             const absl::optional<::GURL>& decoded_url) {*out_decoded_url = std::move(decoded_url);
            loop->Quit();
          },
          &loop,
          out_decoded_url));
