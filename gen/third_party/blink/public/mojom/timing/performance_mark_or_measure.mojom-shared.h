...
class PerformanceMarkOrMeasureDataView {
 public:
  ...
  template <typename UserType>
  [[nodiscard]] bool ReadEntryType(UserType* output) const {
  ...
  PerformanceMarkOrMeasure_EntryType entry_type() const {
    return ::mojo::internal::ToKnownEnumValueHelper(
          static_cast<::blink::mojom::PerformanceMarkOrMeasure_EntryType>(data_->entry_type));
  }
...
struct Serializer<::blink::mojom::PerformanceMarkOrMeasure_EntryType, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    return Traits::FromMojom(::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::blink::mojom::PerformanceMarkOrMeasure_EntryType>(input)), output);
  }
};
...
struct Serializer<::blink::mojom::PerformanceMarkOrMeasureDataView, MaybeConstUserType> {
  ...
  static void Serialize(
      ...
      mojo::internal::MessageFragment<::blink::mojom::internal::PerformanceMarkOrMeasure_Data>& fragment) {
    ...
    mojo::internal::Serialize<::blink::mojom::PerformanceMarkOrMeasure_EntryType>(
        Traits::entry_type(input), &fragment->entry_type);
...
template <>
struct COMPONENT_EXPORT(MOJOM_SHARED_BLINK_COMMON_EXPORT) TraceFormatTraits<::blink::mojom::PerformanceMarkOrMeasure_EntryType> {
