...
void PressureObserverProxy::OnUpdate(
    ::device::mojom::PressureStatePtr in_state) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
// static
bool StructTraits<::blink::mojom::PressureQuantization::DataView, ::blink::mojom::PressureQuantizationPtr>::Read(
    ::blink::mojom::PressureQuantization::DataView input,
    ::blink::mojom::PressureQuantizationPtr* output) {
  bool success = true;
  ::blink::mojom::PressureQuantizationPtr result(::blink::mojom::PressureQuantization::New());
...
void PressureObserverInterceptorForTesting::OnUpdate(::device::mojom::PressureStatePtr state) {
