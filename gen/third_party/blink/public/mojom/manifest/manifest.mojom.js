...
(function() {
  ...
  ManifestScreenshot.Platform = {};
  ManifestScreenshot.Platform.kUnknown = 0;
  ManifestScreenshot.Platform.kWide = 1;
  ManifestScreenshot.Platform.kNarrow = 2;
  ManifestScreenshot.Platform.MIN_VALUE = 0;
  ManifestScreenshot.Platform.MAX_VALUE = 2;

  ManifestScreenshot.Platform.isKnownEnumValue = function(value) {
    switch (value) {
    case 0:
    case 1:
    case 2:
  ...
  ManifestScreenshot.Platform.toKnownEnumValue = function(value) {
    return value;
  };

  ManifestScreenshot.Platform.validate = function(enumValue) {
    const isExtensible = false;
    if (isExtensible || this.isKnownEnumValue(enumValue))
      return validator.validationError.NONE;
  ...
  ManifestScreenshot.validate = function(messageValidator, offset) {
    ...
    // validate ManifestScreenshot.platform
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 8, ManifestScreenshot.Platform);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  ManifestScreenshot.encodedSize = codec.kStructHeaderSize + 16;
  ...
  ManifestScreenshot.decode = function(decoder) {
    ...
    val.platform =
        decoder.decodeStruct(new codec.Enum(ManifestScreenshot.Platform));
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  ManifestScreenshot.encode = function(encoder, val) {
    ...
    encoder.encodeStruct(codec.Int32, val.platform);
    encoder.skip(1);
    encoder.skip(1);
    encoder.skip(1);
    encoder.skip(1);
