...
SubAppsServiceAddInfo::SubAppsServiceAddInfo(
    const WTF::String& unhashed_app_id_in,
...
SubAppsServiceListResult::SubAppsServiceListResult(
    ...
    WTF::Vector<WTF::String> sub_app_ids_in)
...
void SubAppsServiceProxy::Add(
    WTF::Vector<SubAppsServiceAddInfoPtr> in_sub_apps, AddCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("sub_apps"), in_sub_apps,
                        "<value of type WTF::Vector<SubAppsServiceAddInfoPtr>>");
   });
#endif
...
void SubAppsServiceProxy::Remove(
    const WTF::String& in_unhashed_app_id, RemoveCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
class SubAppsService_Add_ProxyToResponder : public ::mojo::internal::ProxyToResponder {
 ...
 private:
  ...
  void Run(
      WTF::Vector<SubAppsServiceAddResultPtr> in_result);
};
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("result"), in_result,
                        "<value of type WTF::Vector<SubAppsServiceAddResultPtr>>");
   });
#endif
...
bool SubAppsServiceStubDispatch::AcceptWithResponder(
  ...
  switch (message->header()->name) {
    case internal::kSubAppsService_Add_Name: {
      ...
      bool success = true;
      WTF::Vector<SubAppsServiceAddInfoPtr> p_sub_apps{};
...
bool StructTraits<::blink::mojom::blink::SubAppsServiceAddInfo::DataView, ::blink::mojom::blink::SubAppsServiceAddInfoPtr>::Read(
    ::blink::mojom::blink::SubAppsServiceAddInfo::DataView input,
    ::blink::mojom::blink::SubAppsServiceAddInfoPtr* output) {
  bool success = true;
...
void SubAppsServiceAsyncWaiter::Add(
    WTF::Vector<SubAppsServiceAddInfoPtr> sub_apps, WTF::Vector<SubAppsServiceAddResultPtr>* out_result) {
  base::RunLoop loop;
  proxy_->Add(std::move(sub_apps),
      base::BindOnce(
          [](base::RunLoop* loop,
             WTF::Vector<SubAppsServiceAddResultPtr>* out_result
,
             WTF::Vector<SubAppsServiceAddResultPtr> result) {*out_result = std::move(result);
            loop->Quit();
          },
          &loop,
          out_result));
...
void SubAppsServiceAsyncWaiter::Remove(
    const WTF::String& unhashed_app_id, SubAppsServiceResult* out_result) {
  base::RunLoop loop;
