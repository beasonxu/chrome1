...
static_assert(
  ...
  template <typename UserType>
  [[nodiscard]] bool ReadUkmData(UserType* output) {
...
class BackgroundFetchService_Fetch_ResponseParamsDataView {
 public:
  ...
  BackgroundFetchError error() const {
    return ::mojo::internal::ToKnownEnumValueHelper(
          static_cast<::blink::mojom::BackgroundFetchError>(data_->error));
  }
...
class BackgroundFetchService_GetDeveloperIds_ResponseParamsDataView {
 public:
  ...
  template <typename UserType>
  [[nodiscard]] bool ReadDeveloperIds(UserType* output) {
...
class BackgroundFetchService_GetIconDisplaySize_ResponseParamsDataView {
 public:
  ...
  template <typename UserType>
  [[nodiscard]] bool ReadIconSizePixels(UserType* output) {
...
class BackgroundFetchRegistrationService_MatchRequests_ParamsDataView {
 public:
  ...
  template <typename UserType>
  [[nodiscard]] bool ReadRequestToMatch(UserType* output) {
...
static_assert(
  ...
  template <typename UserType>
  [[nodiscard]] bool ReadCacheQueryOptions(UserType* output) {
...
class BackgroundFetchRegistrationService_MatchRequests_ResponseParamsDataView {
 public:
  ...
  template <typename UserType>
  [[nodiscard]] bool ReadFetches(UserType* output) {
