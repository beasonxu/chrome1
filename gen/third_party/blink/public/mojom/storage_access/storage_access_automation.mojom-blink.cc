...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    "mojom", "Send blink::test::mojom::StorageAccessAutomation::SetStorageAccess", "input_parameters",
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    "mojom", "Send reply blink::test::mojom::StorageAccessAutomation::SetStorageAccess", "async_response_parameters",
    [&](perfetto::TracedValue context){
      auto dict = std::move(context).WriteDictionary();
      perfetto::WriteIntoTracedValueWithFallback(
...
StorageAccessAutomationAsyncWaiter::StorageAccessAutomationAsyncWaiter(
    StorageAccessAutomation* proxy) : proxy_(proxy) {}

StorageAccessAutomationAsyncWaiter::~StorageAccessAutomationAsyncWaiter() = default;

void StorageAccessAutomationAsyncWaiter::SetStorageAccess(
    const WTF::String& origin, const WTF::String& embedding_origin, bool allowed, bool* out_success) {
  base::RunLoop loop;
