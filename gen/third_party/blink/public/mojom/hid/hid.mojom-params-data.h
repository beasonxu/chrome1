...
static_assert(sizeof(HidService_RegisterClient_Params_Data) == 16,
              "Bad sizeof(HidService_RegisterClient_Params_Data)");
...
static_assert(sizeof(HidService_RequestDevice_Params_Data) == 24,
...
static_assert(sizeof(HidService_Forget_Params_Data) == 16,
              "Bad sizeof(HidService_Forget_Params_Data)");
...
static_assert(sizeof(HidService_Forget_ResponseParams_Data) == 8,
              "Bad sizeof(HidService_Forget_ResponseParams_Data)");
...
class HidService_RegisterClient_ParamsDataView {
 public:
  ...
  HidService_RegisterClient_ParamsDataView(
      internal::HidService_RegisterClient_Params_Data* data,
...
class HidService_Forget_ParamsDataView {
 public:
  ...
  HidService_Forget_ParamsDataView(
      internal::HidService_Forget_Params_Data* data,
      mojo::Message* message)
      : data_(data), message_(message) {}

  bool is_null() const { return !data_; }
  inline void GetDeviceInfoDataView(
      ::device::mojom::HidDeviceInfoDataView* output);
...
class HidService_Forget_ResponseParamsDataView {
 public:
  ...
  HidService_Forget_ResponseParamsDataView(
      internal::HidService_Forget_ResponseParams_Data* data,
      mojo::Message* message)
      : data_(data) {}
...
inline void HidService_RequestDevice_ParamsDataView::GetExclusionFiltersDataView(
    mojo::ArrayDataView<HidDeviceFilterDataView>* output) {
  auto pointer = data_->exclusion_filters.Get();
  *output = mojo::ArrayDataView<HidDeviceFilterDataView>(pointer, message_);
}
...
inline void HidService_Forget_ParamsDataView::GetDeviceInfoDataView(
    ::device::mojom::HidDeviceInfoDataView* output) {
  auto pointer = data_->device_info.Get();
