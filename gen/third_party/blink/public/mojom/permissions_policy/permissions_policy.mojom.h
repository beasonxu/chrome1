...
template <>
struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::ParsedPermissionsPolicyDeclaration::DataView,
                                         ::blink::mojom::ParsedPermissionsPolicyDeclarationPtr> {
  ...
  static decltype(::blink::mojom::ParsedPermissionsPolicyDeclaration::feature) feature(
