...
#include "third_party/blink/public/common/permissions_policy/permissions_policy_forward.h"
...
class PLATFORM_EXPORT ParsedPermissionsPolicyDeclaration {
 public:
  ...
  ParsedPermissionsPolicyDeclaration(
      ...
      WTF::Vector<::scoped_refptr<const ::blink::SecurityOrigin>> allowed_origins,
  ...
  static WTF::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        ParsedPermissionsPolicyDeclaration::DataView, WTF::Vector<uint8_t>>(input);
  }
...
template <>
struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::ParsedPermissionsPolicyDeclaration::DataView,
                                         ::blink::mojom::blink::ParsedPermissionsPolicyDeclarationPtr> {
