...
RemoteFrameToken token, FrameToken openerFrameToken, FrameReplicationState replicationState, org.chromium.mojo_base.mojom.UnguessableToken devtoolsFrameToken, RemoteFrameInterfacesFromBrowser remoteFrameInterfaces, RemoteMainFrameInterfaces remoteMainFrameInterfaces) {
            ...
            try {
                ...
                switch(header.getType()) {
                    ...
                    case CREATE_REMOTE_MAIN_FRAME_ORDINAL: {
                        ...
                        getImpl().createRemoteMainFrame(data.token, data.openerFrameToken, data.replicationState, data.devtoolsFrameToken, data.remoteFrameInterfaces, data.remoteMainFrameInterfaces);
                        return true;
                    }
    ...
    static final class PageBroadcastCreateRemoteMainFrameParams extends org.chromium.mojo.bindings.Struct {
        ...
        protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
            ...
            encoder0.encode(this.devtoolsFrameToken, 40, false);
            
            encoder0.encode(this.remoteFrameInterfaces, 48, false);
            
            encoder0.encode(this.remoteMainFrameInterfaces, 56, false);
        }
    }
