...
class RemoteFrame_Internal {
    ...
    private static final int CREATE_REMOTE_CHILD_ORDINAL = 32;
...
RemoteFrameToken token, FrameToken openerFrameToken, int treeScopeType, FrameReplicationState replicationState, org.chromium.mojo_base.mojom.UnguessableToken devtoolsFrameToken, RemoteFrameInterfacesFromBrowser remoteFrameInterfaces) {
            ...
            try {
                ...
                switch(header.getType()) {
                    ...
                    case CREATE_REMOTE_CHILD_ORDINAL: {
                        ...
                        getImpl().createRemoteChild(data.token, data.openerFrameToken, data.treeScopeType, data.replicationState, data.devtoolsFrameToken, data.remoteFrameInterfaces);
                        return true;
                    }
