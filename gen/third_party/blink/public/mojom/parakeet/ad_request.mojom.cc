...
AdProperties::AdProperties(
    const std::string& width_in,
    const std::string& height_in,
    const std::string& slot_in,
    const std::string& lang_in,
    const std::string& ad_type_in,
    double bid_floor_in)
...
bool StructTraits<::blink::mojom::AdProperties::DataView, ::blink::mojom::AdPropertiesPtr>::Read(
    ::blink::mojom::AdProperties::DataView input,
    ::blink::mojom::AdPropertiesPtr* output) {
  bool success = true;
...
bool StructTraits<::blink::mojom::AdGeolocation::DataView, ::blink::mojom::AdGeolocationPtr>::Read(
    ::blink::mojom::AdGeolocation::DataView input,
    ::blink::mojom::AdGeolocationPtr* output) {
  bool success = true;
...
bool StructTraits<::blink::mojom::AdTargeting::DataView, ::blink::mojom::AdTargetingPtr>::Read(
    ::blink::mojom::AdTargeting::DataView input,
    ::blink::mojom::AdTargetingPtr* output) {
  bool success = true;
...
bool StructTraits<::blink::mojom::AdRequestConfig::DataView, ::blink::mojom::AdRequestConfigPtr>::Read(
    ::blink::mojom::AdRequestConfig::DataView input,
    ::blink::mojom::AdRequestConfigPtr* output) {
  bool success = true;
