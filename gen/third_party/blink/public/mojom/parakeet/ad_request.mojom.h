 ...
 public:
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        AdGeolocation::DataView, std::vector<uint8_t>>(input);
  }
...
class BLINK_COMMON_EXPORT AdProperties {
 public:
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        AdProperties::DataView, std::vector<uint8_t>>(input);
  }
...
AdTargeting& operator=(const AdTargeting&) = delete;
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        AdTargeting::DataView, std::vector<uint8_t>>(input);
  }
...
AdRequestConfig& operator=(const AdRequestConfig&) = delete;
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        AdRequestConfig::DataView, std::vector<uint8_t>>(input);
  }
...
struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::AdProperties::DataView,
  ...
  static const decltype(::blink::mojom::AdProperties::width)& width(
      const ::blink::mojom::AdPropertiesPtr& input) {
    return input->width;
  }

  static const decltype(::blink::mojom::AdProperties::height)& height(
      const ::blink::mojom::AdPropertiesPtr& input) {
    return input->height;
  }

  static const decltype(::blink::mojom::AdProperties::slot)& slot(
      const ::blink::mojom::AdPropertiesPtr& input) {
    return input->slot;
  }

  static const decltype(::blink::mojom::AdProperties::lang)& lang(
      const ::blink::mojom::AdPropertiesPtr& input) {
    return input->lang;
  }

  static const decltype(::blink::mojom::AdProperties::ad_type)& ad_type(
      const ::blink::mojom::AdPropertiesPtr& input) {
    return input->ad_type;
  }

  static decltype(::blink::mojom::AdProperties::bid_floor) bid_floor(
      const ::blink::mojom::AdPropertiesPtr& input) {
...
struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::AdGeolocation::DataView,
  ...
  static decltype(::blink::mojom::AdGeolocation::latitude) latitude(
      const ::blink::mojom::AdGeolocationPtr& input) {
    return input->latitude;
  }

  static decltype(::blink::mojom::AdGeolocation::longitude) longitude(
      const ::blink::mojom::AdGeolocationPtr& input) {
...
struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::AdTargeting::DataView,
  ...
  static const decltype(::blink::mojom::AdTargeting::interests)& interests(
      const ::blink::mojom::AdTargetingPtr& input) {
    return input->interests;
  }

  static const decltype(::blink::mojom::AdTargeting::geolocation)& geolocation(
      const ::blink::mojom::AdTargetingPtr& input) {
...
struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::AdRequestConfig::DataView,
  ...
  static const decltype(::blink::mojom::AdRequestConfig::ad_request_url)& ad_request_url(
      const ::blink::mojom::AdRequestConfigPtr& input) {
    return input->ad_request_url;
  }

  static const decltype(::blink::mojom::AdRequestConfig::ad_properties)& ad_properties(
      const ::blink::mojom::AdRequestConfigPtr& input) {
    return input->ad_properties;
  }

  static const decltype(::blink::mojom::AdRequestConfig::publisher_code)& publisher_code(
      const ::blink::mojom::AdRequestConfigPtr& input) {
    return input->publisher_code;
  }

  static const decltype(::blink::mojom::AdRequestConfig::targeting)& targeting(
      const ::blink::mojom::AdRequestConfigPtr& input) {
  ...
  static const decltype(::blink::mojom::AdRequestConfig::fallback_source)& fallback_source(
      const ::blink::mojom::AdRequestConfigPtr& input) {
