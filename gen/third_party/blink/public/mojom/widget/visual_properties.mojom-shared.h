...
class VisualPropertiesDataView {
 public:
  ...
  template <typename UserType>
  [[nodiscard]] bool ReadNewSize(UserType* output) {
...
struct Serializer<::blink::mojom::VisualPropertiesDataView, MaybeConstUserType> {
  ...
  static void Serialize(
    ...
    mojo::internal::MessageFragment<
        typename decltype(fragment->new_size)::BaseType> new_size_fragment(
            fragment.message());
    mojo::internal::Serialize<::gfx::mojom::SizeDataView>(
        in_new_size, new_size_fragment);
    fragment->new_size.Set(
        new_size_fragment.is_null() ? nullptr : new_size_fragment.data());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        fragment->new_size.is_null(),
        mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER,
    ...
    mojo::internal::Serialize<::gfx::mojom::RectDataView>(
        in_compositor_viewport_pixel_rect, compositor_viewport_pixel_rect_fragment);
    ...
    mojo::internal::Serialize<::cc::mojom::BrowserControlsParamsDataView>(
        in_browser_controls_params, browser_controls_params_fragment);
    ...
    mojo::internal::Serialize<::blink::mojom::DisplayMode>(
        Traits::display_mode(input), &fragment->display_mode);
    ...
    mojo::internal::MessageFragment<
        typename decltype(fragment->window_controls_overlay_rect)::BaseType> window_controls_overlay_rect_fragment(
            fragment.message());
    mojo::internal::Serialize<::gfx::mojom::RectDataView>(
        in_window_controls_overlay_rect, window_controls_overlay_rect_fragment);
