...
class PLATFORM_EXPORT WidgetHostInterceptorForTesting : public WidgetHost {
  ...
  void CreateFrameSink(::mojo::PendingReceiver<::viz::mojom::blink::CompositorFrameSink> compositor_frame_sink_receiver, ::mojo::PendingRemote<::viz::mojom::blink::CompositorFrameSinkClient> compositor_frame_sink_client) override;
...
class PLATFORM_EXPORT WidgetInterceptorForTesting : public Widget {
  ...
  void GetWidgetInputHandler(::mojo::PendingReceiver<::blink::mojom::blink::WidgetInputHandler> request, ::mojo::PendingRemote<::blink::mojom::blink::WidgetInputHandlerHost> host) override;
