...
(function() {
  ...
  UntrustworthyContextMenuParams.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 176, FieldRendererId, true);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  UntrustworthyContextMenuParams.encodedSize = codec.kStructHeaderSize + 184;
