...
// with not having this data in traces there.
  ...
  virtual void RunURLSelectionOperationOnWorklet(const std::string& name, std::vector<SharedStorageUrlWithMetadataPtr> urls_with_metadata, const std::vector<uint8_t>& serialized_data, RunURLSelectionOperationOnWorkletCallback callback) = 0;
...
class BLINK_COMMON_EXPORT SharedStorageDocumentServiceProxy
 ...
 public:
  ...
  void RunURLSelectionOperationOnWorklet(const std::string& name, std::vector<SharedStorageUrlWithMetadataPtr> urls_with_metadata, const std::vector<uint8_t>& serialized_data, RunURLSelectionOperationOnWorkletCallback callback) final;
...
struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::SharedStorageKeyArgument::DataView,
  ...
  static const decltype(::blink::mojom::SharedStorageKeyArgument::data)& data(
      const ::blink::mojom::SharedStorageKeyArgumentPtr& input) {
    return input->data;
  }
...
struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::SharedStorageValueArgument::DataView,
  ...
  static const decltype(::blink::mojom::SharedStorageValueArgument::data)& data(
      const ::blink::mojom::SharedStorageValueArgumentPtr& input) {
    return input->data;
  }
