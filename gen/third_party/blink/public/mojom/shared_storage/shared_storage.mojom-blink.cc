...
void SharedStorageDocumentServiceProxy::AddModuleOnWorklet(
    const ::blink::KURL& in_script_source_url, AddModuleOnWorkletCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void SharedStorageDocumentServiceProxy::RunOperationOnWorklet(
    const WTF::String& in_name, const WTF::Vector<uint8_t>& in_serialized_data, RunOperationOnWorkletCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void SharedStorageDocumentServiceProxy::RunURLSelectionOperationOnWorklet(
    const WTF::String& in_name, WTF::Vector<SharedStorageUrlWithMetadataPtr> in_urls_with_metadata, const WTF::Vector<uint8_t>& in_serialized_data, RunURLSelectionOperationOnWorkletCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
class SharedStorageDocumentService_RunURLSelectionOperationOnWorklet_ProxyToResponder : public ::mojo::internal::ProxyToResponder {
 ...
 private:
  ...
  void Run(
      bool in_success, const WTF::String& in_error_message, const ::blink::KURL& in_opaque_url);
};
...
std::move(p_script_source_url), std::move(callback));
    ...
    case internal::kSharedStorageDocumentService_RunOperationOnWorklet_Name: {
      ...
      bool success = true;
      WTF::String p_name{};
      WTF::Vector<uint8_t> p_serialized_data{};
...
void SharedStorageDocumentServiceInterceptorForTesting::RunOperationOnWorklet(const WTF::String& name, const WTF::Vector<uint8_t>& serialized_data, RunOperationOnWorkletCallback callback) {
  GetForwardingInterface()->RunOperationOnWorklet(std::move(name), std::move(serialized_data), std::move(callback));
}
void SharedStorageDocumentServiceInterceptorForTesting::RunURLSelectionOperationOnWorklet(const WTF::String& name, WTF::Vector<SharedStorageUrlWithMetadataPtr> urls_with_metadata, const WTF::Vector<uint8_t>& serialized_data, RunURLSelectionOperationOnWorkletCallback callback) {
...
,
             WTF::String* out_error_message
,
             ::blink::KURL* out_opaque_url
,
             bool success,
             const WTF::String& error_message,
             const ::blink::KURL& opaque_url) {*out_success = std::move(success);*out_error_message = std::move(error_message);*out_opaque_url = std::move(opaque_url);
            loop->Quit();
          },
          &loop,
          out_success,
