...
void DomStorageProxy::BindSessionStorageArea(
    const ::blink::BlinkStorageKey& in_storage_key, const ::blink::LocalFrameToken& in_local_frame_token, const WTF::String& in_namespace_id, ::mojo::PendingReceiver<::blink::mojom::blink::StorageArea> in_session_namespace) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void DomStorageInterceptorForTesting::BindSessionStorageArea(const ::blink::BlinkStorageKey& storage_key, const ::blink::LocalFrameToken& local_frame_token, const WTF::String& namespace_id, ::mojo::PendingReceiver<::blink::mojom::blink::StorageArea> session_namespace) {
