...
class PLATFORM_EXPORT DomStorageInterceptorForTesting : public DomStorage {
  ...
  void OpenLocalStorage(const ::blink::BlinkStorageKey& storage_key, const ::blink::LocalFrameToken& local_frame_token, ::mojo::PendingReceiver<::blink::mojom::blink::StorageArea> area) override;
  ...
  void BindSessionStorageArea(const ::blink::BlinkStorageKey& storage_key, const ::blink::LocalFrameToken& local_frame_token, const WTF::String& namespace_id, ::mojo::PendingReceiver<::blink::mojom::blink::StorageArea> session_namespace) override;
};
