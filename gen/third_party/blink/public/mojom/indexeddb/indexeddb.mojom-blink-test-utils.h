...
class MODULES_EXPORT IDBDatabaseInterceptorForTesting : public IDBDatabase {
  ...
  void BatchGetAll(int64_t transaction_id, int64_t object_store_id, int64_t index_id, WTF::Vector<IDBKeyRangePtr> key_ranges, uint32_t max_count, BatchGetAllCallback callback) override;
