...
class BLINK_COMMON_EXPORT IDBDatabaseInterceptorForTesting : public IDBDatabase {
  ...
  void BatchGetAll(int64_t transaction_id, int64_t object_store_id, int64_t index_id, const std::vector<::blink::IndexedDBKeyRange>& key_ranges, uint32_t max_count, BatchGetAllCallback callback) override;
  ...
  void CreateIndex(int64_t transaction_id, int64_t object_store_id, int64_t index_id, const ::std::u16string& name, const ::blink::IndexedDBKeyPath& key_path, bool unique, bool multi_entry) override;
...
class BLINK_COMMON_EXPORT IDBFactoryInterceptorForTesting : public IDBFactory {
  ...
  void Open(::mojo::PendingAssociatedRemote<IDBCallbacks> pending_callbacks, ::mojo::PendingAssociatedRemote<IDBDatabaseCallbacks> database_callbacks, const ::std::u16string& name, int64_t version, ::mojo::PendingAssociatedReceiver<IDBTransaction> version_change_transaction_receiver, int64_t transaction_id) override;
