...
// with not having this data in traces there.
  ...
  virtual void QueuePermissionsPolicyViolationReport(const ::GURL& url, const std::string& policy_id, const std::string& disposition, const absl::optional<std::string>& message, const absl::optional<std::string>& source_file, int32_t line_number, int32_t column_number) = 0;
...
class BLINK_COMMON_EXPORT ReportingServiceProxyProxy
 ...
 public:
  ...
  void QueuePermissionsPolicyViolationReport(const ::GURL& url, const std::string& policy_id, const std::string& disposition, const absl::optional<std::string>& message, const absl::optional<std::string>& source_file, int32_t line_number, int32_t column_number) final;
