...
class BLINK_COMMON_EXPORT WebPreferences {
 public:
  ...
  WebPreferences(
      const base::flat_map<std::string, ::std::u16string>& standard_font_family_map,
      const base::flat_map<std::string, ::std::u16string>& fixed_font_family_map,
      const base::flat_map<std::string, ::std::u16string>& serif_font_family_map,
      const base::flat_map<std::string, ::std::u16string>& sans_serif_font_family_map,
      const base::flat_map<std::string, ::std::u16string>& cursive_font_family_map,
      const base::flat_map<std::string, ::std::u16string>& fantasy_font_family_map,
      const base::flat_map<std::string, ::std::u16string>& math_font_family_map,
      ...
      const ::GURL& web_app_scope,
      float font_scale_factor,
      float device_scale_adjustment,
      bool force_enable_zoom,
      const ::GURL& default_video_poster_url,
      ...
      const base::flat_map<EffectiveConnectionType, int32_t>& lazy_frame_loading_distance_thresholds_px,
      const base::flat_map<EffectiveConnectionType, int32_t>& lazy_image_loading_distance_thresholds_px,
...
template <>
struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::WebPreferences::DataView,
  ...
  static decltype(::blink::mojom::WebPreferences::xslt_enabled) xslt_enabled(
      const ::blink::mojom::WebPreferencesPtr& input) {
  ...
  static decltype(::blink::mojom::WebPreferences::databases_enabled) databases_enabled(
      const ::blink::mojom::WebPreferencesPtr& input) {
  ...
  static decltype(::blink::mojom::WebPreferences::pepper_3d_enabled) pepper_3d_enabled(
      const ::blink::mojom::WebPreferencesPtr& input) {
  ...
  static decltype(::blink::mojom::WebPreferences::password_echo_enabled) password_echo_enabled(
      const ::blink::mojom::WebPreferencesPtr& input) {
  ...
  static decltype(::blink::mojom::WebPreferences::threaded_scrolling_enabled) threaded_scrolling_enabled(
      const ::blink::mojom::WebPreferencesPtr& input) {
  ...
  static decltype(::blink::mojom::WebPreferences::navigate_on_drag_drop) navigate_on_drag_drop(
      const ::blink::mojom::WebPreferencesPtr& input) {
  ...
  static decltype(::blink::mojom::WebPreferences::text_autosizing_enabled) text_autosizing_enabled(
      const ::blink::mojom::WebPreferencesPtr& input) {
  ...
  static decltype(::blink::mojom::WebPreferences::font_scale_factor) font_scale_factor(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->font_scale_factor;
  }

  static decltype(::blink::mojom::WebPreferences::device_scale_adjustment) device_scale_adjustment(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->device_scale_adjustment;
  }

  static decltype(::blink::mojom::WebPreferences::force_enable_zoom) force_enable_zoom(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->force_enable_zoom;
  }

  static const decltype(::blink::mojom::WebPreferences::default_video_poster_url)& default_video_poster_url(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->default_video_poster_url;
  }

  static decltype(::blink::mojom::WebPreferences::support_deprecated_target_density_dpi) support_deprecated_target_density_dpi(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->support_deprecated_target_density_dpi;
  }

  static decltype(::blink::mojom::WebPreferences::use_legacy_background_size_shorthand_behavior) use_legacy_background_size_shorthand_behavior(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->use_legacy_background_size_shorthand_behavior;
  }

  static decltype(::blink::mojom::WebPreferences::wide_viewport_quirk) wide_viewport_quirk(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->wide_viewport_quirk;
  }

  static decltype(::blink::mojom::WebPreferences::use_wide_viewport) use_wide_viewport(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->use_wide_viewport;
  }

  static decltype(::blink::mojom::WebPreferences::force_zero_layout_height) force_zero_layout_height(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->force_zero_layout_height;
  }

  static decltype(::blink::mojom::WebPreferences::viewport_meta_merge_content_quirk) viewport_meta_merge_content_quirk(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->viewport_meta_merge_content_quirk;
  }

  static decltype(::blink::mojom::WebPreferences::viewport_meta_non_user_scalable_quirk) viewport_meta_non_user_scalable_quirk(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->viewport_meta_non_user_scalable_quirk;
  }

  static decltype(::blink::mojom::WebPreferences::viewport_meta_zero_values_quirk) viewport_meta_zero_values_quirk(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->viewport_meta_zero_values_quirk;
  }

  static decltype(::blink::mojom::WebPreferences::clobber_user_agent_initial_scale_quirk) clobber_user_agent_initial_scale_quirk(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->clobber_user_agent_initial_scale_quirk;
  }

  static decltype(::blink::mojom::WebPreferences::ignore_main_frame_overflow_hidden_quirk) ignore_main_frame_overflow_hidden_quirk(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->ignore_main_frame_overflow_hidden_quirk;
  }

  static decltype(::blink::mojom::WebPreferences::report_screen_size_in_physical_pixels_quirk) report_screen_size_in_physical_pixels_quirk(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->report_screen_size_in_physical_pixels_quirk;
  }

  static decltype(::blink::mojom::WebPreferences::reuse_global_for_unowned_main_frame) reuse_global_for_unowned_main_frame(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->reuse_global_for_unowned_main_frame;
  }

  static decltype(::blink::mojom::WebPreferences::spellcheck_enabled_by_default) spellcheck_enabled_by_default(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->spellcheck_enabled_by_default;
  }

  static decltype(::blink::mojom::WebPreferences::video_fullscreen_orientation_lock_enabled) video_fullscreen_orientation_lock_enabled(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->video_fullscreen_orientation_lock_enabled;
  }

  static decltype(::blink::mojom::WebPreferences::video_rotate_to_fullscreen_enabled) video_rotate_to_fullscreen_enabled(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->video_rotate_to_fullscreen_enabled;
  }

  static decltype(::blink::mojom::WebPreferences::embedded_media_experience_enabled) embedded_media_experience_enabled(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->embedded_media_experience_enabled;
  }

  static decltype(::blink::mojom::WebPreferences::css_hex_alpha_color_enabled) css_hex_alpha_color_enabled(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->css_hex_alpha_color_enabled;
  }

  static decltype(::blink::mojom::WebPreferences::scroll_top_left_interop_enabled) scroll_top_left_interop_enabled(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->scroll_top_left_interop_enabled;
  }

  static decltype(::blink::mojom::WebPreferences::disable_accelerated_small_canvases) disable_accelerated_small_canvases(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->disable_accelerated_small_canvases;
  }

  static decltype(::blink::mojom::WebPreferences::disable_webauthn) disable_webauthn(
      const ::blink::mojom::WebPreferencesPtr& input) {
