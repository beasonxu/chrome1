...
struct blink_mojom_internal_NativeIOErrorType_DataHashFn {
  ...
  static bool Equal(const ::blink::mojom::NativeIOErrorType& left, const ::blink::mojom::NativeIOErrorType& right) {
    return left == right;
  }
...
template <>
struct HashTraits<::blink::mojom::NativeIOErrorType>
    : public GenericHashTraits<::blink::mojom::NativeIOErrorType> {
  static_assert(true,
  ...
  static void ConstructDeletedValue(::blink::mojom::NativeIOErrorType& slot, bool) {
    slot = static_cast<::blink::mojom::NativeIOErrorType>(-1000001);
  }
  static bool IsDeletedValue(const ::blink::mojom::NativeIOErrorType& value) {
    return value == static_cast<::blink::mojom::NativeIOErrorType>(-1000001);
  }
};
}  // namespace WTF
...
// with not having this data in traces there.
  ...
  virtual bool OpenFile(const WTF::String& name, ::mojo::PendingReceiver<NativeIOFileHost> file_host_receiver, ::base::File* out_backing_file, uint64_t* out_backing_file_size, NativeIOErrorPtr* out_open_error);
...
class PLATFORM_EXPORT NativeIOHostProxy
 ...
 public:
  ...
  bool OpenFile(const WTF::String& name, ::mojo::PendingReceiver<NativeIOFileHost> file_host_receiver, ::base::File* out_backing_file, uint64_t* out_backing_file_size, NativeIOErrorPtr* out_open_error) final;
 ...
 public:
  ...
  static WTF::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        NativeIOError::DataView, WTF::Vector<uint8_t>>(input);
  }
...
template <>
struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::NativeIOError::DataView,
                                         ::blink::mojom::blink::NativeIOErrorPtr> {
  ...
  static decltype(::blink::mojom::blink::NativeIOError::type) type(
      const ::blink::mojom::blink::NativeIOErrorPtr& input) {
    return input->type;
  }

  static const decltype(::blink::mojom::blink::NativeIOError::message)& message(
      const ::blink::mojom::blink::NativeIOErrorPtr& input) {
