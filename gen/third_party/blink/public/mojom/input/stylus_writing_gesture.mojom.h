...
template <>
struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::StylusWritingGestureData::DataView,
  ...
  static const decltype(::blink::mojom::StylusWritingGestureData::start_point)& start_point(
      const ::blink::mojom::StylusWritingGestureDataPtr& input) {
    return input->start_point;
  }

  static const decltype(::blink::mojom::StylusWritingGestureData::end_point)& end_point(
      const ::blink::mojom::StylusWritingGestureDataPtr& input) {
