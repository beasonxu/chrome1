...
bool SpellCheckSuggestion_Data::Validate(
  ...
  [[maybe_unused]] const SpellCheckSuggestion_Data* object =
      static_cast<const SpellCheckSuggestion_Data*>(data);
...
bool TextSuggestion_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const TextSuggestion_Data* object =
      static_cast<const TextSuggestion_Data*>(data);
