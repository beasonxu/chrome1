...
(function() {
  ...
  SyncCompositorDemandDrawHwParams.prototype.initDefaults_ = function() {
    ...
    this.needNewLocalSurfaceId = false;
  };
  ...
  SyncCompositorDemandDrawHwParams.encodedSize = codec.kStructHeaderSize + 32;
  ...
  SyncCompositorDemandDrawHwParams.decode = function(decoder) {
    ...
    val.needNewLocalSurfaceId = (packed >> 0) & 1 ? true : false;
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  SyncCompositorDemandDrawHwParams.encode = function(encoder, val) {
    ...
    packed = 0;
    packed |= (val.needNewLocalSurfaceId & 1) << 0
  ...
  SyncCompositorCommonRendererParams.encode = function(encoder, val) {
    ...
    encoder.encodeStructPointer(geometry$.PointF, val.totalScrollOffset);
    encoder.encodeStructPointer(geometry$.PointF, val.maxScrollOffset);
  ...
  function SynchronousCompositor_OnCompositorFrameTransitionDirectiveProcessed_Params(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  SynchronousCompositor_OnCompositorFrameTransitionDirectiveProcessed_Params.prototype.initDefaults_ = function() {
    this.layerTreeFrameSinkId = 0;
    this.sequenceId = 0;
  };
  SynchronousCompositor_OnCompositorFrameTransitionDirectiveProcessed_Params.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  SynchronousCompositor_OnCompositorFrameTransitionDirectiveProcessed_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  SynchronousCompositor_OnCompositorFrameTransitionDirectiveProcessed_Params.encodedSize = codec.kStructHeaderSize + 8;

  SynchronousCompositor_OnCompositorFrameTransitionDirectiveProcessed_Params.decode = function(decoder) {
    var packed;
    var val = new SynchronousCompositor_OnCompositorFrameTransitionDirectiveProcessed_Params();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.layerTreeFrameSinkId =
        decoder.decodeStruct(codec.Uint32);
  ...
  SynchronousCompositor_OnCompositorFrameTransitionDirectiveProcessed_Params.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(SynchronousCompositor_OnCompositorFrameTransitionDirectiveProcessed_Params.encodedSize);
    encoder.writeUint32(0);
    encoder.encodeStruct(codec.Uint32, val.layerTreeFrameSinkId);
  ...
  SynchronousCompositor_SetScroll_Params.encode = function(encoder, val) {
    ...
    encoder.writeUint32(0);
    encoder.encodeStructPointer(geometry$.PointF, val.offset);
  };
  ...
  var kSynchronousCompositor_OnCompositorFrameTransitionDirectiveProcessed_Name = 9;
  var kSynchronousCompositor_SetScroll_Name = 10;
  var kSynchronousCompositor_BeginFrame_Name = 11;
  var kSynchronousCompositor_SetBeginFrameSourcePaused_Name = 12;
  ...
  SynchronousCompositorPtr.prototype.onCompositorFrameTransitionDirectiveProcessed = function() {
    return SynchronousCompositorProxy.prototype.onCompositorFrameTransitionDirectiveProcessed
        .apply(this.ptr.getProxy(), arguments);
  };

  SynchronousCompositorProxy.prototype.onCompositorFrameTransitionDirectiveProcessed = function(layerTreeFrameSinkId, sequenceId) {
    var params_ = new SynchronousCompositor_OnCompositorFrameTransitionDirectiveProcessed_Params();
    params_.layerTreeFrameSinkId = layerTreeFrameSinkId;
    params_.sequenceId = sequenceId;
    var builder = new codec.MessageV0Builder(
        kSynchronousCompositor_OnCompositorFrameTransitionDirectiveProcessed_Name,
        codec.align(SynchronousCompositor_OnCompositorFrameTransitionDirectiveProcessed_Params.encodedSize));
    builder.encodeStruct(SynchronousCompositor_OnCompositorFrameTransitionDirectiveProcessed_Params, params_);
    var message = builder.finish();
    this.receiver_.accept(message);
  };
  ...
  SynchronousCompositorStub.prototype.onCompositorFrameTransitionDirectiveProcessed = function(layerTreeFrameSinkId, sequenceId) {
    return this.delegate_ && this.delegate_.onCompositorFrameTransitionDirectiveProcessed && this.delegate_.onCompositorFrameTransitionDirectiveProcessed(layerTreeFrameSinkId, sequenceId);
  }
  ...
  SynchronousCompositorStub.prototype.accept = function(message) {
    ...
    case kSynchronousCompositor_ReclaimResources_Name:
      ...
      return true;
    case kSynchronousCompositor_OnCompositorFrameTransitionDirectiveProcessed_Name:
      var params = reader.decodeStruct(SynchronousCompositor_OnCompositorFrameTransitionDirectiveProcessed_Params);
      this.onCompositorFrameTransitionDirectiveProcessed(params.layerTreeFrameSinkId, params.sequenceId);
      return true;
  ...
  function validateSynchronousCompositorRequest(messageValidator) {
    ...
    switch (message.getName()) {
      ...
      case kSynchronousCompositor_OnCompositorFrameTransitionDirectiveProcessed_Name:
        if (!message.expectsResponse() && !message.isResponse())
          paramsClass = SynchronousCompositor_OnCompositorFrameTransitionDirectiveProcessed_Params;
      break;
      case kSynchronousCompositor_SetScroll_Name:
        if (!message.expectsResponse() && !message.isResponse())
