...
StreamDevicesSet::StreamDevicesSet(
    WTF::Vector<StreamDevicesPtr> stream_devices_in)
...
void MediaStreamDeviceObserverInterceptorForTesting::OnDeviceRequestStateChange(const WTF::String& label, const ::blink::MediaStreamDevice& device, MediaStreamStateChange new_state) {
...
void MediaStreamDispatcherHostAsyncWaiter::GenerateStreams(
    int32_t request_id, const ::blink::StreamControls& controls, bool user_gesture, StreamSelectionInfoPtr audio_stream_selection_info, MediaStreamRequestResult* out_result, WTF::String* out_label, StreamDevicesSetPtr* out_stream_devices, bool* out_pan_tilt_zoom_allowed) {
  base::RunLoop loop;
