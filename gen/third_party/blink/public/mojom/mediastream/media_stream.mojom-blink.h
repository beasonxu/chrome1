...
struct blink_mojom_internal_MediaStreamStateChange_DataHashFn {
  ...
  static bool Equal(const ::blink::mojom::MediaStreamStateChange& left, const ::blink::mojom::MediaStreamStateChange& right) {
    return left == right;
  }
  static const bool safe_to_compare_to_empty_or_deleted = true;
};
...
template <>
struct HashTraits<::blink::mojom::MediaStreamStateChange>
    : public GenericHashTraits<::blink::mojom::MediaStreamStateChange> {
  static_assert(true,
                "-1000000 is a reserved enum value");
  static_assert(true,
                "-1000001 is a reserved enum value");
  ...
  static void ConstructDeletedValue(::blink::mojom::MediaStreamStateChange& slot, bool) {
    slot = static_cast<::blink::mojom::MediaStreamStateChange>(-1000001);
  }
  static bool IsDeletedValue(const ::blink::mojom::MediaStreamStateChange& value) {
    return value == static_cast<::blink::mojom::MediaStreamStateChange>(-1000001);
  }
};
}  // namespace WTF
...
class PLATFORM_EXPORT GetOpenDeviceResponse {
 public:
  ...
  static WTF::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        GetOpenDeviceResponse::DataView, WTF::Vector<uint8_t>>(input);
  }
...
class PLATFORM_EXPORT StreamDevices {
 public:
  ...
  static WTF::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        StreamDevices::DataView, WTF::Vector<uint8_t>>(input);
  }
...
StreamDevicesSet& operator=(const StreamDevicesSet&) = delete;
  ...
  static WTF::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        StreamDevicesSet::DataView, WTF::Vector<uint8_t>>(input);
  }
