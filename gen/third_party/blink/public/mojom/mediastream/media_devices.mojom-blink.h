...
// with not having this data in traces there.
  ...
  using EnumerateDevicesCallback = base::OnceCallback<void(const WTF::Vector<WTF::Vector<::blink::WebMediaDeviceInfo>>&, WTF::Vector<VideoInputDeviceCapabilitiesPtr>, WTF::Vector<AudioInputDeviceCapabilitiesPtr>)>;
