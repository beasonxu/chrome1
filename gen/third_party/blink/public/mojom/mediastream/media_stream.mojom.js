...
(function() {
  ...
  StreamControls.decode = function(decoder) {
    ...
    val.requestPanTiltZoomPermission = (packed >> 3) & 1 ? true : false;
    val.requestAllScreens = (packed >> 4) & 1 ? true : false;
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  StreamControls.encode = function(encoder, val) {
    ...
    packed |= (val.requestPanTiltZoomPermission & 1) << 3
    packed |= (val.requestAllScreens & 1) << 4
    encoder.writeUint8(packed);
    encoder.skip(1);
    encoder.skip(1);
    encoder.skip(1);
  ...
  var kMediaStreamDispatcherHost_GetOpenDevice_Name = 7;
  var kMediaStreamDispatcherHost_KeepDeviceAliveForTransfer_Name = 8;
