...
bool SharedFile_Data::Validate(
  ...
  [[maybe_unused]] const SharedFile_Data* object =
      static_cast<const SharedFile_Data*>(data);
...
bool ShareService_Share_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const ShareService_Share_Params_Data* object =
      static_cast<const ShareService_Share_Params_Data*>(data);
...
bool ShareService_Share_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const ShareService_Share_ResponseParams_Data* object =
      static_cast<const ShareService_Share_ResponseParams_Data*>(data);
