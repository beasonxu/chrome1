 ...
 public:
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        FrameAdEvidence::DataView, std::vector<uint8_t>>(input);
  }
...
template <>
struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::FrameAdEvidence::DataView,
                                         ::blink::mojom::FrameAdEvidencePtr> {
  ...
  static decltype(::blink::mojom::FrameAdEvidence::is_complete) is_complete(
      const ::blink::mojom::FrameAdEvidencePtr& input) {
    return input->is_complete;
  }

  static decltype(::blink::mojom::FrameAdEvidence::parent_is_ad) parent_is_ad(
      const ::blink::mojom::FrameAdEvidencePtr& input) {
    return input->parent_is_ad;
  }

  static decltype(::blink::mojom::FrameAdEvidence::latest_filter_list_result) latest_filter_list_result(
      const ::blink::mojom::FrameAdEvidencePtr& input) {
  ...
  static decltype(::blink::mojom::FrameAdEvidence::created_by_ad_script) created_by_ad_script(
      const ::blink::mojom::FrameAdEvidencePtr& input) {
