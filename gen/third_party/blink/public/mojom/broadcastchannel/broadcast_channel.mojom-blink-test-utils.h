...
class CORE_EXPORT BroadcastChannelProviderInterceptorForTesting : public BroadcastChannelProvider {
  ...
  void ConnectToChannel(const WTF::String& name, ::mojo::PendingAssociatedRemote<BroadcastChannelClient> client, ::mojo::PendingAssociatedReceiver<BroadcastChannelClient> connection) override;
};
