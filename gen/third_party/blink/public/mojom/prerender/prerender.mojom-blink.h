...
struct blink_mojom_internal_PrerenderTriggerType_DataHashFn {
  ...
  static bool Equal(const ::blink::mojom::PrerenderTriggerType& left, const ::blink::mojom::PrerenderTriggerType& right) {
    return left == right;
  }
...
template <>
struct HashTraits<::blink::mojom::PrerenderTriggerType>
    : public GenericHashTraits<::blink::mojom::PrerenderTriggerType> {
  static_assert(true,
  ...
  static void ConstructDeletedValue(::blink::mojom::PrerenderTriggerType& slot, bool) {
    slot = static_cast<::blink::mojom::PrerenderTriggerType>(-1000001);
  }
  static bool IsDeletedValue(const ::blink::mojom::PrerenderTriggerType& value) {
    return value == static_cast<::blink::mojom::PrerenderTriggerType>(-1000001);
  }
};
}  // namespace WTF
...
class PLATFORM_EXPORT NoStatePrefetchProcessor
...
struct PLATFORM_EXPORT StructTraits<::blink::mojom::blink::PrerenderAttributes::DataView,
  ...
  static decltype(::blink::mojom::blink::PrerenderAttributes::trigger_type) trigger_type(
      const ::blink::mojom::blink::PrerenderAttributesPtr& input) {
