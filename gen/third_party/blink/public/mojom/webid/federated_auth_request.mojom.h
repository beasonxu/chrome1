...
// with not having this data in traces there.
  ...
  using RequestTokenCallback = base::OnceCallback<void(RequestTokenStatus, const absl::optional<std::string>&)>;
...
class BLINK_COMMON_EXPORT IdentityProvider {
 public:
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        IdentityProvider::DataView, std::vector<uint8_t>>(input);
  }
...
template <>
struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::IdentityProvider::DataView,
                                         ::blink::mojom::IdentityProviderPtr> {
  ...
  static const decltype(::blink::mojom::IdentityProvider::config_url)& config_url(
      const ::blink::mojom::IdentityProviderPtr& input) {
    return input->config_url;
  }

  static const decltype(::blink::mojom::IdentityProvider::client_id)& client_id(
      const ::blink::mojom::IdentityProviderPtr& input) {
    return input->client_id;
  }

  static const decltype(::blink::mojom::IdentityProvider::nonce)& nonce(
      const ::blink::mojom::IdentityProviderPtr& input) {
    return input->nonce;
  }
