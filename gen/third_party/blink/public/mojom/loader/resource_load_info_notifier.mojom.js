...
(function() {
  ...
  function ResourceLoadInfoNotifier_NotifyUpdateUserGestureCarryoverInfo_Params(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  ResourceLoadInfoNotifier_NotifyUpdateUserGestureCarryoverInfo_Params.prototype.initDefaults_ = function() {
  };
  ResourceLoadInfoNotifier_NotifyUpdateUserGestureCarryoverInfo_Params.prototype.initFields_ = function(fields) {
  ...
  ResourceLoadInfoNotifier_NotifyUpdateUserGestureCarryoverInfo_Params.validate = function(messageValidator, offset) {
    var err;
  ...
  ResourceLoadInfoNotifier_NotifyUpdateUserGestureCarryoverInfo_Params.encodedSize = codec.kStructHeaderSize + 0;

  ResourceLoadInfoNotifier_NotifyUpdateUserGestureCarryoverInfo_Params.decode = function(decoder) {
    var packed;
    var val = new ResourceLoadInfoNotifier_NotifyUpdateUserGestureCarryoverInfo_Params();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    return val;
  };

  ResourceLoadInfoNotifier_NotifyUpdateUserGestureCarryoverInfo_Params.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(ResourceLoadInfoNotifier_NotifyUpdateUserGestureCarryoverInfo_Params.encodedSize);
  ...
  var kResourceLoadInfoNotifier_NotifyUpdateUserGestureCarryoverInfo_Name = 0;
  var kResourceLoadInfoNotifier_NotifyResourceRedirectReceived_Name = 1;
  var kResourceLoadInfoNotifier_NotifyResourceResponseReceived_Name = 2;
  var kResourceLoadInfoNotifier_NotifyResourceTransferSizeUpdated_Name = 3;
  var kResourceLoadInfoNotifier_NotifyResourceLoadCompleted_Name = 4;
  var kResourceLoadInfoNotifier_NotifyResourceLoadCanceled_Name = 5;
  var kResourceLoadInfoNotifier_Clone_Name = 6;
  ...
  ResourceLoadInfoNotifierPtr.prototype.notifyUpdateUserGestureCarryoverInfo = function() {
    return ResourceLoadInfoNotifierProxy.prototype.notifyUpdateUserGestureCarryoverInfo
        .apply(this.ptr.getProxy(), arguments);
  };

  ResourceLoadInfoNotifierProxy.prototype.notifyUpdateUserGestureCarryoverInfo = function() {
    var params_ = new ResourceLoadInfoNotifier_NotifyUpdateUserGestureCarryoverInfo_Params();
    var builder = new codec.MessageV0Builder(
        kResourceLoadInfoNotifier_NotifyUpdateUserGestureCarryoverInfo_Name,
        codec.align(ResourceLoadInfoNotifier_NotifyUpdateUserGestureCarryoverInfo_Params.encodedSize));
    builder.encodeStruct(ResourceLoadInfoNotifier_NotifyUpdateUserGestureCarryoverInfo_Params, params_);
  ...
  ResourceLoadInfoNotifierStub.prototype.notifyUpdateUserGestureCarryoverInfo = function() {
    return this.delegate_ && this.delegate_.notifyUpdateUserGestureCarryoverInfo && this.delegate_.notifyUpdateUserGestureCarryoverInfo();
  }
  ...
  ResourceLoadInfoNotifierStub.prototype.accept = function(message) {
    ...
    case kResourceLoadInfoNotifier_NotifyUpdateUserGestureCarryoverInfo_Name:
      var params = reader.decodeStruct(ResourceLoadInfoNotifier_NotifyUpdateUserGestureCarryoverInfo_Params);
    ...
    switch (message.getName()) {
      case kResourceLoadInfoNotifier_NotifyUpdateUserGestureCarryoverInfo_Name:
        if (!message.expectsResponse() && !message.isResponse())
          paramsClass = ResourceLoadInfoNotifier_NotifyUpdateUserGestureCarryoverInfo_Params;
      break;
      case kResourceLoadInfoNotifier_NotifyResourceRedirectReceived_Name:
        if (!message.expectsResponse() && !message.isResponse())
