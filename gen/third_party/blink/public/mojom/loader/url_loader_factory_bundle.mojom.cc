...
URLLoaderFactoryBundle::URLLoaderFactoryBundle(
    ::mojo::PendingRemote<::network::mojom::URLLoaderFactory> default_factory_in,
    base::flat_map<std::string, ::mojo::PendingRemote<::network::mojom::URLLoaderFactory>> scheme_specific_factories_in,
    base::flat_map<::url::Origin, ::mojo::PendingRemote<::network::mojom::URLLoaderFactory>> isolated_world_factories_in,
...
void URLLoaderFactoryBundle::WriteIntoTrace(
    perfetto::TracedValue traced_context) const {
  [[maybe_unused]] auto dict = std::move(traced_context).WriteDictionary();
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "default_factory"), this->default_factory,
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "scheme_specific_factories"), this->scheme_specific_factories,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "isolated_world_factories"), this->isolated_world_factories,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
