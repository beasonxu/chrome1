...
bool ImageDownloader_DownloadImage_Params_Data::Validate(
  ...
  [[maybe_unused]] const ImageDownloader_DownloadImage_Params_Data* object =
      static_cast<const ImageDownloader_DownloadImage_Params_Data*>(data);
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->preferred_size, 3, validation_context)) {
    return false;
  }
