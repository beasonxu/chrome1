...
static_assert(sizeof(DateTimeChooser_CloseDateTimeDialog_Params_Data) == 8,
              "Bad sizeof(DateTimeChooser_CloseDateTimeDialog_Params_Data)");
...
class DateTimeChooser_CloseDateTimeDialog_ParamsDataView {
 public:
  ...
  DateTimeChooser_CloseDateTimeDialog_ParamsDataView(
      internal::DateTimeChooser_CloseDateTimeDialog_Params_Data* data,
      mojo::Message* message)
      : data_(data) {}
