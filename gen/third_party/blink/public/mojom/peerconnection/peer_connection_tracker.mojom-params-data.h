...
static_assert(sizeof(PeerConnectionManager_OnThermalStateChange_Params_Data) == 16,
              "Bad sizeof(PeerConnectionManager_OnThermalStateChange_Params_Data)");
...
static_assert(sizeof(PeerConnectionManager_OnSpeedLimitChange_Params_Data) == 16,
              "Bad sizeof(PeerConnectionManager_OnSpeedLimitChange_Params_Data)");
...
static_assert(sizeof(PeerConnectionTrackerHost_GetUserMedia_Params_Data) == 32,
...
static_assert(sizeof(PeerConnectionTrackerHost_GetUserMediaSuccess_Params_Data) == 40,
              "Bad sizeof(PeerConnectionTrackerHost_GetUserMediaSuccess_Params_Data)");
...
static_assert(sizeof(PeerConnectionTrackerHost_GetUserMediaFailure_Params_Data) == 32,
              "Bad sizeof(PeerConnectionTrackerHost_GetUserMediaFailure_Params_Data)");
...
class PeerConnectionManager_OnThermalStateChange_ParamsDataView {
 public:
  ...
  PeerConnectionManager_OnThermalStateChange_ParamsDataView(
      internal::PeerConnectionManager_OnThermalStateChange_Params_Data* data,
      mojo::Message* message)
      : data_(data) {}

  bool is_null() const { return !data_; }
  template <typename UserType>
  [[nodiscard]] bool ReadThermalState(UserType* output) const {
    auto data_value = data_->thermal_state;
    return mojo::internal::Deserialize<::blink::mojom::DeviceThermalState>(
        data_value, output);
  }
  DeviceThermalState thermal_state() const {
    return ::mojo::internal::ToKnownEnumValueHelper(
          static_cast<::blink::mojom::DeviceThermalState>(data_->thermal_state));
  }
 private:
...
class PeerConnectionManager_OnSpeedLimitChange_ParamsDataView {
 public:
  ...
  PeerConnectionManager_OnSpeedLimitChange_ParamsDataView(
      internal::PeerConnectionManager_OnSpeedLimitChange_Params_Data* data,
      mojo::Message* message)
      : data_(data) {}
...
class PeerConnectionTrackerHost_GetUserMedia_ParamsDataView {
 public:
  ...
  template <typename UserType>
  [[nodiscard]] bool ReadAudioConstraints(UserType* output) {
  ...
  template <typename UserType>
  [[nodiscard]] bool ReadVideoConstraints(UserType* output) {
...
class PeerConnectionTrackerHost_GetUserMediaSuccess_ParamsDataView {
 public:
  ...
  PeerConnectionTrackerHost_GetUserMediaSuccess_ParamsDataView(
      internal::PeerConnectionTrackerHost_GetUserMediaSuccess_Params_Data* data,
      mojo::Message* message)
      : data_(data), message_(message) {}
  ...
  inline void GetAudioTrackInfoDataView(
      mojo::StringDataView* output);

  template <typename UserType>
  [[nodiscard]] bool ReadAudioTrackInfo(UserType* output) {
    
    auto* pointer = data_->audio_track_info.Get();
    return mojo::internal::Deserialize<mojo::StringDataView>(
        pointer, output, message_);
  }
  inline void GetVideoTrackInfoDataView(
      mojo::StringDataView* output);

  template <typename UserType>
  [[nodiscard]] bool ReadVideoTrackInfo(UserType* output) {
...
class PeerConnectionTrackerHost_GetUserMediaFailure_ParamsDataView {
 public:
  ...
  PeerConnectionTrackerHost_GetUserMediaFailure_ParamsDataView(
      internal::PeerConnectionTrackerHost_GetUserMediaFailure_Params_Data* data,
      mojo::Message* message)
      : data_(data), message_(message) {}
