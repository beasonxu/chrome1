...
class ClipboardHost_ReadAvailableCustomAndStandardFormats_HandleSyncResponse
 ...
 public:
  ClipboardHost_ReadAvailableCustomAndStandardFormats_HandleSyncResponse(
      bool* result, WTF::Vector<::WTF::String>* out_format_types)
...
bool ClipboardHostProxy::ReadAvailableCustomAndStandardFormats(
    WTF::Vector<::WTF::String>* out_param_format_types) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void ClipboardHostProxy::ReadUnsanitizedCustomFormat(
    const ::WTF::String& in_format, ReadUnsanitizedCustomFormatCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
class ClipboardHost_ReadAvailableCustomAndStandardFormats_ProxyToResponder : public ::mojo::internal::ProxyToResponder {
 ...
 private:
  ...
  void Run(
      const WTF::Vector<::WTF::String>& in_format_types);
};
...
,
             const WTF::Vector<::WTF::String>& types) {*out_types = std::move(types);
            loop->Quit();
          },
          &loop,
          out_types));
  ...
  proxy_->ReadAvailableCustomAndStandardFormats(
      base::BindOnce(
          [](base::RunLoop* loop,
             WTF::Vector<::WTF::String>* out_format_types
,
             const WTF::Vector<::WTF::String>& format_types) {*out_format_types = std::move(format_types);
            loop->Quit();
          },
          &loop,
          out_format_types));
