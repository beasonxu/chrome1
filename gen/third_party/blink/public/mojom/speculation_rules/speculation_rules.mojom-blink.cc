...
void SpeculationHostProxy::UpdateSpeculationCandidates(
    WTF::Vector<SpeculationCandidatePtr> in_candidates) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("candidates"), in_candidates,
                        "<value of type WTF::Vector<SpeculationCandidatePtr>>");
   });
#endif
...
bool StructTraits<::blink::mojom::blink::SpeculationCandidate::DataView, ::blink::mojom::blink::SpeculationCandidatePtr>::Read(
    ::blink::mojom::blink::SpeculationCandidate::DataView input,
    ::blink::mojom::blink::SpeculationCandidatePtr* output) {
  bool success = true;
