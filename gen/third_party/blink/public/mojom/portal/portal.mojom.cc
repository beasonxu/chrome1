...
void PortalProxy::Activate(
    ::blink::TransferableMessage in_data, ::base::TimeTicks in_activation_time, uint64_t in_trace_id, ActivateCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void PortalInterceptorForTesting::PostMessageToGuest(::blink::TransferableMessage message) {
...
void PortalAsyncWaiter::Activate(
    ::blink::TransferableMessage data, ::base::TimeTicks activation_time, uint64_t trace_id, PortalActivateResult* out_result) {
  base::RunLoop loop;
...
void PortalHostInterceptorForTesting::PostMessageToHost(::blink::TransferableMessage message) {
