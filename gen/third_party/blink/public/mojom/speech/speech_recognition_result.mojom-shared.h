...
struct Serializer<::blink::mojom::SpeechRecognitionHypothesisDataView, MaybeConstUserType> {
  ...
  static void Serialize(
      ...
      mojo::internal::MessageFragment<::blink::mojom::internal::SpeechRecognitionHypothesis_Data>& fragment) {
...
struct Serializer<::blink::mojom::SpeechRecognitionResultDataView, MaybeConstUserType> {
  ...
  static void Serialize(
      MaybeConstUserType& input,
      mojo::internal::MessageFragment<::blink::mojom::internal::SpeechRecognitionResult_Data>& fragment) {
    if (CallIsNullIfExists<Traits>(input))
      return;
    fragment.Allocate();
