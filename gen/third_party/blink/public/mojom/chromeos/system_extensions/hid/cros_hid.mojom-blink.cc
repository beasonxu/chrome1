...
void CrosHIDProxy::AccessDevices(
    WTF::Vector<::blink::mojom::blink::HidDeviceFilterPtr> in_filters, AccessDevicesCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("filters"), in_filters,
                        "<value of type WTF::Vector<::blink::mojom::blink::HidDeviceFilterPtr>>");
   });
#endif
...
bool CrosHIDStubDispatch::AcceptWithResponder(
  ...
  switch (message->header()->name) {
    case internal::kCrosHID_AccessDevices_Name: {
      ...
      bool success = true;
      WTF::Vector<::blink::mojom::blink::HidDeviceFilterPtr> p_filters{};
