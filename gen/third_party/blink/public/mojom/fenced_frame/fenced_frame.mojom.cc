...
FencedFrameReporting::FencedFrameReporting(
    const base::flat_map<ReportingDestination, base::flat_map<std::string, ::GURL>>& metadata_in)
...
void FencedFrameOwnerHostProxy::Navigate(
    const ::GURL& in_url, ::base::TimeTicks in_navigation_start_time) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
bool StructTraits<::blink::mojom::FencedFrameReporting::DataView, ::blink::mojom::FencedFrameReportingPtr>::Read(
    ::blink::mojom::FencedFrameReporting::DataView input,
    ::blink::mojom::FencedFrameReportingPtr* output) {
  bool success = true;
