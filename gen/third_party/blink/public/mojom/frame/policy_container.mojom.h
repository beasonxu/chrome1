...
class BLINK_COMMON_EXPORT PolicyContainerHostKeepAliveHandle
...
struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::PolicyContainerPolicies::DataView,
  ...
  static decltype(::blink::mojom::PolicyContainerPolicies::cross_origin_embedder_policy) cross_origin_embedder_policy(
  ...
  static decltype(::blink::mojom::PolicyContainerPolicies::is_anonymous) is_anonymous(
      const ::blink::mojom::PolicyContainerPoliciesPtr& input) {
