...
class BLINK_COMMON_EXPORT KeepAliveHandle
...
class BLINK_COMMON_EXPORT KeepAliveHandleFactory
...
// with not having this data in traces there.
  ...
  virtual void JavaScriptExecuteRequestForTests(const ::std::u16string& javascript, bool has_user_gesture, bool resolve_promises, int32_t world_id, JavaScriptExecuteRequestForTestsCallback callback) = 0;
  ...
  using ExtractSmartClipDataCallback = base::OnceCallback<void(const ::std::u16string&, const ::std::u16string&, const ::gfx::Rect&)>;
...
// with not having this data in traces there.
  ...
  virtual void ShowCreatedWindow(const ::blink::LocalFrameToken& opener_frame_token, ::WindowOpenDisposition disposition, const ::gfx::Rect& rect, bool opened_by_user_gesture, ShowCreatedWindowCallback callback) = 0;
...
class BLINK_COMMON_EXPORT LocalFrameProxy
 ...
 public:
  ...
  void JavaScriptExecuteRequestForTests(const ::std::u16string& javascript, bool has_user_gesture, bool resolve_promises, int32_t world_id, JavaScriptExecuteRequestForTestsCallback callback) final;
...
class BLINK_COMMON_EXPORT LocalMainFrameHostProxy
 ...
 public:
  ...
  void ShowCreatedWindow(const ::blink::LocalFrameToken& opener_frame_token, ::WindowOpenDisposition disposition, const ::gfx::Rect& rect, bool opened_by_user_gesture, ShowCreatedWindowCallback callback) final;
...
struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::IframeAttributes::DataView,
  ...
  static decltype(::blink::mojom::IframeAttributes::anonymous) anonymous(
      const ::blink::mojom::IframeAttributesPtr& input) {
