...
struct CORE_EXPORT StructTraits<::blink::mojom::blink::FramePolicy::DataView,
  ...
  static decltype(::blink::mojom::blink::FramePolicy::is_fenced) is_fenced(
      const ::blink::mojom::blink::FramePolicyPtr& input) {
    return input->is_fenced;
  }

  static decltype(::blink::mojom::blink::FramePolicy::fenced_frame_mode) fenced_frame_mode(
      const ::blink::mojom::blink::FramePolicyPtr& input) {
