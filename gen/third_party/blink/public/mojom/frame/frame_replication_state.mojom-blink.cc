...
FrameReplicationState::FrameReplicationState(
    ...
    const WTF::String& unique_name_in,
    WTF::Vector<::blink::ParsedPermissionsPolicyDeclaration> permissions_policy_header_in,
    ...
    WTF::Vector<uint32_t> insecure_navigations_set_in,
