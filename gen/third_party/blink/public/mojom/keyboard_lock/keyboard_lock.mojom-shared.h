...
struct Serializer<::blink::mojom::KeyboardLockRequestResult, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    return Traits::FromMojom(::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::blink::mojom::KeyboardLockRequestResult>(input)), output);
  }
};
...
struct Serializer<::blink::mojom::GetKeyboardLayoutMapStatus, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    return Traits::FromMojom(::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::blink::mojom::GetKeyboardLayoutMapStatus>(input)), output);
  }
};
...
struct Serializer<::blink::mojom::GetKeyboardLayoutMapResultDataView, MaybeConstUserType> {
  ...
  static void Serialize(
      ...
      mojo::internal::MessageFragment<::blink::mojom::internal::GetKeyboardLayoutMapResult_Data>& fragment) {
    ...
    mojo::internal::MessageFragment<
        typename decltype(fragment->layout_map)::BaseType>
        layout_map_fragment(fragment.message());
    ...
    fragment->layout_map.Set(
        layout_map_fragment.is_null() ? nullptr : layout_map_fragment.data());
    MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        fragment->layout_map.is_null(),
...
template <>
struct COMPONENT_EXPORT(MOJOM_SHARED_BLINK_COMMON_EXPORT) TraceFormatTraits<::blink::mojom::KeyboardLockRequestResult> {
...
template <>
struct COMPONENT_EXPORT(MOJOM_SHARED_BLINK_COMMON_EXPORT) TraceFormatTraits<::blink::mojom::GetKeyboardLayoutMapStatus> {
