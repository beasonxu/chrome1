...
static_assert(sizeof(WebDatabaseHost_Opened_Params_Data) == 32,
...
class WebDatabaseHost_OpenFile_ParamsDataView {
 public:
  ...
  template <typename UserType>
  [[nodiscard]] bool ReadVfsFileName(UserType* output) {
...
class WebDatabaseHost_Opened_ParamsDataView {
 public:
  ...
  template <typename UserType>
  [[nodiscard]] bool ReadDatabaseDescription(UserType* output) {
