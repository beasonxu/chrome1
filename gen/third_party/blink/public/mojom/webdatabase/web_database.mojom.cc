...
bool WebDatabaseHostProxy::SetFileSize(
    const ::std::u16string& param_vfs_file_name, int64_t param_expected_size, bool* out_param_success) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT_BEGIN1(
...
void WebDatabaseHostProxy::SetFileSize(
    const ::std::u16string& in_vfs_file_name, int64_t in_expected_size, SetFileSizeCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void WebDatabaseHostAsyncWaiter::SetFileSize(
    const ::std::u16string& vfs_file_name, int64_t expected_size, bool* out_success) {
  base::RunLoop loop;
