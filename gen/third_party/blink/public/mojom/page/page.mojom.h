...
// with not having this data in traces there.
  ...
  virtual void CreateRemoteMainFrame(const ::blink::RemoteFrameToken& token, const absl::optional<::blink::FrameToken>& opener_frame_token, ::blink::mojom::FrameReplicationStatePtr replication_state, const ::base::UnguessableToken& devtools_frame_token, ::blink::mojom::RemoteFrameInterfacesFromBrowserPtr remote_frame_interfaces, ::blink::mojom::RemoteMainFrameInterfacesPtr remote_main_frame_interfaces) = 0;
};
...
class BLINK_COMMON_EXPORT PageBroadcastProxy
 ...
 public:
  ...
  void CreateRemoteMainFrame(const ::blink::RemoteFrameToken& token, const absl::optional<::blink::FrameToken>& opener_frame_token, ::blink::mojom::FrameReplicationStatePtr replication_state, const ::base::UnguessableToken& devtools_frame_token, ::blink::mojom::RemoteFrameInterfacesFromBrowserPtr remote_frame_interfaces, ::blink::mojom::RemoteMainFrameInterfacesPtr remote_main_frame_interfaces) final;
...
struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::PageLifecycleState::DataView,
  ...
  static decltype(::blink::mojom::PageLifecycleState::should_dispatch_pageshow_for_debugging) should_dispatch_pageshow_for_debugging(
      const ::blink::mojom::PageLifecycleStatePtr& input) {
...
template <>
struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::PrerenderPageActivationParams::DataView,
