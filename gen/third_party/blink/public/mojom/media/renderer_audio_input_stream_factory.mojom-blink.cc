...
void RendererAudioInputStreamFactoryProxy::CreateStream(
    ::mojo::PendingRemote<RendererAudioInputStreamFactoryClient> in_client, const ::base::UnguessableToken& in_session_id, const ::media::AudioParameters& in_params, bool in_automatic_gain_control, uint32_t in_shared_memory_count, ::media::mojom::blink::AudioProcessingConfigPtr in_processing_config) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("stream"), in_stream,
                        "<value of type ::mojo::PendingRemote<::media::mojom::blink::AudioInputStream>>");
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("client_request"), in_client_request,
                        "<value of type ::mojo::PendingReceiver<::media::mojom::blink::AudioInputStreamClient>>");
      perfetto::WriteIntoTracedValueWithFallback(
