...
struct blink_mojom_internal_FetchPriorityHint_DataHashFn {
  ...
  static bool Equal(const ::blink::mojom::FetchPriorityHint& left, const ::blink::mojom::FetchPriorityHint& right) {
    return left == right;
  }
  static const bool safe_to_compare_to_empty_or_deleted = true;
};
...
struct HashTraits<::blink::mojom::FetchPriorityHint>
    : public GenericHashTraits<::blink::mojom::FetchPriorityHint> {
  static_assert(true,
                "-1000000 is a reserved enum value");
  static_assert(true,
                "-1000001 is a reserved enum value");
  ...
  static void ConstructDeletedValue(::blink::mojom::FetchPriorityHint& slot, bool) {
    slot = static_cast<::blink::mojom::FetchPriorityHint>(-1000001);
  }
  static bool IsDeletedValue(const ::blink::mojom::FetchPriorityHint& value) {
    return value == static_cast<::blink::mojom::FetchPriorityHint>(-1000001);
  }
};
}  // namespace WTF
