...
bool BlobURLStore_Resolve_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const BlobURLStore_Resolve_Params_Data* object =
      static_cast<const BlobURLStore_Resolve_Params_Data*>(data);
...
bool BlobURLStore_Resolve_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const BlobURLStore_Resolve_ResponseParams_Data* object =
      static_cast<const BlobURLStore_Resolve_ResponseParams_Data*>(data);
