    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("clients"), in_clients,
                        "<value of type WTF::Vector<::blink::mojom::blink::ServiceWorkerClientInfoPtr>>");
   });
#endif
...
void ServiceWorkerProxy::InitializeGlobalScope(
    ::mojo::PendingAssociatedRemote<ServiceWorkerHost> in_service_worker_host, ::blink::mojom::blink::ServiceWorkerRegistrationObjectInfoPtr in_registration_info, ::blink::mojom::blink::ServiceWorkerObjectInfoPtr in_service_worker_info, FetchHandlerExistence in_fetch_handler_existence, ::mojo::PendingReceiver<::blink::mojom::blink::ReportingObserver> in_reporting_observer_receiver, ::blink::mojom::blink::AncestorFrameType in_ancestor_frame_type) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void ServiceWorkerProxy::ExecuteScriptForTest(
    const ::WTF::String& in_javascript, bool in_wants_result, ExecuteScriptForTestCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
class ServiceWorker_ExecuteScriptForTest_ProxyToResponder : public ::mojo::internal::ProxyToResponder {
 ...
 private:
  ...
  void Run(
      ::base::Value in_result, const WTF::String& in_error);
};
...
void ServiceWorkerInterceptorForTesting::InitializeGlobalScope(::mojo::PendingAssociatedRemote<ServiceWorkerHost> service_worker_host, ::blink::mojom::blink::ServiceWorkerRegistrationObjectInfoPtr registration_info, ::blink::mojom::blink::ServiceWorkerObjectInfoPtr service_worker_info, FetchHandlerExistence fetch_handler_existence, ::mojo::PendingReceiver<::blink::mojom::blink::ReportingObserver> reporting_observer_receiver, ::blink::mojom::blink::AncestorFrameType ancestor_frame_type) {
...
void ServiceWorkerAsyncWaiter::ExecuteScriptForTest(
    const ::WTF::String& javascript, bool wants_result, ::base::Value* out_result, WTF::String* out_error) {
  base::RunLoop loop;
...
,
             WTF::String* out_error
,
             ::base::Value result,
             const WTF::String& error) {*out_result = std::move(result);*out_error = std::move(error);
            loop->Quit();
          },
          &loop,
          out_result,
