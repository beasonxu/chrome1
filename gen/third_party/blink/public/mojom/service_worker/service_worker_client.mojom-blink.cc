...
void ServiceWorkerClientQueryOptions::WriteIntoTrace(
    perfetto::TracedValue traced_context) const {
  [[maybe_unused]] auto dict = std::move(traced_context).WriteDictionary();
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "include_uncontrolled"), this->include_uncontrolled,
...
void ServiceWorkerClientInfo::WriteIntoTrace(
    perfetto::TracedValue traced_context) const {
  [[maybe_unused]] auto dict = std::move(traced_context).WriteDictionary();
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "last_focus_time"), this->last_focus_time,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
