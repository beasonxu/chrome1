...
// with not having this data in traces there.
  ...
  virtual void OnStarted(::blink::mojom::ServiceWorkerStartStatus status, ::blink::mojom::ServiceWorkerFetchHandlerType fetch_handler_type, int32_t thread_id, EmbeddedWorkerStartTimingPtr start_timing) = 0;
  ...
  virtual void OnReportConsoleMessage(::blink::mojom::ConsoleMessageSource source, ::blink::mojom::ConsoleMessageLevel message_level, const ::std::u16string& message, int32_t line_number, const ::GURL& source_url) = 0;
...
class BLINK_COMMON_EXPORT EmbeddedWorkerInstanceHostProxy
 ...
 public:
  ...
  void OnStarted(::blink::mojom::ServiceWorkerStartStatus status, ::blink::mojom::ServiceWorkerFetchHandlerType fetch_handler_type, int32_t thread_id, EmbeddedWorkerStartTimingPtr start_timing) final;
  ...
  void OnReportConsoleMessage(::blink::mojom::ConsoleMessageSource source, ::blink::mojom::ConsoleMessageLevel message_level, const ::std::u16string& message, int32_t line_number, const ::GURL& source_url) final;
...
struct BLINK_COMMON_EXPORT StructTraits<::blink::mojom::EmbeddedWorkerStartParams::DataView,
  ...
  static  decltype(::blink::mojom::EmbeddedWorkerStartParams::interface_provider)& interface_provider(
       ::blink::mojom::EmbeddedWorkerStartParamsPtr& input) {
