...
bool DispatchFetchEventParams_Data::Validate(
  ...
  [[maybe_unused]] const DispatchFetchEventParams_Data* object =
      static_cast<const DispatchFetchEventParams_Data*>(data);
  ...
  if (!mojo::internal::ValidateHandleOrInterface(object->preload_url_loader_client_receiver,
                                                 validation_context)) {
    return false;
  }
