...
SecurePaymentConfirmationResponse& operator=(const SecurePaymentConfirmationResponse&) = delete;
  ...
  static WTF::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        SecurePaymentConfirmationResponse::DataView, WTF::Vector<uint8_t>>(input);
  }
...
SecurePaymentConfirmationRequest& operator=(const SecurePaymentConfirmationRequest&) = delete;
  ...
  static WTF::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        SecurePaymentConfirmationRequest::DataView, WTF::Vector<uint8_t>>(input);
  }
...
template <>
struct PLATFORM_EXPORT StructTraits<::payments::mojom::blink::SecurePaymentConfirmationResponse::DataView,
                                         ::payments::mojom::blink::SecurePaymentConfirmationResponsePtr> {
