...
class PaymentManager_Init_ParamsDataView {
 public:
  ...
  [[nodiscard]] bool ReadContextUrl(UserType* output) {
  ...
  template <typename UserType>
  [[nodiscard]] bool ReadServiceWorkerScope(UserType* output) {
 ...
 public:
  ...
  PaymentHandlerStatus status() const {
    return ::mojo::internal::ToKnownEnumValueHelper(
          static_cast<::payments::mojom::PaymentHandlerStatus>(data_->status));
  }
 private:
...
class PaymentManager_SetUserHint_ParamsDataView {
 public:
  ...
  template <typename UserType>
  [[nodiscard]] bool ReadUserHint(UserType* output) {
...
class PaymentManager_EnableDelegations_ParamsDataView {
 public:
  ...
  template <typename UserType>
  [[nodiscard]] bool ReadDelegations(UserType* output) {
...
class PaymentHandlerResponseCallback_OnResponseForCanMakePayment_ParamsDataView {
 public:
  ...
  [[nodiscard]] bool ReadResponse(UserType* output) {
    ...
    return mojo::internal::Deserialize<::payments::mojom::CanMakePaymentResponseDataView>(
        pointer, output, message_);
  }
 private:
