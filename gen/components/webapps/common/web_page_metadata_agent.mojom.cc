...
#ifndef COMPONENTS_WEBAPPS_COMMON_WEB_PAGE_METADATA_AGENT_MOJOM_JUMBO_H_
#define COMPONENTS_WEBAPPS_COMMON_WEB_PAGE_METADATA_AGENT_MOJOM_JUMBO_H_
#endif
...
WebPageMetadataAgent::IPCStableHashFunction WebPageMetadataAgent::MessageToMethodInfo_(mojo::Message& message) {
  ...
  switch (message.name()) {
    case internal::kWebPageMetadataAgent_GetWebPageMetadata_Name: {
...
uint32_t WebPageMetadataAgent::GetWebPageMetadata_Sym::IPCStableHash() {
  ...
  constexpr uint32_t kHash = base::MD5Hash32Constexpr(
          "(Impl)webapps::mojom::WebPageMetadataAgent::GetWebPageMetadata");
...
void WebPageMetadataAgentProxy::GetWebPageMetadata(
  ...
  mojo::Message message(
      internal::kWebPageMetadataAgent_GetWebPageMetadata_Name, kFlags, 0, 0, nullptr);
...
void WebPageMetadataAgent_GetWebPageMetadata_ProxyToResponder::Run(
  ...
  mojo::internal::Serialize<::webapps::mojom::WebPageMetadataDataView>(
      in_web_page_metadata, web_page_metadata_fragment);
