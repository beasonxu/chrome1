...
uint32_t CSVPasswordParser::ParseCSV_Sym::IPCStableHash() {
  ...
  constexpr uint32_t kHash = base::MD5Hash32Constexpr(
          "(Impl)password_manager::mojom::CSVPasswordParser::ParseCSV");
...
void CSVPasswordParserProxy::ParseCSV(
  ...
  mojo::Message message(
      internal::kCSVPasswordParser_ParseCSV_Name, kFlags, 0, 0, nullptr);
