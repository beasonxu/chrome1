...
class MalwarePatternType final :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:safe_browsing.MalwarePatternType) */ {
 public:
  inline MalwarePatternType() : MalwarePatternType(nullptr) {}
  ~MalwarePatternType() override;
  explicit PROTOBUF_CONSTEXPR MalwarePatternType(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  PROTOBUF_NOINLINE void Swap(MalwarePatternType* other) {
  ...
  void UnsafeArenaSwap(MalwarePatternType* other) {
    if (other == this) return;
  ...
  MalwarePatternType* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  protected:
  explicit MalwarePatternType(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  static inline bool PATTERN_TYPE_Parse(::PROTOBUF_NAMESPACE_ID::ConstStringParam name,
      PATTERN_TYPE* value) {
  ...
  private:
  ::safe_browsing::MalwarePatternType_PATTERN_TYPE _internal_pattern_type() const;
  void _internal_set_pattern_type(::safe_browsing::MalwarePatternType_PATTERN_TYPE value);
  public:
...
class SocialEngineeringPatternType final :
 ...
 public:
  inline SocialEngineeringPatternType() : SocialEngineeringPatternType(nullptr) {}
  ~SocialEngineeringPatternType() override;
  explicit PROTOBUF_CONSTEXPR SocialEngineeringPatternType(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  PROTOBUF_NOINLINE void Swap(SocialEngineeringPatternType* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(SocialEngineeringPatternType* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  SocialEngineeringPatternType* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  protected:
  explicit SocialEngineeringPatternType(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  private:
  ::safe_browsing::SocialEngineeringPatternType_PATTERN_TYPE _internal_pattern_type() const;
  void _internal_set_pattern_type(::safe_browsing::SocialEngineeringPatternType_PATTERN_TYPE value);
  public:
...
// required .safe_browsing.MalwarePatternType.PATTERN_TYPE pattern_type = 1;
inline bool MalwarePatternType::_internal_has_pattern_type() const {
...
inline ::safe_browsing::MalwarePatternType_PATTERN_TYPE MalwarePatternType::_internal_pattern_type() const {
...
inline void MalwarePatternType::_internal_set_pattern_type(::safe_browsing::MalwarePatternType_PATTERN_TYPE value) {
...
// optional .safe_browsing.SocialEngineeringPatternType.PATTERN_TYPE pattern_type = 1;
inline bool SocialEngineeringPatternType::_internal_has_pattern_type() const {
  bool value = (_has_bits_[0] & 0x00000001u) != 0;
  return value;
}
...
inline ::safe_browsing::SocialEngineeringPatternType_PATTERN_TYPE SocialEngineeringPatternType::_internal_pattern_type() const {
...
inline void SocialEngineeringPatternType::_internal_set_pattern_type(::safe_browsing::SocialEngineeringPatternType_PATTERN_TYPE value) {
