...
// static
bool ScreenAIAnnotator_Annotate_Params_Data::Validate(
    const void* data,
  ...
  [[maybe_unused]] const ScreenAIAnnotator_Annotate_Params_Data* object =
      static_cast<const ScreenAIAnnotator_Annotate_Params_Data*>(data);
...
// static
bool ScreenAIAnnotator_Annotate_ResponseParams_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const ScreenAIAnnotator_Annotate_ResponseParams_Data* object =
      static_cast<const ScreenAIAnnotator_Annotate_ResponseParams_Data*>(data);
...
// static
bool ScreenAIService_BindAnnotator_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const ScreenAIService_BindAnnotator_Params_Data* object =
      static_cast<const ScreenAIService_BindAnnotator_Params_Data*>(data);
...
// static
bool ScreenAIService_BindMainContentExtractor_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const ScreenAIService_BindMainContentExtractor_Params_Data* object =
      static_cast<const ScreenAIService_BindMainContentExtractor_Params_Data*>(data);
