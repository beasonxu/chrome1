...
bool CacheStorageControl_AddReceiver_Params_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->storage_key, 3, validation_context)) {
    return false;
  }
  if (!mojo::internal::ValidateStruct(object->storage_key, validation_context))
    return false;
...
// static
bool CacheStorageControl_DeleteForStorageKey_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const CacheStorageControl_DeleteForStorageKey_Params_Data* object =
      static_cast<const CacheStorageControl_DeleteForStorageKey_Params_Data*>(data);
...
// static
bool CacheStorageControl_GetAllStorageKeysInfo_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const CacheStorageControl_GetAllStorageKeysInfo_Params_Data* object =
      static_cast<const CacheStorageControl_GetAllStorageKeysInfo_Params_Data*>(data);
...
// static
bool CacheStorageControl_GetAllStorageKeysInfo_ResponseParams_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
