...
#ifndef COMPONENTS_SITE_ENGAGEMENT_CORE_MOJOM_SITE_ENGAGEMENT_DETAILS_MOJOM_JUMBO_H_
#define COMPONENTS_SITE_ENGAGEMENT_CORE_MOJOM_SITE_ENGAGEMENT_DETAILS_MOJOM_JUMBO_H_
#endif
...
uint32_t SiteEngagementDetailsProvider::GetSiteEngagementDetails_Sym::IPCStableHash() {
  ...
  constexpr uint32_t kHash = base::MD5Hash32Constexpr(
          "(Impl)site_engagement::mojom::SiteEngagementDetailsProvider::GetSiteEngagementDetails");
...
uint32_t SiteEngagementDetailsProvider::SetSiteEngagementBaseScoreForUrl_Sym::IPCStableHash() {
  ...
  // hash instead of __LINE__.
  constexpr uint32_t kHash = base::MD5Hash32Constexpr(
          "(Impl)site_engagement::mojom::SiteEngagementDetailsProvider::SetSiteEngagementBaseScoreForUrl");
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
