...
class  SpellCheckHost_DisconnectSessionBridge_Params_Data {
 ...
 private:
  friend class mojo::internal::MessageFragment<SpellCheckHost_DisconnectSessionBridge_Params_Data>;
...
class SpellCheckHost_DisconnectSessionBridge_ParamsDataView {
 public:
  SpellCheckHost_DisconnectSessionBridge_ParamsDataView() = default;
