...
// with not having this data in traces there.
  ...
  struct DisconnectSessionBridge_Sym {
    NOINLINE static uint32_t IPCStableHash();
  };
  ...
  virtual void RequestTextCheck(const ::std::u16string& text, int32_t route_id, RequestTextCheckCallback callback) = 0;
  ...
  virtual bool CheckSpelling(const ::std::u16string& word, int32_t route_id, bool* out_correct);

  using CheckSpellingCallback = base::OnceCallback<void(bool)>;
  
  virtual void CheckSpelling(const ::std::u16string& word, int32_t route_id, CheckSpellingCallback callback) = 0;
...
class  SpellCheckHostProxy
 ...
 public:
  ...
  void RequestTextCheck(const ::std::u16string& text, int32_t route_id, RequestTextCheckCallback callback) final;
  
  void DisconnectSessionBridge() final;
  
  bool CheckSpelling(const ::std::u16string& word, int32_t route_id, bool* out_correct) final;
  
  void CheckSpelling(const ::std::u16string& word, int32_t route_id, CheckSpellingCallback callback) final;
