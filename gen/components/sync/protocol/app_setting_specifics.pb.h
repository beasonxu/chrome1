...
class AppSettingSpecifics final :
 ...
 public:
  ...
  protected:
  explicit AppSettingSpecifics(::PROTOBUF_NAMESPACE_ID::Arena* arena,
...
inline bool AppSettingSpecifics::_internal_has_extension_setting() const {
  ...
  PROTOBUF_ASSUME(!value || extension_setting_ != nullptr);
  return value;
}
...
inline void AppSettingSpecifics::unsafe_arena_set_allocated_extension_setting(
    ::sync_pb::ExtensionSettingSpecifics* extension_setting) {
