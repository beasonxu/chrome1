...
class ArcPackageSpecifics final :
 ...
 public:
  ...
  protected:
  explicit ArcPackageSpecifics(::PROTOBUF_NAMESPACE_ID::Arena* arena,
...
void ArcPackageSpecifics::set_package_name(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
