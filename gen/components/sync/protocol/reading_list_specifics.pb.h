...
class ReadingListSpecifics final :
 ...
 public:
  ...
  protected:
  explicit ReadingListSpecifics(::PROTOBUF_NAMESPACE_ID::Arena* arena,
...
void ReadingListSpecifics::set_entry_id(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void ReadingListSpecifics::set_title(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000002u;
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void ReadingListSpecifics::set_url(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000004u;
