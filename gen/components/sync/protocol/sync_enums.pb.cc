...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 SyncEnumsDefaultTypeInternal _SyncEnums_default_instance_;
}  // namespace sync_pb
namespace sync_pb {
...
const std::string& SyncEnums_SingletonDebugEventType_Name(
  ...
  static const bool dummy =
      ::PROTOBUF_NAMESPACE_ID::internal::InitializeEnumStrings(
          ...
          14, SyncEnums_SingletonDebugEventType_strings);
  (void) dummy;
...
static ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<std::string> SyncEnums_ErrorType_strings[11] = {};
...
static const ::PROTOBUF_NAMESPACE_ID::internal::EnumEntry SyncEnums_ErrorType_entries[] = {
  ...
  { {SyncEnums_ErrorType_names + 33, 17}, 10 },
  { {SyncEnums_ErrorType_names + 50, 19}, 14 },
  { {SyncEnums_ErrorType_names + 69, 14}, 9 },
  { {SyncEnums_ErrorType_names + 83, 15}, 2 },
  { {SyncEnums_ErrorType_names + 98, 15}, 12 },
  { {SyncEnums_ErrorType_names + 113, 7}, 0 },
  { {SyncEnums_ErrorType_names + 120, 9}, 3 },
  { {SyncEnums_ErrorType_names + 129, 15}, 8 },
  { {SyncEnums_ErrorType_names + 144, 7}, 100 },
};
...
static const int SyncEnums_ErrorType_entries_by_number[] = {
  ...
  9, // 8 -> TRANSIENT_ERROR
  4, // 9 -> MIGRATION_DONE
  2, // 10 -> DISABLED_BY_ADMIN
  6, // 12 -> PARTIAL_FAILURE
  1, // 13 -> CLIENT_DATA_OBSOLETE
  3, // 14 -> ENCRYPTION_OBSOLETE
  10, // 100 -> UNKNOWN
};
...
const std::string& SyncEnums_ErrorType_Name(
  ...
  static const bool dummy =
      ::PROTOBUF_NAMESPACE_ID::internal::InitializeEnumStrings(
          ...
          11, SyncEnums_ErrorType_strings);
  (void) dummy;
  int idx = ::PROTOBUF_NAMESPACE_ID::internal::LookUpEnumName(
      SyncEnums_ErrorType_entries,
      SyncEnums_ErrorType_entries_by_number,
...
bool SyncEnums_ErrorType_Parse(
  ...
  int int_value;
  bool success = ::PROTOBUF_NAMESPACE_ID::internal::LookUpEnumValue(
      SyncEnums_ErrorType_entries, 11, name, &int_value);
  if (success) {
...
static ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<std::string> SyncEnums_BrowserType_strings[3] = {};
...
static const ::PROTOBUF_NAMESPACE_ID::internal::EnumEntry SyncEnums_BrowserType_entries[] = {
  { {SyncEnums_BrowserType_names + 0, 15}, 3 },
  { {SyncEnums_BrowserType_names + 15, 10}, 2 },
  { {SyncEnums_BrowserType_names + 25, 11}, 1 },
};
...
const std::string& SyncEnums_BrowserType_Name(
  ...
  static const bool dummy =
      ::PROTOBUF_NAMESPACE_ID::internal::InitializeEnumStrings(
          SyncEnums_BrowserType_entries,
          SyncEnums_BrowserType_entries_by_number,
          3, SyncEnums_BrowserType_strings);
  (void) dummy;
  int idx = ::PROTOBUF_NAMESPACE_ID::internal::LookUpEnumName(
      SyncEnums_BrowserType_entries,
      SyncEnums_BrowserType_entries_by_number,
...
void SyncEnums::CheckTypeAndMergeFrom(
  ...
  MergeFrom(*::_pbi::DownCast<const SyncEnums*>(
      &from));
}
