...
class SendTabToSelfSpecifics final :
 ...
 public:
  ...
  protected:
  explicit SendTabToSelfSpecifics(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_target_device_sync_cache_guid(ArgT0&& arg0, ArgT... args);
...
inline void SendTabToSelfSpecifics::clear_target_device_sync_cache_guid() {
  target_device_sync_cache_guid_.ClearToEmpty();
...
void SendTabToSelfSpecifics::set_target_device_sync_cache_guid(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000010u;
 target_device_sync_cache_guid_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* SendTabToSelfSpecifics::release_target_device_sync_cache_guid() {
  ...
  _has_bits_[0] &= ~0x00000010u;
  auto* p = target_device_sync_cache_guid_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (target_device_sync_cache_guid_.IsDefault()) {
...
inline void SendTabToSelfSpecifics::set_allocated_target_device_sync_cache_guid(std::string* target_device_sync_cache_guid) {
  ...
  target_device_sync_cache_guid_.SetAllocated(target_device_sync_cache_guid, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (target_device_sync_cache_guid_.IsDefault()) {
    target_device_sync_cache_guid_.Set("", GetArenaForAllocation());
  }
