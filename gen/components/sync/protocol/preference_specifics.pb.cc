...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 PreferenceSpecificsDefaultTypeInternal _PreferenceSpecifics_default_instance_;
}  // namespace sync_pb
namespace sync_pb {
...
void PreferenceSpecifics::CheckTypeAndMergeFrom(
  ...
  MergeFrom(*::_pbi::DownCast<const PreferenceSpecifics*>(
      &from));
}
