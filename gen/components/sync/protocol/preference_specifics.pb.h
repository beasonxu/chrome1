...
class PreferenceSpecifics final :
 ...
 public:
  ...
  protected:
  explicit PreferenceSpecifics(::PROTOBUF_NAMESPACE_ID::Arena* arena,
...
void PreferenceSpecifics::set_name(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void PreferenceSpecifics::set_value(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000002u;
