...
JNI_GENERATOR_EXPORT void Java_J_N_MBZpZMbr(
  ...
  return JNI_ChildAccountInfoFetcher_SetIsChildAccount(env, accountFetcherServicePtr,
      base::android::JavaParamRef<jobject>(env, accountId), isChildAccount);
}
...
static base::android::ScopedJavaLocalRef<jobject> Java_ChildAccountInfoFetcher_create(JNIEnv* env,
    ...
    const base::android::JavaRef<jobject>& coreAccountInfo) {
  ...
  call_context.Init<
      base::android::MethodID::TYPE_STATIC>(
          ...
          clazz,
          "create",
"(JLorg/chromium/components/signin/base/CoreAccountInfo;)Lorg/chromium/components/signin/ChildAccountInfoFetcher;",
          &g_org_chromium_components_signin_ChildAccountInfoFetcher_create);

  jobject ret =
      env->CallStaticObjectMethod(clazz,
          call_context.base.method_id, nativeAccountFetcherService, coreAccountInfo.obj());
