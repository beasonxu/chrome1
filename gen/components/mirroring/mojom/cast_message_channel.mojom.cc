...
CastMessageChannel::IPCStableHashFunction CastMessageChannel::MessageToMethodInfo_(mojo::Message& message) {
  ...
  switch (message.name()) {
    case internal::kCastMessageChannel_Send_Name: {
      return &CastMessageChannel::Send_Sym::IPCStableHash;
    }
  }
...
const char* CastMessageChannel::MessageToMethodName_(mojo::Message& message) {
  ...
  if (!is_response) {
    switch (message.name()) {
      case internal::kCastMessageChannel_Send_Name:
            return "Receive mirroring::mojom::CastMessageChannel::Send";
    }
  } else {
    switch (message.name()) {
      case internal::kCastMessageChannel_Send_Name:
            return "Receive reply mirroring::mojom::CastMessageChannel::Send";
    }
  }
...
#if !BUILDFLAG(IS_FUCHSIA)
uint32_t CastMessageChannel::Send_Sym::IPCStableHash() {
...
void CastMessageChannelProxy::Send(
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    "mojom", "Send mirroring::mojom::CastMessageChannel::Send", "input_parameters",
  ...
  mojo::internal::MessageFragment<
      ::mirroring::mojom::internal::CastMessageChannel_Send_Params_Data> params(
          message);
  params.Allocate();
  mojo::internal::MessageFragment<
...
bool CastMessageChannelStubDispatch::Accept(
  ...
  switch (message->header()->name) {
    case internal::kCastMessageChannel_Send_Name: {
      ...
      CastMessageChannel_Send_ParamsDataView input_data_view(params, message);
