// components/mirroring/mojom/session_observer.mojom-lite-for-compile.js is auto generated by mojom_bindings_generator.py, do not edit
...
goog.provide('mirroring.mojom.SessionError');
goog.provide('mirroring.mojom.SessionErrorSpec');
/**
...
goog.provide('mirroring.mojom.SessionObserverReceiver');
goog.provide('mirroring.mojom.SessionObserverCallbackRouter');
goog.provide('mirroring.mojom.SessionObserverInterface');
goog.provide('mirroring.mojom.SessionObserverRemote');
goog.provide('mirroring.mojom.SessionObserverPendingReceiver');
...
/** @interface */
mirroring.mojom.SessionObserverInterface = class {
...
goog.provide('mirroring.mojom.SessionObserver_OnError_ParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('mirroring.mojom.SessionObserver_DidStart_ParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('mirroring.mojom.SessionObserver_DidStop_ParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('mirroring.mojom.SessionObserver_LogInfoMessage_ParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('mirroring.mojom.SessionObserver_LogErrorMessage_ParamsSpec');
/**
 * @const { {$:!mojo.internal.MojomType}}
 * @export
 */
...
goog.provide('mirroring.mojom.SessionObserver_LogInfoMessage_Params');
...
goog.provide('mirroring.mojom.SessionObserver_LogErrorMessage_Params');
