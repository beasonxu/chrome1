...
static NOINLINE const char* TranslateErrorToStringHelper(TranslateError value) {
...
bool LanguageDetectionDetails_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->content_language, 5, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->model_detected_language, 6, validation_context)) {
    return false;
  }
  const mojo::internal::ContainerValidateParams model_detected_language_validate_params(
      0, false, nullptr);
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->html_root_language, 8, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->detection_model_version, 11, validation_context)) {
    return false;
  }
  const mojo::internal::ContainerValidateParams detection_model_version_validate_params(
      0, false, nullptr);
...
bool TranslateAgent_GetWebLanguageDetectionDetails_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const TranslateAgent_GetWebLanguageDetectionDetails_Params_Data* object =
      static_cast<const TranslateAgent_GetWebLanguageDetectionDetails_Params_Data*>(data);
...
bool TranslateAgent_GetWebLanguageDetectionDetails_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const TranslateAgent_GetWebLanguageDetectionDetails_ResponseParams_Data* object =
      static_cast<const TranslateAgent_GetWebLanguageDetectionDetails_ResponseParams_Data*>(data);
...
// static
bool ContentTranslateDriver_GetLanguageDetectionModel_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const ContentTranslateDriver_GetLanguageDetectionModel_Params_Data* object =
      static_cast<const ContentTranslateDriver_GetLanguageDetectionModel_Params_Data*>(data);

  return true;
}

ContentTranslateDriver_GetLanguageDetectionModel_Params_Data::ContentTranslateDriver_GetLanguageDetectionModel_Params_Data()
    : header_({sizeof(*this), 0}) {}


// static
bool ContentTranslateDriver_GetLanguageDetectionModel_ResponseParams_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const ContentTranslateDriver_GetLanguageDetectionModel_ResponseParams_Data* object =
      static_cast<const ContentTranslateDriver_GetLanguageDetectionModel_ResponseParams_Data*>(data);
...
ContentTranslateDriver_GetLanguageDetectionModel_ResponseParams_Data::ContentTranslateDriver_GetLanguageDetectionModel_ResponseParams_Data()
    : header_({sizeof(*this), 0}) {}
