...
static std::atomic<jmethodID>
    g_org_chromium_components_variations_firstrun_VariationsSeedBridge_hasNativePref(nullptr);
static jboolean Java_VariationsSeedBridge_hasNativePref(JNIEnv* env) {
  jclass clazz = org_chromium_components_variations_firstrun_VariationsSeedBridge_clazz(env);
  CHECK_CLAZZ(env, clazz,
  ...
  call_context.Init<
      base::android::MethodID::TYPE_STATIC>(
          ...
          "hasNativePref",
          "()Z",
          &g_org_chromium_components_variations_firstrun_VariationsSeedBridge_hasNativePref);
