...
(function() {
  ...
  var route_request_result_code$ =
      mojo.internal.exposeNamespace('mediaRouter.mojom');
  if (mojo.config.autoLoadMojomDeps) {
    mojo.internal.loadMojomIfNecessary(
        'components/media_router/common/mojom/route_request_result_code.mojom', 'route_request_result_code.mojom.js');
  }
  ...
  MediaRoute.decode = function(decoder) {
    ...
    val.isOffTheRecord = (packed >> 1) & 1 ? true : false;
    val.isLocalPresentation = (packed >> 2) & 1 ? true : false;
    val.isConnecting = (packed >> 3) & 1 ? true : false;
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    val.controllerType =
  ...
  MediaRoute.encode = function(encoder, val) {
    ...
    packed |= (val.isOffTheRecord & 1) << 1
    packed |= (val.isLocalPresentation & 1) << 2
    packed |= (val.isConnecting & 1) << 3
  ...
  MediaRouteProvider_CreateRoute_Params.encode = function(encoder, val) {
    ...
    encoder.encodeStruct(codec.Int32, val.frameTreeNodeId);
    packed = 0;
  ...
  MediaRouteProvider_CreateRoute_ResponseParams.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 24, route_request_result_code$.RouteRequestResultCode);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  MediaRouteProvider_CreateRoute_ResponseParams.decode = function(decoder) {
    ...
    val.errorText =
        decoder.decodeStruct(codec.NullableString);
    val.resultCode =
        decoder.decodeStruct(new codec.Enum(route_request_result_code$.RouteRequestResultCode));
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  MediaRouteProvider_TerminateRoute_ResponseParams.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 8, route_request_result_code$.RouteRequestResultCode);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  MediaRouteProvider_StartObservingMediaRoutes_Params.encodedSize = codec.kStructHeaderSize + 0;
  ...
  MediaRouter_OnRoutesUpdated_Params.encodedSize = codec.kStructHeaderSize + 16;
  ...
  var kMediaRouteProvider_TerminateRoute_Name = 2;
  var kMediaRouteProvider_SendRouteMessage_Name = 3;
  var kMediaRouteProvider_SendRouteBinaryMessage_Name = 4;
  var kMediaRouteProvider_StartObservingMediaSinks_Name = 5;
  var kMediaRouteProvider_StopObservingMediaSinks_Name = 6;
  var kMediaRouteProvider_StartObservingMediaRoutes_Name = 7;
  var kMediaRouteProvider_StartListeningForRouteMessages_Name = 8;
  var kMediaRouteProvider_StopListeningForRouteMessages_Name = 9;
  var kMediaRouteProvider_DetachRoute_Name = 10;
  var kMediaRouteProvider_EnableMdnsDiscovery_Name = 11;
  var kMediaRouteProvider_UpdateMediaSinks_Name = 12;
  var kMediaRouteProvider_CreateMediaRouteController_Name = 13;
  var kMediaRouteProvider_GetState_Name = 14;
  ...
  MediaRouteProviderProxy.prototype.createRoute = function(mediaSource, sinkId, originalPresentationId, origin, frameTreeNodeId, timeout, offTheRecord) {
    ...
    params_.frameTreeNodeId = frameTreeNodeId;
  ...
  MediaRouteProviderProxy.prototype.joinRoute = function(mediaSource, presentationId, origin, frameTreeNodeId, timeout, offTheRecord) {
  ...
  MediaRouteProviderProxy.prototype.startObservingMediaRoutes = function() {
  ...
  MediaRouteProviderStub.prototype.createRoute = function(mediaSource, sinkId, originalPresentationId, origin, frameTreeNodeId, timeout, offTheRecord) {
    return this.delegate_ && this.delegate_.createRoute && this.delegate_.createRoute(mediaSource, sinkId, originalPresentationId, origin, frameTreeNodeId, timeout, offTheRecord);
  }
  MediaRouteProviderStub.prototype.joinRoute = function(mediaSource, presentationId, origin, frameTreeNodeId, timeout, offTheRecord) {
    return this.delegate_ && this.delegate_.joinRoute && this.delegate_.joinRoute(mediaSource, presentationId, origin, frameTreeNodeId, timeout, offTheRecord);
  }
  ...
  MediaRouteProviderStub.prototype.startObservingMediaRoutes = function() {
    return this.delegate_ && this.delegate_.startObservingMediaRoutes && this.delegate_.startObservingMediaRoutes();
  }
  ...
  MediaRouteProviderStub.prototype.acceptWithResponder =
    ...
    case kMediaRouteProvider_CreateRoute_Name:
      ...
      this.createRoute(params.mediaSource, params.sinkId, params.originalPresentationId, params.origin, params.frameTreeNodeId, params.timeout, params.offTheRecord).then(function(response) {
        var responseParams =
    ...
    case kMediaRouteProvider_JoinRoute_Name:
      ...
      this.joinRoute(params.mediaSource, params.presentationId, params.origin, params.frameTreeNodeId, params.timeout, params.offTheRecord).then(function(response) {
        var responseParams =
  ...
  var kMediaRouter_OnPresentationConnectionStateChanged_Name = 4;
  var kMediaRouter_OnPresentationConnectionClosed_Name = 5;
  var kMediaRouter_OnRouteMessagesReceived_Name = 6;
  var kMediaRouter_GetMediaSinkServiceStatus_Name = 7;
  var kMediaRouter_GetLogger_Name = 8;
  var kMediaRouter_GetLogsAsString_Name = 9;
  ...
  MediaRouterProxy.prototype.getMirroringServiceHostForTab = function(frameTreeNodeId, receiver) {
  ...
  MediaRouterProxy.prototype.getMirroringServiceHostForDesktop = function(desktopStreamId, receiver) {
  ...
  MediaRouterStub.prototype.onRoutesUpdated = function(providerId, routes) {
    return this.delegate_ && this.delegate_.onRoutesUpdated && this.delegate_.onRoutesUpdated(providerId, routes);
  }
  ...
  MediaRouterStub.prototype.getMirroringServiceHostForTab = function(frameTreeNodeId, receiver) {
    return this.delegate_ && this.delegate_.getMirroringServiceHostForTab && this.delegate_.getMirroringServiceHostForTab(frameTreeNodeId, receiver);
  }
  MediaRouterStub.prototype.getMirroringServiceHostForDesktop = function(desktopStreamId, receiver) {
    return this.delegate_ && this.delegate_.getMirroringServiceHostForDesktop && this.delegate_.getMirroringServiceHostForDesktop(desktopStreamId, receiver);
  }
  ...
  MediaRouterStub.prototype.accept = function(message) {
    ...
    case kMediaRouter_OnRoutesUpdated_Name:
      ...
      this.onRoutesUpdated(params.providerId, params.routes);
      return true;
    ...
    case kMediaRouter_GetMirroringServiceHostForTab_Name:
      ...
      this.getMirroringServiceHostForTab(params.frameTreeNodeId, params.receiver);
      return true;
    case kMediaRouter_GetMirroringServiceHostForDesktop_Name:
      ...
      this.getMirroringServiceHostForDesktop(params.desktopStreamId, params.receiver);
      return true;
