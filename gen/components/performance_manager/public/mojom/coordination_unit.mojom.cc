...
void DocumentCoordinationUnitInterceptorForTesting::OnWebMemoryMeasurementRequested(::performance_manager::mojom::WebMemoryMeasurement::Mode mode, OnWebMemoryMeasurementRequestedCallback callback) {
...
void DocumentCoordinationUnitAsyncWaiter::OnWebMemoryMeasurementRequested(
  ...
  proxy_->OnWebMemoryMeasurementRequested(std::move(mode),
      base::BindOnce(
          [](base::RunLoop* loop,
             ::performance_manager::mojom::WebMemoryMeasurementPtr* out_measurement
,
             ::performance_manager::mojom::WebMemoryMeasurementPtr measurement) {*out_measurement = std::move(measurement);
            loop->Quit();
          },
          &loop,
          out_measurement));
...
void ProcessCoordinationUnitInterceptorForTesting::OnV8ContextCreated(::performance_manager::mojom::V8ContextDescriptionPtr description, ::performance_manager::mojom::IframeAttributionDataPtr iframe_attribution_data) {
...
void ProcessCoordinationUnitInterceptorForTesting::OnRemoteIframeAttached(const ::blink::LocalFrameToken& parent_frame_token, const ::blink::RemoteFrameToken& remote_frame_token, ::performance_manager::mojom::IframeAttributionDataPtr iframe_attribution_data) {
