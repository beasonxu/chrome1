...
PROTOBUF_CONSTEXPR ReadingListLocal::ReadingListLocal(
  ...
  , distilled_path_(&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{})
  , backoff_(&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{})
  , distilled_url_(&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{})
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 ReadingListLocalDefaultTypeInternal _ReadingListLocal_default_instance_;
PROTOBUF_CONSTEXPR ReadingListContentSuggestionsExtra::ReadingListContentSuggestionsExtra(
    ::_pbi::ConstantInitialized)
  : dismissed_(false){}
struct ReadingListContentSuggestionsExtraDefaultTypeInternal {
  PROTOBUF_CONSTEXPR ReadingListContentSuggestionsExtraDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~ReadingListContentSuggestionsExtraDefaultTypeInternal() {}
  union {
    ReadingListContentSuggestionsExtra _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 ReadingListContentSuggestionsExtraDefaultTypeInternal _ReadingListContentSuggestionsExtra_default_instance_;
}  // namespace reading_list
namespace reading_list {
...
ReadingListLocal::ReadingListLocal(const ReadingListLocal& from)
  ...
  distilled_path_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    distilled_path_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (from._internal_has_distilled_path()) {
    distilled_path_.Set(from._internal_distilled_path(), 
      GetArenaForAllocation());
  }
  backoff_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    backoff_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (from._internal_has_backoff()) {
    backoff_.Set(from._internal_backoff(), 
      GetArenaForAllocation());
  }
  distilled_url_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    distilled_url_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (from._internal_has_distilled_url()) {
    distilled_url_.Set(from._internal_distilled_url(), 
      GetArenaForAllocation());
  }
  if (from._internal_has_content_suggestions_extra()) {
  ...
  ::memcpy(&creation_time_us_, &from.creation_time_us_,
    static_cast<size_t>(reinterpret_cast<char*>(&estimated_read_time_seconds_) -
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    reinterpret_cast<char*>(&content_suggestions_extra_) - reinterpret_cast<char*>(this)),
    0, static_cast<size_t>(reinterpret_cast<char*>(&estimated_read_time_seconds_) -
    reinterpret_cast<char*>(&content_suggestions_extra_)) + sizeof(estimated_read_time_seconds_));
}
...
inline void ReadingListLocal::SharedDtor() {
  ...
  title_.Destroy();
  url_.Destroy();
  distilled_path_.Destroy();
  backoff_.Destroy();
  distilled_url_.Destroy();
...
// @@protoc_insertion_point(message_clear_start:reading_list.ReadingListLocal)
  ...
  if (cached_has_bits & 0x0000007fu) {
    ...
    if (cached_has_bits & 0x00000008u) {
      distilled_path_.ClearNonDefaultToEmpty();
    }
    if (cached_has_bits & 0x00000010u) {
      backoff_.ClearNonDefaultToEmpty();
    }
    if (cached_has_bits & 0x00000020u) {
      distilled_url_.ClearNonDefaultToEmpty();
    }
    ...
    switch (tag >> 3) {
      ...
      case 9:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 72)) {
          ...
          failed_download_counter_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 14:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 112)) {
          ...
          distillation_time_us_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 15:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 120)) {
          ...
          distillation_size_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 16:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 130)) {
          ptr = ctx->ParseMessage(_internal_mutable_content_suggestions_extra(), ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* ReadingListLocal::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000400u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteEnumToArray(
      7, this->_internal_distillation_state(), target);
  }

  // optional string distilled_path = 8;
  if (cached_has_bits & 0x00000008u) {
    target = stream->WriteStringMaybeAliased(
        8, this->_internal_distilled_path(), target);
  }
  ...
  if (cached_has_bits & 0x00000010u) {
    target = stream->WriteStringMaybeAliased(
        10, this->_internal_backoff(), target);
  }
  ...
  if (cached_has_bits & 0x00000020u) {
    target = stream->WriteStringMaybeAliased(
        13, this->_internal_distilled_url(), target);
  }
  ...
  if (cached_has_bits & 0x00000040u) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(16, _Internal::content_suggestions_extra(this),
        _Internal::content_suggestions_extra(this).GetCachedSize(), target, stream);
  }
...
// @@protoc_insertion_point(message_byte_size_start:reading_list.ReadingListLocal)
  ...
  if (cached_has_bits & 0x0000ff00u) {
    ...
    if (cached_has_bits & 0x00000400u) {
      total_size += 1 +
        ::_pbi::WireFormatLite::EnumSize(this->_internal_distillation_state());
    }
  ...
  if (cached_has_bits & 0x00010000u) {
    total_size += 2 +
      ::_pbi::WireFormatLite::Int32Size(
        this->_internal_estimated_read_time_seconds());
  }
...
void ReadingListLocal::CheckTypeAndMergeFrom(
  ...
  MergeFrom(*::_pbi::DownCast<const ReadingListLocal*>(
      &from));
}
...
// @@protoc_insertion_point(class_specific_merge_from_start:reading_list.ReadingListLocal)
  ...
  if (cached_has_bits & 0x000000ffu) {
    ...
    if (cached_has_bits & 0x00000008u) {
      _internal_set_distilled_path(from._internal_distilled_path());
    }
    if (cached_has_bits & 0x00000010u) {
      _internal_set_backoff(from._internal_backoff());
    }
    if (cached_has_bits & 0x00000020u) {
      _internal_set_distilled_url(from._internal_distilled_url());
    }
    if (cached_has_bits & 0x00000040u) {
      _internal_mutable_content_suggestions_extra()->::reading_list::ReadingListContentSuggestionsExtra::MergeFrom(from._internal_content_suggestions_extra());
    }
    if (cached_has_bits & 0x00000080u) {
  ...
  if (cached_has_bits & 0x00010000u) {
    _internal_set_estimated_read_time_seconds(from._internal_estimated_read_time_seconds());
  }
  _internal_metadata_.MergeFrom<std::string>(from._internal_metadata_);
}
...
void ReadingListLocal::InternalSwap(ReadingListLocal* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &distilled_path_, lhs_arena,
      &other->distilled_path_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &backoff_, lhs_arena,
      &other->backoff_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &distilled_url_, lhs_arena,
      &other->distilled_url_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(ReadingListLocal, estimated_read_time_seconds_)
      + sizeof(ReadingListLocal::estimated_read_time_seconds_)
      - PROTOBUF_FIELD_OFFSET(ReadingListLocal, content_suggestions_extra_)>(
          reinterpret_cast<char*>(&content_suggestions_extra_),
          reinterpret_cast<char*>(&other->content_suggestions_extra_));
}
...
ReadingListContentSuggestionsExtra::ReadingListContentSuggestionsExtra(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::MessageLite(arena, is_message_owned) {
  SharedCtor();
  // @@protoc_insertion_point(arena_constructor:reading_list.ReadingListContentSuggestionsExtra)
}
...
inline void ReadingListContentSuggestionsExtra::SharedCtor() {
dismissed_ = false;
}
...
inline void ReadingListContentSuggestionsExtra::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
}
...
const char* ReadingListContentSuggestionsExtra::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  _Internal::HasBits has_bits{};
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 8)) {
          ...
          dismissed_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* ReadingListContentSuggestionsExtra::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:reading_list.ReadingListContentSuggestionsExtra)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (cached_has_bits & 0x00000001u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteBoolToArray(1, this->_internal_dismissed(), target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:reading_list.ReadingListContentSuggestionsExtra)
  return target;
}
...
void ReadingListContentSuggestionsExtra::CheckTypeAndMergeFrom(
    const ::PROTOBUF_NAMESPACE_ID::MessageLite& from) {
  MergeFrom(*::_pbi::DownCast<const ReadingListContentSuggestionsExtra*>(
      &from));
}
...
// @@protoc_insertion_point(class_specific_merge_from_start:reading_list.ReadingListContentSuggestionsExtra)
  ...
  if (from._internal_has_dismissed()) {
    _internal_set_dismissed(from._internal_dismissed());
  }
  _internal_metadata_.MergeFrom<std::string>(from._internal_metadata_);
}
...
template<> PROTOBUF_NOINLINE ::reading_list::ReadingListContentSuggestionsExtra*
Arena::CreateMaybeMessage< ::reading_list::ReadingListContentSuggestionsExtra >(Arena* arena) {
  return Arena::CreateMessageInternal< ::reading_list::ReadingListContentSuggestionsExtra >(arena);
}
