...
class Entry final :
 ...
 public:
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::protodb::CustomData >*
      mutable_custom_data();
  private:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::protodb::CustomData >&
      custom_data() const;
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_target_file_path(ArgT0&& arg0, ArgT... args);
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_response_headers(ArgT0&& arg0, ArgT... args);
  ...
  public:
  void unsafe_arena_set_allocated_scheduling_params(
  ...
  public:
  void unsafe_arena_set_allocated_request_params(
...
inline bool Entry::_internal_has_scheduling_params() const {
  ...
  PROTOBUF_ASSUME(!value || scheduling_params_ != nullptr);
  return value;
}
  ...
  if (scheduling_params) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(
                reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(scheduling_params));
...
inline bool Entry::_internal_has_request_params() const {
  ...
  PROTOBUF_ASSUME(!value || request_params_ != nullptr);
  return value;
}
...
inline void Entry::set_allocated_request_params(::protodb::RequestParams* request_params) {
  ...
  if (request_params) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(
                reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(request_params));
    if (message_arena != submessage_arena) {
...
inline void Entry::clear_target_file_path() {
  target_file_path_.ClearToEmpty();
  _has_bits_[0] &= ~0x00000002u;
}
...
void Entry::set_target_file_path(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000002u;
 target_file_path_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline const std::string& Entry::_internal_target_file_path() const {
  return target_file_path_.Get();
}
inline void Entry::_internal_set_target_file_path(const std::string& value) {
  _has_bits_[0] |= 0x00000002u;
  target_file_path_.Set(value, GetArenaForAllocation());
}
inline std::string* Entry::_internal_mutable_target_file_path() {
  _has_bits_[0] |= 0x00000002u;
  return target_file_path_.Mutable(GetArenaForAllocation());
}
inline std::string* Entry::release_target_file_path() {
  ...
  _has_bits_[0] &= ~0x00000002u;
  auto* p = target_file_path_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (target_file_path_.IsDefault()) {
...
inline void Entry::set_allocated_target_file_path(std::string* target_file_path) {
  ...
  target_file_path_.SetAllocated(target_file_path, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (target_file_path_.IsDefault()) {
    target_file_path_.Set("", GetArenaForAllocation());
  }
...
inline void Entry::clear_response_headers() {
  response_headers_.ClearToEmpty();
...
void Entry::set_response_headers(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000004u;
 response_headers_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void Entry::_internal_set_response_headers(const std::string& value) {
  _has_bits_[0] |= 0x00000004u;
  response_headers_.Set(value, GetArenaForAllocation());
}
inline std::string* Entry::_internal_mutable_response_headers() {
  _has_bits_[0] |= 0x00000004u;
  return response_headers_.Mutable(GetArenaForAllocation());
}
inline std::string* Entry::release_response_headers() {
  ...
  _has_bits_[0] &= ~0x00000004u;
  auto* p = response_headers_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (response_headers_.IsDefault()) {
...
inline void Entry::set_allocated_response_headers(std::string* response_headers) {
  ...
  response_headers_.SetAllocated(response_headers, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (response_headers_.IsDefault()) {
    response_headers_.Set("", GetArenaForAllocation());
  }
