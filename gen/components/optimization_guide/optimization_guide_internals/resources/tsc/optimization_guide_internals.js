 ...
 * @returns string
 */
function getChromiumSourceLink(sourceFile, sourceLine) {
    ...
    return `<a href="https://source.chromium.org/chromium/chromium/src/+/main:${sourceFile.slice(6)};l=${sourceLine}">${fileName}(${sourceLine})</a>`;
}
/**
...
function initialize() {
    ...
    getProxy().getCallbackRouter().onLogMessageAdded.addListener((eventTime, logSource, sourceFile, sourceLine, message) => {
