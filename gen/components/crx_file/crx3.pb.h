...
class CrxFileHeader final :
 ...
 public:
  ...
  protected:
  explicit CrxFileHeader(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  void set_verified_contents(ArgT0&& arg0, ArgT... args);
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_signed_header_data(ArgT0&& arg0, ArgT... args);
...
class AsymmetricKeyProof final :
 ...
 public:
  ...
  protected:
  explicit AsymmetricKeyProof(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
...
class SignedData final :
 ...
 public:
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_crx_id(ArgT0&& arg0, ArgT... args);
...
inline void CrxFileHeader::clear_verified_contents() {
  verified_contents_.ClearToEmpty();
...
void CrxFileHeader::set_verified_contents(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 verified_contents_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void CrxFileHeader::_internal_set_verified_contents(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  verified_contents_.Set(value, GetArenaForAllocation());
}
inline std::string* CrxFileHeader::_internal_mutable_verified_contents() {
  _has_bits_[0] |= 0x00000001u;
  return verified_contents_.Mutable(GetArenaForAllocation());
}
inline std::string* CrxFileHeader::release_verified_contents() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  auto* p = verified_contents_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (verified_contents_.IsDefault()) {
...
inline void CrxFileHeader::set_allocated_verified_contents(std::string* verified_contents) {
  ...
  verified_contents_.SetAllocated(verified_contents, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (verified_contents_.IsDefault()) {
    verified_contents_.Set("", GetArenaForAllocation());
  }
...
inline void CrxFileHeader::clear_signed_header_data() {
  signed_header_data_.ClearToEmpty();
...
void CrxFileHeader::set_signed_header_data(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000002u;
 signed_header_data_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* CrxFileHeader::release_signed_header_data() {
  ...
  _has_bits_[0] &= ~0x00000002u;
  auto* p = signed_header_data_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (signed_header_data_.IsDefault()) {
...
inline void CrxFileHeader::set_allocated_signed_header_data(std::string* signed_header_data) {
  ...
  signed_header_data_.SetAllocated(signed_header_data, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (signed_header_data_.IsDefault()) {
    signed_header_data_.Set("", GetArenaForAllocation());
  }
...
void SignedData::set_crx_id(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 crx_id_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void SignedData::_internal_set_crx_id(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  crx_id_.Set(value, GetArenaForAllocation());
}
inline std::string* SignedData::_internal_mutable_crx_id() {
  _has_bits_[0] |= 0x00000001u;
  return crx_id_.Mutable(GetArenaForAllocation());
}
inline std::string* SignedData::release_crx_id() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  auto* p = crx_id_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (crx_id_.IsDefault()) {
...
inline void SignedData::set_allocated_crx_id(std::string* crx_id) {
  ...
  crx_id_.SetAllocated(crx_id, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (crx_id_.IsDefault()) {
    crx_id_.Set("", GetArenaForAllocation());
  }
