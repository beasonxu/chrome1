...
#ifndef COMPONENTS_SCHEMA_ORG_COMMON_METADATA_MOJOM_BLINK_JUMBO_H_
#define COMPONENTS_SCHEMA_ORG_COMMON_METADATA_MOJOM_BLINK_JUMBO_H_
#endif
...
Values::Values() : tag_(Tag::kBoolValues) {
...
bool StructTraits<::schema_org::mojom::blink::Property::DataView, ::schema_org::mojom::blink::PropertyPtr>::Read(
    ::schema_org::mojom::blink::Property::DataView input,
    ::schema_org::mojom::blink::PropertyPtr* output) {
  bool success = true;
...
bool StructTraits<::schema_org::mojom::blink::Entity::DataView, ::schema_org::mojom::blink::EntityPtr>::Read(
    ::schema_org::mojom::blink::Entity::DataView input,
    ::schema_org::mojom::blink::EntityPtr* output) {
  bool success = true;
...
bool UnionTraits<::schema_org::mojom::blink::Values::DataView, ::schema_org::mojom::blink::ValuesPtr>::Read(
    ::schema_org::mojom::blink::Values::DataView input,
    ::schema_org::mojom::blink::ValuesPtr* output) {
