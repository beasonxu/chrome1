...
MOVE_TO, 11.71f, 17.99f,
CUBIC_TO, 8.53f, 17.84f, 6, 15.22f, 6, 12,
R_CUBIC_TO, 0, -3.31f, 2.69f, -6, 6, -6,
R_CUBIC_TO, 3.22f, 0, 5.84f, 2.53f, 5.99f, 5.71f,
R_LINE_TO, -2.1f, -0.63f,
CUBIC_TO, 15.48f, 9.31f, 13.89f, 8, 12, 8,
R_CUBIC_TO, -2.21f, 0, -4, 1.79f, -4, 4,
R_CUBIC_TO, 0, 1.89f, 1.31f, 3.48f, 3.08f, 3.89f,
LINE_TO, 11.71f, 17.99f,
CLOSE,
MOVE_TO, 22, 12,
R_CUBIC_TO, 0, 0.3f, -0.01f, 0.6f, -0.04f, 0.9f,
R_LINE_TO, -1.97f, -0.59f,
CUBIC_TO, 20, 12.21f, 20, 12.1f, 20, 12,
R_CUBIC_TO, 0, -4.42f, -3.58f, -8, -8, -8,
R_CUBIC_TO, -4.42f, 0, -8, 3.58f, -8, 8,
R_CUBIC_TO, 0, 4.42f, 3.58f, 8, 8, 8,
R_CUBIC_TO, 0.1f, 0, 0.21f, 0, 0.31f, -0.01f,
R_LINE_TO, 0.59f, 1.97f,
CUBIC_TO, 12.6f, 21.99f, 12.3f, 22, 12, 22,
CUBIC_TO, 6.48f, 22, 2, 17.52f, 2, 12,
CUBIC_TO, 2, 6.48f, 6.48f, 2, 12, 2,
CUBIC_TO_SHORTHAND, 22, 6.48f, 22, 12,
CLOSE,
MOVE_TO, 18.23f, 16.26f,
LINE_TO, 22, 15,
R_LINE_TO, -10, -3,
R_LINE_TO, 3, 10,
R_LINE_TO, 1.26f, -3.77f,
R_LINE_TO, 4.27f, 4.27f,
R_LINE_TO, 1.98f, -1.98f,
LINE_TO, 18.23f, 16.26f,
CLOSE)
...
MOVE_TO, 23.62f, 11.27f,
R_CUBIC_TO, -2.03f, -1.72f, -4.46f, -3, -7.12f, -3.69f,
CUBIC_TO, 15.06f, 7.21f, 13.56f, 7, 12, 7,
R_CUBIC_TO, -1.56f, 0, -3.06f, 0.21f, -4.5f, 0.58f,
R_CUBIC_TO, -2.66f, 0.69f, -5.08f, 1.96f, -7.12f, 3.69f,
R_CUBIC_TO, -0.45f, 0.38f, -0.5f, 1.07f, -0.08f, 1.49f,
R_LINE_TO, 0.67f, 0.67f,
R_LINE_TO, 2.26f, 2.26f,
R_CUBIC_TO, 0.33f, 0.33f, 0.85f, 0.39f, 1.25f, 0.13f,
R_LINE_TO, 2.56f, -1.64f,
R_CUBIC_TO, 0.29f, -0.18f, 0.46f, -0.5f, 0.46f, -0.84f,
V_LINE_TO, 9.65f,
CUBIC_TO, 8.93f, 9.23f, 10.44f, 9, 12, 9,
R_CUBIC_TO, 1.56f, 0, 3.07f, 0.23f, 4.5f, 0.65f,
R_V_LINE_TO, 3.68f,
R_CUBIC_TO, 0, 0.34f, 0.17f, 0.66f, 0.46f, 0.84f,
R_LINE_TO, 2.56f, 1.64f,
R_CUBIC_TO, 0.4f, 0.25f, 0.92f, 0.2f, 1.25f, -0.13f,
R_LINE_TO, 2.26f, -2.26f,
R_LINE_TO, 0.67f, -0.67f,
R_CUBIC_TO, 0.41f, -0.41f, 0.37f, -1.1f, -0.08f, -1.48f,
CLOSE)
...
MOVE_TO, 4, 12,
R_LINE_TO, 8, -8)
VECTOR_ICON_TEMPLATE_CC(kCloseRoundedRepList, kCloseRoundedIcon, {kCloseRoundedPath, std::size(kCloseRoundedPath)}, {kCloseRounded16Path, std::size(kCloseRounded16Path)})
VECTOR_ICON_REP_TEMPLATE(kCloudDownloadPath, CANVAS_DIMENSIONS, 24,
...
CLOSE)
VECTOR_ICON_TEMPLATE_CC(kCloudDownloadRepList, kCloudDownloadIcon, {kCloudDownloadPath, std::size(kCloudDownloadPath)})
...
QUADRATIC_TO, 7, 16.83f, 7, 16,
V_LINE_TO, 4,
R_QUADRATIC_TO, 0, -0.82f, 0.59f, -1.41f,
QUADRATIC_TO, 8.18f, 2, 9, 2,
R_H_LINE_TO, 9,
R_QUADRATIC_TO, 0.83f, 0, 1.41f, 0.59f,
QUADRATIC_TO, 20, 3.18f, 20, 4,
R_V_LINE_TO, 12,
R_QUADRATIC_TO, 0, 0.83f, -0.59f, 1.41f,
QUADRATIC_TO, 18.83f, 18, 18, 18,
CLOSE,
R_MOVE_TO, 0, -2,
R_H_LINE_TO, 9,
V_LINE_TO, 4,
...
MOVE_TO, 19, 3,
R_H_LINE_TO, -4.18f,
CUBIC_TO, 14.4f, 1.84f, 13.3f, 1, 12, 1,
CUBIC_TO_SHORTHAND, 9.6f, 1.84f, 9.18f, 3,
H_LINE_TO, 5,
CUBIC_TO, 3.9f, 3, 3, 3.9f, 3, 5,
R_V_LINE_TO, 14,
...
R_CUBIC_TO, -0.55f, 0, -1, -0.45f, -1, -1,
CUBIC_TO_SHORTHAND, 11.45f, 3, 12, 3,
CLOSE,
MOVE_TO, 19, 19,
H_LINE_TO, 5,
V_LINE_TO, 5,
...
V_LINE_TO, 19,
CLOSE)
VECTOR_ICON_TEMPLATE_CC(kContentPasteRepList, kContentPasteIcon, {kContentPastePath, std::size(kContentPastePath)})
VECTOR_ICON_REP_TEMPLATE(kContentPasteOffPath, CANVAS_DIMENSIONS, 24,
MOVE_TO, 21.19f, 21.19f,
LINE_TO, 2.81f, 2.81f,
LINE_TO, 1.39f, 4.22f,
LINE_TO, 3, 5.83f,
V_LINE_TO, 19,
...
R_V_LINE_TO, 7,
CLOSE)
VECTOR_ICON_TEMPLATE_CC(kDevicesRepList, kDevicesIcon, {kDevicesPath, std::size(kDevicesPath)})
VECTOR_ICON_REP_TEMPLATE(kDevicesOffPath, CANVAS_DIMENSIONS, 24,
MOVE_TO, 22, 9,
V_LINE_TO, 19,
LINE_TO, 20, 17,
V_LINE_TO, 10,
...
LINE_TO, 14, 11,
V_LINE_TO, 9,
CUBIC_TO, 14, 8.45f, 14.45f, 8, 15, 8,
H_LINE_TO, 21,
CUBIC_TO, 21.55f, 8, 22, 8.45f, 22, 9,
CLOSE,
MOVE_TO, 21, 6,
V_LINE_TO, 4,
H_LINE_TO, 7,
...
LINE_TO, 1.2f, 3.8f,
LINE_TO, 3.06f, 5.66f,
CUBIC_TO, 3.03f, 5.77f, 3, 5.88f, 3, 6,
V_LINE_TO, 17,
H_LINE_TO, 1,
V_LINE_TO, 20,
H_LINE_TO, 12,
...
LINE_TO, 14, 16.6f,
V_LINE_TO, 19,
CUBIC_TO, 14, 19.55f, 14.45f, 20, 15, 20,
H_LINE_TO, 17.4f,
LINE_TO, 20.4f, 23,
LINE_TO, 21.8f, 21.6f,
LINE_TO, 20.2f, 20,
...
VECTOR_ICON_REP_TEMPLATE(kFeedPath, CANVAS_DIMENSIONS, 24,
MOVE_TO, 15, 3,
H_LINE_TO, 5,
R_CUBIC_TO, -1.1f, 0, -1.99f, 0.9f, -1.99f, 2,
LINE_TO, 3, 19,
...
R_V_LINE_TO, 2,
CLOSE)
VECTOR_ICON_TEMPLATE_CC(kFeedRepList, kFeedIcon, {kFeedPath, std::size(kFeedPath)})
...
VECTOR_ICON_REP_TEMPLATE(kFileDownloadOffPath, CANVAS_DIMENSIONS, 24,
MOVE_TO, 18, 15.17f,
V_LINE_TO, 15,
R_H_LINE_TO, 2,
R_V_LINE_TO, 2.17f,
...
R_LINE_TO, 1.41f, -1.42f,
CLOSE)
VECTOR_ICON_TEMPLATE_CC(kFileDownloadOffRepList, kFileDownloadOffIcon, {kFileDownloadOffPath, std::size(kFileDownloadOffPath)})
...
LINE_TO, 10, 9,
CLOSE)
VECTOR_ICON_TEMPLATE_CC(kFolderManagedRepList, kFolderManagedIcon, {kFolderManagedPath, std::size(kFolderManagedPath)}, {kFolderManaged16Path, std::size(kFolderManaged16Path)})
...
R_V_LINE_TO, -1,
CLOSE)
VECTOR_ICON_TEMPLATE_CC(kFolderManagedTouchRepList, kFolderManagedTouchIcon, {kFolderManagedTouchPath, std::size(kFolderManagedTouchPath)})
...
R_LINE_TO, -2, -2,
CLOSE)
VECTOR_ICON_TEMPLATE_CC(kFolderTouchRepList, kFolderTouchIcon, {kFolderTouchPath, std::size(kFolderTouchPath)})
...
CLOSE)
VECTOR_ICON_TEMPLATE_CC(kForwardArrowRepList, kForwardArrowIcon, {kForwardArrowPath, std::size(kForwardArrowPath)}, {kForwardArrow16Path, std::size(kForwardArrow16Path)})
...
CLOSE)
VECTOR_ICON_TEMPLATE_CC(kGoogleColorRepList, kGoogleColorIcon, {kGoogleColorPath, std::size(kGoogleColorPath)}, {kGoogleColor24Path, std::size(kGoogleColor24Path)})
VECTOR_ICON_REP_TEMPLATE(kGppMaybePath, CANVAS_DIMENSIONS, 24,
MOVE_TO, 12, 4.24f,
R_LINE_TO, 6, 3,
R_V_LINE_TO, 4.1f,
R_CUBIC_TO, 0, 3.9f, -2.55f, 7.5f, -6, 8.59f,
R_CUBIC_TO, -3.45f, -1.09f, -6, -4.7f, -6, -8.59f,
R_V_LINE_TO, -4.1f,
R_LINE_TO, 6, -3,
MOVE_TO, 12, 2,
LINE_TO, 4, 6,
R_V_LINE_TO, 5.33f,
R_CUBIC_TO, 0, 4.93f, 3.41f, 9.55f, 8, 10.67f,
R_CUBIC_TO, 4.59f, -1.12f, 8, -5.73f, 8, -10.67f,
V_LINE_TO, 6,
R_LINE_TO, -8, -4,
CLOSE,
R_MOVE_TO, -1, 13,
...
VECTOR_ICON_REP_TEMPLATE(kGroupsPath, CANVAS_DIMENSIONS, 24,
NEW_PATH,
MOVE_TO, 4, 13,
R_CUBIC_TO, 1.1f, 0, 2, -0.9f, 2, -2,
R_CUBIC_TO, 0, -1.1f, -0.9f, -2, -2, -2,
R_CUBIC_TO, -1.1f, 0, -2, 0.9f, -2, 2,
CUBIC_TO, 2, 12.1f, 2.9f, 13, 4, 13,
CLOSE,
MOVE_TO, 5.13f, 14.1f,
CUBIC_TO, 4.76f, 14.04f, 4.39f, 14, 4, 14,
R_CUBIC_TO, -0.99f, 0, -1.93f, 0.21f, -2.78f, 0.58f,
CUBIC_TO, 0.48f, 14.9f, 0, 15.62f, 0, 16.43f,
V_LINE_TO, 18,
R_LINE_TO, 4.5f, 0,
R_V_LINE_TO, -1.61f,
CUBIC_TO, 4.5f, 15.56f, 4.73f, 14.78f, 5.13f, 14.1f,
CLOSE,
MOVE_TO, 20, 13,
R_CUBIC_TO, 1.1f, 0, 2, -0.9f, 2, -2,
R_CUBIC_TO, 0, -1.1f, -0.9f, -2, -2, -2,
R_CUBIC_TO, -1.1f, 0, -2, 0.9f, -2, 2,
CUBIC_TO, 18, 12.1f, 18.9f, 13, 20, 13,
CLOSE,
MOVE_TO, 24, 16.43f,
R_CUBIC_TO, 0, -0.81f, -0.48f, -1.53f, -1.22f, -1.85f,
CUBIC_TO, 21.93f, 14.21f, 20.99f, 14, 20, 14,
R_CUBIC_TO, -0.39f, 0, -0.76f, 0.04f, -1.13f, 0.1f,
R_CUBIC_TO, 0.4f, 0.68f, 0.63f, 1.46f, 0.63f, 2.29f,
V_LINE_TO, 18,
R_LINE_TO, 4.5f, 0,
V_LINE_TO, 16.43f,
CLOSE,
MOVE_TO, 16.24f, 13.65f,
R_CUBIC_TO, -1.17f, -0.52f, -2.61f, -0.9f, -4.24f, -0.9f,
R_CUBIC_TO, -1.63f, 0, -3.07f, 0.39f, -4.24f, 0.9f,
CUBIC_TO, 6.68f, 14.13f, 6, 15.21f, 6, 16.39f,
V_LINE_TO, 18,
R_H_LINE_TO, 12,
R_V_LINE_TO, -1.61f,
CUBIC_TO, 18, 15.21f, 17.32f, 14.13f, 16.24f, 13.65f,
CLOSE,
MOVE_TO, 8.07f, 16,
R_CUBIC_TO, 0.09f, -0.23f, 0.13f, -0.39f, 0.91f, -0.69f,
R_CUBIC_TO, 0.97f, -0.38f, 1.99f, -0.56f, 3.02f, -0.56f,
R_CUBIC_TO, 1.03f, 0, 2.05f, 0.18f, 3.02f, 0.56f,
R_CUBIC_TO, 0.77f, 0.3f, 0.81f, 0.46f, 0.91f, 0.69f,
H_LINE_TO, 8.07f,
CLOSE,
MOVE_TO, 12, 8,
R_CUBIC_TO, 0.55f, 0, 1, 0.45f, 1, 1,
R_CUBIC_TO, 0, 0.55f, -0.45f, 1, -1, 1,
R_CUBIC_TO, -0.55f, 0, -1, -0.45f, -1, -1,
CUBIC_TO_SHORTHAND, 11.45f, 8, 12, 8,
MOVE_TO, 12, 6,
R_CUBIC_TO, -1.66f, 0, -3, 1.34f, -3, 3,
R_CUBIC_TO, 0, 1.66f, 1.34f, 3, 3, 3,
R_CUBIC_TO, 1.66f, 0, 3, -1.34f, 3, -3,
CUBIC_TO, 15, 7.34f, 13.66f, 6, 12, 6,
LINE_TO, 12, 6,
CLOSE)
VECTOR_ICON_TEMPLATE_CC(kGroupsRepList, kGroupsIcon, {kGroupsPath, std::size(kGroupsPath)})
...
CLOSE)
VECTOR_ICON_TEMPLATE_CC(kHelpOutlineRepList, kHelpOutlineIcon, {kHelpOutlinePath, std::size(kHelpOutlinePath)}, {kHelpOutline20Path, std::size(kHelpOutline20Path)})
...
H_LINE_TO, 6,
CLOSE)
VECTOR_ICON_TEMPLATE_CC(kHttpsValidRepList, kHttpsValidIcon, {kHttpsValidPath, std::size(kHttpsValidPath)}, {kHttpsValid16Path, std::size(kHttpsValid16Path)})
VECTOR_ICON_REP_TEMPLATE(kHttpsValidArrowPath, CANVAS_DIMENSIONS, 16,
NEW_PATH,
...
CLOSE)
VECTOR_ICON_TEMPLATE_CC(kHttpsValidArrowRepList, kHttpsValidArrowIcon, {kHttpsValidArrowPath, std::size(kHttpsValidArrowPath)})
...
VECTOR_ICON_REP_TEMPLATE(kLiveCaptionOffPath, CANVAS_DIMENSIONS, 20,
MOVE_TO, 3.5f, 4,
H_LINE_TO, 4,
R_LINE_TO, 2, 2,
H_LINE_TO, 4,
...
R_LINE_TO, -1.41f, 1.41f,
CLOSE)
VECTOR_ICON_TEMPLATE_CC(kLiveCaptionOffRepList, kLiveCaptionOffIcon, {kLiveCaptionOffPath, std::size(kLiveCaptionOffPath)})
...
VECTOR_ICON_REP_TEMPLATE(kLocationOffPath, CANVAS_DIMENSIONS, 24,
MOVE_TO, 12, 6.88f,
...
LINE_TO, 2.81f, 2.81f,
CLOSE)
VECTOR_ICON_TEMPLATE_CC(kLocationOffRepList, kLocationOffIcon, {kLocationOffPath, std::size(kLocationOffPath)})
...
CLOSE)
VECTOR_ICON_TEMPLATE_CC(kLocationOnRepList, kLocationOnIcon, {kLocationOnPath, std::size(kLocationOnPath)}, {kLocationOn16Path, std::size(kLocationOn16Path)})
...
V_LINE_TO, 4.38f,
CLOSE)
VECTOR_ICON_TEMPLATE_CC(kMediaRouterActiveRepList, kMediaRouterActiveIcon, {kMediaRouterActivePath, std::size(kMediaRouterActivePath)})
...
R_H_LINE_TO, -1.38f,
CLOSE)
VECTOR_ICON_TEMPLATE_CC(kMediaRouterWarningRepList, kMediaRouterWarningIcon, {kMediaRouterWarningPath, std::size(kMediaRouterWarningPath)})
...
MOVE_TO, 19, 11,
R_H_LINE_TO, -2,
R_CUBIC_TO, 0, 0.91f, -0.25f, 1.76f, -0.68f, 2.49f,
R_LINE_TO, 1.45f, 1.45f,
CUBIC_TO, 18.54f, 13.82f, 19, 12.47f, 19, 11,
CLOSE,
MOVE_TO, 2.81f, 2.81f,
LINE_TO, 1.39f, 4.22f,
R_LINE_TO, 11.66f, 11.66f,
CUBIC_TO, 12.71f, 15.96f, 12.36f, 16, 12, 16,
R_CUBIC_TO, -2.76f, 0, -5, -2.24f, -5, -5,
H_LINE_TO, 5,
R_CUBIC_TO, 0, 3.53f, 2.61f, 6.43f, 6, 6.92f,
V_LINE_TO, 21,
R_H_LINE_TO, 2,
R_V_LINE_TO, -3.08f,
R_CUBIC_TO, 0.57f, -0.08f, 1.12f, -0.24f, 1.64f, -0.45f,
...
V_LINE_TO, 5,
R_CUBIC_TO, 0, -1.66f, -1.34f, -3, -3, -3,
CUBIC_TO_SHORTHAND, 9, 3.34f, 9, 5,
R_V_LINE_TO, 1.17f,
R_LINE_TO, 5.81f, 5.81f,
CUBIC_TO, 14.92f, 11.67f, 15, 11.35f, 15, 11,
CLOSE)
...
R_H_LINE_TO, 2,
R_V_LINE_TO, 8.5f,
CUBIC_TO, 13, 14.05f, 13.45f, 14.5f, 14, 14.5f,
CLOSE,
MOVE_TO, 5, 5,
R_H_LINE_TO, 2,
R_V_LINE_TO, 8.5f,
...
VECTOR_ICON_REP_TEMPLATE(kMidiOffPath, CANVAS_DIMENSIONS, 24,
MOVE_TO, 21.19f, 21.19f,
LINE_TO, 2.81f, 2.81f,
LINE_TO, 1.39f, 4.22f,
LINE_TO, 3, 5.83f,
...
R_V_LINE_TO, -4.5f,
H_LINE_TO, 10,
R_CUBIC_TO, 0.46f, 0, 0.82f, -0.31f, 0.94f, -0.73f,
R_LINE_TO, 3.31f, 3.31f,
V_LINE_TO, 19,
H_LINE_TO, 9.75f,
CLOSE,
MOVE_TO, 11, 8.17f,
...
R_H_LINE_TO, -2,
R_V_LINE_TO, 8.5f,
R_CUBIC_TO, 0, 0.19f, -0.07f, 0.36f, -0.16f, 0.51f,
LINE_TO, 13, 10.17f,
V_LINE_TO, 5,
R_H_LINE_TO, -2,
V_LINE_TO, 8.17f,
CLOSE)
VECTOR_ICON_TEMPLATE_CC(kMidiOffRepList, kMidiOffIcon, {kMidiOffPath, std::size(kMidiOffPath)})
...
R_V_LINE_TO, 3,
CLOSE)
VECTOR_ICON_TEMPLATE_CC(kNotSecureWarningRepList, kNotSecureWarningIcon, {kNotSecureWarningPath, std::size(kNotSecureWarningPath)}, {kNotSecureWarning16Path, std::size(kNotSecureWarning16Path)})
VECTOR_ICON_REP_TEMPLATE(kNotificationExplorePath, CANVAS_DIMENSIONS, 36,
PATH_COLOR_ARGB, 0xFF, 0xFF, 0xFF, 0xFF,
MOVE_TO, 0, 0,
R_H_LINE_TO, 36,
R_V_LINE_TO, 36,
...
CLOSE)
VECTOR_ICON_TEMPLATE_CC(kNotificationExploreRepList, kNotificationExploreIcon, {kNotificationExplorePath, std::size(kNotificationExplorePath)})
...
LINE_TO, 36, 29.36f,
CLOSE)
VECTOR_ICON_TEMPLATE_CC(kNotificationsOffRepList, kNotificationsOffIcon, {kNotificationsOffPath, std::size(kNotificationsOffPath)})
...
H_LINE_TO, 28,
CLOSE)
VECTOR_ICON_TEMPLATE_CC(kOpenInNewRepList, kOpenInNewIcon, {kOpenInNewPath, std::size(kOpenInNewPath)})
...
VECTOR_ICON_REP_TEMPLATE(kQrCodePath, CANVAS_DIMENSIONS, 20,
MOVE_TO, 2.5f, 9.13f,
V_LINE_TO, 2.5f,
R_H_LINE_TO, 6.63f,
R_V_LINE_TO, 6.63f,
...
R_V_LINE_TO, 1.65f,
CLOSE)
VECTOR_ICON_TEMPLATE_CC(kQrCodeRepList, kQrCodeIcon, {kQrCodePath, std::size(kQrCodePath)})
...
R_H_LINE_TO, 3,
CLOSE)
VECTOR_ICON_TEMPLATE_CC(kSaveOriginalFileRepList, kSaveOriginalFileIcon, {kSaveOriginalFilePath, std::size(kSaveOriginalFilePath)})
...
R_V_LINE_TO, 8,
CLOSE)
VECTOR_ICON_TEMPLATE_CC(kSubmenuArrowRepList, kSubmenuArrowIcon, {kSubmenuArrowPath, std::size(kSubmenuArrowPath)}, {kSubmenuArrow8Path, std::size(kSubmenuArrow8Path)})
...
VECTOR_ICON_REP_TEMPLATE(kTextDecreasePath, CANVAS_DIMENSIONS, 24,
MOVE_TO, 1, 19,
LINE_TO, 6.25f, 5,
H_LINE_TO, 8.75f,
LINE_TO, 14, 19,
...
V_LINE_TO, 13,
CLOSE)
VECTOR_ICON_TEMPLATE_CC(kTextDecreaseRepList, kTextDecreaseIcon, {kTextDecreasePath, std::size(kTextDecreasePath)})
VECTOR_ICON_REP_TEMPLATE(kTextIncreasePath, CANVAS_DIMENSIONS, 24,
MOVE_TO, 1, 19,
LINE_TO, 6.25f, 5,
H_LINE_TO, 8.75f,
LINE_TO, 14, 19,
...
V_LINE_TO, 16,
CLOSE)
VECTOR_ICON_TEMPLATE_CC(kTextIncreaseRepList, kTextIncreaseIcon, {kTextIncreasePath, std::size(kTextIncreasePath)})
VECTOR_ICON_REP_TEMPLATE(kTroubleshootPath, CANVAS_DIMENSIONS, 24,
NEW_PATH,
MOVE_TO, 11, 2,
CUBIC_TO, 6.75f, 2, 3.28f, 5.32f, 3.03f, 9.5f,
R_H_LINE_TO, 2.03f,
R_CUBIC_TO, 0.11f, -1.37f, 0.66f, -2.7f, 1.71f, -3.74f,
CUBIC_TO, 7.94f, 4.58f, 9.47f, 4, 11.01f, 4,
R_CUBIC_TO, 1.54f, 0, 3.08f, 0.59f, 4.25f, 1.76f,
R_CUBIC_TO, 2.34f, 2.35f, 2.34f, 6.15f, 0, 8.49f,
CUBIC_TO, 14.09f, 15.41f, 12.55f, 16, 11.01f, 16,
R_CUBIC_TO, -1.54f, 0, -3.08f, -0.58f, -4.25f, -1.75f,
CUBIC_TO, 6.69f, 14.17f, 6.62f, 14.08f, 6.55f, 14,
H_LINE_TO, 4.08f,
R_CUBIC_TO, 1.38f, 2.39f, 3.96f, 4, 6.92f, 4,
R_CUBIC_TO, 1.85f, 0, 3.55f, -0.63f, 4.9f, -1.69f,
LINE_TO, 20.59f, 21,
LINE_TO, 22, 19.59f,
R_LINE_TO, -4.69f, -4.69f,
CUBIC_TO, 18.37f, 13.55f, 19, 11.85f, 19, 10,
CUBIC_TO, 19, 5.58f, 15.42f, 2, 11, 2,
LINE_TO, 11, 2,
CLOSE,
MOVE_TO, 9.15f, 6.25f,
R_H_LINE_TO, -1.5f,
...
R_V_LINE_TO, 1.5f,
R_H_LINE_TO, 5.06f,
R_LINE_TO, 1.29f, -3.71f,
LINE_TO, 9.92f, 14,
R_H_LINE_TO, 0,
R_H_LINE_TO, 1.49f,
R_H_LINE_TO, 0,
R_LINE_TO, 1.23f, -3.86f,
R_LINE_TO, 1.19f, 2.36f,
R_LINE_TO, 1.67f, 0,
R_LINE_TO, 0, 0,
V_LINE_TO, 11,
R_H_LINE_TO, -0.75f,
R_LINE_TO, -1.5f, -3,
R_H_LINE_TO, -1.5f,
R_LINE_TO, -1.07f, 3.34f,
LINE_TO, 9.15f, 6.25f,
LINE_TO, 9.15f, 6.25f,
CLOSE)
VECTOR_ICON_TEMPLATE_CC(kTroubleshootRepList, kTroubleshootIcon, {kTroubleshootPath, std::size(kTroubleshootPath)})
...
LINE_TO, 9, 6,
H_LINE_TO, 16,
CUBIC_TO, 16.55f, 6, 17, 6.45f, 17, 7,
V_LINE_TO, 10.5f,
LINE_TO, 21, 6.5f,
V_LINE_TO, 18,
CLOSE,
...
LINE_TO, 1.2f, 3.8f,
LINE_TO, 3.53f, 6.13f,
CUBIC_TO, 3.22f, 6.3f, 3, 6.62f, 3, 7,
V_LINE_TO, 17,
CUBIC_TO, 3, 17.55f, 3.45f, 18, 4, 18,
H_LINE_TO, 15.4f,
LINE_TO, 20.4f, 23,
LINE_TO, 21.8f, 21.6f,
CLOSE)
...
VECTOR_ICON_REP_TEMPLATE(kVolumeOffPath, CANVAS_DIMENSIONS, 24,
NEW_PATH,
NEW_PATH,
MOVE_TO, 2.81f, 2.81f,
LINE_TO, 1.39f, 4.22f,
...
CLOSE)
VECTOR_ICON_TEMPLATE_CC(kVolumeOffRepList, kVolumeOffIcon, {kVolumeOffPath, std::size(kVolumeOffPath)})
...
MOVE_TO, 20.91f, 6.68f,
ARC_TO, 2.54f, 2.54f, 0, 0, 0, 19.16f, 6,
H_LINE_TO, 4.9f,
R_CUBIC_TO, -0.66f, 0, -1.28f, 0.24f, -1.75f, 0.68f,
R_ARC_TO, 2.23f, 2.23f, 0, 0, 0, -0.72f, 1.64f,
R_V_LINE_TO, 7.37f,
R_CUBIC_TO, 0, 0.62f, 0.26f, 1.2f, 0.72f, 1.64f,
ARC_TO, 2.54f, 2.54f, 0, 0, 0, 4.9f, 18,
R_H_LINE_TO, 3.42f,
R_CUBIC_TO, 0.45f, 0, 0.88f, -0.11f, 1.27f, -0.33f,
R_CUBIC_TO, 0.38f, -0.22f, 0.7f, -0.52f, 0.91f, -0.89f,
R_LINE_TO, 0.97f, -1.68f,
R_ARC_TO, 0.57f, 0.57f, 0, 0, 1, 0.16f, -0.74f,
R_ARC_TO, 0.67f, 0.67f, 0, 0, 1, 0.81f, 0,
R_CUBIC_TO, 0.24f, 0.18f, 0.3f, 0.49f, 0.16f, 0.74f,
R_LINE_TO, 0.97f, 1.68f,
R_CUBIC_TO, 0.21f, 0.37f, 0.52f, 0.68f, 0.91f, 0.89f,
R_CUBIC_TO, 0.38f, 0.22f, 0.82f, 0.33f, 1.27f, 0.33f,
R_H_LINE_TO, 3.42f,
R_CUBIC_TO, 0.66f, 0, 1.28f, -0.24f, 1.75f, -0.68f,
R_CUBIC_TO, 0.47f, -0.44f, 0.72f, -1.02f, 0.72f, -1.64f,
R_V_LINE_TO, -7.37f,
R_CUBIC_TO, 0, -0.62f, -0.26f, -1.2f, -0.72f, -1.64f,
CLOSE,
MOVE_TO, 7.83f, 13.8f,
R_CUBIC_TO, -1.33f, 0, -2.4f, -1.08f, -2.4f, -2.4f,
R_CUBIC_TO, 0, -1.32f, 1.08f, -2.4f, 2.4f, -2.4f,
R_CUBIC_TO, 1.32f, 0, 2.4f, 1.08f, 2.4f, 2.4f,
R_CUBIC_TO, 0, 1.32f, -1.07f, 2.4f, -2.4f, 2.4f,
CLOSE,
R_MOVE_TO, 8.4f, 0,
R_CUBIC_TO, -1.33f, 0, -2.4f, -1.08f, -2.4f, -2.4f,
R_CUBIC_TO, 0, -1.32f, 1.08f, -2.4f, 2.4f, -2.4f,
...
VECTOR_ICON_REP_TEMPLATE(kVrHeadsetOffPath, CANVAS_DIMENSIONS, 24,
MOVE_TO, 2.81f, 2.81f,
LINE_TO, 1.39f, 4.22f,
LINE_TO, 3.68f, 6.5f,
CUBIC_TO, 3.26f, 6.87f, 3, 7.41f, 3, 8,
R_V_LINE_TO, 8,
R_CUBIC_TO, 0, 1.1f, 0.9f, 2, 2, 2,
R_H_LINE_TO, 3.53f,
R_CUBIC_TO, 1.42f, 0, 2.02f, -1.24f, 2.03f, -1.27f,
R_LINE_TO, 0.91f, -1.76f,
R_CUBIC_TO, 0.08f, -0.16f, 0.22f, -0.26f, 0.37f, -0.31f,
R_LINE_TO, 1.11f, 1.11f,
R_LINE_TO, 0.49f, 0.96f,
R_CUBIC_TO, 0.01f, 0.03f, 0.52f, 1.08f, 1.71f, 1.25f,
R_LINE_TO, 4.63f, 4.63f,
R_LINE_TO, 1.41f, -1.41f,
LINE_TO, 2.81f, 2.81f,
CLOSE,
MOVE_TO, 9.87f, 12.7f,
CUBIC_TO, 9.59f, 13.46f, 8.85f, 14, 8, 14,
R_CUBIC_TO, -1.1f, 0, -2, -0.9f, -2, -2,
R_CUBIC_TO, 0, -0.85f, 0.54f, -1.59f, 1.3f, -1.87f,
R_LINE_TO, 0, 0,
LINE_TO, 9.87f, 12.7f,
LINE_TO, 9.87f, 12.7f,
CLOSE,
MOVE_TO, 16.7f, 13.87f,
R_LINE_TO, 3.62f, 3.62f,
CUBIC_TO, 20.74f, 17.13f, 21, 16.59f, 21, 16,
V_LINE_TO, 8,
R_CUBIC_TO, 0, -1.1f, -0.9f, -2, -2, -2,
H_LINE_TO, 8.83f,
R_CUBIC_TO, 0, 0, 5.3f, 5.3f, 5.3f, 5.3f,
CUBIC_TO, 14.41f, 10.54f, 15.15f, 10, 16, 10,
R_CUBIC_TO, 1.1f, 0, 2, 0.9f, 2, 2,
CUBIC_TO, 18, 12.85f, 17.46f, 13.59f, 16.7f, 13.87f,
CLOSE)
VECTOR_ICON_TEMPLATE_CC(kVrHeadsetOffRepList, kVrHeadsetOffIcon, {kVrHeadsetOffPath, std::size(kVrHeadsetOffPath)})
...
R_V_LINE_TO, 2,
CLOSE)
VECTOR_ICON_TEMPLATE_CC(kWifiAddRepList, kWifiAddIcon, {kWifiAddPath, std::size(kWifiAddPath)})
