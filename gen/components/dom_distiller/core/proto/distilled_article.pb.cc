...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 DistilledArticleProtoDefaultTypeInternal _DistilledArticleProto_default_instance_;
}  // namespace dom_distiller
namespace dom_distiller {
...
void DistilledArticleProto::CheckTypeAndMergeFrom(
  ...
  MergeFrom(*::_pbi::DownCast<const DistilledArticleProto*>(
      &from));
}
...
bool DistilledArticleProto::IsInitialized() const {
  if (!::PROTOBUF_NAMESPACE_ID::internal::AllAreInitialized(pages_))
    return false;
  return true;
}
