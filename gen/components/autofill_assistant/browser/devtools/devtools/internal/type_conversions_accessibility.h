...
#ifndef COMPONENTS_AUTOFILL_ASSISTANT_BROWSER_DEVTOOLS_DEVTOOLS_INTERNAL_TYPE_CONVERSIONS_ACCESSIBILITY_H_
#define COMPONENTS_AUTOFILL_ASSISTANT_BROWSER_DEVTOOLS_DEVTOOLS_INTERNAL_TYPE_CONVERSIONS_ACCESSIBILITY_H_
...
std::unique_ptr<base::Value> ToValueImpl(const accessibility::AXValueNativeSourceType& value, T*) {
  switch (value) {
    ...
    case accessibility::AXValueNativeSourceType::RUBYANNOTATION:
      return std::make_unique<base::Value>("rubyannotation");
...
template <typename T>
std::unique_ptr<base::Value> ToValueImpl(const accessibility::DisableParams& value, T*) {
  return value.Serialize();
}
...
template <typename T>
std::unique_ptr<base::Value> ToValueImpl(const accessibility::DisableResult& value, T*) {
  return value.Serialize();
}
...
template <typename T>
std::unique_ptr<base::Value> ToValueImpl(const accessibility::EnableParams& value, T*) {
  return value.Serialize();
}
...
template <typename T>
std::unique_ptr<base::Value> ToValueImpl(const accessibility::EnableResult& value, T*) {
  return value.Serialize();
}
...
template <typename T>
std::unique_ptr<base::Value> ToValueImpl(const accessibility::GetFullAXTreeParams& value, T*) {
  return value.Serialize();
}
...
template <typename T>
std::unique_ptr<base::Value> ToValueImpl(const accessibility::GetFullAXTreeResult& value, T*) {
  return value.Serialize();
}
...
template <typename T>
std::unique_ptr<base::Value> ToValueImpl(const accessibility::GetRootAXNodeParams& value, T*) {
  return value.Serialize();
}
...
template <typename T>
std::unique_ptr<base::Value> ToValueImpl(const accessibility::GetRootAXNodeResult& value, T*) {
  return value.Serialize();
}
...
template <typename T>
std::unique_ptr<base::Value> ToValueImpl(const accessibility::GetAXNodeAndAncestorsParams& value, T*) {
  return value.Serialize();
}
...
template <typename T>
std::unique_ptr<base::Value> ToValueImpl(const accessibility::GetAXNodeAndAncestorsResult& value, T*) {
  return value.Serialize();
}
...
template <typename T>
std::unique_ptr<base::Value> ToValueImpl(const accessibility::GetChildAXNodesParams& value, T*) {
  return value.Serialize();
}
...
template <typename T>
std::unique_ptr<base::Value> ToValueImpl(const accessibility::GetChildAXNodesResult& value, T*) {
  return value.Serialize();
}
...
template <typename T>
std::unique_ptr<base::Value> ToValueImpl(const accessibility::QueryAXTreeParams& value, T*) {
  return value.Serialize();
}
...
template <typename T>
std::unique_ptr<base::Value> ToValueImpl(const accessibility::QueryAXTreeResult& value, T*) {
  return value.Serialize();
}
...
template <typename T>
std::unique_ptr<base::Value> ToValueImpl(const accessibility::LoadCompleteParams& value, T*) {
  return value.Serialize();
}
...
template <typename T>
std::unique_ptr<base::Value> ToValueImpl(const accessibility::NodesUpdatedParams& value, T*) {
  return value.Serialize();
}
...
#endif  // COMPONENTS_AUTOFILL_ASSISTANT_BROWSER_DEVTOOLS_DEVTOOLS_INTERNAL_TYPE_CONVERSIONS_ACCESSIBILITY_H_
