...
#include "components/autofill_assistant/browser/devtools/devtools/internal/type_conversions_system_info.h"
...
std::unique_ptr<VideoDecodeAcceleratorCapability> VideoDecodeAcceleratorCapability::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (max_resolution_value) {
    ...
    result->max_resolution_ = internal::FromValue<::autofill_assistant::system_info::Size>::Parse(*max_resolution_value, errors);
  } else {
  ...
  if (min_resolution_value) {
    ...
    result->min_resolution_ = internal::FromValue<::autofill_assistant::system_info::Size>::Parse(*min_resolution_value, errors);
  } else {
...
std::unique_ptr<ImageDecodeAcceleratorCapability> ImageDecodeAcceleratorCapability::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (image_type_value) {
    ...
    result->image_type_ = internal::FromValue<::autofill_assistant::system_info::ImageType>::Parse(*image_type_value, errors);
  } else {
  ...
  if (max_dimensions_value) {
    ...
    result->max_dimensions_ = internal::FromValue<::autofill_assistant::system_info::Size>::Parse(*max_dimensions_value, errors);
  } else {
  ...
  if (min_dimensions_value) {
    ...
    result->min_dimensions_ = internal::FromValue<::autofill_assistant::system_info::Size>::Parse(*min_dimensions_value, errors);
  } else {
  ...
  if (subsamplings_value) {
    ...
    result->subsamplings_ = internal::FromValue<std::vector<::autofill_assistant::system_info::SubsamplingFormat>>::Parse(*subsamplings_value, errors);
  } else {
...
std::unique_ptr<GPUInfo> GPUInfo::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (devices_value) {
    ...
    result->devices_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::system_info::GPUDevice>>>::Parse(*devices_value, errors);
  } else {
  ...
  if (video_decoding_value) {
    ...
    result->video_decoding_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::system_info::VideoDecodeAcceleratorCapability>>>::Parse(*video_decoding_value, errors);
  } else {
  ...
  if (video_encoding_value) {
    ...
    result->video_encoding_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::system_info::VideoEncodeAcceleratorCapability>>>::Parse(*video_encoding_value, errors);
  } else {
  ...
  if (image_decoding_value) {
    ...
    result->image_decoding_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::system_info::ImageDecodeAcceleratorCapability>>>::Parse(*image_decoding_value, errors);
  } else {
...
std::unique_ptr<GetInfoResult> GetInfoResult::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (gpu_value) {
    errors->SetName("gpu");
    result->gpu_ = internal::FromValue<::autofill_assistant::system_info::GPUInfo>::Parse(*gpu_value, errors);
  } else {
...
std::unique_ptr<GetProcessInfoResult> GetProcessInfoResult::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (process_info_value) {
    errors->SetName("processInfo");
    result->process_info_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::system_info::ProcessInfo>>>::Parse(*process_info_value, errors);
  } else {
