...
std::unique_ptr<LocationRange> LocationRange::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (start_value) {
    ...
    result->start_ = internal::FromValue<::autofill_assistant::debugger::ScriptPosition>::Parse(*start_value, errors);
  } else {
  ...
  if (end_value) {
    errors->SetName("end");
    result->end_ = internal::FromValue<::autofill_assistant::debugger::ScriptPosition>::Parse(*end_value, errors);
  } else {
...
std::unique_ptr<base::Value> LocationRange::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  result->Set("scriptId", internal::ToValue(script_id_));
...
std::unique_ptr<CallFrame> CallFrame::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (function_location_value) {
    ...
    result->function_location_ = internal::FromValue<::autofill_assistant::debugger::Location>::Parse(*function_location_value, errors);
  }
  const base::Value* location_value = value.FindKey("location");
  if (location_value) {
    errors->SetName("location");
    result->location_ = internal::FromValue<::autofill_assistant::debugger::Location>::Parse(*location_value, errors);
  } else {
  ...
  if (scope_chain_value) {
    ...
    result->scope_chain_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::debugger::Scope>>>::Parse(*scope_chain_value, errors);
  } else {
  ...
  if (this_value) {
    errors->SetName("this");
    result->this_ = internal::FromValue<::autofill_assistant::runtime::RemoteObject>::Parse(*this_value, errors);
  } else {
  ...
  if (return_value_value) {
    ...
    result->return_value_ = internal::FromValue<::autofill_assistant::runtime::RemoteObject>::Parse(*return_value_value, errors);
  }
  const base::Value* can_be_restarted_value = value.FindKey("canBeRestarted");
...
std::unique_ptr<Scope> Scope::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (type_value) {
    errors->SetName("type");
    result->type_ = internal::FromValue<::autofill_assistant::debugger::ScopeType>::Parse(*type_value, errors);
  } else {
  ...
  if (start_location_value) {
    ...
    result->start_location_ = internal::FromValue<::autofill_assistant::debugger::Location>::Parse(*start_location_value, errors);
  }
  const base::Value* end_location_value = value.FindKey("endLocation");
  if (end_location_value) {
    errors->SetName("endLocation");
    result->end_location_ = internal::FromValue<::autofill_assistant::debugger::Location>::Parse(*end_location_value, errors);
  }
  errors->Pop();
  errors->Pop();
  if (errors->HasErrors())
...
std::unique_ptr<BreakLocation> BreakLocation::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (type_value) {
    errors->SetName("type");
    result->type_ = internal::FromValue<::autofill_assistant::debugger::BreakLocationType>::Parse(*type_value, errors);
  }
  errors->Pop();
  errors->Pop();
  if (errors->HasErrors())
...
std::unique_ptr<WasmDisassemblyChunk> WasmDisassemblyChunk::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  errors->Push();
  errors->SetName("WasmDisassemblyChunk");
  const base::Value* lines_value = value.FindKey("lines");
  if (lines_value) {
  ...
  const base::Value* bytecode_offsets_value = value.FindKey("bytecodeOffsets");
...
std::unique_ptr<base::Value> WasmDisassemblyChunk::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
...
std::unique_ptr<DebugSymbols> DebugSymbols::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (type_value) {
    errors->SetName("type");
    result->type_ = internal::FromValue<::autofill_assistant::debugger::DebugSymbolsType>::Parse(*type_value, errors);
  } else {
    errors->AddError("required property missing: type");
  }
...
std::unique_ptr<ContinueToLocationParams> ContinueToLocationParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (target_call_frames_value) {
    ...
    result->target_call_frames_ = internal::FromValue<::autofill_assistant::debugger::ContinueToLocationTargetCallFrames>::Parse(*target_call_frames_value, errors);
  }
  errors->Pop();
  errors->Pop();
  if (errors->HasErrors())
...
std::unique_ptr<EvaluateOnCallFrameResult> EvaluateOnCallFrameResult::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (result_value) {
    ...
    result->result_ = internal::FromValue<::autofill_assistant::runtime::RemoteObject>::Parse(*result_value, errors);
  } else {
  ...
  if (exception_details_value) {
    ...
    result->exception_details_ = internal::FromValue<::autofill_assistant::runtime::ExceptionDetails>::Parse(*exception_details_value, errors);
  }
  errors->Pop();
  errors->Pop();
  if (errors->HasErrors())
...
std::unique_ptr<GetPossibleBreakpointsParams> GetPossibleBreakpointsParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (start_value) {
    errors->SetName("start");
    result->start_ = internal::FromValue<::autofill_assistant::debugger::Location>::Parse(*start_value, errors);
  } else {
    errors->AddError("required property missing: start");
  }
  const base::Value* end_value = value.FindKey("end");
  if (end_value) {
    errors->SetName("end");
    result->end_ = internal::FromValue<::autofill_assistant::debugger::Location>::Parse(*end_value, errors);
  }
...
std::unique_ptr<GetPossibleBreakpointsResult> GetPossibleBreakpointsResult::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (locations_value) {
    ...
    result->locations_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::debugger::BreakLocation>>>::Parse(*locations_value, errors);
  } else {
...
std::unique_ptr<GetScriptSourceResult> GetScriptSourceResult::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (bytecode_value) {
    ...
    result->bytecode_ = internal::FromValue<std::string>::Parse(*bytecode_value, errors);
  }
  errors->Pop();
  errors->Pop();
  if (errors->HasErrors())
...
std::unique_ptr<base::Value> DisassembleWasmModuleParams::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  result->Set("scriptId", internal::ToValue(script_id_));
  return std::move(result);
}
...
std::unique_ptr<DisassembleWasmModuleResult> DisassembleWasmModuleResult::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  errors->Push();
  errors->SetName("DisassembleWasmModuleResult");
  const base::Value* stream_id_value = value.FindKey("streamId");
  if (stream_id_value) {
    errors->SetName("streamId");
    result->stream_id_ = internal::FromValue<std::string>::Parse(*stream_id_value, errors);
  }
  const base::Value* total_number_of_lines_value = value.FindKey("totalNumberOfLines");
  ...
  const base::Value* function_body_offsets_value = value.FindKey("functionBodyOffsets");
  ...
  if (chunk_value) {
    ...
    result->chunk_ = internal::FromValue<::autofill_assistant::debugger::WasmDisassemblyChunk>::Parse(*chunk_value, errors);
  } else {
...
std::unique_ptr<base::Value> DisassembleWasmModuleResult::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  if (stream_id_)
...
std::unique_ptr<base::Value> NextWasmDisassemblyChunkParams::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
...
std::unique_ptr<base::Value> NextWasmDisassemblyChunkResult::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  result->Set("chunk", internal::ToValue(*chunk_));
  return std::move(result);
}
...
std::unique_ptr<GetStackTraceParams> GetStackTraceParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (stack_trace_id_value) {
    ...
    result->stack_trace_id_ = internal::FromValue<::autofill_assistant::runtime::StackTraceId>::Parse(*stack_trace_id_value, errors);
  } else {
...
std::unique_ptr<GetStackTraceResult> GetStackTraceResult::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (stack_trace_value) {
    ...
    result->stack_trace_ = internal::FromValue<::autofill_assistant::runtime::StackTrace>::Parse(*stack_trace_value, errors);
  } else {
...
std::unique_ptr<PauseOnAsyncCallParams> PauseOnAsyncCallParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (parent_stack_trace_id_value) {
    ...
    result->parent_stack_trace_id_ = internal::FromValue<::autofill_assistant::runtime::StackTraceId>::Parse(*parent_stack_trace_id_value, errors);
  } else {
...
std::unique_ptr<RestartFrameParams> RestartFrameParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (mode_value) {
    errors->SetName("mode");
    result->mode_ = internal::FromValue<::autofill_assistant::debugger::RestartFrameMode>::Parse(*mode_value, errors);
  }
  errors->Pop();
  errors->Pop();
  if (errors->HasErrors())
...
std::unique_ptr<RestartFrameResult> RestartFrameResult::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (call_frames_value) {
    ...
    result->call_frames_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::debugger::CallFrame>>>::Parse(*call_frames_value, errors);
  } else {
  ...
  if (async_stack_trace_value) {
    ...
    result->async_stack_trace_ = internal::FromValue<::autofill_assistant::runtime::StackTrace>::Parse(*async_stack_trace_value, errors);
  }
  ...
  if (async_stack_trace_id_value) {
    ...
    result->async_stack_trace_id_ = internal::FromValue<::autofill_assistant::runtime::StackTraceId>::Parse(*async_stack_trace_id_value, errors);
  }
  errors->Pop();
  errors->Pop();
  if (errors->HasErrors())
...
std::unique_ptr<SetBlackboxedRangesParams> SetBlackboxedRangesParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (positions_value) {
    ...
    result->positions_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::debugger::ScriptPosition>>>::Parse(*positions_value, errors);
  } else {
...
std::unique_ptr<SetBreakpointResult> SetBreakpointResult::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (actual_location_value) {
    ...
    result->actual_location_ = internal::FromValue<::autofill_assistant::debugger::Location>::Parse(*actual_location_value, errors);
  } else {
...
std::unique_ptr<SetInstrumentationBreakpointParams> SetInstrumentationBreakpointParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (instrumentation_value) {
    ...
    result->instrumentation_ = internal::FromValue<::autofill_assistant::debugger::SetInstrumentationBreakpointInstrumentation>::Parse(*instrumentation_value, errors);
  } else {
...
std::unique_ptr<SetBreakpointByUrlResult> SetBreakpointByUrlResult::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (locations_value) {
    errors->SetName("locations");
    result->locations_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::debugger::Location>>>::Parse(*locations_value, errors);
  } else {
    errors->AddError("required property missing: locations");
  }
  errors->Pop();
...
std::unique_ptr<SetPauseOnExceptionsParams> SetPauseOnExceptionsParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (state_value) {
    ...
    result->state_ = internal::FromValue<::autofill_assistant::debugger::SetPauseOnExceptionsState>::Parse(*state_value, errors);
  } else {
...
std::unique_ptr<SetReturnValueParams> SetReturnValueParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (new_value_value) {
    ...
    result->new_value_ = internal::FromValue<::autofill_assistant::runtime::CallArgument>::Parse(*new_value_value, errors);
  } else {
...
std::unique_ptr<SetScriptSourceParams> SetScriptSourceParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  const base::Value* allow_top_frame_editing_value = value.FindKey("allowTopFrameEditing");
...
std::unique_ptr<SetScriptSourceResult> SetScriptSourceResult::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (status_value) {
    ...
    result->status_ = internal::FromValue<::autofill_assistant::debugger::SetScriptSourceStatus>::Parse(*status_value, errors);
  } else {
...
std::unique_ptr<StepIntoParams> StepIntoParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  const base::Value* skip_list_value = value.FindKey("skipList");
  if (skip_list_value) {
    errors->SetName("skipList");
    result->skip_list_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::debugger::LocationRange>>>::Parse(*skip_list_value, errors);
  }
  errors->Pop();
  errors->Pop();
  if (errors->HasErrors())
...
std::unique_ptr<PausedParams> PausedParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (reason_value) {
    ...
    result->reason_ = internal::FromValue<::autofill_assistant::debugger::PausedReason>::Parse(*reason_value, errors);
  } else {
  ...
  if (async_call_stack_trace_id_value) {
    ...
    result->async_call_stack_trace_id_ = internal::FromValue<::autofill_assistant::runtime::StackTraceId>::Parse(*async_call_stack_trace_id_value, errors);
  }
  errors->Pop();
  errors->Pop();
  if (errors->HasErrors())
...
std::unique_ptr<ScriptFailedToParseParams> ScriptFailedToParseParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (script_language_value) {
    ...
    result->script_language_ = internal::FromValue<::autofill_assistant::debugger::ScriptLanguage>::Parse(*script_language_value, errors);
  }
  const base::Value* embedder_name_value = value.FindKey("embedderName");
...
std::unique_ptr<ScriptParsedParams> ScriptParsedParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (debug_symbols_value) {
    errors->SetName("debugSymbols");
    result->debug_symbols_ = internal::FromValue<::autofill_assistant::debugger::DebugSymbols>::Parse(*debug_symbols_value, errors);
  }
  const base::Value* embedder_name_value = value.FindKey("embedderName");
  if (embedder_name_value) {
    errors->SetName("embedderName");
