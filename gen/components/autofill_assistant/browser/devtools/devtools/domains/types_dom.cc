...
std::unique_ptr<Node> Node::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (children_value) {
    ...
    result->children_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::dom::Node>>>::Parse(*children_value, errors);
  }
  ...
  if (shadow_root_type_value) {
    ...
    result->shadow_root_type_ = internal::FromValue<::autofill_assistant::dom::ShadowRootType>::Parse(*shadow_root_type_value, errors);
  }
  ...
  if (content_document_value) {
    ...
    result->content_document_ = internal::FromValue<::autofill_assistant::dom::Node>::Parse(*content_document_value, errors);
  }
  const base::Value* shadow_roots_value = value.FindKey("shadowRoots");
  if (shadow_roots_value) {
    errors->SetName("shadowRoots");
    result->shadow_roots_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::dom::Node>>>::Parse(*shadow_roots_value, errors);
  }
  ...
  if (template_content_value) {
    ...
    result->template_content_ = internal::FromValue<::autofill_assistant::dom::Node>::Parse(*template_content_value, errors);
  }
  const base::Value* pseudo_elements_value = value.FindKey("pseudoElements");
  if (pseudo_elements_value) {
    errors->SetName("pseudoElements");
    result->pseudo_elements_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::dom::Node>>>::Parse(*pseudo_elements_value, errors);
  }
  ...
  if (imported_document_value) {
    ...
    result->imported_document_ = internal::FromValue<::autofill_assistant::dom::Node>::Parse(*imported_document_value, errors);
  }
  ...
  if (distributed_nodes_value) {
    ...
    result->distributed_nodes_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::dom::BackendNode>>>::Parse(*distributed_nodes_value, errors);
  }
  ...
  const base::Value* compatibility_mode_value = value.FindKey("compatibilityMode");
  if (compatibility_mode_value) {
    errors->SetName("compatibilityMode");
    result->compatibility_mode_ = internal::FromValue<::autofill_assistant::dom::CompatibilityMode>::Parse(*compatibility_mode_value, errors);
  }
  const base::Value* assigned_slot_value = value.FindKey("assignedSlot");
  if (assigned_slot_value) {
    errors->SetName("assignedSlot");
    result->assigned_slot_ = internal::FromValue<::autofill_assistant::dom::BackendNode>::Parse(*assigned_slot_value, errors);
  }
  errors->Pop();
  errors->Pop();
  if (errors->HasErrors())
...
std::unique_ptr<base::Value> Node::Serialize() const {
  ...
  if (compatibility_mode_)
    result->Set("compatibilityMode", internal::ToValue(compatibility_mode_.value()));
  if (assigned_slot_)
    result->Set("assignedSlot", internal::ToValue(*assigned_slot_.value()));
  return std::move(result);
}
...
std::unique_ptr<BoxModel> BoxModel::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (shape_outside_value) {
    ...
    result->shape_outside_ = internal::FromValue<::autofill_assistant::dom::ShapeOutsideInfo>::Parse(*shape_outside_value, errors);
  }
  errors->Pop();
  errors->Pop();
  if (errors->HasErrors())
...
std::unique_ptr<DescribeNodeResult> DescribeNodeResult::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (node_value) {
    errors->SetName("node");
    result->node_ = internal::FromValue<::autofill_assistant::dom::Node>::Parse(*node_value, errors);
  } else {
...
std::unique_ptr<EnableParams> EnableParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  errors->Push();
  errors->SetName("EnableParams");
  const base::Value* include_whitespace_value = value.FindKey("includeWhitespace");
  if (include_whitespace_value) {
    errors->SetName("includeWhitespace");
    result->include_whitespace_ = internal::FromValue<::autofill_assistant::dom::EnableIncludeWhitespace>::Parse(*include_whitespace_value, errors);
  }
  errors->Pop();
  errors->Pop();
  if (errors->HasErrors())
...
std::unique_ptr<base::Value> EnableParams::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  if (include_whitespace_)
    result->Set("includeWhitespace", internal::ToValue(include_whitespace_.value()));
  return std::move(result);
}
...
std::unique_ptr<GetBoxModelResult> GetBoxModelResult::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (model_value) {
    ...
    result->model_ = internal::FromValue<::autofill_assistant::dom::BoxModel>::Parse(*model_value, errors);
  } else {
...
std::unique_ptr<GetDocumentResult> GetDocumentResult::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (root_value) {
    errors->SetName("root");
    result->root_ = internal::FromValue<::autofill_assistant::dom::Node>::Parse(*root_value, errors);
  } else {
...
std::unique_ptr<GetFlattenedDocumentResult> GetFlattenedDocumentResult::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (nodes_value) {
    ...
    result->nodes_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::dom::Node>>>::Parse(*nodes_value, errors);
  } else {
...
std::unique_ptr<GetNodesForSubtreeByStyleParams> GetNodesForSubtreeByStyleParams::Parse(const base::Value& value, ErrorReporter* errors) {
  errors->Push();
  errors->SetName("GetNodesForSubtreeByStyleParams");
  if (!value.is_dict()) {
    errors->AddError("object expected");
    errors->Pop();
    return nullptr;
  ...
  std::unique_ptr<GetNodesForSubtreeByStyleParams> result(new GetNodesForSubtreeByStyleParams());
  errors->Push();
  errors->SetName("GetNodesForSubtreeByStyleParams");
  const base::Value* node_id_value = value.FindKey("nodeId");
  if (node_id_value) {
  ...
  if (computed_styles_value) {
    ...
    result->computed_styles_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::dom::CSSComputedStyleProperty>>>::Parse(*computed_styles_value, errors);
  } else {
...
std::unique_ptr<base::Value> GetNodesForSubtreeByStyleParams::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  result->Set("nodeId", internal::ToValue(node_id_));
...
std::unique_ptr<GetNodesForSubtreeByStyleParams> GetNodesForSubtreeByStyleParams::Clone() const {
  ErrorReporter errors;
  std::unique_ptr<GetNodesForSubtreeByStyleParams> result = Parse(*Serialize(), &errors);
  DCHECK(!errors.HasErrors());
  return result;
}


std::unique_ptr<GetNodesForSubtreeByStyleResult> GetNodesForSubtreeByStyleResult::Parse(const base::Value& value, ErrorReporter* errors) {
  errors->Push();
  errors->SetName("GetNodesForSubtreeByStyleResult");
  if (!value.is_dict()) {
    errors->AddError("object expected");
    errors->Pop();
    return nullptr;
  ...
  std::unique_ptr<GetNodesForSubtreeByStyleResult> result(new GetNodesForSubtreeByStyleResult());
  errors->Push();
  errors->SetName("GetNodesForSubtreeByStyleResult");
...
std::unique_ptr<base::Value> GetNodesForSubtreeByStyleResult::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  result->Set("nodeIds", internal::ToValue(node_ids_));
  return std::move(result);
}

std::unique_ptr<GetNodesForSubtreeByStyleResult> GetNodesForSubtreeByStyleResult::Clone() const {
  ErrorReporter errors;
  std::unique_ptr<GetNodesForSubtreeByStyleResult> result = Parse(*Serialize(), &errors);
  DCHECK(!errors.HasErrors());
  return result;
}
...
std::unique_ptr<GetTopLayerElementsParams> GetTopLayerElementsParams::Parse(const base::Value& value, ErrorReporter* errors) {
  errors->Push();
  errors->SetName("GetTopLayerElementsParams");
  if (!value.is_dict()) {
    errors->AddError("object expected");
    errors->Pop();
    return nullptr;
  ...
  std::unique_ptr<GetTopLayerElementsParams> result(new GetTopLayerElementsParams());
  errors->Push();
  errors->SetName("GetTopLayerElementsParams");
  errors->Pop();
  errors->Pop();
...
std::unique_ptr<base::Value> GetTopLayerElementsParams::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  return std::move(result);
}

std::unique_ptr<GetTopLayerElementsParams> GetTopLayerElementsParams::Clone() const {
  ErrorReporter errors;
  std::unique_ptr<GetTopLayerElementsParams> result = Parse(*Serialize(), &errors);
  DCHECK(!errors.HasErrors());
  return result;
}


std::unique_ptr<GetTopLayerElementsResult> GetTopLayerElementsResult::Parse(const base::Value& value, ErrorReporter* errors) {
  errors->Push();
  errors->SetName("GetTopLayerElementsResult");
  if (!value.is_dict()) {
    errors->AddError("object expected");
    errors->Pop();
    return nullptr;
  ...
  std::unique_ptr<GetTopLayerElementsResult> result(new GetTopLayerElementsResult());
  errors->Push();
  errors->SetName("GetTopLayerElementsResult");
  const base::Value* node_ids_value = value.FindKey("nodeIds");
  if (node_ids_value) {
...
std::unique_ptr<base::Value> GetTopLayerElementsResult::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  result->Set("nodeIds", internal::ToValue(node_ids_));
  return std::move(result);
}

std::unique_ptr<GetTopLayerElementsResult> GetTopLayerElementsResult::Clone() const {
  ErrorReporter errors;
  std::unique_ptr<GetTopLayerElementsResult> result = Parse(*Serialize(), &errors);
  DCHECK(!errors.HasErrors());
  return result;
}
...
std::unique_ptr<ResolveNodeResult> ResolveNodeResult::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (object_value) {
    ...
    result->object_ = internal::FromValue<::autofill_assistant::runtime::RemoteObject>::Parse(*object_value, errors);
  } else {
...
std::unique_ptr<GetNodeStackTracesResult> GetNodeStackTracesResult::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (creation_value) {
    ...
    result->creation_ = internal::FromValue<::autofill_assistant::runtime::StackTrace>::Parse(*creation_value, errors);
  }
  errors->Pop();
  errors->Pop();
  if (errors->HasErrors())
...
std::unique_ptr<GetContainerForNodeParams> GetContainerForNodeParams::Parse(const base::Value& value, ErrorReporter* errors) {
  errors->Push();
  errors->SetName("GetContainerForNodeParams");
  if (!value.is_dict()) {
    errors->AddError("object expected");
    errors->Pop();
    return nullptr;
  ...
  std::unique_ptr<GetContainerForNodeParams> result(new GetContainerForNodeParams());
  errors->Push();
  errors->SetName("GetContainerForNodeParams");
  const base::Value* node_id_value = value.FindKey("nodeId");
  if (node_id_value) {
  ...
  const base::Value* container_name_value = value.FindKey("containerName");
  if (container_name_value) {
    errors->SetName("containerName");
    result->container_name_ = internal::FromValue<std::string>::Parse(*container_name_value, errors);
  }
  errors->Pop();
  errors->Pop();
  if (errors->HasErrors())
...
std::unique_ptr<base::Value> GetContainerForNodeParams::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  result->Set("nodeId", internal::ToValue(node_id_));
  if (container_name_)
    result->Set("containerName", internal::ToValue(container_name_.value()));
  return std::move(result);
}

std::unique_ptr<GetContainerForNodeParams> GetContainerForNodeParams::Clone() const {
  ErrorReporter errors;
  std::unique_ptr<GetContainerForNodeParams> result = Parse(*Serialize(), &errors);
  DCHECK(!errors.HasErrors());
  return result;
}


std::unique_ptr<GetContainerForNodeResult> GetContainerForNodeResult::Parse(const base::Value& value, ErrorReporter* errors) {
  errors->Push();
  errors->SetName("GetContainerForNodeResult");
  if (!value.is_dict()) {
    errors->AddError("object expected");
    errors->Pop();
    return nullptr;
  ...
  std::unique_ptr<GetContainerForNodeResult> result(new GetContainerForNodeResult());
  errors->Push();
  errors->SetName("GetContainerForNodeResult");
  const base::Value* node_id_value = value.FindKey("nodeId");
  if (node_id_value) {
...
std::unique_ptr<base::Value> GetContainerForNodeResult::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  if (node_id_)
    result->Set("nodeId", internal::ToValue(node_id_.value()));
  return std::move(result);
...
std::unique_ptr<GetContainerForNodeResult> GetContainerForNodeResult::Clone() const {
  ErrorReporter errors;
  std::unique_ptr<GetContainerForNodeResult> result = Parse(*Serialize(), &errors);
  DCHECK(!errors.HasErrors());
  return result;
}


std::unique_ptr<GetQueryingDescendantsForContainerParams> GetQueryingDescendantsForContainerParams::Parse(const base::Value& value, ErrorReporter* errors) {
  errors->Push();
  errors->SetName("GetQueryingDescendantsForContainerParams");
  if (!value.is_dict()) {
    errors->AddError("object expected");
    errors->Pop();
    return nullptr;
  ...
  std::unique_ptr<GetQueryingDescendantsForContainerParams> result(new GetQueryingDescendantsForContainerParams());
  errors->Push();
  errors->SetName("GetQueryingDescendantsForContainerParams");
  const base::Value* node_id_value = value.FindKey("nodeId");
  if (node_id_value) {
...
std::unique_ptr<base::Value> GetQueryingDescendantsForContainerParams::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  result->Set("nodeId", internal::ToValue(node_id_));
  return std::move(result);
}

std::unique_ptr<GetQueryingDescendantsForContainerParams> GetQueryingDescendantsForContainerParams::Clone() const {
  ErrorReporter errors;
  std::unique_ptr<GetQueryingDescendantsForContainerParams> result = Parse(*Serialize(), &errors);
  DCHECK(!errors.HasErrors());
  return result;
}


std::unique_ptr<GetQueryingDescendantsForContainerResult> GetQueryingDescendantsForContainerResult::Parse(const base::Value& value, ErrorReporter* errors) {
  errors->Push();
  errors->SetName("GetQueryingDescendantsForContainerResult");
  if (!value.is_dict()) {
    errors->AddError("object expected");
    errors->Pop();
    return nullptr;
  ...
  std::unique_ptr<GetQueryingDescendantsForContainerResult> result(new GetQueryingDescendantsForContainerResult());
  errors->Push();
  errors->SetName("GetQueryingDescendantsForContainerResult");
  const base::Value* node_ids_value = value.FindKey("nodeIds");
  if (node_ids_value) {
...
std::unique_ptr<base::Value> GetQueryingDescendantsForContainerResult::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  result->Set("nodeIds", internal::ToValue(node_ids_));
  return std::move(result);
}

std::unique_ptr<GetQueryingDescendantsForContainerResult> GetQueryingDescendantsForContainerResult::Clone() const {
  ErrorReporter errors;
  std::unique_ptr<GetQueryingDescendantsForContainerResult> result = Parse(*Serialize(), &errors);
  DCHECK(!errors.HasErrors());
  return result;
}
...
std::unique_ptr<PseudoElementAddedParams> PseudoElementAddedParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (pseudo_element_value) {
    ...
    result->pseudo_element_ = internal::FromValue<::autofill_assistant::dom::Node>::Parse(*pseudo_element_value, errors);
  } else {
...
std::unique_ptr<TopLayerElementsUpdatedParams> TopLayerElementsUpdatedParams::Parse(const base::Value& value, ErrorReporter* errors) {
  errors->Push();
  errors->SetName("TopLayerElementsUpdatedParams");
  if (!value.is_dict()) {
    errors->AddError("object expected");
    errors->Pop();
    return nullptr;
  ...
  std::unique_ptr<TopLayerElementsUpdatedParams> result(new TopLayerElementsUpdatedParams());
  errors->Push();
  errors->SetName("TopLayerElementsUpdatedParams");
  errors->Pop();
  errors->Pop();
...
std::unique_ptr<base::Value> TopLayerElementsUpdatedParams::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  return std::move(result);
}

std::unique_ptr<TopLayerElementsUpdatedParams> TopLayerElementsUpdatedParams::Clone() const {
  ErrorReporter errors;
  std::unique_ptr<TopLayerElementsUpdatedParams> result = Parse(*Serialize(), &errors);
  DCHECK(!errors.HasErrors());
  return result;
}
