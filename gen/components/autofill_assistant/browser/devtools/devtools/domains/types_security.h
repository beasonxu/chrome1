...
#ifndef COMPONENTS_AUTOFILL_ASSISTANT_BROWSER_DEVTOOLS_DEVTOOLS_DOMAINS_TYPES_SECURITY_H_
#define COMPONENTS_AUTOFILL_ASSISTANT_BROWSER_DEVTOOLS_DEVTOOLS_DOMAINS_TYPES_SECURITY_H_
...
class CertificateSecurityState {
 public:
  ...
  CertificateSecurityState(const CertificateSecurityState&) = delete;
  CertificateSecurityState& operator=(const CertificateSecurityState&) = delete;
 ...
 private:
  ...
  double valid_from_;
  double valid_to_;
  absl::optional<std::string> certificate_network_error_;
...
class SafetyTipInfo {
 public:
  ...
  SafetyTipInfo(const SafetyTipInfo&) = delete;
  SafetyTipInfo& operator=(const SafetyTipInfo&) = delete;
  ~SafetyTipInfo() { }

  // Describes whether the page triggers any safety tips or reputation warnings. Default is unknown.
  ::autofill_assistant::security::SafetyTipStatus GetSafetyTipStatus() const { return safety_tip_status_; }
  void SetSafetyTipStatus(::autofill_assistant::security::SafetyTipStatus value) { safety_tip_status_ = value; }
  ...
  public:
    ...
    SafetyTipInfoBuilder<STATE | kSafetyTipStatusSet>& SetSafetyTipStatus(::autofill_assistant::security::SafetyTipStatus value) {
 ...
 private:
  ...
  ::autofill_assistant::security::SafetyTipStatus safety_tip_status_;
  absl::optional<std::string> safe_url_;
};
...
class VisibleSecurityState {
 public:
  ...
  VisibleSecurityState(const VisibleSecurityState&) = delete;
  VisibleSecurityState& operator=(const VisibleSecurityState&) = delete;
  ...
  const ::autofill_assistant::security::CertificateSecurityState* GetCertificateSecurityState() const { DCHECK(HasCertificateSecurityState()); return certificate_security_state_.value().get(); }
  void SetCertificateSecurityState(std::unique_ptr<::autofill_assistant::security::CertificateSecurityState> value) { certificate_security_state_ = std::move(value); }

  // The type of Safety Tip triggered on the page. Note that this field will be set even if the Safety Tip UI was not actually shown.
  bool HasSafetyTipInfo() const { return !!safety_tip_info_; }
  const ::autofill_assistant::security::SafetyTipInfo* GetSafetyTipInfo() const { DCHECK(HasSafetyTipInfo()); return safety_tip_info_.value().get(); }
  void SetSafetyTipInfo(std::unique_ptr<::autofill_assistant::security::SafetyTipInfo> value) { safety_tip_info_ = std::move(value); }
  ...
  public:
    ...
    VisibleSecurityStateBuilder<STATE | kSecurityStateSet>& SetSecurityState(::autofill_assistant::security::SecurityState value) {
    ...
    VisibleSecurityStateBuilder<STATE>& SetCertificateSecurityState(std::unique_ptr<::autofill_assistant::security::CertificateSecurityState> value) {
      result_->SetCertificateSecurityState(std::move(value));
      return *this;
    }

    VisibleSecurityStateBuilder<STATE>& SetSafetyTipInfo(std::unique_ptr<::autofill_assistant::security::SafetyTipInfo> value) {
 ...
 private:
  ...
  absl::optional<std::unique_ptr<::autofill_assistant::security::CertificateSecurityState>> certificate_security_state_;
  absl::optional<std::unique_ptr<::autofill_assistant::security::SafetyTipInfo>> safety_tip_info_;
...
class SecurityStateExplanation {
 public:
  ...
  SecurityStateExplanation(const SecurityStateExplanation&) = delete;
  SecurityStateExplanation& operator=(const SecurityStateExplanation&) = delete;
  ...
  ::autofill_assistant::security::MixedContentType GetMixedContentType() const { return mixed_content_type_; }
  ...
  public:
    ...
    SecurityStateExplanationBuilder<STATE | kSecurityStateSet>& SetSecurityState(::autofill_assistant::security::SecurityState value) {
      static_assert(!(STATE & kSecurityStateSet), "property securityState should not have already been set");
      result_->SetSecurityState(value);
      return CastState<kSecurityStateSet>();
    }
    ...
    SecurityStateExplanationBuilder<STATE | kMixedContentTypeSet>& SetMixedContentType(::autofill_assistant::security::MixedContentType value) {
 ...
 private:
  ...
  ::autofill_assistant::security::MixedContentType mixed_content_type_;
  std::vector<std::string> certificate_;
  absl::optional<std::vector<std::string>> recommendations_;
};
...
class InsecureContentStatus {
 public:
  ...
  InsecureContentStatus(const InsecureContentStatus&) = delete;
  InsecureContentStatus& operator=(const InsecureContentStatus&) = delete;
  ...
  ::autofill_assistant::security::SecurityState GetRanInsecureContentStyle() const { return ran_insecure_content_style_; }
  void SetRanInsecureContentStyle(::autofill_assistant::security::SecurityState value) { ran_insecure_content_style_ = value; }

  // Always set to unknown.
  ::autofill_assistant::security::SecurityState GetDisplayedInsecureContentStyle() const { return displayed_insecure_content_style_; }
  void SetDisplayedInsecureContentStyle(::autofill_assistant::security::SecurityState value) { displayed_insecure_content_style_ = value; }
  ...
  public:
    ...
    InsecureContentStatusBuilder<STATE | kRanInsecureContentStyleSet>& SetRanInsecureContentStyle(::autofill_assistant::security::SecurityState value) {
    ...
    InsecureContentStatusBuilder<STATE | kDisplayedInsecureContentStyleSet>& SetDisplayedInsecureContentStyle(::autofill_assistant::security::SecurityState value) {
 ...
 private:
  ...
  ::autofill_assistant::security::SecurityState ran_insecure_content_style_;
  ::autofill_assistant::security::SecurityState displayed_insecure_content_style_;
};
...
class SetIgnoreCertificateErrorsParams {
 public:
  ...
  SetIgnoreCertificateErrorsParams(const SetIgnoreCertificateErrorsParams&) = delete;
  SetIgnoreCertificateErrorsParams& operator=(const SetIgnoreCertificateErrorsParams&) = delete;
...
class SetIgnoreCertificateErrorsResult {
 public:
  ...
  SetIgnoreCertificateErrorsResult(const SetIgnoreCertificateErrorsResult&) = delete;
  SetIgnoreCertificateErrorsResult& operator=(const SetIgnoreCertificateErrorsResult&) = delete;
...
class HandleCertificateErrorParams {
 public:
  ...
  HandleCertificateErrorParams(const HandleCertificateErrorParams&) = delete;
  HandleCertificateErrorParams& operator=(const HandleCertificateErrorParams&) = delete;
  ...
  ::autofill_assistant::security::CertificateErrorAction GetAction() const { return action_; }
  void SetAction(::autofill_assistant::security::CertificateErrorAction value) { action_ = value; }
  ...
  public:
    ...
    HandleCertificateErrorParamsBuilder<STATE | kActionSet>& SetAction(::autofill_assistant::security::CertificateErrorAction value) {
 ...
 private:
  ...
  int event_id_;
  ::autofill_assistant::security::CertificateErrorAction action_;
};
...
class HandleCertificateErrorResult {
 public:
  ...
  HandleCertificateErrorResult(const HandleCertificateErrorResult&) = delete;
  HandleCertificateErrorResult& operator=(const HandleCertificateErrorResult&) = delete;
...
class SetOverrideCertificateErrorsParams {
 public:
  ...
  SetOverrideCertificateErrorsParams(const SetOverrideCertificateErrorsParams&) = delete;
  SetOverrideCertificateErrorsParams& operator=(const SetOverrideCertificateErrorsParams&) = delete;
...
class SetOverrideCertificateErrorsResult {
 public:
  ...
  SetOverrideCertificateErrorsResult(const SetOverrideCertificateErrorsResult&) = delete;
  SetOverrideCertificateErrorsResult& operator=(const SetOverrideCertificateErrorsResult&) = delete;
...
class CertificateErrorParams {
 public:
  ...
  CertificateErrorParams(const CertificateErrorParams&) = delete;
  CertificateErrorParams& operator=(const CertificateErrorParams&) = delete;
...
class VisibleSecurityStateChangedParams {
 public:
  ...
  VisibleSecurityStateChangedParams(const VisibleSecurityStateChangedParams&) = delete;
  VisibleSecurityStateChangedParams& operator=(const VisibleSecurityStateChangedParams&) = delete;
  ~VisibleSecurityStateChangedParams() { }

  // Security state information about the page.
  const ::autofill_assistant::security::VisibleSecurityState* GetVisibleSecurityState() const { return visible_security_state_.get(); }
  void SetVisibleSecurityState(std::unique_ptr<::autofill_assistant::security::VisibleSecurityState> value) { visible_security_state_ = std::move(value); }
  ...
  public:
    ...
    VisibleSecurityStateChangedParamsBuilder<STATE | kVisibleSecurityStateSet>& SetVisibleSecurityState(std::unique_ptr<::autofill_assistant::security::VisibleSecurityState> value) {
 ...
 private:
  ...
  std::unique_ptr<::autofill_assistant::security::VisibleSecurityState> visible_security_state_;
};
...
class SecurityStateChangedParams {
 public:
  ...
  SecurityStateChangedParams(const SecurityStateChangedParams&) = delete;
  SecurityStateChangedParams& operator=(const SecurityStateChangedParams&) = delete;
  ...
  // empty.
  const std::vector<std::unique_ptr<::autofill_assistant::security::SecurityStateExplanation>>* GetExplanations() const { return &explanations_; }
  void SetExplanations(std::vector<std::unique_ptr<::autofill_assistant::security::SecurityStateExplanation>> value) { explanations_ = std::move(value); }

  // Information about insecure content on the page.
  const ::autofill_assistant::security::InsecureContentStatus* GetInsecureContentStatus() const { return insecure_content_status_.get(); }
  void SetInsecureContentStatus(std::unique_ptr<::autofill_assistant::security::InsecureContentStatus> value) { insecure_content_status_ = std::move(value); }
  ...
  public:
    ...
    SecurityStateChangedParamsBuilder<STATE | kSecurityStateSet>& SetSecurityState(::autofill_assistant::security::SecurityState value) {
      static_assert(!(STATE & kSecurityStateSet), "property securityState should not have already been set");
      result_->SetSecurityState(value);
      return CastState<kSecurityStateSet>();
    }
    ...
    SecurityStateChangedParamsBuilder<STATE | kExplanationsSet>& SetExplanations(std::vector<std::unique_ptr<::autofill_assistant::security::SecurityStateExplanation>> value) {
    ...
    SecurityStateChangedParamsBuilder<STATE | kInsecureContentStatusSet>& SetInsecureContentStatus(std::unique_ptr<::autofill_assistant::security::InsecureContentStatus> value) {
 ...
 private:
  ...
  std::vector<std::unique_ptr<::autofill_assistant::security::SecurityStateExplanation>> explanations_;
  std::unique_ptr<::autofill_assistant::security::InsecureContentStatus> insecure_content_status_;
  absl::optional<std::string> summary_;
};
...
#endif  // COMPONENTS_AUTOFILL_ASSISTANT_BROWSER_DEVTOOLS_DEVTOOLS_DOMAINS_TYPES_SECURITY_H_
