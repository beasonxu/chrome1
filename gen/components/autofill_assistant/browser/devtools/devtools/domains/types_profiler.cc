...
#include "components/autofill_assistant/browser/devtools/devtools/internal/type_conversions_profiler.h"
...
std::unique_ptr<ProfileNode> ProfileNode::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (call_frame_value) {
    ...
    result->call_frame_ = internal::FromValue<::autofill_assistant::runtime::CallFrame>::Parse(*call_frame_value, errors);
  } else {
  ...
  if (position_ticks_value) {
    ...
    result->position_ticks_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::profiler::PositionTickInfo>>>::Parse(*position_ticks_value, errors);
  }
  errors->Pop();
  errors->Pop();
  if (errors->HasErrors())
...
std::unique_ptr<Profile> Profile::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (nodes_value) {
    ...
    result->nodes_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::profiler::ProfileNode>>>::Parse(*nodes_value, errors);
  } else {
...
std::unique_ptr<FunctionCoverage> FunctionCoverage::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (ranges_value) {
    ...
    result->ranges_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::profiler::CoverageRange>>>::Parse(*ranges_value, errors);
  } else {
...
std::unique_ptr<ScriptCoverage> ScriptCoverage::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (functions_value) {
    ...
    result->functions_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::profiler::FunctionCoverage>>>::Parse(*functions_value, errors);
  } else {
...
std::unique_ptr<TypeProfileEntry> TypeProfileEntry::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (types_value) {
    ...
    result->types_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::profiler::TypeObject>>>::Parse(*types_value, errors);
  } else {
...
std::unique_ptr<ScriptTypeProfile> ScriptTypeProfile::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (entries_value) {
    ...
    result->entries_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::profiler::TypeProfileEntry>>>::Parse(*entries_value, errors);
  } else {
...
std::unique_ptr<GetBestEffortCoverageResult> GetBestEffortCoverageResult::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (result_value) {
    ...
    result->result_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::profiler::ScriptCoverage>>>::Parse(*result_value, errors);
  } else {
...
std::unique_ptr<StopResult> StopResult::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (profile_value) {
    errors->SetName("profile");
    result->profile_ = internal::FromValue<::autofill_assistant::profiler::Profile>::Parse(*profile_value, errors);
  } else {
...
std::unique_ptr<TakeTypeProfileResult> TakeTypeProfileResult::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (result_value) {
    errors->SetName("result");
    result->result_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::profiler::ScriptTypeProfile>>>::Parse(*result_value, errors);
  } else {
    errors->AddError("required property missing: result");
  }
  errors->Pop();
...
std::unique_ptr<PreciseCoverageDeltaUpdateParams> PreciseCoverageDeltaUpdateParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  const base::Value* occasion_value = value.FindKey("occasion");
  if (occasion_value) {
