...
#ifndef COMPONENTS_AUTOFILL_ASSISTANT_BROWSER_DEVTOOLS_DEVTOOLS_DOMAINS_TYPES_ANIMATION_H_
#define COMPONENTS_AUTOFILL_ASSISTANT_BROWSER_DEVTOOLS_DEVTOOLS_DOMAINS_TYPES_ANIMATION_H_

#include "third_party/abseil-cpp/absl/types/optional.h"
#include "base/values.h"
#include "components/autofill_assistant/browser/devtools/devtools/internal/types_forward_declarations_animation.h"
...
class Animation {
 public:
  ...
  ::autofill_assistant::animation::AnimationType GetType() const { return type_; }
  void SetType(::autofill_assistant::animation::AnimationType value) { type_ = value; }

  // `Animation`'s source animation node.
  bool HasSource() const { return !!source_; }
  const ::autofill_assistant::animation::AnimationEffect* GetSource() const { DCHECK(HasSource()); return source_.value().get(); }
  void SetSource(std::unique_ptr<::autofill_assistant::animation::AnimationEffect> value) { source_ = std::move(value); }
  ...
  public:
    ...
    AnimationBuilder<STATE | kTypeSet>& SetType(::autofill_assistant::animation::AnimationType value) {
    ...
    AnimationBuilder<STATE>& SetSource(std::unique_ptr<::autofill_assistant::animation::AnimationEffect> value) {
 ...
 private:
  ...
  ::autofill_assistant::animation::AnimationType type_;
  absl::optional<std::unique_ptr<::autofill_assistant::animation::AnimationEffect>> source_;
  absl::optional<std::string> css_id_;
};
...
class AnimationEffect {
 public:
  ...
  const ::autofill_assistant::animation::KeyframesRule* GetKeyframesRule() const { DCHECK(HasKeyframesRule()); return keyframes_rule_.value().get(); }
  void SetKeyframesRule(std::unique_ptr<::autofill_assistant::animation::KeyframesRule> value) { keyframes_rule_ = std::move(value); }
  ...
  public:
    ...
    AnimationEffectBuilder<STATE>& SetKeyframesRule(std::unique_ptr<::autofill_assistant::animation::KeyframesRule> value) {
 ...
 private:
  ...
  absl::optional<std::unique_ptr<::autofill_assistant::animation::KeyframesRule>> keyframes_rule_;
  std::string easing_;
};
...
class KeyframesRule {
 public:
  ...
  KeyframesRule(const KeyframesRule&) = delete;
  KeyframesRule& operator=(const KeyframesRule&) = delete;
  ~KeyframesRule() { }
  ...
  const std::vector<std::unique_ptr<::autofill_assistant::animation::KeyframeStyle>>* GetKeyframes() const { return &keyframes_; }
  void SetKeyframes(std::vector<std::unique_ptr<::autofill_assistant::animation::KeyframeStyle>> value) { keyframes_ = std::move(value); }
  ...
  public:
    ...
    KeyframesRuleBuilder<STATE | kKeyframesSet>& SetKeyframes(std::vector<std::unique_ptr<::autofill_assistant::animation::KeyframeStyle>> value) {
 ...
 private:
  ...
  std::vector<std::unique_ptr<::autofill_assistant::animation::KeyframeStyle>> keyframes_;
};
...
class KeyframeStyle {
 public:
  ...
  KeyframeStyle(const KeyframeStyle&) = delete;
  KeyframeStyle& operator=(const KeyframeStyle&) = delete;
  ~KeyframeStyle() { }
...
class GetCurrentAnimationTimeParams {
 public:
  ...
  GetCurrentAnimationTimeParams(const GetCurrentAnimationTimeParams&) = delete;
  GetCurrentAnimationTimeParams& operator=(const GetCurrentAnimationTimeParams&) = delete;
...
class GetCurrentAnimationTimeResult {
 public:
  ...
  GetCurrentAnimationTimeResult(const GetCurrentAnimationTimeResult&) = delete;
  GetCurrentAnimationTimeResult& operator=(const GetCurrentAnimationTimeResult&) = delete;
...
class GetPlaybackRateParams {
 public:
  ...
  GetPlaybackRateParams(const GetPlaybackRateParams&) = delete;
  GetPlaybackRateParams& operator=(const GetPlaybackRateParams&) = delete;
...
class GetPlaybackRateResult {
 public:
  ...
  GetPlaybackRateResult(const GetPlaybackRateResult&) = delete;
  GetPlaybackRateResult& operator=(const GetPlaybackRateResult&) = delete;
...
class ReleaseAnimationsParams {
 public:
  ...
  ReleaseAnimationsParams(const ReleaseAnimationsParams&) = delete;
  ReleaseAnimationsParams& operator=(const ReleaseAnimationsParams&) = delete;
...
class ReleaseAnimationsResult {
 public:
  ...
  ReleaseAnimationsResult(const ReleaseAnimationsResult&) = delete;
  ReleaseAnimationsResult& operator=(const ReleaseAnimationsResult&) = delete;
...
class ResolveAnimationParams {
 public:
  ...
  ResolveAnimationParams(const ResolveAnimationParams&) = delete;
  ResolveAnimationParams& operator=(const ResolveAnimationParams&) = delete;
...
class ResolveAnimationResult {
 public:
  ...
  ResolveAnimationResult(const ResolveAnimationResult&) = delete;
  ResolveAnimationResult& operator=(const ResolveAnimationResult&) = delete;
  ~ResolveAnimationResult() { }

  // Corresponding remote object.
  const ::autofill_assistant::runtime::RemoteObject* GetRemoteObject() const { return remote_object_.get(); }
  void SetRemoteObject(std::unique_ptr<::autofill_assistant::runtime::RemoteObject> value) { remote_object_ = std::move(value); }
  ...
  public:
    ...
    ResolveAnimationResultBuilder<STATE | kRemoteObjectSet>& SetRemoteObject(std::unique_ptr<::autofill_assistant::runtime::RemoteObject> value) {
 ...
 private:
  ...
  std::unique_ptr<::autofill_assistant::runtime::RemoteObject> remote_object_;
};
...
class SeekAnimationsParams {
 public:
  ...
  SeekAnimationsParams(const SeekAnimationsParams&) = delete;
  SeekAnimationsParams& operator=(const SeekAnimationsParams&) = delete;
...
class SeekAnimationsResult {
 public:
  ...
  SeekAnimationsResult(const SeekAnimationsResult&) = delete;
  SeekAnimationsResult& operator=(const SeekAnimationsResult&) = delete;
...
class SetPausedParams {
 public:
  ...
  SetPausedParams(const SetPausedParams&) = delete;
  SetPausedParams& operator=(const SetPausedParams&) = delete;
  ~SetPausedParams() { }
...
class SetPausedResult {
 public:
  ...
  SetPausedResult(const SetPausedResult&) = delete;
  SetPausedResult& operator=(const SetPausedResult&) = delete;
  ~SetPausedResult() { }
...
class SetPlaybackRateParams {
 public:
  ...
  SetPlaybackRateParams(const SetPlaybackRateParams&) = delete;
  SetPlaybackRateParams& operator=(const SetPlaybackRateParams&) = delete;
...
class SetPlaybackRateResult {
 public:
  ...
  SetPlaybackRateResult(const SetPlaybackRateResult&) = delete;
  SetPlaybackRateResult& operator=(const SetPlaybackRateResult&) = delete;
...
class SetTimingParams {
 public:
  ...
  SetTimingParams(const SetTimingParams&) = delete;
  SetTimingParams& operator=(const SetTimingParams&) = delete;
  ~SetTimingParams() { }
...
class SetTimingResult {
 public:
  ...
  SetTimingResult(const SetTimingResult&) = delete;
  SetTimingResult& operator=(const SetTimingResult&) = delete;
  ~SetTimingResult() { }
...
class AnimationCanceledParams {
 public:
  ...
  AnimationCanceledParams(const AnimationCanceledParams&) = delete;
  AnimationCanceledParams& operator=(const AnimationCanceledParams&) = delete;
...
class AnimationCreatedParams {
 public:
  ...
  AnimationCreatedParams(const AnimationCreatedParams&) = delete;
  AnimationCreatedParams& operator=(const AnimationCreatedParams&) = delete;
...
class AnimationStartedParams {
 public:
  ...
  AnimationStartedParams(const AnimationStartedParams&) = delete;
  AnimationStartedParams& operator=(const AnimationStartedParams&) = delete;
  ~AnimationStartedParams() { }

  // Animation that was started.
  const ::autofill_assistant::animation::Animation* GetAnimation() const { return animation_.get(); }
  void SetAnimation(std::unique_ptr<::autofill_assistant::animation::Animation> value) { animation_ = std::move(value); }
  ...
  public:
    ...
    AnimationStartedParamsBuilder<STATE | kAnimationSet>& SetAnimation(std::unique_ptr<::autofill_assistant::animation::Animation> value) {
 ...
 private:
  ...
  std::unique_ptr<::autofill_assistant::animation::Animation> animation_;
};
...
#endif  // COMPONENTS_AUTOFILL_ASSISTANT_BROWSER_DEVTOOLS_DEVTOOLS_DOMAINS_TYPES_ANIMATION_H_
