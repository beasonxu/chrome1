...
#include "components/autofill_assistant/browser/devtools/devtools/internal/type_conversions_memory.h"
...
std::unique_ptr<SamplingProfile> SamplingProfile::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (samples_value) {
    ...
    result->samples_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::memory::SamplingProfileNode>>>::Parse(*samples_value, errors);
  } else {
  ...
  if (modules_value) {
    ...
    result->modules_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::memory::Module>>>::Parse(*modules_value, errors);
  } else {
...
std::unique_ptr<SimulatePressureNotificationParams> SimulatePressureNotificationParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (level_value) {
    ...
    result->level_ = internal::FromValue<::autofill_assistant::memory::PressureLevel>::Parse(*level_value, errors);
  } else {
...
std::unique_ptr<GetAllTimeSamplingProfileResult> GetAllTimeSamplingProfileResult::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (profile_value) {
    ...
    result->profile_ = internal::FromValue<::autofill_assistant::memory::SamplingProfile>::Parse(*profile_value, errors);
  } else {
