...
#include "components/autofill_assistant/browser/devtools/devtools/internal/type_conversions_fetch.h"
...
std::unique_ptr<RequestPattern> RequestPattern::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (request_stage_value) {
    ...
    result->request_stage_ = internal::FromValue<::autofill_assistant::fetch::RequestStage>::Parse(*request_stage_value, errors);
  }
  errors->Pop();
  errors->Pop();
  if (errors->HasErrors())
...
std::unique_ptr<AuthChallenge> AuthChallenge::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (source_value) {
    ...
    result->source_ = internal::FromValue<::autofill_assistant::fetch::AuthChallengeSource>::Parse(*source_value, errors);
  }
...
std::unique_ptr<AuthChallengeResponse> AuthChallengeResponse::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (response_value) {
    ...
    result->response_ = internal::FromValue<::autofill_assistant::fetch::AuthChallengeResponseResponse>::Parse(*response_value, errors);
  } else {
...
std::unique_ptr<EnableParams> EnableParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (patterns_value) {
    ...
    result->patterns_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::fetch::RequestPattern>>>::Parse(*patterns_value, errors);
  }
...
std::unique_ptr<FulfillRequestParams> FulfillRequestParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (response_headers_value) {
    ...
    result->response_headers_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::fetch::HeaderEntry>>>::Parse(*response_headers_value, errors);
  }
  ...
  if (binary_response_headers_value) {
    ...
    result->binary_response_headers_ = internal::FromValue<std::string>::Parse(*binary_response_headers_value, errors);
  }
...
std::unique_ptr<ContinueRequestParams> ContinueRequestParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (headers_value) {
    ...
    result->headers_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::fetch::HeaderEntry>>>::Parse(*headers_value, errors);
  }
  const base::Value* intercept_response_value = value.FindKey("interceptResponse");
...
std::unique_ptr<ContinueWithAuthParams> ContinueWithAuthParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (auth_challenge_response_value) {
    errors->SetName("authChallengeResponse");
    result->auth_challenge_response_ = internal::FromValue<::autofill_assistant::fetch::AuthChallengeResponse>::Parse(*auth_challenge_response_value, errors);
  } else {
...
std::unique_ptr<base::Value> ContinueResponseParams::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  result->Set("requestId", internal::ToValue(request_id_));
  if (response_code_)
...
std::unique_ptr<base::Value> ContinueResponseResult::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  return std::move(result);
}
...
std::unique_ptr<AuthRequiredParams> AuthRequiredParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (auth_challenge_value) {
    errors->SetName("authChallenge");
    result->auth_challenge_ = internal::FromValue<::autofill_assistant::fetch::AuthChallenge>::Parse(*auth_challenge_value, errors);
  } else {
