...
#include "components/autofill_assistant/browser/devtools/devtools/internal/type_conversions_console.h"
...
std::unique_ptr<ConsoleMessage> ConsoleMessage::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (source_value) {
    ...
    result->source_ = internal::FromValue<::autofill_assistant::console::ConsoleMessageSource>::Parse(*source_value, errors);
  } else {
  ...
  if (level_value) {
    ...
    result->level_ = internal::FromValue<::autofill_assistant::console::ConsoleMessageLevel>::Parse(*level_value, errors);
  } else {
...
std::unique_ptr<MessageAddedParams> MessageAddedParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (message_value) {
    ...
    result->message_ = internal::FromValue<::autofill_assistant::console::ConsoleMessage>::Parse(*message_value, errors);
  } else {
