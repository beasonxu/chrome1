...
std::unique_ptr<WebDriverValue> WebDriverValue::Parse(const base::Value& value, ErrorReporter* errors) {
  errors->Push();
  errors->SetName("WebDriverValue");
  if (!value.is_dict()) {
  ...
  std::unique_ptr<WebDriverValue> result(new WebDriverValue());
  errors->Push();
  errors->SetName("WebDriverValue");
  const base::Value* type_value = value.FindKey("type");
  if (type_value) {
    errors->SetName("type");
    result->type_ = internal::FromValue<::autofill_assistant::runtime::WebDriverValueType>::Parse(*type_value, errors);
  } else {
...
std::unique_ptr<base::Value> WebDriverValue::Serialize() const {
...
std::unique_ptr<WebDriverValue> WebDriverValue::Clone() const {
  ErrorReporter errors;
  std::unique_ptr<WebDriverValue> result = Parse(*Serialize(), &errors);
...
std::unique_ptr<RemoteObject> RemoteObject::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (type_value) {
    errors->SetName("type");
    result->type_ = internal::FromValue<::autofill_assistant::runtime::RemoteObjectType>::Parse(*type_value, errors);
  } else {
    errors->AddError("required property missing: type");
  }
  ...
  if (subtype_value) {
    ...
    result->subtype_ = internal::FromValue<::autofill_assistant::runtime::RemoteObjectSubtype>::Parse(*subtype_value, errors);
  }
  ...
  const base::Value* web_driver_value_value = value.FindKey("webDriverValue");
  if (web_driver_value_value) {
    errors->SetName("webDriverValue");
    result->web_driver_value_ = internal::FromValue<::autofill_assistant::runtime::WebDriverValue>::Parse(*web_driver_value_value, errors);
  }
  const base::Value* object_id_value = value.FindKey("objectId");
  if (object_id_value) {
    errors->SetName("objectId");
  ...
  if (preview_value) {
    ...
    result->preview_ = internal::FromValue<::autofill_assistant::runtime::ObjectPreview>::Parse(*preview_value, errors);
  }
  const base::Value* custom_preview_value = value.FindKey("customPreview");
  if (custom_preview_value) {
    errors->SetName("customPreview");
    result->custom_preview_ = internal::FromValue<::autofill_assistant::runtime::CustomPreview>::Parse(*custom_preview_value, errors);
  }
  errors->Pop();
  errors->Pop();
  if (errors->HasErrors())
...
std::unique_ptr<base::Value> RemoteObject::Serialize() const {
  ...
  if (web_driver_value_)
    result->Set("webDriverValue", internal::ToValue(*web_driver_value_.value()));
  if (object_id_)
    result->Set("objectId", internal::ToValue(object_id_.value()));
  if (preview_)
...
std::unique_ptr<ObjectPreview> ObjectPreview::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (type_value) {
    errors->SetName("type");
    result->type_ = internal::FromValue<::autofill_assistant::runtime::ObjectPreviewType>::Parse(*type_value, errors);
  } else {
    errors->AddError("required property missing: type");
  }
  const base::Value* subtype_value = value.FindKey("subtype");
  if (subtype_value) {
    errors->SetName("subtype");
    result->subtype_ = internal::FromValue<::autofill_assistant::runtime::ObjectPreviewSubtype>::Parse(*subtype_value, errors);
  }
  const base::Value* description_value = value.FindKey("description");
  if (description_value) {
    errors->SetName("description");
  ...
  if (properties_value) {
    ...
    result->properties_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::runtime::PropertyPreview>>>::Parse(*properties_value, errors);
  } else {
  ...
  if (entries_value) {
    ...
    result->entries_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::runtime::EntryPreview>>>::Parse(*entries_value, errors);
  }
  errors->Pop();
  errors->Pop();
  if (errors->HasErrors())
...
std::unique_ptr<PropertyPreview> PropertyPreview::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (type_value) {
    errors->SetName("type");
    result->type_ = internal::FromValue<::autofill_assistant::runtime::PropertyPreviewType>::Parse(*type_value, errors);
  } else {
    errors->AddError("required property missing: type");
  }
  const base::Value* value_value = value.FindKey("value");
  ...
  if (value_preview_value) {
    ...
    result->value_preview_ = internal::FromValue<::autofill_assistant::runtime::ObjectPreview>::Parse(*value_preview_value, errors);
  }
  const base::Value* subtype_value = value.FindKey("subtype");
  if (subtype_value) {
    errors->SetName("subtype");
    result->subtype_ = internal::FromValue<::autofill_assistant::runtime::PropertyPreviewSubtype>::Parse(*subtype_value, errors);
  }
  errors->Pop();
  errors->Pop();
  if (errors->HasErrors())
...
std::unique_ptr<EntryPreview> EntryPreview::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (key_value) {
    errors->SetName("key");
    result->key_ = internal::FromValue<::autofill_assistant::runtime::ObjectPreview>::Parse(*key_value, errors);
  }
  const base::Value* value_value = value.FindKey("value");
  if (value_value) {
    errors->SetName("value");
    result->value_ = internal::FromValue<::autofill_assistant::runtime::ObjectPreview>::Parse(*value_value, errors);
  } else {
...
std::unique_ptr<PropertyDescriptor> PropertyDescriptor::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (value_value) {
    errors->SetName("value");
    result->value_ = internal::FromValue<::autofill_assistant::runtime::RemoteObject>::Parse(*value_value, errors);
  }
  ...
  if (get_value) {
    errors->SetName("get");
    result->get_ = internal::FromValue<::autofill_assistant::runtime::RemoteObject>::Parse(*get_value, errors);
  }
  const base::Value* set_value = value.FindKey("set");
  if (set_value) {
    errors->SetName("set");
    result->set_ = internal::FromValue<::autofill_assistant::runtime::RemoteObject>::Parse(*set_value, errors);
  }
  ...
  if (symbol_value) {
    ...
    result->symbol_ = internal::FromValue<::autofill_assistant::runtime::RemoteObject>::Parse(*symbol_value, errors);
  }
  errors->Pop();
  errors->Pop();
  if (errors->HasErrors())
...
std::unique_ptr<ExecutionContextDescription> ExecutionContextDescription::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  const base::Value* unique_id_value = value.FindKey("uniqueId");
  if (unique_id_value) {
...
std::unique_ptr<ExceptionDetails> ExceptionDetails::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (exception_value) {
    ...
    result->exception_ = internal::FromValue<::autofill_assistant::runtime::RemoteObject>::Parse(*exception_value, errors);
  }
  ...
  const base::Value* exception_meta_data_value = value.FindKey("exceptionMetaData");
...
std::unique_ptr<StackTrace> StackTrace::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (call_frames_value) {
    ...
    result->call_frames_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::runtime::CallFrame>>>::Parse(*call_frames_value, errors);
  } else {
  ...
  if (parent_value) {
    ...
    result->parent_ = internal::FromValue<::autofill_assistant::runtime::StackTrace>::Parse(*parent_value, errors);
  }
  const base::Value* parent_id_value = value.FindKey("parentId");
  if (parent_id_value) {
    errors->SetName("parentId");
    result->parent_id_ = internal::FromValue<::autofill_assistant::runtime::StackTraceId>::Parse(*parent_id_value, errors);
  }
  errors->Pop();
  errors->Pop();
  if (errors->HasErrors())
...
std::unique_ptr<CallFunctionOnParams> CallFunctionOnParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (arguments_value) {
    ...
    result->arguments_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::runtime::CallArgument>>>::Parse(*arguments_value, errors);
  }
  ...
  const base::Value* generate_web_driver_value_value = value.FindKey("generateWebDriverValue");
  if (generate_web_driver_value_value) {
    errors->SetName("generateWebDriverValue");
    result->generate_web_driver_value_ = internal::FromValue<bool>::Parse(*generate_web_driver_value_value, errors);
  }
  errors->Pop();
  errors->Pop();
  if (errors->HasErrors())
...
std::unique_ptr<base::Value> CallFunctionOnParams::Serialize() const {
  ...
  if (generate_web_driver_value_)
    result->Set("generateWebDriverValue", internal::ToValue(generate_web_driver_value_.value()));
  return std::move(result);
}
...
std::unique_ptr<EvaluateParams> EvaluateParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  const base::Value* unique_context_id_value = value.FindKey("uniqueContextId");
...
std::unique_ptr<GetPropertiesParams> GetPropertiesParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  const base::Value* non_indexed_properties_only_value = value.FindKey("nonIndexedPropertiesOnly");
...
std::unique_ptr<GetPropertiesResult> GetPropertiesResult::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (result_value) {
    errors->SetName("result");
    result->result_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::runtime::PropertyDescriptor>>>::Parse(*result_value, errors);
  } else {
    errors->AddError("required property missing: result");
  }
  ...
  if (internal_properties_value) {
    ...
    result->internal_properties_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::runtime::InternalPropertyDescriptor>>>::Parse(*internal_properties_value, errors);
  }
  ...
  if (private_properties_value) {
    ...
    result->private_properties_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::runtime::PrivatePropertyDescriptor>>>::Parse(*private_properties_value, errors);
  }
  const base::Value* exception_details_value = value.FindKey("exceptionDetails");
  if (exception_details_value) {
    errors->SetName("exceptionDetails");
...
std::unique_ptr<QueryObjectsResult> QueryObjectsResult::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (objects_value) {
    ...
    result->objects_ = internal::FromValue<::autofill_assistant::runtime::RemoteObject>::Parse(*objects_value, errors);
  } else {
...
std::unique_ptr<AddBindingParams> AddBindingParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  const base::Value* execution_context_name_value = value.FindKey("executionContextName");
...
std::unique_ptr<GetExceptionDetailsParams> GetExceptionDetailsParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  errors->Push();
  errors->SetName("GetExceptionDetailsParams");
  const base::Value* error_object_id_value = value.FindKey("errorObjectId");
...
std::unique_ptr<base::Value> GetExceptionDetailsParams::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
...
std::unique_ptr<base::Value> GetExceptionDetailsResult::Serialize() const {
  std::unique_ptr<base::DictionaryValue> result(new base::DictionaryValue());
  if (exception_details_)
    result->Set("exceptionDetails", internal::ToValue(*exception_details_.value()));
  return std::move(result);
...
std::unique_ptr<ConsoleAPICalledParams> ConsoleAPICalledParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (type_value) {
    errors->SetName("type");
    result->type_ = internal::FromValue<::autofill_assistant::runtime::ConsoleAPICalledType>::Parse(*type_value, errors);
  } else {
    errors->AddError("required property missing: type");
  }
  ...
  if (args_value) {
    errors->SetName("args");
    result->args_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::runtime::RemoteObject>>>::Parse(*args_value, errors);
  } else {
...
std::unique_ptr<ExecutionContextCreatedParams> ExecutionContextCreatedParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (context_value) {
    errors->SetName("context");
    result->context_ = internal::FromValue<::autofill_assistant::runtime::ExecutionContextDescription>::Parse(*context_value, errors);
  } else {
