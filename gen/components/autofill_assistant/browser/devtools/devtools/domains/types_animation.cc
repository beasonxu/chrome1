...
#include "components/autofill_assistant/browser/devtools/devtools/internal/type_conversions_animation.h"
...
std::unique_ptr<Animation> Animation::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (type_value) {
    errors->SetName("type");
    result->type_ = internal::FromValue<::autofill_assistant::animation::AnimationType>::Parse(*type_value, errors);
  } else {
  ...
  if (source_value) {
    ...
    result->source_ = internal::FromValue<::autofill_assistant::animation::AnimationEffect>::Parse(*source_value, errors);
  }
...
std::unique_ptr<AnimationEffect> AnimationEffect::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (keyframes_rule_value) {
    ...
    result->keyframes_rule_ = internal::FromValue<::autofill_assistant::animation::KeyframesRule>::Parse(*keyframes_rule_value, errors);
  }
...
std::unique_ptr<KeyframesRule> KeyframesRule::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (keyframes_value) {
    ...
    result->keyframes_ = internal::FromValue<std::vector<std::unique_ptr<::autofill_assistant::animation::KeyframeStyle>>>::Parse(*keyframes_value, errors);
  } else {
...
std::unique_ptr<ResolveAnimationResult> ResolveAnimationResult::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (remote_object_value) {
    ...
    result->remote_object_ = internal::FromValue<::autofill_assistant::runtime::RemoteObject>::Parse(*remote_object_value, errors);
  } else {
...
std::unique_ptr<AnimationStartedParams> AnimationStartedParams::Parse(const base::Value& value, ErrorReporter* errors) {
  ...
  if (animation_value) {
    errors->SetName("animation");
    result->animation_ = internal::FromValue<::autofill_assistant::animation::Animation>::Parse(*animation_value, errors);
  } else {
