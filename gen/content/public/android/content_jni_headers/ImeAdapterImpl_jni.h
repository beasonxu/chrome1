...
JNI_GENERATOR_EXPORT void Java_J_N_MrkJlyAt(
    ...
    jint focusType) {
  ImeAdapterAndroid* native = reinterpret_cast<ImeAdapterAndroid*>(nativeImeAdapterAndroid);
  CHECK_NATIVE_PTR(env, jcaller, native, "AdvanceFocusForIME");
  return native->AdvanceFocusForIME(env, base::android::JavaParamRef<jobject>(env, caller),
      focusType);
}
...
JNI_GENERATOR_EXPORT void Java_J_N_M3wL9MnJ(
    ...
    jobject gestureData) {
  ImeAdapterAndroid* native = reinterpret_cast<ImeAdapterAndroid*>(nativeImeAdapterAndroid);
  CHECK_NATIVE_PTR(env, jcaller, native, "HandleStylusWritingGestureAction");
  return native->HandleStylusWritingGestureAction(env, base::android::JavaParamRef<jobject>(env,
      caller), base::android::JavaParamRef<jobject>(env, gestureData));
}
...
static void Java_ImeAdapterImpl_updateState(JNIEnv* env, const base::android::JavaRef<jobject>& obj,
    ...
    JniIntWrapper lastVkVisibilityRequest,
    JniIntWrapper vkPolicy,
    jboolean keyboardOverlayContent) {
  ...
  call_context.Init<
      base::android::MethodID::TYPE_INSTANCE>(
          ...
          clazz,
          "updateState",
          "(IIIIZZLjava/lang/String;IIIIZIIZ)V",
     ...
     env->CallVoidMethod(obj.obj(),
          call_context.base.method_id, as_jint(textInputType), as_jint(textInputFlags),
              ...
              as_jint(compositionEnd), replyToRequest, as_jint(lastVkVisibilityRequest),
              as_jint(vkPolicy), keyboardOverlayContent);
}
...
static void Java_ImeAdapterImpl_focusedNodeChanged(JNIEnv* env, const
    ...
    JniIntWrapper nodeLeftDip,
    JniIntWrapper nodeTopDip,
    JniIntWrapper nodeRightDip,
    JniIntWrapper nodeBottomDip) {
  jclass clazz = org_chromium_content_browser_input_ImeAdapterImpl_clazz(env);
  CHECK_CLAZZ(env, obj.obj(),
      org_chromium_content_browser_input_ImeAdapterImpl_clazz(env));
  ...
  call_context.Init<
     ...
     env->CallVoidMethod(obj.obj(),
          call_context.base.method_id, isEditable, as_jint(nodeLeftDip), as_jint(nodeTopDip),
              as_jint(nodeRightDip), as_jint(nodeBottomDip));
}

static std::atomic<jmethodID>
    g_org_chromium_content_browser_input_ImeAdapterImpl_requestStartStylusWriting(nullptr);
static jboolean Java_ImeAdapterImpl_requestStartStylusWriting(JNIEnv* env, const
    base::android::JavaRef<jobject>& obj) {
  jclass clazz = org_chromium_content_browser_input_ImeAdapterImpl_clazz(env);
  CHECK_CLAZZ(env, obj.obj(),
      org_chromium_content_browser_input_ImeAdapterImpl_clazz(env), false);
  ...
  call_context.Init<
      base::android::MethodID::TYPE_INSTANCE>(
          env,
          clazz,
          "requestStartStylusWriting",
          "()Z",
          &g_org_chromium_content_browser_input_ImeAdapterImpl_requestStartStylusWriting);
...
static std::atomic<jmethodID>
    g_org_chromium_content_browser_input_ImeAdapterImpl_onEditElementFocusedForStylusWriting(nullptr);
static void Java_ImeAdapterImpl_onEditElementFocusedForStylusWriting(JNIEnv* env, const
    base::android::JavaRef<jobject>& obj, JniIntWrapper focusedEditLeft,
    JniIntWrapper focusedEditTop,
    JniIntWrapper focusedEditRight,
    JniIntWrapper focusedEditBottom,
    JniIntWrapper caretX,
    JniIntWrapper caretY) {
  jclass clazz = org_chromium_content_browser_input_ImeAdapterImpl_clazz(env);
  CHECK_CLAZZ(env, obj.obj(),
      org_chromium_content_browser_input_ImeAdapterImpl_clazz(env));
  ...
  call_context.Init<
      base::android::MethodID::TYPE_INSTANCE>(
          ...
          "(IIIIII)V",
&g_org_chromium_content_browser_input_ImeAdapterImpl_onEditElementFocusedForStylusWriting);

     env->CallVoidMethod(obj.obj(),
          call_context.base.method_id, as_jint(focusedEditLeft), as_jint(focusedEditTop),
              as_jint(focusedEditRight), as_jint(focusedEditBottom), as_jint(caretX),
              as_jint(caretY));
}
