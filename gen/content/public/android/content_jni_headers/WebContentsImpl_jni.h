...
JNI_GENERATOR_EXPORT void Java_J_N_M0iG1Oc2(
  ...
  return native->ClearNativeReference(env);
}
...
JNI_GENERATOR_EXPORT jobject Java_J_N_MunY3e38(
  ...
  return native->GetTopLevelNativeWindow(env).Release();
}
...
JNI_GENERATOR_EXPORT void Java_J_N_MOKG_1Wbb(
  ...
  return native->SetTopLevelNativeWindow(env, base::android::JavaParamRef<jobject>(env,
      windowAndroid));
}
...
JNI_GENERATOR_EXPORT jobject Java_J_N_MjidYpBx(
  ...
  return native->GetMainFrame(env).Release();
}
...
JNI_GENERATOR_EXPORT jobject Java_J_N_MT2cFaRc(
  ...
  return native->GetFocusedFrame(env).Release();
}
...
JNI_GENERATOR_EXPORT jobject Java_J_N_MZAK3_1Tx(
    ...
    jint renderFrameId) {
  WebContentsAndroid* native = reinterpret_cast<WebContentsAndroid*>(nativeWebContentsAndroid);
  CHECK_NATIVE_PTR(env, jcaller, native, "GetRenderFrameHostFromId", NULL);
  return native->GetRenderFrameHostFromId(env, renderProcessId, renderFrameId).Release();
}
...
JNI_GENERATOR_EXPORT jobjectArray Java_J_N_MEpC20hN(
  ...
  return native->GetAllRenderFrameHosts(env).Release();
}
...
JNI_GENERATOR_EXPORT jobject Java_J_N_Mj9slq6o(
  ...
  return native->GetRenderWidgetHostView(env).Release();
}
...
JNI_GENERATOR_EXPORT jobjectArray Java_J_N_MJSe_1z5C(
  ...
  return native->GetInnerWebContents(env).Release();
}
...
JNI_GENERATOR_EXPORT jint Java_J_N_MOzDgqoz(
    ...
    jlong nativeWebContentsAndroid) {
  WebContentsAndroid* native = reinterpret_cast<WebContentsAndroid*>(nativeWebContentsAndroid);
  CHECK_NATIVE_PTR(env, jcaller, native, "GetVisibility", 0);
  return native->GetVisibility(env);
}
...
JNI_GENERATOR_EXPORT jstring Java_J_N_M7OgjMU8(
  ...
  return native->GetTitle(env).Release();
}
...
JNI_GENERATOR_EXPORT jobject Java_J_N_M8927Uaf(
  ...
  return native->GetVisibleURL(env).Release();
}
...
JNI_GENERATOR_EXPORT jstring Java_J_N_M4pZ82rG(
  ...
  return native->GetEncoding(env).Release();
}
...
JNI_GENERATOR_EXPORT jboolean Java_J_N_MgB0r7fM(
    ...
    jlong nativeWebContentsAndroid) {
  WebContentsAndroid* native = reinterpret_cast<WebContentsAndroid*>(nativeWebContentsAndroid);
  CHECK_NATIVE_PTR(env, jcaller, native, "ShouldShowLoadingUI", false);
  return native->ShouldShowLoadingUI(env);
}
...
JNI_GENERATOR_EXPORT void Java_J_N_M6R_1ShZs(
    ...
    jboolean autoCancel) {
  WebContentsAndroid* native = reinterpret_cast<WebContentsAndroid*>(nativeWebContentsAndroid);
  CHECK_NATIVE_PTR(env, jcaller, native, "DispatchBeforeUnload");
  return native->DispatchBeforeUnload(env, autoCancel);
}
...
JNI_GENERATOR_EXPORT void Java_J_N_MdSkKRWg(
  ...
  return native->PasteAsPlainText(env);
}
...
JNI_GENERATOR_EXPORT void Java_J_N_MevqfbP8(
  ...
  return native->Replace(env, base::android::JavaParamRef<jstring>(env, word));
}
...
JNI_GENERATOR_EXPORT void Java_J_N_MDK_1KK0z(
  ...
  return native->CollapseSelection(env);
}
...
JNI_GENERATOR_EXPORT void Java_J_N_MkBVGSRs(
  ...
  return native->SetImportance(env, importance);
}
...
JNI_GENERATOR_EXPORT void Java_J_N_M4fkbrQM(
  ...
  return native->SetAudioMuted(env, mute);
}
...
JNI_GENERATOR_EXPORT jboolean Java_J_N_M2hIwGoV(
    ...
    jlong nativeWebContentsAndroid) {
  WebContentsAndroid* native = reinterpret_cast<WebContentsAndroid*>(nativeWebContentsAndroid);
  CHECK_NATIVE_PTR(env, jcaller, native, "IsFullscreenForCurrentTab", false);
  return native->IsFullscreenForCurrentTab(env);
}
...
JNI_GENERATOR_EXPORT void Java_J_N_M6c69Eq5(
  ...
  return native->ExitFullscreen(env);
}
...
JNI_GENERATOR_EXPORT void Java_J_N_M6Fd7RHW(
  ...
  WebContentsAndroid* native = reinterpret_cast<WebContentsAndroid*>(nativeWebContentsAndroid);
  CHECK_NATIVE_PTR(env, jcaller, native, "SelectAroundCaret");
  return native->SelectAroundCaret(env, granularity, shouldShowHandle, shouldShowContextMenu);
}
...
JNI_GENERATOR_EXPORT void Java_J_N_MjgOFo_1o(
  ...
  return native->AdjustSelectionByCharacterOffset(env, startAdjust, endAdjust, showSelectionMenu);
}
...
JNI_GENERATOR_EXPORT jobject Java_J_N_MrqMRJsG(
  ...
  return native->GetLastCommittedURL(env).Release();
}
...
JNI_GENERATOR_EXPORT void Java_J_N_M0uS2SDH(
  ...
  return native->EvaluateJavaScript(env, base::android::JavaParamRef<jstring>(env, script),
...
JNI_GENERATOR_EXPORT void Java_J_N_MPoHZQTR(
  ...
  return native->EvaluateJavaScriptForTests(env, base::android::JavaParamRef<jstring>(env, script),
      base::android::JavaParamRef<jobject>(env, callback));
}
...
JNI_GENERATOR_EXPORT void Java_J_N_MseJ7A4a(
  ...
  return native->AddMessageToDevToolsConsole(env, level, base::android::JavaParamRef<jstring>(env,
      message));
}
...
JNI_GENERATOR_EXPORT void Java_J_N_MZFXk0el(
  ...
  return native->PostMessageToMainFrame(env, base::android::JavaParamRef<jobject>(env, payload),
...
JNI_GENERATOR_EXPORT jint Java_J_N_MGZCJ6jO(
  ...
  return native->GetThemeColor(env);
}
...
JNI_GENERATOR_EXPORT jfloat Java_J_N_MoQgY_1pw(
  ...
  return native->GetLoadProgress(env);
}
...
JNI_GENERATOR_EXPORT void Java_J_N_MHF1rPTW(
  ...
  return native->RequestSmartClipExtract(env, base::android::JavaParamRef<jobject>(env, callback),
      x, y, width, height);
}
...
JNI_GENERATOR_EXPORT void Java_J_N_M16eLpU9(
  ...
  return native->RequestAccessibilitySnapshot(env, base::android::JavaParamRef<jobject>(env,
      viewStructureRoot), base::android::JavaParamRef<jobject>(env, viewStructureBuilder),
      base::android::JavaParamRef<jobject>(env, doneCallback));
}
...
JNI_GENERATOR_EXPORT void Java_J_N_MjBPqNgx(
  ...
  return native->SetSpatialNavigationDisabled(env, disabled);
}
...
JNI_GENERATOR_EXPORT void Java_J_N_MbcpLoZf(
    ...
    jboolean enabled) {
  WebContentsAndroid* native = reinterpret_cast<WebContentsAndroid*>(nativeWebContentsAndroid);
  CHECK_NATIVE_PTR(env, jcaller, native, "SetStylusHandwritingEnabled");
  return native->SetStylusHandwritingEnabled(env, enabled);
}
...
JNI_GENERATOR_EXPORT jint Java_J_N_Mi3V1mlO(
  ...
  return native->DownloadImage(env, base::android::JavaParamRef<jobject>(env, url), isFavicon,
...
JNI_GENERATOR_EXPORT void Java_J_N_M12SiBFk(
  ...
  return native->SetHasPersistentVideo(env, value);
}
...
JNI_GENERATOR_EXPORT jboolean Java_J_N_MZao1OQG(
  ...
  return native->HasActiveEffectivelyFullscreenVideo(env);
}
...
JNI_GENERATOR_EXPORT jobject Java_J_N_MN9JdEk5(
  ...
  return native->GetFullscreenVideoSize(env).Release();
}
...
JNI_GENERATOR_EXPORT void Java_J_N_M7tTrJ_1X(
  ...
  return native->SetSize(env, width, height);
}
...
JNI_GENERATOR_EXPORT jobject Java_J_N_MJJFrmZs(
  ...
  return native->GetOrCreateEventForwarder(env).Release();
}
...
JNI_GENERATOR_EXPORT void Java_J_N_MgyWdCWB(
  ...
  return native->SetViewAndroidDelegate(env, base::android::JavaParamRef<jobject>(env,
      viewDelegate));
}
...
JNI_GENERATOR_EXPORT void Java_J_N_MlztHl3v(
  ...
  return native->SendOrientationChangeEvent(env, orientation);
}
...
JNI_GENERATOR_EXPORT void Java_J_N_MqhGkzSt(
  ...
  return native->OnScaleFactorChanged(env);
}
...
JNI_GENERATOR_EXPORT void Java_J_N_M9QxNoTJ(
  ...
  return native->SetFocus(env, focused);
}
...
JNI_GENERATOR_EXPORT void Java_J_N_MtjP03pj(
  ...
  return native->SetDisplayCutoutSafeArea(env, top, left, bottom, right);
}
...
JNI_GENERATOR_EXPORT void Java_J_N_Mzsx8Sk2(
  ...
  return native->NotifyRendererPreferenceUpdate(env);
}
...
JNI_GENERATOR_EXPORT void Java_J_N_MgcGzQax(
  ...
  return native->NotifyBrowserControlsHeightChanged(env);
}
...
JNI_GENERATOR_EXPORT jboolean Java_J_N_M5A4vDoy(
  ...
  return native->IsBeingDestroyed(env);
}
...
static std::atomic<jmethodID>
    g_org_chromium_content_browser_webcontents_WebContentsImpl_createRenderFrameHostArray(nullptr);
static base::android::ScopedJavaLocalRef<jobjectArray>
    Java_WebContentsImpl_createRenderFrameHostArray(JNIEnv* env, JniIntWrapper size) {
  jclass clazz = org_chromium_content_browser_webcontents_WebContentsImpl_clazz(env);
  CHECK_CLAZZ(env, clazz,
      org_chromium_content_browser_webcontents_WebContentsImpl_clazz(env), NULL);
  ...
  call_context.Init<
      base::android::MethodID::TYPE_STATIC>(
          env,
          clazz,
          "createRenderFrameHostArray",
          "(I)[Lorg/chromium/content_public/browser/RenderFrameHost;",
          &g_org_chromium_content_browser_webcontents_WebContentsImpl_createRenderFrameHostArray);
...
static std::atomic<jmethodID>
    g_org_chromium_content_browser_webcontents_WebContentsImpl_addRenderFrameHostToArray(nullptr);
static void Java_WebContentsImpl_addRenderFrameHostToArray(JNIEnv* env, const
    base::android::JavaRef<jobjectArray>& frames,
    JniIntWrapper index,
  ...
  call_context.Init<
      base::android::MethodID::TYPE_STATIC>(
          env,
          clazz,
          "addRenderFrameHostToArray",
"([Lorg/chromium/content_public/browser/RenderFrameHost;ILorg/chromium/content_public/browser/RenderFrameHost;)V",
          &g_org_chromium_content_browser_webcontents_WebContentsImpl_addRenderFrameHostToArray);

     env->CallStaticVoidMethod(clazz,
          call_context.base.method_id, frames.obj(), as_jint(index), frame.obj());
}
...
"(Lorg/chromium/content_public/browser/ImageDownloadCallback;IILorg/chromium/url/GURL;Ljava/util/List;Ljava/util/List;)V",
