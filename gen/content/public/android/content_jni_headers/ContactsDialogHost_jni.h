...
static base::android::ScopedJavaLocalRef<jobject> Java_ContactsDialogHost_create(JNIEnv* env, const
  ...
  call_context.Init<
      base::android::MethodID::TYPE_STATIC>(
          ...
          clazz,
          "create",
"(Lorg/chromium/content_public/browser/WebContents;J)Lorg/chromium/content/browser/ContactsDialogHost;",
          &g_org_chromium_content_browser_ContactsDialogHost_create);

  jobject ret =
      env->CallStaticObjectMethod(clazz,
          call_context.base.method_id, webContents.obj(), nativeContactsProviderAndroid);
