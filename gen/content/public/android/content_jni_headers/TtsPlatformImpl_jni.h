...
JNI_GENERATOR_EXPORT void Java_J_N_MpJkwIUo(
  ...
  return native->VoicesChanged(env);
}
...
JNI_GENERATOR_EXPORT void Java_J_N_M47GdBO5(
  ...
  return native->OnEndEvent(env, utteranceId);
}
...
JNI_GENERATOR_EXPORT void Java_J_N_M2_00024X0reE(
  ...
  return native->OnStartEvent(env, utteranceId);
}
...
JNI_GENERATOR_EXPORT void Java_J_N_M1Kw17GB(
  ...
  return native->OnErrorEvent(env, utteranceId);
}
...
static jboolean Java_TtsPlatformImpl_speak(JNIEnv* env, const base::android::JavaRef<jobject>& obj,
    ...
    const base::android::JavaRef<jstring>& engineId,
    jfloat rate,
    jfloat pitch,
    jfloat volume) {
  jclass clazz = org_chromium_content_browser_TtsPlatformImpl_clazz(env);
  ...
  call_context.Init<
      base::android::MethodID::TYPE_INSTANCE>(
          ...
          clazz,
          "speak",
          "(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;FFF)Z",
          &g_org_chromium_content_browser_TtsPlatformImpl_speak);

  jboolean ret =
      env->CallBooleanMethod(obj.obj(),
          call_context.base.method_id, as_jint(utteranceId), text.obj(), lang.obj(), engineId.obj(),
              rate, pitch, volume);
  return ret;
}
