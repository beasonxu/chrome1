...
static const mojo::internal::GenericValidationInfo kMediaInternalLogRecordsValidationInfo[] = {
...
bool MediaInternalLogRecordsRequestValidator::Accept(mojo::Message* message) {
  ...
  return mojo::internal::ValidateRequestGenericPacked(message, name, kMediaInternalLogRecordsValidationInfo);
}
...
void MediaInternalLogRecordsInterceptorForTesting::Log(const std::vector<::media::MediaLogRecord>& events) {
  GetForwardingInterface()->Log(std::move(events));
}
