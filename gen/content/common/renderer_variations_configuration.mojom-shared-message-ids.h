...
constexpr uint32_t kRendererVariationsConfiguration_SetVariationsHeaders_Name = 0;
constexpr uint32_t kRendererVariationsConfiguration_SetFieldTrialGroup_Name = 1;
