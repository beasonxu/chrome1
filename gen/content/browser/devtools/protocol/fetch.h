...
public:
    ...
    virtual void ContinueRequest(const String& in_requestId, Maybe<String> in_url, Maybe<String> in_method, Maybe<Binary> in_postData, Maybe<protocol::Array<protocol::Fetch::HeaderEntry>> in_headers, Maybe<bool> in_interceptResponse, std::unique_ptr<ContinueRequestCallback> callback) = 0;
    ...
    virtual void ContinueResponse(const String& in_requestId, Maybe<int> in_responseCode, Maybe<String> in_responsePhrase, Maybe<protocol::Array<protocol::Fetch::HeaderEntry>> in_responseHeaders, Maybe<Binary> in_binaryResponseHeaders, std::unique_ptr<ContinueResponseCallback> callback) = 0;
...
public:
  explicit Frontend(FrontendChannel* frontend_channel) : frontend_channel_(frontend_channel) {}
    void RequestPaused(const String& requestId, std::unique_ptr<protocol::Network::Request> request, const String& frameId, const String& resourceType, Maybe<String> responseErrorReason = Maybe<String>(), Maybe<int> responseStatusCode = Maybe<int>(), Maybe<String> responseStatusText = Maybe<String>(), Maybe<protocol::Array<protocol::Fetch::HeaderEntry>> responseHeaders = Maybe<protocol::Array<protocol::Fetch::HeaderEntry>>(), Maybe<String> networkId = Maybe<String>());
