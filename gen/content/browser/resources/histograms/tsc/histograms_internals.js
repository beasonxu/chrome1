...
function setExpanded(histogramNode, expanded) {
    const body = histogramNode.querySelector('.histogram-body');
    const expand = histogramNode.querySelector('.expand');
    const collapse = histogramNode.querySelector('.collapse');
...
function addHistograms(histograms) {
    ...
    for (const histogram of histograms) {
        ...
        const template = document.body.querySelector('#histogram-template');
        assert(template);
