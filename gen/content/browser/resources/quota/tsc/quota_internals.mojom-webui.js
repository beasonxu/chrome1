...
export class QuotaInternalsHandlerRemote {
     ...
     */
    getDiskAvailabilityAndTempPoolSize() {
        return this.proxy.sendMessage(0, QuotaInternalsHandler_GetDiskAvailabilityAndTempPoolSize_ParamsSpec.$, QuotaInternalsHandler_GetDiskAvailabilityAndTempPoolSize_ResponseParamsSpec.$, []);
    }
    /**
     * @return {!Promise<{
          evictionStatistics: !Object<!string, !string>,
     ...
     */
    getStatistics() {
        return this.proxy.sendMessage(1, QuotaInternalsHandler_GetStatistics_ParamsSpec.$, QuotaInternalsHandler_GetStatistics_ResponseParamsSpec.$, []);
    }
    /**
     * @param { !url_mojom_Origin } originUrl
     */
    simulateStoragePressure(originUrl) {
        this.proxy.sendMessage(2, QuotaInternalsHandler_SimulateStoragePressure_ParamsSpec.$, null, [
            originUrl
        ]);
    }
    /**
     ...
     */
    retrieveBucketsTable() {
        return this.proxy.sendMessage(3, QuotaInternalsHandler_RetrieveBucketsTable_ParamsSpec.$, QuotaInternalsHandler_RetrieveBucketsTable_ResponseParamsSpec.$, []);
    }
    /**
     * @param { !StorageType } storageType
     * @return {!Promise<{
     ...
     */
    getGlobalUsageForInternals(storageType) {
        return this.proxy.sendMessage(4, QuotaInternalsHandler_GetGlobalUsageForInternals_ParamsSpec.$, QuotaInternalsHandler_GetGlobalUsageForInternals_ResponseParamsSpec.$, [
            storageType
        ]);
    }
}
...
export class QuotaInternalsHandlerReceiver {
    ...
    constructor(impl) {
        ...
        this.helper_internal_.registerHandler(0, QuotaInternalsHandler_GetDiskAvailabilityAndTempPoolSize_ParamsSpec.$, QuotaInternalsHandler_GetDiskAvailabilityAndTempPoolSize_ResponseParamsSpec.$, impl.getDiskAvailabilityAndTempPoolSize.bind(impl));
        this.helper_internal_.registerHandler(1, QuotaInternalsHandler_GetStatistics_ParamsSpec.$, QuotaInternalsHandler_GetStatistics_ResponseParamsSpec.$, impl.getStatistics.bind(impl));
        this.helper_internal_.registerHandler(2, QuotaInternalsHandler_SimulateStoragePressure_ParamsSpec.$, null, impl.simulateStoragePressure.bind(impl));
        this.helper_internal_.registerHandler(3, QuotaInternalsHandler_RetrieveBucketsTable_ParamsSpec.$, QuotaInternalsHandler_RetrieveBucketsTable_ResponseParamsSpec.$, impl.retrieveBucketsTable.bind(impl));
        this.helper_internal_.registerHandler(4, QuotaInternalsHandler_GetGlobalUsageForInternals_ParamsSpec.$, QuotaInternalsHandler_GetGlobalUsageForInternals_ResponseParamsSpec.$, impl.getGlobalUsageForInternals.bind(impl));
        /** @public {!mojo.internal.interfaceSupport.ConnectionErrorEventRouter} */
...
export class QuotaInternalsHandlerCallbackRouter {
    constructor() {
        ...
        this.helper_internal_.registerHandler(0, QuotaInternalsHandler_GetDiskAvailabilityAndTempPoolSize_ParamsSpec.$, QuotaInternalsHandler_GetDiskAvailabilityAndTempPoolSize_ResponseParamsSpec.$, this.getDiskAvailabilityAndTempPoolSize.createReceiverHandler(true /* expectsResponse */));
        /**
         * @public {!mojo.internal.interfaceSupport.InterfaceCallbackReceiver}
         */
        this.getStatistics =
            new mojo.internal.interfaceSupport.InterfaceCallbackReceiver(this.router_);
        this.helper_internal_.registerHandler(1, QuotaInternalsHandler_GetStatistics_ParamsSpec.$, QuotaInternalsHandler_GetStatistics_ResponseParamsSpec.$, this.getStatistics.createReceiverHandler(true /* expectsResponse */));
        /**
         * @public {!mojo.internal.interfaceSupport.InterfaceCallbackReceiver}
         */
        this.simulateStoragePressure =
            new mojo.internal.interfaceSupport.InterfaceCallbackReceiver(this.router_);
        this.helper_internal_.registerHandler(2, QuotaInternalsHandler_SimulateStoragePressure_ParamsSpec.$, null, this.simulateStoragePressure.createReceiverHandler(false /* expectsResponse */));
        /**
         * @public {!mojo.internal.interfaceSupport.InterfaceCallbackReceiver}
         */
        this.retrieveBucketsTable =
            new mojo.internal.interfaceSupport.InterfaceCallbackReceiver(this.router_);
        this.helper_internal_.registerHandler(3, QuotaInternalsHandler_RetrieveBucketsTable_ParamsSpec.$, QuotaInternalsHandler_RetrieveBucketsTable_ResponseParamsSpec.$, this.retrieveBucketsTable.createReceiverHandler(true /* expectsResponse */));
        /**
         * @public {!mojo.internal.interfaceSupport.InterfaceCallbackReceiver}
         */
        this.getGlobalUsageForInternals =
            new mojo.internal.interfaceSupport.InterfaceCallbackReceiver(this.router_);
        this.helper_internal_.registerHandler(4, QuotaInternalsHandler_GetGlobalUsageForInternals_ParamsSpec.$, QuotaInternalsHandler_GetGlobalUsageForInternals_ResponseParamsSpec.$, this.getGlobalUsageForInternals.createReceiverHandler(true /* expectsResponse */));
        /** @public {!mojo.internal.interfaceSupport.ConnectionErrorEventRouter} */
        this.onConnectionError = this.helper_internal_.getConnectionErrorEventRouter();
    }
    /**
...
mojo.internal.Struct(BucketTableEntrySpec.$, 'BucketTableEntry', [
    ...
    mojo.internal.StructField('type', 16, 0, StorageTypeSpec.$, 0, false /* nullable */, 0),
    mojo.internal.StructField('name', 24, 0, mojo.internal.String, null, false /* nullable */, 0),
    mojo.internal.StructField('usage', 32, 0, mojo.internal.Int64, BigInt('-1'), false /* nullable */, 0),
